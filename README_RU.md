...
![узлы](https://img.shields.io/badge/узлы-107-brightgreen) ![живые](https://img.shields.io/badge/живые-1949-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-102ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-04_00:23_UTC-informational)
...
- **Медиана RTT**: 102 ms
- **Последнее обновление (UTC)**: 2026-06-04 00:23 UTC

**Распределение протоколов:** shadowsocks × 24 · trojan × 38 · vless × 36 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `epodonios` × 26 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 29 · `snakem982` × 1 · `surfboard-eternity` × 1
