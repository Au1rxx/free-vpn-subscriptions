...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-2120-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-364ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-24_19:28_UTC-informational)
...
- **Выбрано узлов**: 114
- **Живых во всех источниках**: 2120
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 364 ms
- **Последнее обновление (UTC)**: 2026-06-24 19:28 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 30 · trojan × 32 · vless × 34 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 37 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 6 · `ruking-clash` × 15 · `surfboard-eternity` × 2
