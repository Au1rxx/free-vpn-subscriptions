...
![узлы](https://img.shields.io/badge/узлы-141-brightgreen) ![живые](https://img.shields.io/badge/живые-2494-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-170ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_19:15_UTC-informational)
...
- **Выбрано узлов**: 141
- **Живых во всех источниках**: 2494
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 170 ms
- **Последнее обновление (UTC)**: 2026-05-09 19:15 UTC

**Распределение протоколов:** shadowsocks × 52 · trojan × 16 · vless × 64 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 20 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
