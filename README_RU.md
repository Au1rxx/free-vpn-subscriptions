...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2278-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-179ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-25_22:25_UTC-informational)
...
- **Медиана RTT**: 179 ms
- **Последнее обновление (UTC)**: 2026-04-25 22:25 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 18 · vless × 87 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 53 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 6
