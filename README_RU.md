...
![узлы](https://img.shields.io/badge/узлы-75-brightgreen) ![живые](https://img.shields.io/badge/живые-2114-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-124ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-10_07:12_UTC-informational)
...
- **Медиана RTT**: 124 ms
- **Последнее обновление (UTC)**: 2026-07-10 07:12 UTC

**Распределение протоколов:** shadowsocks × 20 · trojan × 10 · vless × 15 · vmess × 30

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 33 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `surfboard-eternity` × 2
