...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-2393-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-493ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-18_20:20_UTC-informational)
...
- **Выбрано узлов**: 111
- **Живых во всех источниках**: 2393
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 493 ms
- **Последнее обновление (UTC)**: 2026-06-18 20:20 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 38 · trojan × 24 · vless × 38 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 35 · `snakem982` × 7 · `surfboard-eternity` × 5
