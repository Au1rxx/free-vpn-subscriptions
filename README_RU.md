...
![узлы](https://img.shields.io/badge/узлы-81-brightgreen) ![живые](https://img.shields.io/badge/живые-2269-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-184ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-20_12:33_UTC-informational)
...
- **Медиана RTT**: 184 ms
- **Последнее обновление (UTC)**: 2026-06-20 12:33 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 22 · vless × 8 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `ruking-clash` × 15 · `surfboard-eternity` × 2
