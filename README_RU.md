...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2446-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-136ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_06:35_UTC-informational)
...
- **Медиана RTT**: 136 ms
- **Последнее обновление (UTC)**: 2026-05-11 06:35 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 5 · vless × 94 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
