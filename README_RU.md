...
![узлы](https://img.shields.io/badge/узлы-65-brightgreen) ![живые](https://img.shields.io/badge/живые-2001-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-200ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_10:23_UTC-informational)
...
- **Медиана RTT**: 200 ms
- **Последнее обновление (UTC)**: 2026-05-28 10:23 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 10 · vless × 14 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
