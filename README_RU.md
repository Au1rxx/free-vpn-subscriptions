...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2630-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-79ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-17_17:13_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 67 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2630
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 79 ms
- **Последнее обновление (UTC)**: 2026-05-17 17:13 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 43 · trojan × 14 · vless × 86 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 6 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 37 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 46 · `pawdroid` × 2 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 3
