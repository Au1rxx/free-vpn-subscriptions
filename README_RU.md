...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2307-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-399ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-18_08:34_UTC-informational)
...
- **Медиана RTT**: 399 ms
- **Последнее обновление (UTC)**: 2026-07-18 08:34 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 103 · vless × 8 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 59 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 45 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
