...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2102-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-99ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-29_03:17_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2102
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 99 ms
- **Последнее обновление (UTC)**: 2026-04-29 03:17 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 5 · vless × 103 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 74 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
