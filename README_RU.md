...
![узлы](https://img.shields.io/badge/узлы-74-brightgreen) ![живые](https://img.shields.io/badge/живые-2324-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-155ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-31_18:39_UTC-informational)
...
- **Медиана RTT**: 155 ms
- **Последнее обновление (UTC)**: 2026-05-31 18:39 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 22 · trojan × 13 · vless × 5 · vmess × 33

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 24 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `surfboard-eternity` × 3
