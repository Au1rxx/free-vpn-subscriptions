...
![узлы](https://img.shields.io/badge/узлы-101-brightgreen) ![живые](https://img.shields.io/badge/живые-2176-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-153ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-06_04:36_UTC-informational)
...
- **Медиана RTT**: 153 ms
- **Последнее обновление (UTC)**: 2026-06-06 04:36 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 27 · vless × 32 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 25 · `lagzian-mix` × 3 · `mahdi0024` × 20 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 28 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
