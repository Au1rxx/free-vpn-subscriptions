...
![узлы](https://img.shields.io/badge/узлы-93-brightgreen) ![живые](https://img.shields.io/badge/живые-1853-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-361ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_22:35_UTC-informational)
...
- **Медиана RTT**: 361 ms
- **Последнее обновление (UTC)**: 2026-06-07 22:35 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 52 · trojan × 19 · vless × 15 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `ruking-clash` × 3 · `surfboard-eternity` × 1
