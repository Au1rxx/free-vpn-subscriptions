...
![узлы](https://img.shields.io/badge/узлы-142-brightgreen) ![живые](https://img.shields.io/badge/живые-2461-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-121ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-24_10:16_UTC-informational)
...
- **Медиана RTT**: 121 ms
- **Последнее обновление (UTC)**: 2026-04-24 10:16 UTC

**Распределение протоколов:** shadowsocks × 14 · trojan × 22 · vless × 92 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 71 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
