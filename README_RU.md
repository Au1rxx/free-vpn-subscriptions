...
![узлы](https://img.shields.io/badge/узлы-73-brightgreen) ![живые](https://img.shields.io/badge/живые-2087-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-277ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_17:22_UTC-informational)
...
- **Медиана RTT**: 277 ms
- **Последнее обновление (UTC)**: 2026-05-28 17:22 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 22 · vless × 12 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 3 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
