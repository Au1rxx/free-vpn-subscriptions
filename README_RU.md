...
![узлы](https://img.shields.io/badge/узлы-116-brightgreen) ![живые](https://img.shields.io/badge/живые-1904-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-291ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_01:22_UTC-informational)
...
- **Медиана RTT**: 291 ms
- **Последнее обновление (UTC)**: 2026-07-07 01:22 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 46 · trojan × 27 · vless × 20 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 10 · `mahdi0024` × 28 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 9 · `ninjastrikers` × 22 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 2
