...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2561-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-85ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-16_00:18_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2561
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 85 ms
- **Последнее обновление (UTC)**: 2026-05-16 00:18 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 10 · vless × 96 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 61 · `pawdroid` × 9 · `ruking-clash` × 5 · `surfboard-eternity` × 3
