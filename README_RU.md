...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2133-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-96ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_03:25_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2133
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 96 ms
- **Последнее обновление (UTC)**: 2026-04-26 03:25 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 7 · vless × 104 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 69 · `pawdroid` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 2
