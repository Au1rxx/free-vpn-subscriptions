...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2491-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-98ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_04:25_UTC-informational)
...
- **Медиана RTT**: 98 ms
- **Последнее обновление (UTC)**: 2026-05-10 04:25 UTC

**Распределение протоколов:** shadowsocks × 47 · trojan × 3 · vless × 91 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 34 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 60 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 6
