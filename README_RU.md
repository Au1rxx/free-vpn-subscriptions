...
![узлы](https://img.shields.io/badge/узлы-116-brightgreen) ![живые](https://img.shields.io/badge/живые-1906-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-320ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_23:26_UTC-informational)
...
- **Медиана RTT**: 320 ms
- **Последнее обновление (UTC)**: 2026-07-05 23:26 UTC

**Распределение протоколов:** shadowsocks × 49 · trojan × 26 · vless × 10 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 31 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `ruking-clash` × 2 · `surfboard-eternity` × 4
