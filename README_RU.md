...
![узлы](https://img.shields.io/badge/узлы-123-brightgreen) ![живые](https://img.shields.io/badge/живые-2075-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-379ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-24_17:36_UTC-informational)
...
- **Выбрано узлов**: 123
- **Живых во всех источниках**: 2075
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 379 ms
- **Последнее обновление (UTC)**: 2026-06-24 17:36 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 33 · vless × 38 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 40 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 3
