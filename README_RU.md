...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2455-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-78ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-18_12:37_UTC-informational)
...
- **Медиана RTT**: 78 ms
- **Последнее обновление (UTC)**: 2026-05-18 12:37 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 45 · trojan × 8 · vless × 89 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 40 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 53 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
