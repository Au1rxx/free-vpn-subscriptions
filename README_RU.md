...
![узлы](https://img.shields.io/badge/узлы-145-brightgreen) ![живые](https://img.shields.io/badge/живые-2350-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-92ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-24_23:31_UTC-informational)
...
- **Выбрано узлов**: 145
- **Живых во всех источниках**: 2350
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 92 ms
- **Последнее обновление (UTC)**: 2026-05-24 23:31 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 19 · vless × 56 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 47 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 47 · `pawdroid` × 5 · `ruking-clash` × 4 · `surfboard-eternity` × 8
