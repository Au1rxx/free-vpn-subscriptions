...
![узлы](https://img.shields.io/badge/узлы-147-brightgreen) ![живые](https://img.shields.io/badge/живые-2561-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-97ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-14_20:33_UTC-informational)
...
- **Медиана RTT**: 97 ms
- **Последнее обновление (UTC)**: 2026-05-14 20:33 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 25 · vless × 79 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 7 · `ninjastrikers` × 49 · `pawdroid` × 8 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
