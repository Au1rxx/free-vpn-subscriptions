...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1611-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-368ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-15_04:27_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1611
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 368 ms
- **Последнее обновление (UTC)**: 2026-07-15 04:27 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 97 · trojan × 26 · vless × 16 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 2 · `epodonios` × 23 · `mahdi0024` × 13 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4
