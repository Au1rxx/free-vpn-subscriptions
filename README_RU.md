...
![узлы](https://img.shields.io/badge/узлы-144-brightgreen) ![живые](https://img.shields.io/badge/живые-1974-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-501ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-16_22:32_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 68 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 144
- **Живых во всех источниках**: 1974
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 501 ms
- **Последнее обновление (UTC)**: 2026-06-16 22:32 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 16 · vmess × 54

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 58 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `ruking-clash` × 18
