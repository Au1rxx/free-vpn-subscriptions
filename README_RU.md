...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2253-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-246ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-20_17:20_UTC-informational)
...
- **Медиана RTT**: 246 ms
- **Последнее обновление (UTC)**: 2026-04-20 17:20 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 13 · vless × 96 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 51 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 7
