...
![узлы](https://img.shields.io/badge/узлы-82-brightgreen) ![живые](https://img.shields.io/badge/живые-2049-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-353ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-01_19:23_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 16 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 82
- **Живых во всех источниках**: 2049
- **RTT самого быстрого узла**: 39 ms
- **Медиана RTT**: 353 ms
- **Последнее обновление (UTC)**: 2026-07-01 19:23 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 45 · trojan × 18 · vless × 12 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 3 · `surfboard-eternity` × 4
