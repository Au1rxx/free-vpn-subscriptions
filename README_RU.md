...
![узлы](https://img.shields.io/badge/узлы-77-brightgreen) ![живые](https://img.shields.io/badge/живые-1761-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-325ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-08_14:10_UTC-informational)
...
- **Выбрано узлов**: 77
- **Живых во всех источниках**: 1761
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 325 ms
- **Последнее обновление (UTC)**: 2026-06-08 14:10 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 42 · trojan × 17 · vless × 13 · vmess × 4

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 1 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 24 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 6
