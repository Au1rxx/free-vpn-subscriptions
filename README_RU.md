...
![узлы](https://img.shields.io/badge/узлы-115-brightgreen) ![живые](https://img.shields.io/badge/живые-1913-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-336ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_05:25_UTC-informational)
...
- **Выбрано узлов**: 115
- **Живых во всех источниках**: 1913
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 336 ms
- **Последнее обновление (UTC)**: 2026-07-14 05:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 22 · vless × 23 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 3 · `ninjastrikers` × 24 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
