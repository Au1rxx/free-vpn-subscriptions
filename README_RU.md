...
![узлы](https://img.shields.io/badge/узлы-79-brightgreen) ![живые](https://img.shields.io/badge/живые-2238-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-417ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-29_09:11_UTC-informational)
...
- **Выбрано узлов**: 79
- **Живых во всех источниках**: 2238
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 417 ms
- **Последнее обновление (UTC)**: 2026-06-29 09:11 UTC

**Распределение протоколов:** shadowsocks × 18 · trojan × 27 · vless × 19 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 2
