...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2476-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-108ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_06:30_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2476
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 108 ms
- **Последнее обновление (UTC)**: 2026-05-10 06:30 UTC

**Распределение протоколов:** shadowsocks × 45 · trojan × 3 · vless × 94 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 67 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
