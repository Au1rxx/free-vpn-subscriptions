...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2324-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-104ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-23_22:20_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 72 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2324
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 104 ms
- **Последнее обновление (UTC)**: 2026-05-23 22:20 UTC

**Распределение протоколов:** shadowsocks × 44 · trojan × 17 · vless × 63 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 43 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 6
