...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2474-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-116ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-16_23:36_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2474
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 116 ms
- **Последнее обновление (UTC)**: 2026-05-16 23:36 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 24 · vless × 76 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 6 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
