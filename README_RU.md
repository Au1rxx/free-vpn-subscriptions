...
![узлы](https://img.shields.io/badge/узлы-75-brightgreen) ![живые](https://img.shields.io/badge/живые-1965-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-174ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_09:34_UTC-informational)
...
- **Медиана RTT**: 174 ms
- **Последнее обновление (UTC)**: 2026-07-04 09:34 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 18 · vless × 8 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 5 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
