...
![узлы](https://img.shields.io/badge/узлы-98-brightgreen) ![живые](https://img.shields.io/badge/живые-1896-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-298ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-06_14:34_UTC-informational)
...
- **Медиана RTT**: 298 ms
- **Последнее обновление (UTC)**: 2026-07-06 14:34 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 36 · trojan × 26 · vless × 6 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 3
