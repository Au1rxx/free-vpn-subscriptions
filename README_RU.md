...
![узлы](https://img.shields.io/badge/узлы-86-brightgreen) ![живые](https://img.shields.io/badge/живые-2022-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-201ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-26_21:10_UTC-informational)
...
- **Медиана RTT**: 201 ms
- **Последнее обновление (UTC)**: 2026-06-26 21:10 UTC

**Распределение протоколов:** shadowsocks × 17 · trojan × 32 · vless × 17 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `ruking-clash` × 17
