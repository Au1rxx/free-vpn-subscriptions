...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2415-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-397ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-18_23:37_UTC-informational)
...
- **Медиана RTT**: 397 ms
- **Последнее обновление (UTC)**: 2026-07-18 23:37 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 38 · trojan × 98 · vless × 7 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 49 · `mahdibland-shadowsocks` × 41 · `matin-v2ray` × 3 · `ninjastrikers` × 6 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 7 · `surfboard-eternity` × 4
