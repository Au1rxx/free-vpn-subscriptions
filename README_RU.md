...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2314-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-309ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_15:24_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2314
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 309 ms
- **Последнее обновление (UTC)**: 2026-04-21 15:24 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 16 · vless × 87 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 46 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 56 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 9
