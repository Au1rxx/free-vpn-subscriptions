...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2540-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-96ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-25_11:37_UTC-informational)
...
- **Медиана RTT**: 96 ms
- **Последнее обновление (UTC)**: 2026-04-25 11:37 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 14 · vless × 98 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 3
