...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1904-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-310ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-07_23:23_UTC-informational)
...
- **Медиана RTT**: 310 ms
- **Последнее обновление (UTC)**: 2026-05-07 23:23 UTC

**Распределение протоколов:** shadowsocks × 51 · trojan × 22 · vless × 68 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 9
