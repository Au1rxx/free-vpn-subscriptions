...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2415-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-280ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_19:11_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2415
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 280 ms
- **Последнее обновление (UTC)**: 2026-05-10 19:11 UTC

**Распределение протоколов:** shadowsocks × 52 · trojan × 13 · vless × 75 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 9 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 57 · `pawdroid` × 4 · `ruking-clash` × 4 · `snakem982` × 5 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
