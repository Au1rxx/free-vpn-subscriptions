...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2168-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-278ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_11:36_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2168
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 278 ms
- **Последнее обновление (UTC)**: 2026-05-06 11:36 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 21 · vless × 81 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 67 · `surfboard-eternity` × 6
