...
![узлы](https://img.shields.io/badge/узлы-109-brightgreen) ![живые](https://img.shields.io/badge/живые-2069-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-212ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_14:31_UTC-informational)
...
- **Медиана RTT**: 212 ms
- **Последнее обновление (UTC)**: 2026-07-12 14:31 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 57 · trojan × 17 · vless × 21 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `mfuu-clash` × 6 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 4
