...
![узлы](https://img.shields.io/badge/узлы-88-brightgreen) ![живые](https://img.shields.io/badge/живые-2320-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-340ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-11_23:09_UTC-informational)
...
- **Выбрано узлов**: 88
- **Живых во всех источниках**: 2320
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 340 ms
- **Последнее обновление (UTC)**: 2026-06-11 23:09 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 18 · vless × 15 · vmess × 5

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 6 · `surfboard-eternity` × 6
