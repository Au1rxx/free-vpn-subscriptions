...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1647-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-400ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-15_12:30_UTC-informational)
...
| 🇯🇵 Japan (`JP`) | 17 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1647
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 400 ms
- **Последнее обновление (UTC)**: 2026-07-15 12:30 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 87 · trojan × 43 · vless × 11 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 20 · `mahdi0024` × 8 · `mahdibland-aggregator` × 35 · `mahdibland-shadowsocks` × 32 · `matin-v2ray` × 2 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 9 · `surfboard-eternity` × 2
