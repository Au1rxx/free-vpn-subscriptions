...
![узлы](https://img.shields.io/badge/узлы-110-brightgreen) ![живые](https://img.shields.io/badge/живые-1911-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-353ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-26_02:33_UTC-informational)
...
- **Медиана RTT**: 353 ms
- **Последнее обновление (UTC)**: 2026-06-26 02:33 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 38 · vless × 29 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 24 · `ruking-clash` × 17 · `surfboard-eternity` × 2
