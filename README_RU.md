...
![узлы](https://img.shields.io/badge/узлы-92-brightgreen) ![живые](https://img.shields.io/badge/живые-2021-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-380ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-26_16:36_UTC-informational)
...
- **Медиана RTT**: 380 ms
- **Последнее обновление (UTC)**: 2026-06-26 16:36 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 33 · vless × 17 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 17 · `surfboard-eternity` × 3
