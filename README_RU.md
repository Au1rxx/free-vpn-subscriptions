...
![узлы](https://img.shields.io/badge/узлы-109-brightgreen) ![живые](https://img.shields.io/badge/живые-1889-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-359ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-06_11:27_UTC-informational)
...
- **Медиана RTT**: 359 ms
- **Последнее обновление (UTC)**: 2026-07-06 11:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 11 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 6 · `ninjastrikers` × 12 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 5
