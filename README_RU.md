...
![узлы](https://img.shields.io/badge/узлы-68-brightgreen) ![живые](https://img.shields.io/badge/живые-1993-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-169ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_12:25_UTC-informational)
...
- **Медиана RTT**: 169 ms
- **Последнее обновление (UTC)**: 2026-07-04 12:25 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 21 · vless × 8 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 13 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 2
