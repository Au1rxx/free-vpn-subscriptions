...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2076-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-226ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-07_15:32_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2076
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 226 ms
- **Последнее обновление (UTC)**: 2026-05-07 15:32 UTC

**Распределение протоколов:** shadowsocks × 56 · trojan × 11 · vless × 77 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 62 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
