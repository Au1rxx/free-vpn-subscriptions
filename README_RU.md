...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2373-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-120ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-12_17:19_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2373
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 120 ms
- **Последнее обновление (UTC)**: 2026-05-12 17:19 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 14 · vless × 84 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 41 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
