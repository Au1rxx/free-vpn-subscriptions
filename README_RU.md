...
![узлы](https://img.shields.io/badge/узлы-78-brightgreen) ![живые](https://img.shields.io/badge/живые-2066-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-172ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-29_07:19_UTC-informational)
...
- **Выбрано узлов**: 78
- **Живых во всех источниках**: 2066
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 172 ms
- **Последнее обновление (UTC)**: 2026-05-29 07:19 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 32 · vless × 15 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
