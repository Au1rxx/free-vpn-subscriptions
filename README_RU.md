...
![узлы](https://img.shields.io/badge/узлы-97-brightgreen) ![живые](https://img.shields.io/badge/живые-1930-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-341ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-16_18:34_UTC-informational)
...
- **Медиана RTT**: 341 ms
- **Последнее обновление (UTC)**: 2026-06-16 18:34 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 47 · trojan × 21 · vless × 17 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 11 · `surfboard-eternity` × 4
