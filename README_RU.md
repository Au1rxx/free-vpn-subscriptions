...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2469-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-154ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_18:37_UTC-informational)
...
- **Медиана RTT**: 154 ms
- **Последнее обновление (UTC)**: 2026-04-27 18:37 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 21 · vless × 90 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 27 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
