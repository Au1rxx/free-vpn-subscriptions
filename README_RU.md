...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2474-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-161ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_13:12_UTC-informational)
...
- **Медиана RTT**: 161 ms
- **Последнее обновление (UTC)**: 2026-05-10 13:12 UTC

**Распределение протоколов:** shadowsocks × 48 · trojan × 16 · vless × 78 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 62 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
