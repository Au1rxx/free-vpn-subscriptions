...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2273-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-159ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_08:34_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2273
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 159 ms
- **Последнее обновление (UTC)**: 2026-04-22 08:34 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 4 · vless × 103 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 42 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 6
