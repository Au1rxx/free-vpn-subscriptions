...
![узлы](https://img.shields.io/badge/узлы-99-brightgreen) ![живые](https://img.shields.io/badge/живые-1945-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-285ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_12:36_UTC-informational)
...
- **Выбрано узлов**: 99
- **Живых во всех источниках**: 1945
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 285 ms
- **Последнее обновление (UTC)**: 2026-07-12 12:36 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 17 · vless × 12 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 1
