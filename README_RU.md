...
![узлы](https://img.shields.io/badge/узлы-147-brightgreen) ![живые](https://img.shields.io/badge/живые-2281-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-435ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_21:31_UTC-informational)
...
- **Выбрано узлов**: 147
- **Живых во всех источниках**: 2281
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 435 ms
- **Последнее обновление (UTC)**: 2026-04-21 21:31 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 23 · vless × 80 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 46 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 5
