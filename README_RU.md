...
![узлы](https://img.shields.io/badge/узлы-84-brightgreen) ![живые](https://img.shields.io/badge/живые-1948-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-177ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-03_08:32_UTC-informational)
...
- **Медиана RTT**: 177 ms
- **Последнее обновление (UTC)**: 2026-07-03 08:32 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 20 · vless × 13 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 3
