...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2020-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-398ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-16_10:30_UTC-informational)
...
- **Медиана RTT**: 398 ms
- **Последнее обновление (UTC)**: 2026-07-16 10:30 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 44 · trojan × 73 · vless × 22 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `mahdi0024` × 18 · `mahdibland-aggregator` × 34 · `mahdibland-shadowsocks` × 46 · `matin-v2ray` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 11 · `surfboard-eternity` × 3
