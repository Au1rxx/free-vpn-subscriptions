...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2266-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-112ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-03_11:15_UTC-informational)
...
- **Медиана RTT**: 112 ms
- **Последнее обновление (UTC)**: 2026-05-03 11:15 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 15 · vless × 99 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 61 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
