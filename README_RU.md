...
![узлы](https://img.shields.io/badge/узлы-138-brightgreen) ![живые](https://img.shields.io/badge/живые-1815-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-387ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-15_19:09_UTC-informational)
...
| 🇯🇵 Japan (`JP`) | 18 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Выбрано узлов**: 138
- **Живых во всех источниках**: 1815
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 387 ms
- **Последнее обновление (UTC)**: 2026-07-15 19:09 UTC

**Распределение протоколов:** hysteria2 × 3 · shadowsocks × 72 · trojan × 34 · vless × 19 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `mahdi0024` × 23 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 3 · `ninjastrikers` × 15 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 3
