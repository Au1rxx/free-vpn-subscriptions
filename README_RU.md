...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2083-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-157ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-01_19:27_UTC-informational)
...
- **Медиана RTT**: 157 ms
- **Последнее обновление (UTC)**: 2026-05-01 19:27 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 19 · vless × 77 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 49 · `pawdroid` × 3 · `surfboard-eternity` × 7
