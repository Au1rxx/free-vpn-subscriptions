...
![узлы](https://img.shields.io/badge/узлы-63-brightgreen) ![живые](https://img.shields.io/badge/живые-1954-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-275ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_22:19_UTC-informational)
...
- **Медиана RTT**: 275 ms
- **Последнее обновление (UTC)**: 2026-06-30 22:19 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 29 · vless × 6 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `mfuu-clash` × 8 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 5
