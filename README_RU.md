...
![узлы](https://img.shields.io/badge/узлы-144-brightgreen) ![живые](https://img.shields.io/badge/живые-2125-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-164ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-28_23:24_UTC-informational)
...
- **Выбрано узлов**: 144
- **Живых во всех источниках**: 2125
- **RTT самого быстрого узла**: 38 ms
- **Медиана RTT**: 164 ms
- **Последнее обновление (UTC)**: 2026-04-28 23:24 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 22 · vless × 78 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 39 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 7 · `ninjastrikers` × 55 · `ruking-clash` × 1 · `surfboard-eternity` × 6
