...
![узлы](https://img.shields.io/badge/узлы-101-brightgreen) ![живые](https://img.shields.io/badge/живые-1900-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-307ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-11_15:39_UTC-informational)
...
- **Медиана RTT**: 307 ms
- **Последнее обновление (UTC)**: 2026-07-11 15:39 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 53 · trojan × 14 · vless × 15 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 25 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 3 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 4
