...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2527-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-85ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_07:27_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2527
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 85 ms
- **Последнее обновление (UTC)**: 2026-04-27 07:27 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 3 · vless × 101 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 43 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 4 · `surfboard-eternity` × 6
