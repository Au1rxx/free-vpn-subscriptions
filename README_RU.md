...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2608-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-155ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_00:36_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2608
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 155 ms
- **Последнее обновление (UTC)**: 2026-04-23 00:36 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 14 · vless × 96 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 74 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
