...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2222-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-107ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-30_07:22_UTC-informational)
...
- **Медиана RTT**: 107 ms
- **Последнее обновление (UTC)**: 2026-04-30 07:22 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 17 · vless × 90 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 7 · `ninjastrikers` × 67 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
