...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2284-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-66ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-19_09:31_UTC-informational)
...
- **Медиана RTT**: 66 ms
- **Последнее обновление (UTC)**: 2026-05-19 09:31 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 17 · trojan × 27 · vless × 88 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 61 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 4
