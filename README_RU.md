...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2567-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-156ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_21:20_UTC-informational)
...
- **Медиана RTT**: 156 ms
- **Последнее обновление (UTC)**: 2026-04-26 21:20 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 22 · vless × 80 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 42 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 3 · `ninjastrikers` × 50 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
