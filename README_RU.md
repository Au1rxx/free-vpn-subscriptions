...
![узлы](https://img.shields.io/badge/узлы-110-brightgreen) ![живые](https://img.shields.io/badge/живые-1975-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-283ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_09:20_UTC-informational)
...
- **Медиана RTT**: 283 ms
- **Последнее обновление (UTC)**: 2026-07-12 09:20 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 53 · trojan × 17 · vless × 21 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 17 · `pawdroid` × 10 · `snakem982` × 1 · `surfboard-eternity` × 5
