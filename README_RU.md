...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2354-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-87ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-24_02:33_UTC-informational)
...
- **Медиана RTT**: 87 ms
- **Последнее обновление (UTC)**: 2026-05-24 02:33 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 3 · vless × 85 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 57 · `pawdroid` × 4 · `surfboard-eternity` × 7
