...
![узлы](https://img.shields.io/badge/узлы-96-brightgreen) ![живые](https://img.shields.io/badge/живые-1899-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-158ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-04_19:39_UTC-informational)
...
- **Выбрано узлов**: 96
- **Живых во всех источниках**: 1899
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 158 ms
- **Последнее обновление (UTC)**: 2026-06-04 19:39 UTC

**Распределение протоколов:** shadowsocks × 20 · trojan × 47 · vless × 19 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `ruking-clash` × 4 · `surfboard-eternity` × 2
