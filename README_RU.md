...
![узлы](https://img.shields.io/badge/узлы-123-brightgreen) ![живые](https://img.shields.io/badge/живые-1819-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-312ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_06:16_UTC-informational)
...
- **Медиана RTT**: 312 ms
- **Последнее обновление (UTC)**: 2026-07-08 06:16 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 55 · trojan × 28 · vless × 21 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 6 · `ninjastrikers` × 26 · `pawdroid` × 9 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 1
