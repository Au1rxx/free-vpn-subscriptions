...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2069-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-123ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-29_09:31_UTC-informational)
...
- **Медиана RTT**: 123 ms
- **Последнее обновление (UTC)**: 2026-04-29 09:31 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 4 · vless × 95 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 10
