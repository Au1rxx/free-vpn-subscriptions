...
![узлы](https://img.shields.io/badge/узлы-93-brightgreen) ![живые](https://img.shields.io/badge/живые-2275-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-182ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-20_09:12_UTC-informational)
...
- **Выбрано узлов**: 93
- **Живых во всех источниках**: 2275
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 182 ms
- **Последнее обновление (UTC)**: 2026-06-20 09:12 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 28 · vless × 13 · vmess × 30

**Источники в этом запуске:** `barry-far-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 5
