...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1896-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-418ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-17_05:32_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 87 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1896
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 418 ms
- **Последнее обновление (UTC)**: 2026-06-17 05:32 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 44 · trojan × 13 · vless × 20 · vmess × 72

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 74 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 18 · `ruking-clash` × 3 · `surfboard-eternity` × 3
