...
![узлы](https://img.shields.io/badge/узлы-89-brightgreen) ![живые](https://img.shields.io/badge/живые-1872-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-161ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-03_07:34_UTC-informational)
...
- **Выбрано узлов**: 89
- **Живых во всех источниках**: 1872
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 161 ms
- **Последнее обновление (UTC)**: 2026-07-03 07:34 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 21 · vless × 16 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 5 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
