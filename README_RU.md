...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2361-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-95ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-25_01:09_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2361
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 95 ms
- **Последнее обновление (UTC)**: 2026-05-25 01:09 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 2 · vless × 81 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 48 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 66 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 3
