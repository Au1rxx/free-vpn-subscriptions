...
![узлы](https://img.shields.io/badge/узлы-120-brightgreen) ![живые](https://img.shields.io/badge/живые-1805-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-347ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_03:23_UTC-informational)
...
- **Выбрано узлов**: 120
- **Живых во всех источниках**: 1805
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 347 ms
- **Последнее обновление (UTC)**: 2026-07-08 03:23 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 55 · trojan × 29 · vless × 18 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 7 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 3
