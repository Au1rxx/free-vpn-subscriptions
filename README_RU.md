...
![узлы](https://img.shields.io/badge/узлы-84-brightgreen) ![живые](https://img.shields.io/badge/живые-1983-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-175ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-03_18:14_UTC-informational)
...
- **Медиана RTT**: 175 ms
- **Последнее обновление (UTC)**: 2026-07-03 18:14 UTC

**Распределение протоколов:** shadowsocks × 24 · trojan × 24 · vless × 14 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 11 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
