...
![узлы](https://img.shields.io/badge/узлы-140-brightgreen) ![живые](https://img.shields.io/badge/живые-2308-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-290ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_19:19_UTC-informational)
...
- **Выбрано узлов**: 140
- **Живых во всех источниках**: 2308
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 290 ms
- **Последнее обновление (UTC)**: 2026-04-21 19:19 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 24 · vless × 71 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 37 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 1 · `ruking-clash` × 7 · `snakem982` × 2 · `surfboard-eternity` × 5
