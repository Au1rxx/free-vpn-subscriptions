...
![узлы](https://img.shields.io/badge/узлы-95-brightgreen) ![живые](https://img.shields.io/badge/живые-2033-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-145ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_03:12_UTC-informational)
...
- **Медиана RTT**: 145 ms
- **Последнее обновление (UTC)**: 2026-05-28 03:12 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 26 · vless × 34 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 26 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 2
