...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2136-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-90ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_02:27_UTC-informational)
...
- **Медиана RTT**: 90 ms
- **Последнее обновление (UTC)**: 2026-04-26 02:27 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 7 · vless × 97 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 31 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 1 · `surfboard-eternity` × 6
