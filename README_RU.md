...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2552-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-72ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-16_09:33_UTC-informational)
...
- **Медиана RTT**: 72 ms
- **Последнее обновление (UTC)**: 2026-05-16 09:33 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 8 · vless × 102 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 8 · `ruking-clash` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
