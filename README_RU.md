...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2402-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-375ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-19_02:17_UTC-informational)
...
|---|---|---|---|---|
| 🇯🇵 Japan (`JP`) | 75 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2402
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 375 ms
- **Последнее обновление (UTC)**: 2026-07-19 02:17 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 36 · trojan × 92 · vless × 16 · vmess × 5

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `mahdi0024` × 35 · `mahdibland-aggregator` × 34 · `mahdibland-shadowsocks` × 38 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 10 · `surfboard-eternity` × 7
