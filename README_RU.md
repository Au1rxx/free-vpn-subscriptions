...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2542-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-165ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_08:37_UTC-informational)
...
- **Медиана RTT**: 165 ms
- **Последнее обновление (UTC)**: 2026-04-23 08:37 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 20 · vless × 93 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 73 · `pawdroid` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
