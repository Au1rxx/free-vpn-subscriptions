...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-2025-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-331ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-02_05:18_UTC-informational)
...
- **Выбрано узлов**: 114
- **Живых во всех источниках**: 2025
- **RTT самого быстрого узла**: 40 ms
- **Медиана RTT**: 331 ms
- **Последнее обновление (UTC)**: 2026-07-02 05:18 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 47 · trojan × 35 · vless × 21 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 25 · `pawdroid` × 4 · `surfboard-eternity` × 1
