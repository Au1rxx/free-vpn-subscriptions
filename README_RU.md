...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2223-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-115ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_03:40_UTC-informational)
...
- **Медиана RTT**: 115 ms
- **Последнее обновление (UTC)**: 2026-04-21 03:40 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 3 · vless × 101 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 47 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 3 · `ninjastrikers` × 52 · `ruking-clash` × 10 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
