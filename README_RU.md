...
![узлы](https://img.shields.io/badge/узлы-97-brightgreen) ![живые](https://img.shields.io/badge/живые-2320-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-170ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_03:11_UTC-informational)
...
- **Медиана RTT**: 170 ms
- **Последнее обновление (UTC)**: 2026-06-10 03:11 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 14 · vless × 25 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 24 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 6
