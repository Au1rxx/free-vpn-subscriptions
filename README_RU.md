...
![узлы](https://img.shields.io/badge/узлы-149-brightgreen) ![живые](https://img.shields.io/badge/живые-2174-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-400ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-16_18:18_UTC-informational)
...
- **Медиана RTT**: 400 ms
- **Последнее обновление (UTC)**: 2026-07-16 18:18 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 79 · vless × 9 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `mahdi0024` × 51 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 33 · `matin-v2ray` × 5 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 4
