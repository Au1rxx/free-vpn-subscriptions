...
![узлы](https://img.shields.io/badge/узлы-119-brightgreen) ![живые](https://img.shields.io/badge/живые-1875-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-284ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_07:35_UTC-informational)
...
- **Медиана RTT**: 284 ms
- **Последнее обновление (UTC)**: 2026-07-12 07:35 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 51 · trojan × 23 · vless × 25 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 1 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 9 · `ninjastrikers` × 20 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 7
