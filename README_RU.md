...
![узлы](https://img.shields.io/badge/узлы-109-brightgreen) ![живые](https://img.shields.io/badge/живые-1985-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-341ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_21:19_UTC-informational)
...
- **Выбрано узлов**: 109
- **Живых во всех источниках**: 1985
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 341 ms
- **Последнее обновление (UTC)**: 2026-07-04 21:19 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 52 · trojan × 23 · vless × 7 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 37 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 5 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
