...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2382-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-96ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-23_16:10_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2382
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 96 ms
- **Последнее обновление (UTC)**: 2026-05-23 16:10 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 18 · vless × 69 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 40 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 5 · `surfboard-eternity` × 2
