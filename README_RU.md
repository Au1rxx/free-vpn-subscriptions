...
![узлы](https://img.shields.io/badge/узлы-71-brightgreen) ![живые](https://img.shields.io/badge/живые-2407-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-148ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-02_15:33_UTC-informational)
...
- **Медиана RTT**: 148 ms
- **Последнее обновление (UTC)**: 2026-07-02 15:33 UTC

**Распределение протоколов:** shadowsocks × 20 · trojan × 16 · vless × 20 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 8 · `ninjastrikers` × 13 · `pawdroid` × 11 · `surfboard-eternity` × 2
