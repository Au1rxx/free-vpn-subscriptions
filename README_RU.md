...
![узлы](https://img.shields.io/badge/узлы-78-brightgreen) ![живые](https://img.shields.io/badge/живые-2420-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-164ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-01_15:20_UTC-informational)
...
- **Выбрано узлов**: 78
- **Живых во всех источниках**: 2420
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 164 ms
- **Последнее обновление (UTC)**: 2026-06-01 15:20 UTC

**Распределение протоколов:** shadowsocks × 15 · trojan × 26 · vless × 7 · vmess × 30

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 9 · `pawdroid` × 5 · `surfboard-eternity` × 2
