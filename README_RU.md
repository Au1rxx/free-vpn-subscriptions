...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2039-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-73ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-22_13:15_UTC-informational)
...
- **Медиана RTT**: 73 ms
- **Последнее обновление (UTC)**: 2026-05-22 13:15 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 13 · vless × 87 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 63 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
