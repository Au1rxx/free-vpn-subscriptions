...
![узлы](https://img.shields.io/badge/узлы-105-brightgreen) ![живые](https://img.shields.io/badge/живые-1888-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-328ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-11_14:27_UTC-informational)
...
- **Медиана RTT**: 328 ms
- **Последнее обновление (UTC)**: 2026-07-11 14:27 UTC

**Распределение протоколов:** shadowsocks × 53 · trojan × 16 · vless × 17 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 27 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 4 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 2
