...
![узлы](https://img.shields.io/badge/узлы-100-brightgreen) ![живые](https://img.shields.io/badge/живые-2033-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-103ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_00:19_UTC-informational)
...
- **Выбрано узлов**: 100
- **Живых во всех источниках**: 2033
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 103 ms
- **Последнее обновление (UTC)**: 2026-05-28 00:19 UTC

**Распределение протоколов:** shadowsocks × 24 · trojan × 26 · vless × 42 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 32 · `pawdroid` × 6 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 2
