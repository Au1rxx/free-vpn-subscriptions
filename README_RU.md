...
![узлы](https://img.shields.io/badge/узлы-84-brightgreen) ![живые](https://img.shields.io/badge/живые-2253-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-168ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_07:21_UTC-informational)
...
- **Медиана RTT**: 168 ms
- **Последнее обновление (UTC)**: 2026-06-07 07:21 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 20 · vless × 12 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 1
