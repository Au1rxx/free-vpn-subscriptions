...
![узлы](https://img.shields.io/badge/узлы-86-brightgreen) ![живые](https://img.shields.io/badge/живые-2173-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-169ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_10:23_UTC-informational)
...
- **Выбрано узлов**: 86
- **Живых во всех источниках**: 2173
- **RTT самого быстрого узла**: 23 ms
- **Медиана RTT**: 169 ms
- **Последнее обновление (UTC)**: 2026-06-07 10:23 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 21 · vless × 11 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
