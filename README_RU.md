...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2647-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-102ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-25_02:24_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2647
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 102 ms
- **Последнее обновление (UTC)**: 2026-04-25 02:24 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 9 · vless × 106 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 67 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2 · `vxiaov-clash` × 1
