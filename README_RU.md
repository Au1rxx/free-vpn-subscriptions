...
![узлы](https://img.shields.io/badge/узлы-96-brightgreen) ![живые](https://img.shields.io/badge/живые-1844-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-374ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_08:38_UTC-informational)
...
- **Выбрано узлов**: 96
- **Живых во всех источниках**: 1844
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 374 ms
- **Последнее обновление (UTC)**: 2026-06-30 08:38 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 35 · trojan × 41 · vless × 10 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 12
