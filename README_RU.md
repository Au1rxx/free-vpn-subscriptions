...
![узлы](https://img.shields.io/badge/узлы-108-brightgreen) ![живые](https://img.shields.io/badge/живые-1905-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-356ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_06:10_UTC-informational)
...
- **Медиана RTT**: 356 ms
- **Последнее обновление (UTC)**: 2026-07-14 06:10 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 41 · trojan × 20 · vless × 18 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 4 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 5
