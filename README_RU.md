...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2642-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-84ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-25_06:30_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2642
- **RTT самого быстрого узла**: 23 ms
- **Медиана RTT**: 84 ms
- **Последнее обновление (UTC)**: 2026-04-25 06:30 UTC

**Распределение протоколов:** shadowsocks × 25 · trojan × 8 · vless × 108 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 68 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
