...
![узлы](https://img.shields.io/badge/узлы-87-brightgreen) ![живые](https://img.shields.io/badge/живые-2203-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-265ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-11_08:28_UTC-informational)
...
| 🇭🇰 Hong Kong (`HK`) | 4 | [clash-HK.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-HK.yaml) | [singbox-HK.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-HK.json) | [v2ray-base64-HK.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-HK.txt) |
...
- **Выбрано узлов**: 87
- **Живых во всех источниках**: 2203
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 265 ms
- **Последнее обновление (UTC)**: 2026-06-11 08:28 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 11 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 6
