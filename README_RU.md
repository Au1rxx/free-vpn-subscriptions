...
![узлы](https://img.shields.io/badge/узлы-88-brightgreen) ![живые](https://img.shields.io/badge/живые-2045-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-344ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-01_20:36_UTC-informational)
...
- **Выбрано узлов**: 88
- **Живых во всех источниках**: 2045
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 344 ms
- **Последнее обновление (UTC)**: 2026-07-01 20:36 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 47 · trojan × 22 · vless × 11 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 5 · `ninjastrikers` × 17 · `surfboard-eternity` × 4
