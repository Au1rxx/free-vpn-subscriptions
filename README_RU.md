...
![узлы](https://img.shields.io/badge/узлы-115-brightgreen) ![живые](https://img.shields.io/badge/живые-1983-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-373ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-12_23:25_UTC-informational)
...
- **Выбрано узлов**: 115
- **Живых во всех источниках**: 1983
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 373 ms
- **Последнее обновление (UTC)**: 2026-06-12 23:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 53 · trojan × 44 · vless × 11 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 33 · `lagzian-mix` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 7
