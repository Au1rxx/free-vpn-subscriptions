...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2191-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-92ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-02_08:10_UTC-informational)
...
- **Медиана RTT**: 92 ms
- **Последнее обновление (UTC)**: 2026-05-02 08:10 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 8 · vless × 96 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 64 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7
