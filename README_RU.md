...
![узлы](https://img.shields.io/badge/узлы-147-brightgreen) ![живые](https://img.shields.io/badge/живые-2216-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-293ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-04_18:10_UTC-informational)
...
- **Медиана RTT**: 293 ms
- **Последнее обновление (UTC)**: 2026-05-04 18:10 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 23 · vless × 74 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 3 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
