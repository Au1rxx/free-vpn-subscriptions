...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2299-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-399ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-18_09:27_UTC-informational)
...
|---|---|---|---|---|
| 🇯🇵 Japan (`JP`) | 100 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2299
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 399 ms
- **Последнее обновление (UTC)**: 2026-07-18 09:27 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 103 · vless × 9 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `mahdi0024` × 61 · `mahdibland-aggregator` × 31 · `mahdibland-shadowsocks` × 35 · `matin-v2ray` × 2 · `ninjastrikers` × 3 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
