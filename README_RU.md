...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2229-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-117ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-30_09:25_UTC-informational)
...
- **Медиана RTT**: 117 ms
- **Последнее обновление (UTC)**: 2026-04-30 09:25 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 18 · vless × 90 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 66 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 9
