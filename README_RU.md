...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2466-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-79ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-25_11:23_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2466
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 79 ms
- **Последнее обновление (UTC)**: 2026-05-25 11:23 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 17 · vless × 64 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 50 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 6 · `ruking-clash` × 6 · `surfboard-eternity` × 4
