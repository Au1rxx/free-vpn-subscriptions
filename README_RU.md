...
![узлы](https://img.shields.io/badge/узлы-130-brightgreen) ![живые](https://img.shields.io/badge/живые-2005-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-469ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-23_21:23_UTC-informational)
...
- **Выбрано узлов**: 130
- **Живых во всех источниках**: 2005
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 469 ms
- **Последнее обновление (UTC)**: 2026-06-23 21:23 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 38 · trojan × 30 · vless × 45 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 45 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
