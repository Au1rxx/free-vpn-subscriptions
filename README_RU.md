...
![узлы](https://img.shields.io/badge/узлы-84-brightgreen) ![живые](https://img.shields.io/badge/живые-1932-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-231ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-06_15:30_UTC-informational)
...
- **Медиана RTT**: 231 ms
- **Последнее обновление (UTC)**: 2026-07-06 15:30 UTC

**Распределение протоколов:** shadowsocks × 20 · trojan × 29 · vless × 6 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 5
