...
![узлы](https://img.shields.io/badge/узлы-97-brightgreen) ![живые](https://img.shields.io/badge/живые-1830-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-354ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_16:14_UTC-informational)
...
- **Выбрано узлов**: 97
- **Живых во всех источниках**: 1830
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 354 ms
- **Последнее обновление (UTC)**: 2026-06-07 16:14 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 54 · trojan × 20 · vless × 15 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 22 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
