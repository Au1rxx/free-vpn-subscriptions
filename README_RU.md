...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2025-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-145ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-07_01:31_UTC-informational)
...
- **Медиана RTT**: 145 ms
- **Последнее обновление (UTC)**: 2026-05-07 01:31 UTC

**Распределение протоколов:** shadowsocks × 50 · trojan × 4 · vless × 84 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
