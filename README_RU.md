...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2186-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-162ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_11:16_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2186
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 162 ms
- **Последнее обновление (UTC)**: 2026-04-21 11:16 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 3 · vless × 106 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 54 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 52 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 6
