...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2446-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-98ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-24_00:29_UTC-informational)
...
- **Медиана RTT**: 98 ms
- **Последнее обновление (UTC)**: 2026-04-24 00:29 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 11 · vless × 105 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 6
