...
![узлы](https://img.shields.io/badge/узлы-109-brightgreen) ![живые](https://img.shields.io/badge/живые-2254-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-381ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-01_11:29_UTC-informational)
...
- **Выбрано узлов**: 109
- **Живых во всех источниках**: 2254
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 381 ms
- **Последнее обновление (UTC)**: 2026-07-01 11:29 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 54 · trojan × 36 · vless × 10 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 19 · `mfuu-clash` × 9 · `ninjastrikers` × 19 · `pawdroid` × 6 · `surfboard-eternity` × 3
