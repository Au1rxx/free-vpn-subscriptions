...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2228-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-142ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_01:28_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2228
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 142 ms
- **Последнее обновление (UTC)**: 2026-05-06 01:28 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 15 · vless × 89 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 79 · `pawdroid` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
