...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2115-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-132ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-29_12:39_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2115
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 132 ms
- **Последнее обновление (UTC)**: 2026-04-29 12:39 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 10 · vless × 89 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 60 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
