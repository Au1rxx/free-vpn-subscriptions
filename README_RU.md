...
![узлы](https://img.shields.io/badge/узлы-88-brightgreen) ![живые](https://img.shields.io/badge/живые-2089-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-153ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-10_04:20_UTC-informational)
...
- **Медиана RTT**: 153 ms
- **Последнее обновление (UTC)**: 2026-07-10 04:20 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 10 · vless × 18 · vmess × 32

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 5 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6
