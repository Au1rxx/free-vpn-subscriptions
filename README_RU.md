...
![узлы](https://img.shields.io/badge/узлы-86-brightgreen) ![живые](https://img.shields.io/badge/живые-1885-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-359ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_20:19_UTC-informational)
...
- **Выбрано узлов**: 86
- **Живых во всех источниках**: 1885
- **RTT самого быстрого узла**: 22 ms
- **Медиана RTT**: 359 ms
- **Последнее обновление (UTC)**: 2026-06-07 20:19 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 46 · trojan × 19 · vless × 13 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
