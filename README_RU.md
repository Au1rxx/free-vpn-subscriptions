...
![узлы](https://img.shields.io/badge/узлы-115-brightgreen) ![живые](https://img.shields.io/badge/живые-2038-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-187ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_05:34_UTC-informational)
...
- **Выбрано узлов**: 115
- **Живых во всех источниках**: 2038
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 187 ms
- **Последнее обновление (UTC)**: 2026-07-13 05:34 UTC

**Распределение протоколов:** shadowsocks × 55 · trojan × 17 · vless × 30 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 10 · `mahdi0024` × 29 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 3
