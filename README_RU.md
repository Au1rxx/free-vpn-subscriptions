...
![узлы](https://img.shields.io/badge/узлы-146-brightgreen) ![живые](https://img.shields.io/badge/живые-2081-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-176ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-29_18:35_UTC-informational)
...
- **Медиана RTT**: 176 ms
- **Последнее обновление (UTC)**: 2026-04-29 18:35 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 16 · vless × 78 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 58 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
