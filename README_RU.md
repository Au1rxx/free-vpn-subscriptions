...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-1801-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-366ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_11:24_UTC-informational)
...
- **Медиана RTT**: 366 ms
- **Последнее обновление (UTC)**: 2026-07-08 11:24 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 62 · trojan × 23 · vless × 13 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 17 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 8 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
