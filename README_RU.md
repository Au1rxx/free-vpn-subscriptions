...
![узлы](https://img.shields.io/badge/узлы-85-brightgreen) ![живые](https://img.shields.io/badge/живые-2142-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-170ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-30_13:11_UTC-informational)
...
- **Выбрано узлов**: 85
- **Живых во всех источниках**: 2142
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 170 ms
- **Последнее обновление (UTC)**: 2026-05-30 13:11 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 24 · vless × 9 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 29 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 3 · `surfboard-eternity` × 5
