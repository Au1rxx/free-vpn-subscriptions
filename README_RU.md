...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2148-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-120ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-01_15:35_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2148
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 120 ms
- **Последнее обновление (UTC)**: 2026-05-01 15:35 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 10 · vless × 88 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
