...
![узлы](https://img.shields.io/badge/узлы-113-brightgreen) ![живые](https://img.shields.io/badge/живые-2117-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-277ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-25_07:12_UTC-informational)
...
- **Выбрано узлов**: 113
- **Живых во всех источниках**: 2117
- **RTT самого быстрого узла**: 26 ms
- **Медиана RTT**: 277 ms
- **Последнее обновление (UTC)**: 2026-06-25 07:12 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 33 · vless × 38 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 32 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 6
