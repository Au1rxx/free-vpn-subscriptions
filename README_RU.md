...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2354-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-89ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-22_16:18_UTC-informational)
...
- **Медиана RTT**: 89 ms
- **Последнее обновление (UTC)**: 2026-05-22 16:18 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 16 · vless × 87 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 25 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 64 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 4
