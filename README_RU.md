...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2222-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-126ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-30_08:25_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2222
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 126 ms
- **Последнее обновление (UTC)**: 2026-04-30 08:25 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 19 · vless × 92 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 71 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
