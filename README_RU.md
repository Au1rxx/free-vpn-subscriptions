...
![узлы](https://img.shields.io/badge/узлы-69-brightgreen) ![живые](https://img.shields.io/badge/живые-2000-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-175ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_11:13_UTC-informational)
...
- **Медиана RTT**: 175 ms
- **Последнее обновление (UTC)**: 2026-07-04 11:13 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 15 · vless × 6 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 5 · `ninjastrikers` × 6 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
