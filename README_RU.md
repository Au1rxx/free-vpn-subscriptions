...
![узлы](https://img.shields.io/badge/узлы-90-brightgreen) ![живые](https://img.shields.io/badge/живые-2116-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-160ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-09_16:37_UTC-informational)
...
- **Медиана RTT**: 160 ms
- **Последнее обновление (UTC)**: 2026-07-09 16:37 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 9 · vless × 22 · vmess × 32

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 5 · `ninjastrikers` × 11 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 3
