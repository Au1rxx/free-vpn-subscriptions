...
![узлы](https://img.shields.io/badge/узлы-102-brightgreen) ![живые](https://img.shields.io/badge/живые-2196-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-194ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-11_04:29_UTC-informational)
...
- **Медиана RTT**: 194 ms
- **Последнее обновление (UTC)**: 2026-06-11 04:29 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 19 · vless × 25 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 27 · `pawdroid` × 5 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
