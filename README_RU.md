...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2175-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-90ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-01_10:11_UTC-informational)
...
- **Медиана RTT**: 90 ms
- **Последнее обновление (UTC)**: 2026-05-01 10:11 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 6 · vless × 90 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `surfboard-eternity` × 5
