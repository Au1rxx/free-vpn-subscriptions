...
![узлы](https://img.shields.io/badge/узлы-98-brightgreen) ![живые](https://img.shields.io/badge/живые-1888-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-351ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-13_08:37_UTC-informational)
...
- **Медиана RTT**: 351 ms
- **Последнее обновление (UTC)**: 2026-06-13 08:37 UTC

**Распределение протоколов:** shadowsocks × 49 · trojan × 25 · vless × 16 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 11 · `surfboard-eternity` × 3
