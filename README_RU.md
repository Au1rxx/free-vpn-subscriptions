...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2655-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-105ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-25_01:14_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2655
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 105 ms
- **Последнее обновление (UTC)**: 2026-04-25 01:14 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 9 · vless × 106 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 34 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 5
