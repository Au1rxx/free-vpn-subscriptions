...
![узлы](https://img.shields.io/badge/узлы-128-brightgreen) ![живые](https://img.shields.io/badge/живые-1796-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-367ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-09_08:31_UTC-informational)
...
- **Выбрано узлов**: 128
- **Живых во всех источниках**: 1796
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 367 ms
- **Последнее обновление (UTC)**: 2026-07-09 08:31 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 62 · trojan × 23 · vless × 16 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `epodonios` × 15 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 8 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 4
