...
![узлы](https://img.shields.io/badge/узлы-131-brightgreen) ![живые](https://img.shields.io/badge/живые-2100-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-474ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-20_20:31_UTC-informational)
...
- **Выбрано узлов**: 131
- **Живых во всех источниках**: 2100
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 474 ms
- **Последнее обновление (UTC)**: 2026-06-20 20:31 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 34 · vless × 32 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 38 · `surfboard-eternity` × 3
