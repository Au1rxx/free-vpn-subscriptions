...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2213-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-155ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_04:29_UTC-informational)
...
- **Медиана RTT**: 155 ms
- **Последнее обновление (UTC)**: 2026-05-06 04:29 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 21 · vless × 84 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 75 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
