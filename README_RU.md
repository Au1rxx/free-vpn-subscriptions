...
![узлы](https://img.shields.io/badge/узлы-105-brightgreen) ![живые](https://img.shields.io/badge/живые-1915-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-439ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-12_15:26_UTC-informational)
...
- **Медиана RTT**: 439 ms
- **Последнее обновление (UTC)**: 2026-06-12 15:26 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 45 · trojan × 39 · vless × 12 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 3
