...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2064-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-165ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-29_15:11_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2064
- **RTT самого быстрого узла**: 38 ms
- **Медиана RTT**: 165 ms
- **Последнее обновление (UTC)**: 2026-04-29 15:11 UTC

**Распределение протоколов:** shadowsocks × 45 · trojan × 8 · vless × 87 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 40 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
