...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2662-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-89ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-18_01:16_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2662
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 89 ms
- **Последнее обновление (UTC)**: 2026-05-18 01:16 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 43 · trojan × 5 · vless × 94 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 6 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 38 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 58 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 6
