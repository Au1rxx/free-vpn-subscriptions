...
![узлы](https://img.shields.io/badge/узлы-99-brightgreen) ![живые](https://img.shields.io/badge/живые-2232-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-142ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_02:27_UTC-informational)
...
- **Медиана RTT**: 142 ms
- **Последнее обновление (UTC)**: 2026-06-07 02:27 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 21 · vless × 25 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 30 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 5
