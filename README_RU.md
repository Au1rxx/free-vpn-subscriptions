...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-1831-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-377ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_19:39_UTC-informational)
...
- **Выбрано узлов**: 111
- **Живых во всех источниках**: 1831
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 377 ms
- **Последнее обновление (UTC)**: 2026-06-15 19:39 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 50 · trojan × 23 · vless × 22 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 8 · `surfboard-eternity` × 5
