...
![узлы](https://img.shields.io/badge/узлы-113-brightgreen) ![живые](https://img.shields.io/badge/живые-1853-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-344ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-16_06:20_UTC-informational)
...
- **Выбрано узлов**: 113
- **Живых во всех источниках**: 1853
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 344 ms
- **Последнее обновление (UTC)**: 2026-06-16 06:20 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 47 · trojan × 25 · vless × 29 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 27 · `pawdroid` × 3 · `ruking-clash` × 9 · `surfboard-eternity` × 3
