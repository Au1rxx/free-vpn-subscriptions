...
![узлы](https://img.shields.io/badge/узлы-77-brightgreen) ![живые](https://img.shields.io/badge/живые-2510-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-114ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-02_09:19_UTC-informational)
...
- **Выбрано узлов**: 77
- **Живых во всех источниках**: 2510
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 114 ms
- **Последнее обновление (UTC)**: 2026-06-02 09:19 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 24 · vless × 8 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
