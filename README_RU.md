...
![узлы](https://img.shields.io/badge/узлы-149-brightgreen) ![живые](https://img.shields.io/badge/живые-2563-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-167ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-24_19:33_UTC-informational)
...
- **Медиана RTT**: 167 ms
- **Последнее обновление (UTC)**: 2026-04-24 19:33 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 22 · vless × 85 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 52 · `snakem982` × 1 · `surfboard-eternity` × 6
