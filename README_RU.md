...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-1874-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-362ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_18:33_UTC-informational)
...
- **Выбрано узлов**: 111
- **Живых во всех источниках**: 1874
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 362 ms
- **Последнее обновление (UTC)**: 2026-07-13 18:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 50 · trojan × 19 · vless × 12 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `mahdi0024` × 27 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 6 · `ninjastrikers` × 11 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 3
