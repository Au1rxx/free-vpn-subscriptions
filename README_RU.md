...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2010-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-149ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-08_03:33_UTC-informational)
...
- **Медиана RTT**: 149 ms
- **Последнее обновление (UTC)**: 2026-05-08 03:33 UTC

**Распределение протоколов:** shadowsocks × 51 · trojan × 6 · vless × 84 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 80 · `snakem982` × 1 · `surfboard-eternity` × 6
