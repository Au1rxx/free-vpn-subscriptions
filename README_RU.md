...
![узлы](https://img.shields.io/badge/узлы-91-brightgreen) ![живые](https://img.shields.io/badge/живые-1870-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-388ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_18:13_UTC-informational)
...
- **Медиана RTT**: 388 ms
- **Последнее обновление (UTC)**: 2026-06-30 18:13 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 34 · trojan × 34 · vless × 16 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `mahdi0024` × 7 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 9 · `ninjastrikers` × 15 · `pawdroid` × 6 · `ruking-clash` × 11 · `surfboard-eternity` × 6
