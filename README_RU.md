...
![узлы](https://img.shields.io/badge/узлы-80-brightgreen) ![живые](https://img.shields.io/badge/живые-1998-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-169ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-03_17:24_UTC-informational)
...
- **Медиана RTT**: 169 ms
- **Последнее обновление (UTC)**: 2026-07-03 17:24 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 23 · vless × 16 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 10 · `ninjastrikers` × 12 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 3
