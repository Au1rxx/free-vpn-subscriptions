...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2419-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-99ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-14_14:22_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2419
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 99 ms
- **Последнее обновление (UTC)**: 2026-05-14 14:22 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 18 · vless × 82 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 33 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 6
