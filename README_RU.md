...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1789-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-591ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-17_09:35_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1789
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 591 ms
- **Последнее обновление (UTC)**: 2026-06-17 09:35 UTC

**Распределение протоколов:** hysteria2 × 5 · shadowsocks × 40 · trojan × 27 · vless × 19 · vmess × 59

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 61 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 3
