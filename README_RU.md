...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2257-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-85ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-21_16:27_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2257
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 85 ms
- **Последнее обновление (UTC)**: 2026-05-21 16:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 30 · trojan × 28 · vless × 81 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 43 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 9 · `surfboard-eternity` × 3
