...
![узлы](https://img.shields.io/badge/узлы-90-brightgreen) ![живые](https://img.shields.io/badge/живые-2196-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-553ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-29_12:38_UTC-informational)
...
- **Медиана RTT**: 553 ms
- **Последнее обновление (UTC)**: 2026-06-29 12:38 UTC

**Распределение протоколов:** shadowsocks × 18 · trojan × 40 · vless × 19 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 5
