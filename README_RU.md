...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-391-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-95ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-19_06:53_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 391
- **RTT самого быстрого узла**: 5 ms
- **Медиана RTT**: 95 ms
- **Последнее обновление (UTC)**: 2026-04-19 06:53 UTC

**Распределение протоколов:** shadowsocks × 100 · trojan × 12 · vmess × 38

**Источники в этом запуске:** `freefq` × 2 · `mahdibland-aggregator` × 62 · `mahdibland-shadowsocks` × 70 · `pawdroid` × 2 · `vxiaov-clash` × 14
