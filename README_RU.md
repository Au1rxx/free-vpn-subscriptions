...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2196-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-352ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-19_04:28_UTC-informational)
...
- **Медиана RTT**: 352 ms
- **Последнее обновление (UTC)**: 2026-07-19 04:28 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 45 · trojan × 75 · vless × 18 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `mahdi0024` × 65 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 7 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 9
