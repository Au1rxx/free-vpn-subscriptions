...
![узлы](https://img.shields.io/badge/узлы-94-brightgreen) ![живые](https://img.shields.io/badge/живые-1824-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-350ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_23:17_UTC-informational)
...
- **Выбрано узлов**: 94
- **Живых во всех источниках**: 1824
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 350 ms
- **Последнее обновление (UTC)**: 2026-06-07 23:17 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 54 · trojan × 22 · vless × 11 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `ruking-clash` × 3 · `surfboard-eternity` × 5
