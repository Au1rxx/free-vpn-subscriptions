...
![узлы](https://img.shields.io/badge/узлы-62-brightgreen) ![живые](https://img.shields.io/badge/живые-1987-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-162ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-27_22:14_UTC-informational)
...
- **Медиана RTT**: 162 ms
- **Последнее обновление (UTC)**: 2026-05-27 22:14 UTC

**Распределение протоколов:** shadowsocks × 25 · trojan × 20 · vless × 8 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `ruking-clash` × 2 · `snakem982` × 7 · `surfboard-eternity` × 2
