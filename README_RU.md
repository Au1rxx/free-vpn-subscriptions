...
![узлы](https://img.shields.io/badge/узлы-93-brightgreen) ![живые](https://img.shields.io/badge/живые-1814-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-314ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-08_07:33_UTC-informational)
...
- **Медиана RTT**: 314 ms
- **Последнее обновление (UTC)**: 2026-06-08 07:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 47 · trojan × 16 · vless × 23 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 22 · `pawdroid` × 5 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 5
