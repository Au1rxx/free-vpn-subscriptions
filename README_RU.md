...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2430-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-80ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-15_11:11_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2430
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 80 ms
- **Последнее обновление (UTC)**: 2026-05-15 11:11 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 5 · vless × 93 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 3 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `pawdroid` × 7 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
