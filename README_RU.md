...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2192-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-156ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_02:24_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2192
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 156 ms
- **Последнее обновление (UTC)**: 2026-04-22 02:24 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 4 · vless × 98 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 74 · `pawdroid` × 3 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 8
