...
![узлы](https://img.shields.io/badge/узлы-139-brightgreen) ![живые](https://img.shields.io/badge/живые-1715-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-369ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-11_03:29_UTC-informational)
...
- **Выбрано узлов**: 139
- **Живых во всех источниках**: 1715
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 369 ms
- **Последнее обновление (UTC)**: 2026-07-11 03:29 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 77 · trojan × 22 · vless × 23 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 22 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 3 · `ninjastrikers` × 23 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4
