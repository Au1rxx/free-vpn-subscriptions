...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2201-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-158ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-30_15:29_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2201
- **RTT самого быстрого узла**: 39 ms
- **Медиана RTT**: 158 ms
- **Последнее обновление (UTC)**: 2026-04-30 15:29 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 19 · vless × 81 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
