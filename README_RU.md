...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-1762-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-362ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_18:18_UTC-informational)
...
- **Выбрано узлов**: 114
- **Живых во всех источниках**: 1762
- **RTT самого быстрого узла**: 55 ms
- **Медиана RTT**: 362 ms
- **Последнее обновление (UTC)**: 2026-07-07 18:18 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 66 · trojan × 16 · vless × 17 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 5 · `ninjastrikers` × 9 · `pawdroid` × 9 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
