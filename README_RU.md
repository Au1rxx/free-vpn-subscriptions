...
![узлы](https://img.shields.io/badge/узлы-141-brightgreen) ![живые](https://img.shields.io/badge/живые-2567-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-163ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-24_16:30_UTC-informational)
...
- **Медиана RTT**: 163 ms
- **Последнее обновление (UTC)**: 2026-04-24 16:30 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 21 · vless × 84 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 32 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 56 · `pawdroid` × 1 · `surfboard-eternity` × 6
