...
![узлы](https://img.shields.io/badge/узлы-79-brightgreen) ![живые](https://img.shields.io/badge/живые-2334-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-179ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_07:12_UTC-informational)
...
- **Медиана RTT**: 179 ms
- **Последнее обновление (UTC)**: 2026-06-10 07:12 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 13 · vless × 14 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 2
