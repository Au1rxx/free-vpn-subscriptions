...
![узлы](https://img.shields.io/badge/узлы-146-brightgreen) ![живые](https://img.shields.io/badge/живые-2348-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-99ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-24_18:24_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 75 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 146
- **Живых во всех источниках**: 2348
- **RTT самого быстрого узла**: 39 ms
- **Медиана RTT**: 99 ms
- **Последнее обновление (UTC)**: 2026-05-24 18:24 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 19 · vless × 60 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 46 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 54 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
