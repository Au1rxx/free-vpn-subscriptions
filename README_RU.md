...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2336-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-398ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-18_07:33_UTC-informational)
...
|---|---|---|---|---|
| 🇯🇵 Japan (`JP`) | 98 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Медиана RTT**: 398 ms
- **Последнее обновление (UTC)**: 2026-07-18 07:33 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 100 · vless × 9 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 3 · `mahdi0024` × 64 · `mahdibland-aggregator` × 35 · `mahdibland-shadowsocks` × 29 · `matin-v2ray` × 3 · `ninjastrikers` × 4 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
