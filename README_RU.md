...
![узлы](https://img.shields.io/badge/узлы-125-brightgreen) ![живые](https://img.shields.io/badge/живые-1758-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-374ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_15:18_UTC-informational)
...
- **Выбрано узлов**: 125
- **Живых во всех источниках**: 1758
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 374 ms
- **Последнее обновление (UTC)**: 2026-07-08 15:18 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 69 · trojan × 20 · vless × 12 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 6
