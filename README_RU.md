...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2187-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-87ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-02_05:19_UTC-informational)
...
- **Медиана RTT**: 87 ms
- **Последнее обновление (UTC)**: 2026-05-02 05:19 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 7 · vless × 94 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 2 · `surfboard-eternity` × 7
