...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2407-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-135ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_09:33_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2407
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 135 ms
- **Последнее обновление (UTC)**: 2026-05-11 09:33 UTC

**Распределение протоколов:** shadowsocks × 46 · trojan × 4 · vless × 92 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 5
