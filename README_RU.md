...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2343-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-401ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-17_21:35_UTC-informational)
...
|---|---|---|---|---|
| 🇯🇵 Japan (`JP`) | 93 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Медиана RTT**: 401 ms
- **Последнее обновление (UTC)**: 2026-07-17 21:35 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 97 · vless × 11 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `mahdi0024` × 65 · `mahdibland-aggregator` × 31 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 4 · `ninjastrikers` × 6 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 8 · `surfboard-eternity` × 3
