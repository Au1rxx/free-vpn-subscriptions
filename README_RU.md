...
![узлы](https://img.shields.io/badge/узлы-76-brightgreen) ![живые](https://img.shields.io/badge/живые-2380-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-329ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-11_17:27_UTC-informational)
...
- **Выбрано узлов**: 76
- **Живых во всех источниках**: 2380
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 329 ms
- **Последнее обновление (UTC)**: 2026-06-11 17:27 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 18 · vless × 10 · vmess × 5

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 17 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 2
