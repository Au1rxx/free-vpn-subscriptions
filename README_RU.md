...
![узлы](https://img.shields.io/badge/узлы-130-brightgreen) ![живые](https://img.shields.io/badge/живые-1738-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-362ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_17:24_UTC-informational)
...
- **Медиана RTT**: 362 ms
- **Последнее обновление (UTC)**: 2026-07-08 17:24 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 71 · trojan × 22 · vless × 14 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 19 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 15 · `pawdroid` × 8 · `ruking-clash` × 2 · `surfboard-eternity` × 3
