...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2096-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-223ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-29_20:26_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2096
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 223 ms
- **Последнее обновление (UTC)**: 2026-04-29 20:26 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 18 · vless × 80 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 6 · `ninjastrikers` × 56 · `surfboard-eternity` × 8
