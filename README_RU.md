...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2526-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-89ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_05:24_UTC-informational)
...
- **Медиана RTT**: 89 ms
- **Последнее обновление (UTC)**: 2026-04-27 05:24 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 4 · vless × 96 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 63 · `pawdroid` × 1 · `surfboard-eternity` × 5
