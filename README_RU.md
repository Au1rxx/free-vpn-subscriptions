...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2579-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-136ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_23:39_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2579
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 136 ms
- **Последнее обновление (UTC)**: 2026-04-26 23:39 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 11 · vless × 87 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 48 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 46 · `pawdroid` × 1 · `surfboard-eternity` × 6
