...
![узлы](https://img.shields.io/badge/узлы-149-brightgreen) ![живые](https://img.shields.io/badge/живые-1558-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-388ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_17:25_UTC-informational)
...
- **Выбрано узлов**: 149
- **Живых во всех источниках**: 1558
- **RTT самого быстрого узла**: 25 ms
- **Медиана RTT**: 388 ms
- **Последнее обновление (UTC)**: 2026-07-07 17:25 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 92 · trojan × 27 · vless × 14 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 26 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 32 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 7 · `ruking-clash` × 1 · `surfboard-eternity` × 3
