...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2489-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-86ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-16_18:11_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2489
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 86 ms
- **Последнее обновление (UTC)**: 2026-05-16 18:11 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 19 · vless × 83 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 34 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 50 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 3
