...
![узлы](https://img.shields.io/badge/узлы-106-brightgreen) ![живые](https://img.shields.io/badge/живые-1948-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-317ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_11:35_UTC-informational)
...
- **Медиана RTT**: 317 ms
- **Последнее обновление (UTC)**: 2026-07-05 11:35 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 45 · trojan × 25 · vless × 8 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
