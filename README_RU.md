...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2256-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-140ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-03_12:14_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2256
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 140 ms
- **Последнее обновление (UTC)**: 2026-05-03 12:14 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 21 · vless × 93 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 5 · `ninjastrikers` × 60 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
