...
![узлы](https://img.shields.io/badge/узлы-131-brightgreen) ![живые](https://img.shields.io/badge/живые-2612-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-291ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_23:11_UTC-informational)
...
- **Выбрано узлов**: 131
- **Живых во всех источниках**: 2612
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 291 ms
- **Последнее обновление (UTC)**: 2026-04-22 23:11 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 20 · vless × 68 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
