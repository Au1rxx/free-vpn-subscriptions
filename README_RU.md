...
![узлы](https://img.shields.io/badge/узлы-80-brightgreen) ![живые](https://img.shields.io/badge/живые-2091-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-147ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-10_02:26_UTC-informational)
...
- **Медиана RTT**: 147 ms
- **Последнее обновление (UTC)**: 2026-07-10 02:26 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 10 · vless × 13 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 4
