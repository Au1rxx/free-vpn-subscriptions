...
![узлы](https://img.shields.io/badge/узлы-113-brightgreen) ![живые](https://img.shields.io/badge/живые-1791-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-319ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_08:15_UTC-informational)
...
- **Выбрано узлов**: 113
- **Живых во всех источниках**: 1791
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 319 ms
- **Последнее обновление (UTC)**: 2026-07-07 08:15 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 45 · trojan × 27 · vless × 21 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 9 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 5
