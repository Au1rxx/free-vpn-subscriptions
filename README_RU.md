...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-2363-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-111ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-01_00:11_UTC-informational)
...
- **Медиана RTT**: 111 ms
- **Последнее обновление (UTC)**: 2026-06-01 00:11 UTC

**Распределение протоколов:** shadowsocks × 19 · trojan × 30 · vless × 26 · vmess × 36

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 32 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
