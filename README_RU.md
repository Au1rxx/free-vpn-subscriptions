...
![узлы](https://img.shields.io/badge/узлы-81-brightgreen) ![живые](https://img.shields.io/badge/живые-1768-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-317ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-08_10:36_UTC-informational)
...
- **Выбрано узлов**: 81
- **Живых во всех источниках**: 1768
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 317 ms
- **Последнее обновление (UTC)**: 2026-06-08 10:36 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 43 · trojan × 17 · vless × 15 · vmess × 5

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 18 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 4
