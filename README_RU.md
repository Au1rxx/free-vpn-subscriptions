...
![узлы](https://img.shields.io/badge/узлы-108-brightgreen) ![живые](https://img.shields.io/badge/живые-1887-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-234ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-11_17:30_UTC-informational)
...
- **Выбрано узлов**: 108
- **Живых во всех источниках**: 1887
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 234 ms
- **Последнее обновление (UTC)**: 2026-07-11 17:30 UTC

**Распределение протоколов:** shadowsocks × 48 · trojan × 18 · vless × 24 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 14 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 10 · `ninjastrikers` × 13 · `pawdroid` × 9 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
