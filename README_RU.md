...
![узлы](https://img.shields.io/badge/узлы-109-brightgreen) ![живые](https://img.shields.io/badge/живые-1952-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-309ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_15:32_UTC-informational)
...
- **Медиана RTT**: 309 ms
- **Последнее обновление (UTC)**: 2026-07-05 15:32 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 35 · trojan × 33 · vless × 10 · vmess × 30

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 6 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 4
