...
![узлы](https://img.shields.io/badge/узлы-126-brightgreen) ![живые](https://img.shields.io/badge/живые-1967-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-352ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_04:38_UTC-informational)
...
- **Медиана RTT**: 352 ms
- **Последнее обновление (UTC)**: 2026-07-05 04:38 UTC

**Распределение протоколов:** shadowsocks × 57 · trojan × 28 · vless × 13 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 42 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
