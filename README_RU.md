...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1926-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-304ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-16_17:18_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 91 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Медиана RTT**: 304 ms
- **Последнее обновление (UTC)**: 2026-06-16 17:18 UTC

**Распределение протоколов:** shadowsocks × 48 · trojan × 12 · vless × 15 · vmess × 75

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 16 · `lagzian-mix` × 1 · `mahdi0024` × 78 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 1
