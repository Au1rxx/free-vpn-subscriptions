...
![узлы](https://img.shields.io/badge/узлы-122-brightgreen) ![живые](https://img.shields.io/badge/живые-1806-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-339ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-11_04:22_UTC-informational)
...
- **Выбрано узлов**: 122
- **Живых во всех источниках**: 1806
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 339 ms
- **Последнее обновление (UTC)**: 2026-07-11 04:22 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 55 · trojan × 25 · vless × 23 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 33 · `matin-v2ray` × 2 · `ninjastrikers` × 26 · `pawdroid` × 9 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
