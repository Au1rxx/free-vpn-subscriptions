...
![узлы](https://img.shields.io/badge/узлы-140-brightgreen) ![живые](https://img.shields.io/badge/живые-2290-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-317ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-04_22:29_UTC-informational)
...
- **Выбрано узлов**: 140
- **Живых во всех источниках**: 2290
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 317 ms
- **Последнее обновление (UTC)**: 2026-05-04 22:29 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 25 · vless × 69 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
