...
![узлы](https://img.shields.io/badge/узлы-141-brightgreen) ![живые](https://img.shields.io/badge/живые-2572-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-111ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-14_16:30_UTC-informational)
...
- **Выбрано узлов**: 141
- **Живых во всех источниках**: 2572
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 111 ms
- **Последнее обновление (UTC)**: 2026-05-14 16:30 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 21 · vless × 75 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 54 · `pawdroid` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
