...
![узлы](https://img.shields.io/badge/узлы-79-brightgreen) ![живые](https://img.shields.io/badge/живые-1868-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-156ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-03_13:37_UTC-informational)
...
- **Выбрано узлов**: 79
- **Живых во всех источниках**: 1868
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 156 ms
- **Последнее обновление (UTC)**: 2026-07-03 13:37 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 23 · vless × 11 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
