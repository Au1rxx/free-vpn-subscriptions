...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2080-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-188ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-29_16:37_UTC-informational)
...
- **Медиана RTT**: 188 ms
- **Последнее обновление (UTC)**: 2026-04-29 16:37 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 16 · vless × 80 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 6 · `ninjastrikers` × 57 · `surfboard-eternity` × 7
