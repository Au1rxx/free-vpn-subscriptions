...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2574-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-88ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_00:22_UTC-informational)
...
- **Медиана RTT**: 88 ms
- **Последнее обновление (UTC)**: 2026-04-27 00:22 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 5 · vless × 96 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 45 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 56 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
