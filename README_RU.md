...
![узлы](https://img.shields.io/badge/узлы-137-brightgreen) ![живые](https://img.shields.io/badge/живые-1923-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-383ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_14:13_UTC-informational)
...
- **Медиана RTT**: 383 ms
- **Последнее обновление (UTC)**: 2026-07-04 14:13 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 70 · trojan × 27 · vless × 11 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 41 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 5 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 8
