...
![узлы](https://img.shields.io/badge/узлы-70-brightgreen) ![живые](https://img.shields.io/badge/живые-2008-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-204ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_08:22_UTC-informational)
...
- **Выбрано узлов**: 70
- **Живых во всех источниках**: 2008
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 204 ms
- **Последнее обновление (UTC)**: 2026-05-28 08:22 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 14 · vless × 16 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 4 · `surfboard-eternity` × 4
