...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2340-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-91ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-24_17:24_UTC-informational)
...
- **Медиана RTT**: 91 ms
- **Последнее обновление (UTC)**: 2026-05-24 17:24 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 18 · vless × 65 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 43 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 56 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 4
