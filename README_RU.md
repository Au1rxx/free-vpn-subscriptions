...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2418-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-396ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-18_22:09_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2418
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 396 ms
- **Последнее обновление (UTC)**: 2026-07-18 22:09 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 33 · trojan × 97 · vless × 13 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 33 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 45 · `matin-v2ray` × 5 · `ninjastrikers` × 6 · `pawdroid` × 6 · `ruking-clash` × 2 · `snakem982` × 10 · `surfboard-eternity` × 7
