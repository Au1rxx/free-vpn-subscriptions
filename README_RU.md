...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2199-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-227ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_12:29_UTC-informational)
...
- **Медиана RTT**: 227 ms
- **Последнее обновление (UTC)**: 2026-04-21 12:29 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 4 · vless × 104 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 59 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 2 · `ruking-clash` × 7 · `snakem982` × 2 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
