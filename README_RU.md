...
![узлы](https://img.shields.io/badge/узлы-101-brightgreen) ![живые](https://img.shields.io/badge/живые-2314-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-183ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-20_01:14_UTC-informational)
...
- **Медиана RTT**: 183 ms
- **Последнее обновление (UTC)**: 2026-06-20 01:14 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 26 · vless × 18 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 11 · `mahdi0024` × 24 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 22 · `pawdroid` × 1 · `ruking-clash` × 18 · `surfboard-eternity` × 6
