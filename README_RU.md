...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2084-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-85ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-03_02:21_UTC-informational)
...
- **Медиана RTT**: 85 ms
- **Последнее обновление (UTC)**: 2026-05-03 02:21 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 5 · vless × 101 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 64 · `pawdroid` × 2 · `surfboard-eternity` × 4
