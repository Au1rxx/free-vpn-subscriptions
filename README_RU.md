...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2244-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-279ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-05_18:25_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2244
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 279 ms
- **Последнее обновление (UTC)**: 2026-05-05 18:25 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 30 · vless × 71 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 39 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 54 · `snakem982` × 1 · `surfboard-eternity` × 8
