...
![узлы](https://img.shields.io/badge/узлы-132-brightgreen) ![живые](https://img.shields.io/badge/живые-1860-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-385ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-15_18:10_UTC-informational)
...
- **Выбрано узлов**: 132
- **Живых во всех источниках**: 1860
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 385 ms
- **Последнее обновление (UTC)**: 2026-07-15 18:10 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 73 · trojan × 27 · vless × 20 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `mahdi0024` × 18 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 14 · `surfboard-eternity` × 2
