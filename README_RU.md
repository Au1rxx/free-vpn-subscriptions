...
![узлы](https://img.shields.io/badge/узлы-71-brightgreen) ![живые](https://img.shields.io/badge/живые-2086-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-263ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_18:22_UTC-informational)
...
- **Медиана RTT**: 263 ms
- **Последнее обновление (UTC)**: 2026-05-28 18:22 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 20 · vless × 12 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 4
