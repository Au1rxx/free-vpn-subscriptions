...
![узлы](https://img.shields.io/badge/узлы-112-brightgreen) ![живые](https://img.shields.io/badge/живые-1871-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-363ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-06_13:40_UTC-informational)
...
- **Медиана RTT**: 363 ms
- **Последнее обновление (UTC)**: 2026-07-06 13:40 UTC

**Распределение протоколов:** hysteria2 × 3 · shadowsocks × 42 · trojan × 25 · vless × 13 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 6 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 2
