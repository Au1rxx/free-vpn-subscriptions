...
![узлы](https://img.shields.io/badge/узлы-96-brightgreen) ![живые](https://img.shields.io/badge/живые-1956-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-484ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-18_10:19_UTC-informational)
...
- **Медиана RTT**: 484 ms
- **Последнее обновление (UTC)**: 2026-06-18 10:19 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 25 · vless × 28 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 25 · `snakem982` × 5 · `surfboard-eternity` × 4
