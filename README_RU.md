...
![узлы](https://img.shields.io/badge/узлы-135-brightgreen) ![живые](https://img.shields.io/badge/живые-1912-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-657ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-17_08:19_UTC-informational)
...
- **Выбрано узлов**: 135
- **Живых во всех источниках**: 1912
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 657 ms
- **Последнее обновление (UTC)**: 2026-06-17 08:19 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 38 · trojan × 28 · vless × 15 · vmess × 53

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 56 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 3
