...
![узлы](https://img.shields.io/badge/узлы-126-brightgreen) ![живые](https://img.shields.io/badge/живые-2298-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-83ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-18_16:38_UTC-informational)
...
- **Выбрано узлов**: 126
- **Живых во всех источниках**: 2298
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 83 ms
- **Последнее обновление (UTC)**: 2026-05-18 16:38 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 16 · trojan × 22 · vless × 68 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 6 · `ruking-clash` × 2 · `surfboard-eternity` × 4
