...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2290-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-398ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-17_17:34_UTC-informational)
...
- **Медиана RTT**: 398 ms
- **Последнее обновление (UTC)**: 2026-07-17 17:34 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 96 · vless × 17 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 3 · `mahdi0024` × 63 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 2 · `ninjastrikers` × 4 · `pawdroid` × 9 · `ruking-clash` × 3 · `snakem982` × 15 · `surfboard-eternity` × 7
