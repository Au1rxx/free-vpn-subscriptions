...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2049-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-72ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-22_10:11_UTC-informational)
...
- **Медиана RTT**: 72 ms
- **Последнее обновление (UTC)**: 2026-05-22 10:11 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 34 · trojan × 11 · vless × 92 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 67 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 8
