...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2595-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-146ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_01:22_UTC-informational)
...
- **Медиана RTT**: 146 ms
- **Последнее обновление (UTC)**: 2026-04-23 01:22 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 13 · vless × 99 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 76 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 7
