...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2418-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-225ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_14:23_UTC-informational)
...
- **Медиана RTT**: 225 ms
- **Последнее обновление (UTC)**: 2026-05-10 14:23 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 16 · vless × 83 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 60 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 3 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
