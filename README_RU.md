...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2172-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-397ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-16_22:37_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2172
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 397 ms
- **Последнее обновление (UTC)**: 2026-07-16 22:37 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 75 · vless × 11 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `mahdi0024` × 51 · `mahdibland-aggregator` × 30 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 5
