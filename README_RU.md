...
![узлы](https://img.shields.io/badge/узлы-84-brightgreen) ![живые](https://img.shields.io/badge/живые-2217-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-178ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-06_23:34_UTC-informational)
...
- **Медиана RTT**: 178 ms
- **Последнее обновление (UTC)**: 2026-06-06 23:34 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 31 · trojan × 21 · vless × 8 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
