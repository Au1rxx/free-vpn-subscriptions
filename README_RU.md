...
![узлы](https://img.shields.io/badge/узлы-138-brightgreen) ![живые](https://img.shields.io/badge/живые-2203-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-170ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-28_21:38_UTC-informational)
...
- **Медиана RTT**: 170 ms
- **Последнее обновление (UTC)**: 2026-04-28 21:38 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 23 · vless × 73 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 54 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
