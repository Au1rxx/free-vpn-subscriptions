...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2157-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-115ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-02_18:12_UTC-informational)
...
- **Медиана RTT**: 115 ms
- **Последнее обновление (UTC)**: 2026-05-02 18:12 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 15 · vless × 87 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 52 · `pawdroid` × 3 · `surfboard-eternity` × 6
