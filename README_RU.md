...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2450-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-126ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-13_17:20_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2450
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 126 ms
- **Последнее обновление (UTC)**: 2026-05-13 17:20 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 20 · vless × 78 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 5 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 6
