...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2480-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-93ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-25_05:37_UTC-informational)
...
- **Медиана RTT**: 93 ms
- **Последнее обновление (UTC)**: 2026-05-25 05:37 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 3 · vless × 84 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `epodonios` × 5 · `mahdi0024` × 41 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 61 · `pawdroid` × 4 · `ruking-clash` × 5 · `surfboard-eternity` × 4
