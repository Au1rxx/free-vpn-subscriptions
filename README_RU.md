...
![узлы](https://img.shields.io/badge/узлы-124-brightgreen) ![живые](https://img.shields.io/badge/живые-2012-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-343ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_07:25_UTC-informational)
...
- **Выбрано узлов**: 124
- **Живых во всех источниках**: 2012
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 343 ms
- **Последнее обновление (UTC)**: 2026-07-05 07:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 57 · trojan × 27 · vless × 11 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 4 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 2
