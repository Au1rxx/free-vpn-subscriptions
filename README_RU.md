...
![узлы](https://img.shields.io/badge/узлы-104-brightgreen) ![живые](https://img.shields.io/badge/живые-1857-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-369ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_09:12_UTC-informational)
...
- **Медиана RTT**: 369 ms
- **Последнее обновление (UTC)**: 2026-06-15 09:12 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 50 · trojan × 22 · vless × 20 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 11 · `surfboard-eternity` × 9
