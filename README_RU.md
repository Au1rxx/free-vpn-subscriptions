...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2237-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-442ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-20_19:35_UTC-informational)
...
- **Медиана RTT**: 442 ms
- **Последнее обновление (UTC)**: 2026-04-20 19:35 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 18 · vless × 90 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 50 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 10
