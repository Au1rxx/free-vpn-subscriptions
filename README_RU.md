...
![узлы](https://img.shields.io/badge/узлы-100-brightgreen) ![живые](https://img.shields.io/badge/живые-1918-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-271ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-11_21:27_UTC-informational)
...
- **Выбрано узлов**: 100
- **Живых во всех источниках**: 1918
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 271 ms
- **Последнее обновление (UTC)**: 2026-07-11 21:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 53 · trojan × 16 · vless × 12 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 5 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 5
