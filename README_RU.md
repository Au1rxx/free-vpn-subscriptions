...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1958-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-279ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-07_22:32_UTC-informational)
...
- **Медиана RTT**: 279 ms
- **Последнее обновление (UTC)**: 2026-05-07 22:32 UTC

**Распределение протоколов:** shadowsocks × 53 · trojan × 18 · vless × 69 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 57 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 8
