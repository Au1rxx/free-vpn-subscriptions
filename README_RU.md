...
![узлы](https://img.shields.io/badge/узлы-90-brightgreen) ![живые](https://img.shields.io/badge/живые-1923-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-170ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-03_18:38_UTC-informational)
...
- **Медиана RTT**: 170 ms
- **Последнее обновление (UTC)**: 2026-06-03 18:38 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 37 · vless × 15 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 29 · `mahdi0024` × 12 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 10 · `surfboard-eternity` × 3
