...
![узлы](https://img.shields.io/badge/узлы-91-brightgreen) ![живые](https://img.shields.io/badge/живые-2079-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-442ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-27_08:28_UTC-informational)
...
- **Выбрано узлов**: 91
- **Живых во всех источниках**: 2079
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 442 ms
- **Последнее обновление (UTC)**: 2026-06-27 08:28 UTC

**Распределение протоколов:** shadowsocks × 17 · trojan × 36 · vless × 18 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 16 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 1
