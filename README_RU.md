...
![узлы](https://img.shields.io/badge/узлы-115-brightgreen) ![живые](https://img.shields.io/badge/живые-1801-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-360ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_15:20_UTC-informational)
...
- **Медиана RTT**: 360 ms
- **Последнее обновление (UTC)**: 2026-07-07 15:20 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 53 · trojan × 30 · vless × 14 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 5 · `ninjastrikers` × 16 · `pawdroid` × 7 · `ruking-clash` × 1
