...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2166-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-96ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_06:33_UTC-informational)
...
- **Медиана RTT**: 96 ms
- **Последнее обновление (UTC)**: 2026-04-26 06:33 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 9 · vless × 104 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
