...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2314-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-78ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-20_05:33_UTC-informational)
...
- **Медиана RTT**: 78 ms
- **Последнее обновление (UTC)**: 2026-05-20 05:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 41 · trojan × 11 · vless × 79 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
