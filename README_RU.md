...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2447-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-131ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_20:24_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2447
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 131 ms
- **Последнее обновление (UTC)**: 2026-04-27 20:24 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 21 · vless × 90 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 31 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 50 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7
