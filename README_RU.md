...
![узлы](https://img.shields.io/badge/узлы-119-brightgreen) ![живые](https://img.shields.io/badge/живые-1769-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-361ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_20:30_UTC-informational)
...
- **Выбрано узлов**: 119
- **Живых во всех источниках**: 1769
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 361 ms
- **Последнее обновление (UTC)**: 2026-07-08 20:30 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 66 · trojan × 21 · vless × 10 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `ninjastrikers` × 19 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 4
