...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2071-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-104ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-02_00:14_UTC-informational)
...
- **Медиана RTT**: 104 ms
- **Последнее обновление (UTC)**: 2026-05-02 00:14 UTC

**Распределение протоколов:** shadowsocks × 47 · trojan × 6 · vless × 85 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 29 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
