...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2260-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-81ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-01_07:20_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2260
- **RTT самого быстрого узла**: 22 ms
- **Медиана RTT**: 81 ms
- **Последнее обновление (UTC)**: 2026-05-01 07:20 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 9 · vless × 93 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 65 · `pawdroid` × 1 · `surfboard-eternity` × 5
