...
![узлы](https://img.shields.io/badge/узлы-118-brightgreen) ![живые](https://img.shields.io/badge/живые-1859-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-275ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-11_18:27_UTC-informational)
...
- **Выбрано узлов**: 118
- **Живых во всех источниках**: 1859
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 275 ms
- **Последнее обновление (UTC)**: 2026-07-11 18:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 55 · trojan × 14 · vless × 31 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 10 · `ninjastrikers` × 16 · `pawdroid` × 11 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 2
