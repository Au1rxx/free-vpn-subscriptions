...
![узлы](https://img.shields.io/badge/узлы-117-brightgreen) ![живые](https://img.shields.io/badge/живые-1984-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-348ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-28_03:17_UTC-informational)
...
- **Выбрано узлов**: 117
- **Живых во всех источниках**: 1984
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 348 ms
- **Последнее обновление (UTC)**: 2026-06-28 03:17 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 32 · trojan × 38 · vless × 36 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 5
