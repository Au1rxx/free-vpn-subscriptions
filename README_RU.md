...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2366-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-144ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-12_19:16_UTC-informational)
...
- **Медиана RTT**: 144 ms
- **Последнее обновление (UTC)**: 2026-05-12 19:16 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 20 · vless × 78 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 53 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
