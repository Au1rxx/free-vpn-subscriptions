...
![узлы](https://img.shields.io/badge/узлы-123-brightgreen) ![живые](https://img.shields.io/badge/живые-2090-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-281ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_15:22_UTC-informational)
...
- **Выбрано узлов**: 123
- **Живых во всех источниках**: 2090
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 281 ms
- **Последнее обновление (UTC)**: 2026-07-12 15:22 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 62 · trojan × 20 · vless × 27 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 16 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 6 · `surfboard-eternity` × 4
