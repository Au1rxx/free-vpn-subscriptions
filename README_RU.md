...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2476-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-398ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-18_15:12_UTC-informational)
...
- **Медиана RTT**: 398 ms
- **Последнее обновление (UTC)**: 2026-07-18 15:12 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 98 · vless × 11 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 42 · `mahdibland-shadowsocks` × 37 · `matin-v2ray` × 5 · `ninjastrikers` × 6 · `pawdroid` × 6 · `ruking-clash` × 2 · `snakem982` × 8 · `surfboard-eternity` × 5
