...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2482-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-86ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-16_16:31_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2482
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 86 ms
- **Последнее обновление (UTC)**: 2026-05-16 16:31 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 19 · vless × 83 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 54 · `pawdroid` × 8 · `ruking-clash` × 5 · `surfboard-eternity` × 6
