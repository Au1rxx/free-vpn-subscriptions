...
![узлы](https://img.shields.io/badge/узлы-95-brightgreen) ![живые](https://img.shields.io/badge/живые-1891-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-362ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_13:37_UTC-informational)
...
- **Выбрано узлов**: 95
- **Живых во всех источниках**: 1891
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 362 ms
- **Последнее обновление (UTC)**: 2026-06-15 13:37 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 43 · trojan × 21 · vless × 16 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 18 · `mfuu-clash` × 2 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 3
