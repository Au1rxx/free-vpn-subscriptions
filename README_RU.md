...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2614-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-76ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-18_08:14_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2614
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 76 ms
- **Последнее обновление (UTC)**: 2026-05-18 08:14 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 8 · vless × 94 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 53 · `pawdroid` × 10 · `ruking-clash` × 7 · `surfboard-eternity` × 6
