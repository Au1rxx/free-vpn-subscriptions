...
![узлы](https://img.shields.io/badge/узлы-104-brightgreen) ![живые](https://img.shields.io/badge/живые-1919-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-346ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_08:12_UTC-informational)
...
- **Медиана RTT**: 346 ms
- **Последнее обновление (UTC)**: 2026-07-14 08:12 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 39 · trojan × 19 · vless × 17 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 18 · `pawdroid` × 10 · `ruking-clash` × 1 · `surfboard-eternity` × 1
