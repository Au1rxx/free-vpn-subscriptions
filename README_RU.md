...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2006-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-393ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-16_06:29_UTC-informational)
...
|---|---|---|---|---|
| 🇯🇵 Japan (`JP`) | 67 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Медиана RTT**: 393 ms
- **Последнее обновление (UTC)**: 2026-07-16 06:29 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 44 · trojan × 71 · vless × 22 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 15 · `mahdibland-aggregator` × 42 · `mahdibland-shadowsocks` × 43 · `matin-v2ray` × 6 · `ninjastrikers` × 15 · `pawdroid` × 6 · `ruking-clash` × 2 · `snakem982` × 6 · `surfboard-eternity` × 1
