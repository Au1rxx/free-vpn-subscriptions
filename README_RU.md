...
![узлы](https://img.shields.io/badge/узлы-77-brightgreen) ![живые](https://img.shields.io/badge/живые-2465-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-164ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-02_13:12_UTC-informational)
...
- **Медиана RTT**: 164 ms
- **Последнее обновление (UTC)**: 2026-06-02 13:12 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 25 · vless × 6 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 35 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 8 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
