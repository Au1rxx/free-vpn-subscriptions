...
![узлы](https://img.shields.io/badge/узлы-120-brightgreen) ![живые](https://img.shields.io/badge/живые-1774-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-378ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-09_14:16_UTC-informational)
...
- **Медиана RTT**: 378 ms
- **Последнее обновление (UTC)**: 2026-07-09 14:16 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 63 · trojan × 17 · vless × 14 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 17 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 4 · `ninjastrikers` × 15 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 4
