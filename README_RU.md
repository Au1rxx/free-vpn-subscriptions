...
![узлы](https://img.shields.io/badge/узлы-103-brightgreen) ![живые](https://img.shields.io/badge/живые-1832-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-336ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-11_13:18_UTC-informational)
...
- **Медиана RTT**: 336 ms
- **Последнее обновление (UTC)**: 2026-07-11 13:18 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 47 · trojan × 20 · vless × 17 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
