...
![узлы](https://img.shields.io/badge/узлы-124-brightgreen) ![живые](https://img.shields.io/badge/живые-2054-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-238ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_18:20_UTC-informational)
...
- **Выбрано узлов**: 124
- **Живых во всех источниках**: 2054
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 238 ms
- **Последнее обновление (UTC)**: 2026-07-12 18:20 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 68 · trojan × 13 · vless × 27 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 5 · `mfuu-clash` × 6 · `ninjastrikers` × 8 · `pawdroid` × 12 · `ruking-clash` × 1 · `snakem982` × 6 · `surfboard-eternity` × 3
