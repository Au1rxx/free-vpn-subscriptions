...
- **Медиана RTT**: 96 ms
- **Последнее обновление (UTC)**: 2026-04-19 07:12 UTC

**Распределение протоколов:** shadowsocks × 102 · trojan × 12 · vmess × 36

**Источники в этом запуске:** `freefq` × 2 · `mahdibland-aggregator` × 76 · `mahdibland-shadowsocks` × 56 · `pawdroid` × 3 · `vxiaov-clash` × 13
