...
![узлы](https://img.shields.io/badge/узлы-118-brightgreen) ![живые](https://img.shields.io/badge/живые-1854-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-331ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_06:38_UTC-informational)
...
- **Выбрано узлов**: 118
- **Живых во всех источниках**: 1854
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 331 ms
- **Последнее обновление (UTC)**: 2026-07-07 06:38 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 48 · trojan × 22 · vless × 23 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 27 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 9 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 2
