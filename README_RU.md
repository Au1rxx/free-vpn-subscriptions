...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2196-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-400ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-16_14:36_UTC-informational)
...
|---|---|---|---|---|
| 🇯🇵 Japan (`JP`) | 71 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Медиана RTT**: 400 ms
- **Последнее обновление (UTC)**: 2026-07-16 14:36 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 79 · vless × 13 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `mahdi0024` × 57 · `mahdibland-aggregator` × 29 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 6 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 6 · `surfboard-eternity` × 5
