...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2471-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-108ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_14:17_UTC-informational)
...
- **Медиана RTT**: 108 ms
- **Последнее обновление (UTC)**: 2026-04-27 14:17 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 15 · vless × 98 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
