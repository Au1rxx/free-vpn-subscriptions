...
![узлы](https://img.shields.io/badge/узлы-138-brightgreen) ![живые](https://img.shields.io/badge/живые-2322-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-309ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_20:32_UTC-informational)
...
- **Медиана RTT**: 309 ms
- **Последнее обновление (UTC)**: 2026-04-21 20:32 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 24 · vless × 68 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 37 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
