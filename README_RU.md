...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2586-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-106ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_15:21_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2586
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 106 ms
- **Последнее обновление (UTC)**: 2026-04-26 15:21 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 4 · vless × 93 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 52 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 51 · `pawdroid` × 1 · `surfboard-eternity` × 6
