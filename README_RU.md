...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2565-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-162ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_20:11_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2565
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 162 ms
- **Последнее обновление (UTC)**: 2026-04-26 20:11 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 16 · vless × 80 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 43 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 46 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
