...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2079-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-157ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-01_23:34_UTC-informational)
...
- **Медиана RTT**: 157 ms
- **Последнее обновление (UTC)**: 2026-05-01 23:34 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 15 · vless × 85 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 53 · `pawdroid` × 1 · `surfboard-eternity` × 9
