...
![узлы](https://img.shields.io/badge/узлы-135-brightgreen) ![живые](https://img.shields.io/badge/живые-2004-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-404ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-23_17:24_UTC-informational)
...
- **Выбрано узлов**: 135
- **Живых во всех источниках**: 2004
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 404 ms
- **Последнее обновление (UTC)**: 2026-06-23 17:24 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 41 · trojan × 31 · vless × 45 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 45 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 7 · `ruking-clash` × 17 · `surfboard-eternity` × 3
