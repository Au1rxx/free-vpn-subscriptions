...
![узлы](https://img.shields.io/badge/узлы-102-brightgreen) ![живые](https://img.shields.io/badge/живые-2146-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-569ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-29_13:31_UTC-informational)
...
- **Выбрано узлов**: 102
- **Живых во всех источниках**: 2146
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 569 ms
- **Последнее обновление (UTC)**: 2026-06-29 13:31 UTC

**Распределение протоколов:** shadowsocks × 16 · trojan × 52 · vless × 20 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `epodonios` × 18 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 10
