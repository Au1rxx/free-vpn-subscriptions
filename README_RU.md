...
![узлы](https://img.shields.io/badge/узлы-109-brightgreen) ![живые](https://img.shields.io/badge/живые-1981-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-293ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_08:39_UTC-informational)
...
- **Выбрано узлов**: 109
- **Живых во всех источниках**: 1981
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 293 ms
- **Последнее обновление (UTC)**: 2026-07-05 08:39 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 9 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 27 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 7
