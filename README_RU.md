...
![узлы](https://img.shields.io/badge/узлы-89-brightgreen) ![живые](https://img.shields.io/badge/живые-2057-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-151ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-10_00:22_UTC-informational)
...
- **Медиана RTT**: 151 ms
- **Последнее обновление (UTC)**: 2026-07-10 00:22 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 26 · trojan × 10 · vless × 19 · vmess × 33

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 34 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
