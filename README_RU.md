...
![узлы](https://img.shields.io/badge/узлы-99-brightgreen) ![живые](https://img.shields.io/badge/живые-2301-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-176ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-20_03:27_UTC-informational)
...
- **Выбрано узлов**: 99
- **Живых во всех источниках**: 2301
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 176 ms
- **Последнее обновление (UTC)**: 2026-06-20 03:27 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 27 · vless × 19 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 22 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 2
