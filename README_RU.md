...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2571-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-125ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-28_12:26_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2571
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 125 ms
- **Последнее обновление (UTC)**: 2026-04-28 12:26 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 17 · vless × 96 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 17 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 6 · `ninjastrikers` × 68 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6
