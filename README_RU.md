...
![узлы](https://img.shields.io/badge/узлы-119-brightgreen) ![живые](https://img.shields.io/badge/живые-1785-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-380ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-09_15:16_UTC-informational)
...
- **Медиана RTT**: 380 ms
- **Последнее обновление (UTC)**: 2026-07-09 15:16 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 59 · trojan × 17 · vless × 21 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 4 · `ninjastrikers` × 16 · `pawdroid` × 11 · `ruking-clash` × 2 · `surfboard-eternity` × 1
