...
![узлы](https://img.shields.io/badge/узлы-78-brightgreen) ![живые](https://img.shields.io/badge/живые-2255-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-278ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-02_13:11_UTC-informational)
...
- **Выбрано узлов**: 78
- **Живых во всех источниках**: 2255
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 278 ms
- **Последнее обновление (UTC)**: 2026-07-02 13:11 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 21 · vless × 10 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 7 · `ninjastrikers` × 13 · `pawdroid` × 3 · `surfboard-eternity` × 7
