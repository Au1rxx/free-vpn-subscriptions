...
![узлы](https://img.shields.io/badge/узлы-57-brightgreen) ![живые](https://img.shields.io/badge/живые-2100-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-167ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_20:22_UTC-informational)
...
- **Медиана RTT**: 167 ms
- **Последнее обновление (UTC)**: 2026-05-28 20:22 UTC

**Распределение протоколов:** shadowsocks × 25 · trojan × 15 · vless × 8 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 5 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 3
