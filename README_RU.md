...
![узлы](https://img.shields.io/badge/узлы-131-brightgreen) ![живые](https://img.shields.io/badge/живые-2400-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-471ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-19_00:32_UTC-informational)
...
- **Выбрано узлов**: 131
- **Живых во всех источниках**: 2400
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 471 ms
- **Последнее обновление (UTC)**: 2026-06-19 00:32 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 44 · trojan × 28 · vless × 49 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `epodonios` × 12 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 28 · `pawdroid` × 3 · `ruking-clash` × 32 · `snakem982` × 10 · `surfboard-eternity` × 3
