...
![узлы](https://img.shields.io/badge/узлы-82-brightgreen) ![живые](https://img.shields.io/badge/живые-2147-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-173ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-28_17:16_UTC-informational)
...
- **Выбрано узлов**: 82
- **Живых во всех источниках**: 2147
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 173 ms
- **Последнее обновление (UTC)**: 2026-06-28 17:16 UTC

**Распределение протоколов:** shadowsocks × 18 · trojan × 27 · vless × 20 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 3
