...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2246-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-149ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-25_21:14_UTC-informational)
...
- **Медиана RTT**: 149 ms
- **Последнее обновление (UTC)**: 2026-04-25 21:14 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 13 · vless × 87 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 35 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 1 · `ninjastrikers` × 54 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 6
