...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1919-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-130ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-12_10:21_UTC-informational)
...
- **Медиана RTT**: 130 ms
- **Последнее обновление (UTC)**: 2026-05-12 10:21 UTC

**Распределение протоколов:** shadowsocks × 53 · trojan × 4 · vless × 83 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
