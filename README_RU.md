...
![узлы](https://img.shields.io/badge/узлы-94-brightgreen) ![живые](https://img.shields.io/badge/живые-2039-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-359ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_13:35_UTC-informational)
...
- **Медиана RTT**: 359 ms
- **Последнее обновление (UTC)**: 2026-07-04 13:35 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 45 · trojan × 16 · vless × 10 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 5 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 4
