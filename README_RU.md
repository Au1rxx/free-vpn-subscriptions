...
![узлы](https://img.shields.io/badge/узлы-136-brightgreen) ![живые](https://img.shields.io/badge/живые-2582-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-291ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_18:24_UTC-informational)
...
- **Медиана RTT**: 291 ms
- **Последнее обновление (UTC)**: 2026-04-22 18:24 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 22 · vless × 71 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 6
