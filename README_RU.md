...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1976-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-337ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_23:32_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1976
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 337 ms
- **Последнее обновление (UTC)**: 2026-05-06 23:32 UTC

**Распределение протоколов:** shadowsocks × 46 · trojan × 19 · vless × 71 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 61 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
