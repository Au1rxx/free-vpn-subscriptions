...
![узлы](https://img.shields.io/badge/узлы-94-brightgreen) ![живые](https://img.shields.io/badge/живые-1923-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-340ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_12:29_UTC-informational)
...
- **Медиана RTT**: 340 ms
- **Последнее обновление (UTC)**: 2026-07-14 12:29 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 16 · vless × 11 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 25 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 4
