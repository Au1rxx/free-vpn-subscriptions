...
![узлы](https://img.shields.io/badge/узлы-137-brightgreen) ![живые](https://img.shields.io/badge/живые-2446-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-338ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_23:16_UTC-informational)
...
- **Медиана RTT**: 338 ms
- **Последнее обновление (UTC)**: 2026-04-23 23:16 UTC

**Распределение протоколов:** shadowsocks × 19 · trojan × 22 · vless × 79 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 2 · `surfboard-eternity` × 4
