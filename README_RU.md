...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1954-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-352ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_21:35_UTC-informational)
...
- **Медиана RTT**: 352 ms
- **Последнее обновление (UTC)**: 2026-05-06 21:35 UTC

**Распределение протоколов:** shadowsocks × 48 · trojan × 19 · vless × 70 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 57 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 7
