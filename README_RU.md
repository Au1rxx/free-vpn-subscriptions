...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1967-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-365ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_17:29_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1967
- **RTT самого быстрого узла**: 41 ms
- **Медиана RTT**: 365 ms
- **Последнее обновление (UTC)**: 2026-05-06 17:29 UTC

**Распределение протоколов:** shadowsocks × 48 · trojan × 20 · vless × 71 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 58 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
