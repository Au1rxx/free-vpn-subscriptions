...
![узлы](https://img.shields.io/badge/узлы-60-brightgreen) ![живые](https://img.shields.io/badge/живые-1971-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-134ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-27_18:22_UTC-informational)
...
- **Медиана RTT**: 134 ms
- **Последнее обновление (UTC)**: 2026-05-27 18:22 UTC

**Распределение протоколов:** shadowsocks × 24 · trojan × 11 · vless × 19 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 1 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 4 · `ruking-clash` × 7 · `snakem982` × 1 · `surfboard-eternity` × 3
