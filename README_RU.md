...
![узлы](https://img.shields.io/badge/узлы-124-brightgreen) ![живые](https://img.shields.io/badge/живые-2059-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-406ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-23_07:27_UTC-informational)
...
- **Медиана RTT**: 406 ms
- **Последнее обновление (UTC)**: 2026-06-23 07:27 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 31 · vless × 47 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 45 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 3
