...
![узлы](https://img.shields.io/badge/узлы-91-brightgreen) ![живые](https://img.shields.io/badge/живые-1945-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-208ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_19:25_UTC-informational)
...
- **Медиана RTT**: 208 ms
- **Последнее обновление (UTC)**: 2026-07-05 19:25 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 22 · vless × 7 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 6 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 2
