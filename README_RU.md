...
![узлы](https://img.shields.io/badge/узлы-120-brightgreen) ![живые](https://img.shields.io/badge/живые-1979-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-277ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-25_03:27_UTC-informational)
...
- **Выбрано узлов**: 120
- **Живых во всех источниках**: 1979
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 277 ms
- **Последнее обновление (UTC)**: 2026-06-25 03:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 26 · trojan × 33 · vless × 47 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 38 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 4
