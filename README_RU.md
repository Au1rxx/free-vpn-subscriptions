...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2578-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-112ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_17:11_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2578
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 112 ms
- **Последнее обновление (UTC)**: 2026-04-26 17:11 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 8 · vless × 88 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 42 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 51 · `pawdroid` × 3 · `surfboard-eternity` × 3
