...
![узлы](https://img.shields.io/badge/узлы-109-brightgreen) ![живые](https://img.shields.io/badge/живые-1858-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-376ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_22:31_UTC-informational)
...
- **Выбрано узлов**: 109
- **Живых во всех источниках**: 1858
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 376 ms
- **Последнее обновление (UTC)**: 2026-06-15 22:31 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 54 · trojan × 25 · vless × 15 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `ruking-clash` × 8 · `surfboard-eternity` × 5
