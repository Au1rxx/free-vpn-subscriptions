...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1904-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-371ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-22_05:29_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1904
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 371 ms
- **Последнее обновление (UTC)**: 2026-06-22 05:29 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 27 · vless × 61 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 29 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 26 · `pawdroid` × 2 · `ruking-clash` × 31 · `snakem982` × 1 · `surfboard-eternity` × 3
