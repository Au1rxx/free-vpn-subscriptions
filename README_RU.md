...
![узлы](https://img.shields.io/badge/узлы-81-brightgreen) ![живые](https://img.shields.io/badge/живые-2018-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-161ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_06:09_UTC-informational)
...
- **Медиана RTT**: 161 ms
- **Последнее обновление (UTC)**: 2026-07-04 06:09 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 22 · vless × 12 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
