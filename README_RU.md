...
![узлы](https://img.shields.io/badge/узлы-71-brightgreen) ![живые](https://img.shields.io/badge/живые-1884-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-288ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-05_12:30_UTC-informational)
...
- **Медиана RTT**: 288 ms
- **Последнее обновление (UTC)**: 2026-06-05 12:30 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 23 · vless × 10 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
