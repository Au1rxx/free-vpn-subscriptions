...
![узлы](https://img.shields.io/badge/узлы-87-brightgreen) ![живые](https://img.shields.io/badge/живые-2242-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-235ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-29_04:29_UTC-informational)
...
- **Медиана RTT**: 235 ms
- **Последнее обновление (UTC)**: 2026-06-29 04:29 UTC

**Распределение протоколов:** shadowsocks × 17 · trojan × 30 · vless × 27 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 8 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 3
