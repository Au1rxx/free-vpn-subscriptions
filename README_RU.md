...
![узлы](https://img.shields.io/badge/узлы-86-brightgreen) ![живые](https://img.shields.io/badge/живые-2542-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-100ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-02_07:11_UTC-informational)
...
- **Медиана RTT**: 100 ms
- **Последнее обновление (UTC)**: 2026-06-02 07:11 UTC

**Распределение протоколов:** shadowsocks × 25 · trojan × 27 · vless × 13 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 17 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
