...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2639-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-96ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-25_03:37_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2639
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 96 ms
- **Последнее обновление (UTC)**: 2026-04-25 03:37 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 9 · vless × 106 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 63 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
