...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-389-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-107ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-19_08:44_UTC-informational)
...
- **Медиана RTT**: 107 ms
- **Последнее обновление (UTC)**: 2026-04-19 08:44 UTC

**Распределение протоколов:** shadowsocks × 103 · trojan × 6 · vmess × 41

**Источники в этом запуске:** `freefq` × 1 · `mahdibland-aggregator` × 73 · `mahdibland-shadowsocks` × 60 · `pawdroid` × 3 · `vxiaov-clash` × 13
