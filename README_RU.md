...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-1931-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-412ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-25_18:37_UTC-informational)
...
- **Выбрано узлов**: 111
- **Живых во всех источниках**: 1931
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 412 ms
- **Последнее обновление (UTC)**: 2026-06-25 18:37 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 40 · vless × 21 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 23 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 20 · `surfboard-eternity` × 3
