...
![узлы](https://img.shields.io/badge/узлы-120-brightgreen) ![живые](https://img.shields.io/badge/живые-1909-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-340ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_02:19_UTC-informational)
...
- **Медиана RTT**: 340 ms
- **Последнее обновление (UTC)**: 2026-07-14 02:19 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 26 · vless × 24 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 29 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 7 · `ninjastrikers` × 22 · `pawdroid` × 10 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
