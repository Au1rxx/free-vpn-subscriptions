...
![узлы](https://img.shields.io/badge/узлы-53-brightgreen) ![живые](https://img.shields.io/badge/живые-2055-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-225ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-29_13:19_UTC-informational)
...
- **Медиана RTT**: 225 ms
- **Последнее обновление (UTC)**: 2026-05-29 13:19 UTC

**Распределение протоколов:** shadowsocks × 20 · trojan × 15 · vless × 9 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 8 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
