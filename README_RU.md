...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2626-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-78ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-17_08:34_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2626
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 78 ms
- **Последнее обновление (UTC)**: 2026-05-17 08:34 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 6 · vless × 96 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 57 · `pawdroid` × 6 · `ruking-clash` × 5 · `surfboard-eternity` × 4
