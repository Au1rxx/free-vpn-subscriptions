...
![узлы](https://img.shields.io/badge/узлы-89-brightgreen) ![живые](https://img.shields.io/badge/живые-2071-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-100ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-03_16:15_UTC-informational)
...
- **Выбрано узлов**: 89
- **Живых во всех источниках**: 2071
- **RTT самого быстрого узла**: 26 ms
- **Медиана RTT**: 100 ms
- **Последнее обновление (UTC)**: 2026-06-03 16:15 UTC

**Распределение протоколов:** shadowsocks × 14 · trojan × 36 · vless × 16 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 8 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
