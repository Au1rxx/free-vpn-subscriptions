...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2682-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-93ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-17_22:37_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2682
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 93 ms
- **Последнее обновление (UTC)**: 2026-05-17 22:37 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 42 · trojan × 22 · vless × 78 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 7 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 49 · `pawdroid` × 3 · `ruking-clash` × 9 · `snakem982` × 1 · `surfboard-eternity` × 3
