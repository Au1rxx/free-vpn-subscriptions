...
![узлы](https://img.shields.io/badge/узлы-134-brightgreen) ![живые](https://img.shields.io/badge/живые-2048-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-361ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-24_02:30_UTC-informational)
...
- **Выбрано узлов**: 134
- **Живых во всех источниках**: 2048
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 361 ms
- **Последнее обновление (UTC)**: 2026-06-24 02:30 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 27 · vless × 57 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 45 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 24 · `pawdroid` × 7 · `ruking-clash` × 12 · `surfboard-eternity` × 6
