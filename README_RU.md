...
![узлы](https://img.shields.io/badge/узлы-82-brightgreen) ![живые](https://img.shields.io/badge/живые-2259-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-339ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-01_18:12_UTC-informational)
...
- **Выбрано узлов**: 82
- **Живых во всех источниках**: 2259
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 339 ms
- **Последнее обновление (UTC)**: 2026-07-01 18:12 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 42 · trojan × 19 · vless × 14 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 10 · `pawdroid` × 6 · `surfboard-eternity` × 2
