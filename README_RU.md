...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2416-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-108ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-24_06:14_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2416
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 108 ms
- **Последнее обновление (UTC)**: 2026-04-24 06:14 UTC

**Распределение протоколов:** shadowsocks × 19 · trojan × 16 · vless × 99 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 73 · `pawdroid` × 3 · `snakem982` × 3 · `surfboard-eternity` × 6
