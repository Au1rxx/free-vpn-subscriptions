...
![узлы](https://img.shields.io/badge/узлы-118-brightgreen) ![живые](https://img.shields.io/badge/живые-2089-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-407ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-24_21:11_UTC-informational)
...
- **Выбрано узлов**: 118
- **Живых во всех источниках**: 2089
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 407 ms
- **Последнее обновление (UTC)**: 2026-06-24 21:11 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 34 · vless × 33 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 37 · `mahdi0024` × 16 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 14 · `surfboard-eternity` × 5
