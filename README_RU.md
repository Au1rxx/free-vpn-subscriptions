...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2585-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-76ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-16_12:17_UTC-informational)
...
- **Медиана RTT**: 76 ms
- **Последнее обновление (UTC)**: 2026-05-16 12:17 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 15 · vless × 94 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `epodonios` × 10 · `mahdi0024` × 35 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 58 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
