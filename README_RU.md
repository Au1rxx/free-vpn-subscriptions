...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2640-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-76ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-17_09:13_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2640
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 76 ms
- **Последнее обновление (UTC)**: 2026-05-17 09:13 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 4 · vless × 98 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 5 · `epodonios` × 2 · `lagzian-mix` × 5 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 60 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 4
