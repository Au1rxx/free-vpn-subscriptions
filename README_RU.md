...
![узлы](https://img.shields.io/badge/узлы-123-brightgreen) ![живые](https://img.shields.io/badge/живые-1810-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-357ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_05:12_UTC-informational)
...
- **Выбрано узлов**: 123
- **Живых во всех источниках**: 1810
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 357 ms
- **Последнее обновление (UTC)**: 2026-07-08 05:12 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 57 · trojan × 25 · vless × 17 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 5 · `ninjastrikers` × 25 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 1
