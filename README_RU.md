...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2360-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-73ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-23_06:38_UTC-informational)
...
- **Медиана RTT**: 73 ms
- **Последнее обновление (UTC)**: 2026-05-23 06:38 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 7 · vless × 100 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 19 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 70 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
