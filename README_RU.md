...
![узлы](https://img.shields.io/badge/узлы-100-brightgreen) ![живые](https://img.shields.io/badge/живые-1876-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-360ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-13_12:34_UTC-informational)
...
- **Выбрано узлов**: 100
- **Живых во всех источниках**: 1876
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 360 ms
- **Последнее обновление (UTC)**: 2026-06-13 12:34 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 56 · trojan × 23 · vless × 13 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 12 · `surfboard-eternity` × 2
