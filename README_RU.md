...
![узлы](https://img.shields.io/badge/узлы-137-brightgreen) ![живые](https://img.shields.io/badge/живые-2535-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-275ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_17:36_UTC-informational)
...
- **Выбрано узлов**: 137
- **Живых во всех источниках**: 2535
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 275 ms
- **Последнее обновление (UTC)**: 2026-05-09 17:36 UTC

**Распределение протоколов:** shadowsocks × 49 · trojan × 19 · vless × 61 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 58 · `pawdroid` × 1 · `ruking-clash` × 7 · `snakem982` × 3 · `surfboard-eternity` × 9
