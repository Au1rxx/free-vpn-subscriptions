...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2291-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-162ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-25_15:12_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2291
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 162 ms
- **Последнее обновление (UTC)**: 2026-04-25 15:12 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 18 · vless × 86 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 6
