...
![узлы](https://img.shields.io/badge/узлы-121-brightgreen) ![живые](https://img.shields.io/badge/живые-1906-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-359ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_04:38_UTC-informational)
...
- **Медиана RTT**: 359 ms
- **Последнее обновление (UTC)**: 2026-07-14 04:38 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 41 · trojan × 24 · vless × 26 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 6 · `ninjastrikers` × 23 · `pawdroid` × 6 · `ruking-clash` × 2 · `surfboard-eternity` × 3
