...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2378-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-398ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-18_12:27_UTC-informational)
...
- **Медиана RTT**: 398 ms
- **Последнее обновление (UTC)**: 2026-07-18 12:27 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 98 · vless × 13 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `mahdi0024` × 60 · `mahdibland-aggregator` × 34 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 5 · `ninjastrikers` × 3 · `pawdroid` × 8 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4
