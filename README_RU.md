...
![узлы](https://img.shields.io/badge/узлы-81-brightgreen) ![живые](https://img.shields.io/badge/живые-1751-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-317ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-08_13:32_UTC-informational)
...
- **Выбрано узлов**: 81
- **Живых во всех источниках**: 1751
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 317 ms
- **Последнее обновление (UTC)**: 2026-06-08 13:32 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 43 · trojan × 19 · vless × 12 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 4 · `surfboard-eternity` × 4
