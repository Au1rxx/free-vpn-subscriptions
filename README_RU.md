...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2090-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-82ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-03_01:35_UTC-informational)
...
- **Медиана RTT**: 82 ms
- **Последнее обновление (UTC)**: 2026-05-03 01:35 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 3 · vless × 101 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 62 · `pawdroid` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
