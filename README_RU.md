...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2619-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-76ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-17_16:25_UTC-informational)
...
- **Медиана RTT**: 76 ms
- **Последнее обновление (UTC)**: 2026-05-17 16:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 43 · trojan × 6 · vless × 94 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 4 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 42 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 49 · `pawdroid` × 2 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 4
