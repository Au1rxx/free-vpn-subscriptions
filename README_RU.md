...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1619-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-369ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-15_03:10_UTC-informational)
...
| 🇺🇸 United States (`US`) | 25 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1619
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 369 ms
- **Последнее обновление (UTC)**: 2026-07-15 03:10 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 107 · trojan × 14 · vless × 18 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 27 · `mahdi0024` × 11 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 4 · `snakem982` × 3 · `surfboard-eternity` × 1
