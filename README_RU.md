...
![узлы](https://img.shields.io/badge/узлы-127-brightgreen) ![живые](https://img.shields.io/badge/живые-2484-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-489ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-19_11:38_UTC-informational)
...
- **Выбрано узлов**: 127
- **Живых во всех источниках**: 2484
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 489 ms
- **Последнее обновление (UTC)**: 2026-06-19 11:38 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 32 · trojan × 27 · vless × 48 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 7
