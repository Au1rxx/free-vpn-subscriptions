...
![узлы](https://img.shields.io/badge/узлы-127-brightgreen) ![живые](https://img.shields.io/badge/живые-2023-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-289ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_22:21_UTC-informational)
...
- **Выбрано узлов**: 127
- **Живых во всех источниках**: 2023
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 289 ms
- **Последнее обновление (UTC)**: 2026-07-12 22:21 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 69 · trojan × 26 · vless × 18 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 10 · `ninjastrikers` × 17 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 8
