...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2473-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-129ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_17:30_UTC-informational)
...
- **Медиана RTT**: 129 ms
- **Последнее обновление (UTC)**: 2026-04-27 17:30 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 17 · vless × 93 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
