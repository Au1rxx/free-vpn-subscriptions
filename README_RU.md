...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-1849-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-354ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_07:11_UTC-informational)
...
- **Медиана RTT**: 354 ms
- **Последнее обновление (UTC)**: 2026-06-15 07:11 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 53 · trojan × 23 · vless × 18 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 19 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 4
