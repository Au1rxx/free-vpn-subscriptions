...
![узлы](https://img.shields.io/badge/узлы-109-brightgreen) ![живые](https://img.shields.io/badge/живые-1866-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-344ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_06:12_UTC-informational)
...
- **Выбрано узлов**: 109
- **Живых во всех источниках**: 1866
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 344 ms
- **Последнее обновление (UTC)**: 2026-06-15 06:12 UTC

**Распределение протоколов:** shadowsocks × 45 · trojan × 26 · vless × 25 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 29 · `pawdroid` × 1 · `ruking-clash` × 11 · `surfboard-eternity` × 2
