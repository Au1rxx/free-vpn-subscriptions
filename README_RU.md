...
![узлы](https://img.shields.io/badge/узлы-126-brightgreen) ![живые](https://img.shields.io/badge/живые-1889-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-305ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_02:20_UTC-informational)
...
- **Выбрано узлов**: 126
- **Живых во всех источниках**: 1889
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 305 ms
- **Последнее обновление (UTC)**: 2026-07-12 02:20 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 60 · trojan × 26 · vless × 22 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 6 · `ninjastrikers` × 24 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
