...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2473-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-77ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-21_14:33_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2473
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 77 ms
- **Последнее обновление (UTC)**: 2026-05-21 14:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 13 · vless × 83 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 58 · `pawdroid` × 10 · `ruking-clash` × 2 · `surfboard-eternity` × 8
