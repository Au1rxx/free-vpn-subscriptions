...
![узлы](https://img.shields.io/badge/узлы-99-brightgreen) ![живые](https://img.shields.io/badge/живые-1991-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-343ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_21:30_UTC-informational)
...
- **Выбрано узлов**: 99
- **Живых во всех источниках**: 1991
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 343 ms
- **Последнее обновление (UTC)**: 2026-06-10 21:30 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 18 · vless × 14 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
