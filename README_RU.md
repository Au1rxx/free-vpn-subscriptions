...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2224-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-88ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_01:10_UTC-informational)
...
- **Медиана RTT**: 88 ms
- **Последнее обновление (UTC)**: 2026-04-26 01:10 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 5 · vless × 100 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 33 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 62 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 7
