...
![узлы](https://img.shields.io/badge/узлы-121-brightgreen) ![живые](https://img.shields.io/badge/живые-1911-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-338ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-06_10:32_UTC-informational)
...
- **Медиана RTT**: 338 ms
- **Последнее обновление (UTC)**: 2026-07-06 10:32 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 48 · trojan × 30 · vless × 14 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 6
