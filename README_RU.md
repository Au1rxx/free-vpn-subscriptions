...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2270-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-158ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_09:38_UTC-informational)
...
- **Медиана RTT**: 158 ms
- **Последнее обновление (UTC)**: 2026-04-22 09:38 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 13 · vless × 92 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 34 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 71 · `ruking-clash` × 6 · `surfboard-eternity` × 7
