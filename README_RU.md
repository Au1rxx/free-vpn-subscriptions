...
![узлы](https://img.shields.io/badge/узлы-124-brightgreen) ![живые](https://img.shields.io/badge/живые-1836-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-357ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_00:23_UTC-informational)
...
- **Выбрано узлов**: 124
- **Живых во всех источниках**: 1836
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 357 ms
- **Последнее обновление (UTC)**: 2026-07-08 00:23 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 58 · trojan × 31 · vless × 19 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 7 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
