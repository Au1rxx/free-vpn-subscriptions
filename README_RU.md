...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2548-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-93ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_02:27_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2548
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 93 ms
- **Последнее обновление (UTC)**: 2026-04-27 02:27 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 3 · vless × 99 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 47 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 56 · `pawdroid` × 1 · `surfboard-eternity` × 4
