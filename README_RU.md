...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-1914-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-347ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_20:11_UTC-informational)
...
- **Медиана RTT**: 347 ms
- **Последнее обновление (UTC)**: 2026-07-04 20:11 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 55 · trojan × 21 · vless × 10 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 6 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 2
