...
![узлы](https://img.shields.io/badge/узлы-116-brightgreen) ![живые](https://img.shields.io/badge/живые-1829-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-277ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-08_00:13_UTC-informational)
...
- **Медиана RTT**: 277 ms
- **Последнее обновление (UTC)**: 2026-06-08 00:13 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 25 · vless × 35 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 36 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 6
