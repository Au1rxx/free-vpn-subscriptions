...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2264-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-186ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-30_23:13_UTC-informational)
...
- **Медиана RTT**: 186 ms
- **Последнее обновление (UTC)**: 2026-04-30 23:13 UTC

**Распределение протоколов:** shadowsocks × 25 · trojan × 23 · vless × 81 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 43 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 52 · `surfboard-eternity` × 7
