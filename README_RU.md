...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1998-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-363ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-23_01:22_UTC-informational)
...
- **Медиана RTT**: 363 ms
- **Последнее обновление (UTC)**: 2026-06-23 01:22 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 28 · vless × 68 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 57 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 24 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
