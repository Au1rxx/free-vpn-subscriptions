...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-1799-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-337ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-11_08:35_UTC-informational)
...
- **Выбрано узлов**: 114
- **Живых во всех источниках**: 1799
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 337 ms
- **Последнее обновление (UTC)**: 2026-07-11 08:35 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 55 · trojan × 20 · vless × 23 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 6 · `ninjastrikers` × 22 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 1
