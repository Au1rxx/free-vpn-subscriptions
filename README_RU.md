...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2223-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-121ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-03_13:27_UTC-informational)
...
- **Медиана RTT**: 121 ms
- **Последнее обновление (UTC)**: 2026-05-03 13:27 UTC

**Распределение протоколов:** shadowsocks × 25 · trojan × 24 · vless × 91 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 35 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 60 · `pawdroid` × 1 · `surfboard-eternity` × 5
