...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2475-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-103ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_07:19_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2475
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 103 ms
- **Последнее обновление (UTC)**: 2026-05-10 07:19 UTC

**Распределение протоколов:** shadowsocks × 44 · trojan × 4 · vless × 94 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 74 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
