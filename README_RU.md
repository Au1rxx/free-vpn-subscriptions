...
![узлы](https://img.shields.io/badge/узлы-119-brightgreen) ![живые](https://img.shields.io/badge/живые-1953-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-333ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-06_06:26_UTC-informational)
...
- **Выбрано узлов**: 119
- **Живых во всех источниках**: 1953
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 333 ms
- **Последнее обновление (UTC)**: 2026-07-06 06:26 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 50 · trojan × 26 · vless × 12 · vmess × 30

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 5
