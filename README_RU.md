...
![узлы](https://img.shields.io/badge/узлы-147-brightgreen) ![живые](https://img.shields.io/badge/живые-1882-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-368ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-16_02:25_UTC-informational)
...
- **Выбрано узлов**: 147
- **Живых во всех источниках**: 1882
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 368 ms
- **Последнее обновление (UTC)**: 2026-07-16 02:25 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 63 · trojan × 45 · vless × 24 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `mahdi0024` × 19 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 11 · `ninjastrikers` × 26 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 11 · `surfboard-eternity` × 2
