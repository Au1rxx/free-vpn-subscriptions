...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2192-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-81ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_09:22_UTC-informational)
...
- **Медиана RTT**: 81 ms
- **Последнее обновление (UTC)**: 2026-04-26 09:22 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 10 · vless × 103 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 67 · `pawdroid` × 4 · `surfboard-eternity` × 7 · `vxiaov-clash` × 2
