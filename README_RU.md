...
![узлы](https://img.shields.io/badge/узлы-106-brightgreen) ![живые](https://img.shields.io/badge/живые-1867-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-358ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_23:16_UTC-informational)
...
- **Выбрано узлов**: 106
- **Живых во всех источниках**: 1867
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 358 ms
- **Последнее обновление (UTC)**: 2026-06-15 23:16 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 50 · trojan × 26 · vless × 16 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 3
