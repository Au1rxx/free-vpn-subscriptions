...
![узлы](https://img.shields.io/badge/узлы-118-brightgreen) ![живые](https://img.shields.io/badge/живые-1956-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-300ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-13_00:25_UTC-informational)
...
- **Медиана RTT**: 300 ms
- **Последнее обновление (UTC)**: 2026-06-13 00:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 55 · trojan × 24 · vless × 30 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 35 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 6
