...
![узлы](https://img.shields.io/badge/узлы-106-brightgreen) ![живые](https://img.shields.io/badge/живые-2122-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-349ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-02_07:33_UTC-informational)
...
- **Выбрано узлов**: 106
- **Живых во всех источниках**: 2122
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 349 ms
- **Последнее обновление (UTC)**: 2026-07-02 07:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 47 · trojan × 30 · vless × 19 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 8 · `ninjastrikers` × 22 · `pawdroid` × 2 · `surfboard-eternity` × 4
