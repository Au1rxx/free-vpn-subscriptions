...
![узлы](https://img.shields.io/badge/узлы-100-brightgreen) ![живые](https://img.shields.io/badge/живые-1973-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-251ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_16:39_UTC-informational)
...
- **Медиана RTT**: 251 ms
- **Последнее обновление (UTC)**: 2026-07-05 16:39 UTC

**Распределение протоколов:** hysteria2 × 3 · shadowsocks × 36 · trojan × 25 · vless × 8 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 6 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 2
