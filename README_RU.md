...
![узлы](https://img.shields.io/badge/узлы-149-brightgreen) ![живые](https://img.shields.io/badge/живые-2344-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-375ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-08_21:11_UTC-informational)
...
- **Выбрано узлов**: 149
- **Живых во всех источниках**: 2344
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 375 ms
- **Последнее обновление (UTC)**: 2026-05-08 21:11 UTC

**Распределение протоколов:** shadowsocks × 53 · trojan × 21 · vless × 66 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
