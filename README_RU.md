...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2398-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-107ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-13_04:28_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2398
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 107 ms
- **Последнее обновление (UTC)**: 2026-05-13 04:28 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 2 · vless × 96 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 40 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
