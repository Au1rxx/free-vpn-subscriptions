...
![узлы](https://img.shields.io/badge/узлы-136-brightgreen) ![живые](https://img.shields.io/badge/живые-2469-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-217ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_22:26_UTC-informational)
...
- **Выбрано узлов**: 136
- **Живых во всех источниках**: 2469
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 217 ms
- **Последнее обновление (UTC)**: 2026-04-23 22:26 UTC

**Распределение протоколов:** shadowsocks × 20 · trojan × 23 · vless × 74 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 7
