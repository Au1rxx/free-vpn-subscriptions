...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2462-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-76ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-18_11:25_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2462
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 76 ms
- **Последнее обновление (UTC)**: 2026-05-18 11:25 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 8 · vless × 93 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 37 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
