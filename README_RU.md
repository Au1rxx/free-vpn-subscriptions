...
![узлы](https://img.shields.io/badge/узлы-87-brightgreen) ![живые](https://img.shields.io/badge/живые-2141-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-272ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-28_16:09_UTC-informational)
...
- **Медиана RTT**: 272 ms
- **Последнее обновление (UTC)**: 2026-06-28 16:09 UTC

**Распределение протоколов:** shadowsocks × 18 · trojan × 33 · vless × 19 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 3
