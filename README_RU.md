...
![узлы](https://img.shields.io/badge/узлы-81-brightgreen) ![живые](https://img.shields.io/badge/живые-2055-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-159ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_05:16_UTC-informational)
...
- **Медиана RTT**: 159 ms
- **Последнее обновление (UTC)**: 2026-07-04 05:16 UTC

**Распределение протоколов:** shadowsocks × 25 · trojan × 23 · vless × 13 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 6 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
