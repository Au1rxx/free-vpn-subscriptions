...
![узлы](https://img.shields.io/badge/узлы-93-brightgreen) ![живые](https://img.shields.io/badge/живые-2003-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-271ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-26_22:13_UTC-informational)
...
- **Медиана RTT**: 271 ms
- **Последнее обновление (UTC)**: 2026-06-26 22:13 UTC

**Распределение протоколов:** shadowsocks × 19 · trojan × 37 · vless × 17 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `ruking-clash` × 19 · `surfboard-eternity` × 3
