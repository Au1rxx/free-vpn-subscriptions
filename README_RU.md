...
![узлы](https://img.shields.io/badge/узлы-117-brightgreen) ![живые](https://img.shields.io/badge/живые-1901-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-324ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-13_04:35_UTC-informational)
...
- **Выбрано узлов**: 117
- **Живых во всех источниках**: 1901
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 324 ms
- **Последнее обновление (UTC)**: 2026-06-13 04:35 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 51 · trojan × 30 · vless × 26 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 32 · `pawdroid` × 7 · `ruking-clash` × 9 · `surfboard-eternity` × 2
