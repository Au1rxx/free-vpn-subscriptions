...
![узлы](https://img.shields.io/badge/узлы-101-brightgreen) ![живые](https://img.shields.io/badge/живые-1947-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-352ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_12:30_UTC-informational)
...
- **Выбрано узлов**: 101
- **Живых во всех источниках**: 1947
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 352 ms
- **Последнее обновление (UTC)**: 2026-07-13 12:30 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 50 · trojan × 19 · vless × 16 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 25 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 6 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
