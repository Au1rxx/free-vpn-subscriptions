...
![узлы](https://img.shields.io/badge/узлы-128-brightgreen) ![живые](https://img.shields.io/badge/живые-1814-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-274ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-09_01:15_UTC-informational)
...
- **Выбрано узлов**: 128
- **Живых во всех источниках**: 1814
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 274 ms
- **Последнее обновление (UTC)**: 2026-07-09 01:15 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 29 · vless × 26 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 7 · `ninjastrikers` × 22 · `pawdroid` × 8 · `ruking-clash` × 3 · `snakem982` × 4 · `surfboard-eternity` × 5
