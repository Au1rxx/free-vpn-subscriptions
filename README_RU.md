...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2619-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-79ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-17_21:36_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 64 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2619
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 79 ms
- **Последнее обновление (UTC)**: 2026-05-17 21:36 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 42 · trojan × 14 · vless × 86 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 6 · `epodonios` × 3 · `lagzian-mix` × 6 · `mahdi0024` × 37 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 6 · `ruking-clash` × 8 · `surfboard-eternity` × 3 · `vxiaov-clash` × 2
