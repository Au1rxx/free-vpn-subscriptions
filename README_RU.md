...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1909-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-153ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-12_12:29_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1909
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 153 ms
- **Последнее обновление (UTC)**: 2026-05-12 12:29 UTC

**Распределение протоколов:** shadowsocks × 57 · trojan × 9 · vless × 75 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 5 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 58 · `pawdroid` × 5 · `snakem982` × 1 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
