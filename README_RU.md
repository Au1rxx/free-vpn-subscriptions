...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2193-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-250ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-30_16:34_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2193
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 250 ms
- **Последнее обновление (UTC)**: 2026-04-30 16:34 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 19 · vless × 74 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 53 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
