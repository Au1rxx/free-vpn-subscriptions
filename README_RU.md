...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1958-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-225ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-07_17:31_UTC-informational)
...
- **Медиана RTT**: 225 ms
- **Последнее обновление (UTC)**: 2026-05-07 17:31 UTC

**Распределение протоколов:** shadowsocks × 61 · trojan × 8 · vless × 72 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 8 · `mahdi0024` × 12 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 57 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
