...
![узлы](https://img.shields.io/badge/узлы-96-brightgreen) ![живые](https://img.shields.io/badge/живые-1949-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-262ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-06_18:31_UTC-informational)
...
- **Выбрано узлов**: 96
- **Живых во всех источниках**: 1949
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 262 ms
- **Последнее обновление (UTC)**: 2026-07-06 18:31 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 41 · trojan × 19 · vless × 16 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 21 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 8 · `ninjastrikers` × 7 · `pawdroid` × 10 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
