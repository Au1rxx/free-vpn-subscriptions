...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2087-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-119ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-29_13:34_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2087
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 119 ms
- **Последнее обновление (UTC)**: 2026-04-29 13:34 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 6 · vless × 94 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 57 · `ruking-clash` × 7 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
