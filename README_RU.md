...
![узлы](https://img.shields.io/badge/узлы-117-brightgreen) ![живые](https://img.shields.io/badge/живые-1980-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-110ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-04_01:22_UTC-informational)
...
- **Медиана RTT**: 110 ms
- **Последнее обновление (UTC)**: 2026-06-04 01:22 UTC

**Распределение протоколов:** shadowsocks × 25 · trojan × 46 · vless × 35 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 4 · `ninjastrikers` × 29 · `pawdroid` × 1 · `surfboard-eternity` × 2
