...
![узлы](https://img.shields.io/badge/узлы-128-brightgreen) ![живые](https://img.shields.io/badge/живые-2544-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-472ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-19_06:37_UTC-informational)
...
- **Выбрано узлов**: 128
- **Живых во всех источниках**: 2544
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 472 ms
- **Последнее обновление (UTC)**: 2026-06-19 06:37 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 35 · trojan × 23 · vless × 55 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 34 · `snakem982` × 5 · `surfboard-eternity` × 1
