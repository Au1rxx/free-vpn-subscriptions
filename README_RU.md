...
![узлы](https://img.shields.io/badge/узлы-91-brightgreen) ![живые](https://img.shields.io/badge/живые-2021-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-354ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-29_23:24_UTC-informational)
...
- **Медиана RTT**: 354 ms
- **Последнее обновление (UTC)**: 2026-06-29 23:24 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 35 · vless × 10 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 5 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 13 · `surfboard-eternity` × 2
