...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2521-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-90ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-20_10:41_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2521
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 90 ms
- **Последнее обновление (UTC)**: 2026-04-20 10:41 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 9 · vless × 107 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 35 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 1 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 4
