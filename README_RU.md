...
![узлы](https://img.shields.io/badge/узлы-120-brightgreen) ![живые](https://img.shields.io/badge/живые-2018-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-319ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-25_10:38_UTC-informational)
...
- **Выбрано узлов**: 120
- **Живых во всех источниках**: 2018
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 319 ms
- **Последнее обновление (UTC)**: 2026-06-25 10:38 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 39 · trojan × 29 · vless × 36 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 31 · `lagzian-mix` × 3 · `mahdi0024` × 20 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 6
