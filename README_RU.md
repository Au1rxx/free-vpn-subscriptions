...
![узлы](https://img.shields.io/badge/узлы-92-brightgreen) ![живые](https://img.shields.io/badge/живые-2092-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-333ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_18:22_UTC-informational)
...
- **Выбрано узлов**: 92
- **Живых во всех источниках**: 2092
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 333 ms
- **Последнее обновление (UTC)**: 2026-06-10 18:22 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 43 · trojan × 13 · vless × 14 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 2
