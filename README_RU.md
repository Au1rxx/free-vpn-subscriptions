...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2251-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-441ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_22:29_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2251
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 441 ms
- **Последнее обновление (UTC)**: 2026-04-21 22:29 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 22 · vless × 84 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 47 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 5
