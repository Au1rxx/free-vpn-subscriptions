...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2372-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-76ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-23_09:37_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2372
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 76 ms
- **Последнее обновление (UTC)**: 2026-05-23 09:37 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 5 · vless × 101 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 68 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
