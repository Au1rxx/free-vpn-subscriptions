...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1620-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-381ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_22:17_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1620
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 381 ms
- **Последнее обновление (UTC)**: 2026-07-14 22:17 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 99 · trojan × 29 · vless × 13 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `mahdi0024` × 12 · `mahdibland-aggregator` × 32 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 6 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
