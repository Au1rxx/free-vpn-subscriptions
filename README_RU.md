...
![узлы](https://img.shields.io/badge/узлы-81-brightgreen) ![живые](https://img.shields.io/badge/живые-2173-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-172ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-06_09:33_UTC-informational)
...
- **Медиана RTT**: 172 ms
- **Последнее обновление (UTC)**: 2026-06-06 09:33 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 24 · vless × 16 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 25 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 1
