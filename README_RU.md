...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-1779-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-360ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_14:33_UTC-informational)
...
- **Выбрано узлов**: 114
- **Живых во всех источниках**: 1779
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 360 ms
- **Последнее обновление (UTC)**: 2026-07-08 14:33 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 56 · trojan × 21 · vless × 12 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 4 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 5
