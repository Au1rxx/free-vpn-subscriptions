...
![узлы](https://img.shields.io/badge/узлы-108-brightgreen) ![живые](https://img.shields.io/badge/живые-2188-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-198ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-11_02:23_UTC-informational)
...
- **Выбрано узлов**: 108
- **Живых во всех источниках**: 2188
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 198 ms
- **Последнее обновление (UTC)**: 2026-06-11 02:23 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 31 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 17 · `ninjastrikers` × 33 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 3
