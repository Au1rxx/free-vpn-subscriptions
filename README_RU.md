...
![узлы](https://img.shields.io/badge/узлы-142-brightgreen) ![живые](https://img.shields.io/badge/живые-2241-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-411ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_23:36_UTC-informational)
...
- **Медиана RTT**: 411 ms
- **Последнее обновление (UTC)**: 2026-04-21 23:36 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 23 · vless × 71 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 4 · `surfboard-eternity` × 6
