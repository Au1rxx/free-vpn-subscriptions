...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2266-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-125ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_00:15_UTC-informational)
...
- **Медиана RTT**: 125 ms
- **Последнее обновление (UTC)**: 2026-04-21 00:15 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 4 · vless × 111 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 52 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7
