...
![узлы](https://img.shields.io/badge/узлы-74-brightgreen) ![живые](https://img.shields.io/badge/живые-2173-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-171ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-06_12:28_UTC-informational)
...
- **Медиана RTT**: 171 ms
- **Последнее обновление (UTC)**: 2026-06-06 12:28 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 25 · vless × 5 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
