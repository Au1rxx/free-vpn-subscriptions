...
![узлы](https://img.shields.io/badge/узлы-123-brightgreen) ![живые](https://img.shields.io/badge/живые-2492-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-439ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_21:14_UTC-informational)
...
- **Выбрано узлов**: 123
- **Живых во всех источниках**: 2492
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 439 ms
- **Последнее обновление (UTC)**: 2026-04-23 21:14 UTC

**Распределение протоколов:** shadowsocks × 14 · trojan × 25 · vless × 70 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 47 · `pawdroid` × 2 · `surfboard-eternity` × 1
