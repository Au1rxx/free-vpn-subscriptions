...
![узлы](https://img.shields.io/badge/узлы-149-brightgreen) ![живые](https://img.shields.io/badge/живые-1654-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-393ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-15_13:13_UTC-informational)
...
- **Выбрано узлов**: 149
- **Живых во всех источниках**: 1654
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 393 ms
- **Последнее обновление (UTC)**: 2026-07-15 13:13 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 93 · trojan × 35 · vless × 12 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 20 · `mahdi0024` × 13 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 9 · `surfboard-eternity` × 4
