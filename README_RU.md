...
![узлы](https://img.shields.io/badge/узлы-116-brightgreen) ![живые](https://img.shields.io/badge/живые-1780-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-365ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-18_01:09_UTC-informational)
...
- **Медиана RTT**: 365 ms
- **Последнее обновление (UTC)**: 2026-06-18 01:09 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 47 · trojan × 29 · vless × 32 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 24 · `pawdroid` × 1 · `ruking-clash` × 15 · `surfboard-eternity` × 4
