...
![узлы](https://img.shields.io/badge/узлы-115-brightgreen) ![живые](https://img.shields.io/badge/живые-1905-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-355ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_07:27_UTC-informational)
...
- **Медиана RTT**: 355 ms
- **Последнее обновление (UTC)**: 2026-07-14 07:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 18 · vless × 18 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 8 · `mahdi0024` × 22 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 19 · `pawdroid` × 10 · `snakem982` × 1 · `surfboard-eternity` × 3
