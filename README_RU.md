...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2089-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-165ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-03_14:31_UTC-informational)
...
- **Медиана RTT**: 165 ms
- **Последнее обновление (UTC)**: 2026-05-03 14:31 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 25 · vless × 87 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 59 · `pawdroid` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
