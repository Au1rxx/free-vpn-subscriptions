...
![узлы](https://img.shields.io/badge/узлы-70-brightgreen) ![живые](https://img.shields.io/badge/живые-2103-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-154ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-10_11:23_UTC-informational)
...
- **Медиана RTT**: 154 ms
- **Последнее обновление (UTC)**: 2026-07-10 11:23 UTC

**Распределение протоколов:** shadowsocks × 20 · trojan × 9 · vless × 14 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 5 · `ninjastrikers` × 12 · `pawdroid` × 2
