...
![узлы](https://img.shields.io/badge/узлы-84-brightgreen) ![живые](https://img.shields.io/badge/живые-2007-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-264ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-26_18:36_UTC-informational)
...
- **Медиана RTT**: 264 ms
- **Последнее обновление (UTC)**: 2026-06-26 18:36 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 28 · vless × 15 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 5
