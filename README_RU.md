...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2618-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-76ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-17_18:12_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2618
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 76 ms
- **Последнее обновление (UTC)**: 2026-05-17 18:12 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 44 · trojan × 7 · vless × 92 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 5 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 39 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 47 · `pawdroid` × 6 · `ruking-clash` × 9 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
