...
![узлы](https://img.shields.io/badge/узлы-84-brightgreen) ![живые](https://img.shields.io/badge/живые-2086-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-178ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-06_19:33_UTC-informational)
...
- **Выбрано узлов**: 84
- **Живых во всех источниках**: 2086
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 178 ms
- **Последнее обновление (UTC)**: 2026-06-06 19:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 32 · trojan × 20 · vless × 7 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 39 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 2
