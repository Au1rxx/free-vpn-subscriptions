...
![узлы](https://img.shields.io/badge/узлы-105-brightgreen) ![живые](https://img.shields.io/badge/живые-1963-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-352ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-26_05:22_UTC-informational)
...
- **Медиана RTT**: 352 ms
- **Последнее обновление (UTC)**: 2026-06-26 05:22 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 37 · vless × 26 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `ruking-clash` × 18 · `surfboard-eternity` × 4
