...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1987-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-166ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-07_10:27_UTC-informational)
...
- **Медиана RTT**: 166 ms
- **Последнее обновление (UTC)**: 2026-05-07 10:27 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 16 · vless × 88 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 73 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
