...
![узлы](https://img.shields.io/badge/узлы-98-brightgreen) ![живые](https://img.shields.io/badge/живые-1905-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-346ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-06_21:25_UTC-informational)
...
- **Выбрано узлов**: 98
- **Живых во всех источниках**: 1905
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 346 ms
- **Последнее обновление (UTC)**: 2026-07-06 21:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 46 · trojan × 25 · vless × 8 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
