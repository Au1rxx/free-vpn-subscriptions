...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2595-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-104ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-14_21:16_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2595
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 104 ms
- **Последнее обновление (UTC)**: 2026-05-14 21:16 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 23 · vless × 84 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 7 · `ninjastrikers` × 52 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 6
