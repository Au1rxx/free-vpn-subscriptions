...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2220-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-100ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-30_06:30_UTC-informational)
...
- **Медиана RTT**: 100 ms
- **Последнее обновление (UTC)**: 2026-04-30 06:30 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 10 · vless × 97 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 14 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 71 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
