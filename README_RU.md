...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2186-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-117ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-01_13:16_UTC-informational)
...
- **Медиана RTT**: 117 ms
- **Последнее обновление (UTC)**: 2026-05-01 13:16 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 13 · vless × 81 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `snakem982` × 1 · `surfboard-eternity` × 4
