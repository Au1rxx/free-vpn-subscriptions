...
![узлы](https://img.shields.io/badge/узлы-84-brightgreen) ![живые](https://img.shields.io/badge/живые-2118-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-291ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-28_15:16_UTC-informational)
...
- **Медиана RTT**: 291 ms
- **Последнее обновление (UTC)**: 2026-06-28 15:16 UTC

**Распределение протоколов:** shadowsocks × 17 · trojan × 30 · vless × 19 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 2
