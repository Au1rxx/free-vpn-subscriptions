...
![узлы](https://img.shields.io/badge/узлы-145-brightgreen) ![живые](https://img.shields.io/badge/живые-1942-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-418ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-21_23:32_UTC-informational)
...
- **Выбрано узлов**: 145
- **Живых во всех источниках**: 1942
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 418 ms
- **Последнее обновление (UTC)**: 2026-06-21 23:32 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 45 · trojan × 32 · vless × 52 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 5 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 34 · `snakem982` × 2 · `surfboard-eternity` × 3
