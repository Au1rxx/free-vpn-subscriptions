...
![узлы](https://img.shields.io/badge/узлы-86-brightgreen) ![живые](https://img.shields.io/badge/живые-2128-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-345ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-28_14:39_UTC-informational)
...
- **Медиана RTT**: 345 ms
- **Последнее обновление (UTC)**: 2026-06-28 14:39 UTC

**Распределение протоколов:** shadowsocks × 17 · trojan × 32 · vless × 19 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 2
