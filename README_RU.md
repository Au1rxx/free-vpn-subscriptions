...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2471-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-75ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-18_10:39_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2471
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 75 ms
- **Последнее обновление (UTC)**: 2026-05-18 10:39 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 45 · trojan × 6 · vless × 92 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `epodonios` × 2 · `lagzian-mix` × 5 · `mahdi0024` × 39 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 5 · `ruking-clash` × 11 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
