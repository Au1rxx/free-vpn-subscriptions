...
![узлы](https://img.shields.io/badge/узлы-109-brightgreen) ![живые](https://img.shields.io/badge/живые-1686-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-405ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-13_23:25_UTC-informational)
...
- **Выбрано узлов**: 109
- **Живых во всех источниках**: 1686
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 405 ms
- **Последнее обновление (UTC)**: 2026-06-13 23:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 54 · trojan × 32 · vless × 15 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 14 · `surfboard-eternity` × 4
