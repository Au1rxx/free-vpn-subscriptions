...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2599-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-70ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-20_09:11_UTC-informational)
...
- **Медиана RTT**: 70 ms
- **Последнее обновление (UTC)**: 2026-05-20 09:11 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 7 · vless × 94 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 70 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
