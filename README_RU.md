...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2103-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-101ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-29_01:33_UTC-informational)
...
- **Медиана RTT**: 101 ms
- **Последнее обновление (UTC)**: 2026-04-29 01:33 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 5 · vless × 102 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7
