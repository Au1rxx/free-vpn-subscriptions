...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2196-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-149ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_09:19_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2196
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 149 ms
- **Последнее обновление (UTC)**: 2026-04-21 09:19 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 2 · vless × 105 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 53 · `epodonios` × 3 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 56 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
