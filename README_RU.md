...
![узлы](https://img.shields.io/badge/узлы-72-brightgreen) ![живые](https://img.shields.io/badge/живые-1985-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-178ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_10:19_UTC-informational)
...
- **Медиана RTT**: 178 ms
- **Последнее обновление (UTC)**: 2026-07-04 10:19 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 20 · vless × 6 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
