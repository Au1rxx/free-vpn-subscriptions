...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2215-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-113ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_05:16_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2215
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 113 ms
- **Последнее обновление (UTC)**: 2026-04-21 05:16 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 1 · vless × 107 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 48 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 57 · `ruking-clash` × 6 · `surfboard-eternity` × 8
