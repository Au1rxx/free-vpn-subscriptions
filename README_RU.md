...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2086-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-154ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-01_22:39_UTC-informational)
...
- **Медиана RTT**: 154 ms
- **Последнее обновление (UTC)**: 2026-05-01 22:39 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 19 · vless × 80 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 3 · `surfboard-eternity` × 11
