...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2589-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-94ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-28_05:37_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2589
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 94 ms
- **Последнее обновление (UTC)**: 2026-04-28 05:37 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 10 · vless × 109 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 4
