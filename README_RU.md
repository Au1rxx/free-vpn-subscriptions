...
![узлы](https://img.shields.io/badge/узлы-143-brightgreen) ![живые](https://img.shields.io/badge/живые-2607-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-164ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-24_17:40_UTC-informational)
...
- **Выбрано узлов**: 143
- **Живых во всех источниках**: 2607
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 164 ms
- **Последнее обновление (UTC)**: 2026-04-24 17:40 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 21 · vless × 85 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 34 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 60 · `pawdroid` × 2 · `surfboard-eternity` × 1
