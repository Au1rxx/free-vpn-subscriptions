...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2440-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-79ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-15_09:14_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2440
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 79 ms
- **Последнее обновление (UTC)**: 2026-05-15 09:14 UTC

**Распределение протоколов:** shadowsocks × 44 · trojan × 6 · vless × 91 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 57 · `pawdroid` × 8 · `ruking-clash` × 5 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
