...
![узлы](https://img.shields.io/badge/узлы-85-brightgreen) ![живые](https://img.shields.io/badge/живые-2132-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-147ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-09_17:27_UTC-informational)
...
- **Медиана RTT**: 147 ms
- **Последнее обновление (UTC)**: 2026-07-09 17:27 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 10 · vless × 21 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 37 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 10 · `pawdroid` × 8 · `ruking-clash` × 2
