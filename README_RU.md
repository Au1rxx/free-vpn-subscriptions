...
![узлы](https://img.shields.io/badge/узлы-128-brightgreen) ![живые](https://img.shields.io/badge/живые-2134-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-87ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-25_20:19_UTC-informational)
...
- **Выбрано узлов**: 128
- **Живых во всех источниках**: 2134
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 87 ms
- **Последнее обновление (UTC)**: 2026-05-25 20:19 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 26 · vless × 58 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 49 · `pawdroid` × 7 · `ruking-clash` × 10 · `surfboard-eternity` × 5
