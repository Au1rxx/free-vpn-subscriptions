...
![узлы](https://img.shields.io/badge/узлы-146-brightgreen) ![живые](https://img.shields.io/badge/живые-1888-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-478ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-22_14:22_UTC-informational)
...
- **Выбрано узлов**: 146
- **Живых во всех источниках**: 1888
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 478 ms
- **Последнее обновление (UTC)**: 2026-06-22 14:22 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 29 · vless × 63 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 41 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 31 · `snakem982` × 3 · `surfboard-eternity` × 2
