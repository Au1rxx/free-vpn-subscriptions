...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2278-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-147ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-05_01:28_UTC-informational)
...
- **Медиана RTT**: 147 ms
- **Последнее обновление (UTC)**: 2026-05-05 01:28 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 10 · vless × 95 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 78 · `pawdroid` × 2 · `surfboard-eternity` × 7
