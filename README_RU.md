...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2314-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-436ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_17:19_UTC-informational)
...
- **Медиана RTT**: 436 ms
- **Последнее обновление (UTC)**: 2026-04-21 17:19 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 18 · vless × 86 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 48 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 52 · `ruking-clash` × 6 · `surfboard-eternity` × 4
