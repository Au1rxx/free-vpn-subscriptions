...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2218-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-123ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_06:21_UTC-informational)
...
- **Медиана RTT**: 123 ms
- **Последнее обновление (UTC)**: 2026-04-22 06:21 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 4 · vless × 98 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 38 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 9
