...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2661-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-74ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-17_12:32_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2661
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 74 ms
- **Последнее обновление (UTC)**: 2026-05-17 12:32 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 9 · vless × 89 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 6 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 5 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 5
