...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2281-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-171ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-25_17:36_UTC-informational)
...
- **Медиана RTT**: 171 ms
- **Последнее обновление (UTC)**: 2026-04-25 17:36 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 18 · vless × 85 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 55 · `snakem982` × 3 · `surfboard-eternity` × 7
