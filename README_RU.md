...
![узлы](https://img.shields.io/badge/узлы-128-brightgreen) ![живые](https://img.shields.io/badge/живые-2541-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-346ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_21:23_UTC-informational)
...
- **Выбрано узлов**: 128
- **Живых во всех источниках**: 2541
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 346 ms
- **Последнее обновление (UTC)**: 2026-04-22 21:23 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 21 · vless × 67 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
