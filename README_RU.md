...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2475-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-80ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-17_02:39_UTC-informational)
...
- **Медиана RTT**: 80 ms
- **Последнее обновление (UTC)**: 2026-05-17 02:39 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 5 · vless × 97 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 37 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 55 · `pawdroid` × 6 · `ruking-clash` × 6 · `surfboard-eternity` × 5
