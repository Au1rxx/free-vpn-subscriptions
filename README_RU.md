...
![узлы](https://img.shields.io/badge/узлы-77-brightgreen) ![живые](https://img.shields.io/badge/живые-1989-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-163ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_08:22_UTC-informational)
...
- **Медиана RTT**: 163 ms
- **Последнее обновление (UTC)**: 2026-07-04 08:22 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 20 · vless × 11 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 5 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
