...
![узлы](https://img.shields.io/badge/узлы-108-brightgreen) ![живые](https://img.shields.io/badge/живые-1981-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-278ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_10:22_UTC-informational)
...
- **Медиана RTT**: 278 ms
- **Последнее обновление (UTC)**: 2026-07-05 10:22 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 48 · trojan × 23 · vless × 10 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 32 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 9
