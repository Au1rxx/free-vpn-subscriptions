...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2438-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-115ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_05:26_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2438
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 115 ms
- **Последнее обновление (UTC)**: 2026-05-11 05:26 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 5 · vless × 96 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 74 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 7
