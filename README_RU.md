...
![узлы](https://img.shields.io/badge/узлы-72-brightgreen) ![живые](https://img.shields.io/badge/живые-2157-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-169ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-06_13:11_UTC-informational)
...
- **Медиана RTT**: 169 ms
- **Последнее обновление (UTC)**: 2026-06-06 13:11 UTC

**Распределение протоколов:** shadowsocks × 24 · trojan × 24 · vless × 7 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3
