...
![узлы](https://img.shields.io/badge/узлы-136-brightgreen) ![живые](https://img.shields.io/badge/живые-2433-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-115ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-24_11:21_UTC-informational)
...
- **Медиана RTT**: 115 ms
- **Последнее обновление (UTC)**: 2026-04-24 11:21 UTC

**Распределение протоколов:** shadowsocks × 11 · trojan × 21 · vless × 91 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 67 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
