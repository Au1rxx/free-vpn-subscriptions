...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2500-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-88ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-15_19:28_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 60 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2500
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 88 ms
- **Последнее обновление (UTC)**: 2026-05-15 19:28 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 14 · vless × 92 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 48 · `pawdroid` × 10 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 4
