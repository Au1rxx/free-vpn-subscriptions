...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2294-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-120ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-20_02:25_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2294
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 120 ms
- **Последнее обновление (UTC)**: 2026-05-20 02:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 38 · trojan × 6 · vless × 84 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 63 · `pawdroid` × 8 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
