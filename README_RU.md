...
![узлы](https://img.shields.io/badge/узлы-130-brightgreen) ![живые](https://img.shields.io/badge/живые-1939-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-469ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-17_06:16_UTC-informational)
...
- **Выбрано узлов**: 130
- **Живых во всех источниках**: 1939
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 469 ms
- **Последнее обновление (UTC)**: 2026-06-17 06:16 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 27 · vless × 23 · vmess × 39

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 41 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
