...
![узлы](https://img.shields.io/badge/узлы-104-brightgreen) ![живые](https://img.shields.io/badge/живые-2226-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-155ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_03:14_UTC-informational)
...
- **Выбрано узлов**: 104
- **Живых во всех источниках**: 2226
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 155 ms
- **Последнее обновление (UTC)**: 2026-06-07 03:14 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 24 · vless × 26 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 33 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 1
