...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2439-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-259ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_23:24_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2439
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 259 ms
- **Последнее обновление (UTC)**: 2026-05-10 23:24 UTC

**Распределение протоколов:** shadowsocks × 49 · trojan × 16 · vless × 76 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 5 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
