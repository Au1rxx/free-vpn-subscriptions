...
![узлы](https://img.shields.io/badge/узлы-147-brightgreen) ![живые](https://img.shields.io/badge/живые-1502-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-375ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-09_05:18_UTC-informational)
...
- **Выбрано узлов**: 147
- **Живых во всех источниках**: 1502
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 375 ms
- **Последнее обновление (UTC)**: 2026-07-09 05:18 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 74 · trojan × 28 · vless × 17 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 30 · `matin-v2ray` × 5 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 6
