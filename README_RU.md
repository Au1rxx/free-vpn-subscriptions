...
![узлы](https://img.shields.io/badge/узлы-143-brightgreen) ![живые](https://img.shields.io/badge/живые-2305-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-94ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-24_21:25_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 79 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Медиана RTT**: 94 ms
- **Последнее обновление (UTC)**: 2026-05-24 21:25 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 21 · vless × 52 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 48 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 45 · `pawdroid` × 5 · `ruking-clash` × 4 · `surfboard-eternity` × 3
