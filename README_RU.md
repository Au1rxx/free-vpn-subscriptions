...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1937-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-122ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-08_00:12_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1937
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 122 ms
- **Последнее обновление (UTC)**: 2026-05-08 00:12 UTC

**Распределение протоколов:** shadowsocks × 50 · trojan × 4 · vless × 86 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 70 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
