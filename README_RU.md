...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-1919-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-339ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_00:27_UTC-informational)
...
- **Медиана RTT**: 339 ms
- **Последнее обновление (UTC)**: 2026-07-14 00:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 39 · trojan × 25 · vless × 17 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 29 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 6 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
