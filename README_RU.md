...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2041-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-78ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-22_08:17_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2041
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 78 ms
- **Последнее обновление (UTC)**: 2026-05-22 08:17 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 9 · vless × 86 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 3 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
