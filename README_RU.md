...
![узлы](https://img.shields.io/badge/узлы-74-brightgreen) ![живые](https://img.shields.io/badge/живые-1896-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-162ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-03_11:30_UTC-informational)
...
- **Медиана RTT**: 162 ms
- **Последнее обновление (UTC)**: 2026-07-03 11:30 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 18 · vless × 10 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 7 · `mahdi0024` × 14 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 5 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
