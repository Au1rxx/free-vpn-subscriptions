...
![узлы](https://img.shields.io/badge/узлы-83-brightgreen) ![живые](https://img.shields.io/badge/живые-1845-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-378ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_19:26_UTC-informational)
...
- **Выбрано узлов**: 83
- **Живых во всех источниках**: 1845
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 378 ms
- **Последнее обновление (UTC)**: 2026-06-30 19:26 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 33 · trojan × 30 · vless × 14 · vmess × 5

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 8 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 3
