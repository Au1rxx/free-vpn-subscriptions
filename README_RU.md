...
![узлы](https://img.shields.io/badge/узлы-126-brightgreen) ![живые](https://img.shields.io/badge/живые-1834-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-344ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_01:25_UTC-informational)
...
- **Выбрано узлов**: 126
- **Живых во всех источниках**: 1834
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 344 ms
- **Последнее обновление (UTC)**: 2026-07-08 01:25 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 57 · trojan × 29 · vless × 23 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 7 · `ninjastrikers` × 25 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 7
