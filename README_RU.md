...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-393-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-119ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-19_06:42_UTC-informational)
...
- **Медиана RTT**: 119 ms
- **Последнее обновление (UTC)**: 2026-04-19 06:42 UTC

**Распределение протоколов:** shadowsocks × 104 · trojan × 7 · vmess × 39

**Источники в этом запуске:** `freefq` × 2 · `mahdibland-aggregator` × 67 · `mahdibland-shadowsocks` × 65 · `vxiaov-clash` × 16
