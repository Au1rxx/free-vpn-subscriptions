...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2174-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-75ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-26_07:32_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2174
- **RTT самого быстрого узла**: 43 ms
- **Медиана RTT**: 75 ms
- **Последнее обновление (UTC)**: 2026-05-26 07:32 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 14 · vless × 85 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `pawdroid` × 4 · `ruking-clash` × 9 · `surfboard-eternity` × 4
