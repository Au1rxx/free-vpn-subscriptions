...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2244-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-142ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_05:30_UTC-informational)
...
- **Медиана RTT**: 142 ms
- **Последнее обновление (UTC)**: 2026-04-22 05:30 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 2 · vless × 98 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 40 · `epodonios` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 62 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 9
