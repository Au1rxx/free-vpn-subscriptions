...
![узлы](https://img.shields.io/badge/узлы-104-brightgreen) ![живые](https://img.shields.io/badge/живые-2003-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-177ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-04_14:20_UTC-informational)
...
- **Медиана RTT**: 177 ms
- **Последнее обновление (UTC)**: 2026-06-04 14:20 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 54 · vless × 19 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 39 · `epodonios` × 29 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 5
