...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1958-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-150ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-07_05:15_UTC-informational)
...
- **Медиана RTT**: 150 ms
- **Последнее обновление (UTC)**: 2026-05-07 05:15 UTC

**Распределение протоколов:** shadowsocks × 51 · trojan × 5 · vless × 83 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 70 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
