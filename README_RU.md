...
![узлы](https://img.shields.io/badge/узлы-107-brightgreen) ![живые](https://img.shields.io/badge/живые-2113-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-357ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-02_08:29_UTC-informational)
...
- **Выбрано узлов**: 107
- **Живых во всех источниках**: 2113
- **RTT самого быстрого узла**: 51 ms
- **Медиана RTT**: 357 ms
- **Последнее обновление (UTC)**: 2026-07-02 08:29 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 55 · trojan × 28 · vless × 15 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 21 · `pawdroid` × 3 · `surfboard-eternity` × 4
