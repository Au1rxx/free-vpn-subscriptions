...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2574-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-130ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_18:37_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2574
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 130 ms
- **Последнее обновление (UTC)**: 2026-04-26 18:37 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 13 · vless × 85 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 50 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
