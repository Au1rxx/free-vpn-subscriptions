...
![узлы](https://img.shields.io/badge/узлы-91-brightgreen) ![живые](https://img.shields.io/badge/живые-2093-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-173ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-27_07:13_UTC-informational)
...
- **Выбрано узлов**: 91
- **Живых во всех источниках**: 2093
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 173 ms
- **Последнее обновление (UTC)**: 2026-06-27 07:13 UTC

**Распределение протоколов:** shadowsocks × 18 · trojan × 29 · vless × 24 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 16 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 11
