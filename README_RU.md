...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2000-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-398ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-16_05:28_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2000
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 398 ms
- **Последнее обновление (UTC)**: 2026-07-16 05:28 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 44 · trojan × 72 · vless × 22 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `mahdi0024` × 17 · `mahdibland-aggregator` × 49 · `mahdibland-shadowsocks` × 29 · `matin-v2ray` × 3 · `ninjastrikers` × 15 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 9 · `surfboard-eternity` × 3
