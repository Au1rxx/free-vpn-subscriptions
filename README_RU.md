...
![узлы](https://img.shields.io/badge/узлы-60-brightgreen) ![живые](https://img.shields.io/badge/живые-1971-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-149ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-27_16:31_UTC-informational)
...
- **Медиана RTT**: 149 ms
- **Последнее обновление (UTC)**: 2026-05-27 16:31 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 12 · vless × 17 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 4 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 3
