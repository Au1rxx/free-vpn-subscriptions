...
![узлы](https://img.shields.io/badge/узлы-73-brightgreen) ![живые](https://img.shields.io/badge/живые-2502-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-97ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-02_10:26_UTC-informational)
...
- **Выбрано узлов**: 73
- **Живых во всех источниках**: 2502
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 97 ms
- **Последнее обновление (UTC)**: 2026-06-02 10:26 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 22 · vless × 8 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 10 · `pawdroid` × 3 · `surfboard-eternity` × 1
