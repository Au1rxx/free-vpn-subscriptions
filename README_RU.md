...
![узлы](https://img.shields.io/badge/узлы-83-brightgreen) ![живые](https://img.shields.io/badge/живые-2366-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-97ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-02_20:22_UTC-informational)
...
- **Выбрано узлов**: 83
- **Живых во всех источниках**: 2366
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 97 ms
- **Последнее обновление (UTC)**: 2026-06-02 20:22 UTC

**Распределение протоколов:** shadowsocks × 20 · trojan × 26 · vless × 6 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 8 · `snakem982` × 1 · `surfboard-eternity` × 6
