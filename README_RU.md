...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2191-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-123ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_08:12_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2191
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 123 ms
- **Последнее обновление (UTC)**: 2026-04-21 08:12 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 3 · vless × 103 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 50 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 55 · `pawdroid` × 2 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
