...
![узлы](https://img.shields.io/badge/узлы-108-brightgreen) ![живые](https://img.shields.io/badge/живые-1854-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-276ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-08_03:15_UTC-informational)
...
- **Медиана RTT**: 276 ms
- **Последнее обновление (UTC)**: 2026-06-08 03:15 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 21 · vless × 32 · vmess × 5

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 2 · `ninjastrikers` × 33 · `pawdroid` × 2 · `ruking-clash` × 4 · `surfboard-eternity` × 5
