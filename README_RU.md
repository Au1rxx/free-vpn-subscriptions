...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2624-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-81ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-17_05:19_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2624
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 81 ms
- **Последнее обновление (UTC)**: 2026-05-17 05:19 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 4 · vless × 96 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 7 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 34 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
