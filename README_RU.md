...
![узлы](https://img.shields.io/badge/узлы-85-brightgreen) ![живые](https://img.shields.io/badge/живые-2101-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-241ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-09_23:15_UTC-informational)
...
- **Медиана RTT**: 241 ms
- **Последнее обновление (UTC)**: 2026-06-09 23:15 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 18 · vless × 8 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 7
