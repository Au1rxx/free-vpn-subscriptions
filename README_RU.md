...
![узлы](https://img.shields.io/badge/узлы-88-brightgreen) ![живые](https://img.shields.io/badge/живые-1758-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-360ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-10_16:25_UTC-informational)
...
- **Медиана RTT**: 360 ms
- **Последнее обновление (UTC)**: 2026-07-10 16:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 50 · trojan × 13 · vless × 10 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
