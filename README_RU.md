...
![узлы](https://img.shields.io/badge/узлы-76-brightgreen) ![живые](https://img.shields.io/badge/живые-2147-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-211ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_22:25_UTC-informational)
...
- **Медиана RTT**: 211 ms
- **Последнее обновление (UTC)**: 2026-05-28 22:25 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 28 · vless × 10 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 3
