...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2561-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-75ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-16_10:18_UTC-informational)
...
- **Медиана RTT**: 75 ms
- **Последнее обновление (UTC)**: 2026-05-16 10:18 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 13 · vless × 96 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `pawdroid` × 7 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
