...
![узлы](https://img.shields.io/badge/узлы-117-brightgreen) ![живые](https://img.shields.io/badge/живые-1971-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-351ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-28_04:37_UTC-informational)
...
- **Выбрано узлов**: 117
- **Живых во всех источниках**: 1971
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 351 ms
- **Последнее обновление (UTC)**: 2026-06-28 04:37 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 33 · trojan × 42 · vless × 30 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `ruking-clash` × 15 · `surfboard-eternity` × 7
