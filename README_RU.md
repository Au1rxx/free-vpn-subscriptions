...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1970-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-402ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-16_08:08_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1970
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 402 ms
- **Последнее обновление (UTC)**: 2026-07-16 08:08 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 42 · trojan × 78 · vless × 19 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 23 · `mahdibland-aggregator` × 48 · `mahdibland-shadowsocks` × 30 · `matin-v2ray` × 4 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 8 · `surfboard-eternity` × 4
