...
![узлы](https://img.shields.io/badge/узлы-103-brightgreen) ![живые](https://img.shields.io/badge/живые-1802-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-396ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_14:24_UTC-informational)
...
- **Выбрано узлов**: 103
- **Живых во всех источниках**: 1802
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 396 ms
- **Последнее обновление (UTC)**: 2026-06-30 14:24 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 39 · trojan × 43 · vless × 11 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 17 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 13 · `surfboard-eternity` × 5
