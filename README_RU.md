...
![узлы](https://img.shields.io/badge/узлы-113-brightgreen) ![живые](https://img.shields.io/badge/живые-1940-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-251ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_08:37_UTC-informational)
...
- **Медиана RTT**: 251 ms
- **Последнее обновление (UTC)**: 2026-07-12 08:37 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 51 · trojan × 17 · vless × 25 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 9 · `mfuu-clash` × 4 · `ninjastrikers` × 19 · `pawdroid` × 8 · `snakem982` × 1 · `surfboard-eternity` × 5
