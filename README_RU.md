...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2342-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-82ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-20_18:29_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2342
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 82 ms
- **Последнее обновление (UTC)**: 2026-05-20 18:29 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 39 · trojan × 20 · vless × 70 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 9 · `surfboard-eternity` × 7
