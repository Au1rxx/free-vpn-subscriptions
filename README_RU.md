...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2315-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-452ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_18:12_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 61 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2315
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 452 ms
- **Последнее обновление (UTC)**: 2026-04-21 18:12 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 18 · vless × 89 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 52 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 47 · `ruking-clash` × 7 · `surfboard-eternity` × 6
