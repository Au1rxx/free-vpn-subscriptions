...
![узлы](https://img.shields.io/badge/узлы-128-brightgreen) ![живые](https://img.shields.io/badge/живые-1997-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-355ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_02:27_UTC-informational)
...
- **Медиана RTT**: 355 ms
- **Последнее обновление (UTC)**: 2026-07-05 02:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 55 · trojan × 25 · vless × 20 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 38 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 5 · `ninjastrikers` × 21 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 2
