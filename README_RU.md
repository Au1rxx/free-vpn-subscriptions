...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2304-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-400ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-17_22:25_UTC-informational)
...
|---|---|---|---|---|
| 🇯🇵 Japan (`JP`) | 96 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2304
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 400 ms
- **Последнее обновление (UTC)**: 2026-07-17 22:25 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 100 · vless × 9 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 5 · `mahdi0024` × 65 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 31 · `matin-v2ray` × 3 · `ninjastrikers` × 2 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 6 · `surfboard-eternity` × 3
