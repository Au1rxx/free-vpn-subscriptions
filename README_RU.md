...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1634-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-376ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-15_01:09_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1634
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 376 ms
- **Последнее обновление (UTC)**: 2026-07-15 01:09 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 99 · trojan × 23 · vless × 17 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 26 · `mahdi0024` × 14 · `mahdibland-aggregator` × 34 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
