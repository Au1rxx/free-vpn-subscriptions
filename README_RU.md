...
![узлы](https://img.shields.io/badge/узлы-121-brightgreen) ![живые](https://img.shields.io/badge/живые-1977-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-368ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-28_07:33_UTC-informational)
...
- **Выбрано узлов**: 121
- **Живых во всех источниках**: 1977
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 368 ms
- **Последнее обновление (UTC)**: 2026-06-28 07:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 36 · trojan × 42 · vless × 29 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
