...
![узлы](https://img.shields.io/badge/узлы-105-brightgreen) ![живые](https://img.shields.io/badge/живые-1927-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-369ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_10:10_UTC-informational)
...
- **Медиана RTT**: 369 ms
- **Последнее обновление (UTC)**: 2026-07-13 10:10 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 18 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `epodonios` × 6 · `mahdi0024` × 26 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 6 · `snakem982` × 1 · `surfboard-eternity` × 3
