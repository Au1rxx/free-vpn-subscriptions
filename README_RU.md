...
![узлы](https://img.shields.io/badge/узлы-120-brightgreen) ![живые](https://img.shields.io/badge/живые-2300-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-359ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-12_04:19_UTC-informational)
...
- **Выбрано узлов**: 120
- **Живых во всех источниках**: 2300
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 359 ms
- **Последнее обновление (UTC)**: 2026-06-12 04:19 UTC

**Распределение протоколов:** shadowsocks × 45 · trojan × 45 · vless × 25 · vmess × 5

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 28 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 3
