...
![узлы](https://img.shields.io/badge/узлы-91-brightgreen) ![живые](https://img.shields.io/badge/живые-2163-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-305ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-11_14:15_UTC-informational)
...
| 🇭🇰 Hong Kong (`HK`) | 5 | [clash-HK.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-HK.yaml) | [singbox-HK.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-HK.json) | [v2ray-base64-HK.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-HK.txt) |
...
- **Выбрано узлов**: 91
- **Живых во всех источниках**: 2163
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 305 ms
- **Последнее обновление (UTC)**: 2026-06-11 14:15 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 33 · trojan × 25 · vless × 11 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 1
