...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2217-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-172ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-30_20:29_UTC-informational)
...
- **Медиана RTT**: 172 ms
- **Последнее обновление (UTC)**: 2026-04-30 20:29 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 23 · vless × 75 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 32 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 51 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
