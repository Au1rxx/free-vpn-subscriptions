...
![узлы](https://img.shields.io/badge/узлы-134-brightgreen) ![живые](https://img.shields.io/badge/живые-1890-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-390ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_14:31_UTC-informational)
...
- **Выбрано узлов**: 134
- **Живых во всех источниках**: 1890
- **RTT самого быстрого узла**: 26 ms
- **Медиана RTT**: 390 ms
- **Последнее обновление (UTC)**: 2026-07-13 14:31 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 74 · trojan × 23 · vless × 21 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `epodonios` × 22 · `mahdi0024` × 28 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 6 · `ninjastrikers` × 18 · `pawdroid` × 5 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
