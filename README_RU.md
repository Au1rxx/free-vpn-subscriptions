...
![узлы](https://img.shields.io/badge/узлы-70-brightgreen) ![живые](https://img.shields.io/badge/живые-2055-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-203ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_09:15_UTC-informational)
...
- **Медиана RTT**: 203 ms
- **Последнее обновление (UTC)**: 2026-05-28 09:15 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 14 · vless × 16 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 6 · `ruking-clash` × 2 · `snakem982` × 4 · `surfboard-eternity` × 4
