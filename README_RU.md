...
![узлы](https://img.shields.io/badge/узлы-110-brightgreen) ![живые](https://img.shields.io/badge/живые-1796-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-358ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_12:33_UTC-informational)
...
- **Медиана RTT**: 358 ms
- **Последнее обновление (UTC)**: 2026-07-08 12:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 61 · trojan × 20 · vless × 16 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 10 · `lagzian-mix` × 7 · `mahdi0024` × 15 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 18 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 3
