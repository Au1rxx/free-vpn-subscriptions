...
![узлы](https://img.shields.io/badge/узлы-135-brightgreen) ![живые](https://img.shields.io/badge/живые-1712-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-378ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-14_02:33_UTC-informational)
...
- **Выбрано узлов**: 135
- **Живых во всех источниках**: 1712
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 378 ms
- **Последнее обновление (UTC)**: 2026-06-14 02:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 54 · trojan × 37 · vless × 36 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 34 · `pawdroid` × 4 · `ruking-clash` × 21 · `surfboard-eternity` × 7
