...
![узлы](https://img.shields.io/badge/узлы-105-brightgreen) ![живые](https://img.shields.io/badge/живые-1693-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-517ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-14_13:19_UTC-informational)
...
- **Выбрано узлов**: 105
- **Живых во всех источниках**: 1693
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 517 ms
- **Последнее обновление (UTC)**: 2026-06-14 13:19 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 52 · trojan × 30 · vless × 14 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `mahdi0024` × 7 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 15 · `surfboard-eternity` × 5
