...
![узлы](https://img.shields.io/badge/узлы-109-brightgreen) ![живые](https://img.shields.io/badge/живые-2059-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-340ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-02_03:27_UTC-informational)
...
- **Медиана RTT**: 340 ms
- **Последнее обновление (UTC)**: 2026-07-02 03:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 44 · trojan × 37 · vless × 18 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 25 · `pawdroid` × 2 · `surfboard-eternity` × 1
