...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2347-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-276ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_14:22_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2347
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 276 ms
- **Последнее обновление (UTC)**: 2026-05-11 14:22 UTC

**Распределение протоколов:** shadowsocks × 49 · trojan × 15 · vless × 77 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 63 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
