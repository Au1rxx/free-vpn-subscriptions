...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1875-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-221ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_17:26_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 51 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
| 🇯🇵 Japan (`JP`) | 3 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1875
- **RTT самого быстрого узла**: 42 ms
- **Медиана RTT**: 221 ms
- **Последнее обновление (UTC)**: 2026-05-11 17:26 UTC

**Распределение протоколов:** shadowsocks × 65 · trojan × 4 · vless × 69 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 9 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 5 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 57 · `pawdroid` × 4 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
