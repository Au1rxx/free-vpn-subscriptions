...
![узлы](https://img.shields.io/badge/узлы-138-brightgreen) ![живые](https://img.shields.io/badge/живые-2523-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-206ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_18:18_UTC-informational)
...
- **Медиана RTT**: 206 ms
- **Последнее обновление (UTC)**: 2026-04-23 18:18 UTC

**Распределение протоколов:** shadowsocks × 15 · trojan × 26 · vless × 81 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
