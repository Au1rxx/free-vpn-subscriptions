...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2180-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-92ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-26_05:24_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2180
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 92 ms
- **Последнее обновление (UTC)**: 2026-05-26 05:24 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 18 · vless × 82 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 70 · `pawdroid` × 5 · `ruking-clash` × 13 · `surfboard-eternity` × 3
