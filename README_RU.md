...
![узлы](https://img.shields.io/badge/узлы-123-brightgreen) ![живые](https://img.shields.io/badge/живые-1764-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-377ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-09_11:20_UTC-informational)
...
- **Выбрано узлов**: 123
- **Живых во всех источниках**: 1764
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 377 ms
- **Последнее обновление (UTC)**: 2026-07-09 11:20 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 64 · trojan × 21 · vless × 13 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
