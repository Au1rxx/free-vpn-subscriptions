...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2334-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-81ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-24_10:22_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 65 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2334
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 81 ms
- **Последнее обновление (UTC)**: 2026-05-24 10:22 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 19 · vless × 71 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 40 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 58 · `pawdroid` × 3 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
