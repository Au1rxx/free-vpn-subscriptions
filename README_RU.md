...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2174-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-104ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-03_04:39_UTC-informational)
...
- **Медиана RTT**: 104 ms
- **Последнее обновление (UTC)**: 2026-05-03 04:39 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 4 · vless × 106 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 6 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 69 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
