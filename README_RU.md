...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1609-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-376ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-15_06:10_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1609
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 376 ms
- **Последнее обновление (UTC)**: 2026-07-15 06:10 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 96 · trojan × 27 · vless × 17 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 30 · `mahdi0024` × 11 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 7
