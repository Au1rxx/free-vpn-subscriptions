...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2522-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-161ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_07:18_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2522
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 161 ms
- **Последнее обновление (UTC)**: 2026-04-23 07:18 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 17 · vless × 94 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 20 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 72 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
