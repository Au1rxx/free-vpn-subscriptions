...
![узлы](https://img.shields.io/badge/узлы-57-brightgreen) ![живые](https://img.shields.io/badge/живые-1962-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-157ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-27_17:11_UTC-informational)
...
- **Выбрано узлов**: 57
- **Живых во всех источниках**: 1962
- **RTT самого быстрого узла**: 39 ms
- **Медиана RTT**: 157 ms
- **Последнее обновление (UTC)**: 2026-05-27 17:11 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 10 · vless × 17 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 6 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 3
