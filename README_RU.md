...
![узлы](https://img.shields.io/badge/узлы-149-brightgreen) ![живые](https://img.shields.io/badge/живые-1908-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-470ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-22_07:37_UTC-informational)
...
- **Медиана RTT**: 470 ms
- **Последнее обновление (UTC)**: 2026-06-22 07:37 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 46 · trojan × 30 · vless × 59 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 6 · `ruking-clash` × 31 · `snakem982` × 3 · `surfboard-eternity` × 2
