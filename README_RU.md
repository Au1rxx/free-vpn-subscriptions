...
![узлы](https://img.shields.io/badge/узлы-87-brightgreen) ![живые](https://img.shields.io/badge/живые-2057-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-353ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-01_21:39_UTC-informational)
...
- **Медиана RTT**: 353 ms
- **Последнее обновление (UTC)**: 2026-07-01 21:39 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 44 · trojan × 22 · vless × 12 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 7 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 3 · `ninjastrikers` × 18 · `pawdroid` × 2 · `surfboard-eternity` × 3
