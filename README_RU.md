...
![узлы](https://img.shields.io/badge/узлы-105-brightgreen) ![живые](https://img.shields.io/badge/живые-1925-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-241ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_13:13_UTC-informational)
...
- **Медиана RTT**: 241 ms
- **Последнее обновление (UTC)**: 2026-07-12 13:13 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 59 · trojan × 14 · vless × 11 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 2
