...
![узлы](https://img.shields.io/badge/узлы-137-brightgreen) ![живые](https://img.shields.io/badge/живые-1712-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-396ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-14_03:37_UTC-informational)
...
- **Медиана RTT**: 396 ms
- **Последнее обновление (UTC)**: 2026-06-14 03:37 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 53 · trojan × 38 · vless × 38 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 24 · `ninjastrikers` × 35 · `pawdroid` × 8 · `ruking-clash` × 21 · `surfboard-eternity` × 3
