...
![узлы](https://img.shields.io/badge/узлы-148-brightgreen) ![живые](https://img.shields.io/badge/живые-1959-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-322ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_22:39_UTC-informational)
...
- **Выбрано узлов**: 148
- **Живых во всех источниках**: 1959
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 322 ms
- **Последнее обновление (UTC)**: 2026-05-06 22:39 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 19 · vless × 72 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 6
