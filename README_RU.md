...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2516-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-105ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_13:16_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2516
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 105 ms
- **Последнее обновление (UTC)**: 2026-04-27 13:16 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 7 · vless × 93 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 46 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 52 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
