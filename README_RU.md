...
![узлы](https://img.shields.io/badge/узлы-82-brightgreen) ![живые](https://img.shields.io/badge/живые-1947-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-120ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-03_19:28_UTC-informational)
...
- **Медиана RTT**: 120 ms
- **Последнее обновление (UTC)**: 2026-06-03 19:28 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 31 · vless × 15 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `mahdi0024` × 14 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 6 · `pawdroid` × 1 · `surfboard-eternity` × 3
