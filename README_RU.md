...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1888-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-281ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_20:29_UTC-informational)
...
- **Медиана RTT**: 281 ms
- **Последнее обновление (UTC)**: 2026-05-11 20:29 UTC

**Распределение протоколов:** shadowsocks × 73 · trojan × 2 · vless × 63 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 7 · `mahdi0024` × 5 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 3 · `ninjastrikers` × 44 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
