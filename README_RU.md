...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2259-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-150ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_07:28_UTC-informational)
...
- **Медиана RTT**: 150 ms
- **Последнее обновление (UTC)**: 2026-04-22 07:28 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 4 · vless × 103 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 39 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 11 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 66 · `ruking-clash` × 4 · `surfboard-eternity` × 6
