...
![узлы](https://img.shields.io/badge/узлы-102-brightgreen) ![живые](https://img.shields.io/badge/живые-2320-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-186ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-20_00:26_UTC-informational)
...
- **Медиана RTT**: 186 ms
- **Последнее обновление (UTC)**: 2026-06-20 00:26 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 29 · vless × 19 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 19 · `surfboard-eternity` × 4
