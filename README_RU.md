...
![узлы](https://img.shields.io/badge/узлы-127-brightgreen) ![живые](https://img.shields.io/badge/живые-2002-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-330ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_05:35_UTC-informational)
...
- **Выбрано узлов**: 127
- **Живых во всех источниках**: 2002
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 330 ms
- **Последнее обновление (UTC)**: 2026-07-05 05:35 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 56 · trojan × 27 · vless × 14 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 5 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 4
