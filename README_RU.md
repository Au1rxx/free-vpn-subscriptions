...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2385-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-93ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-21_03:27_UTC-informational)
...
- **Медиана RTT**: 93 ms
- **Последнее обновление (UTC)**: 2026-05-21 03:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 36 · trojan × 13 · vless × 81 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
