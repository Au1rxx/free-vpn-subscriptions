...
![узлы](https://img.shields.io/badge/узлы-127-brightgreen) ![живые](https://img.shields.io/badge/живые-2118-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-400ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-20_23:31_UTC-informational)
...
- **Выбрано узлов**: 127
- **Живых во всех источниках**: 2118
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 400 ms
- **Последнее обновление (UTC)**: 2026-06-20 23:31 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 35 · vless × 29 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 6 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 31 · `surfboard-eternity` × 2
