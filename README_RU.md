...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2384-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-87ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-22_18:15_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2384
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 87 ms
- **Последнее обновление (UTC)**: 2026-05-22 18:15 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 36 · trojan × 25 · vless × 77 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
