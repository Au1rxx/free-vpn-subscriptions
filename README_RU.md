...
![узлы](https://img.shields.io/badge/узлы-92-brightgreen) ![живые](https://img.shields.io/badge/живые-2199-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-568ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-29_11:28_UTC-informational)
...
- **Выбрано узлов**: 92
- **Живых во всех источниках**: 2199
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 568 ms
- **Последнее обновление (UTC)**: 2026-06-29 11:28 UTC

**Распределение протоколов:** shadowsocks × 16 · trojan × 40 · vless × 21 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 18 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 2
