...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2159-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-111ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-30_02:11_UTC-informational)
...
- **Медиана RTT**: 111 ms
- **Последнее обновление (UTC)**: 2026-04-30 02:11 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 4 · vless × 99 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 65 · `ruking-clash` × 1 · `surfboard-eternity` × 7
