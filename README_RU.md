...
![узлы](https://img.shields.io/badge/узлы-137-brightgreen) ![живые](https://img.shields.io/badge/живые-2494-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-168ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_18:39_UTC-informational)
...
- **Медиана RTT**: 168 ms
- **Последнее обновление (UTC)**: 2026-05-09 18:39 UTC

**Распределение протоколов:** shadowsocks × 52 · trojan × 16 · vless × 61 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `ruking-clash` × 8 · `snakem982` × 3 · `surfboard-eternity` × 6
