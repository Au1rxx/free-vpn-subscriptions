...
![узлы](https://img.shields.io/badge/узлы-88-brightgreen) ![живые](https://img.shields.io/badge/живые-2135-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-279ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_13:29_UTC-informational)
...
- **Выбрано узлов**: 88
- **Живых во всех источниках**: 2135
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 279 ms
- **Последнее обновление (UTC)**: 2026-06-10 13:29 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 38 · trojan × 16 · vless × 11 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 5 · `surfboard-eternity` × 4
