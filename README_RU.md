...
![узлы](https://img.shields.io/badge/узлы-123-brightgreen) ![живые](https://img.shields.io/badge/живые-1815-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-366ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_07:09_UTC-informational)
...
- **Медиана RTT**: 366 ms
- **Последнее обновление (UTC)**: 2026-07-07 07:09 UTC

**Распределение протоколов:** hysteria2 × 3 · shadowsocks × 50 · trojan × 28 · vless × 19 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 10 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 2
