...
![узлы](https://img.shields.io/badge/узлы-127-brightgreen) ![живые](https://img.shields.io/badge/живые-1840-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-347ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_05:24_UTC-informational)
...
- **Выбрано узлов**: 127
- **Живых во всех источниках**: 1840
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 347 ms
- **Последнее обновление (UTC)**: 2026-07-07 05:24 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 53 · trojan × 25 · vless × 26 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 9 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 4
