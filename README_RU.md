...
![узлы](https://img.shields.io/badge/узлы-119-brightgreen) ![живые](https://img.shields.io/badge/живые-1952-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-434ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-12_21:10_UTC-informational)
...
- **Выбрано узлов**: 119
- **Живых во всех источниках**: 1952
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 434 ms
- **Последнее обновление (UTC)**: 2026-06-12 21:10 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 54 · trojan × 43 · vless × 13 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 33 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 8 · `surfboard-eternity` × 6
