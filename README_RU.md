...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2175-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-99ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_04:36_UTC-informational)
...
- **Медиана RTT**: 99 ms
- **Последнее обновление (UTC)**: 2026-04-26 04:36 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 10 · vless × 102 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 26 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 73 · `pawdroid` × 3 · `surfboard-eternity` × 4
