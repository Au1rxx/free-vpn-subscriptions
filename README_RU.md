...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2283-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-94ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-19_03:39_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2283
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 94 ms
- **Последнее обновление (UTC)**: 2026-05-19 03:39 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 24 · trojan × 21 · vless × 79 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 26 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 71 · `pawdroid` × 3 · `surfboard-eternity` × 7
