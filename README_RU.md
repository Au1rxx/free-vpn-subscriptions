...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2218-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-120ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_04:29_UTC-informational)
...
- **Медиана RTT**: 120 ms
- **Последнее обновление (UTC)**: 2026-04-21 04:29 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 2 · vless × 102 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 47 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 54 · `ruking-clash` × 11 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
