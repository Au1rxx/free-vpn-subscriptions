...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1935-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-257ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-22_02:30_UTC-informational)
...
- **Медиана RTT**: 257 ms
- **Последнее обновление (UTC)**: 2026-06-22 02:30 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 44 · trojan × 15 · vless × 78 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 39 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 16 · `snakem982` × 5 · `surfboard-eternity` × 2
