...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2445-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-118ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-24_03:27_UTC-informational)
...
- **Медиана RTT**: 118 ms
- **Последнее обновление (UTC)**: 2026-04-24 03:27 UTC

**Распределение протоколов:** shadowsocks × 24 · trojan × 12 · vless × 102 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 73 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
