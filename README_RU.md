...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2433-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-81ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-25_13:30_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2433
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 81 ms
- **Последнее обновление (UTC)**: 2026-05-25 13:30 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 16 · vless × 69 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 40 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 54 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 4
