...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2418-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-88ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-19_21:17_UTC-informational)
...
- **Медиана RTT**: 88 ms
- **Последнее обновление (UTC)**: 2026-05-19 21:17 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 38 · trojan × 21 · vless × 70 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 2 · `ninjastrikers` × 49 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 8
