...
![узлы](https://img.shields.io/badge/узлы-138-brightgreen) ![живые](https://img.shields.io/badge/живые-2588-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-229ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_14:16_UTC-informational)
...
- **Выбрано узлов**: 138
- **Живых во всех источниках**: 2588
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 229 ms
- **Последнее обновление (UTC)**: 2026-04-22 14:16 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 22 · vless × 79 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 57 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7
