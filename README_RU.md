...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-1798-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-337ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-11_09:11_UTC-informational)
...
- **Выбрано узлов**: 114
- **Живых во всех источниках**: 1798
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 337 ms
- **Последнее обновление (UTC)**: 2026-07-11 09:11 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 53 · trojan × 21 · vless × 22 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 7 · `ninjastrikers` × 22 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 2
