...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2550-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-76ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-20_06:23_UTC-informational)
...
- **Медиана RTT**: 76 ms
- **Последнее обновление (UTC)**: 2026-05-20 06:23 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 33 · trojan × 7 · vless × 91 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 70 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 8
