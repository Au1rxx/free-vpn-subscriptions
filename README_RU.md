...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2085-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-80ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-03_03:15_UTC-informational)
...
- **Медиана RTT**: 80 ms
- **Последнее обновление (UTC)**: 2026-05-03 03:15 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 4 · vless × 104 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 64 · `pawdroid` × 1 · `surfboard-eternity` × 7
