...
![узлы](https://img.shields.io/badge/узлы-104-brightgreen) ![живые](https://img.shields.io/badge/живые-1961-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-184ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-28_00:12_UTC-informational)
...
- **Медиана RTT**: 184 ms
- **Последнее обновление (UTC)**: 2026-06-28 00:12 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 42 · vless × 30 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 7
