...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2394-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-139ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-12_23:20_UTC-informational)
...
- **Медиана RTT**: 139 ms
- **Последнее обновление (UTC)**: 2026-05-12 23:20 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 19 · vless × 84 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 43 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 44 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 2
