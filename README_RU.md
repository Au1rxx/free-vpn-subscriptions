...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2307-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-117ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-20_01:23_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2307
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 117 ms
- **Последнее обновление (UTC)**: 2026-05-20 01:23 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 41 · trojan × 4 · vless × 85 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 7
