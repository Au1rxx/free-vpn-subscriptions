...
![узлы](https://img.shields.io/badge/узлы-79-brightgreen) ![живые](https://img.shields.io/badge/живые-2206-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-167ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-06_22:29_UTC-informational)
...
- **Выбрано узлов**: 79
- **Живых во всех источниках**: 2206
- **RTT самого быстрого узла**: 19 ms
- **Медиана RTT**: 167 ms
- **Последнее обновление (UTC)**: 2026-06-06 22:29 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 20 · vless × 6 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 10 · `ruking-clash` × 1 · `surfboard-eternity` × 3
