...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2191-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-172ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-02_15:20_UTC-informational)
...
- **Медиана RTT**: 172 ms
- **Последнее обновление (UTC)**: 2026-05-02 15:20 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 19 · vless × 81 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `pawdroid` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
