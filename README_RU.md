...
![узлы](https://img.shields.io/badge/узлы-123-brightgreen) ![живые](https://img.shields.io/badge/живые-1793-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-376ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_14:26_UTC-informational)
...
- **Медиана RTT**: 376 ms
- **Последнее обновление (UTC)**: 2026-07-07 14:26 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 63 · trojan × 28 · vless × 9 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `mahdi0024` × 26 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 7 · `ruking-clash` × 1 · `surfboard-eternity` × 3
