...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2141-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-285ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_13:31_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2141
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 285 ms
- **Последнее обновление (UTC)**: 2026-05-06 13:31 UTC

**Распределение протоколов:** shadowsocks × 46 · trojan × 17 · vless × 75 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 57 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
