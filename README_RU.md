...
![узлы](https://img.shields.io/badge/узлы-74-brightgreen) ![живые](https://img.shields.io/badge/живые-1948-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-174ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-03_21:33_UTC-informational)
...
- **Медиана RTT**: 174 ms
- **Последнее обновление (UTC)**: 2026-07-03 21:33 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 21 · vless × 9 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
