...
![узлы](https://img.shields.io/badge/узлы-92-brightgreen) ![живые](https://img.shields.io/badge/живые-1931-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-341ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_20:09_UTC-informational)
...
- **Медиана RTT**: 341 ms
- **Последнее обновление (UTC)**: 2026-07-13 20:09 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 19 · vless × 9 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `mahdi0024` × 24 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 8 · `ninjastrikers` × 13 · `pawdroid` × 2 · `snakem982` × 1
