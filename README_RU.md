...
![узлы](https://img.shields.io/badge/узлы-120-brightgreen) ![живые](https://img.shields.io/badge/живые-1752-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-476ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-17_22:22_UTC-informational)
...
- **Выбрано узлов**: 120
- **Живых во всех источниках**: 1752
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 476 ms
- **Последнее обновление (UTC)**: 2026-06-17 22:22 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 49 · trojan × 32 · vless × 29 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 16 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 23 · `surfboard-eternity` × 3
