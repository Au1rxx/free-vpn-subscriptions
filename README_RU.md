...
![узлы](https://img.shields.io/badge/узлы-141-brightgreen) ![живые](https://img.shields.io/badge/живые-2555-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-186ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_11:35_UTC-informational)
...
- **Выбрано узлов**: 141
- **Живых во всех источниках**: 2555
- **RTT самого быстрого узла**: 26 ms
- **Медиана RTT**: 186 ms
- **Последнее обновление (UTC)**: 2026-04-23 11:35 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 22 · vless × 80 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 70 · `pawdroid` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
