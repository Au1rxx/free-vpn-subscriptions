...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-1948-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-358ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_08:23_UTC-informational)
...
- **Выбрано узлов**: 111
- **Живых во всех источниках**: 1948
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 358 ms
- **Последнее обновление (UTC)**: 2026-07-13 08:23 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 23 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 26 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 3
