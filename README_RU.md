...
![узлы](https://img.shields.io/badge/узлы-81-brightgreen) ![живые](https://img.shields.io/badge/живые-1892-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-355ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-08_20:24_UTC-informational)
...
- **Медиана RTT**: 355 ms
- **Последнее обновление (UTC)**: 2026-06-08 20:24 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 14 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `ruking-clash` × 7 · `surfboard-eternity` × 4
