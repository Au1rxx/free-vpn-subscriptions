...
![узлы](https://img.shields.io/badge/узлы-85-brightgreen) ![живые](https://img.shields.io/badge/живые-2269-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-319ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-02_14:15_UTC-informational)
...
- **Выбрано узлов**: 85
- **Живых во всех источниках**: 2269
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 319 ms
- **Последнее обновление (UTC)**: 2026-07-02 14:15 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 36 · trojan × 22 · vless × 17 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 11 · `ninjastrikers` × 14 · `pawdroid` × 5 · `surfboard-eternity` × 1
