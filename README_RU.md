...
![узлы](https://img.shields.io/badge/узлы-126-brightgreen) ![живые](https://img.shields.io/badge/живые-1969-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-338ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_03:33_UTC-informational)
...
- **Выбрано узлов**: 126
- **Живых во всех источниках**: 1969
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 338 ms
- **Последнее обновление (UTC)**: 2026-07-05 03:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 56 · trojan × 29 · vless × 14 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 39 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 3 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
