...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2165-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-83ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-01_12:24_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2165
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 83 ms
- **Последнее обновление (UTC)**: 2026-05-01 12:24 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 13 · vless × 85 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
