...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2378-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-350ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_13:35_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2378
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 350 ms
- **Последнее обновление (UTC)**: 2026-05-11 13:35 UTC

**Распределение протоколов:** shadowsocks × 45 · trojan × 17 · vless × 79 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
