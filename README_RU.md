...
![узлы](https://img.shields.io/badge/узлы-89-brightgreen) ![живые](https://img.shields.io/badge/живые-1877-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-365ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_14:16_UTC-informational)
...
- **Медиана RTT**: 365 ms
- **Последнее обновление (UTC)**: 2026-06-07 14:16 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 48 · trojan × 20 · vless × 14 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 5
