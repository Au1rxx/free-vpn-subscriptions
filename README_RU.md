...
![узлы](https://img.shields.io/badge/узлы-100-brightgreen) ![живые](https://img.shields.io/badge/живые-2039-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-183ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-27_01:28_UTC-informational)
...
| 🇭🇰 Hong Kong (`HK`) | 15 | [clash-HK.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-HK.yaml) | [singbox-HK.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-HK.json) | [v2ray-base64-HK.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-HK.txt) |
...
- **Выбрано узлов**: 100
- **Живых во всех источниках**: 2039
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 183 ms
- **Последнее обновление (UTC)**: 2026-06-27 01:28 UTC

**Распределение протоколов:** shadowsocks × 17 · trojan × 35 · vless × 28 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 3
