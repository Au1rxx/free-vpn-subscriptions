...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2579-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-103ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-28_04:22_UTC-informational)
...
- **Медиана RTT**: 103 ms
- **Последнее обновление (UTC)**: 2026-04-28 04:22 UTC

**Распределение протоколов:** shadowsocks × 19 · trojan × 7 · vless × 115 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 68 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
