...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-1825-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-398ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-16_12:10_UTC-informational)
...
- **Медиана RTT**: 398 ms
- **Последнее обновление (UTC)**: 2026-06-16 12:10 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 52 · trojan × 28 · vless × 19 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 5
