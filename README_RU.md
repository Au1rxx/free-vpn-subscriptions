...
![узлы](https://img.shields.io/badge/узлы-143-brightgreen) ![живые](https://img.shields.io/badge/живые-2322-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-116ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-22_23:28_UTC-informational)
...
- **Выбрано узлов**: 143
- **Живых во всех источниках**: 2322
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 116 ms
- **Последнее обновление (UTC)**: 2026-05-22 23:28 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 24 · vless × 70 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 53 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
