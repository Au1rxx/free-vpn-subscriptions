...
![узлы](https://img.shields.io/badge/узлы-76-brightgreen) ![живые](https://img.shields.io/badge/живые-2079-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-150ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-10_08:13_UTC-informational)
...
- **Медиана RTT**: 150 ms
- **Последнее обновление (UTC)**: 2026-07-10 08:13 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 11 · vless × 14 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 34 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `surfboard-eternity` × 3
