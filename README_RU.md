...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2244-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-80ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-19_05:23_UTC-informational)
...
- **Медиана RTT**: 80 ms
- **Последнее обновление (UTC)**: 2026-05-19 05:23 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 23 · trojan × 17 · vless × 85 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 65 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 3
