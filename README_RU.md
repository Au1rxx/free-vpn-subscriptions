...
![узлы](https://img.shields.io/badge/узлы-121-brightgreen) ![живые](https://img.shields.io/badge/живые-1906-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-275ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_04:35_UTC-informational)
...
- **Выбрано узлов**: 121
- **Живых во всех источниках**: 1906
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 275 ms
- **Последнее обновление (UTC)**: 2026-07-12 04:35 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 54 · trojan × 18 · vless × 27 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 9 · `ninjastrikers` × 23 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 3
