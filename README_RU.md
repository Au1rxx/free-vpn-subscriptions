...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-393-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-116ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-19_07:09_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 393
- **RTT самого быстрого узла**: 9 ms
- **Медиана RTT**: 116 ms
- **Последнее обновление (UTC)**: 2026-04-19 07:09 UTC

**Распределение протоколов:** shadowsocks × 104 · trojan × 7 · vmess × 39

**Источники в этом запуске:** `freefq` × 2 · `mahdibland-aggregator` × 63 · `mahdibland-shadowsocks` × 67 · `pawdroid` × 3 · `vxiaov-clash` × 15
