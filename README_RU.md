...
![узлы](https://img.shields.io/badge/узлы-127-brightgreen) ![живые](https://img.shields.io/badge/живые-1982-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-218ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_04:18_UTC-informational)
...
- **Медиана RTT**: 218 ms
- **Последнее обновление (UTC)**: 2026-07-13 04:18 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 62 · trojan × 18 · vless × 31 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `mahdi0024` × 31 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `ninjastrikers` × 23 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 1
