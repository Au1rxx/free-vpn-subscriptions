...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2251-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-446ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-20_20:36_UTC-informational)
...
- **Медиана RTT**: 446 ms
- **Последнее обновление (UTC)**: 2026-04-20 20:36 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 9 · vless × 101 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 64 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 41 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 4
