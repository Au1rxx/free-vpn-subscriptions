...
![узлы](https://img.shields.io/badge/узлы-58-brightgreen) ![живые](https://img.shields.io/badge/живые-2382-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-132ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-02_18:13_UTC-informational)
...
- **Медиана RTT**: 132 ms
- **Последнее обновление (UTC)**: 2026-07-02 18:13 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 22 · trojan × 12 · vless × 10 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 8 · `surfboard-eternity` × 2
