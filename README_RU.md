...
![узлы](https://img.shields.io/badge/узлы-82-brightgreen) ![живые](https://img.shields.io/badge/живые-2081-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-310ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-01_23:38_UTC-informational)
...
- **Выбрано узлов**: 82
- **Живых во всех источниках**: 2081
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 310 ms
- **Последнее обновление (UTC)**: 2026-07-01 23:38 UTC

**Распределение протоколов:** shadowsocks × 45 · trojan × 19 · vless × 11 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 6 · `ninjastrikers` × 18 · `pawdroid` × 1 · `surfboard-eternity` × 3
