...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2480-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-86ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-16_19:29_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2480
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 86 ms
- **Последнее обновление (UTC)**: 2026-05-16 19:29 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 16 · vless × 83 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 44 · `pawdroid` × 6 · `ruking-clash` × 7 · `surfboard-eternity` × 6
