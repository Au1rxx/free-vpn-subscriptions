...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2350-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-397ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-18_01:20_UTC-informational)
...
- **Медиана RTT**: 397 ms
- **Последнее обновление (UTC)**: 2026-07-18 01:20 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 87 · vless × 18 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `mahdi0024` × 68 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 6 · `surfboard-eternity` × 5
