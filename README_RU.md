...
![узлы](https://img.shields.io/badge/узлы-73-brightgreen) ![живые](https://img.shields.io/badge/живые-1948-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-164ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-03_10:25_UTC-informational)
...
- **Медиана RTT**: 164 ms
- **Последнее обновление (UTC)**: 2026-07-03 10:25 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 21 · vless × 6 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
