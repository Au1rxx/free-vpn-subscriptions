...
![узлы](https://img.shields.io/badge/узлы-107-brightgreen) ![живые](https://img.shields.io/badge/живые-2347-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-91ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-03_02:26_UTC-informational)
...
- **Медиана RTT**: 91 ms
- **Последнее обновление (UTC)**: 2026-06-03 02:26 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 32 · vless × 24 · vmess × 30

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 29 · `surfboard-eternity` × 3
