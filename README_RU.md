...
![узлы](https://img.shields.io/badge/узлы-83-brightgreen) ![живые](https://img.shields.io/badge/живые-2189-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-191ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-06_10:22_UTC-informational)
...
- **Выбрано узлов**: 83
- **Живых во всех источниках**: 2189
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 191 ms
- **Последнее обновление (UTC)**: 2026-06-06 10:22 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 24 · vless × 19 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 26 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 5 · `surfboard-eternity` × 3
