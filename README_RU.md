...
![узлы](https://img.shields.io/badge/узлы-118-brightgreen) ![живые](https://img.shields.io/badge/живые-1960-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-351ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_09:23_UTC-informational)
...
- **Медиана RTT**: 351 ms
- **Последнее обновление (UTC)**: 2026-07-05 09:23 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 53 · trojan × 28 · vless × 10 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 36 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `ninjastrikers` × 16 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
