...
![узлы](https://img.shields.io/badge/узлы-122-brightgreen) ![живые](https://img.shields.io/badge/живые-1914-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-341ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-06_04:35_UTC-informational)
...
- **Медиана RTT**: 341 ms
- **Последнее обновление (UTC)**: 2026-07-06 04:35 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 49 · trojan × 25 · vless × 15 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 7 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
