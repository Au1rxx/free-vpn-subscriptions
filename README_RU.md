...
![узлы](https://img.shields.io/badge/узлы-126-brightgreen) ![живые](https://img.shields.io/badge/живые-2033-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-359ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-02_06:32_UTC-informational)
...
- **Медиана RTT**: 359 ms
- **Последнее обновление (UTC)**: 2026-07-02 06:32 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 57 · trojan × 40 · vless × 20 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 25 · `pawdroid` × 5 · `surfboard-eternity` × 1
