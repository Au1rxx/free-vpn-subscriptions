...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-388-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-138ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-19_07:23_UTC-informational)
...
| 🇸🇬 Singapore (`SG`) | 3 | [clash-SG.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-SG.yaml) | [singbox-SG.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-SG.json) | [v2ray-base64-SG.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-SG.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 388
- **RTT самого быстрого узла**: 1 ms
- **Медиана RTT**: 138 ms
- **Последнее обновление (UTC)**: 2026-04-19 07:23 UTC

**Распределение протоколов:** shadowsocks × 101 · trojan × 7 · vmess × 42

**Источники в этом запуске:** `freefq` × 2 · `mahdibland-aggregator` × 64 · `mahdibland-shadowsocks` × 67 · `pawdroid` × 3 · `vxiaov-clash` × 14
