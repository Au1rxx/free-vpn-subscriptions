...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2084-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-112ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-02_20:18_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2084
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 112 ms
- **Последнее обновление (UTC)**: 2026-05-02 20:18 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 14 · vless × 87 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
