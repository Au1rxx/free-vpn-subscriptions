...
![узлы](https://img.shields.io/badge/узлы-73-brightgreen) ![живые](https://img.shields.io/badge/живые-2438-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-106ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-02_16:18_UTC-informational)
...
- **Медиана RTT**: 106 ms
- **Последнее обновление (UTC)**: 2026-06-02 16:18 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 25 · vless × 7 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 5 · `pawdroid` × 2
