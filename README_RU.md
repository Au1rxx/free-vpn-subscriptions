...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2470-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-93ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-15_01:12_UTC-informational)
...
- **Медиана RTT**: 93 ms
- **Последнее обновление (UTC)**: 2026-05-15 01:12 UTC

**Распределение протоколов:** shadowsocks × 44 · trojan × 8 · vless × 91 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 32 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 52 · `pawdroid` × 7 · `ruking-clash` × 5 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
