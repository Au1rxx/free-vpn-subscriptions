...
![узлы](https://img.shields.io/badge/узлы-122-brightgreen) ![живые](https://img.shields.io/badge/живые-1790-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-345ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-11_05:14_UTC-informational)
...
- **Выбрано узлов**: 122
- **Живых во всех источниках**: 1790
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 345 ms
- **Последнее обновление (UTC)**: 2026-07-11 05:14 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 56 · trojan × 22 · vless × 25 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 9 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 3 · `ninjastrikers` × 25 · `pawdroid` × 10 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 3
