...
![узлы](https://img.shields.io/badge/узлы-130-brightgreen) ![живые](https://img.shields.io/badge/живые-2018-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-263ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_17:34_UTC-informational)
...
- **Медиана RTT**: 263 ms
- **Последнее обновление (UTC)**: 2026-07-12 17:34 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 60 · trojan × 24 · vless × 30 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 34 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `mfuu-clash` × 5 · `ninjastrikers` × 15 · `pawdroid` × 12 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 2
