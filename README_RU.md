...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1865-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-369ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-16_01:20_UTC-informational)
...
- **Медиана RTT**: 369 ms
- **Последнее обновление (UTC)**: 2026-07-16 01:20 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 71 · trojan × 39 · vless × 25 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `mahdi0024` × 23 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 7 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 12 · `surfboard-eternity` × 2
