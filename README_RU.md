...
![узлы](https://img.shields.io/badge/узлы-75-brightgreen) ![живые](https://img.shields.io/badge/живые-1938-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-229ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_11:25_UTC-informational)
...
- **Медиана RTT**: 229 ms
- **Последнее обновление (UTC)**: 2026-05-28 11:25 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 17 · vless × 13 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 3
