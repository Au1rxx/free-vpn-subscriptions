...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2448-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-127ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_03:11_UTC-informational)
...
- **Медиана RTT**: 127 ms
- **Последнее обновление (UTC)**: 2026-05-11 03:11 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 2 · vless × 98 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 5 · `ninjastrikers` × 72 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 5
