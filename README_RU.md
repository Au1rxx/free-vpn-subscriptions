...
![узлы](https://img.shields.io/badge/узлы-102-brightgreen) ![живые](https://img.shields.io/badge/живые-1812-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-316ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_16:37_UTC-informational)
...
- **Медиана RTT**: 316 ms
- **Последнее обновление (UTC)**: 2026-07-07 16:37 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 21 · vless × 14 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
