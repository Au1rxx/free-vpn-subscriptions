...
![узлы](https://img.shields.io/badge/узлы-137-brightgreen) ![живые](https://img.shields.io/badge/живые-1812-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-369ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_07:30_UTC-informational)
...
- **Выбрано узлов**: 137
- **Живых во всех источниках**: 1812
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 369 ms
- **Последнее обновление (UTC)**: 2026-07-08 07:30 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 74 · trojan × 23 · vless × 24 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 18 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 4 · `ninjastrikers` × 23 · `pawdroid` × 10 · `ruking-clash` × 2 · `surfboard-eternity` × 4
