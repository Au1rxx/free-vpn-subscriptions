...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2451-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-83ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-14_13:16_UTC-informational)
...
- **Медиана RTT**: 83 ms
- **Последнее обновление (UTC)**: 2026-05-14 13:16 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 12 · vless × 88 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 8 · `surfboard-eternity` × 7
