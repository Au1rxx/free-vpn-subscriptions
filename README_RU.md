...
![узлы](https://img.shields.io/badge/узлы-87-brightgreen) ![живые](https://img.shields.io/badge/живые-2080-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-356ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-01_22:27_UTC-informational)
...
- **Выбрано узлов**: 87
- **Живых во всех источниках**: 2080
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 356 ms
- **Последнее обновление (UTC)**: 2026-07-01 22:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 47 · trojan × 23 · vless × 9 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 1 · `surfboard-eternity` × 2
