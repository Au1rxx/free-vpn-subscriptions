...
![узлы](https://img.shields.io/badge/узлы-129-brightgreen) ![живые](https://img.shields.io/badge/живые-2268-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-84ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-18_20:37_UTC-informational)
...
- **Медиана RTT**: 84 ms
- **Последнее обновление (UTC)**: 2026-05-18 20:37 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 16 · trojan × 25 · vless × 68 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `ruking-clash` × 7 · `surfboard-eternity` × 4
