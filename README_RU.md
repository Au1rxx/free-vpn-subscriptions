...
![узлы](https://img.shields.io/badge/узлы-106-brightgreen) ![живые](https://img.shields.io/badge/живые-1947-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-152ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-04_05:09_UTC-informational)
...
- **Медиана RTT**: 152 ms
- **Последнее обновление (UTC)**: 2026-06-04 05:09 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 47 · vless × 29 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 34 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 23 · `pawdroid` × 1 · `surfboard-eternity` × 2
