...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2188-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-111ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-01_11:21_UTC-informational)
...
- **Медиана RTT**: 111 ms
- **Последнее обновление (UTC)**: 2026-05-01 11:21 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 7 · vless × 92 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 61 · `surfboard-eternity` × 6
