...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2314-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-402ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-17_20:19_UTC-informational)
...
|---|---|---|---|---|
| 🇯🇵 Japan (`JP`) | 102 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Медиана RTT**: 402 ms
- **Последнее обновление (UTC)**: 2026-07-17 20:19 UTC

**Распределение протоколов:** shadowsocks × 24 · trojan × 107 · vless × 8 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 60 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 29 · `matin-v2ray` × 1 · `ninjastrikers` × 2 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 16 · `surfboard-eternity` × 5
