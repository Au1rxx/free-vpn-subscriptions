...
![узлы](https://img.shields.io/badge/узлы-113-brightgreen) ![живые](https://img.shields.io/badge/живые-1819-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-380ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_10:20_UTC-informational)
...
- **Выбрано узлов**: 113
- **Живых во всех источниках**: 1819
- **RTT самого быстрого узла**: 47 ms
- **Медиана RTT**: 380 ms
- **Последнее обновление (UTC)**: 2026-07-08 10:20 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 62 · trojan × 23 · vless × 14 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 16 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 8 · `ruking-clash` × 2 · `surfboard-eternity` × 4
