...
![узлы](https://img.shields.io/badge/узлы-140-brightgreen) ![живые](https://img.shields.io/badge/живые-1638-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-402ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-15_10:18_UTC-informational)
...
- **Медиана RTT**: 402 ms
- **Последнее обновление (UTC)**: 2026-07-15 10:18 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 88 · trojan × 29 · vless × 15 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `mahdi0024` × 12 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
