...
![узлы](https://img.shields.io/badge/узлы-128-brightgreen) ![живые](https://img.shields.io/badge/живые-2609-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-384ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_22:13_UTC-informational)
...
- **Выбрано узлов**: 128
- **Живых во всех источниках**: 2609
- **RTT самого быстрого узла**: 25 ms
- **Медиана RTT**: 384 ms
- **Последнее обновление (UTC)**: 2026-04-22 22:13 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 20 · vless × 66 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
