...
![узлы](https://img.shields.io/badge/узлы-131-brightgreen) ![живые](https://img.shields.io/badge/живые-2106-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-182ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-03_22:35_UTC-informational)
...
- **Выбрано узлов**: 131
- **Живых во всех источниках**: 2106
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 182 ms
- **Последнее обновление (UTC)**: 2026-05-03 22:35 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 20 · vless × 72 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `ruking-clash` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
