...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2592-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-104ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_14:40_UTC-informational)
...
- **Медиана RTT**: 104 ms
- **Последнее обновление (UTC)**: 2026-04-26 14:40 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 4 · vless × 92 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 48 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 55 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
