...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2211-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-108ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_13:15_UTC-informational)
...
- **Медиана RTT**: 108 ms
- **Последнее обновление (UTC)**: 2026-04-26 13:15 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 16 · vless × 98 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 68 · `surfboard-eternity` × 9
