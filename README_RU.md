...
![узлы](https://img.shields.io/badge/узлы-120-brightgreen) ![живые](https://img.shields.io/badge/живые-1812-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-366ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_09:35_UTC-informational)
...
- **Медиана RTT**: 366 ms
- **Последнее обновление (UTC)**: 2026-07-08 09:35 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 68 · trojan × 25 · vless × 12 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 19 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 4
