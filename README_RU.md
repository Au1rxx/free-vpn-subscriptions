...
![узлы](https://img.shields.io/badge/узлы-102-brightgreen) ![живые](https://img.shields.io/badge/живые-1867-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-352ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_02:16_UTC-informational)
...
- **Медиана RTT**: 352 ms
- **Последнее обновление (UTC)**: 2026-06-30 02:16 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 39 · trojan × 34 · vless × 20 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 16 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 4
