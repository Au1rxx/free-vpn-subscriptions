...
![узлы](https://img.shields.io/badge/узлы-112-brightgreen) ![живые](https://img.shields.io/badge/живые-1869-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-343ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_20:31_UTC-informational)
...
- **Медиана RTT**: 343 ms
- **Последнее обновление (UTC)**: 2026-07-05 20:31 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 48 · trojan × 24 · vless × 9 · vmess × 30

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 2
