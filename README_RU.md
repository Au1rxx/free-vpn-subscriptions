...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1630-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-388ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-15_07:36_UTC-informational)
...
| 🇩🇪 Germany (`DE`) | 17 | [clash-DE.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-DE.yaml) | [singbox-DE.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-DE.json) | [v2ray-base64-DE.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-DE.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1630
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 388 ms
- **Последнее обновление (UTC)**: 2026-07-15 07:36 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 91 · trojan × 29 · vless × 17 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 25 · `mahdi0024` × 12 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 4 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 2 · `snakem982` × 4 · `surfboard-eternity` × 1
