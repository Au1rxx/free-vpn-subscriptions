...
![узлы](https://img.shields.io/badge/узлы-148-brightgreen) ![живые](https://img.shields.io/badge/живые-2274-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-245ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-05_13:29_UTC-informational)
...
- **Выбрано узлов**: 148
- **Живых во всех источниках**: 2274
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 245 ms
- **Последнее обновление (UTC)**: 2026-05-05 13:29 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 29 · vless × 70 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
