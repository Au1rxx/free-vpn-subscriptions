...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2223-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-136ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_00:19_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2223
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 136 ms
- **Последнее обновление (UTC)**: 2026-04-22 00:19 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 4 · vless × 98 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 71 · `ruking-clash` × 5 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
