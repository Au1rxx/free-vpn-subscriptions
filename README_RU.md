...
![узлы](https://img.shields.io/badge/узлы-106-brightgreen) ![живые](https://img.shields.io/badge/живые-1880-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-357ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_21:23_UTC-informational)
...
- **Выбрано узлов**: 106
- **Живых во всех источниках**: 1880
- **RTT самого быстрого узла**: 24 ms
- **Медиана RTT**: 357 ms
- **Последнее обновление (UTC)**: 2026-07-13 21:23 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 41 · trojan × 21 · vless × 13 · vmess × 30

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 6 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
