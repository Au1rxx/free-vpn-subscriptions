...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2556-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-99ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-28_13:31_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2556
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 99 ms
- **Последнее обновление (UTC)**: 2026-04-28 13:31 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 22 · vless × 96 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 59 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
