...
![узлы](https://img.shields.io/badge/узлы-64-brightgreen) ![живые](https://img.shields.io/badge/живые-2402-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-135ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-02_19:24_UTC-informational)
...
- **Медиана RTT**: 135 ms
- **Последнее обновление (UTC)**: 2026-07-02 19:24 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 23 · trojan × 15 · vless × 8 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 3 · `ninjastrikers` × 8 · `pawdroid` × 4 · `surfboard-eternity` × 6
