...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1954-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-324ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_22:33_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 53 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1954
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 324 ms
- **Последнее обновление (UTC)**: 2026-05-11 22:33 UTC

**Распределение протоколов:** shadowsocks × 52 · trojan × 18 · vless × 69 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 4 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 58 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
