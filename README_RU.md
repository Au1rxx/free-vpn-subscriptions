...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2331-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-81ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-22_20:28_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2331
- **RTT самого быстрого узла**: 40 ms
- **Медиана RTT**: 81 ms
- **Последнее обновление (UTC)**: 2026-05-22 20:28 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 83 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 55 · `pawdroid` × 8 · `ruking-clash` × 5 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
