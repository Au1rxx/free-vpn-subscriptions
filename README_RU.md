...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2064-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-87ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-22_06:15_UTC-informational)
...
- **Медиана RTT**: 87 ms
- **Последнее обновление (UTC)**: 2026-05-22 06:15 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 8 · vless × 87 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 62 · `pawdroid` × 4 · `ruking-clash` × 8 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
