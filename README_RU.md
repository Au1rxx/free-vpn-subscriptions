...
![узлы](https://img.shields.io/badge/узлы-80-brightgreen) ![живые](https://img.shields.io/badge/живые-2071-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-162ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-29_08:34_UTC-informational)
...
- **Медиана RTT**: 162 ms
- **Последнее обновление (UTC)**: 2026-05-29 08:34 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 30 · vless × 14 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 3 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 1 · `surfboard-eternity` × 4
