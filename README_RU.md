...
![узлы](https://img.shields.io/badge/узлы-142-brightgreen) ![живые](https://img.shields.io/badge/живые-2250-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-425ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-04_21:24_UTC-informational)
...
- **Выбрано узлов**: 142
- **Живых во всех источниках**: 2250
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 425 ms
- **Последнее обновление (UTC)**: 2026-05-04 21:24 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 26 · vless × 69 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 56 · `ruking-clash` × 3 · `surfboard-eternity` × 6
