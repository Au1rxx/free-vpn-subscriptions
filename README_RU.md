...
![узлы](https://img.shields.io/badge/узлы-140-brightgreen) ![живые](https://img.shields.io/badge/живые-2556-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-370ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_15:16_UTC-informational)
...
- **Медиана RTT**: 370 ms
- **Последнее обновление (UTC)**: 2026-04-22 15:16 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 21 · vless × 77 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 58 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 9
