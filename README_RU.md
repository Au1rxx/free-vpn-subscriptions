...
![узлы](https://img.shields.io/badge/узлы-60-brightgreen) ![живые](https://img.shields.io/badge/живые-2066-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-166ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_21:30_UTC-informational)
...
- **Медиана RTT**: 166 ms
- **Последнее обновление (UTC)**: 2026-05-28 21:30 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 24 · trojan × 19 · vless × 7 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 8 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
