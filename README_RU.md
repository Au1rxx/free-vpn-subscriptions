...
![узлы](https://img.shields.io/badge/узлы-129-brightgreen) ![живые](https://img.shields.io/badge/живые-1777-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-379ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_18:13_UTC-informational)
...
- **Выбрано узлов**: 129
- **Живых во всех источниках**: 1777
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 379 ms
- **Последнее обновление (UTC)**: 2026-07-08 18:13 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 72 · trojan × 20 · vless × 13 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 20 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 4 · `ninjastrikers` × 15 · `pawdroid` × 8 · `ruking-clash` × 2 · `surfboard-eternity` × 3
