...
![узлы](https://img.shields.io/badge/узлы-142-brightgreen) ![живые](https://img.shields.io/badge/живые-2067-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-406ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-23_06:16_UTC-informational)
...
- **Выбрано узлов**: 142
- **Живых во всех источниках**: 2067
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 406 ms
- **Последнее обновление (UTC)**: 2026-06-23 06:16 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 35 · trojan × 29 · vless × 61 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 51 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 4
