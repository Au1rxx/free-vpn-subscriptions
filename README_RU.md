...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2427-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-116ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-13_18:30_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2427
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 116 ms
- **Последнее обновление (UTC)**: 2026-05-13 18:30 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 20 · vless × 81 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 3 · `ruking-clash` × 6 · `snakem982` × 2 · `surfboard-eternity` × 4
