...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2094-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-92ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-29_00:26_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2094
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 92 ms
- **Последнее обновление (UTC)**: 2026-04-29 00:26 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 8 · vless × 99 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
