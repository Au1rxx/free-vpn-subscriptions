...
![узлы](https://img.shields.io/badge/узлы-134-brightgreen) ![живые](https://img.shields.io/badge/живые-1915-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-349ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-06_03:20_UTC-informational)
...
- **Выбрано узлов**: 134
- **Живых во всех источниках**: 1915
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 349 ms
- **Последнее обновление (UTC)**: 2026-07-06 03:20 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 54 · trojan × 33 · vless × 17 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 5 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 3
