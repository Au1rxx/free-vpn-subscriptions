...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2289-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-398ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-17_15:30_UTC-informational)
...
|---|---|---|---|---|
| 🇯🇵 Japan (`JP`) | 89 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Медиана RTT**: 398 ms
- **Последнее обновление (UTC)**: 2026-07-17 15:30 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 94 · vless × 14 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 3 · `mahdi0024` × 53 · `mahdibland-aggregator` × 32 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 4 · `ninjastrikers` × 4 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 19 · `surfboard-eternity` × 3
