...
![узлы](https://img.shields.io/badge/узлы-144-brightgreen) ![живые](https://img.shields.io/badge/живые-1926-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-481ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-22_13:37_UTC-informational)
...
- **Выбрано узлов**: 144
- **Живых во всех источниках**: 1926
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 481 ms
- **Последнее обновление (UTC)**: 2026-06-22 13:37 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 29 · vless × 62 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 41 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 8
