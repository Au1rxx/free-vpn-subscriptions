...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2600-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-163ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_02:32_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2600
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 163 ms
- **Последнее обновление (UTC)**: 2026-04-23 02:32 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 14 · vless × 96 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 75 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
