...
![узлы](https://img.shields.io/badge/узлы-88-brightgreen) ![живые](https://img.shields.io/badge/живые-2206-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-277ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-11_07:32_UTC-informational)
...
- **Медиана RTT**: 277 ms
- **Последнее обновление (UTC)**: 2026-06-11 07:32 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 14 · vless × 16 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 3
