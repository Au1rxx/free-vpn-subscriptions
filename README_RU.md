...
![узлы](https://img.shields.io/badge/узлы-98-brightgreen) ![живые](https://img.shields.io/badge/живые-1938-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-346ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_09:36_UTC-informational)
...
- **Медиана RTT**: 346 ms
- **Последнее обновление (UTC)**: 2026-07-14 09:36 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 16 · vless × 14 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 6 · `snakem982` × 1 · `surfboard-eternity` × 5
