...
![узлы](https://img.shields.io/badge/узлы-140-brightgreen) ![живые](https://img.shields.io/badge/живые-2214-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-284ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-05_17:15_UTC-informational)
...
- **Выбрано узлов**: 140
- **Живых во всех источниках**: 2214
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 284 ms
- **Последнее обновление (UTC)**: 2026-05-05 17:15 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 26 · vless × 69 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `snakem982` × 1 · `surfboard-eternity` × 9
