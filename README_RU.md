...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2305-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-350ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-08_18:33_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2305
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 350 ms
- **Последнее обновление (UTC)**: 2026-05-08 18:33 UTC

**Распределение протоколов:** shadowsocks × 54 · trojan × 18 · vless × 67 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 7 · `mahdi0024` × 6 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 9
