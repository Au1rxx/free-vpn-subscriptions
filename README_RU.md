...
![узлы](https://img.shields.io/badge/узлы-121-brightgreen) ![живые](https://img.shields.io/badge/живые-2461-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-493ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-19_10:26_UTC-informational)
...
- **Выбрано узлов**: 121
- **Живых во всех источниках**: 2461
- **RTT самого быстрого узла**: 38 ms
- **Медиана RTT**: 493 ms
- **Последнее обновление (UTC)**: 2026-06-19 10:26 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 32 · trojan × 21 · vless × 52 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 20 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 42 · `snakem982` × 3 · `surfboard-eternity` × 2
