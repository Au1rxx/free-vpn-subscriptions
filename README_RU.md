...
![узлы](https://img.shields.io/badge/узлы-148-brightgreen) ![живые](https://img.shields.io/badge/живые-2480-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-234ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_14:30_UTC-informational)
...
- **Медиана RTT**: 234 ms
- **Последнее обновление (UTC)**: 2026-05-09 14:30 UTC

**Распределение протоколов:** shadowsocks × 49 · trojan × 18 · vless × 73 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 3 · `ruking-clash` × 7 · `snakem982` × 2 · `surfboard-eternity` × 7
