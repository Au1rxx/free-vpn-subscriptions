...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2378-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-107ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-12_22:17_UTC-informational)
...
- **Медиана RTT**: 107 ms
- **Последнее обновление (UTC)**: 2026-05-12 22:17 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 16 · vless × 87 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 40 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 47 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
