...
![узлы](https://img.shields.io/badge/узлы-138-brightgreen) ![живые](https://img.shields.io/badge/живые-1698-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-373ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_01:23_UTC-informational)
...
- **Выбрано узлов**: 138
- **Живых во всех источниках**: 1698
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 373 ms
- **Последнее обновление (UTC)**: 2026-06-15 01:23 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 56 · trojan × 26 · vless × 41 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 36 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 2
