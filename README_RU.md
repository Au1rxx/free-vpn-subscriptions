...
![узлы](https://img.shields.io/badge/узлы-106-brightgreen) ![живые](https://img.shields.io/badge/живые-1901-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-342ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-06_23:19_UTC-informational)
...
- **Медиана RTT**: 342 ms
- **Последнее обновление (UTC)**: 2026-07-06 23:19 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 44 · trojan × 30 · vless × 10 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 6 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
