...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1980-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-396ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-24_00:12_UTC-informational)
...
- **Медиана RTT**: 396 ms
- **Последнее обновление (UTC)**: 2026-06-24 00:12 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 43 · trojan × 32 · vless × 61 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 43 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 27 · `pawdroid` × 7 · `ruking-clash` × 16 · `surfboard-eternity` × 3
