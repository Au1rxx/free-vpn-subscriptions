...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2364-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-94ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-23_21:15_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2364
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 94 ms
- **Последнее обновление (UTC)**: 2026-05-23 21:15 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 22 · vless × 63 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 40 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 4 · `surfboard-eternity` × 4
