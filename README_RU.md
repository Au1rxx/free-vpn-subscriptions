...
![узлы](https://img.shields.io/badge/узлы-115-brightgreen) ![живые](https://img.shields.io/badge/живые-1785-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-365ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_13:16_UTC-informational)
...
- **Медиана RTT**: 365 ms
- **Последнее обновление (UTC)**: 2026-07-07 13:16 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 59 · trojan × 22 · vless × 10 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 7 · `ruking-clash` × 3 · `surfboard-eternity` × 1
