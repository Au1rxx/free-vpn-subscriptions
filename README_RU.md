...
![узлы](https://img.shields.io/badge/узлы-139-brightgreen) ![живые](https://img.shields.io/badge/живые-1902-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-426ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-22_08:39_UTC-informational)
...
- **Медиана RTT**: 426 ms
- **Последнее обновление (UTC)**: 2026-06-22 08:39 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 45 · trojan × 26 · vless × 54 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 4 · `surfboard-eternity` × 4
