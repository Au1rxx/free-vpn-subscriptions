...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1883-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-212ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_16:38_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1883
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 212 ms
- **Последнее обновление (UTC)**: 2026-05-11 16:38 UTC

**Распределение протоколов:** shadowsocks × 65 · trojan × 7 · vless × 65 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 54 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
