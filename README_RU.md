...
![узлы](https://img.shields.io/badge/узлы-97-brightgreen) ![живые](https://img.shields.io/badge/живые-1932-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-331ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_13:18_UTC-informational)
...
- **Медиана RTT**: 331 ms
- **Последнее обновление (UTC)**: 2026-07-14 13:18 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 42 · trojan × 15 · vless × 13 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 4 · `ninjastrikers` × 10 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 3
