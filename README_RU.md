...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1961-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-573ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-16_20:15_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 85 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1961
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 573 ms
- **Последнее обновление (UTC)**: 2026-06-16 20:15 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 46 · trojan × 20 · vless × 12 · vmess × 71

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 73 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 3
