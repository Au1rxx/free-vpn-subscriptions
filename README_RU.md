...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2604-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-164ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_03:37_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2604
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 164 ms
- **Последнее обновление (UTC)**: 2026-04-23 03:37 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 16 · vless × 96 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 77 · `snakem982` × 1 · `surfboard-eternity` × 6
