...
![узлы](https://img.shields.io/badge/узлы-143-brightgreen) ![живые](https://img.shields.io/badge/живые-2358-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-109ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-24_22:18_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 77 | [clash-US.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Выбрано узлов**: 143
- **Живых во всех источниках**: 2358
- **RTT самого быстрого узла**: 23 ms
- **Медиана RTT**: 109 ms
- **Последнее обновление (UTC)**: 2026-05-24 22:18 UTC

**Распределение протоколов:** shadowsocks × 44 · trojan × 18 · vless × 53 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 49 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
