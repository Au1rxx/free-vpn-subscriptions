...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2515-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-106ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_01:33_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2515
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 106 ms
- **Последнее обновление (UTC)**: 2026-05-10 01:33 UTC

**Распределение протоколов:** shadowsocks × 50 · trojan × 4 · vless × 88 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 66 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
