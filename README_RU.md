...
![узлы](https://img.shields.io/badge/узлы-74-brightgreen) ![живые](https://img.shields.io/badge/живые-1982-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-180ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-03_15:35_UTC-informational)
...
- **Медиана RTT**: 180 ms
- **Последнее обновление (UTC)**: 2026-07-03 15:35 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 23 · vless × 6 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
