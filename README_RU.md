...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2465-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-140ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_11:32_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2465
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 140 ms
- **Последнее обновление (UTC)**: 2026-05-10 11:32 UTC

**Распределение протоколов:** shadowsocks × 51 · trojan × 4 · vless × 85 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 8
