...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2474-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-97ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-15_00:25_UTC-informational)
...
- **Медиана RTT**: 97 ms
- **Последнее обновление (UTC)**: 2026-05-15 00:25 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 8 · vless × 92 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 3 · `epodonios` × 2 · `lagzian-mix` × 7 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 60 · `pawdroid` × 7 · `ruking-clash` × 5 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
