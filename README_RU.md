...
![узлы](https://img.shields.io/badge/узлы-143-brightgreen) ![живые](https://img.shields.io/badge/живые-2098-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-379ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-21_07:34_UTC-informational)
...
- **Выбрано узлов**: 143
- **Живых во всех источниках**: 2098
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 379 ms
- **Последнее обновление (UTC)**: 2026-06-21 07:34 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 31 · vless × 45 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 33 · `snakem982` × 2 · `surfboard-eternity` × 2
