...
![узлы](https://img.shields.io/badge/узлы-83-brightgreen) ![живые](https://img.shields.io/badge/живые-2027-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-153ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_07:26_UTC-informational)
...
- **Медиана RTT**: 153 ms
- **Последнее обновление (UTC)**: 2026-07-04 07:26 UTC

**Распределение протоколов:** shadowsocks × 25 · trojan × 21 · vless × 17 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 7 · `ninjastrikers` × 17 · `pawdroid` × 8 · `ruking-clash` × 2 · `surfboard-eternity` × 3
