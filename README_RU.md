...
![узлы](https://img.shields.io/badge/узлы-94-brightgreen) ![живые](https://img.shields.io/badge/живые-1850-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-358ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-09_07:25_UTC-informational)
...
- **Выбрано узлов**: 94
- **Живых во всех источниках**: 1850
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 358 ms
- **Последнее обновление (UTC)**: 2026-06-09 07:25 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 46 · trojan × 21 · vless × 16 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 8 · `surfboard-eternity` × 3
