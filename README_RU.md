...
![узлы](https://img.shields.io/badge/узлы-72-brightgreen) ![живые](https://img.shields.io/badge/живые-2105-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-155ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-10_12:27_UTC-informational)
...
- **Медиана RTT**: 155 ms
- **Последнее обновление (UTC)**: 2026-07-10 12:27 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 10 · vless × 13 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
