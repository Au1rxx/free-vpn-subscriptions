...
![узлы](https://img.shields.io/badge/узлы-149-brightgreen) ![живые](https://img.shields.io/badge/живые-2331-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-447ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_16:34_UTC-informational)
...
- **Медиана RTT**: 447 ms
- **Последнее обновление (UTC)**: 2026-04-21 16:34 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 19 · vless × 87 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 50 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
