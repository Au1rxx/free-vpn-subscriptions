...
![узлы](https://img.shields.io/badge/узлы-107-brightgreen) ![живые](https://img.shields.io/badge/живые-1881-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-372ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-06_12:28_UTC-informational)
...
- **Выбрано узлов**: 107
- **Живых во всех источниках**: 1881
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 372 ms
- **Последнее обновление (UTC)**: 2026-07-06 12:28 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 38 · trojan × 30 · vless × 9 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 6 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 4
