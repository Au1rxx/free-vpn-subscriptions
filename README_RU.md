...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1990-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-399ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-16_04:14_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1990
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 399 ms
- **Последнее обновление (UTC)**: 2026-07-16 04:14 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 46 · trojan × 71 · vless × 21 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 69 · `matin-v2ray` × 4 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 8 · `surfboard-eternity` × 1
