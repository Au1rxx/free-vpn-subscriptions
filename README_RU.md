...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2210-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-154ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-30_11:30_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2210
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 154 ms
- **Последнее обновление (UTC)**: 2026-04-30 11:30 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 20 · vless × 86 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 36 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 64 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
