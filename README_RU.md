...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2246-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-435ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-20_21:12_UTC-informational)
...
- **Медиана RTT**: 435 ms
- **Последнее обновление (UTC)**: 2026-04-20 21:12 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 5 · vless × 103 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 60 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 44 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 4
