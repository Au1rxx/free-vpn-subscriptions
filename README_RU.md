...
![узлы](https://img.shields.io/badge/узлы-135-brightgreen) ![живые](https://img.shields.io/badge/живые-2550-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-287ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_20:29_UTC-informational)
...
- **Выбрано узлов**: 135
- **Живых во всех источниках**: 2550
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 287 ms
- **Последнее обновление (UTC)**: 2026-04-22 20:29 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 22 · vless × 70 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `epodonios` × 11 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 50 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
