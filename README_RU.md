...
![узлы](https://img.shields.io/badge/узлы-141-brightgreen) ![живые](https://img.shields.io/badge/живые-2567-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-176ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-24_21:34_UTC-informational)
...
- **Медиана RTT**: 176 ms
- **Последнее обновление (UTC)**: 2026-04-24 21:34 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 23 · vless × 78 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 33 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 54 · `snakem982` × 1 · `surfboard-eternity` × 4
