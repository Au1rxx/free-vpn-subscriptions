...
![узлы](https://img.shields.io/badge/узлы-137-brightgreen) ![живые](https://img.shields.io/badge/живые-2459-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-204ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_14:14_UTC-informational)
...
- **Выбрано узлов**: 137
- **Живых во всех источниках**: 2459
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 204 ms
- **Последнее обновление (UTC)**: 2026-04-23 14:14 UTC

**Распределение протоколов:** shadowsocks × 17 · trojan × 20 · vless × 86 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 59 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 5
