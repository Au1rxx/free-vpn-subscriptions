...
![узлы](https://img.shields.io/badge/узлы-119-brightgreen) ![живые](https://img.shields.io/badge/живые-2394-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-488ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-18_23:23_UTC-informational)
...
- **Выбрано узлов**: 119
- **Живых во всех источниках**: 2394
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 488 ms
- **Последнее обновление (UTC)**: 2026-06-18 23:23 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 39 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 38 · `snakem982` × 6 · `surfboard-eternity` × 2
