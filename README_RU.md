...
![узлы](https://img.shields.io/badge/узлы-100-brightgreen) ![живые](https://img.shields.io/badge/живые-2211-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-357ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-02_11:21_UTC-informational)
...
- **Выбрано узлов**: 100
- **Живых во всех источниках**: 2211
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 357 ms
- **Последнее обновление (UTC)**: 2026-07-02 11:21 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 24 · vless × 18 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 8 · `ninjastrikers` × 17 · `pawdroid` × 4 · `surfboard-eternity` × 6
