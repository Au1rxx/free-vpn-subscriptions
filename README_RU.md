...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-394-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-137ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-19_09:40_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 394
- **RTT самого быстрого узла**: 1 ms
- **Медиана RTT**: 137 ms
- **Последнее обновление (UTC)**: 2026-04-19 09:40 UTC

**Распределение протоколов:** shadowsocks × 101 · trojan × 8 · vmess × 41

**Источники в этом запуске:** `freefq` × 2 · `mahdibland-aggregator` × 56 · `mahdibland-shadowsocks` × 73 · `pawdroid` × 4 · `vxiaov-clash` × 15
