...
![узлы](https://img.shields.io/badge/узлы-94-brightgreen) ![живые](https://img.shields.io/badge/живые-1880-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-408ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-29_16:21_UTC-informational)
...
- **Медиана RTT**: 408 ms
- **Последнее обновление (UTC)**: 2026-06-29 16:21 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 33 · vless × 21 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
