...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2218-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-101ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_06:10_UTC-informational)
...
- **Медиана RTT**: 101 ms
- **Последнее обновление (UTC)**: 2026-04-21 06:10 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 2 · vless × 105 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 47 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 57 · `pawdroid` × 1 · `ruking-clash` × 8 · `surfboard-eternity` × 6
