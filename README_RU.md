...
![узлы](https://img.shields.io/badge/узлы-105-brightgreen) ![живые](https://img.shields.io/badge/живые-1980-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-420ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-18_12:12_UTC-informational)
...
- **Медиана RTT**: 420 ms
- **Последнее обновление (UTC)**: 2026-06-18 12:12 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 35 · trojan × 31 · vless × 31 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 9 · `pawdroid` × 6 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 6
