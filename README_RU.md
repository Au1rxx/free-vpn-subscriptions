...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1913-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-106ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-12_09:34_UTC-informational)
...
- **Медиана RTT**: 106 ms
- **Последнее обновление (UTC)**: 2026-05-12 09:34 UTC

**Распределение протоколов:** shadowsocks × 60 · trojan × 2 · vless × 77 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 4 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 60 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
