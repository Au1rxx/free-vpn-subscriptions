...
![узлы](https://img.shields.io/badge/узлы-92-brightgreen) ![живые](https://img.shields.io/badge/живые-2247-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-347ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-02_12:25_UTC-informational)
...
- **Выбрано узлов**: 92
- **Живых во всех источниках**: 2247
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 347 ms
- **Последнее обновление (UTC)**: 2026-07-02 12:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 14 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 8 · `ninjastrikers` × 16 · `pawdroid` × 5 · `surfboard-eternity` × 3
