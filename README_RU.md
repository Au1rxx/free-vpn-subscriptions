...
![узлы](https://img.shields.io/badge/узлы-112-brightgreen) ![живые](https://img.shields.io/badge/живые-2542-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-279ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-02_06:37_UTC-informational)
...
- **Выбрано узлов**: 112
- **Живых во всех источниках**: 2542
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 279 ms
- **Последнее обновление (UTC)**: 2026-06-02 06:37 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 37 · vless × 16 · vmess × 18

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 19 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
