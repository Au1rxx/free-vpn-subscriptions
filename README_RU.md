...
![узлы](https://img.shields.io/badge/узлы-50-brightgreen) ![живые](https://img.shields.io/badge/живые-2049-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-163ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-29_10:33_UTC-informational)
...
- **Медиана RTT**: 163 ms
- **Последнее обновление (UTC)**: 2026-05-29 10:33 UTC

**Распределение протоколов:** shadowsocks × 24 · trojan × 10 · vless × 7 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `ruking-clash` × 2 · `surfboard-eternity` × 5
