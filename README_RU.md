...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2411-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-399ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-18_21:13_UTC-informational)
...
|---|---|---|---|---|
| 🇯🇵 Japan (`JP`) | 85 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2411
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 399 ms
- **Последнее обновление (UTC)**: 2026-07-18 21:13 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 32 · trojan × 100 · vless × 11 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 28 · `mahdibland-aggregator` × 37 · `mahdibland-shadowsocks` × 40 · `matin-v2ray` × 5 · `ninjastrikers` × 5 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 16 · `surfboard-eternity` × 3
