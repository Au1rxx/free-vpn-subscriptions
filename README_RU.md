...
![узлы](https://img.shields.io/badge/узлы-118-brightgreen) ![живые](https://img.shields.io/badge/живые-1775-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-360ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-09_10:13_UTC-informational)
...
- **Выбрано узлов**: 118
- **Живых во всех источниках**: 1775
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 360 ms
- **Последнее обновление (UTC)**: 2026-07-09 10:13 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 56 · trojan × 20 · vless × 16 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 7 · `ninjastrikers` × 15 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 3
