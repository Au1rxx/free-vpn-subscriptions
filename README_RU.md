...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2447-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-99ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-24_01:30_UTC-informational)
...
- **Медиана RTT**: 99 ms
- **Последнее обновление (UTC)**: 2026-04-24 01:30 UTC

**Распределение протоколов:** shadowsocks × 20 · trojan × 13 · vless × 104 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 25 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
