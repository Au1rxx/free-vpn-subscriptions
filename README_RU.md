...
![узлы](https://img.shields.io/badge/узлы-92-brightgreen) ![живые](https://img.shields.io/badge/живые-1954-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-479ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-26_07:35_UTC-informational)
...
- **Медиана RTT**: 479 ms
- **Последнее обновление (UTC)**: 2026-06-26 07:35 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 40 · vless × 19 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 19 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 5 · `ruking-clash` × 16 · `surfboard-eternity` × 3
