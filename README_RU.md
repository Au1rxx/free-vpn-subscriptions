...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2547-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-88ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_03:11_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2547
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 88 ms
- **Последнее обновление (UTC)**: 2026-04-27 03:11 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 4 · vless × 100 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 46 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 55 · `pawdroid` × 1 · `surfboard-eternity` × 6
