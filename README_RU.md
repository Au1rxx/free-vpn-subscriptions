...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2425-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-137ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_03:27_UTC-informational)
...
- **Медиана RTT**: 137 ms
- **Последнее обновление (UTC)**: 2026-05-09 03:27 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 10 · vless × 92 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 72 · `pawdroid` × 1 · `surfboard-eternity` × 7
