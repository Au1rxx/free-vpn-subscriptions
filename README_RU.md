...
![узлы](https://img.shields.io/badge/узлы-97-brightgreen) ![живые](https://img.shields.io/badge/живые-1933-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-344ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_17:10_UTC-informational)
...
- **Выбрано узлов**: 97
- **Живых во всех источниках**: 1933
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 344 ms
- **Последнее обновление (UTC)**: 2026-07-13 17:10 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 45 · trojan × 14 · vless × 12 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 26 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 4 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
