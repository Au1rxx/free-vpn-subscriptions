...
![узлы](https://img.shields.io/badge/узлы-130-brightgreen) ![живые](https://img.shields.io/badge/живые-1799-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-277ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-09_02:18_UTC-informational)
...
- **Медиана RTT**: 277 ms
- **Последнее обновление (UTC)**: 2026-07-09 02:18 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 57 · trojan × 27 · vless × 22 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 8 · `ninjastrikers` × 21 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 4
