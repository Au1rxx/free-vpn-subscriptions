...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2425-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-107ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_05:21_UTC-informational)
...
- **Медиана RTT**: 107 ms
- **Последнее обновление (UTC)**: 2026-05-09 05:21 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 15 · vless × 89 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 75 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 5
