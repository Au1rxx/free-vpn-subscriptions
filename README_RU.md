...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1857-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-471ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-22_15:32_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1857
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 471 ms
- **Последнее обновление (UTC)**: 2026-06-22 15:32 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 31 · vless × 66 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `epodonios` × 41 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 2 · `surfboard-eternity` × 3
