...
![узлы](https://img.shields.io/badge/узлы-132-brightgreen) ![живые](https://img.shields.io/badge/живые-1748-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-386ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_14:16_UTC-informational)
...
- **Выбрано узлов**: 132
- **Живых во всех источниках**: 1748
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 386 ms
- **Последнее обновление (UTC)**: 2026-07-14 14:16 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 83 · trojan × 20 · vless × 15 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `mahdi0024` × 11 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
