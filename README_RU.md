...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2025-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-168ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-07_11:22_UTC-informational)
...
- **Медиана RTT**: 168 ms
- **Последнее обновление (UTC)**: 2026-05-07 11:22 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 9 · vless × 88 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 69 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
