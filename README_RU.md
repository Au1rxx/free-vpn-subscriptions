...
![узлы](https://img.shields.io/badge/узлы-95-brightgreen) ![живые](https://img.shields.io/badge/живые-1940-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-307ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-27_21:11_UTC-informational)
...
- **Медиана RTT**: 307 ms
- **Последнее обновление (UTC)**: 2026-06-27 21:11 UTC

**Распределение протоколов:** shadowsocks × 24 · trojan × 37 · vless × 20 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 22 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 4
