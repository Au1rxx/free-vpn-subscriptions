...
![узлы](https://img.shields.io/badge/узлы-91-brightgreen) ![живые](https://img.shields.io/badge/живые-1918-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-309ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_19:17_UTC-informational)
...
- **Медиана RTT**: 309 ms
- **Последнее обновление (UTC)**: 2026-07-13 19:17 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 11 · vless × 11 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `mahdi0024` × 26 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 6 · `ninjastrikers` × 7 · `pawdroid` × 2 · `ruking-clash` × 1
