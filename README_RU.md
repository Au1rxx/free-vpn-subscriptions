...
![узлы](https://img.shields.io/badge/узлы-85-brightgreen) ![живые](https://img.shields.io/badge/живые-2033-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-198ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_07:27_UTC-informational)
...
- **Медиана RTT**: 198 ms
- **Последнее обновление (UTC)**: 2026-05-28 07:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 30 · trojan × 24 · vless × 19 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 5
