...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2413-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-227ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_20:29_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2413
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 227 ms
- **Последнее обновление (UTC)**: 2026-05-10 20:29 UTC

**Распределение протоколов:** shadowsocks × 50 · trojan × 12 · vless × 77 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 52 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 6 · `surfboard-eternity` × 2 · `vxiaov-clash` × 1
