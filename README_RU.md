...
![узлы](https://img.shields.io/badge/узлы-123-brightgreen) ![живые](https://img.shields.io/badge/живые-1784-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-348ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-09_06:13_UTC-informational)
...
- **Выбрано узлов**: 123
- **Живых во всех источниках**: 1784
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 348 ms
- **Последнее обновление (UTC)**: 2026-07-09 06:13 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 50 · trojan × 28 · vless × 17 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 4 · `ninjastrikers` × 22 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 3
