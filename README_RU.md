...
![узлы](https://img.shields.io/badge/узлы-84-brightgreen) ![живые](https://img.shields.io/badge/живые-2314-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-276ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-19_17:09_UTC-informational)
...
- **Медиана RTT**: 276 ms
- **Последнее обновление (UTC)**: 2026-06-19 17:09 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 23 · vless × 10 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 4 · `ruking-clash` × 18 · `surfboard-eternity` × 7
