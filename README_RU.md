...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-1968-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-331ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_13:39_UTC-informational)
...
- **Выбрано узлов**: 114
- **Живых во всех источниках**: 1968
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 331 ms
- **Последнее обновление (UTC)**: 2026-07-05 13:39 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 24 · vless × 12 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 34 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 10 · `ninjastrikers` × 13 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
