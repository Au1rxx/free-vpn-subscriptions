...
![узлы](https://img.shields.io/badge/узлы-145-brightgreen) ![живые](https://img.shields.io/badge/живые-2526-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-187ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_10:10_UTC-informational)
...
- **Медиана RTT**: 187 ms
- **Последнее обновление (UTC)**: 2026-04-23 10:10 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 20 · vless × 87 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 67 · `pawdroid` × 1 · `surfboard-eternity` × 5
