...
![узлы](https://img.shields.io/badge/узлы-121-brightgreen) ![живые](https://img.shields.io/badge/живые-2011-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-332ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_00:35_UTC-informational)
...
- **Выбрано узлов**: 121
- **Живых во всех источниках**: 2011
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 332 ms
- **Последнее обновление (UTC)**: 2026-07-05 00:35 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 55 · trojan × 23 · vless × 17 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 39 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
