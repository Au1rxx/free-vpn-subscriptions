...
![узлы](https://img.shields.io/badge/узлы-125-brightgreen) ![живые](https://img.shields.io/badge/живые-2536-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-187ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-02_05:38_UTC-informational)
...
- **Медиана RTT**: 187 ms
- **Последнее обновление (UTC)**: 2026-06-02 05:38 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 41 · trojan × 36 · vless × 21 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 25 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 7
