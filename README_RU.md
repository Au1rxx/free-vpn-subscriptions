...
![узлы](https://img.shields.io/badge/узлы-137-brightgreen) ![живые](https://img.shields.io/badge/живые-1701-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-377ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-14_04:23_UTC-informational)
...
- **Выбрано узлов**: 137
- **Живых во всех источниках**: 1701
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 377 ms
- **Последнее обновление (UTC)**: 2026-06-14 04:23 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 53 · trojan × 40 · vless × 36 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 17 · `ninjastrikers` × 34 · `pawdroid` × 3 · `ruking-clash` × 22 · `surfboard-eternity` × 4
