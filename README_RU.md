...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2452-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-156ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_19:14_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2452
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 156 ms
- **Последнее обновление (UTC)**: 2026-04-27 19:14 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 19 · vless × 92 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 31 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
