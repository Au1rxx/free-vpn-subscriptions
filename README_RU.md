...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-2262-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-359ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-12_06:10_UTC-informational)
...
- **Выбрано узлов**: 111
- **Живых во всех источниках**: 2262
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 359 ms
- **Последнее обновление (UTC)**: 2026-06-12 06:10 UTC

**Распределение протоколов:** shadowsocks × 46 · trojan × 41 · vless × 18 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 33 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 5
