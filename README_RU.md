...
![узлы](https://img.shields.io/badge/узлы-138-brightgreen) ![живые](https://img.shields.io/badge/живые-2105-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-164ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-28_22:33_UTC-informational)
...
- **Медиана RTT**: 164 ms
- **Последнее обновление (UTC)**: 2026-04-28 22:33 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 22 · vless × 75 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 35 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 53 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
