...
![узлы](https://img.shields.io/badge/узлы-81-brightgreen) ![живые](https://img.shields.io/badge/живые-2550-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-101ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-02_08:34_UTC-informational)
...
- **Медиана RTT**: 101 ms
- **Последнее обновление (UTC)**: 2026-06-02 08:34 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 22 · trojan × 26 · vless × 11 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 6 · `snakem982` × 1
