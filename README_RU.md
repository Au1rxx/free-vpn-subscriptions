...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2531-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-95ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-20_11:31_UTC-informational)
...
- **Медиана RTT**: 95 ms
- **Последнее обновление (UTC)**: 2026-04-20 11:31 UTC

**Распределение протоколов:** shadowsocks × 19 · trojan × 16 · vless × 101 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 35 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 3 · `ninjastrikers` × 59 · `ruking-clash` × 7 · `surfboard-eternity` × 1
