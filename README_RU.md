...
![узлы](https://img.shields.io/badge/узлы-65-brightgreen) ![живые](https://img.shields.io/badge/живые-2404-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-152ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-02_23:16_UTC-informational)
...
- **Медиана RTT**: 152 ms
- **Последнее обновление (UTC)**: 2026-07-02 23:16 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 17 · vless × 5 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 1 · `surfboard-eternity` × 5
