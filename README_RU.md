...
![узлы](https://img.shields.io/badge/узлы-98-brightgreen) ![живые](https://img.shields.io/badge/живые-1857-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-354ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_18:14_UTC-informational)
...
- **Медиана RTT**: 354 ms
- **Последнее обновление (UTC)**: 2026-06-07 18:14 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 54 · trojan × 22 · vless × 15 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 24 · `mfuu-clash` × 4 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 1
