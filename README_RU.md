...
![узлы](https://img.shields.io/badge/узлы-112-brightgreen) ![живые](https://img.shields.io/badge/живые-1973-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-339ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_14:12_UTC-informational)
...
- **Выбрано узлов**: 112
- **Живых во всех источниках**: 1973
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 339 ms
- **Последнее обновление (UTC)**: 2026-07-05 14:12 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 42 · trojan × 25 · vless × 13 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
