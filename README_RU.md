...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2209-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-97ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-01_02:17_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2209
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 97 ms
- **Последнее обновление (UTC)**: 2026-05-01 02:17 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 5 · vless × 97 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 68 · `snakem982` × 1 · `surfboard-eternity` × 5
