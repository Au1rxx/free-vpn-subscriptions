...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2203-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-93ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_10:24_UTC-informational)
...
- **Медиана RTT**: 93 ms
- **Последнее обновление (UTC)**: 2026-04-26 10:24 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 11 · vless × 100 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 68 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
