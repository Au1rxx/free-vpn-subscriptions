...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2154-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-155ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-01_16:37_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2154
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 155 ms
- **Последнее обновление (UTC)**: 2026-05-01 16:37 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 15 · vless × 82 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 51 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
