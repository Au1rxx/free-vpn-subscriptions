...
![узлы](https://img.shields.io/badge/узлы-99-brightgreen) ![живые](https://img.shields.io/badge/живые-2330-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-167ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_02:22_UTC-informational)
...
- **Медиана RTT**: 167 ms
- **Последнее обновление (UTC)**: 2026-06-10 02:22 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 14 · vless × 28 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 29 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 5
