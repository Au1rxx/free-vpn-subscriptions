...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2117-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-96ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-02_04:18_UTC-informational)
...
- **Медиана RTT**: 96 ms
- **Последнее обновление (UTC)**: 2026-05-02 04:18 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 6 · vless × 94 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 32 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 56 · `pawdroid` × 1 · `surfboard-eternity` × 8
