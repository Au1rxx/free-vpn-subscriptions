...
![узлы](https://img.shields.io/badge/узлы-146-brightgreen) ![живые](https://img.shields.io/badge/живые-2057-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-429ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-21_12:34_UTC-informational)
...
- **Выбрано узлов**: 146
- **Живых во всех источниках**: 2057
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 429 ms
- **Последнее обновление (UTC)**: 2026-06-21 12:34 UTC

**Распределение протоколов:** shadowsocks × 45 · trojan × 34 · vless × 44 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 21 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 37 · `surfboard-eternity` × 3
