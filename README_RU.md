...
![узлы](https://img.shields.io/badge/узлы-79-brightgreen) ![живые](https://img.shields.io/badge/живые-2109-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-568ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-28_21:21_UTC-informational)
...
- **Медиана RTT**: 568 ms
- **Последнее обновление (UTC)**: 2026-06-28 21:21 UTC

**Распределение протоколов:** shadowsocks × 16 · trojan × 30 · vless × 18 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 3
