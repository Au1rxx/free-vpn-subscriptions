...
![узлы](https://img.shields.io/badge/узлы-144-brightgreen) ![живые](https://img.shields.io/badge/живые-2082-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-193ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-03_17:22_UTC-informational)
...
- **Выбрано узлов**: 144
- **Живых во всех источниках**: 2082
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 193 ms
- **Последнее обновление (UTC)**: 2026-05-03 17:22 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 23 · vless × 82 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 3 · `ninjastrikers` × 54 · `ruking-clash` × 1 · `surfboard-eternity` × 6
