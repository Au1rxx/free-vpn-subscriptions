...
![узлы](https://img.shields.io/badge/узлы-133-brightgreen) ![живые](https://img.shields.io/badge/живые-1993-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-408ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-23_15:33_UTC-informational)
...
- **Выбрано узлов**: 133
- **Живых во всех источниках**: 1993
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 408 ms
- **Последнее обновление (UTC)**: 2026-06-23 15:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 33 · vless × 45 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 50 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `mfuu-clash` × 7 · `ninjastrikers` × 15 · `pawdroid` × 6 · `ruking-clash` × 9 · `surfboard-eternity` × 1
