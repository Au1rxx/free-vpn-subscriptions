...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2448-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-107ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-14_04:37_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2448
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 107 ms
- **Последнее обновление (UTC)**: 2026-05-14 04:37 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 2 · vless × 98 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 61 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 4
