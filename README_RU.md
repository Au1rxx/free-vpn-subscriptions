...
![узлы](https://img.shields.io/badge/узлы-78-brightgreen) ![живые](https://img.shields.io/badge/живые-2347-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-132ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-31_17:33_UTC-informational)
...
- **Медиана RTT**: 132 ms
- **Последнее обновление (UTC)**: 2026-05-31 17:33 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 17 · vless × 8 · vmess × 32

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
