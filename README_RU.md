...
![узлы](https://img.shields.io/badge/узлы-78-brightgreen) ![живые](https://img.shields.io/badge/живые-2128-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-270ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-09_15:19_UTC-informational)
...
- **Медиана RTT**: 270 ms
- **Последнее обновление (UTC)**: 2026-06-09 15:19 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 15 · vless × 8 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 6
