...
![узлы](https://img.shields.io/badge/узлы-95-brightgreen) ![живые](https://img.shields.io/badge/живые-1728-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-362ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-10_17:14_UTC-informational)
...
- **Выбрано узлов**: 95
- **Живых во всех источниках**: 1728
- **RTT самого быстрого узла**: 40 ms
- **Медиана RTT**: 362 ms
- **Последнее обновление (UTC)**: 2026-07-10 17:14 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 19 · vless × 11 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
