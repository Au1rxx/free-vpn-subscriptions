...
![узлы](https://img.shields.io/badge/узлы-98-brightgreen) ![живые](https://img.shields.io/badge/живые-1897-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-350ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-13_13:16_UTC-informational)
...
- **Выбрано узлов**: 98
- **Живых во всех источниках**: 1897
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 350 ms
- **Последнее обновление (UTC)**: 2026-06-13 13:16 UTC

**Распределение протоколов:** shadowsocks × 54 · trojan × 25 · vless × 12 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 13 · `mahdi0024` × 3 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 4
