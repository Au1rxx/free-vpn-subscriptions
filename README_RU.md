...
![узлы](https://img.shields.io/badge/узлы-86-brightgreen) ![живые](https://img.shields.io/badge/живые-1822-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-390ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_20:35_UTC-informational)
...
- **Медиана RTT**: 390 ms
- **Последнее обновление (UTC)**: 2026-06-30 20:35 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 31 · vless × 10 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 5
