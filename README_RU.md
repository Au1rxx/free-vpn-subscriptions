...
![узлы](https://img.shields.io/badge/узлы-104-brightgreen) ![живые](https://img.shields.io/badge/живые-1843-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-167ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-04_20:29_UTC-informational)
...
- **Выбрано узлов**: 104
- **Живых во всех источниках**: 1843
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 167 ms
- **Последнее обновление (UTC)**: 2026-06-04 20:29 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 51 · vless × 20 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `ruking-clash` × 3 · `surfboard-eternity` × 6
