...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2028-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-69ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-22_09:11_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2028
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 69 ms
- **Последнее обновление (UTC)**: 2026-05-22 09:11 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 36 · trojan × 10 · vless × 91 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 67 · `pawdroid` × 4 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 8
