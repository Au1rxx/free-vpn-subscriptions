...
![узлы](https://img.shields.io/badge/узлы-72-brightgreen) ![живые](https://img.shields.io/badge/живые-2147-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-161ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-30_09:28_UTC-informational)
...
- **Медиана RTT**: 161 ms
- **Последнее обновление (UTC)**: 2026-05-30 09:28 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 24 · trojan × 13 · vless × 8 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 3 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 3 · `ninjastrikers` × 6 · `pawdroid` × 2 · `surfboard-eternity` × 2
