...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-2016-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-338ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-25_11:11_UTC-informational)
...
- **Выбрано узлов**: 111
- **Живых во всех источниках**: 2016
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 338 ms
- **Последнее обновление (UTC)**: 2026-06-25 11:11 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 29 · vless × 34 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 34 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 7
