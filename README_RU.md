...
![узлы](https://img.shields.io/badge/узлы-144-brightgreen) ![живые](https://img.shields.io/badge/живые-2256-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-293ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-04_19:17_UTC-informational)
...
- **Медиана RTT**: 293 ms
- **Последнее обновление (UTC)**: 2026-05-04 19:17 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 25 · vless × 71 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 60 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
