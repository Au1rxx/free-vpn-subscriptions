...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2329-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-91ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-24_05:32_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2329
- **RTT самого быстрого узла**: 38 ms
- **Медиана RTT**: 91 ms
- **Последнее обновление (UTC)**: 2026-05-24 05:32 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 3 · vless × 87 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 34 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 56 · `pawdroid` × 4 · `surfboard-eternity` × 9
