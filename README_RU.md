...
![узлы](https://img.shields.io/badge/узлы-85-brightgreen) ![живые](https://img.shields.io/badge/живые-2232-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-170ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_09:27_UTC-informational)
...
- **Выбрано узлов**: 85
- **Живых во всех источниках**: 2232
- **RTT самого быстрого узла**: 26 ms
- **Медиана RTT**: 170 ms
- **Последнее обновление (UTC)**: 2026-06-07 09:27 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 19 · vless × 12 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `mahdi0024` × 37 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 2
