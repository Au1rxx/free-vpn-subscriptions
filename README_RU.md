...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1923-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-222ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-22_03:14_UTC-informational)
...
- **Медиана RTT**: 222 ms
- **Последнее обновление (UTC)**: 2026-06-22 03:14 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 47 · trojan × 10 · vless × 79 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `epodonios` × 41 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 18 · `snakem982` × 2 · `surfboard-eternity` × 3
