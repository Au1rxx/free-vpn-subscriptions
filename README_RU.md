...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2532-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-113ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-25_08:16_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2532
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 113 ms
- **Последнее обновление (UTC)**: 2026-04-25 08:16 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 17 · vless × 96 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 68 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
