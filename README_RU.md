...
![узлы](https://img.shields.io/badge/узлы-120-brightgreen) ![живые](https://img.shields.io/badge/живые-1778-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-357ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_19:25_UTC-informational)
...
- **Медиана RTT**: 357 ms
- **Последнее обновление (UTC)**: 2026-07-08 19:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 67 · trojan × 20 · vless × 10 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 16 · `lagzian-mix` × 4 · `mahdi0024` × 19 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 5 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 4
