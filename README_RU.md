...
![узлы](https://img.shields.io/badge/узлы-77-brightgreen) ![живые](https://img.shields.io/badge/живые-2408-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-104ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-01_09:11_UTC-informational)
...
- **Медиана RTT**: 104 ms
- **Последнее обновление (UTC)**: 2026-06-01 09:11 UTC

**Распределение протоколов:** shadowsocks × 14 · trojan × 27 · vless × 8 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 12 · `mahdi0024` × 20 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 3 · `surfboard-eternity` × 4
