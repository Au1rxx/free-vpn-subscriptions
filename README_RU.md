...
![узлы](https://img.shields.io/badge/узлы-117-brightgreen) ![живые](https://img.shields.io/badge/живые-1825-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-362ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_22:33_UTC-informational)
...
- **Медиана RTT**: 362 ms
- **Последнее обновление (UTC)**: 2026-07-07 22:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 59 · trojan × 27 · vless × 15 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 7 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
