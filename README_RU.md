...
![узлы](https://img.shields.io/badge/узлы-146-brightgreen) ![живые](https://img.shields.io/badge/живые-2217-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-181ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_13:29_UTC-informational)
...
- **Медиана RTT**: 181 ms
- **Последнее обновление (UTC)**: 2026-04-22 13:29 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 21 · vless × 79 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 62 · `ruking-clash` × 5 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
