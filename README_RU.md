...
![узлы](https://img.shields.io/badge/узлы-100-brightgreen) ![живые](https://img.shields.io/badge/живые-2042-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-186ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-27_02:27_UTC-informational)
...
- **Выбрано узлов**: 100
- **Живых во всех источниках**: 2042
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 186 ms
- **Последнее обновление (UTC)**: 2026-06-27 02:27 UTC

**Распределение протоколов:** shadowsocks × 18 · trojan × 35 · vless × 26 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 3
