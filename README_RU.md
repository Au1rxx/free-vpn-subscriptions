...
![узлы](https://img.shields.io/badge/узлы-129-brightgreen) ![живые](https://img.shields.io/badge/живые-1898-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-356ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-16_04:18_UTC-informational)
...
- **Выбрано узлов**: 129
- **Живых во всех источниках**: 1898
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 356 ms
- **Последнее обновление (UTC)**: 2026-06-16 04:18 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 51 · trojan × 30 · vless × 35 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 31 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 3
