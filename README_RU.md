...
![узлы](https://img.shields.io/badge/узлы-145-brightgreen) ![живые](https://img.shields.io/badge/живые-2520-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-104ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-24_13:37_UTC-informational)
...
- **Выбрано узлов**: 145
- **Живых во всех источниках**: 2520
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 104 ms
- **Последнее обновление (UTC)**: 2026-04-24 13:37 UTC

**Распределение протоколов:** shadowsocks × 20 · trojan × 20 · vless × 94 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `pawdroid` × 3 · `surfboard-eternity` × 3
