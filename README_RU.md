...
![узлы](https://img.shields.io/badge/узлы-138-brightgreen) ![живые](https://img.shields.io/badge/живые-1829-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-402ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-15_22:11_UTC-informational)
...
- **Выбрано узлов**: 138
- **Живых во всех источниках**: 1829
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 402 ms
- **Последнее обновление (UTC)**: 2026-07-15 22:11 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 74 · trojan × 39 · vless × 10 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `mahdi0024` × 19 · `mahdibland-aggregator` × 30 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 3 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 4
