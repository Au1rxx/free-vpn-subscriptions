...
![узлы](https://img.shields.io/badge/узлы-135-brightgreen) ![живые](https://img.shields.io/badge/живые-1750-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-371ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_08:11_UTC-informational)
...
- **Выбрано узлов**: 135
- **Живых во всех источниках**: 1750
- **RTT самого быстрого узла**: 40 ms
- **Медиана RTT**: 371 ms
- **Последнее обновление (UTC)**: 2026-07-08 08:11 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 73 · trojan × 24 · vless × 23 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 8 · `ruking-clash` × 2 · `surfboard-eternity` × 3
