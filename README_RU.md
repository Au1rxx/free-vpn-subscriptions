...
![узлы](https://img.shields.io/badge/узлы-115-brightgreen) ![живые](https://img.shields.io/badge/живые-1888-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-262ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_06:08_UTC-informational)
...
- **Медиана RTT**: 262 ms
- **Последнее обновление (UTC)**: 2026-07-12 06:08 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 50 · trojan × 16 · vless × 27 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 12 · `ninjastrikers` × 25 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
