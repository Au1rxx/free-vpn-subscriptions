...
![узлы](https://img.shields.io/badge/узлы-112-brightgreen) ![живые](https://img.shields.io/badge/живые-1922-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-361ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_23:14_UTC-informational)
...
- **Выбрано узлов**: 112
- **Живых во всех источниках**: 1922
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 361 ms
- **Последнее обновление (UTC)**: 2026-07-13 23:14 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 41 · trojan × 25 · vless × 13 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 8 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 4
