...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2241-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-181ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-22_10:32_UTC-informational)
...
- **Медиана RTT**: 181 ms
- **Последнее обновление (UTC)**: 2026-04-22 10:32 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 18 · vless × 90 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 36 · `epodonios` × 9 · `lagzian-mix` × 7 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 6
