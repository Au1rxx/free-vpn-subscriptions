...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2128-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-400ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-16_20:13_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2128
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 400 ms
- **Последнее обновление (UTC)**: 2026-07-16 20:13 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 76 · vless × 12 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 2 · `mahdi0024` × 47 · `mahdibland-aggregator` × 37 · `mahdibland-shadowsocks` × 29 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 9 · `surfboard-eternity` × 3
