...
![узлы](https://img.shields.io/badge/узлы-101-brightgreen) ![живые](https://img.shields.io/badge/живые-2410-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-115ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-01_05:13_UTC-informational)
...
- **Медиана RTT**: 115 ms
- **Последнее обновление (UTC)**: 2026-06-01 05:13 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 21 · vless × 23 · vmess × 36

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 29 · `surfboard-eternity` × 2
