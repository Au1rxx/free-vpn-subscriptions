...
![узлы](https://img.shields.io/badge/узлы-92-brightgreen) ![живые](https://img.shields.io/badge/живые-2142-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-178ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-06_15:17_UTC-informational)
...
- **Медиана RTT**: 178 ms
- **Последнее обновление (UTC)**: 2026-06-06 15:17 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 29 · trojan × 29 · vless × 10 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 15 · `mahdi0024` × 35 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 1
