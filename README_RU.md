...
![узлы](https://img.shields.io/badge/узлы-139-brightgreen) ![живые](https://img.shields.io/badge/живые-2223-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-117ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-28_14:18_UTC-informational)
...
- **Медиана RTT**: 117 ms
- **Последнее обновление (UTC)**: 2026-04-28 14:18 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 19 · vless × 79 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 17 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `mfuu-clash` × 5 · `ninjastrikers` × 55 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6
