...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2100-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-196ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-29_23:18_UTC-informational)
...
- **Медиана RTT**: 196 ms
- **Последнее обновление (UTC)**: 2026-04-29 23:18 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 21 · vless × 81 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 40 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 54 · `pawdroid` × 2 · `surfboard-eternity` × 2 · `vxiaov-clash` × 2
