...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2012-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-100ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-22_00:40_UTC-informational)
...
- **Медиана RTT**: 100 ms
- **Последнее обновление (UTC)**: 2026-05-22 00:40 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 13 · vless × 82 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 9 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 8
