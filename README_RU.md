...
![узлы](https://img.shields.io/badge/узлы-140-brightgreen) ![живые](https://img.shields.io/badge/живые-2506-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-147ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_22:30_UTC-informational)
...
- **Выбрано узлов**: 140
- **Живых во всех источниках**: 2506
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 147 ms
- **Последнее обновление (UTC)**: 2026-05-09 22:30 UTC

**Распределение протоколов:** shadowsocks × 46 · trojan × 17 · vless × 68 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 56 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 8
