...
![узлы](https://img.shields.io/badge/узлы-58-brightgreen) ![живые](https://img.shields.io/badge/живые-2497-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-111ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-01_20:34_UTC-informational)
...
- **Выбрано узлов**: 58
- **Живых во всех источниках**: 2497
- **RTT самого быстрого узла**: 26 ms
- **Медиана RTT**: 111 ms
- **Последнее обновление (UTC)**: 2026-06-01 20:34 UTC

**Распределение протоколов:** shadowsocks × 15 · trojan × 20 · vless × 4 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 2 · `surfboard-eternity` × 1
