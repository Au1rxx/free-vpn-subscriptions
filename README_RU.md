...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1911-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-341ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_21:30_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1911
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 341 ms
- **Последнее обновление (UTC)**: 2026-05-11 21:30 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 65 · trojan × 9 · vless × 62 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 8 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 58 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
