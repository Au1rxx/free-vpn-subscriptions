...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2162-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-86ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-03_06:16_UTC-informational)
...
- **Медиана RTT**: 86 ms
- **Последнее обновление (UTC)**: 2026-05-03 06:16 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 5 · vless × 101 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
