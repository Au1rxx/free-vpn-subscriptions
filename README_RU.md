...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1966-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-180ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-07_13:21_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1966
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 180 ms
- **Последнее обновление (UTC)**: 2026-05-07 13:21 UTC

**Распределение протоколов:** shadowsocks × 53 · trojan × 6 · vless × 81 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 64 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
