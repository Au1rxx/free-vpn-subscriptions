...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2302-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-117ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-05_08:15_UTC-informational)
...
- **Медиана RTT**: 117 ms
- **Последнее обновление (UTC)**: 2026-05-05 08:15 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 17 · vless × 86 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 68 · `ruking-clash` × 2 · `surfboard-eternity` × 8
