...
![узлы](https://img.shields.io/badge/узлы-80-brightgreen) ![живые](https://img.shields.io/badge/живые-2323-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-225ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-19_20:20_UTC-informational)
...
- **Выбрано узлов**: 80
- **Живых во всех источниках**: 2323
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 225 ms
- **Последнее обновление (UTC)**: 2026-06-19 20:20 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 25 · vless × 7 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 14 · `surfboard-eternity` × 3
