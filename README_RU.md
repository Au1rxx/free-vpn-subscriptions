...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2481-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-80ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-21_13:38_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2481
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 80 ms
- **Последнее обновление (UTC)**: 2026-05-21 13:38 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 10 · vless × 85 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 17 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 60 · `pawdroid` × 9 · `ruking-clash` × 5 · `surfboard-eternity` × 9
