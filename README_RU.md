...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2447-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-78ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-15_07:14_UTC-informational)
...
- **Медиана RTT**: 78 ms
- **Последнее обновление (UTC)**: 2026-05-15 07:14 UTC

**Распределение протоколов:** shadowsocks × 44 · trojan × 4 · vless × 93 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 3 · `ninjastrikers` × 62 · `pawdroid` × 5 · `ruking-clash` × 5 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
