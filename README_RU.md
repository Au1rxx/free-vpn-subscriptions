...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2287-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-362ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-19_03:27_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2287
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 362 ms
- **Последнее обновление (UTC)**: 2026-07-19 03:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 39 · trojan × 86 · vless × 17 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `mahdi0024` × 47 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 33 · `matin-v2ray` × 7 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 10 · `surfboard-eternity` × 7
