...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-1804-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-282ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_23:15_UTC-informational)
...
- **Выбрано узлов**: 111
- **Живых во всех источниках**: 1804
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 282 ms
- **Последнее обновление (UTC)**: 2026-07-08 23:15 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 48 · trojan × 24 · vless × 13 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 7 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 5
