...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2196-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-360ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-19_05:32_UTC-informational)
...
- **Медиана RTT**: 360 ms
- **Последнее обновление (UTC)**: 2026-07-19 05:32 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 44 · trojan × 78 · vless × 16 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 67 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 8 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 5
