...
![узлы](https://img.shields.io/badge/узлы-90-brightgreen) ![живые](https://img.shields.io/badge/живые-1947-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-280ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-26_20:34_UTC-informational)
...
- **Медиана RTT**: 280 ms
- **Последнее обновление (UTC)**: 2026-06-26 20:34 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 29 · vless × 14 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `mahdi0024` × 16 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `ruking-clash` × 17 · `surfboard-eternity` × 5
