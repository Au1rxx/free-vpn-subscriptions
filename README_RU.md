...
![узлы](https://img.shields.io/badge/узлы-130-brightgreen) ![живые](https://img.shields.io/badge/живые-2479-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-474ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-19_02:26_UTC-informational)
...
- **Выбрано узлов**: 130
- **Живых во всех источниках**: 2479
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 474 ms
- **Последнее обновление (UTC)**: 2026-06-19 02:26 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 35 · trojan × 28 · vless × 56 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 26 · `pawdroid` × 4 · `ruking-clash` × 39 · `snakem982` × 6 · `surfboard-eternity` × 2
