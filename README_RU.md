...
![узлы](https://img.shields.io/badge/узлы-69-brightgreen) ![живые](https://img.shields.io/badge/живые-2052-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-234ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_16:38_UTC-informational)
...
- **Выбрано узлов**: 69
- **Живых во всех источниках**: 2052
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 234 ms
- **Последнее обновление (UTC)**: 2026-05-28 16:38 UTC

**Распределение протоколов:** hysteria2 × 3 · shadowsocks × 30 · trojan × 14 · vless × 12 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 5 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 3
