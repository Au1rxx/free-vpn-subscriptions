...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2073-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-166ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-02_22:26_UTC-informational)
...
- **Медиана RTT**: 166 ms
- **Последнее обновление (UTC)**: 2026-05-02 22:26 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 18 · vless × 86 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 25 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 51 · `pawdroid` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
