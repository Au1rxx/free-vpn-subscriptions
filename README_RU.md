...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2506-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-92ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_08:14_UTC-informational)
...
- **Медиана RTT**: 92 ms
- **Последнее обновление (UTC)**: 2026-04-27 08:14 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 4 · vless × 99 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 48 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 2 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
