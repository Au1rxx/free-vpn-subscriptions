...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2064-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-88ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-04_07:38_UTC-informational)
...
- **Медиана RTT**: 88 ms
- **Последнее обновление (UTC)**: 2026-05-04 07:38 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 12 · vless × 102 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 8 · `ninjastrikers` × 69 · `snakem982` × 1 · `surfboard-eternity` × 8
