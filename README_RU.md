...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1902-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-325ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_19:33_UTC-informational)
...
- **Медиана RTT**: 325 ms
- **Последнее обновление (UTC)**: 2026-05-11 19:33 UTC

**Распределение протоколов:** shadowsocks × 60 · trojan × 13 · vless × 66 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 6 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 56 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 13
