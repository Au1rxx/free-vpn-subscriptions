...
![узлы](https://img.shields.io/badge/узлы-115-brightgreen) ![живые](https://img.shields.io/badge/живые-1967-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-349ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_15:23_UTC-informational)
...
- **Медиана RTT**: 349 ms
- **Последнее обновление (UTC)**: 2026-07-04 15:23 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 51 · trojan × 22 · vless × 15 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 36 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 6 · `ninjastrikers` × 13 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 1
