...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-1957-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-206ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_06:15_UTC-informational)
...
- **Выбрано узлов**: 114
- **Живых во всех источниках**: 1957
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 206 ms
- **Последнее обновление (UTC)**: 2026-07-13 06:15 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 52 · trojan × 18 · vless × 29 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 4 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 4
