...
![узлы](https://img.shields.io/badge/узлы-115-brightgreen) ![живые](https://img.shields.io/badge/живые-2059-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-229ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_19:10_UTC-informational)
...
- **Выбрано узлов**: 115
- **Живых во всех источниках**: 2059
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 229 ms
- **Последнее обновление (UTC)**: 2026-07-12 19:10 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 67 · trojan × 9 · vless × 24 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 37 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 8 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3
