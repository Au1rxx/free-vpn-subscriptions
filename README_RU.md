...
![узлы](https://img.shields.io/badge/узлы-86-brightgreen) ![живые](https://img.shields.io/badge/живые-2242-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-155ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-29_03:29_UTC-informational)
...
- **Медиана RTT**: 155 ms
- **Последнее обновление (UTC)**: 2026-06-29 03:29 UTC

**Распределение протоколов:** shadowsocks × 17 · trojan × 28 · vless × 27 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 19 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 8 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 1
