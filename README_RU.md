...
![узлы](https://img.shields.io/badge/узлы-116-brightgreen) ![живые](https://img.shields.io/badge/живые-2546-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-488ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-19_09:20_UTC-informational)
...
- **Выбрано узлов**: 116
- **Живых во всех источниках**: 2546
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 488 ms
- **Последнее обновление (UTC)**: 2026-06-19 09:20 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 32 · trojan × 25 · vless × 41 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 15 · `mahdi0024` × 6 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 36 · `snakem982` × 4 · `surfboard-eternity` × 4
