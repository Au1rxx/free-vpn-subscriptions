...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2536-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-91ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-16_01:15_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2536
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 91 ms
- **Последнее обновление (UTC)**: 2026-05-16 01:15 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 9 · vless × 100 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 66 · `pawdroid` × 8 · `ruking-clash` × 4 · `surfboard-eternity` × 6
