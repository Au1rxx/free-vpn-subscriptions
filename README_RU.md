...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2276-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-151ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-21_01:36_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2276
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 151 ms
- **Последнее обновление (UTC)**: 2026-04-21 01:36 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 3 · vless × 114 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 54 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 7
