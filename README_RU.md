...
![узлы](https://img.shields.io/badge/узлы-113-brightgreen) ![живые](https://img.shields.io/badge/живые-1997-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-338ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-04_22:33_UTC-informational)
...
- **Медиана RTT**: 338 ms
- **Последнее обновление (UTC)**: 2026-07-04 22:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 55 · trojan × 22 · vless × 9 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 36 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
