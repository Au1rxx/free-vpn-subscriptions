...
![узлы](https://img.shields.io/badge/узлы-125-brightgreen) ![живые](https://img.shields.io/badge/живые-2058-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-278ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_16:09_UTC-informational)
...
- **Выбрано узлов**: 125
- **Живых во всех источниках**: 2058
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 278 ms
- **Последнее обновление (UTC)**: 2026-07-12 16:09 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 66 · trojan × 19 · vless × 26 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 4
