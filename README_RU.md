...
![узлы](https://img.shields.io/badge/узлы-119-brightgreen) ![живые](https://img.shields.io/badge/живые-2519-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-429ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-23_20:36_UTC-informational)
...
- **Выбрано узлов**: 119
- **Живых во всех источниках**: 2519
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 429 ms
- **Последнее обновление (UTC)**: 2026-04-23 20:36 UTC

**Распределение протоколов:** shadowsocks × 14 · trojan × 25 · vless × 65 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `surfboard-eternity` × 6
