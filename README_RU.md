...
![узлы](https://img.shields.io/badge/узлы-133-brightgreen) ![живые](https://img.shields.io/badge/живые-2331-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-67ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-19_11:26_UTC-informational)
...
- **Медиана RTT**: 67 ms
- **Последнее обновление (UTC)**: 2026-05-19 11:26 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 14 · trojan × 23 · vless × 80 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 56 · `pawdroid` × 9 · `surfboard-eternity` × 2
