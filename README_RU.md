...
![узлы](https://img.shields.io/badge/узлы-107-brightgreen) ![живые](https://img.shields.io/badge/живые-1955-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-383ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_19:19_UTC-informational)
...
- **Выбрано узлов**: 107
- **Живых во всех источниках**: 1955
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 383 ms
- **Последнее обновление (UTC)**: 2026-06-10 19:19 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 18 · vless × 11 · vmess × 35

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 34 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 6 · `surfboard-eternity` × 1
