...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2078-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-183ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-29_19:20_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2078
- **RTT самого быстрого узла**: 39 ms
- **Медиана RTT**: 183 ms
- **Последнее обновление (UTC)**: 2026-04-29 19:20 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 15 · vless × 82 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 57 · `pawdroid` × 1 · `surfboard-eternity` × 6
