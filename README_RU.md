...
![узлы](https://img.shields.io/badge/узлы-101-brightgreen) ![живые](https://img.shields.io/badge/живые-1924-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-403ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-25_16:25_UTC-informational)
...
- **Медиана RTT**: 403 ms
- **Последнее обновление (UTC)**: 2026-06-25 16:25 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 37 · vless × 19 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 18 · `surfboard-eternity` × 2
