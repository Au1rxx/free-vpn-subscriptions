...
![узлы](https://img.shields.io/badge/узлы-140-brightgreen) ![живые](https://img.shields.io/badge/живые-2464-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-148ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-24_12:27_UTC-informational)
...
- **Выбрано узлов**: 140
- **Живых во всех источниках**: 2464
- **RTT самого быстрого узла**: 23 ms
- **Медиана RTT**: 148 ms
- **Последнее обновление (UTC)**: 2026-04-24 12:27 UTC

**Распределение протоколов:** shadowsocks × 14 · trojan × 23 · vless × 90 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
