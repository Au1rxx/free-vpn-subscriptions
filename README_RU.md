...
![узлы](https://img.shields.io/badge/узлы-136-brightgreen) ![живые](https://img.shields.io/badge/живые-1999-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-448ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-23_23:09_UTC-informational)
...
- **Медиана RTT**: 448 ms
- **Последнее обновление (UTC)**: 2026-06-23 23:09 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 39 · trojan × 30 · vless × 51 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 49 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
