...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1991-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-290ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_14:30_UTC-informational)
...
- **Медиана RTT**: 290 ms
- **Последнее обновление (UTC)**: 2026-05-06 14:30 UTC

**Распределение протоколов:** shadowsocks × 51 · trojan × 16 · vless × 72 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 3 · `ninjastrikers` × 61 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
