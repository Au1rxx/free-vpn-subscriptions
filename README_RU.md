...
![узлы](https://img.shields.io/badge/узлы-108-brightgreen) ![живые](https://img.shields.io/badge/живые-1860-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-308ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_04:38_UTC-informational)
...
- **Медиана RTT**: 308 ms
- **Последнее обновление (UTC)**: 2026-07-07 04:38 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 43 · trojan × 22 · vless × 21 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 9 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
