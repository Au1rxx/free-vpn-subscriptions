...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2224-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-374ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-17_01:33_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2224
- **RTT самого быстрого узла**: 20 ms
- **Медиана RTT**: 374 ms
- **Последнее обновление (UTC)**: 2026-07-17 01:33 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 75 · vless × 16 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `mahdi0024` × 42 · `mahdibland-aggregator` × 33 · `mahdibland-shadowsocks` × 32 · `matin-v2ray` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 2
