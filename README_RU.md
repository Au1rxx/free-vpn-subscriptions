...
![узлы](https://img.shields.io/badge/узлы-78-brightgreen) ![живые](https://img.shields.io/badge/живые-1978-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-174ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-03_22:36_UTC-informational)
...
- **Медиана RTT**: 174 ms
- **Последнее обновление (UTC)**: 2026-07-03 22:36 UTC

**Распределение протоколов:** shadowsocks × 24 · trojan × 23 · vless × 7 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 6 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
