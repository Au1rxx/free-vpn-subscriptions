...
![узлы](https://img.shields.io/badge/узлы-104-brightgreen) ![живые](https://img.shields.io/badge/живые-1884-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-356ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-13_10:09_UTC-informational)
...
- **Выбрано узлов**: 104
- **Живых во всех источниках**: 1884
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 356 ms
- **Последнее обновление (UTC)**: 2026-06-13 10:09 UTC

**Распределение протоколов:** shadowsocks × 58 · trojan × 23 · vless × 15 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 7 · `ruking-clash` × 12 · `surfboard-eternity` × 5
