...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2542-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-85ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_06:09_UTC-informational)
...
- **Медиана RTT**: 85 ms
- **Последнее обновление (UTC)**: 2026-04-27 06:09 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 6 · vless × 97 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 48 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 51 · `surfboard-eternity` × 4
