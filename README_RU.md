...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1623-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-375ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-15_02:14_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1623
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 375 ms
- **Последнее обновление (UTC)**: 2026-07-15 02:14 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 102 · trojan × 17 · vless × 19 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 35 · `mahdi0024` × 10 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 4
