...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2454-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-112ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_04:24_UTC-informational)
...
- **Медиана RTT**: 112 ms
- **Последнее обновление (UTC)**: 2026-05-11 04:24 UTC

**Распределение протоколов:** shadowsocks × 44 · trojan × 3 · vless × 95 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 71 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
