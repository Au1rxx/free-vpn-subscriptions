...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2044-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-168ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-02_21:26_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2044
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 168 ms
- **Последнее обновление (UTC)**: 2026-05-02 21:26 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 17 · vless × 87 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
