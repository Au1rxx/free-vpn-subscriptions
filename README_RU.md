...
![узлы](https://img.shields.io/badge/узлы-74-brightgreen) ![живые](https://img.shields.io/badge/живые-2263-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-166ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-30_14:36_UTC-informational)
...
- **Выбрано узлов**: 74
- **Живых во всех источниках**: 2263
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 166 ms
- **Последнее обновление (UTC)**: 2026-05-30 14:36 UTC

**Распределение протоколов:** shadowsocks × 24 · trojan × 16 · vless × 7 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 6 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 3
