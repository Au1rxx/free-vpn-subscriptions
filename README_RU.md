...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1935-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-142ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-07_08:11_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1935
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 142 ms
- **Последнее обновление (UTC)**: 2026-05-07 08:11 UTC

**Распределение протоколов:** shadowsocks × 50 · trojan × 5 · vless × 86 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 70 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
