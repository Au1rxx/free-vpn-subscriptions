...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1870-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-379ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-16_00:27_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1870
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 379 ms
- **Последнее обновление (UTC)**: 2026-07-16 00:27 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 70 · trojan × 39 · vless × 26 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 18 · `mahdi0024` × 24 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 10 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 4
