...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2216-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-402ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-17_14:22_UTC-informational)
...
|---|---|---|---|---|
| 🇯🇵 Japan (`JP`) | 109 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2216
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 402 ms
- **Последнее обновление (UTC)**: 2026-07-17 14:22 UTC

**Распределение протоколов:** shadowsocks × 25 · trojan × 109 · vless × 3 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 2 · `mahdi0024` × 71 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 30 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 5 · `surfboard-eternity` × 2
