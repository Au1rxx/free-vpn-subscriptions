...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2364-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-92ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-23_15:25_UTC-informational)
...
- **Медиана RTT**: 92 ms
- **Последнее обновление (UTC)**: 2026-05-23 15:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 35 · trojan × 22 · vless × 71 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `surfboard-eternity` × 7
