...
![узлы](https://img.shields.io/badge/узлы-126-brightgreen) ![живые](https://img.shields.io/badge/живые-1995-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-348ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_06:24_UTC-informational)
...
- **Выбрано узлов**: 126
- **Живых во всех источниках**: 1995
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 348 ms
- **Последнее обновление (UTC)**: 2026-07-05 06:24 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 59 · trojan × 25 · vless × 12 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 41 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 4 · `ninjastrikers` × 18 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
