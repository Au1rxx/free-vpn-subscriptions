...
![узлы](https://img.shields.io/badge/узлы-149-brightgreen) ![живые](https://img.shields.io/badge/живые-2356-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-88ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-20_19:15_UTC-informational)
...
- **Выбрано узлов**: 149
- **Живых во всех источниках**: 2356
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 88 ms
- **Последнее обновление (UTC)**: 2026-05-20 19:15 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 27 · vless × 65 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 7
