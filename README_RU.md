...
![узлы](https://img.shields.io/badge/узлы-145-brightgreen) ![живые](https://img.shields.io/badge/живые-2083-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-372ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-23_05:24_UTC-informational)
...
- **Выбрано узлов**: 145
- **Живых во всех источниках**: 2083
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 372 ms
- **Последнее обновление (UTC)**: 2026-06-23 05:24 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 39 · trojan × 29 · vless × 63 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 50 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 21 · `pawdroid` × 4 · `ruking-clash` × 19 · `surfboard-eternity` × 5
