...
![узлы](https://img.shields.io/badge/узлы-87-brightgreen) ![живые](https://img.shields.io/badge/живые-2246-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-354ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-01_17:16_UTC-informational)
...
- **Выбрано узлов**: 87
- **Живых во всех источниках**: 2246
- **RTT самого быстрого узла**: 53 ms
- **Медиана RTT**: 354 ms
- **Последнее обновление (UTC)**: 2026-07-01 17:16 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 27 · vless × 13 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 18 · `pawdroid` × 5 · `surfboard-eternity` × 2
