...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-394-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-138ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-19_06:41_UTC-informational)
...
- **RTT самого быстрого узла**: 9 ms
- **Медиана RTT**: 138 ms
- **Последнее обновление (UTC)**: 2026-04-19 06:41 UTC

**Распределение протоколов:** shadowsocks × 103 · trojan × 7 · vmess × 40

**Источники в этом запуске:** `freefq` × 2 · `mahdibland-aggregator` × 62 · `mahdibland-shadowsocks` × 71 · `vxiaov-clash` × 15
