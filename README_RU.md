...
![узлы](https://img.shields.io/badge/узлы-99-brightgreen) ![живые](https://img.shields.io/badge/живые-1900-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-376ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-17_14:18_UTC-informational)
...
- **Выбрано узлов**: 99
- **Живых во всех источниках**: 1900
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 376 ms
- **Последнее обновление (UTC)**: 2026-06-17 14:18 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 23 · vless × 21 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 11 · `mahdi0024` × 14 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 20 · `surfboard-eternity` × 4
