...
![узлы](https://img.shields.io/badge/узлы-123-brightgreen) ![живые](https://img.shields.io/badge/живые-2010-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-314ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-12_21:29_UTC-informational)
...
- **Выбрано узлов**: 123
- **Живых во всех источниках**: 2010
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 314 ms
- **Последнее обновление (UTC)**: 2026-07-12 21:29 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 69 · trojan × 25 · vless × 15 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 30 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 6 · `mfuu-clash` × 4 · `ninjastrikers` × 15 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 5
