...
![узлы](https://img.shields.io/badge/узлы-104-brightgreen) ![живые](https://img.shields.io/badge/живые-1871-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-354ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_06:11_UTC-informational)
...
- **Выбрано узлов**: 104
- **Живых во всех источниках**: 1871
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 354 ms
- **Последнее обновление (UTC)**: 2026-06-30 06:11 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 41 · trojan × 37 · vless × 17 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 4
