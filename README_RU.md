...
![узлы](https://img.shields.io/badge/узлы-96-brightgreen) ![живые](https://img.shields.io/badge/живые-1853-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-356ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-09_13:30_UTC-informational)
...
- **Медиана RTT**: 356 ms
- **Последнее обновление (UTC)**: 2026-06-09 13:30 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 51 · trojan × 17 · vless × 15 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 14 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 5 · `surfboard-eternity` × 2
