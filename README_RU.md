...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2320-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-398ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-18_06:18_UTC-informational)
...
- **Медиана RTT**: 398 ms
- **Последнее обновление (UTC)**: 2026-07-18 06:18 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 97 · vless × 14 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 66 · `mahdibland-aggregator` × 34 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 6 · `snakem982` × 2 · `surfboard-eternity` × 1
