...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-1879-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-357ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_21:32_UTC-informational)
...
- **Медиана RTT**: 357 ms
- **Последнее обновление (UTC)**: 2026-07-05 21:32 UTC

**Распределение протоколов:** shadowsocks × 47 · trojan × 24 · vless × 13 · vmess × 30

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 2
