...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2289-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-214ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-08_15:19_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2289
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 214 ms
- **Последнее обновление (UTC)**: 2026-05-08 15:19 UTC

**Распределение протоколов:** shadowsocks × 50 · trojan × 18 · vless × 73 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 67 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
