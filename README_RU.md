...
![узлы](https://img.shields.io/badge/узлы-115-brightgreen) ![живые](https://img.shields.io/badge/живые-1813-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-370ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_21:38_UTC-informational)
...
- **Выбрано узлов**: 115
- **Живых во всех источниках**: 1813
- **RTT самого быстрого узла**: 51 ms
- **Медиана RTT**: 370 ms
- **Последнее обновление (UTC)**: 2026-07-07 21:38 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 55 · trojan × 27 · vless × 17 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 10 · `ninjastrikers` × 16 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 2
