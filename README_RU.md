...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2579-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-106ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-26_16:17_UTC-informational)
...
- **Медиана RTT**: 106 ms
- **Последнее обновление (UTC)**: 2026-04-26 16:17 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 5 · vless × 93 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 51 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 51 · `pawdroid` × 3 · `surfboard-eternity` × 7
