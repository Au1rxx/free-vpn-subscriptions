...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-1780-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-347ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-11_07:31_UTC-informational)
...
- **Выбрано узлов**: 111
- **Живых во всех источниках**: 1780
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 347 ms
- **Последнее обновление (UTC)**: 2026-07-11 07:31 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 51 · trojan × 23 · vless × 20 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 6 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 3
