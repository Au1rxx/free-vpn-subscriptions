...
![узлы](https://img.shields.io/badge/узлы-133-brightgreen) ![живые](https://img.shields.io/badge/живые-1989-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-228ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-13_02:09_UTC-informational)
...
- **Выбрано узлов**: 133
- **Живых во всех источниках**: 1989
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 228 ms
- **Последнее обновление (UTC)**: 2026-07-13 02:09 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 67 · trojan × 21 · vless × 28 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 5 · `mahdi0024` × 24 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 7 · `ninjastrikers` × 25 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 5
