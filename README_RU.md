...
![узлы](https://img.shields.io/badge/узлы-60-brightgreen) ![живые](https://img.shields.io/badge/живые-2090-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-169ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_19:20_UTC-informational)
...
- **Медиана RTT**: 169 ms
- **Последнее обновление (UTC)**: 2026-05-28 19:20 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 13 · vless × 8 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 3 · `epodonios` × 15 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 9
