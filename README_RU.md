...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2491-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-397ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-18_14:08_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2491
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 397 ms
- **Последнее обновление (UTC)**: 2026-07-18 14:08 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 97 · vless × 17 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 3 · `mahdi0024` × 30 · `mahdibland-aggregator` × 48 · `mahdibland-shadowsocks` × 36 · `matin-v2ray` × 3 · `ninjastrikers` × 4 · `pawdroid` × 14 · `ruking-clash` × 1 · `snakem982` × 6 · `surfboard-eternity` × 2
