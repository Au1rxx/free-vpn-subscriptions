...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2119-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-396ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-16_21:14_UTC-informational)
...
|---|---|---|---|---|
| 🇯🇵 Japan (`JP`) | 73 | [clash-JP.yaml](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/clash-JP.yaml) | [singbox-JP.json](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/singbox-JP.json) | [v2ray-base64-JP.txt](https://github.com/Au1rxx/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-JP.txt) |
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2119
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 396 ms
- **Последнее обновление (UTC)**: 2026-07-16 21:14 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 71 · vless × 11 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `epodonios` × 4 · `mahdi0024` × 54 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 40 · `matin-v2ray` × 8 · `ninjastrikers` × 3 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 8 · `surfboard-eternity` × 4
