...
![узлы](https://img.shields.io/badge/узлы-133-brightgreen) ![живые](https://img.shields.io/badge/живые-1635-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-480ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-14_20:27_UTC-informational)
...
- **Выбрано узлов**: 133
- **Живых во всех источниках**: 1635
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 480 ms
- **Последнее обновление (UTC)**: 2026-06-14 20:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 61 · trojan × 32 · vless × 26 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 17 · `surfboard-eternity` × 4
