...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2347-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-76ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-23_08:20_UTC-informational)
...
- **Медиана RTT**: 76 ms
- **Последнее обновление (UTC)**: 2026-05-23 08:20 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 5 · vless × 105 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 70 · `pawdroid` × 8 · `ruking-clash` × 3 · `surfboard-eternity` × 4
