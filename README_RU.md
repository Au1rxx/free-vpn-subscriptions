...
![узлы](https://img.shields.io/badge/узлы-122-brightgreen) ![живые](https://img.shields.io/badge/живые-2285-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-337ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-12_03:26_UTC-informational)
...
- **Выбрано узлов**: 122
- **Живых во всех источниках**: 2285
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 337 ms
- **Последнее обновление (UTC)**: 2026-06-12 03:26 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 41 · trojan × 44 · vless × 30 · vmess × 5

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 31 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 7
