...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2564-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-88ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-04-27_01:13_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2564
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 88 ms
- **Последнее обновление (UTC)**: 2026-04-27 01:13 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 5 · vless × 95 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 46 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 59 · `pawdroid` × 1 · `surfboard-eternity` × 3
