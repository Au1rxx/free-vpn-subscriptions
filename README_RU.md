...
![узлы](https://img.shields.io/badge/узлы-93-brightgreen) ![живые](https://img.shields.io/badge/живые-2266-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-277ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-20_08:26_UTC-informational)
...
- **Медиана RTT**: 277 ms
- **Последнее обновление (UTC)**: 2026-06-20 08:26 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 28 · vless × 14 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 18 · `surfboard-eternity` × 4
