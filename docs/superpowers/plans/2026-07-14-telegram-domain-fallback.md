...
**Tech Stack:** Go 1.24、`net/http`、`net.DNSError`、表驱动单元测试、现有 systemd 生产安装流程。
...
- [ ] **Step 2: 通过 transient systemd credential 运行真实发现**
