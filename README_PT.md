...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2198-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-371ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-19_06:19_UTC-informational)
...
- **RTT mediano**: 371 ms
- **Última atualização (UTC)**: 2026-07-19 06:19 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 79 · vless × 18 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 72 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 6 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 5
