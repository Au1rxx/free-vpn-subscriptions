...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2238-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-92ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_05:26_UTC-informational)
...
- **Ativos em todas as fontes**: 2238
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 92 ms
- **Última atualização (UTC)**: 2026-05-01 05:26 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 7 · vless × 93 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
