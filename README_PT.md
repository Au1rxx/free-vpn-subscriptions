...
![nós](https://img.shields.io/badge/nós-147-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2592-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-124ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_20:30_UTC-informational)
...
- **Ativos em todas as fontes**: 2592
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 124 ms
- **Última atualização (UTC)**: 2026-04-24 20:30 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 22 · vless × 84 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
