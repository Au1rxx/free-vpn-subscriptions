...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2606-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-167ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_04:24_UTC-informational)
...
- **Ativos em todas as fontes**: 2606
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 167 ms
- **Última atualização (UTC)**: 2026-04-23 04:24 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 18 · vless × 96 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 75 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 2
