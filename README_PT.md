...
![nós](https://img.shields.io/badge/nós-77-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2408-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-104ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_09:11_UTC-informational)
...
- **RTT mediano**: 104 ms
- **Última atualização (UTC)**: 2026-06-01 09:11 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 27 · vless × 8 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 12 · `mahdi0024` × 20 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 3 · `surfboard-eternity` × 4
