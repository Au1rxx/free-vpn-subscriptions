...
![nós](https://img.shields.io/badge/nós-127-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1982-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-218ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_04:18_UTC-informational)
...
- **RTT mediano**: 218 ms
- **Última atualização (UTC)**: 2026-07-13 04:18 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 62 · trojan × 18 · vless × 31 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `mahdi0024` × 31 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `ninjastrikers` × 23 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 1
