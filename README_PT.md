...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2605-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-86ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-28_08:31_UTC-informational)
...
- **Ativos em todas as fontes**: 2605
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 86 ms
- **Última atualização (UTC)**: 2026-04-28 08:31 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 11 · vless × 104 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 66 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 5
