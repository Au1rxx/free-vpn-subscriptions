...
![nós](https://img.shields.io/badge/nós-133-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2331-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-67ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-19_11:26_UTC-informational)
...
- **RTT mediano**: 67 ms
- **Última atualização (UTC)**: 2026-05-19 11:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 14 · trojan × 23 · vless × 80 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 56 · `pawdroid` × 9 · `surfboard-eternity` × 2
