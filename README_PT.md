...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1834-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-344ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_01:25_UTC-informational)
...
- **RTT mediano**: 344 ms
- **Última atualização (UTC)**: 2026-07-08 01:25 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 57 · trojan × 29 · vless × 23 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 7 · `ninjastrikers` × 25 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 7
