...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2337-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-80ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-24_03:14_UTC-informational)
...
- **RTT mediano**: 80 ms
- **Última atualização (UTC)**: 2026-05-24 03:14 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 3 · vless × 87 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 63 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 6
