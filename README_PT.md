...
![nós](https://img.shields.io/badge/nós-119-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2394-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-488ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_23:23_UTC-informational)
...
- **Ativos em todas as fontes**: 2394
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 488 ms
- **Última atualização (UTC)**: 2026-06-18 23:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 39 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 38 · `snakem982` × 6 · `surfboard-eternity` × 2
