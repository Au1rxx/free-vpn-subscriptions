...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1870-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-379ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_00:27_UTC-informational)
...
- **Ativos em todas as fontes**: 1870
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 379 ms
- **Última atualização (UTC)**: 2026-07-16 00:27 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 70 · trojan × 39 · vless × 26 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 18 · `mahdi0024` × 24 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 10 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 4
