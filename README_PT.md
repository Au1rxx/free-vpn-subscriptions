...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2275-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-182ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_09:12_UTC-informational)
...
- **Nós selecionados**: 93
- **Ativos em todas as fontes**: 2275
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 182 ms
- **Última atualização (UTC)**: 2026-06-20 09:12 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 28 · vless × 13 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 5
