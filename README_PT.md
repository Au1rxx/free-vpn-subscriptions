...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1995-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-348ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_06:24_UTC-informational)
...
- **RTT mediano**: 348 ms
- **Última atualização (UTC)**: 2026-07-05 06:24 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 59 · trojan × 25 · vless × 12 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 41 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 4 · `ninjastrikers` × 18 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
