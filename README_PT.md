...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2540-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-96ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_11:37_UTC-informational)
...
- **RTT mediano**: 96 ms
- **Última atualização (UTC)**: 2026-04-25 11:37 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 14 · vless × 98 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 3
