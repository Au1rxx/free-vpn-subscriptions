...
![nós](https://img.shields.io/badge/nós-137-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2459-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-204ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_14:14_UTC-informational)
...
- **RTT mediano**: 204 ms
- **Última atualização (UTC)**: 2026-04-23 14:14 UTC

**Mix de protocolos:** shadowsocks × 17 · trojan × 20 · vless × 86 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 59 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 5
