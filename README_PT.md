...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2091-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-104ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_06:36_UTC-informational)
...
- **RTT mediano**: 104 ms
- **Última atualização (UTC)**: 2026-04-29 06:36 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 11 · vless × 96 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 6 · `ninjastrikers` × 67 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 4
