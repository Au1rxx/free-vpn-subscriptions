...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2378-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-350ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_13:35_UTC-informational)
...
- **Ativos em todas as fontes**: 2378
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 350 ms
- **Última atualização (UTC)**: 2026-05-11 13:35 UTC

**Mix de protocolos:** shadowsocks × 45 · trojan × 17 · vless × 79 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
