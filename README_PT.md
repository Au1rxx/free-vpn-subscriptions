...
![nós](https://img.shields.io/badge/nós-146-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2217-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-181ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_13:29_UTC-informational)
...
- **RTT mediano**: 181 ms
- **Última atualização (UTC)**: 2026-04-22 13:29 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 21 · vless × 79 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 62 · `ruking-clash` × 5 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
