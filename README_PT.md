...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2314-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-402ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_20:19_UTC-informational)
...
- **RTT mediano**: 402 ms
- **Última atualização (UTC)**: 2026-07-17 20:19 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 107 · vless × 8 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 60 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 29 · `matin-v2ray` × 1 · `ninjastrikers` × 2 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 16 · `surfboard-eternity` × 5
