...
![nós](https://img.shields.io/badge/nós-143-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2216-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-366ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-05_20:27_UTC-informational)
...
- **RTT mediano**: 366 ms
- **Última atualização (UTC)**: 2026-05-05 20:27 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 28 · vless × 68 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 38 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 3 · `surfboard-eternity` × 10
