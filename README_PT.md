...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2097-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-279ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_08:23_UTC-informational)
...
- **RTT mediano**: 279 ms
- **Última atualização (UTC)**: 2026-06-25 08:23 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 34 · vless × 36 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 33 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 4
