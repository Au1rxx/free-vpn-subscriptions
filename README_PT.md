...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2005-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-441ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_12:39_UTC-informational)
...
- **RTT mediano**: 441 ms
- **Última atualização (UTC)**: 2026-06-28 12:39 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 34 · vless × 25 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 31 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 13 · `surfboard-eternity` × 5
