...
![nós](https://img.shields.io/badge/nós-69-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2338-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-141ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_20:17_UTC-informational)
...
- **Nós selecionados**: 69
- **Ativos em todas as fontes**: 2338
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 141 ms
- **Última atualização (UTC)**: 2026-07-02 20:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 25 · trojan × 16 · vless × 11 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 5 · `ninjastrikers` × 10 · `pawdroid` × 4 · `surfboard-eternity` × 4
