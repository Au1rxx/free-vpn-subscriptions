...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2094-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-175ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_15:28_UTC-informational)
...
- **RTT mediano**: 175 ms
- **Última atualização (UTC)**: 2026-05-03 15:28 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 22 · vless × 87 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 25 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
