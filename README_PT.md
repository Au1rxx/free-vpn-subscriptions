...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1859-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-275ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_18:27_UTC-informational)
...
- **Ativos em todas as fontes**: 1859
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 275 ms
- **Última atualização (UTC)**: 2026-07-11 18:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 14 · vless × 31 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 10 · `ninjastrikers` × 16 · `pawdroid` × 11 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 2
