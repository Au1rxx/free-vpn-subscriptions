...
![nós](https://img.shields.io/badge/nós-122-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2540-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-168ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_03:26_UTC-informational)
...
- **Ativos em todas as fontes**: 2540
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 168 ms
- **Última atualização (UTC)**: 2026-06-02 03:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 33 · trojan × 35 · vless × 25 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 27 · `pawdroid` × 5 · `snakem982` × 2 · `surfboard-eternity` × 3
