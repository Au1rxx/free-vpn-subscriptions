...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2225-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-404ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_06:11_UTC-informational)
...
- **Ativos em todas as fontes**: 2225
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 404 ms
- **Última atualização (UTC)**: 2026-07-17 06:11 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 78 · vless × 15 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 4 · `mahdi0024` × 41 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 43 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 5
