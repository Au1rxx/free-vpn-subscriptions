...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2006-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-354ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_23:25_UTC-informational)
...
- **Ativos em todas as fontes**: 2006
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 354 ms
- **Última atualização (UTC)**: 2026-07-04 23:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 52 · trojan × 23 · vless × 9 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
