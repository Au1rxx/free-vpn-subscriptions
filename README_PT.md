...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2256-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-140ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_12:14_UTC-informational)
...
- **Ativos em todas as fontes**: 2256
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 140 ms
- **Última atualização (UTC)**: 2026-05-03 12:14 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 21 · vless × 93 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 5 · `ninjastrikers` × 60 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
