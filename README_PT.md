...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1825-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-374ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_23:18_UTC-informational)
...
- **RTT mediano**: 374 ms
- **Última atualização (UTC)**: 2026-07-07 23:18 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 66 · trojan × 26 · vless × 10 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 9 · `ninjastrikers` × 17 · `ruking-clash` × 1 · `surfboard-eternity` × 3
