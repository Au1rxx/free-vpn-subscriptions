...
![nós](https://img.shields.io/badge/nós-90-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1854-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-351ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_08:09_UTC-informational)
...
- **RTT mediano**: 351 ms
- **Última atualização (UTC)**: 2026-06-09 08:09 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 46 · trojan × 17 · vless × 15 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 2
