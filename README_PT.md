...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2360-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-480ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_19:17_UTC-informational)
...
- **Ativos em todas as fontes**: 2360
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 480 ms
- **Última atualização (UTC)**: 2026-06-18 19:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 34 · vless × 31 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 29 · `snakem982` × 7 · `surfboard-eternity` × 4
