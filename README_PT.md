...
![nós](https://img.shields.io/badge/nós-149-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1886-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-379ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_03:10_UTC-informational)
...
- **Ativos em todas as fontes**: 1886
- **RTT do nó mais rápido**: 40 ms
- **RTT mediano**: 379 ms
- **Última atualização (UTC)**: 2026-07-16 03:10 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 69 · trojan × 40 · vless × 27 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `mahdi0024` × 20 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 6 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 13 · `surfboard-eternity` × 4
