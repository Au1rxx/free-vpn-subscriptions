...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2131-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-401ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_09:24_UTC-informational)
...
- **RTT mediano**: 401 ms
- **Última atualização (UTC)**: 2026-07-17 09:24 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 84 · vless × 11 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 3 · `mahdi0024` × 57 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 4 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 11 · `surfboard-eternity` × 1
