...
![nós](https://img.shields.io/badge/nós-122-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2472-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-474ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_05:15_UTC-informational)
...
- **RTT mediano**: 474 ms
- **Última atualização (UTC)**: 2026-06-19 05:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 27 · vless × 49 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 35 · `snakem982` × 7 · `surfboard-eternity` × 4
