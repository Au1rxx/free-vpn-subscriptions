...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2191-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-123ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_08:12_UTC-informational)
...
- **RTT mediano**: 123 ms
- **Última atualização (UTC)**: 2026-04-21 08:12 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 3 · vless × 103 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 50 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 55 · `pawdroid` × 2 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
