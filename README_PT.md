...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2169-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-114ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-02_17:34_UTC-informational)
...
- **Ativos em todas as fontes**: 2169
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 114 ms
- **Última atualização (UTC)**: 2026-05-02 17:34 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 16 · vless × 89 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `ninjastrikers` × 56 · `pawdroid` × 2 · `surfboard-eternity` × 7
