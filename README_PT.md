...
![nós](https://img.shields.io/badge/nós-138-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1619-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-389ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_20:36_UTC-informational)
...
- **Ativos em todas as fontes**: 1619
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 389 ms
- **Última atualização (UTC)**: 2026-07-14 20:36 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 96 · trojan × 27 · vless × 7 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 26 · `mahdi0024` × 14 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
