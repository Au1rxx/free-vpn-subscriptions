...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1853-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-344ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_06:20_UTC-informational)
...
- **RTT mediano**: 344 ms
- **Última atualização (UTC)**: 2026-06-16 06:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 25 · vless × 29 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 27 · `pawdroid` × 3 · `ruking-clash` × 9 · `surfboard-eternity` × 3
