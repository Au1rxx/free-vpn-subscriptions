...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2128-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-86ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_05:30_UTC-informational)
...
- **RTT mediano**: 86 ms
- **Última atualização (UTC)**: 2026-05-03 05:30 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 10 · vless × 98 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 70 · `pawdroid` × 3 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
