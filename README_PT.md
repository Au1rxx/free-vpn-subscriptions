...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2301-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-176ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_03:27_UTC-informational)
...
- **RTT mediano**: 176 ms
- **Última atualização (UTC)**: 2026-06-20 03:27 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 27 · vless × 19 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 22 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 2
