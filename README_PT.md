...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1624-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-379ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_23:24_UTC-informational)
...
- **RTT mediano**: 379 ms
- **Última atualização (UTC)**: 2026-07-14 23:24 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 99 · trojan × 30 · vless × 10 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 29 · `mahdi0024` × 14 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
