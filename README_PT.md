...
![nós](https://img.shields.io/badge/nós-141-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2572-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-111ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-14_16:30_UTC-informational)
...
- **Ativos em todas as fontes**: 2572
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 111 ms
- **Última atualização (UTC)**: 2026-05-14 16:30 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 21 · vless × 75 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 54 · `pawdroid` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
