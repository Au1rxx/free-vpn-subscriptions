...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2265-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-448ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-20_23:39_UTC-informational)
...
- **RTT mediano**: 448 ms
- **Última atualização (UTC)**: 2026-04-20 23:39 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 18 · vless × 96 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 55 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 49 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 6
