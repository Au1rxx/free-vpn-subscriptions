...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2474-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-97ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-15_00:25_UTC-informational)
...
- **RTT mediano**: 97 ms
- **Última atualização (UTC)**: 2026-05-15 00:25 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 8 · vless × 92 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 3 · `epodonios` × 2 · `lagzian-mix` × 7 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 60 · `pawdroid` × 7 · `ruking-clash` × 5 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
