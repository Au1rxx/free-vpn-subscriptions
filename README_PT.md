...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1800-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-362ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_13:12_UTC-informational)
...
- **Ativos em todas as fontes**: 1800
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 362 ms
- **Última atualização (UTC)**: 2026-07-09 13:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 62 · trojan × 17 · vless × 11 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 4 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 3
