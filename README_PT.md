...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1945-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-285ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_12:36_UTC-informational)
...
- **RTT mediano**: 285 ms
- **Última atualização (UTC)**: 2026-07-12 12:36 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 17 · vless × 12 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 1
