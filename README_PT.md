...
![nós](https://img.shields.io/badge/nós-60-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2090-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-169ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_19:20_UTC-informational)
...
- **RTT mediano**: 169 ms
- **Última atualização (UTC)**: 2026-05-28 19:20 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 13 · vless × 8 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 3 · `epodonios` × 15 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 9
