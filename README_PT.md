...
![nós](https://img.shields.io/badge/nós-91-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2408-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-81ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-03_03:34_UTC-informational)
...
- **RTT mediano**: 81 ms
- **Última atualização (UTC)**: 2026-06-03 03:34 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 34 · vless × 21 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 24 · `pawdroid` × 2 · `surfboard-eternity` × 3
