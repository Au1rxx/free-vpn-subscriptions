...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1947-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-152ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_05:09_UTC-informational)
...
- **RTT mediano**: 152 ms
- **Última atualização (UTC)**: 2026-06-04 05:09 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 47 · vless × 29 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 34 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 23 · `pawdroid` × 1 · `surfboard-eternity` × 2
