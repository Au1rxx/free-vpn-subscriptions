...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1905-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-346ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_21:25_UTC-informational)
...
- **Nós selecionados**: 98
- **Ativos em todas as fontes**: 1905
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 346 ms
- **Última atualização (UTC)**: 2026-07-06 21:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 46 · trojan × 25 · vless × 8 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
