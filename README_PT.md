...
![nós](https://img.shields.io/badge/nós-85-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2106-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-155ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_03:10_UTC-informational)
...
- **RTT mediano**: 155 ms
- **Última atualização (UTC)**: 2026-07-10 03:10 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 10 · vless × 18 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 5 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
