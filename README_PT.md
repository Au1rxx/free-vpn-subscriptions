...
![nós](https://img.shields.io/badge/nós-81-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2444-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-78ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-03_12:24_UTC-informational)
...
- **RTT mediano**: 78 ms
- **Última atualização (UTC)**: 2026-06-03 12:24 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 38 · vless × 6 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 9 · `pawdroid` × 2 · `surfboard-eternity` × 4
