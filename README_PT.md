...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2109-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-127ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_01:30_UTC-informational)
...
- **RTT mediano**: 127 ms
- **Última atualização (UTC)**: 2026-07-10 01:30 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 10 · vless × 24 · vmess × 33

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 37 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 8 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
