...
![nós](https://img.shields.io/badge/nós-140-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2464-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-148ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_12:27_UTC-informational)
...
- **RTT mediano**: 148 ms
- **Última atualização (UTC)**: 2026-04-24 12:27 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 23 · vless × 90 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
