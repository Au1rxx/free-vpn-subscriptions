...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2047-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-337ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_04:37_UTC-informational)
...
- **RTT mediano**: 337 ms
- **Última atualização (UTC)**: 2026-07-02 04:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 38 · vless × 23 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 25 · `pawdroid` × 7 · `surfboard-eternity` × 5
