...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2411-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-399ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_21:13_UTC-informational)
...
- **RTT mediano**: 399 ms
- **Última atualização (UTC)**: 2026-07-18 21:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 32 · trojan × 100 · vless × 11 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 28 · `mahdibland-aggregator` × 37 · `mahdibland-shadowsocks` × 40 · `matin-v2ray` × 5 · `ninjastrikers` × 5 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 16 · `surfboard-eternity` × 3
