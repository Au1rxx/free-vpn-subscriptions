...
![nós](https://img.shields.io/badge/nós-78-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2255-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-278ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_13:11_UTC-informational)
...
- **Nós selecionados**: 78
- **Ativos em todas as fontes**: 2255
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 278 ms
- **Última atualização (UTC)**: 2026-07-02 13:11 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 21 · vless × 10 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 7 · `ninjastrikers` × 13 · `pawdroid` × 3 · `surfboard-eternity` × 7
