...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2579-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-106ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_16:17_UTC-informational)
...
- **RTT mediano**: 106 ms
- **Última atualização (UTC)**: 2026-04-26 16:17 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 5 · vless × 93 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 51 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 51 · `pawdroid` × 3 · `surfboard-eternity` × 7
