...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1880-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-357ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_21:23_UTC-informational)
...
- **RTT mediano**: 357 ms
- **Última atualização (UTC)**: 2026-07-13 21:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 21 · vless × 13 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 6 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
