...
![nós](https://img.shields.io/badge/nós-91-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2093-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-173ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_07:13_UTC-informational)
...
- **RTT mediano**: 173 ms
- **Última atualização (UTC)**: 2026-06-27 07:13 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 29 · vless × 24 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 16 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 11
