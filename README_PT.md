...
![nós](https://img.shields.io/badge/nós-129-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1922-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-330ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_02:17_UTC-informational)
...
- **RTT mediano**: 330 ms
- **Última atualização (UTC)**: 2026-07-06 02:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 27 · vless × 21 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 11 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
