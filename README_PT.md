...
![nós](https://img.shields.io/badge/nós-116-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1904-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-291ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_01:22_UTC-informational)
...
- **RTT mediano**: 291 ms
- **Última atualização (UTC)**: 2026-07-07 01:22 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 46 · trojan × 27 · vless × 20 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 10 · `mahdi0024` × 28 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 9 · `ninjastrikers` × 22 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 2
