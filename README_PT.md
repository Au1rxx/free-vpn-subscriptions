...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1853-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-356ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_13:30_UTC-informational)
...
- **RTT mediano**: 356 ms
- **Última atualização (UTC)**: 2026-06-09 13:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 17 · vless × 15 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 14 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 5 · `surfboard-eternity` × 2
