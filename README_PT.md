...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2188-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-111ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_11:21_UTC-informational)
...
- **RTT mediano**: 111 ms
- **Última atualização (UTC)**: 2026-05-01 11:21 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 7 · vless × 92 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 61 · `surfboard-eternity` × 6
