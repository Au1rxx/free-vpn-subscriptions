...
![nós](https://img.shields.io/badge/nós-136-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2469-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-217ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_22:26_UTC-informational)
...
- **RTT mediano**: 217 ms
- **Última atualização (UTC)**: 2026-04-23 22:26 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 23 · vless × 74 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 7
