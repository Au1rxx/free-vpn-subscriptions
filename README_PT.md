...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2020-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-369ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_21:17_UTC-informational)
...
- **RTT mediano**: 369 ms
- **Última atualização (UTC)**: 2026-06-29 21:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 33 · vless × 7 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 3
