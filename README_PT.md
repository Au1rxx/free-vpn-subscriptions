...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2246-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-435ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-20_21:12_UTC-informational)
...
- **RTT mediano**: 435 ms
- **Última atualização (UTC)**: 2026-04-20 21:12 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 5 · vless × 103 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 60 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 44 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 4
