...
![nós](https://img.shields.io/badge/nós-73-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2087-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-277ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_17:22_UTC-informational)
...
- **Nós selecionados**: 73
- **Ativos em todas as fontes**: 2087
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 277 ms
- **Última atualização (UTC)**: 2026-05-28 17:22 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 22 · vless × 12 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 3 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
