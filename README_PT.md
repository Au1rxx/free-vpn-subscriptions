...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1693-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-517ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_13:19_UTC-informational)
...
- **RTT mediano**: 517 ms
- **Última atualização (UTC)**: 2026-06-14 13:19 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 52 · trojan × 30 · vless × 14 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `mahdi0024` × 7 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 15 · `surfboard-eternity` × 5
