...
![nós](https://img.shields.io/badge/nós-143-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2305-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-94ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-24_21:25_UTC-informational)
...
- **RTT mediano**: 94 ms
- **Última atualização (UTC)**: 2026-05-24 21:25 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 21 · vless × 52 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 48 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 45 · `pawdroid` × 5 · `ruking-clash` × 4 · `surfboard-eternity` × 3
