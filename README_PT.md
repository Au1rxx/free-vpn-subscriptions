...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2302-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-68ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-19_08:39_UTC-informational)
...
- **RTT mediano**: 68 ms
- **Última atualização (UTC)**: 2026-05-19 08:39 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 18 · trojan × 24 · vless × 91 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 19 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 66 · `pawdroid` × 7 · `ruking-clash` × 1 · `surfboard-eternity` × 2
