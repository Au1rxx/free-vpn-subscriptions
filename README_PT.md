...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1911-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-278ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_16:34_UTC-informational)
...
- **RTT mediano**: 278 ms
- **Última atualização (UTC)**: 2026-07-11 16:34 UTC

**Mix de protocolos:** shadowsocks × 53 · trojan × 13 · vless × 14 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 25 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 1
