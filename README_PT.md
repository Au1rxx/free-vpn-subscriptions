...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1937-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-122ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-08_00:12_UTC-informational)
...
- **RTT mediano**: 122 ms
- **Última atualização (UTC)**: 2026-05-08 00:12 UTC

**Mix de protocolos:** shadowsocks × 50 · trojan × 4 · vless × 86 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 70 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
