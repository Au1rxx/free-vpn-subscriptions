...
![nós](https://img.shields.io/badge/nós-124-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2012-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-343ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_07:25_UTC-informational)
...
- **RTT mediano**: 343 ms
- **Última atualização (UTC)**: 2026-07-05 07:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 57 · trojan × 27 · vless × 11 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 4 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 2
