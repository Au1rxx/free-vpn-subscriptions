...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2344-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-401ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_11:13_UTC-informational)
...
- **RTT mediano**: 401 ms
- **Última atualização (UTC)**: 2026-07-18 11:13 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 105 · vless × 11 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 3 · `mahdi0024` × 62 · `mahdibland-aggregator` × 35 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 4 · `ninjastrikers` × 5 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
