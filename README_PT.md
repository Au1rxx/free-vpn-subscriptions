...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2281-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-174ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_19:17_UTC-informational)
...
- **RTT mediano**: 174 ms
- **Última atualização (UTC)**: 2026-04-25 19:17 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 18 · vless × 83 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
