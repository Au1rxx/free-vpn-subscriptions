...
![nós](https://img.shields.io/badge/nós-147-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1882-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-368ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_02:25_UTC-informational)
...
- **RTT mediano**: 368 ms
- **Última atualização (UTC)**: 2026-07-16 02:25 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 63 · trojan × 45 · vless × 24 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `mahdi0024` × 19 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 11 · `ninjastrikers` × 26 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 11 · `surfboard-eternity` × 2
