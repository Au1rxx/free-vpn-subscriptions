...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2500-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-15_19:28_UTC-informational)
...
- **Ativos em todas as fontes**: 2500
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-05-15 19:28 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 14 · vless × 92 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 48 · `pawdroid` × 10 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 4
