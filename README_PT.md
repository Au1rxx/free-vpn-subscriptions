...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1799-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-337ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_08:35_UTC-informational)
...
- **RTT mediano**: 337 ms
- **Última atualização (UTC)**: 2026-07-11 08:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 20 · vless × 23 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 6 · `ninjastrikers` × 22 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 1
