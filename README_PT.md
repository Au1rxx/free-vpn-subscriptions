...
![nós](https://img.shields.io/badge/nós-88-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2320-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-340ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-11_23:09_UTC-informational)
...
- **RTT mediano**: 340 ms
- **Última atualização (UTC)**: 2026-06-11 23:09 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 18 · vless × 15 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 6 · `surfboard-eternity` × 6
