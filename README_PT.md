...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1618-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-392ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_17:33_UTC-informational)
...
- **Ativos em todas as fontes**: 1618
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 392 ms
- **Última atualização (UTC)**: 2026-07-14 17:33 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 95 · trojan × 29 · vless × 15 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 23 · `mahdi0024` × 13 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 7 · `ninjastrikers` × 15 · `pawdroid` × 9 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
