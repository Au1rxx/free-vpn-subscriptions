...
![nós](https://img.shields.io/badge/nós-89-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2057-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-151ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_00:22_UTC-informational)
...
- **RTT mediano**: 151 ms
- **Última atualização (UTC)**: 2026-07-10 00:22 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 26 · trojan × 10 · vless × 19 · vmess × 33

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 34 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
