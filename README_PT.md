...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2020-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-396ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_11:33_UTC-informational)
...
- **RTT mediano**: 396 ms
- **Última atualização (UTC)**: 2026-07-16 11:33 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 51 · trojan × 69 · vless × 19 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `mahdi0024` × 17 · `mahdibland-aggregator` × 35 · `mahdibland-shadowsocks` × 44 · `matin-v2ray` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 7 · `pawdroid` × 8 · `ruking-clash` × 2 · `snakem982` × 9 · `surfboard-eternity` × 3
