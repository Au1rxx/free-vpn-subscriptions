...
![nós](https://img.shields.io/badge/nós-119-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1875-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-284ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_07:35_UTC-informational)
...
- **RTT mediano**: 284 ms
- **Última atualização (UTC)**: 2026-07-12 07:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 23 · vless × 25 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 9 · `ninjastrikers` × 20 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 7
