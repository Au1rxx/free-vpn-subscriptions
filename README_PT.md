...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2314-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-309ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_15:24_UTC-informational)
...
- **RTT mediano**: 309 ms
- **Última atualização (UTC)**: 2026-04-21 15:24 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 16 · vless × 87 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 46 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 56 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 9
