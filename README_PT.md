...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2027-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-418ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_13:34_UTC-informational)
...
- **RTT mediano**: 418 ms
- **Última atualização (UTC)**: 2026-06-28 13:34 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 31 · vless × 27 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 20 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 1
