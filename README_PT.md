...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1624-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-403ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_16:33_UTC-informational)
...
- **Ativos em todas as fontes**: 1624
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 403 ms
- **Última atualização (UTC)**: 2026-06-14 16:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 62 · trojan × 23 · vless × 24 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 4
