...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2247-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-347ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_12:25_UTC-informational)
...
- **Nós selecionados**: 92
- **Ativos em todas as fontes**: 2247
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 347 ms
- **Última atualização (UTC)**: 2026-07-02 12:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 14 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 8 · `ninjastrikers` × 16 · `pawdroid` × 5 · `surfboard-eternity` × 3
