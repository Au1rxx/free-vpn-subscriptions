...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2307-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-117ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-20_01:23_UTC-informational)
...
- **Ativos em todas as fontes**: 2307
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 117 ms
- **Última atualização (UTC)**: 2026-05-20 01:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 4 · vless × 85 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 7
