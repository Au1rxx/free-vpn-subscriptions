...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2586-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-106ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_15:21_UTC-informational)
...
- **Ativos em todas as fontes**: 2586
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 106 ms
- **Última atualização (UTC)**: 2026-04-26 15:21 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 4 · vless × 93 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 52 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 51 · `pawdroid` × 1 · `surfboard-eternity` × 6
