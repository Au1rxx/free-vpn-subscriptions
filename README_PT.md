...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2585-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-77ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-16_07:21_UTC-informational)
...
- **Ativos em todas as fontes**: 2585
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 77 ms
- **Última atualização (UTC)**: 2026-05-16 07:21 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 10 · vless × 98 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 61 · `pawdroid` × 7 · `ruking-clash` × 3 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
