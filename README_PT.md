...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2191-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-172ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-02_15:20_UTC-informational)
...
- **RTT mediano**: 172 ms
- **Última atualização (UTC)**: 2026-05-02 15:20 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 19 · vless × 81 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `pawdroid` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
