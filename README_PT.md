...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1935-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-257ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_02:30_UTC-informational)
...
- **RTT mediano**: 257 ms
- **Última atualização (UTC)**: 2026-06-22 02:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 15 · vless × 78 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 39 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 16 · `snakem982` × 5 · `surfboard-eternity` × 2
