...
![nós](https://img.shields.io/badge/nós-148-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2274-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-245ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-05_13:29_UTC-informational)
...
- **RTT mediano**: 245 ms
- **Última atualização (UTC)**: 2026-05-05 13:29 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 29 · vless × 70 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
