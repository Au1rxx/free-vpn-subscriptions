...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1904-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-371ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_05:29_UTC-informational)
...
- **Ativos em todas as fontes**: 1904
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 371 ms
- **Última atualização (UTC)**: 2026-06-22 05:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 27 · vless × 61 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 29 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 26 · `pawdroid` × 2 · `ruking-clash` × 31 · `snakem982` × 1 · `surfboard-eternity` × 3
