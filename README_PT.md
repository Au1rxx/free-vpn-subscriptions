...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1889-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-359ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_11:27_UTC-informational)
...
- **RTT mediano**: 359 ms
- **Última atualização (UTC)**: 2026-07-06 11:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 11 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 6 · `ninjastrikers` × 12 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 5
