...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2234-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-105ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_00:28_UTC-informational)
...
- **RTT mediano**: 105 ms
- **Última atualização (UTC)**: 2026-05-01 00:28 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 5 · vless × 97 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 68 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
