...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1623-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-375ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_02:14_UTC-informational)
...
- **Ativos em todas as fontes**: 1623
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 375 ms
- **Última atualização (UTC)**: 2026-07-15 02:14 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 102 · trojan × 17 · vless × 19 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 35 · `mahdi0024` × 10 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 4
