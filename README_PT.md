...
![nós](https://img.shields.io/badge/nós-60-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2066-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-166ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_21:30_UTC-informational)
...
- **RTT mediano**: 166 ms
- **Última atualização (UTC)**: 2026-05-28 21:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 24 · trojan × 19 · vless × 7 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 8 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
