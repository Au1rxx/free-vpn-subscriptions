...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1908-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-284ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_08:18_UTC-informational)
...
- **RTT mediano**: 284 ms
- **Última atualização (UTC)**: 2026-07-06 08:18 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 28 · vless × 12 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 29 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 4 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 4
