...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2075-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-95ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_05:39_UTC-informational)
...
- **RTT mediano**: 95 ms
- **Última atualização (UTC)**: 2026-05-04 05:39 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 7 · vless × 104 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 69 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
