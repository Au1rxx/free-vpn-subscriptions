...
![nós](https://img.shields.io/badge/nós-133-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2567-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-250ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_19:34_UTC-informational)
...
- **Ativos em todas as fontes**: 2567
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 250 ms
- **Última atualização (UTC)**: 2026-04-22 19:34 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 22 · vless × 70 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 54 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
