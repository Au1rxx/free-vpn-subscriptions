...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2128-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-400ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_20:13_UTC-informational)
...
- **RTT mediano**: 400 ms
- **Última atualização (UTC)**: 2026-07-16 20:13 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 76 · vless × 12 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 2 · `mahdi0024` × 47 · `mahdibland-aggregator` × 37 · `mahdibland-shadowsocks` × 29 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 9 · `surfboard-eternity` × 3
