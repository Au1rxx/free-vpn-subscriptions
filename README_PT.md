...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1889-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-305ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_02:20_UTC-informational)
...
- **Ativos em todas as fontes**: 1889
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 305 ms
- **Última atualização (UTC)**: 2026-07-12 02:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 60 · trojan × 26 · vless × 22 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 6 · `ninjastrikers` × 24 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
