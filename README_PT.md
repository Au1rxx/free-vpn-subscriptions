...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2655-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-105ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_01:14_UTC-informational)
...
- **Ativos em todas as fontes**: 2655
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 105 ms
- **Última atualização (UTC)**: 2026-04-25 01:14 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 9 · vless × 106 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 34 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 5
