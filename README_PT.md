...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2022-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-405ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_22:14_UTC-informational)
...
- **Ativos em todas as fontes**: 2022
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 405 ms
- **Última atualização (UTC)**: 2026-06-23 22:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 30 · vless × 43 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 44 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 18 · `surfboard-eternity` × 3
