...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2469-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-154ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_18:37_UTC-informational)
...
- **RTT mediano**: 154 ms
- **Última atualização (UTC)**: 2026-04-27 18:37 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 21 · vless × 90 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 27 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
