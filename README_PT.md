...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2086-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-154ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_22:39_UTC-informational)
...
- **RTT mediano**: 154 ms
- **Última atualização (UTC)**: 2026-05-01 22:39 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 19 · vless × 80 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 3 · `surfboard-eternity` × 11
