...
![nós](https://img.shields.io/badge/nós-120-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1979-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-277ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_03:27_UTC-informational)
...
- **RTT mediano**: 277 ms
- **Última atualização (UTC)**: 2026-06-25 03:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 26 · trojan × 33 · vless × 47 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 38 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 4
