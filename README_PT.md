...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2232-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-142ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_02:27_UTC-informational)
...
- **Nós selecionados**: 99
- **Ativos em todas as fontes**: 2232
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 142 ms
- **Última atualização (UTC)**: 2026-06-07 02:27 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 21 · vless × 25 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 30 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 5
