...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2335-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-375ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_15:36_UTC-informational)
...
- **RTT mediano**: 375 ms
- **Última atualização (UTC)**: 2026-07-01 15:36 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 36 · vless × 10 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 10 · `ninjastrikers` × 14 · `pawdroid` × 6 · `surfboard-eternity` × 4
