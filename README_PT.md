...
![nós](https://img.shields.io/badge/nós-124-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2059-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-406ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_07:27_UTC-informational)
...
- **Ativos em todas as fontes**: 2059
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 406 ms
- **Última atualização (UTC)**: 2026-06-23 07:27 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 31 · vless × 47 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 45 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 3
