...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2211-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-357ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_11:21_UTC-informational)
...
- **RTT mediano**: 357 ms
- **Última atualização (UTC)**: 2026-07-02 11:21 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 24 · vless × 18 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 8 · `ninjastrikers` × 17 · `pawdroid` × 4 · `surfboard-eternity` × 6
