...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2238-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-417ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_09:11_UTC-informational)
...
- **RTT mediano**: 417 ms
- **Última atualização (UTC)**: 2026-06-29 09:11 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 27 · vless × 19 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 2
