...
![nós](https://img.shields.io/badge/nós-127-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1810-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-360ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_10:29_UTC-informational)
...
- **Ativos em todas as fontes**: 1810
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 360 ms
- **Última atualização (UTC)**: 2026-07-07 10:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 66 · trojan × 20 · vless × 21 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 10 · `ninjastrikers` × 17 · `pawdroid` × 7 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
