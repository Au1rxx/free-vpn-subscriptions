...
![nós](https://img.shields.io/badge/nós-140-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2290-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-317ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_22:29_UTC-informational)
...
- **RTT mediano**: 317 ms
- **Última atualização (UTC)**: 2026-05-04 22:29 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 25 · vless × 69 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
