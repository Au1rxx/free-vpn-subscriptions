...
![nós](https://img.shields.io/badge/nós-120-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2003-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-263ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_20:12_UTC-informational)
...
- **Ativos em todas as fontes**: 2003
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 263 ms
- **Última atualização (UTC)**: 2026-07-12 20:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 64 · trojan × 18 · vless × 21 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 8 · `mahdi0024` × 30 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 2
