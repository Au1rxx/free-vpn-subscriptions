...
![nós](https://img.shields.io/badge/nós-133-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2374-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-503ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_15:30_UTC-informational)
...
- **RTT mediano**: 503 ms
- **Última atualização (UTC)**: 2026-06-18 15:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 36 · vless × 48 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 25 · `snakem982` × 9 · `surfboard-eternity` × 3
