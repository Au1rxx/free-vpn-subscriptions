...
![nós](https://img.shields.io/badge/nós-142-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2250-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-425ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_21:24_UTC-informational)
...
- **RTT mediano**: 425 ms
- **Última atualização (UTC)**: 2026-05-04 21:24 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 26 · vless × 69 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 56 · `ruking-clash` × 3 · `surfboard-eternity` × 6
