...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2073-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-166ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-02_22:26_UTC-informational)
...
- **RTT mediano**: 166 ms
- **Última atualização (UTC)**: 2026-05-02 22:26 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 18 · vless × 86 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 25 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 51 · `pawdroid` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
