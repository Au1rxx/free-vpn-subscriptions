...
![nós](https://img.shields.io/badge/nós-143-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2322-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-116ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_23:28_UTC-informational)
...
- **Ativos em todas as fontes**: 2322
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 116 ms
- **Última atualização (UTC)**: 2026-05-22 23:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 24 · vless × 70 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 53 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
