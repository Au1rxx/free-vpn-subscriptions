...
![nós](https://img.shields.io/badge/nós-123-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1784-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-348ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_06:13_UTC-informational)
...
- **Ativos em todas as fontes**: 1784
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 348 ms
- **Última atualização (UTC)**: 2026-07-09 06:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 28 · vless × 17 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 4 · `ninjastrikers` × 22 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 3
