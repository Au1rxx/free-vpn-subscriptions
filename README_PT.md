...
![nós](https://img.shields.io/badge/nós-143-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2098-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-379ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_07:34_UTC-informational)
...
- **Ativos em todas as fontes**: 2098
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 379 ms
- **Última atualização (UTC)**: 2026-06-21 07:34 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 31 · vless × 45 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 33 · `snakem982` × 2 · `surfboard-eternity` × 2
