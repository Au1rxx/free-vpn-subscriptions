...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2296-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-399ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_18:17_UTC-informational)
...
- **Ativos em todas as fontes**: 2296
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 399 ms
- **Última atualização (UTC)**: 2026-07-17 18:17 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 101 · vless × 14 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 58 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 8 · `ruking-clash` × 2 · `snakem982` × 13 · `surfboard-eternity` × 3
