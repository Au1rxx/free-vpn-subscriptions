...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2249-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-89ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_09:39_UTC-informational)
...
- **RTT mediano**: 89 ms
- **Última atualização (UTC)**: 2026-05-03 09:39 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 13 · vless × 100 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
