...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2475-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-103ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_07:19_UTC-informational)
...
- **Ativos em todas as fontes**: 2475
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 103 ms
- **Última atualização (UTC)**: 2026-05-10 07:19 UTC

**Mix de protocolos:** shadowsocks × 44 · trojan × 4 · vless × 94 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 74 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
