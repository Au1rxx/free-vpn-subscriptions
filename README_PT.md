...
![nós](https://img.shields.io/badge/nós-71-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2281-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-153ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_20:15_UTC-informational)
...
- **RTT mediano**: 153 ms
- **Última atualização (UTC)**: 2026-05-30 20:15 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 11 · vless × 9 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `mahdi0024` × 24 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 7 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 4
