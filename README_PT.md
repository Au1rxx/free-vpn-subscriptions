...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2444-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-76ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-18_13:29_UTC-informational)
...
- **RTT mediano**: 76 ms
- **Última atualização (UTC)**: 2026-05-18 13:29 UTC

**Mix de protocolos:** shadowsocks × 44 · trojan × 7 · vless × 92 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 6
