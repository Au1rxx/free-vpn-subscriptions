...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1919-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-176ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_20:09_UTC-informational)
...
- **RTT mediano**: 176 ms
- **Última atualização (UTC)**: 2026-07-03 20:09 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 22 · vless × 11 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 6 · `ninjastrikers` × 9 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
