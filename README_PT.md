...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2277-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-155ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_18:30_UTC-informational)
...
- **RTT mediano**: 155 ms
- **Última atualização (UTC)**: 2026-04-25 18:30 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 17 · vless × 85 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 52 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
