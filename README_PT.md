...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2257-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-85ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_16:27_UTC-informational)
...
- **Ativos em todas as fontes**: 2257
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 85 ms
- **Última atualização (UTC)**: 2026-05-21 16:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 30 · trojan × 28 · vless × 81 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 43 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 9 · `surfboard-eternity` × 3
