...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2213-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-155ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_04:29_UTC-informational)
...
- **RTT mediano**: 155 ms
- **Última atualização (UTC)**: 2026-05-06 04:29 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 21 · vless × 84 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 75 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
