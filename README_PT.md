...
![nós](https://img.shields.io/badge/nós-127-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2118-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-400ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_23:31_UTC-informational)
...
- **Ativos em todas as fontes**: 2118
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 400 ms
- **Última atualização (UTC)**: 2026-06-20 23:31 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 35 · vless × 29 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 6 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 31 · `surfboard-eternity` × 2
