...
![nós](https://img.shields.io/badge/nós-71-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1884-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-288ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-05_12:30_UTC-informational)
...
- **RTT mediano**: 288 ms
- **Última atualização (UTC)**: 2026-06-05 12:30 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 23 · vless × 10 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
