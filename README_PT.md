...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1954-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-352ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_21:35_UTC-informational)
...
- **RTT mediano**: 352 ms
- **Última atualização (UTC)**: 2026-05-06 21:35 UTC

**Mix de protocolos:** shadowsocks × 48 · trojan × 19 · vless × 70 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 57 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 7
