...
![nós](https://img.shields.io/badge/nós-141-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2075-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-379ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_10:19_UTC-informational)
...
- **RTT mediano**: 379 ms
- **Última atualização (UTC)**: 2026-06-21 10:19 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 32 · vless × 44 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 34 · `snakem982` × 1 · `surfboard-eternity` × 3
