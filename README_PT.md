...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2284-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-66ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-19_09:31_UTC-informational)
...
- **RTT mediano**: 66 ms
- **Última atualização (UTC)**: 2026-05-19 09:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 17 · trojan × 27 · vless × 88 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 61 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 4
