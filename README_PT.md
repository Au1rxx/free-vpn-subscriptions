...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1967-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-352ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_04:38_UTC-informational)
...
- **RTT mediano**: 352 ms
- **Última atualização (UTC)**: 2026-07-05 04:38 UTC

**Mix de protocolos:** shadowsocks × 57 · trojan × 28 · vless × 13 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 42 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
