...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2147-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-173ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_17:16_UTC-informational)
...
- **RTT mediano**: 173 ms
- **Última atualização (UTC)**: 2026-06-28 17:16 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 27 · vless × 20 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 3
