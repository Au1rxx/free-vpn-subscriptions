...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2212-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-106ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_04:38_UTC-informational)
...
- **Ativos em todas as fontes**: 2212
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 106 ms
- **Última atualização (UTC)**: 2026-04-30 04:38 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 5 · vless × 103 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 71 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 7
