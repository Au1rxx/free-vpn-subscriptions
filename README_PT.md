...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2385-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-93ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_03:27_UTC-informational)
...
- **RTT mediano**: 93 ms
- **Última atualização (UTC)**: 2026-05-21 03:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 13 · vless × 81 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
