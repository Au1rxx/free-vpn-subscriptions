...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1857-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-354ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_18:14_UTC-informational)
...
- **RTT mediano**: 354 ms
- **Última atualização (UTC)**: 2026-06-07 18:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 22 · vless × 15 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 24 · `mfuu-clash` × 4 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 1
