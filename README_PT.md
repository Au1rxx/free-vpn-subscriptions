...
![nós](https://img.shields.io/badge/nós-90-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2116-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-160ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_16:37_UTC-informational)
...
- **RTT mediano**: 160 ms
- **Última atualização (UTC)**: 2026-07-09 16:37 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 9 · vless × 22 · vmess × 32

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 5 · `ninjastrikers` × 11 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 3
