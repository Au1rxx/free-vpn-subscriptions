...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2147-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-173ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_12:11_UTC-informational)
...
- **RTT mediano**: 173 ms
- **Última atualização (UTC)**: 2026-06-07 12:11 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 23 · vless × 9 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 1 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 5
