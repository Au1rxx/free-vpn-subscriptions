...
![nós](https://img.shields.io/badge/nós-71-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2327-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-122ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_15:27_UTC-informational)
...
- **RTT mediano**: 122 ms
- **Última atualização (UTC)**: 2026-05-31 15:27 UTC

**Mix de protocolos:** shadowsocks × 17 · trojan × 15 · vless × 5 · vmess × 34

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
