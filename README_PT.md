...
![nós](https://img.shields.io/badge/nós-78-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2066-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-172ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_07:19_UTC-informational)
...
- **RTT mediano**: 172 ms
- **Última atualização (UTC)**: 2026-05-29 07:19 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 32 · vless × 15 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
