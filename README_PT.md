...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1892-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-310ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_09:32_UTC-informational)
...
- **RTT mediano**: 310 ms
- **Última atualização (UTC)**: 2026-07-06 09:32 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 27 · vless × 12 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 3
