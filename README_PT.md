...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2421-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-298ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_17:17_UTC-informational)
...
- **Ativos em todas as fontes**: 2421
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 298 ms
- **Última atualização (UTC)**: 2026-05-10 17:17 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 16 · vless × 80 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 58 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 3 · `surfboard-eternity` × 9
