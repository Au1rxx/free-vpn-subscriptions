...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2317-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-172ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_05:15_UTC-informational)
...
- **RTT mediano**: 172 ms
- **Última atualização (UTC)**: 2026-06-20 05:15 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 24 · vless × 16 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 3
