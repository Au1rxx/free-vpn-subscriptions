...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2079-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-150ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_08:13_UTC-informational)
...
- **RTT mediano**: 150 ms
- **Última atualização (UTC)**: 2026-07-10 08:13 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 11 · vless × 14 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 34 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `surfboard-eternity` × 3
