...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2618-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-76ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-17_18:12_UTC-informational)
...
- **Ativos em todas as fontes**: 2618
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 76 ms
- **Última atualização (UTC)**: 2026-05-17 18:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 7 · vless × 92 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 5 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 39 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 47 · `pawdroid` × 6 · `ruking-clash` × 9 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
