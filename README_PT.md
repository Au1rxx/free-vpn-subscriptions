...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2475-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-80ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-17_02:39_UTC-informational)
...
- **RTT mediano**: 80 ms
- **Última atualização (UTC)**: 2026-05-17 02:39 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 5 · vless × 97 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 37 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 55 · `pawdroid` × 6 · `ruking-clash` × 6 · `surfboard-eternity` × 5
