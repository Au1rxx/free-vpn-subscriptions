...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2485-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-91ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-16_20:35_UTC-informational)
...
- **Ativos em todas as fontes**: 2485
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 91 ms
- **Última atualização (UTC)**: 2026-05-16 20:35 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 17 · vless × 85 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 36 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 49 · `pawdroid` × 9 · `ruking-clash` × 6 · `surfboard-eternity` × 5
