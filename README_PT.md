...
![nós](https://img.shields.io/badge/nós-91-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2163-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-305ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-11_14:15_UTC-informational)
...
- **Nós selecionados**: 91
- **Ativos em todas as fontes**: 2163
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 305 ms
- **Última atualização (UTC)**: 2026-06-11 14:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 33 · trojan × 25 · vless × 11 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 1
