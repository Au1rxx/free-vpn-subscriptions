...
![nós](https://img.shields.io/badge/nós-54-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2047-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-189ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_12:32_UTC-informational)
...
- **RTT mediano**: 189 ms
- **Última atualização (UTC)**: 2026-05-29 12:32 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 13 · vless × 7 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 6 · `ruking-clash` × 3 · `surfboard-eternity` × 2
