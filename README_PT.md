...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2567-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-142ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_19:38_UTC-informational)
...
- **RTT mediano**: 142 ms
- **Última atualização (UTC)**: 2026-04-26 19:38 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 18 · vless × 80 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 43 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 4 · `ninjastrikers` × 53 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
