...
![nós](https://img.shields.io/badge/nós-122-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1790-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-345ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_05:14_UTC-informational)
...
- **Ativos em todas as fontes**: 1790
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 345 ms
- **Última atualização (UTC)**: 2026-07-11 05:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 56 · trojan × 22 · vless × 25 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 9 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 3 · `ninjastrikers` × 25 · `pawdroid` × 10 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 3
