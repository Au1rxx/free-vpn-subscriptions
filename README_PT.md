...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2600-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-163ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_02:32_UTC-informational)
...
- **RTT mediano**: 163 ms
- **Última atualização (UTC)**: 2026-04-23 02:32 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 14 · vless × 96 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 75 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
