...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2691-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-80ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-18_05:19_UTC-informational)
...
- **Ativos em todas as fontes**: 2691
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 80 ms
- **Última atualização (UTC)**: 2026-05-18 05:19 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 3 · vless × 98 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 61 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
