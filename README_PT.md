...
![nós](https://img.shields.io/badge/nós-120-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1701-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-379ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_18:28_UTC-informational)
...
- **Ativos em todas as fontes**: 1701
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 379 ms
- **Última atualização (UTC)**: 2026-07-10 18:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 75 · trojan × 19 · vless × 11 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 26 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
