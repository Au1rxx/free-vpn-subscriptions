...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2401-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-397ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_20:29_UTC-informational)
...
- **RTT mediano**: 397 ms
- **Última atualização (UTC)**: 2026-07-18 20:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 97 · vless × 13 · vmess × 4

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 44 · `mahdibland-shadowsocks` × 46 · `matin-v2ray` × 4 · `ninjastrikers` × 4 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 5
