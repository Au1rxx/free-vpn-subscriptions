...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2081-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-310ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_23:38_UTC-informational)
...
- **RTT mediano**: 310 ms
- **Última atualização (UTC)**: 2026-07-01 23:38 UTC

**Mix de protocolos:** shadowsocks × 45 · trojan × 19 · vless × 11 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 6 · `ninjastrikers` × 18 · `pawdroid` × 1 · `surfboard-eternity` × 3
