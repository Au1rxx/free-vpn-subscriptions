...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2444-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-103ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-14_05:23_UTC-informational)
...
- **RTT mediano**: 103 ms
- **Última atualização (UTC)**: 2026-05-14 05:23 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 5 · vless × 94 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 3 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 65 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 4
