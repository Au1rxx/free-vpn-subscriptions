...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2120-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-364ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_19:28_UTC-informational)
...
- **RTT mediano**: 364 ms
- **Última atualização (UTC)**: 2026-06-24 19:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 30 · trojan × 32 · vless × 34 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 37 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 6 · `ruking-clash` × 15 · `surfboard-eternity` × 2
