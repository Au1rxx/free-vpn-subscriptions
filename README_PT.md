...
![nós](https://img.shields.io/badge/nós-116-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1780-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-365ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_01:09_UTC-informational)
...
- **RTT mediano**: 365 ms
- **Última atualização (UTC)**: 2026-06-18 01:09 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 29 · vless × 32 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 24 · `pawdroid` × 1 · `ruking-clash` × 15 · `surfboard-eternity` × 4
