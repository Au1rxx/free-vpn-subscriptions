...
![nós](https://img.shields.io/badge/nós-86-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2022-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-201ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_21:10_UTC-informational)
...
- **RTT mediano**: 201 ms
- **Última atualização (UTC)**: 2026-06-26 21:10 UTC

**Mix de protocolos:** shadowsocks × 17 · trojan × 32 · vless × 17 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `ruking-clash` × 17
