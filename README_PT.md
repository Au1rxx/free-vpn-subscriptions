...
![nós](https://img.shields.io/badge/nós-91-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2079-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-442ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_08:28_UTC-informational)
...
- **RTT mediano**: 442 ms
- **Última atualização (UTC)**: 2026-06-27 08:28 UTC

**Mix de protocolos:** shadowsocks × 17 · trojan × 36 · vless × 18 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 16 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 1
