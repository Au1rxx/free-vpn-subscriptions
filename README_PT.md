...
![nós](https://img.shields.io/badge/nós-149-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2174-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-400ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_18:18_UTC-informational)
...
- **RTT mediano**: 400 ms
- **Última atualização (UTC)**: 2026-07-16 18:18 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 79 · vless × 9 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `mahdi0024` × 51 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 33 · `matin-v2ray` × 5 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 4
