...
![nós](https://img.shields.io/badge/nós-78-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2347-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-132ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_17:33_UTC-informational)
...
- **RTT mediano**: 132 ms
- **Última atualização (UTC)**: 2026-05-31 17:33 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 17 · vless × 8 · vmess × 32

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
