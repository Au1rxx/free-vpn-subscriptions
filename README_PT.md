...
![nós](https://img.shields.io/badge/nós-128-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1814-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-274ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_01:15_UTC-informational)
...
- **RTT mediano**: 274 ms
- **Última atualização (UTC)**: 2026-07-09 01:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 29 · vless × 26 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 7 · `ninjastrikers` × 22 · `pawdroid` × 8 · `ruking-clash` × 3 · `snakem982` × 4 · `surfboard-eternity` × 5
