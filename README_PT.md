...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2611-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-161ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_22:20_UTC-informational)
...
- **Ativos em todas as fontes**: 2611
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 161 ms
- **Última atualização (UTC)**: 2026-04-27 22:20 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 22 · vless × 90 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 6
