...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2039-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-359ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_13:35_UTC-informational)
...
- **RTT mediano**: 359 ms
- **Última atualização (UTC)**: 2026-07-04 13:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 16 · vless × 10 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 5 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 4
