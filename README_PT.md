...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1801-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-363ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_09:37_UTC-informational)
...
- **RTT mediano**: 363 ms
- **Última atualização (UTC)**: 2026-07-09 09:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 22 · vless × 17 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 7 · `ninjastrikers` × 17 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 6
