...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2331-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-81ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_20:28_UTC-informational)
...
- **RTT mediano**: 81 ms
- **Última atualização (UTC)**: 2026-05-22 20:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 83 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 55 · `pawdroid` × 8 · `ruking-clash` × 5 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
