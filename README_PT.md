...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2471-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-75ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-18_10:39_UTC-informational)
...
- **RTT mediano**: 75 ms
- **Última atualização (UTC)**: 2026-05-18 10:39 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 6 · vless × 92 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 2 · `lagzian-mix` × 5 · `mahdi0024` × 39 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 5 · `ruking-clash` × 11 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
