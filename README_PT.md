...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2041-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-78ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_08:17_UTC-informational)
...
- **Ativos em todas as fontes**: 2041
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 78 ms
- **Última atualização (UTC)**: 2026-05-22 08:17 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 9 · vless × 86 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 3 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
