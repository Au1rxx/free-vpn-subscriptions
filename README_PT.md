...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2439-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-259ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_23:24_UTC-informational)
...
- **RTT mediano**: 259 ms
- **Última atualização (UTC)**: 2026-05-10 23:24 UTC

**Mix de protocolos:** shadowsocks × 49 · trojan × 16 · vless × 76 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 5 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
