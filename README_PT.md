...
![nós](https://img.shields.io/badge/nós-144-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2082-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-193ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_17:22_UTC-informational)
...
- **RTT mediano**: 193 ms
- **Última atualização (UTC)**: 2026-05-03 17:22 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 23 · vless × 82 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 3 · `ninjastrikers` × 54 · `ruking-clash` × 1 · `surfboard-eternity` × 6
