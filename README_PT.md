...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2450-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-122ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-14_22:27_UTC-informational)
...
- **RTT mediano**: 122 ms
- **Última atualização (UTC)**: 2026-05-14 22:27 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 25 · vless × 78 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 52 · `pawdroid` × 5 · `ruking-clash` × 5 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
