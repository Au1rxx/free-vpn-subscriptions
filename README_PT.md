...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2480-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-86ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-16_19:29_UTC-informational)
...
- **RTT mediano**: 86 ms
- **Última atualização (UTC)**: 2026-05-16 19:29 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 16 · vless × 83 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 44 · `pawdroid` × 6 · `ruking-clash` × 7 · `surfboard-eternity` × 6
