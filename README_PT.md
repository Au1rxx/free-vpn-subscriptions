...
![nós](https://img.shields.io/badge/nós-125-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1836-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-408ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_18:11_UTC-informational)
...
- **RTT mediano**: 408 ms
- **Última atualização (UTC)**: 2026-06-15 18:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 23 · vless × 34 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 22 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 19 · `surfboard-eternity` × 1
