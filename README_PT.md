...
![nós](https://img.shields.io/badge/nós-145-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2526-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-187ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_10:10_UTC-informational)
...
- **RTT mediano**: 187 ms
- **Última atualização (UTC)**: 2026-04-23 10:10 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 20 · vless × 87 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 67 · `pawdroid` × 1 · `surfboard-eternity` × 5
