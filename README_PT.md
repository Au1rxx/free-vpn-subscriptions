...
![nós](https://img.shields.io/badge/nós-147-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1556-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-387ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_21:24_UTC-informational)
...
- **Ativos em todas as fontes**: 1556
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 387 ms
- **Última atualização (UTC)**: 2026-07-14 21:24 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 97 · trojan × 28 · vless × 13 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 25 · `mahdi0024` × 13 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 33 · `matin-v2ray` × 8 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
