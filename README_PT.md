...
![nós](https://img.shields.io/badge/nós-78-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1978-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-174ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_22:36_UTC-informational)
...
- **RTT mediano**: 174 ms
- **Última atualização (UTC)**: 2026-07-03 22:36 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 23 · vless × 7 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 6 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
