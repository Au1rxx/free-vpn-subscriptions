...
![nós](https://img.shields.io/badge/nós-129-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2131-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-94ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-25_17:38_UTC-informational)
...
- **RTT mediano**: 94 ms
- **Última atualização (UTC)**: 2026-05-25 17:38 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 27 · vless × 55 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 55 · `pawdroid` × 2 · `ruking-clash` × 10 · `surfboard-eternity` × 5
