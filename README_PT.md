...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1981-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-278ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_10:22_UTC-informational)
...
- **RTT mediano**: 278 ms
- **Última atualização (UTC)**: 2026-07-05 10:22 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 48 · trojan × 23 · vless × 10 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 32 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 9
