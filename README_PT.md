...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2433-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-81ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-25_13:30_UTC-informational)
...
- **RTT mediano**: 81 ms
- **Última atualização (UTC)**: 2026-05-25 13:30 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 16 · vless × 69 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 40 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 54 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 4
