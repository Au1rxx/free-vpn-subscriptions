...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1780-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-347ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_07:31_UTC-informational)
...
- **Ativos em todas as fontes**: 1780
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 347 ms
- **Última atualização (UTC)**: 2026-07-11 07:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 23 · vless × 20 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 6 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 3
