...
![nós](https://img.shields.io/badge/nós-124-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1836-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-357ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_00:23_UTC-informational)
...
- **RTT mediano**: 357 ms
- **Última atualização (UTC)**: 2026-07-08 00:23 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 58 · trojan × 31 · vless × 19 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 7 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
