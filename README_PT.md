...
![nós](https://img.shields.io/badge/nós-148-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1959-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-322ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_22:39_UTC-informational)
...
- **RTT mediano**: 322 ms
- **Última atualização (UTC)**: 2026-05-06 22:39 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 19 · vless × 72 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 6
