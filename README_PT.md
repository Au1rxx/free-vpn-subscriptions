...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2139-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-96ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-26_01:36_UTC-informational)
...
- **Ativos em todas as fontes**: 2139
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 96 ms
- **Última atualização (UTC)**: 2026-05-26 01:36 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 20 · vless × 87 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `pawdroid` × 6 · `ruking-clash` × 8 · `surfboard-eternity` × 7
