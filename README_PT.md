...
![nós](https://img.shields.io/badge/nós-146-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2081-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-176ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_18:35_UTC-informational)
...
- **RTT mediano**: 176 ms
- **Última atualização (UTC)**: 2026-04-29 18:35 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 16 · vless × 78 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 58 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
