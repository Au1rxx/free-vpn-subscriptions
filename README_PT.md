...
![nós](https://img.shields.io/badge/nós-110-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1967-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-336ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_10:23_UTC-informational)
...
- **RTT mediano**: 336 ms
- **Última atualização (UTC)**: 2026-07-12 10:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 26 · vless × 12 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `mfuu-clash` × 6 · `ninjastrikers` × 14 · `pawdroid` × 9 · `surfboard-eternity` × 2
