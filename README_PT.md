...
![nós](https://img.shields.io/badge/nós-86-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1822-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-390ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_20:35_UTC-informational)
...
- **RTT mediano**: 390 ms
- **Última atualização (UTC)**: 2026-06-30 20:35 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 31 · vless × 10 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 5
