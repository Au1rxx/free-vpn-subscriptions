...
![nós](https://img.shields.io/badge/nós-75-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2136-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-164ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_22:35_UTC-informational)
...
- **Nós selecionados**: 75
- **Ativos em todas as fontes**: 2136
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 164 ms
- **Última atualização (UTC)**: 2026-07-09 22:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 22 · trojan × 11 · vless × 10 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
