...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2693-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-77ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-18_06:16_UTC-informational)
...
- **Ativos em todas as fontes**: 2693
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 77 ms
- **Última atualização (UTC)**: 2026-05-18 06:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 5 · vless × 97 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 64 · `pawdroid` × 6 · `ruking-clash` × 7 · `surfboard-eternity` × 3
