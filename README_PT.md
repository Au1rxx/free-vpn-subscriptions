...
![nós](https://img.shields.io/badge/nós-81-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2269-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-184ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_12:33_UTC-informational)
...
- **RTT mediano**: 184 ms
- **Última atualização (UTC)**: 2026-06-20 12:33 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 22 · vless × 8 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `ruking-clash` × 15 · `surfboard-eternity` × 2
