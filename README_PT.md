...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1888-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-281ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_20:29_UTC-informational)
...
- **RTT mediano**: 281 ms
- **Última atualização (UTC)**: 2026-05-11 20:29 UTC

**Mix de protocolos:** shadowsocks × 73 · trojan × 2 · vless × 63 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 7 · `mahdi0024` × 5 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 3 · `ninjastrikers` × 44 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
