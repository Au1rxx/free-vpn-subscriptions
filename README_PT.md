...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1611-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-368ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_04:27_UTC-informational)
...
- **Ativos em todas as fontes**: 1611
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 368 ms
- **Última atualização (UTC)**: 2026-07-15 04:27 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 97 · trojan × 26 · vless × 16 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 2 · `epodonios` × 23 · `mahdi0024` × 13 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4
