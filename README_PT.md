...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1897-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-278ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_00:17_UTC-informational)
...
- **RTT mediano**: 278 ms
- **Última atualização (UTC)**: 2026-07-07 00:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 28 · vless × 18 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 7 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
