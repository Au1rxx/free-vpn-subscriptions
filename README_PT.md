...
![nós](https://img.shields.io/badge/nós-140-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2214-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-284ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-05_17:15_UTC-informational)
...
- **RTT mediano**: 284 ms
- **Última atualização (UTC)**: 2026-05-05 17:15 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 26 · vless × 69 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `snakem982` × 1 · `surfboard-eternity` × 9
