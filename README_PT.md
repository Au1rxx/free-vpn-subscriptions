...
![nós](https://img.shields.io/badge/nós-71-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2011-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-152ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-27_14:26_UTC-informational)
...
- **RTT mediano**: 152 ms
- **Última atualização (UTC)**: 2026-05-27 14:26 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 17 · vless × 16 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 5 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 8 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 1
