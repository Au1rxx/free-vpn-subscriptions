...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2493-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-143ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_10:28_UTC-informational)
...
- **Ativos em todas as fontes**: 2493
- **RTT do nó mais rápido**: 24 ms
- **RTT mediano**: 143 ms
- **Última atualização (UTC)**: 2026-05-10 10:28 UTC

**Mix de protocolos:** shadowsocks × 49 · trojan × 7 · vless × 86 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 9
