...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1789-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-591ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_09:35_UTC-informational)
...
- **RTT mediano**: 591 ms
- **Última atualização (UTC)**: 2026-06-17 09:35 UTC

**Mix de protocolos:** hysteria2 × 5 · shadowsocks × 40 · trojan × 27 · vless × 19 · vmess × 59

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 61 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 3
