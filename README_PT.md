...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2181-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-384ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_13:11_UTC-informational)
...
- **Ativos em todas as fontes**: 2181
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 384 ms
- **Última atualização (UTC)**: 2026-04-21 13:11 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 9 · vless × 99 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 55 · `epodonios` × 5 · `lagzian-mix` × 7 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `ruking-clash` × 11 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
