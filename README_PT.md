...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2089-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-165ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_14:31_UTC-informational)
...
- **Ativos em todas as fontes**: 2089
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 165 ms
- **Última atualização (UTC)**: 2026-05-03 14:31 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 25 · vless × 87 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 59 · `pawdroid` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
