...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2610-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-107ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-28_01:14_UTC-informational)
...
- **Ativos em todas as fontes**: 2610
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 107 ms
- **Última atualização (UTC)**: 2026-04-28 01:14 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 6 · vless × 107 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 5 · `ninjastrikers` × 61 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
