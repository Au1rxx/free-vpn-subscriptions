...
![nós](https://img.shields.io/badge/nós-127-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2509-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-398ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_19:33_UTC-informational)
...
- **RTT mediano**: 398 ms
- **Última atualização (UTC)**: 2026-04-23 19:33 UTC

**Mix de protocolos:** shadowsocks × 13 · trojan × 24 · vless × 76 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `pawdroid` × 1 · `surfboard-eternity` × 1
