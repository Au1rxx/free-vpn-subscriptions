...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2315-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-452ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_18:12_UTC-informational)
...
- **Ativos em todas as fontes**: 2315
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 452 ms
- **Última atualização (UTC)**: 2026-04-21 18:12 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 18 · vless × 89 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 52 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 47 · `ruking-clash` × 7 · `surfboard-eternity` × 6
