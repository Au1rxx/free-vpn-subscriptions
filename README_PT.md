...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2141-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-272ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_16:09_UTC-informational)
...
- **RTT mediano**: 272 ms
- **Última atualização (UTC)**: 2026-06-28 16:09 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 33 · vless × 19 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 3
