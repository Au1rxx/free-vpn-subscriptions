...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1879-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-357ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_21:32_UTC-informational)
...
- **RTT mediano**: 357 ms
- **Última atualização (UTC)**: 2026-07-05 21:32 UTC

**Mix de protocolos:** shadowsocks × 47 · trojan × 24 · vless × 13 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 2
