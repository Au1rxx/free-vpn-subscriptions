...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1933-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-344ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_17:10_UTC-informational)
...
- **RTT mediano**: 344 ms
- **Última atualização (UTC)**: 2026-07-13 17:10 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 14 · vless × 12 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 26 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 4 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
