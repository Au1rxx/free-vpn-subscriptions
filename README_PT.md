...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2192-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-81ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_09:22_UTC-informational)
...
- **RTT mediano**: 81 ms
- **Última atualização (UTC)**: 2026-04-26 09:22 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 10 · vless × 103 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 67 · `pawdroid` × 4 · `surfboard-eternity` × 7 · `vxiaov-clash` × 2
