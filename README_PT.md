...
![nós](https://img.shields.io/badge/nós-146-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1888-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-478ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_14:22_UTC-informational)
...
- **RTT mediano**: 478 ms
- **Última atualização (UTC)**: 2026-06-22 14:22 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 29 · vless × 63 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 41 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 31 · `snakem982` × 3 · `surfboard-eternity` × 2
