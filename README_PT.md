...
![nós](https://img.shields.io/badge/nós-139-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2654-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-199ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_22:32_UTC-informational)
...
- **Ativos em todas as fontes**: 2654
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 199 ms
- **Última atualização (UTC)**: 2026-04-24 22:32 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 23 · vless × 79 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 48 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
