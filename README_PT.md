...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2447-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-99ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_01:30_UTC-informational)
...
- **RTT mediano**: 99 ms
- **Última atualização (UTC)**: 2026-04-24 01:30 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 13 · vless × 104 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 25 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
