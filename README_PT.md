...
![nós](https://img.shields.io/badge/nós-83-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2189-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-191ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_10:22_UTC-informational)
...
- **RTT mediano**: 191 ms
- **Última atualização (UTC)**: 2026-06-06 10:22 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 24 · vless × 19 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 26 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 5 · `surfboard-eternity` × 3
