...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1858-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-376ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_22:31_UTC-informational)
...
- **RTT mediano**: 376 ms
- **Última atualização (UTC)**: 2026-06-15 22:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 25 · vless × 15 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `ruking-clash` × 8 · `surfboard-eternity` × 5
