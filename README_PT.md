...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2444-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-86ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-25_06:12_UTC-informational)
...
- **RTT mediano**: 86 ms
- **Última atualização (UTC)**: 2026-05-25 06:12 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 2 · vless × 79 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 45 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 59 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 1
