...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2425-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-137ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-09_03:27_UTC-informational)
...
- **RTT mediano**: 137 ms
- **Última atualização (UTC)**: 2026-05-09 03:27 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 10 · vless × 92 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 72 · `pawdroid` × 1 · `surfboard-eternity` × 7
