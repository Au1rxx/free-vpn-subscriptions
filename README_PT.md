...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2597-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-8ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-19_10:41_UTC-informational)
...
- **RTT mediano**: 8 ms
- **Última atualização (UTC)**: 2026-04-19 10:41 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 17 · vless × 77 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 15 · `epodonios` × 33 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 39 · `ruking-clash` × 18 · `snakem982` × 6 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
