...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1828-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-329ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_09:12_UTC-informational)
...
- **Ativos em todas as fontes**: 1828
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 329 ms
- **Última atualização (UTC)**: 2026-07-07 09:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 23 · vless × 23 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 10 · `ninjastrikers` × 15 · `pawdroid` × 7 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
