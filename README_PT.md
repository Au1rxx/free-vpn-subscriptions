...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2462-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-76ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-18_11:25_UTC-informational)
...
- **Ativos em todas as fontes**: 2462
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 76 ms
- **Última atualização (UTC)**: 2026-05-18 11:25 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 8 · vless × 93 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 37 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
