...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1854-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-331ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_06:38_UTC-informational)
...
- **RTT mediano**: 331 ms
- **Última atualização (UTC)**: 2026-07-07 06:38 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 48 · trojan × 22 · vless × 23 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 27 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 9 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 2
