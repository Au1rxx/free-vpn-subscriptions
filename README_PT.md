...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1849-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-354ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_07:11_UTC-informational)
...
- **RTT mediano**: 354 ms
- **Última atualização (UTC)**: 2026-06-15 07:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 23 · vless × 18 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 19 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 4
