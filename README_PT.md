...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2092-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-333ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_18:22_UTC-informational)
...
- **RTT mediano**: 333 ms
- **Última atualização (UTC)**: 2026-06-10 18:22 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 13 · vless × 14 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 2
