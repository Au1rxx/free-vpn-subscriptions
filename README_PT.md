...
![nós](https://img.shields.io/badge/nós-145-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2439-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-81ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-25_12:26_UTC-informational)
...
- **RTT mediano**: 81 ms
- **Última atualização (UTC)**: 2026-05-25 12:26 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 18 · vless × 65 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 35 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 8 · `surfboard-eternity` × 7
