...
![nós](https://img.shields.io/badge/nós-71-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2410-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-155ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_16:10_UTC-informational)
...
- **Nós selecionados**: 71
- **Ativos em todas as fontes**: 2410
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 155 ms
- **Última atualização (UTC)**: 2026-07-02 16:10 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 16 · vless × 20 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 8 · `ninjastrikers` × 12 · `pawdroid` × 11 · `surfboard-eternity` × 3
