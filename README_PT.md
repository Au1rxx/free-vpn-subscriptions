...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1940-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-314ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_01:25_UTC-informational)
...
- **RTT mediano**: 314 ms
- **Última atualização (UTC)**: 2026-07-12 01:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 62 · trojan × 19 · vless × 27 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 5 · `ninjastrikers` × 26 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
