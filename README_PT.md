...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1903-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-160ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_05:36_UTC-informational)
...
- **RTT mediano**: 160 ms
- **Última atualização (UTC)**: 2026-07-03 05:36 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 20 · vless × 16 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `mahdi0024` × 17 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
