...
![nós](https://img.shields.io/badge/nós-129-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1822-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-281ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_00:23_UTC-informational)
...
- **RTT mediano**: 281 ms
- **Última atualização (UTC)**: 2026-07-09 00:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 52 · trojan × 27 · vless × 24 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 20 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 9 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 3
