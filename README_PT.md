...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2038-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-187ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_05:34_UTC-informational)
...
- **RTT mediano**: 187 ms
- **Última atualização (UTC)**: 2026-07-13 05:34 UTC

**Mix de protocolos:** shadowsocks × 55 · trojan × 17 · vless × 30 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 10 · `mahdi0024` × 29 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 3
