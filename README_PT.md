...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2471-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-108ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_14:17_UTC-informational)
...
- **RTT mediano**: 108 ms
- **Última atualização (UTC)**: 2026-04-27 14:17 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 15 · vless × 98 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
