...
![nós](https://img.shields.io/badge/nós-86-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2542-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-100ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_07:11_UTC-informational)
...
- **RTT mediano**: 100 ms
- **Última atualização (UTC)**: 2026-06-02 07:11 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 27 · vless × 13 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 17 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
