...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2266-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-125ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_00:15_UTC-informational)
...
- **RTT mediano**: 125 ms
- **Última atualização (UTC)**: 2026-04-21 00:15 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 4 · vless × 111 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 52 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7
