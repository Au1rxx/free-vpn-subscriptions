...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1936-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-253ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_07:22_UTC-informational)
...
- **RTT mediano**: 253 ms
- **Última atualização (UTC)**: 2026-07-06 07:22 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 27 · vless × 16 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 4 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
