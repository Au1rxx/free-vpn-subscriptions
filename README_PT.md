...
![nós](https://img.shields.io/badge/nós-107-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1955-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-383ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_19:19_UTC-informational)
...
- **RTT mediano**: 383 ms
- **Última atualização (UTC)**: 2026-06-10 19:19 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 18 · vless × 11 · vmess × 35

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 34 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 6 · `surfboard-eternity` × 1
