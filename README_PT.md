...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2260-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-81ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_07:20_UTC-informational)
...
- **RTT mediano**: 81 ms
- **Última atualização (UTC)**: 2026-05-01 07:20 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 9 · vless × 93 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 65 · `pawdroid` × 1 · `surfboard-eternity` × 5
