...
![nós](https://img.shields.io/badge/nós-57-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1962-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-157ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-27_17:11_UTC-informational)
...
- **Nós selecionados**: 57
- **Ativos em todas as fontes**: 1962
- **RTT do nó mais rápido**: 39 ms
- **RTT mediano**: 157 ms
- **Última atualização (UTC)**: 2026-05-27 17:11 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 10 · vless × 17 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 6 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 3
