...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2165-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-137ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_01:30_UTC-informational)
...
- **RTT mediano**: 137 ms
- **Última atualização (UTC)**: 2026-06-06 01:30 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 27 · vless × 31 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 30 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
