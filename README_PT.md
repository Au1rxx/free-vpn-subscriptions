...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2619-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-79ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-17_21:36_UTC-informational)
...
- **Ativos em todas as fontes**: 2619
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 79 ms
- **Última atualização (UTC)**: 2026-05-17 21:36 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 14 · vless × 86 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 6 · `epodonios` × 3 · `lagzian-mix` × 6 · `mahdi0024` × 37 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 6 · `ruking-clash` × 8 · `surfboard-eternity` × 3 · `vxiaov-clash` × 2
