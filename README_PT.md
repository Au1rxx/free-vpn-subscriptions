...
![nós](https://img.shields.io/badge/nós-132-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2254-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-77ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-18_23:18_UTC-informational)
...
- **Ativos em todas as fontes**: 2254
- **RTT do nó mais rápido**: 22 ms
- **RTT mediano**: 77 ms
- **Última atualização (UTC)**: 2026-05-18 23:18 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 19 · trojan × 27 · vless × 63 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 25 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 50 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 3
