...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2094-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-101ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_05:33_UTC-informational)
...
- **RTT mediano**: 101 ms
- **Última atualização (UTC)**: 2026-04-29 05:33 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 8 · vless × 97 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 73 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 2 · `surfboard-eternity` × 8
