...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2585-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-79ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-28_09:17_UTC-informational)
...
- **RTT mediano**: 79 ms
- **Última atualização (UTC)**: 2026-04-28 09:17 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 14 · vless × 104 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
