...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1865-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-335ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_06:23_UTC-informational)
...
- **RTT mediano**: 335 ms
- **Última atualização (UTC)**: 2026-06-09 06:23 UTC

**Mix de protocolos:** shadowsocks × 48 · trojan × 19 · vless × 20 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `mahdi0024` × 13 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 22 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 10 · `surfboard-eternity` × 3
