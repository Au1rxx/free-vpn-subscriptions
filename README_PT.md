...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2057-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-353ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_21:39_UTC-informational)
...
- **RTT mediano**: 353 ms
- **Última atualização (UTC)**: 2026-07-01 21:39 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 22 · vless × 12 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 7 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 3 · `ninjastrikers` × 18 · `pawdroid` × 2 · `surfboard-eternity` × 3
