...
![nós](https://img.shields.io/badge/nós-64-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2497-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-163ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_21:35_UTC-informational)
...
- **RTT mediano**: 163 ms
- **Última atualização (UTC)**: 2026-06-01 21:35 UTC

**Mix de protocolos:** shadowsocks × 16 · trojan × 22 · vless × 3 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 16 · `mahdi0024` × 15 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `surfboard-eternity` × 3
