...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2385-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-132ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_20:26_UTC-informational)
...
- **RTT mediano**: 132 ms
- **Última atualização (UTC)**: 2026-05-12 20:26 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 20 · vless × 80 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
