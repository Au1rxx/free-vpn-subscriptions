...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2281-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-66ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-19_10:15_UTC-informational)
...
- **Ativos em todas as fontes**: 2281
- **RTT do nó mais rápido**: 24 ms
- **RTT mediano**: 66 ms
- **Última atualização (UTC)**: 2026-05-19 10:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 19 · trojan × 24 · vless × 85 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 59 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 4
