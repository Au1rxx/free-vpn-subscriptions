...
![nós](https://img.shields.io/badge/nós-146-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2325-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-90ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-24_13:39_UTC-informational)
...
- **Ativos em todas as fontes**: 2325
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 90 ms
- **Última atualização (UTC)**: 2026-05-24 13:39 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 18 · vless × 65 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 55 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 7
