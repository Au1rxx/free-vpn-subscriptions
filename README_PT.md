...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1905-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-355ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_07:27_UTC-informational)
...
- **RTT mediano**: 355 ms
- **Última atualização (UTC)**: 2026-07-14 07:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 18 · vless × 18 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 8 · `mahdi0024` × 22 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 19 · `pawdroid` × 10 · `snakem982` × 1 · `surfboard-eternity` × 3
