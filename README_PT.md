...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2156-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-404ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_13:11_UTC-informational)
...
- **RTT mediano**: 404 ms
- **Última atualização (UTC)**: 2026-07-17 13:11 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 85 · vless × 15 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 3 · `mahdi0024` × 51 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 30 · `matin-v2ray` × 5 · `ninjastrikers` × 12 · `pawdroid` × 8 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 3
