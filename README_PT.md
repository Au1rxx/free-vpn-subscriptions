...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2578-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-112ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_17:11_UTC-informational)
...
- **RTT mediano**: 112 ms
- **Última atualização (UTC)**: 2026-04-26 17:11 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 8 · vless × 88 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 42 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 51 · `pawdroid` × 3 · `surfboard-eternity` × 3
