...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1926-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-304ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_17:18_UTC-informational)
...
- **RTT mediano**: 304 ms
- **Última atualização (UTC)**: 2026-06-16 17:18 UTC

**Mix de protocolos:** shadowsocks × 48 · trojan × 12 · vless × 15 · vmess × 75

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 16 · `lagzian-mix` × 1 · `mahdi0024` × 78 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 1
