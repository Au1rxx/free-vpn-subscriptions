...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2526-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-89ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_05:24_UTC-informational)
...
- **RTT mediano**: 89 ms
- **Última atualização (UTC)**: 2026-04-27 05:24 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 4 · vless × 96 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 63 · `pawdroid` × 1 · `surfboard-eternity` × 5
