...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1921-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-151ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_13:11_UTC-informational)
...
- **RTT mediano**: 151 ms
- **Última atualização (UTC)**: 2026-05-12 13:11 UTC

**Mix de protocolos:** shadowsocks × 55 · trojan × 6 · vless × 79 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 7 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `snakem982` × 1 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
