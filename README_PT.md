...
![nós](https://img.shields.io/badge/nós-120-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1812-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-366ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_09:35_UTC-informational)
...
- **RTT mediano**: 366 ms
- **Última atualização (UTC)**: 2026-07-08 09:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 68 · trojan × 25 · vless × 12 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 19 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 4
