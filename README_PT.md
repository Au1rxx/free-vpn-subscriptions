...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2561-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-85ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-16_00:18_UTC-informational)
...
- **RTT mediano**: 85 ms
- **Última atualização (UTC)**: 2026-05-16 00:18 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 10 · vless × 96 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 61 · `pawdroid` × 9 · `ruking-clash` × 5 · `surfboard-eternity` × 3
