...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2064-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_07:38_UTC-informational)
...
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-05-04 07:38 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 12 · vless × 102 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 8 · `ninjastrikers` × 69 · `snakem982` × 1 · `surfboard-eternity` × 8
