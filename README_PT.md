...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2287-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-362ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-19_03:27_UTC-informational)
...
- **Ativos em todas as fontes**: 2287
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 362 ms
- **Última atualização (UTC)**: 2026-07-19 03:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 86 · vless × 17 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `mahdi0024` × 47 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 33 · `matin-v2ray` × 7 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 10 · `surfboard-eternity` × 7
