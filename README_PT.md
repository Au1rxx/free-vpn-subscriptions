...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2009-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-400ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_09:36_UTC-informational)
...
- **RTT mediano**: 400 ms
- **Última atualização (UTC)**: 2026-07-16 09:36 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 73 · vless × 21 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 42 · `mahdibland-shadowsocks` × 46 · `matin-v2ray` × 3 · `mfuu-clash` × 3 · `ninjastrikers` × 10 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 12
