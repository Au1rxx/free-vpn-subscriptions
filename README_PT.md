...
![nós](https://img.shields.io/badge/nós-69-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2000-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-175ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_11:13_UTC-informational)
...
- **RTT mediano**: 175 ms
- **Última atualização (UTC)**: 2026-07-04 11:13 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 15 · vless × 6 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 5 · `ninjastrikers` × 6 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
