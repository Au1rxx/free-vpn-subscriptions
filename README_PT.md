...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1948-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-317ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_11:35_UTC-informational)
...
- **RTT mediano**: 317 ms
- **Última atualização (UTC)**: 2026-07-05 11:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 25 · vless × 8 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
