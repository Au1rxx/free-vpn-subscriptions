...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2209-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-97ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_02:17_UTC-informational)
...
- **RTT mediano**: 97 ms
- **Última atualização (UTC)**: 2026-05-01 02:17 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 5 · vless × 97 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 68 · `snakem982` × 1 · `surfboard-eternity` × 5
