...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2213-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-147ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_21:27_UTC-informational)
...
- **RTT mediano**: 147 ms
- **Última atualização (UTC)**: 2026-05-29 21:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 14 · trojan × 33 · vless × 6 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 1
