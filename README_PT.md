...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2069-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-123ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_09:31_UTC-informational)
...
- **RTT mediano**: 123 ms
- **Última atualização (UTC)**: 2026-04-29 09:31 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 4 · vless × 95 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 10
