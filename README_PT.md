...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2476-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-398ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_15:12_UTC-informational)
...
- **RTT mediano**: 398 ms
- **Última atualização (UTC)**: 2026-07-18 15:12 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 98 · vless × 11 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 42 · `mahdibland-shadowsocks` × 37 · `matin-v2ray` × 5 · `ninjastrikers` × 6 · `pawdroid` × 6 · `ruking-clash` × 2 · `snakem982` × 8 · `surfboard-eternity` × 5
