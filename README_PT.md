...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2025-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-331ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_05:18_UTC-informational)
...
- **RTT mediano**: 331 ms
- **Última atualização (UTC)**: 2026-07-02 05:18 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 35 · vless × 21 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 25 · `pawdroid` × 4 · `surfboard-eternity` × 1
