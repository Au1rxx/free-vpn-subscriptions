...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2380-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-329ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-11_17:27_UTC-informational)
...
- **RTT mediano**: 329 ms
- **Última atualização (UTC)**: 2026-06-11 17:27 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 18 · vless × 10 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 17 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 2
