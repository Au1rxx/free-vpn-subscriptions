...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2514-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-98ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_10:27_UTC-informational)
...
- **RTT mediano**: 98 ms
- **Última atualização (UTC)**: 2026-04-27 10:27 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 7 · vless × 94 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 44 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 59 · `pawdroid` × 1 · `surfboard-eternity` × 3
