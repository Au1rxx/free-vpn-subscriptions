...
![nós](https://img.shields.io/badge/nós-101-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2176-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-153ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_04:36_UTC-informational)
...
- **Ativos em todas as fontes**: 2176
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 153 ms
- **Última atualização (UTC)**: 2026-06-06 04:36 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 27 · vless × 32 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 25 · `lagzian-mix` × 3 · `mahdi0024` × 20 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 28 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
