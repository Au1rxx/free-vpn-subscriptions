...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2266-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-277ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_08:26_UTC-informational)
...
- **RTT mediano**: 277 ms
- **Última atualização (UTC)**: 2026-06-20 08:26 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 28 · vless × 14 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 18 · `surfboard-eternity` × 4
