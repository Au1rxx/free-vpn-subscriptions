...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1738-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-364ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_01:25_UTC-informational)
...
- **Ativos em todas as fontes**: 1738
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 364 ms
- **Última atualização (UTC)**: 2026-07-11 01:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 85 · trojan × 26 · vless × 21 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 29 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 4 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 7
