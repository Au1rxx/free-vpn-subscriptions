...
![nós](https://img.shields.io/badge/nós-67-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2264-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-165ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_17:21_UTC-informational)
...
- **RTT mediano**: 165 ms
- **Última atualização (UTC)**: 2026-05-29 17:21 UTC

**Mix de protocolos:** shadowsocks × 12 · trojan × 27 · vless × 4 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 2
