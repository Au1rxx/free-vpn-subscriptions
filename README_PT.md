...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2463-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-76ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-25_08:36_UTC-informational)
...
- **RTT mediano**: 76 ms
- **Última atualização (UTC)**: 2026-05-25 08:36 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 3 · vless × 81 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 39 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 58 · `pawdroid` × 5 · `ruking-clash` × 8 · `surfboard-eternity` × 5
