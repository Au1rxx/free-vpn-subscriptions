...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2007-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-371ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_18:23_UTC-informational)
...
- **RTT mediano**: 371 ms
- **Última atualização (UTC)**: 2026-06-29 18:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 23 · vless × 26 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 7
