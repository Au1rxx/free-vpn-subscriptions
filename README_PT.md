...
![nós](https://img.shields.io/badge/nós-102-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1960-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-283ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_18:36_UTC-informational)
...
- **RTT mediano**: 283 ms
- **Última atualização (UTC)**: 2026-07-05 18:36 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 24 · vless × 8 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `mahdi0024` × 27 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 6 · `ninjastrikers` × 10 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 5
