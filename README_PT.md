...
![nós](https://img.shields.io/badge/nós-64-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2402-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-135ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_19:24_UTC-informational)
...
- **RTT mediano**: 135 ms
- **Última atualização (UTC)**: 2026-07-02 19:24 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 23 · trojan × 15 · vless × 8 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 3 · `ninjastrikers` × 8 · `pawdroid` × 4 · `surfboard-eternity` × 6
