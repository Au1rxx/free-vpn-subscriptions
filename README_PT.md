...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2490-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-137ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_14:32_UTC-informational)
...
- **Nós selecionados**: 76
- **Ativos em todas as fontes**: 2490
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 137 ms
- **Última atualização (UTC)**: 2026-06-02 14:32 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 26 · vless × 8 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 9 · `pawdroid` × 4 · `surfboard-eternity` × 4
