...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2186-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-162ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_11:16_UTC-informational)
...
- **RTT mediano**: 162 ms
- **Última atualização (UTC)**: 2026-04-21 11:16 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 3 · vless × 106 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 54 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 52 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 6
