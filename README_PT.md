...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1964-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-495ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_09:17_UTC-informational)
...
- **RTT mediano**: 495 ms
- **Última atualização (UTC)**: 2026-06-18 09:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 26 · vless × 31 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 7 · `ruking-clash` × 18 · `snakem982` × 7 · `surfboard-eternity` × 2
