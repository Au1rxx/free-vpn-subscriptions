...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2157-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-129ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_06:17_UTC-informational)
...
- **RTT mediano**: 129 ms
- **Última atualização (UTC)**: 2026-07-10 06:17 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 9 · vless × 19 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 1 · `surfboard-eternity` × 2
