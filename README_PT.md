...
![nós](https://img.shields.io/badge/nós-123-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2492-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-439ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_21:14_UTC-informational)
...
- **Ativos em todas as fontes**: 2492
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 439 ms
- **Última atualização (UTC)**: 2026-04-23 21:14 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 25 · vless × 70 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 47 · `pawdroid` × 2 · `surfboard-eternity` × 1
