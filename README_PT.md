...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2235-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-109ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_03:22_UTC-informational)
...
- **Ativos em todas as fontes**: 2235
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 109 ms
- **Última atualização (UTC)**: 2026-04-30 03:22 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 4 · vless × 102 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 13 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 71 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
