...
![nós](https://img.shields.io/badge/nós-136-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2582-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-291ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_18:24_UTC-informational)
...
- **RTT mediano**: 291 ms
- **Última atualização (UTC)**: 2026-04-22 18:24 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 22 · vless × 71 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 6
