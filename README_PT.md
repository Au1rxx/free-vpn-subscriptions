...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2526-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-119ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_12:19_UTC-informational)
...
- **Ativos em todas as fontes**: 2526
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 119 ms
- **Última atualização (UTC)**: 2026-04-25 12:19 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 20 · vless × 92 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 59 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
