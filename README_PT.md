...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2426-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-83ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-19_22:16_UTC-informational)
...
- **RTT mediano**: 83 ms
- **Última atualização (UTC)**: 2026-05-19 22:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 9 · vless × 82 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 5 · `ruking-clash` × 16 · `snakem982` × 1 · `surfboard-eternity` × 6
