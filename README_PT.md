...
![nós](https://img.shields.io/badge/nós-90-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2196-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-553ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_12:38_UTC-informational)
...
- **RTT mediano**: 553 ms
- **Última atualização (UTC)**: 2026-06-29 12:38 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 40 · vless × 19 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 5
