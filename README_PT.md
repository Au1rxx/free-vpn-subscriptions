...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2062-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-117ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_01:23_UTC-informational)
...
- **RTT mediano**: 117 ms
- **Última atualização (UTC)**: 2026-04-30 01:23 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 4 · vless × 94 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 69 · `surfboard-eternity` × 7
