...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2090-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-82ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_01:35_UTC-informational)
...
- **RTT mediano**: 82 ms
- **Última atualização (UTC)**: 2026-05-03 01:35 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 3 · vless × 101 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 62 · `pawdroid` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
