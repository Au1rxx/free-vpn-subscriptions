...
![nós](https://img.shields.io/badge/nós-89-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2071-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-100ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-03_16:15_UTC-informational)
...
- **Nós selecionados**: 89
- **Ativos em todas as fontes**: 2071
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 100 ms
- **Última atualização (UTC)**: 2026-06-03 16:15 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 36 · vless × 16 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 8 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
