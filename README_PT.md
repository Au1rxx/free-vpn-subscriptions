...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2317-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-359ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_08:29_UTC-informational)
...
- **RTT mediano**: 359 ms
- **Última atualização (UTC)**: 2026-07-01 08:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 32 · vless × 17 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 12 · `ninjastrikers` × 22 · `pawdroid` × 7 · `surfboard-eternity` × 1
