...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1801-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-366ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_11:24_UTC-informational)
...
- **Ativos em todas as fontes**: 1801
- **RTT do nó mais rápido**: 43 ms
- **RTT mediano**: 366 ms
- **Última atualização (UTC)**: 2026-07-08 11:24 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 62 · trojan × 23 · vless × 13 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 17 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 8 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
