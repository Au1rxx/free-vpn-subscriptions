...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2080-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-188ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_16:37_UTC-informational)
...
- **RTT mediano**: 188 ms
- **Última atualização (UTC)**: 2026-04-29 16:37 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 16 · vless × 80 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 6 · `ninjastrikers` × 57 · `surfboard-eternity` × 7
