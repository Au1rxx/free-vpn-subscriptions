...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2049-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-353ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_19:23_UTC-informational)
...
- **RTT mediano**: 353 ms
- **Última atualização (UTC)**: 2026-07-01 19:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 18 · vless × 12 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 3 · `surfboard-eternity` × 4
