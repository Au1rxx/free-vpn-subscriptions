...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2229-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-144ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_01:38_UTC-informational)
...
- **RTT mediano**: 144 ms
- **Última atualização (UTC)**: 2026-04-22 01:38 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 5 · vless × 97 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 71 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 5
