...
![nós](https://img.shields.io/badge/nós-133-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1998-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-413ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_18:40_UTC-informational)
...
- **RTT mediano**: 413 ms
- **Última atualização (UTC)**: 2026-06-23 18:40 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 38 · trojan × 29 · vless × 45 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 47 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 5
