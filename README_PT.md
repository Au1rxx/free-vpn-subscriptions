...
![nós](https://img.shields.io/badge/nós-116-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1906-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-320ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_23:26_UTC-informational)
...
- **RTT mediano**: 320 ms
- **Última atualização (UTC)**: 2026-07-05 23:26 UTC

**Mix de protocolos:** shadowsocks × 49 · trojan × 26 · vless × 10 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 31 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `ruking-clash` × 2 · `surfboard-eternity` × 4
