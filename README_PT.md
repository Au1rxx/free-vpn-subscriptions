...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1930-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-336ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_15:23_UTC-informational)
...
- **Ativos em todas as fontes**: 1930
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 336 ms
- **Última atualização (UTC)**: 2026-05-11 15:23 UTC

**Mix de protocolos:** shadowsocks × 57 · trojan × 12 · vless × 70 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 6 · `epodonios` × 8 · `lagzian-mix` × 8 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 59 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
