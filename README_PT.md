...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2467-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-105ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_02:21_UTC-informational)
...
- **RTT mediano**: 105 ms
- **Última atualização (UTC)**: 2026-04-24 02:21 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 14 · vless × 104 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 21 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 75 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
