...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2183-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-403ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_23:20_UTC-informational)
...
- **Ativos em todas as fontes**: 2183
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 403 ms
- **Última atualização (UTC)**: 2026-07-16 23:20 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 75 · vless × 9 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `mahdi0024` × 45 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 29 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 9 · `surfboard-eternity` × 6
