...
![nós](https://img.shields.io/badge/nós-121-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1849-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-351ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_19:39_UTC-informational)
...
- **RTT mediano**: 351 ms
- **Última atualização (UTC)**: 2026-07-06 19:39 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 60 · trojan × 25 · vless × 12 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 10 · `mfuu-clash` × 1 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 1
