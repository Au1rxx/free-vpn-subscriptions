...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2585-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-76ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-16_12:17_UTC-informational)
...
- **RTT mediano**: 76 ms
- **Última atualização (UTC)**: 2026-05-16 12:17 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 15 · vless × 94 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `epodonios` × 10 · `mahdi0024` × 35 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 58 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
