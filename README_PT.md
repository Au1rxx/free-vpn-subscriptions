...
![nós](https://img.shields.io/badge/nós-74-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1948-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-174ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_21:33_UTC-informational)
...
- **RTT mediano**: 174 ms
- **Última atualização (UTC)**: 2026-07-03 21:33 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 21 · vless × 9 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
