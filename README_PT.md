...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1914-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-347ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_20:11_UTC-informational)
...
- **RTT mediano**: 347 ms
- **Última atualização (UTC)**: 2026-07-04 20:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 21 · vless × 10 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 6 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 2
