...
![nós](https://img.shields.io/badge/nós-77-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1959-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-162ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_16:33_UTC-informational)
...
- **RTT mediano**: 162 ms
- **Última atualização (UTC)**: 2026-07-03 16:33 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 21 · vless × 16 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 11 · `ninjastrikers` × 9 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 3
