...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2090-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-118ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_10:27_UTC-informational)
...
- **Ativos em todas as fontes**: 2090
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 118 ms
- **Última atualização (UTC)**: 2026-04-29 10:27 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 4 · vless × 96 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 1 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
