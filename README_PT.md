...
![nós](https://img.shields.io/badge/nós-84-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2253-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-168ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_07:21_UTC-informational)
...
- **RTT mediano**: 168 ms
- **Última atualização (UTC)**: 2026-06-07 07:21 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 20 · vless × 12 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 1
