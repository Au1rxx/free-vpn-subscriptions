...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2059-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-340ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_03:27_UTC-informational)
...
- **RTT mediano**: 340 ms
- **Última atualização (UTC)**: 2026-07-02 03:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 37 · vless × 18 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 25 · `pawdroid` × 2 · `surfboard-eternity` × 1
