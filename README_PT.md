...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2189-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-115ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-02_13:39_UTC-informational)
...
- **RTT mediano**: 115 ms
- **Última atualização (UTC)**: 2026-05-02 13:39 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 20 · vless × 84 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 54 · `pawdroid` × 2 · `surfboard-eternity` × 9
