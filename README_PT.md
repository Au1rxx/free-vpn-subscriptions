...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2448-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-127ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_03:11_UTC-informational)
...
- **RTT mediano**: 127 ms
- **Última atualização (UTC)**: 2026-05-11 03:11 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 2 · vless × 98 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 5 · `ninjastrikers` × 72 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 5
