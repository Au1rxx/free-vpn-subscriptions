...
![nós](https://img.shields.io/badge/nós-142-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2067-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-406ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_06:16_UTC-informational)
...
- **Ativos em todas as fontes**: 2067
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 406 ms
- **Última atualização (UTC)**: 2026-06-23 06:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 29 · vless × 61 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 51 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 4
