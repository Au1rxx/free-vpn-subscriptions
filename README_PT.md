...
![nós](https://img.shields.io/badge/nós-110-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1911-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-353ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_02:33_UTC-informational)
...
- **RTT mediano**: 353 ms
- **Última atualização (UTC)**: 2026-06-26 02:33 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 38 · vless × 29 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 24 · `ruking-clash` × 17 · `surfboard-eternity` × 2
