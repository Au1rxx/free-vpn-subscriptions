...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2324-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-104ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_22:20_UTC-informational)
...
- **Ativos em todas as fontes**: 2324
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 104 ms
- **Última atualização (UTC)**: 2026-05-23 22:20 UTC

**Mix de protocolos:** shadowsocks × 44 · trojan × 17 · vless × 63 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 43 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 6
