...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2266-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-386ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_02:16_UTC-informational)
...
- **RTT mediano**: 386 ms
- **Última atualização (UTC)**: 2026-07-18 02:16 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 77 · vless × 18 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 8 · `mahdi0024` × 60 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 6 · `snakem982` × 5 · `surfboard-eternity` × 5
