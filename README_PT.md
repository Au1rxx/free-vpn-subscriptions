...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2017-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-281ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_15:21_UTC-informational)
...
- **RTT mediano**: 281 ms
- **Última atualização (UTC)**: 2026-06-26 15:21 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 33 · vless × 17 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 20 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 5 · `ruking-clash` × 16 · `surfboard-eternity` × 2
