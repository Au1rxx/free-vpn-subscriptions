...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2418-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-225ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_14:23_UTC-informational)
...
- **Ativos em todas as fontes**: 2418
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 225 ms
- **Última atualização (UTC)**: 2026-05-10 14:23 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 16 · vless × 83 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 60 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 3 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
