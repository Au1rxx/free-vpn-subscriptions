...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1902-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-325ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_19:33_UTC-informational)
...
- **RTT mediano**: 325 ms
- **Última atualização (UTC)**: 2026-05-11 19:33 UTC

**Mix de protocolos:** shadowsocks × 60 · trojan × 13 · vless × 66 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 6 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 56 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 13
