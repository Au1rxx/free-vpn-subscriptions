...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2213-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-97ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_12:37_UTC-informational)
...
- **RTT mediano**: 97 ms
- **Última atualização (UTC)**: 2026-04-26 12:37 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 16 · vless × 98 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 3 · `surfboard-eternity` × 8
