...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2245-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-84ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_08:17_UTC-informational)
...
- **RTT mediano**: 84 ms
- **Última atualização (UTC)**: 2026-05-03 08:17 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 12 · vless × 102 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 64 · `pawdroid` × 2 · `surfboard-eternity` × 6
