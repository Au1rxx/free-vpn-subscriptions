...
![nós](https://img.shields.io/badge/nós-135-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1912-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-657ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_08:19_UTC-informational)
...
- **Ativos em todas as fontes**: 1912
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 657 ms
- **Última atualização (UTC)**: 2026-06-17 08:19 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 28 · vless × 15 · vmess × 53

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 56 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 3
