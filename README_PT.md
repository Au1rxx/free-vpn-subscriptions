...
![nós](https://img.shields.io/badge/nós-128-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2609-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-384ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_22:13_UTC-informational)
...
- **RTT mediano**: 384 ms
- **Última atualização (UTC)**: 2026-04-22 22:13 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 20 · vless × 66 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
