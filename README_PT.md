...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2532-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-113ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_08:16_UTC-informational)
...
- **Ativos em todas as fontes**: 2532
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 113 ms
- **Última atualização (UTC)**: 2026-04-25 08:16 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 17 · vless × 96 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 68 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
