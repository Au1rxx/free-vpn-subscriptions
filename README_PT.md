...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2373-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-120ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_17:19_UTC-informational)
...
- **Ativos em todas as fontes**: 2373
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 120 ms
- **Última atualização (UTC)**: 2026-05-12 17:19 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 14 · vless × 84 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 41 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
