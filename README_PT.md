...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2209-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-198ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_19:22_UTC-informational)
...
- **RTT mediano**: 198 ms
- **Última atualização (UTC)**: 2026-04-30 19:22 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 20 · vless × 73 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 50 · `surfboard-eternity` × 8
