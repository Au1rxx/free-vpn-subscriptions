...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1940-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-307ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_21:11_UTC-informational)
...
- **RTT mediano**: 307 ms
- **Última atualização (UTC)**: 2026-06-27 21:11 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 37 · vless × 20 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 22 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 4
