...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1617-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-372ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_05:13_UTC-informational)
...
- **Ativos em todas as fontes**: 1617
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 372 ms
- **Última atualização (UTC)**: 2026-07-15 05:13 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 96 · trojan × 26 · vless × 17 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `mahdi0024` × 11 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 2
