...
![nós](https://img.shields.io/badge/nós-123-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1793-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-376ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_14:26_UTC-informational)
...
- **RTT mediano**: 376 ms
- **Última atualização (UTC)**: 2026-07-07 14:26 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 63 · trojan × 28 · vless × 9 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `mahdi0024` × 26 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 7 · `ruking-clash` × 1 · `surfboard-eternity` × 3
