...
![nós](https://img.shields.io/badge/nós-121-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1911-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-338ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_10:32_UTC-informational)
...
- **RTT mediano**: 338 ms
- **Última atualização (UTC)**: 2026-07-06 10:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 48 · trojan × 30 · vless × 14 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 6
