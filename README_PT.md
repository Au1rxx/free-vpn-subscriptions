...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2299-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-399ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_09:27_UTC-informational)
...
- **Ativos em todas as fontes**: 2299
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 399 ms
- **Última atualização (UTC)**: 2026-07-18 09:27 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 103 · vless × 9 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `mahdi0024` × 61 · `mahdibland-aggregator` × 31 · `mahdibland-shadowsocks` × 35 · `matin-v2ray` × 2 · `ninjastrikers` × 3 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
