...
![nós](https://img.shields.io/badge/nós-137-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1712-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-396ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_03:37_UTC-informational)
...
- **RTT mediano**: 396 ms
- **Última atualização (UTC)**: 2026-06-14 03:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 38 · vless × 38 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 24 · `ninjastrikers` × 35 · `pawdroid` × 8 · `ruking-clash` × 21 · `surfboard-eternity` × 3
