...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1941-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-156ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_08:34_UTC-informational)
...
- **RTT mediano**: 156 ms
- **Última atualização (UTC)**: 2026-06-04 08:34 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 44 · vless × 21 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `epodonios` × 23 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 1
