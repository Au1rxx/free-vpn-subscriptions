...
![nós](https://img.shields.io/badge/nós-78-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2128-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-270ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_15:19_UTC-informational)
...
- **RTT mediano**: 270 ms
- **Última atualização (UTC)**: 2026-06-09 15:19 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 15 · vless × 8 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 6
