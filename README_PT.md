...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1850-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-358ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_07:25_UTC-informational)
...
- **Nós selecionados**: 94
- **Ativos em todas as fontes**: 1850
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 358 ms
- **Última atualização (UTC)**: 2026-06-09 07:25 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 46 · trojan × 21 · vless × 16 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 8 · `surfboard-eternity` × 3
