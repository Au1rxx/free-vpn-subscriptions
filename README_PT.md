...
![nós](https://img.shields.io/badge/nós-121-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2011-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-332ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_00:35_UTC-informational)
...
- **Ativos em todas as fontes**: 2011
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 332 ms
- **Última atualização (UTC)**: 2026-07-05 00:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 23 · vless × 17 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 39 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
