...
![nós](https://img.shields.io/badge/nós-138-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2690-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-177ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_23:28_UTC-informational)
...
- **Ativos em todas as fontes**: 2690
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 177 ms
- **Última atualização (UTC)**: 2026-04-24 23:28 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 22 · vless × 77 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 46 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
