...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2188-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-198ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-11_02:23_UTC-informational)
...
- **RTT mediano**: 198 ms
- **Última atualização (UTC)**: 2026-06-11 02:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 31 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 17 · `ninjastrikers` × 33 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 3
