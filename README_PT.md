...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1949-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-262ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_18:31_UTC-informational)
...
- **RTT mediano**: 262 ms
- **Última atualização (UTC)**: 2026-07-06 18:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 19 · vless × 16 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 21 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 8 · `ninjastrikers` × 7 · `pawdroid` × 10 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
