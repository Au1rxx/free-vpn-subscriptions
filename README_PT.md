...
![nós](https://img.shields.io/badge/nós-138-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2220-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-156ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-28_17:32_UTC-informational)
...
- **Ativos em todas as fontes**: 2220
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 156 ms
- **Última atualização (UTC)**: 2026-04-28 17:32 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 23 · vless × 76 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
