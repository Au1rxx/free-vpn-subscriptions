...
![nós](https://img.shields.io/badge/nós-120-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1918-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-352ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_01:22_UTC-informational)
...
- **RTT mediano**: 352 ms
- **Última atualização (UTC)**: 2026-07-14 01:22 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 25 · vless × 23 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 7 · `ninjastrikers` × 22 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 5
