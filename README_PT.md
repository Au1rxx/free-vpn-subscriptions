...
![nós](https://img.shields.io/badge/nós-138-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1611-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-420ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_18:13_UTC-informational)
...
- **RTT mediano**: 420 ms
- **Última atualização (UTC)**: 2026-06-14 18:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 72 · trojan × 31 · vless × 23 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 4
