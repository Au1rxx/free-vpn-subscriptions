...
![nós](https://img.shields.io/badge/nós-128-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2544-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-472ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_06:37_UTC-informational)
...
- **Ativos em todas as fontes**: 2544
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 472 ms
- **Última atualização (UTC)**: 2026-06-19 06:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 23 · vless × 55 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 34 · `snakem982` × 5 · `surfboard-eternity` × 1
