...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2361-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-95ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-25_01:09_UTC-informational)
...
- **RTT mediano**: 95 ms
- **Última atualização (UTC)**: 2026-05-25 01:09 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 2 · vless × 81 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 48 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 66 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 3
