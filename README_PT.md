...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2201-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-158ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_15:29_UTC-informational)
...
- **Ativos em todas as fontes**: 2201
- **RTT do nó mais rápido**: 39 ms
- **RTT mediano**: 158 ms
- **Última atualização (UTC)**: 2026-04-30 15:29 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 19 · vless × 81 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
