...
![nós](https://img.shields.io/badge/nós-124-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2054-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-238ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_18:20_UTC-informational)
...
- **RTT mediano**: 238 ms
- **Última atualização (UTC)**: 2026-07-12 18:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 68 · trojan × 13 · vless × 27 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 5 · `mfuu-clash` × 6 · `ninjastrikers` × 8 · `pawdroid` × 12 · `ruking-clash` × 1 · `snakem982` × 6 · `surfboard-eternity` × 3
