...
![nós](https://img.shields.io/badge/nós-134-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1707-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-379ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_21:28_UTC-informational)
...
- **Ativos em todas as fontes**: 1707
- **RTT do nó mais rápido**: 38 ms
- **RTT mediano**: 379 ms
- **Última atualização (UTC)**: 2026-07-10 21:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 86 · trojan × 20 · vless × 14 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 22 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 5 · `snakem982` × 4 · `surfboard-eternity` × 7
