...
![nós](https://img.shields.io/badge/nós-73-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1948-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-164ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_10:25_UTC-informational)
...
- **RTT mediano**: 164 ms
- **Última atualização (UTC)**: 2026-07-03 10:25 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 21 · vless × 6 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
