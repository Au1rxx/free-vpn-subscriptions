...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2085-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-309ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_23:11_UTC-informational)
...
- **Nós selecionados**: 96
- **Ativos em todas as fontes**: 2085
- **RTT do nó mais rápido**: 25 ms
- **RTT mediano**: 309 ms
- **Última atualização (UTC)**: 2026-06-10 23:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 19 · vless × 11 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 3
