...
![nós](https://img.shields.io/badge/nós-103-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1802-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-396ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_14:24_UTC-informational)
...
- **Ativos em todas as fontes**: 1802
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 396 ms
- **Última atualização (UTC)**: 2026-06-30 14:24 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 43 · vless × 11 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 17 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 13 · `surfboard-eternity` × 5
