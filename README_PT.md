...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2171-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-402ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_12:38_UTC-informational)
...
- **Ativos em todas as fontes**: 2171
- **RTT do nó mais rápido**: 23 ms
- **RTT mediano**: 402 ms
- **Última atualização (UTC)**: 2026-07-17 12:38 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 87 · vless × 11 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `mahdi0024` × 52 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 30 · `matin-v2ray` × 6 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 9 · `surfboard-eternity` × 4
