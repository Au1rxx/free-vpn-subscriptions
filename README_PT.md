...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1899-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-102ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-05_00:10_UTC-informational)
...
- **RTT mediano**: 102 ms
- **Última atualização (UTC)**: 2026-06-05 00:10 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 32 · vless × 39 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `epodonios` × 28 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 30 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6
