...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1762-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-362ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_18:18_UTC-informational)
...
- **Ativos em todas as fontes**: 1762
- **RTT do nó mais rápido**: 55 ms
- **RTT mediano**: 362 ms
- **Última atualização (UTC)**: 2026-07-07 18:18 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 66 · trojan × 16 · vless × 17 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 5 · `ninjastrikers` × 9 · `pawdroid` × 9 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
