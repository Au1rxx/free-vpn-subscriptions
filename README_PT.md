...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2220-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-173ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_22:27_UTC-informational)
...
- **RTT mediano**: 173 ms
- **Última atualização (UTC)**: 2026-04-30 22:27 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 23 · vless × 79 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 42 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 50 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
