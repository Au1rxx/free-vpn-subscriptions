...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1956-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-300ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-13_00:25_UTC-informational)
...
- **RTT mediano**: 300 ms
- **Última atualização (UTC)**: 2026-06-13 00:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 24 · vless × 30 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 35 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 6
