...
![nós](https://img.shields.io/badge/nós-90-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1947-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-280ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_20:34_UTC-informational)
...
- **RTT mediano**: 280 ms
- **Última atualização (UTC)**: 2026-06-26 20:34 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 29 · vless × 14 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `mahdi0024` × 16 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `ruking-clash` × 17 · `surfboard-eternity` × 5
