...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1814-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-314ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_07:33_UTC-informational)
...
- **RTT mediano**: 314 ms
- **Última atualização (UTC)**: 2026-06-08 07:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 16 · vless × 23 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 22 · `pawdroid` × 5 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 5
