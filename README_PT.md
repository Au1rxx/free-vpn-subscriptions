...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1819-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-380ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_10:20_UTC-informational)
...
- **RTT mediano**: 380 ms
- **Última atualização (UTC)**: 2026-07-08 10:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 62 · trojan × 23 · vless × 14 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 16 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 8 · `ruking-clash` × 2 · `surfboard-eternity` × 4
