...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2242-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-235ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_04:29_UTC-informational)
...
- **RTT mediano**: 235 ms
- **Última atualização (UTC)**: 2026-06-29 04:29 UTC

**Mix de protocolos:** shadowsocks × 17 · trojan × 30 · vless × 27 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 8 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 3
