...
![nós](https://img.shields.io/badge/nós-81-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2550-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-101ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_08:34_UTC-informational)
...
- **RTT mediano**: 101 ms
- **Última atualização (UTC)**: 2026-06-02 08:34 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 22 · trojan × 26 · vless × 11 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 6 · `snakem982` × 1
