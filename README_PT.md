...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1830-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-354ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_16:14_UTC-informational)
...
- **Nós selecionados**: 97
- **Ativos em todas as fontes**: 1830
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 354 ms
- **Última atualização (UTC)**: 2026-06-07 16:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 20 · vless × 15 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 22 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
