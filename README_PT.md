...
![nós](https://img.shields.io/badge/nós-117-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1800-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-360ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_11:37_UTC-informational)
...
- **RTT mediano**: 360 ms
- **Última atualização (UTC)**: 2026-07-07 11:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 61 · trojan × 23 · vless × 11 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 1
