...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2142-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-178ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_15:17_UTC-informational)
...
- **RTT mediano**: 178 ms
- **Última atualização (UTC)**: 2026-06-06 15:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 29 · trojan × 29 · vless × 10 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 15 · `mahdi0024` × 35 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 1
