...
![nós](https://img.shields.io/badge/nós-116-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1813-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-372ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_13:34_UTC-informational)
...
- **Ativos em todas as fontes**: 1813
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 372 ms
- **Última atualização (UTC)**: 2026-07-08 13:34 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 71 · trojan × 16 · vless × 14 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 3
