...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2525-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-91ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-15_18:21_UTC-informational)
...
- **RTT mediano**: 91 ms
- **Última atualização (UTC)**: 2026-05-15 18:21 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 12 · vless × 94 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 9 · `ruking-clash` × 7 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
