...
![nós](https://img.shields.io/badge/nós-130-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2514-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-311ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_17:12_UTC-informational)
...
- **Ativos em todas as fontes**: 2514
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 311 ms
- **Última atualização (UTC)**: 2026-04-23 17:12 UTC

**Mix de protocolos:** shadowsocks × 13 · trojan × 24 · vless × 77 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 49 · `pawdroid` × 1 · `snakem982` × 1
