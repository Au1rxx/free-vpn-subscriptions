...
![nós](https://img.shields.io/badge/nós-131-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1700-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-360ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_01:32_UTC-informational)
...
- **RTT mediano**: 360 ms
- **Última atualização (UTC)**: 2026-06-14 01:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 34 · vless × 35 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 17 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 36 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 4
