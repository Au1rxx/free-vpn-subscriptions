...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2344-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-93ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_23:20_UTC-informational)
...
- **RTT mediano**: 93 ms
- **Última atualização (UTC)**: 2026-05-23 23:20 UTC

**Mix de protocolos:** shadowsocks × 45 · trojan × 20 · vless × 60 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 46 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 49 · `pawdroid` × 4 · `surfboard-eternity` × 2 · `vxiaov-clash` × 1
