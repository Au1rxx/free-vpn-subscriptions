...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2122-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-173ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_01:12_UTC-informational)
...
- **RTT mediano**: 173 ms
- **Última atualização (UTC)**: 2026-06-21 01:12 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 28 · vless × 62 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 39 · `mahdi0024` × 26 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 4 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 22 · `snakem982` × 1 · `surfboard-eternity` × 4
