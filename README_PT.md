...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1985-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-170ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_19:22_UTC-informational)
...
- **RTT mediano**: 170 ms
- **Última atualização (UTC)**: 2026-07-03 19:22 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 24 · vless × 10 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 6 · `ninjastrikers` × 10 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
