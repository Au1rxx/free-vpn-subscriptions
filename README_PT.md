...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1980-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-420ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_12:12_UTC-informational)
...
- **Ativos em todas as fontes**: 1980
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 420 ms
- **Última atualização (UTC)**: 2026-06-18 12:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 31 · vless × 31 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 9 · `pawdroid` × 6 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 6
