...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2251-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-441ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_22:29_UTC-informational)
...
- **RTT mediano**: 441 ms
- **Última atualização (UTC)**: 2026-04-21 22:29 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 22 · vless × 84 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 47 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 5
