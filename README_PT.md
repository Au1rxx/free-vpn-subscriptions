...
![nós](https://img.shields.io/badge/nós-90-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1923-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-170ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-03_18:38_UTC-informational)
...
- **RTT mediano**: 170 ms
- **Última atualização (UTC)**: 2026-06-03 18:38 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 37 · vless × 15 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 29 · `mahdi0024` × 12 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 10 · `surfboard-eternity` × 3
