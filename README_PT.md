...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1919-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-346ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_08:12_UTC-informational)
...
- **RTT mediano**: 346 ms
- **Última atualização (UTC)**: 2026-07-14 08:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 19 · vless × 17 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 18 · `pawdroid` × 10 · `ruking-clash` × 1 · `surfboard-eternity` × 1
