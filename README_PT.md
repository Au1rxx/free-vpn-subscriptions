...
![nós](https://img.shields.io/badge/nós-84-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1983-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-175ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_18:14_UTC-informational)
...
- **RTT mediano**: 175 ms
- **Última atualização (UTC)**: 2026-07-03 18:14 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 24 · vless × 14 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 11 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
