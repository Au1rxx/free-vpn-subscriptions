...
![nós](https://img.shields.io/badge/nós-143-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2358-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-109ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-24_22:18_UTC-informational)
...
- **RTT mediano**: 109 ms
- **Última atualização (UTC)**: 2026-05-24 22:18 UTC

**Mix de protocolos:** shadowsocks × 44 · trojan × 18 · vless × 53 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 49 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
