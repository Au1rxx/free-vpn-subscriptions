...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2148-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-327ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_22:19_UTC-informational)
...
- **RTT mediano**: 327 ms
- **Última atualização (UTC)**: 2026-06-09 22:19 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 17 · vless × 11 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 5
