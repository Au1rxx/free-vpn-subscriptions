...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1980-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-276ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_17:31_UTC-informational)
...
- **RTT mediano**: 276 ms
- **Última atualização (UTC)**: 2026-07-04 17:31 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 20 · vless × 11 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 27 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 8 · `ninjastrikers` × 12 · `pawdroid` × 6 · `ruking-clash` × 2 · `surfboard-eternity` × 4
