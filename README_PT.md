...
![nós](https://img.shields.io/badge/nós-122-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2285-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-337ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_03:26_UTC-informational)
...
- **RTT mediano**: 337 ms
- **Última atualização (UTC)**: 2026-06-12 03:26 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 41 · trojan × 44 · vless × 30 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 31 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 7
