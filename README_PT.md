...
![nós](https://img.shields.io/badge/nós-72-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2341-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-110ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_16:33_UTC-informational)
...
- **RTT mediano**: 110 ms
- **Última atualização (UTC)**: 2026-05-31 16:33 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 13 · vless × 8 · vmess × 32

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
