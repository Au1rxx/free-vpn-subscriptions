...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1980-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-396ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_00:12_UTC-informational)
...
- **RTT mediano**: 396 ms
- **Última atualização (UTC)**: 2026-06-24 00:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 32 · vless × 61 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 43 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 27 · `pawdroid` × 7 · `ruking-clash` × 16 · `surfboard-eternity` × 3
