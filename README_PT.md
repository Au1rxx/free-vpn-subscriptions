...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2194-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-109ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_01:36_UTC-informational)
...
- **Ativos em todas as fontes**: 2194
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 109 ms
- **Última atualização (UTC)**: 2026-05-30 01:36 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 24 · vless × 34 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 34 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 2
