...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-388-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-138ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-19_07:23_UTC-informational)
...
- **Ativos em todas as fontes**: 388
- **RTT do nó mais rápido**: 1 ms
- **RTT mediano**: 138 ms
- **Última atualização (UTC)**: 2026-04-19 07:23 UTC

**Mix de protocolos:** shadowsocks × 101 · trojan × 7 · vmess × 42

**Fontes usadas nesta execução:** `freefq` × 2 · `mahdibland-aggregator` × 64 · `mahdibland-shadowsocks` × 67 · `pawdroid` × 3 · `vxiaov-clash` × 14
