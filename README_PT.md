...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2468-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-125ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_16:12_UTC-informational)
...
- **RTT mediano**: 125 ms
- **Última atualização (UTC)**: 2026-04-27 16:12 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 14 · vless × 98 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 57 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 6
