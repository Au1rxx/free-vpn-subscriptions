...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2545-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-176ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_09:23_UTC-informational)
...
- **Ativos em todas as fontes**: 2545
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 176 ms
- **Última atualização (UTC)**: 2026-04-23 09:23 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 21 · vless × 91 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 75 · `pawdroid` × 1 · `surfboard-eternity` × 5
