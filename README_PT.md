...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1990-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-181ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-08_10:11_UTC-informational)
...
- **RTT mediano**: 181 ms
- **Última atualização (UTC)**: 2026-05-08 10:11 UTC

**Mix de protocolos:** shadowsocks × 60 · trojan × 3 · vless × 81 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 12 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 74 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
