...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2020-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-398ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_10:30_UTC-informational)
...
- **RTT mediano**: 398 ms
- **Última atualização (UTC)**: 2026-07-16 10:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 73 · vless × 22 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `mahdi0024` × 18 · `mahdibland-aggregator` × 34 · `mahdibland-shadowsocks` × 46 · `matin-v2ray` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 11 · `surfboard-eternity` × 3
