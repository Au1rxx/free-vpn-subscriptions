...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1996-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-416ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_11:24_UTC-informational)
...
- **RTT mediano**: 416 ms
- **Última atualização (UTC)**: 2026-06-28 11:24 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 33 · trojan × 36 · vless × 28 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 3
