...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2186-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-117ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_13:16_UTC-informational)
...
- **RTT mediano**: 117 ms
- **Última atualização (UTC)**: 2026-05-01 13:16 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 13 · vless × 81 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `snakem982` × 1 · `surfboard-eternity` × 4
