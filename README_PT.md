...
![nós](https://img.shields.io/badge/nós-127-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2552-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-488ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_12:14_UTC-informational)
...
- **Ativos em todas as fontes**: 2552
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 488 ms
- **Última atualização (UTC)**: 2026-06-19 12:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 34 · trojan × 26 · vless × 46 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `epodonios` × 22 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 4 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 6 · `surfboard-eternity` × 2
