...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2227-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-69ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-19_07:10_UTC-informational)
...
- **RTT mediano**: 69 ms
- **Última atualização (UTC)**: 2026-05-19 07:10 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 19 · vless × 91 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 71 · `pawdroid` × 10 · `snakem982` × 1 · `surfboard-eternity` × 4
