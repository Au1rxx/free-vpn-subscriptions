...
![nós](https://img.shields.io/badge/nós-143-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2256-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-277ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_15:31_UTC-informational)
...
- **RTT mediano**: 277 ms
- **Última atualização (UTC)**: 2026-05-04 15:31 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 23 · vless × 70 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 58 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 8
