...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2007-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-121ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-07_02:32_UTC-informational)
...
- **Ativos em todas as fontes**: 2007
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 121 ms
- **Última atualização (UTC)**: 2026-05-07 02:32 UTC

**Mix de protocolos:** shadowsocks × 44 · trojan × 5 · vless × 88 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 67 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
