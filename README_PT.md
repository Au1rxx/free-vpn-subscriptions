...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2003-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-177ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_14:20_UTC-informational)
...
- **RTT mediano**: 177 ms
- **Última atualização (UTC)**: 2026-06-04 14:20 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 54 · vless × 19 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 39 · `epodonios` × 29 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 5
