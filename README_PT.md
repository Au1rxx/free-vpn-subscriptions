...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1801-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-360ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_15:20_UTC-informational)
...
- **RTT mediano**: 360 ms
- **Última atualização (UTC)**: 2026-07-07 15:20 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 53 · trojan × 30 · vless × 14 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 5 · `ninjastrikers` × 16 · `pawdroid` × 7 · `ruking-clash` × 1
