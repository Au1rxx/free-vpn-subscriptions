...
![nós](https://img.shields.io/badge/nós-122-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1991-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-350ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_02:20_UTC-informational)
...
- **Ativos em todas as fontes**: 1991
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 350 ms
- **Última atualização (UTC)**: 2026-06-28 02:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 41 · vless × 33 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 5
