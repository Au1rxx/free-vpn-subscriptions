...
![nós](https://img.shields.io/badge/nós-128-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1796-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-367ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_08:31_UTC-informational)
...
- **RTT mediano**: 367 ms
- **Última atualização (UTC)**: 2026-07-09 08:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 62 · trojan × 23 · vless × 16 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `epodonios` × 15 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 8 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 4
