...
![nós](https://img.shields.io/badge/nós-140-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2308-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-290ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_19:19_UTC-informational)
...
- **Ativos em todas as fontes**: 2308
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 290 ms
- **Última atualização (UTC)**: 2026-04-21 19:19 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 24 · vless × 71 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 37 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 1 · `ruking-clash` × 7 · `snakem982` × 2 · `surfboard-eternity` × 5
