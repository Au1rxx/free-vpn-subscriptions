...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1773-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-332ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_11:36_UTC-informational)
...
- **Nós selecionados**: 82
- **Ativos em todas as fontes**: 1773
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 332 ms
- **Última atualização (UTC)**: 2026-06-08 11:36 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 16 · vless × 11 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 17 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 4
