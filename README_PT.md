...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2465-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-140ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_11:32_UTC-informational)
...
- **Ativos em todas as fontes**: 2465
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 140 ms
- **Última atualização (UTC)**: 2026-05-10 11:32 UTC

**Mix de protocolos:** shadowsocks × 51 · trojan × 4 · vless × 85 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 8
