...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1875-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-221ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_17:26_UTC-informational)
...
- **RTT mediano**: 221 ms
- **Última atualização (UTC)**: 2026-05-11 17:26 UTC

**Mix de protocolos:** shadowsocks × 65 · trojan × 4 · vless × 69 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 9 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 5 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 57 · `pawdroid` × 4 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
