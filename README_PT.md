...
![nós](https://img.shields.io/badge/nós-148-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2387-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-368ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-08_22:27_UTC-informational)
...
- **RTT mediano**: 368 ms
- **Última atualização (UTC)**: 2026-05-08 22:27 UTC

**Mix de protocolos:** shadowsocks × 51 · trojan × 23 · vless × 64 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 8
