...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2438-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-115ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_05:26_UTC-informational)
...
- **RTT mediano**: 115 ms
- **Última atualização (UTC)**: 2026-05-11 05:26 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 5 · vless × 96 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 74 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 7
