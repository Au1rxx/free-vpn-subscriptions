...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2463-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-87ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_07:33_UTC-informational)
...
- **RTT mediano**: 87 ms
- **Última atualização (UTC)**: 2026-04-24 07:33 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 9 · vless × 103 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 72 · `pawdroid` × 2 · `snakem982` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
