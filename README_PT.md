...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2098-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-193ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_07:32_UTC-informational)
...
- **RTT mediano**: 193 ms
- **Última atualização (UTC)**: 2026-06-06 07:32 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 26 · vless × 19 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 22 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `surfboard-eternity` × 4
