...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1883-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-212ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_16:38_UTC-informational)
...
- **Ativos em todas as fontes**: 1883
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 212 ms
- **Última atualização (UTC)**: 2026-05-11 16:38 UTC

**Mix de protocolos:** shadowsocks × 65 · trojan × 7 · vless × 65 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 54 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
