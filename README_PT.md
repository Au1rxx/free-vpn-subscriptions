...
![nós](https://img.shields.io/badge/nós-135-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2550-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-287ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_20:29_UTC-informational)
...
- **RTT mediano**: 287 ms
- **Última atualização (UTC)**: 2026-04-22 20:29 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 22 · vless × 70 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `epodonios` × 11 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 50 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
