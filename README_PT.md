...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1965-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-488ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_14:22_UTC-informational)
...
- **Ativos em todas as fontes**: 1965
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 488 ms
- **Última atualização (UTC)**: 2026-06-18 14:22 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 29 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 25 · `snakem982` × 7 · `surfboard-eternity` × 2
