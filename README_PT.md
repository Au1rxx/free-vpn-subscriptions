...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1876-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-299ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_04:14_UTC-informational)
...
- **RTT mediano**: 299 ms
- **Última atualização (UTC)**: 2026-06-09 04:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 46 · trojan × 22 · vless × 25 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 27 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 5
