...
![nós](https://img.shields.io/badge/nós-85-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2101-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-241ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_23:15_UTC-informational)
...
- **RTT mediano**: 241 ms
- **Última atualização (UTC)**: 2026-06-09 23:15 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 18 · vless × 8 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 7
