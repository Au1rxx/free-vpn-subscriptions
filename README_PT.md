...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1884-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-356ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-13_10:09_UTC-informational)
...
- **RTT mediano**: 356 ms
- **Última atualização (UTC)**: 2026-06-13 10:09 UTC

**Mix de protocolos:** shadowsocks × 58 · trojan × 23 · vless × 15 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 7 · `ruking-clash` × 12 · `surfboard-eternity` × 5
