...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2179-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-238ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_12:25_UTC-informational)
...
- **RTT mediano**: 238 ms
- **Última atualização (UTC)**: 2026-04-22 12:25 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 21 · vless × 81 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 71 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 7
