...
![nós](https://img.shields.io/badge/nós-147-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2074-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-199ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_17:21_UTC-informational)
...
- **RTT mediano**: 199 ms
- **Última atualização (UTC)**: 2026-04-29 17:21 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 18 · vless × 76 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 7 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 7 · `ninjastrikers` × 53 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
