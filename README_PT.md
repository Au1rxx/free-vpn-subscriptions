...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1771-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-369ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_15:19_UTC-informational)
...
- **Nós selecionados**: 93
- **Ativos em todas as fontes**: 1771
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 369 ms
- **Última atualização (UTC)**: 2026-06-08 15:19 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 46 · trojan × 19 · vless × 21 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 17 · `ninjastrikers` × 16 · `pawdroid` × 7 · `ruking-clash` × 6 · `surfboard-eternity` × 5
