...
![nós](https://img.shields.io/badge/nós-123-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1764-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-377ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_11:20_UTC-informational)
...
- **Ativos em todas as fontes**: 1764
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 377 ms
- **Última atualização (UTC)**: 2026-07-09 11:20 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 64 · trojan × 21 · vless × 13 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
