...
![nós](https://img.shields.io/badge/nós-127-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1992-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-270ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_23:32_UTC-informational)
...
- **Ativos em todas as fontes**: 1992
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 270 ms
- **Última atualização (UTC)**: 2026-07-12 23:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 69 · trojan × 22 · vless × 20 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 30 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 7 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 7
