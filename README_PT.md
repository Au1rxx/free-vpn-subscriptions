...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2038-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-168ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_14:33_UTC-informational)
...
- **RTT mediano**: 168 ms
- **Última atualização (UTC)**: 2026-04-29 14:33 UTC

**Mix de protocolos:** shadowsocks × 45 · trojan × 9 · vless × 88 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 40 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 52 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
