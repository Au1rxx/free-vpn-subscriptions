...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1956-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-341ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_11:09_UTC-informational)
...
- **RTT mediano**: 341 ms
- **Última atualização (UTC)**: 2026-07-12 11:09 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 18 · vless × 14 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 4 · `mfuu-clash` × 5 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4
