...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2253-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-246ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-20_17:20_UTC-informational)
...
- **RTT mediano**: 246 ms
- **Última atualização (UTC)**: 2026-04-20 17:20 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 13 · vless × 96 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 51 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 7
