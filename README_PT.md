...
![nós](https://img.shields.io/badge/nós-71-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2072-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-163ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_09:27_UTC-informational)
...
- **RTT mediano**: 163 ms
- **Última atualização (UTC)**: 2026-05-29 09:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 26 · trojan × 25 · vless × 10 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 3 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 10 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 1
