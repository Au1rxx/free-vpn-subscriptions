...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2240-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-472ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_11:15_UTC-informational)
...
- **RTT mediano**: 472 ms
- **Última atualização (UTC)**: 2026-06-12 11:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 38 · vless × 11 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 30 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `ruking-clash` × 5 · `surfboard-eternity` × 4
