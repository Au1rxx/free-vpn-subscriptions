...
![nós](https://img.shields.io/badge/nós-145-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2350-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-92ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-24_23:31_UTC-informational)
...
- **Ativos em todas as fontes**: 2350
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 92 ms
- **Última atualização (UTC)**: 2026-05-24 23:31 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 19 · vless × 56 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 47 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 47 · `pawdroid` × 5 · `ruking-clash` × 4 · `surfboard-eternity` × 8
