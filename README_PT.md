...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2290-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-398ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_17:34_UTC-informational)
...
- **RTT mediano**: 398 ms
- **Última atualização (UTC)**: 2026-07-17 17:34 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 96 · vless × 17 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 3 · `mahdi0024` × 63 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 2 · `ninjastrikers` × 4 · `pawdroid` × 9 · `ruking-clash` × 3 · `snakem982` × 15 · `surfboard-eternity` × 7
