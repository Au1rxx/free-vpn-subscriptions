...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2163-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-115ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_07:10_UTC-informational)
...
- **RTT mediano**: 115 ms
- **Última atualização (UTC)**: 2026-04-21 07:10 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 1 · vless × 111 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 50 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 59 · `ruking-clash` × 11 · `surfboard-eternity` × 7
