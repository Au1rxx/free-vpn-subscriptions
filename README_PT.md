...
![nós](https://img.shields.io/badge/nós-136-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1982-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-260ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_01:29_UTC-informational)
...
- **RTT mediano**: 260 ms
- **Última atualização (UTC)**: 2026-07-13 01:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 73 · trojan × 19 · vless × 27 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `mahdi0024` × 29 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 7 · `ninjastrikers` × 23 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 5
