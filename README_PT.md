...
![nós](https://img.shields.io/badge/nós-101-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2023-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-181ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_03:09_UTC-informational)
...
- **RTT mediano**: 181 ms
- **Última atualização (UTC)**: 2026-06-27 03:09 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 35 · vless × 26 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 19 · `surfboard-eternity` × 4
