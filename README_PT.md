...
![nós](https://img.shields.io/badge/nós-127-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1840-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-347ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_05:24_UTC-informational)
...
- **Ativos em todas as fontes**: 1840
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 347 ms
- **Última atualização (UTC)**: 2026-07-07 05:24 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 53 · trojan × 25 · vless × 26 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 9 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 4
