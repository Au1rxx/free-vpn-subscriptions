...
![nós](https://img.shields.io/badge/nós-146-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2267-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-186ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-05_12:10_UTC-informational)
...
- **Ativos em todas as fontes**: 2267
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 186 ms
- **Última atualização (UTC)**: 2026-05-05 12:10 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 29 · vless × 70 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
