...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2259-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-150ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_07:28_UTC-informational)
...
- **RTT mediano**: 150 ms
- **Última atualização (UTC)**: 2026-04-22 07:28 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 4 · vless × 103 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 39 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 11 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 66 · `ruking-clash` × 4 · `surfboard-eternity` × 6
