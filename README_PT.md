...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2010-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-149ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-08_03:33_UTC-informational)
...
- **RTT mediano**: 149 ms
- **Última atualização (UTC)**: 2026-05-08 03:33 UTC

**Mix de protocolos:** shadowsocks × 51 · trojan × 6 · vless × 84 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 80 · `snakem982` × 1 · `surfboard-eternity` × 6
