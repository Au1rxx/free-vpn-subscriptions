...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1728-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-362ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_17:14_UTC-informational)
...
- **Nós selecionados**: 95
- **Ativos em todas as fontes**: 1728
- **RTT do nó mais rápido**: 40 ms
- **RTT mediano**: 362 ms
- **Última atualização (UTC)**: 2026-07-10 17:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 19 · vless × 11 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
