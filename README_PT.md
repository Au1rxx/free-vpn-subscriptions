...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2145-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-90ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-26_00:33_UTC-informational)
...
- **RTT mediano**: 90 ms
- **Última atualização (UTC)**: 2026-05-26 00:33 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 20 · vless × 85 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `mahdi0024` × 12 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 73 · `pawdroid` × 2 · `ruking-clash` × 12 · `snakem982` × 1 · `surfboard-eternity` × 2
