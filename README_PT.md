...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1931-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-412ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_18:37_UTC-informational)
...
- **RTT mediano**: 412 ms
- **Última atualização (UTC)**: 2026-06-25 18:37 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 40 · vless × 21 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 23 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 20 · `surfboard-eternity` × 3
