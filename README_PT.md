...
![nós](https://img.shields.io/badge/nós-143-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2607-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-164ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_17:40_UTC-informational)
...
- **Ativos em todas as fontes**: 2607
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 164 ms
- **Última atualização (UTC)**: 2026-04-24 17:40 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 21 · vless × 85 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 34 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 60 · `pawdroid` × 2 · `surfboard-eternity` × 1
