...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2176-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-146ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_10:38_UTC-informational)
...
- **RTT mediano**: 146 ms
- **Última atualização (UTC)**: 2026-04-21 10:38 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 4 · vless × 102 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 50 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 6
