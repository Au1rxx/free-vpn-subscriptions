...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2162-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-92ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-26_03:30_UTC-informational)
...
- **RTT mediano**: 92 ms
- **Última atualização (UTC)**: 2026-05-26 03:30 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 15 · vless × 87 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 73 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 5
