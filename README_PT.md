...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2466-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-79ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-25_11:23_UTC-informational)
...
- **RTT mediano**: 79 ms
- **Última atualização (UTC)**: 2026-05-25 11:23 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 17 · vless × 64 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 50 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 6 · `ruking-clash` × 6 · `surfboard-eternity` × 4
