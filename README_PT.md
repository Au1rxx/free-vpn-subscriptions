...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1924-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-361ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_11:23_UTC-informational)
...
- **RTT mediano**: 361 ms
- **Última atualização (UTC)**: 2026-07-13 11:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 17 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 26 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 6 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
