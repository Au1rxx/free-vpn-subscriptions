...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2234-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-150ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_03:34_UTC-informational)
...
- **RTT mediano**: 150 ms
- **Última atualização (UTC)**: 2026-04-22 03:34 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 4 · vless × 101 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 39 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `pawdroid` × 1 · `ruking-clash` × 5 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
