...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2080-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-299ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_00:22_UTC-informational)
...
- **Ativos em todas as fontes**: 2080
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 299 ms
- **Última atualização (UTC)**: 2026-07-02 00:22 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 30 · vless × 19 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 26 · `pawdroid` × 2 · `surfboard-eternity` × 2
