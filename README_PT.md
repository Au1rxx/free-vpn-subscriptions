...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1973-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-251ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_16:39_UTC-informational)
...
- **RTT mediano**: 251 ms
- **Última atualização (UTC)**: 2026-07-05 16:39 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 36 · trojan × 25 · vless × 8 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 6 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 2
