...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2430-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-70ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-03_09:17_UTC-informational)
...
- **RTT mediano**: 70 ms
- **Última atualização (UTC)**: 2026-06-03 09:17 UTC

**Mix de protocolos:** shadowsocks × 13 · trojan × 38 · vless × 5 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `surfboard-eternity` × 2
