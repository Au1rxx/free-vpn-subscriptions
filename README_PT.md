...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2166-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-366ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-19_07:20_UTC-informational)
...
- **RTT mediano**: 366 ms
- **Última atualização (UTC)**: 2026-07-19 07:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 46 · trojan × 77 · vless × 16 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 62 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 10
