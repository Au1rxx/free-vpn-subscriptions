...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2059-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-229ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_19:10_UTC-informational)
...
- **RTT mediano**: 229 ms
- **Última atualização (UTC)**: 2026-07-12 19:10 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 67 · trojan × 9 · vless × 24 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 37 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 8 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3
