...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2264-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-186ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_23:13_UTC-informational)
...
- **RTT mediano**: 186 ms
- **Última atualização (UTC)**: 2026-04-30 23:13 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 23 · vless × 81 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 43 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 52 · `surfboard-eternity` × 7
