...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2224-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-161ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_01:38_UTC-informational)
...
- **RTT mediano**: 161 ms
- **Última atualização (UTC)**: 2026-06-07 01:38 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 23 · vless × 29 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 39 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 32 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 2
