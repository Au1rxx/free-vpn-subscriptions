...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2393-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-493ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_20:20_UTC-informational)
...
- **RTT mediano**: 493 ms
- **Última atualização (UTC)**: 2026-06-18 20:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 24 · vless × 38 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 35 · `snakem982` × 7 · `surfboard-eternity` × 5
