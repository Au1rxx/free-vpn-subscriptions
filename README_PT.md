...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2455-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-169ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_15:26_UTC-informational)
...
- **RTT mediano**: 169 ms
- **Última atualização (UTC)**: 2026-04-27 15:26 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 22 · vless × 87 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 19 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
