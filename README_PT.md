...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2425-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-107ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-09_05:21_UTC-informational)
...
- **RTT mediano**: 107 ms
- **Última atualização (UTC)**: 2026-05-09 05:21 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 15 · vless × 89 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 75 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 5
