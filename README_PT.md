...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2170-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-143ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_00:24_UTC-informational)
...
- **RTT mediano**: 143 ms
- **Última atualização (UTC)**: 2026-06-06 00:24 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 26 · vless × 32 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 30 · `surfboard-eternity` × 6
