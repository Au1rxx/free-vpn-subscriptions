...
![nós](https://img.shields.io/badge/nós-148-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1879-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-396ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_17:34_UTC-informational)
...
- **RTT mediano**: 396 ms
- **Última atualização (UTC)**: 2026-07-15 17:34 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 66 · trojan × 53 · vless × 16 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 28 · `mahdi0024` × 17 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 8 · `ruking-clash` × 1 · `snakem982` × 12 · `surfboard-eternity` × 4
