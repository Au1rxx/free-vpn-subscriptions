...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2105-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-158ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_21:22_UTC-informational)
...
- **Ativos em todas as fontes**: 2105
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 158 ms
- **Última atualização (UTC)**: 2026-05-01 21:22 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 15 · vless × 87 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 34 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
