...
![nós](https://img.shields.io/badge/nós-147-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1747-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-387ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_15:16_UTC-informational)
...
- **Ativos em todas as fontes**: 1747
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 387 ms
- **Última atualização (UTC)**: 2026-07-14 15:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 93 · trojan × 24 · vless × 21 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 34 · `epodonios` × 18 · `mahdi0024` × 9 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 4 · `ninjastrikers` × 19 · `pawdroid` × 10 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
