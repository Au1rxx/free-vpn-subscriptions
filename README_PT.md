...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2287-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-156ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_18:12_UTC-informational)
...
- **RTT mediano**: 156 ms
- **Última atualização (UTC)**: 2026-05-30 18:12 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 16 · vless × 9 · vmess × 32

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 6 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
