...
![nós](https://img.shields.io/badge/nós-134-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1890-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-390ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_14:31_UTC-informational)
...
- **Ativos em todas as fontes**: 1890
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 390 ms
- **Última atualização (UTC)**: 2026-07-13 14:31 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 74 · trojan × 23 · vless × 21 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `epodonios` × 22 · `mahdi0024` × 28 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 6 · `ninjastrikers` × 18 · `pawdroid` × 5 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
