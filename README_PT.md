...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2000-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-344ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_19:33_UTC-informational)
...
- **RTT mediano**: 344 ms
- **Última atualização (UTC)**: 2026-06-29 19:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 34 · trojan × 31 · vless × 5 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 3
