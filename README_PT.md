...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2574-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-130ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_18:37_UTC-informational)
...
- **RTT mediano**: 130 ms
- **Última atualização (UTC)**: 2026-04-26 18:37 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 13 · vless × 85 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 50 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
