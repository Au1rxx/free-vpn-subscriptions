...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2595-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-146ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_01:22_UTC-informational)
...
- **Ativos em todas as fontes**: 2595
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 146 ms
- **Última atualização (UTC)**: 2026-04-23 01:22 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 13 · vless × 99 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 76 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 7
