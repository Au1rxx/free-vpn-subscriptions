...
![nós](https://img.shields.io/badge/nós-72-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2517-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-113ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_22:34_UTC-informational)
...
- **Nós selecionados**: 72
- **Ativos em todas as fontes**: 2517
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 113 ms
- **Última atualização (UTC)**: 2026-06-01 22:34 UTC

**Mix de protocolos:** shadowsocks × 16 · trojan × 31 · vless × 3 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `epodonios` × 13 · `mahdi0024` × 17 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `surfboard-eternity` × 3
