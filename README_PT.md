...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2213-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-153ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_12:19_UTC-informational)
...
- **RTT mediano**: 153 ms
- **Última atualização (UTC)**: 2026-04-30 12:19 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 19 · vless × 87 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 40 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
