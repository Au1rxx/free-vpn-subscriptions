...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1958-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-279ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-07_22:32_UTC-informational)
...
- **RTT mediano**: 279 ms
- **Última atualização (UTC)**: 2026-05-07 22:32 UTC

**Mix de protocolos:** shadowsocks × 53 · trojan × 18 · vless × 69 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 57 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 8
