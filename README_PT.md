...
![nós](https://img.shields.io/badge/nós-137-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1923-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-383ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_14:13_UTC-informational)
...
- **RTT mediano**: 383 ms
- **Última atualização (UTC)**: 2026-07-04 14:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 70 · trojan × 27 · vless × 11 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 41 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 5 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 8
