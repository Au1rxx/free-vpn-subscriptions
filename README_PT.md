...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1857-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-471ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_15:32_UTC-informational)
...
- **RTT mediano**: 471 ms
- **Última atualização (UTC)**: 2026-06-22 15:32 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 31 · vless × 66 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 41 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 2 · `surfboard-eternity` × 3
