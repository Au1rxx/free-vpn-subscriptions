...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2209-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-403ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_07:09_UTC-informational)
...
- **Ativos em todas as fontes**: 2209
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 403 ms
- **Última atualização (UTC)**: 2026-07-17 07:09 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 82 · vless × 13 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 45 · `mahdibland-aggregator` × 33 · `mahdibland-shadowsocks` × 30 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 3
