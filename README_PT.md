...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2522-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-161ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_07:18_UTC-informational)
...
- **Ativos em todas as fontes**: 2522
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 161 ms
- **Última atualização (UTC)**: 2026-04-23 07:18 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 17 · vless × 94 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 20 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 72 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
