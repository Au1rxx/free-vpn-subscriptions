...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1941-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-358ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_20:11_UTC-informational)
...
- **RTT mediano**: 358 ms
- **Última atualização (UTC)**: 2026-06-27 20:11 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 39 · vless × 20 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 5
