...
![nós](https://img.shields.io/badge/nós-75-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2460-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-160ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_12:35_UTC-informational)
...
- **Nós selecionados**: 75
- **Ativos em todas as fontes**: 2460
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 160 ms
- **Última atualização (UTC)**: 2026-06-02 12:35 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 23 · vless × 7 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 3 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
