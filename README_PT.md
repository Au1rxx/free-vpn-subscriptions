...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2626-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-78ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-17_08:34_UTC-informational)
...
- **Ativos em todas as fontes**: 2626
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 78 ms
- **Última atualização (UTC)**: 2026-05-17 08:34 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 6 · vless × 96 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 57 · `pawdroid` × 6 · `ruking-clash` × 5 · `surfboard-eternity` × 4
