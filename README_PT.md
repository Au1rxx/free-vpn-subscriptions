...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2021-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-204ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-07_12:20_UTC-informational)
...
- **RTT mediano**: 204 ms
- **Última atualização (UTC)**: 2026-05-07 12:20 UTC

**Mix de protocolos:** shadowsocks × 46 · trojan × 12 · vless × 83 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 69 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 9
