...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2372-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-76ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_09:37_UTC-informational)
...
- **RTT mediano**: 76 ms
- **Última atualização (UTC)**: 2026-05-23 09:37 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 5 · vless × 101 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 68 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
