...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2582-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-113ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_22:35_UTC-informational)
...
- **RTT mediano**: 113 ms
- **Última atualização (UTC)**: 2026-04-26 22:35 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 11 · vless × 85 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 45 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 47 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
