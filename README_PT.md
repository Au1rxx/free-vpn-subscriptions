...
![nós](https://img.shields.io/badge/nós-138-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2322-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-309ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_20:32_UTC-informational)
...
- **RTT mediano**: 309 ms
- **Última atualização (UTC)**: 2026-04-21 20:32 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 24 · vless × 68 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 37 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
