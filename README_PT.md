...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2364-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-94ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_21:15_UTC-informational)
...
- **RTT mediano**: 94 ms
- **Última atualização (UTC)**: 2026-05-23 21:15 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 22 · vless × 63 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 40 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 4 · `surfboard-eternity` × 4
