...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2592-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-104ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_14:40_UTC-informational)
...
- **RTT mediano**: 104 ms
- **Última atualização (UTC)**: 2026-04-26 14:40 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 4 · vless × 92 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 48 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 55 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
