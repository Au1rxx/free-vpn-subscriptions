...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1781-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-333ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_10:34_UTC-informational)
...
- **RTT mediano**: 333 ms
- **Última atualização (UTC)**: 2026-07-11 10:34 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 18 · vless × 15 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 13 · `mahdi0024` × 7 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 4 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 2
