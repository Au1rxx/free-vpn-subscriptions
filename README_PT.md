...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2341-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-83ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-24_04:21_UTC-informational)
...
- **Ativos em todas as fontes**: 2341
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 83 ms
- **Última atualização (UTC)**: 2026-05-24 04:21 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 1 · vless × 84 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 59 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7
