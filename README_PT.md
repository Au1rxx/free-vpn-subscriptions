...
![nós](https://img.shields.io/badge/nós-68-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1993-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-169ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_12:25_UTC-informational)
...
- **RTT mediano**: 169 ms
- **Última atualização (UTC)**: 2026-07-04 12:25 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 21 · vless × 8 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 13 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 2
