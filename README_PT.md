...
![nós](https://img.shields.io/badge/nós-146-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2348-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-99ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-24_18:24_UTC-informational)
...
- **RTT mediano**: 99 ms
- **Última atualização (UTC)**: 2026-05-24 18:24 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 19 · vless × 60 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 46 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 54 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
