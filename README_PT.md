...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2148-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-158ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_03:10_UTC-informational)
...
- **RTT mediano**: 158 ms
- **Última atualização (UTC)**: 2026-06-06 03:10 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 27 · vless × 31 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 26 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 30 · `surfboard-eternity` × 1
