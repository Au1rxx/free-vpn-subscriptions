...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2642-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-84ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_06:30_UTC-informational)
...
- **Ativos em todas as fontes**: 2642
- **RTT do nó mais rápido**: 23 ms
- **RTT mediano**: 84 ms
- **Última atualização (UTC)**: 2026-04-25 06:30 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 8 · vless × 108 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 68 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
