...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2705-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-87ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-18_02:39_UTC-informational)
...
- **Ativos em todas as fontes**: 2705
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 87 ms
- **Última atualização (UTC)**: 2026-05-18 02:39 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 4 · vless × 95 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 7 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 61 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 4
