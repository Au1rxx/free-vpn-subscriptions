...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2233-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-117ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_02:37_UTC-informational)
...
- **RTT mediano**: 117 ms
- **Última atualização (UTC)**: 2026-04-21 02:37 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 3 · vless × 109 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 49 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 1 · `ruking-clash` × 8 · `surfboard-eternity` × 5
