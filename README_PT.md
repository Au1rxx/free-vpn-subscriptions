...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2080-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-356ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_22:27_UTC-informational)
...
- **RTT mediano**: 356 ms
- **Última atualização (UTC)**: 2026-07-01 22:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 23 · vless × 9 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 1 · `surfboard-eternity` × 2
