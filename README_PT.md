...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1910-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-354ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_03:30_UTC-informational)
...
- **RTT mediano**: 354 ms
- **Última atualização (UTC)**: 2026-07-14 03:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 24 · vless × 27 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 29 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 6 · `ninjastrikers` × 22 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 2
