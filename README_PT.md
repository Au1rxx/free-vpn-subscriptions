...
![nós](https://img.shields.io/badge/nós-137-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1812-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-369ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_07:30_UTC-informational)
...
- **RTT mediano**: 369 ms
- **Última atualização (UTC)**: 2026-07-08 07:30 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 74 · trojan × 23 · vless × 24 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 18 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 4 · `ninjastrikers` × 23 · `pawdroid` × 10 · `ruking-clash` × 2 · `surfboard-eternity` × 4
