...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2595-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-104ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-14_21:16_UTC-informational)
...
- **RTT mediano**: 104 ms
- **Última atualização (UTC)**: 2026-05-14 21:16 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 23 · vless × 84 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 7 · `ninjastrikers` × 52 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 6
