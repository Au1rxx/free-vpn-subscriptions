...
![nós](https://img.shields.io/badge/nós-139-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1592-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-403ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_19:25_UTC-informational)
...
- **Ativos em todas as fontes**: 1592
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 403 ms
- **Última atualização (UTC)**: 2026-07-14 19:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 94 · trojan × 26 · vless × 9 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 20 · `mahdi0024` × 13 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 5 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
