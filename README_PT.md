...
![nós](https://img.shields.io/badge/nós-121-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2117-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-82ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-26_17:35_UTC-informational)
...
- **RTT mediano**: 82 ms
- **Última atualização (UTC)**: 2026-05-26 17:35 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 12 · vless × 70 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 44 · `pawdroid` × 5 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 2
