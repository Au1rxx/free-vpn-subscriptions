...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1916-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-337ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_22:31_UTC-informational)
...
- **RTT mediano**: 337 ms
- **Última atualização (UTC)**: 2026-07-05 22:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 25 · vless × 11 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 10 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 4
