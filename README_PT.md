...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1967-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-349ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_15:23_UTC-informational)
...
- **RTT mediano**: 349 ms
- **Última atualização (UTC)**: 2026-07-04 15:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 22 · vless × 15 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 36 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 6 · `ninjastrikers` × 13 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 1
