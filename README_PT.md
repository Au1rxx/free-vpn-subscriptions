...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2600-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-67ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-20_10:30_UTC-informational)
...
- **RTT mediano**: 67 ms
- **Última atualização (UTC)**: 2026-05-20 10:30 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 12 · vless × 90 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 70 · `pawdroid` × 13 · `ruking-clash` × 1 · `surfboard-eternity` × 7
