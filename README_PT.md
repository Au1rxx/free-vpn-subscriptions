...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2647-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-102ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_02:24_UTC-informational)
...
- **Ativos em todas as fontes**: 2647
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 102 ms
- **Última atualização (UTC)**: 2026-04-25 02:24 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 9 · vless × 106 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 67 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2 · `vxiaov-clash` × 1
