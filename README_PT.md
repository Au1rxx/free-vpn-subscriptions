...
![nós](https://img.shields.io/badge/nós-80-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2323-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-225ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_20:20_UTC-informational)
...
- **Nós selecionados**: 80
- **Ativos em todas as fontes**: 2323
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 225 ms
- **Última atualização (UTC)**: 2026-06-19 20:20 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 25 · vless × 7 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 14 · `surfboard-eternity` × 3
