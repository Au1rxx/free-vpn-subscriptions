...
![nós](https://img.shields.io/badge/nós-131-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2106-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-182ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_22:35_UTC-informational)
...
- **Ativos em todas as fontes**: 2106
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 182 ms
- **Última atualização (UTC)**: 2026-05-03 22:35 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 20 · vless × 72 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `ruking-clash` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
