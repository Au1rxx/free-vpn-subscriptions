...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2202-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-93ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-02_10:39_UTC-informational)
...
- **RTT mediano**: 93 ms
- **Última atualização (UTC)**: 2026-05-02 10:39 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 10 · vless × 91 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 4 · `snakem982` × 1 · `surfboard-eternity` × 10
