...
![nós](https://img.shields.io/badge/nós-80-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2071-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-162ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_08:34_UTC-informational)
...
- **RTT mediano**: 162 ms
- **Última atualização (UTC)**: 2026-05-29 08:34 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 30 · vless × 14 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 3 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 1 · `surfboard-eternity` × 4
