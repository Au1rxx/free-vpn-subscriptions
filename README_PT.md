...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2205-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-160ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_04:34_UTC-informational)
...
- **RTT mediano**: 160 ms
- **Última atualização (UTC)**: 2026-05-30 04:34 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 26 · vless × 19 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
