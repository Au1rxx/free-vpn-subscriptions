...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2166-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-401ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_15:14_UTC-informational)
...
- **RTT mediano**: 401 ms
- **Última atualização (UTC)**: 2026-07-16 15:14 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 75 · vless × 13 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `mahdi0024` × 53 · `mahdibland-aggregator` × 30 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 4 · `ninjastrikers` × 8 · `pawdroid` × 8 · `ruking-clash` × 1 · `snakem982` × 8 · `surfboard-eternity` × 3
