...
![nós](https://img.shields.io/badge/nós-65-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2404-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-152ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_23:16_UTC-informational)
...
- **RTT mediano**: 152 ms
- **Última atualização (UTC)**: 2026-07-02 23:16 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 17 · vless × 5 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 1 · `surfboard-eternity` × 5
