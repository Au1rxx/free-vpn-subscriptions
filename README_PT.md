...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2042-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-186ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_02:27_UTC-informational)
...
- **RTT mediano**: 186 ms
- **Última atualização (UTC)**: 2026-06-27 02:27 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 35 · vless × 26 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 3
