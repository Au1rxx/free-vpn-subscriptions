...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2373-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_14:39_UTC-informational)
...
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-05-23 14:39 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 18 · vless × 66 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 42 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 48 · `pawdroid` × 7 · `surfboard-eternity` × 4
