...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1961-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-143ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_03:12_UTC-informational)
...
- **RTT mediano**: 143 ms
- **Última atualização (UTC)**: 2026-05-12 03:12 UTC

**Mix de protocolos:** shadowsocks × 52 · trojan × 4 · vless × 86 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 9 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 64 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 2
