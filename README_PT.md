...
![nós](https://img.shields.io/badge/nós-149-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1558-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-388ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_17:25_UTC-informational)
...
- **Ativos em todas as fontes**: 1558
- **RTT do nó mais rápido**: 25 ms
- **RTT mediano**: 388 ms
- **Última atualização (UTC)**: 2026-07-07 17:25 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 92 · trojan × 27 · vless × 14 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 26 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 32 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 7 · `ruking-clash` × 1 · `surfboard-eternity` × 3
