...
![nós](https://img.shields.io/badge/nós-80-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2091-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-147ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_02:26_UTC-informational)
...
- **RTT mediano**: 147 ms
- **Última atualização (UTC)**: 2026-07-10 02:26 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 10 · vless × 13 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 4
