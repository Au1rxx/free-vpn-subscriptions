...
![nós](https://img.shields.io/badge/nós-63-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1954-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-275ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_22:19_UTC-informational)
...
- **RTT mediano**: 275 ms
- **Última atualização (UTC)**: 2026-06-30 22:19 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 29 · vless × 6 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `mfuu-clash` × 8 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 5
