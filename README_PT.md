...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2245-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-159ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_12:30_UTC-informational)
...
- **RTT mediano**: 159 ms
- **Última atualização (UTC)**: 2026-05-31 12:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 23 · trojan × 21 · vless × 7 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
