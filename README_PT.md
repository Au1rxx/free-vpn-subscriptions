...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2579-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-136ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_23:39_UTC-informational)
...
- **RTT mediano**: 136 ms
- **Última atualização (UTC)**: 2026-04-26 23:39 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 11 · vless × 87 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 48 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 46 · `pawdroid` × 1 · `surfboard-eternity` × 6
