...
![nós](https://img.shields.io/badge/nós-101-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1900-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-307ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_15:39_UTC-informational)
...
- **RTT mediano**: 307 ms
- **Última atualização (UTC)**: 2026-07-11 15:39 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 14 · vless × 15 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 25 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 3 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 4
