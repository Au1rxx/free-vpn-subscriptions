...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2404-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-168ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_11:10_UTC-informational)
...
- **RTT mediano**: 168 ms
- **Última atualização (UTC)**: 2026-05-11 11:10 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 8 · vless × 84 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 60 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 2
