...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2330-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-167ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_02:22_UTC-informational)
...
- **RTT mediano**: 167 ms
- **Última atualização (UTC)**: 2026-06-10 02:22 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 14 · vless × 28 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 29 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 5
