...
![nós](https://img.shields.io/badge/nós-85-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2232-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-170ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_09:27_UTC-informational)
...
- **RTT mediano**: 170 ms
- **Última atualização (UTC)**: 2026-06-07 09:27 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 19 · vless × 12 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `mahdi0024` × 37 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 2
