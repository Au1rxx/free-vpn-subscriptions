...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2116-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-153ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-02_23:19_UTC-informational)
...
- **RTT mediano**: 153 ms
- **Última atualização (UTC)**: 2026-05-02 23:19 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 21 · vless × 83 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 50 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
