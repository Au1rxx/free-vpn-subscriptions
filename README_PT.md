...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1966-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-180ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-07_13:21_UTC-informational)
...
- **RTT mediano**: 180 ms
- **Última atualização (UTC)**: 2026-05-07 13:21 UTC

**Mix de protocolos:** shadowsocks × 53 · trojan × 6 · vless × 81 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 64 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
