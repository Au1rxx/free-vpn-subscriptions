...
![nós](https://img.shields.io/badge/nós-74-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1982-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-180ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_15:35_UTC-informational)
...
- **RTT mediano**: 180 ms
- **Última atualização (UTC)**: 2026-07-03 15:35 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 23 · vless × 6 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
