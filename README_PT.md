...
![nós](https://img.shields.io/badge/nós-85-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2269-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-319ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_14:15_UTC-informational)
...
- **RTT mediano**: 319 ms
- **Última atualização (UTC)**: 2026-07-02 14:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 22 · vless × 17 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 11 · `ninjastrikers` × 14 · `pawdroid` × 5 · `surfboard-eternity` × 1
