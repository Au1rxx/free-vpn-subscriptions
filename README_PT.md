...
![nós](https://img.shields.io/badge/nós-73-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2358-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-158ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_03:14_UTC-informational)
...
- **RTT mediano**: 158 ms
- **Última atualização (UTC)**: 2026-07-03 03:14 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 18 · vless × 10 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 1 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 18 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
