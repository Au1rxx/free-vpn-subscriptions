...
![nós](https://img.shields.io/badge/nós-84-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2114-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-137ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_05:12_UTC-informational)
...
- **RTT mediano**: 137 ms
- **Última atualização (UTC)**: 2026-07-10 05:12 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 10 · vless × 19 · vmess × 32

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 41 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 3 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 3
