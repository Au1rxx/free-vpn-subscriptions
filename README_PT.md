...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1905-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-356ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_06:10_UTC-informational)
...
- **RTT mediano**: 356 ms
- **Última atualização (UTC)**: 2026-07-14 06:10 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 20 · vless × 18 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 4 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 5
