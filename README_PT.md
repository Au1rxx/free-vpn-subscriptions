...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2338-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-396ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_00:19_UTC-informational)
...
- **RTT mediano**: 396 ms
- **Última atualização (UTC)**: 2026-07-18 00:19 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 90 · vless × 15 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 6 · `mahdi0024` × 58 · `mahdibland-aggregator` × 31 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 2 · `snakem982` × 11 · `surfboard-eternity` × 4
