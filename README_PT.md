...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1620-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-381ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_22:17_UTC-informational)
...
- **Ativos em todas as fontes**: 1620
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 381 ms
- **Última atualização (UTC)**: 2026-07-14 22:17 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 99 · trojan × 29 · vless × 13 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `mahdi0024` × 12 · `mahdibland-aggregator` × 32 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 6 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
