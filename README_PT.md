...
![nós](https://img.shields.io/badge/nós-101-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2314-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-183ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_01:14_UTC-informational)
...
- **RTT mediano**: 183 ms
- **Última atualização (UTC)**: 2026-06-20 01:14 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 26 · vless × 18 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 11 · `mahdi0024` × 24 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 22 · `pawdroid` × 1 · `ruking-clash` × 18 · `surfboard-eternity` × 6
