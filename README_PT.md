...
![nós](https://img.shields.io/badge/nós-66-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2194-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-361ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-05_15:36_UTC-informational)
...
- **RTT mediano**: 361 ms
- **Última atualização (UTC)**: 2026-06-05 15:36 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 24 · vless × 13 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 20 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 10 · `pawdroid` × 3 · `surfboard-eternity` × 2
