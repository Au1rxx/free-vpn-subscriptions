...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2364-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-92ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_15:25_UTC-informational)
...
- **RTT mediano**: 92 ms
- **Última atualização (UTC)**: 2026-05-23 15:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 22 · vless × 71 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `surfboard-eternity` × 7
