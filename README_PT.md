...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2290-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-166ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_09:11_UTC-informational)
...
- **RTT mediano**: 166 ms
- **Última atualização (UTC)**: 2026-05-31 09:11 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 31 · vless × 11 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 3 · `surfboard-eternity` × 3
