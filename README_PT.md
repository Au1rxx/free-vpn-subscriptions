...
![nós](https://img.shields.io/badge/nós-88-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2089-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-153ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_04:20_UTC-informational)
...
**Mix de protocolos:** shadowsocks × 28 · trojan × 10 · vless × 18 · vmess × 32

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 5 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6
