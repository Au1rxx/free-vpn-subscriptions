...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2033-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-359ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_06:32_UTC-informational)
...
- **RTT mediano**: 359 ms
- **Última atualização (UTC)**: 2026-07-02 06:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 57 · trojan × 40 · vless × 20 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 25 · `pawdroid` × 5 · `surfboard-eternity` × 1
