...
![nós](https://img.shields.io/badge/nós-83-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2366-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-97ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_20:22_UTC-informational)
...
- **RTT mediano**: 97 ms
- **Última atualização (UTC)**: 2026-06-02 20:22 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 26 · vless × 6 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 8 · `snakem982` × 1 · `surfboard-eternity` × 6
