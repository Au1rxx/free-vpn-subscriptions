...
![nós](https://img.shields.io/badge/nós-145-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2520-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-104ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_13:37_UTC-informational)
...
- **RTT mediano**: 104 ms
- **Última atualização (UTC)**: 2026-04-24 13:37 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 20 · vless × 94 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `pawdroid` × 3 · `surfboard-eternity` × 3
