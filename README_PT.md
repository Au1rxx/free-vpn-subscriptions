...
![nós](https://img.shields.io/badge/nós-107-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1757-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-384ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_12:28_UTC-informational)
...
- **RTT mediano**: 384 ms
- **Última atualização (UTC)**: 2026-06-17 12:28 UTC

**Mix de protocolos:** hysteria2 × 4 · shadowsocks × 43 · trojan × 27 · vless × 21 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 3 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 3
