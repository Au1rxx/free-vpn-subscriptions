...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2165-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-83ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_12:24_UTC-informational)
...
- **Ativos em todas as fontes**: 2165
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 83 ms
- **Última atualização (UTC)**: 2026-05-01 12:24 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 13 · vless × 85 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
