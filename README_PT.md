...
![nós](https://img.shields.io/badge/nós-122-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1914-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-341ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_04:35_UTC-informational)
...
- **RTT mediano**: 341 ms
- **Última atualização (UTC)**: 2026-07-06 04:35 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 49 · trojan × 25 · vless × 15 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 7 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
