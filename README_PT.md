...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1959-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-157ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_06:34_UTC-informational)
...
- **RTT mediano**: 157 ms
- **Última atualização (UTC)**: 2026-05-12 06:34 UTC

**Mix de protocolos:** shadowsocks × 58 · trojan × 3 · vless × 79 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 4 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 74 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
