...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2249-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-169ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-20_14:23_UTC-informational)
...
- **RTT mediano**: 169 ms
- **Última atualização (UTC)**: 2026-04-20 14:23 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 14 · vless × 97 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 47 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `ruking-clash` × 6 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
