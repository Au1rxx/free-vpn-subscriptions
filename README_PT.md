...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2117-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-277ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_07:12_UTC-informational)
...
- **RTT mediano**: 277 ms
- **Última atualização (UTC)**: 2026-06-25 07:12 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 33 · vless × 38 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 32 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 6
