...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2147-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-211ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_22:25_UTC-informational)
...
- **RTT mediano**: 211 ms
- **Última atualização (UTC)**: 2026-05-28 22:25 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 28 · vless × 10 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 3
