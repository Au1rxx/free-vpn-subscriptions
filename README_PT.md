...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2429-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-92ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-25_14:10_UTC-informational)
...
- **RTT mediano**: 92 ms
- **Última atualização (UTC)**: 2026-05-25 14:10 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 16 · vless × 67 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 40 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 2
