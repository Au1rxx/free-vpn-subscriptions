...
![nós](https://img.shields.io/badge/nós-57-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1926-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-92ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-27_10:14_UTC-informational)
...
- **RTT mediano**: 92 ms
- **Última atualização (UTC)**: 2026-05-27 10:14 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 7 · vless × 14 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 1 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 5
