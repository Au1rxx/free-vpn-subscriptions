...
![nós](https://img.shields.io/badge/nós-149-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2331-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-447ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_16:34_UTC-informational)
...
- **RTT mediano**: 447 ms
- **Última atualização (UTC)**: 2026-04-21 16:34 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 19 · vless × 87 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 50 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
