...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2334-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-81ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-24_10:22_UTC-informational)
...
- **RTT mediano**: 81 ms
- **Última atualização (UTC)**: 2026-05-24 10:22 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 19 · vless × 71 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 40 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 58 · `pawdroid` × 3 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
