...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2024-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-328ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_16:19_UTC-informational)
...
- **RTT mediano**: 328 ms
- **Última atualização (UTC)**: 2026-06-10 16:19 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 19 · vless × 16 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 12 · `pawdroid` × 6 · `ruking-clash` × 9 · `surfboard-eternity` × 5
