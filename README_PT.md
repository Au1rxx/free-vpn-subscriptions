...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1974-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-146ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_05:23_UTC-informational)
...
- **RTT mediano**: 146 ms
- **Última atualização (UTC)**: 2026-05-12 05:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 57 · trojan × 5 · vless × 77 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 4 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 12
