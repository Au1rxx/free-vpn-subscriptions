...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1791-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-319ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_08:15_UTC-informational)
...
- **Ativos em todas as fontes**: 1791
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 319 ms
- **Última atualização (UTC)**: 2026-07-07 08:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 27 · vless × 21 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 9 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 5
