...
![nós](https://img.shields.io/badge/nós-73-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2148-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-159ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_12:28_UTC-informational)
...
- **RTT mediano**: 159 ms
- **Última atualização (UTC)**: 2026-05-30 12:28 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 12 · vless × 8 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 4 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
