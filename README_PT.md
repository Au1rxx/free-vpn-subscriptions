...
![nós](https://img.shields.io/badge/nós-125-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1770-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-374ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_12:34_UTC-informational)
...
- **Ativos em todas as fontes**: 1770
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 374 ms
- **Última atualização (UTC)**: 2026-07-07 12:34 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 67 · trojan × 24 · vless × 10 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 4
