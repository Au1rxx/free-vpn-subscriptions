...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2364-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-103ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_01:26_UTC-informational)
...
- **RTT mediano**: 103 ms
- **Última atualização (UTC)**: 2026-06-01 01:26 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 27 · vless × 32 · vmess × 34

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 32 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 4
