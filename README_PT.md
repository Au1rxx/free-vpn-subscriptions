...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1787-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-338ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_12:27_UTC-informational)
...
- **Ativos em todas as fontes**: 1787
- **RTT do nó mais rápido**: 38 ms
- **RTT mediano**: 338 ms
- **Última atualização (UTC)**: 2026-07-11 12:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 19 · vless × 14 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 30 · `matin-v2ray` × 9 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 3
