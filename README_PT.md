...
![nós](https://img.shields.io/badge/nós-117-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1901-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-324ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-13_04:35_UTC-informational)
...
- **RTT mediano**: 324 ms
- **Última atualização (UTC)**: 2026-06-13 04:35 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 51 · trojan × 30 · vless × 26 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 32 · `pawdroid` × 7 · `ruking-clash` × 9 · `surfboard-eternity` × 2
