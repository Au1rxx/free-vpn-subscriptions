...
![nós](https://img.shields.io/badge/nós-81-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1768-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-317ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_10:36_UTC-informational)
...
- **Nós selecionados**: 81
- **Ativos em todas as fontes**: 1768
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 317 ms
- **Última atualização (UTC)**: 2026-06-08 10:36 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 17 · vless × 15 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 18 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 4
