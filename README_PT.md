...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2024-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-78ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_14:35_UTC-informational)
...
- **Ativos em todas as fontes**: 2024
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 78 ms
- **Última atualização (UTC)**: 2026-05-22 14:35 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 21 · vless × 83 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 69 · `pawdroid` × 4 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
