...
![nós](https://img.shields.io/badge/nós-120-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2018-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-319ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_10:38_UTC-informational)
...
- **RTT mediano**: 319 ms
- **Última atualização (UTC)**: 2026-06-25 10:38 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 29 · vless × 36 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 31 · `lagzian-mix` × 3 · `mahdi0024` × 20 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 6
