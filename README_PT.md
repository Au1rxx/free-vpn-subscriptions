...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1956-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-152ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-07_07:27_UTC-informational)
...
- **RTT mediano**: 152 ms
- **Última atualização (UTC)**: 2026-05-07 07:27 UTC

**Mix de protocolos:** shadowsocks × 49 · trojan × 5 · vless × 87 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 72 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
