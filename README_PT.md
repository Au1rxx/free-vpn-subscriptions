...
![nós](https://img.shields.io/badge/nós-130-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1738-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-362ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_17:24_UTC-informational)
...
- **RTT mediano**: 362 ms
- **Última atualização (UTC)**: 2026-07-08 17:24 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 71 · trojan × 22 · vless × 14 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 19 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 15 · `pawdroid` × 8 · `ruking-clash` × 2 · `surfboard-eternity` × 3
