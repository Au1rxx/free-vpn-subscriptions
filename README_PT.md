...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2427-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-116ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-13_18:30_UTC-informational)
...
- **Ativos em todas as fontes**: 2427
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 116 ms
- **Última atualização (UTC)**: 2026-05-13 18:30 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 20 · vless × 81 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 3 · `ruking-clash` × 6 · `snakem982` × 2 · `surfboard-eternity` × 4
