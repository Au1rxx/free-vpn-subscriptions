...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2547-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_03:11_UTC-informational)
...
- **Ativos em todas as fontes**: 2547
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-04-27 03:11 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 4 · vless × 100 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 46 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 55 · `pawdroid` × 1 · `surfboard-eternity` × 6
