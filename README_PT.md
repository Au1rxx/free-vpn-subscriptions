...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1927-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-411ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_19:35_UTC-informational)
...
- **RTT mediano**: 411 ms
- **Última atualização (UTC)**: 2026-06-25 19:35 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 38 · vless × 18 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 20 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 20 · `surfboard-eternity` × 6
