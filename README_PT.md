...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2054-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-120ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_02:28_UTC-informational)
...
- **RTT mediano**: 120 ms
- **Última atualização (UTC)**: 2026-05-28 02:28 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 26 · vless × 42 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 35 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 7 · `surfboard-eternity` × 4
