...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2196-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-149ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_09:19_UTC-informational)
...
- **RTT mediano**: 149 ms
- **Última atualização (UTC)**: 2026-04-21 09:19 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 2 · vless × 105 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 53 · `epodonios` × 3 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 56 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
