...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2446-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-136ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_06:35_UTC-informational)
...
- **RTT mediano**: 136 ms
- **Última atualização (UTC)**: 2026-05-11 06:35 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 5 · vless × 94 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
