...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2402-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-375ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-19_02:17_UTC-informational)
...
- **Ativos em todas as fontes**: 2402
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 375 ms
- **Última atualização (UTC)**: 2026-07-19 02:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 92 · vless × 16 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `mahdi0024` × 35 · `mahdibland-aggregator` × 34 · `mahdibland-shadowsocks` × 38 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 10 · `surfboard-eternity` × 7
