...
![nós](https://img.shields.io/badge/nós-138-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2588-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-229ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_14:16_UTC-informational)
...
- **Ativos em todas as fontes**: 2588
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 229 ms
- **Última atualização (UTC)**: 2026-04-22 14:16 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 22 · vless × 79 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 57 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7
