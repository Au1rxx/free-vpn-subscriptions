...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2222-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-107ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_07:22_UTC-informational)
...
- **RTT mediano**: 107 ms
- **Última atualização (UTC)**: 2026-04-30 07:22 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 17 · vless × 90 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 7 · `ninjastrikers` × 67 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
