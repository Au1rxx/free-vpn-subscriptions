...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1961-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-573ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_20:15_UTC-informational)
...
- **RTT mediano**: 573 ms
- **Última atualização (UTC)**: 2026-06-16 20:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 46 · trojan × 20 · vless × 12 · vmess × 71

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 73 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 3
