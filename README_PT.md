...
![nós](https://img.shields.io/badge/nós-75-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2105-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-158ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_09:30_UTC-informational)
...
- **RTT mediano**: 158 ms
- **Última atualização (UTC)**: 2026-07-10 09:30 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 12 · vless × 11 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 2 · `snakem982` × 1
