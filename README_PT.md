...
![nós](https://img.shields.io/badge/nós-89-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2081-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-252ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_12:30_UTC-informational)
...
- **RTT mediano**: 252 ms
- **Última atualização (UTC)**: 2026-06-27 12:30 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 33 · vless × 15 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 12 · `surfboard-eternity` × 2
