...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2025-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-145ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-07_01:31_UTC-informational)
...
- **Ativos em todas as fontes**: 2025
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 145 ms
- **Última atualização (UTC)**: 2026-05-07 01:31 UTC

**Mix de protocolos:** shadowsocks × 50 · trojan × 4 · vless × 84 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
