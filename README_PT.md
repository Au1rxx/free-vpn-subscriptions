...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1867-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-358ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_23:16_UTC-informational)
...
- **Ativos em todas as fontes**: 1867
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 358 ms
- **Última atualização (UTC)**: 2026-06-15 23:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 26 · vless × 16 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 3
