...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2118-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-117ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_00:39_UTC-informational)
...
- **RTT mediano**: 117 ms
- **Última atualização (UTC)**: 2026-04-30 00:39 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 4 · vless × 96 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 70 · `snakem982` × 1 · `surfboard-eternity` × 5
