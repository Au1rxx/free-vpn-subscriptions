...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2241-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-181ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_10:32_UTC-informational)
...
- **RTT mediano**: 181 ms
- **Última atualização (UTC)**: 2026-04-22 10:32 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 18 · vless × 90 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 36 · `epodonios` × 9 · `lagzian-mix` × 7 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 6
