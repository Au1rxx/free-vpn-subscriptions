...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1871-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-354ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_06:11_UTC-informational)
...
- **RTT mediano**: 354 ms
- **Última atualização (UTC)**: 2026-06-30 06:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 37 · vless × 17 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 4
