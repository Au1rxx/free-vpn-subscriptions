...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2220-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-122ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_13:31_UTC-informational)
...
- **RTT mediano**: 122 ms
- **Última atualização (UTC)**: 2026-04-25 13:31 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 16 · vless × 88 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 57 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
