...
![nós](https://img.shields.io/badge/nós-128-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1774-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-358ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_07:38_UTC-informational)
...
- **RTT mediano**: 358 ms
- **Última atualização (UTC)**: 2026-07-09 07:38 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 57 · trojan × 25 · vless × 17 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 4 · `ninjastrikers` × 18 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 7
