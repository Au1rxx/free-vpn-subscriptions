...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2523-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-109ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_10:31_UTC-informational)
...
- **Ativos em todas as fontes**: 2523
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 109 ms
- **Última atualização (UTC)**: 2026-04-25 10:31 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 17 · vless × 97 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 63 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
