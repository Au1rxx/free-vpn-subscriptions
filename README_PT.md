...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2235-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-207ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_18:39_UTC-informational)
...
- **RTT mediano**: 207 ms
- **Última atualização (UTC)**: 2026-04-30 18:39 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 25 · vless × 73 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `snakem982` × 3 · `surfboard-eternity` × 5
