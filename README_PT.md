...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1975-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-399ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_07:17_UTC-informational)
...
- **RTT mediano**: 399 ms
- **Última atualização (UTC)**: 2026-07-16 07:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 70 · vless × 14 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `mahdi0024` × 18 · `mahdibland-aggregator` × 38 · `mahdibland-shadowsocks` × 42 · `matin-v2ray` × 4 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 8 · `surfboard-eternity` × 3
