...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1888-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-351ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-13_08:37_UTC-informational)
...
- **RTT mediano**: 351 ms
- **Última atualização (UTC)**: 2026-06-13 08:37 UTC

**Mix de protocolos:** shadowsocks × 49 · trojan × 25 · vless × 16 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 11 · `surfboard-eternity` × 3
