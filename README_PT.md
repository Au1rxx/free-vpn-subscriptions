...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2116-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-355ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_19:18_UTC-informational)
...
- **RTT mediano**: 355 ms
- **Última atualização (UTC)**: 2026-06-20 19:18 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 26 · vless × 23 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 3 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 25 · `surfboard-eternity` × 1
