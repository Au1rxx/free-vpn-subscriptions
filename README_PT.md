...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2254-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-381ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_11:29_UTC-informational)
...
- **RTT mediano**: 381 ms
- **Última atualização (UTC)**: 2026-07-01 11:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 36 · vless × 10 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 19 · `mfuu-clash` × 9 · `ninjastrikers` × 19 · `pawdroid` × 6 · `surfboard-eternity` × 3
