...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2261-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-400ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_10:11_UTC-informational)
...
- **RTT mediano**: 400 ms
- **Última atualização (UTC)**: 2026-07-18 10:11 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 107 · vless × 6 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 62 · `mahdibland-aggregator` × 30 · `mahdibland-shadowsocks` × 40 · `ninjastrikers` × 3 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 4
