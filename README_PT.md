...
![nós](https://img.shields.io/badge/nós-144-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1865-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-380ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_23:21_UTC-informational)
...
- **RTT mediano**: 380 ms
- **Última atualização (UTC)**: 2026-07-15 23:21 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 70 · trojan × 40 · vless × 19 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `mahdi0024` × 23 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 9 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 4
