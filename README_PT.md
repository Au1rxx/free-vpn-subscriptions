...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2646-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_04:32_UTC-informational)
...
- **Ativos em todas as fontes**: 2646
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-04-25 04:32 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 12 · vless × 106 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 33 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 66 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
