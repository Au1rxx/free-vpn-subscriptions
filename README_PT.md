...
![nós](https://img.shields.io/badge/nós-149-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1908-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-470ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_07:37_UTC-informational)
...
- **Ativos em todas as fontes**: 1908
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 470 ms
- **Última atualização (UTC)**: 2026-06-22 07:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 46 · trojan × 30 · vless × 59 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 6 · `ruking-clash` × 31 · `snakem982` × 3 · `surfboard-eternity` × 2
