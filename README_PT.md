...
![nós](https://img.shields.io/badge/nós-146-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2057-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-429ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_12:34_UTC-informational)
...
- **RTT mediano**: 429 ms
- **Última atualização (UTC)**: 2026-06-21 12:34 UTC

**Mix de protocolos:** shadowsocks × 45 · trojan × 34 · vless × 44 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 21 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 37 · `surfboard-eternity` × 3
