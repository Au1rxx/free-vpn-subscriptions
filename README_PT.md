...
![nós](https://img.shields.io/badge/nós-127-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2484-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-489ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_11:38_UTC-informational)
...
- **RTT mediano**: 489 ms
- **Última atualização (UTC)**: 2026-06-19 11:38 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 32 · trojan × 27 · vless × 48 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 7
