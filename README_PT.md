...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2400-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-74ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-03_08:35_UTC-informational)
...
- **RTT mediano**: 74 ms
- **Última atualização (UTC)**: 2026-06-03 08:35 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 37 · vless × 6 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 10 · `pawdroid` × 1 · `surfboard-eternity` × 2
