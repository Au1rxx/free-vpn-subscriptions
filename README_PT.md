...
![nós](https://img.shields.io/badge/nós-112-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1973-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-339ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_14:12_UTC-informational)
...
- **RTT mediano**: 339 ms
- **Última atualização (UTC)**: 2026-07-05 14:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 25 · vless × 13 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
