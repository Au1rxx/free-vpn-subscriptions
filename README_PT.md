...
![nós](https://img.shields.io/badge/nós-84-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2314-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-276ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_17:09_UTC-informational)
...
- **RTT mediano**: 276 ms
- **Última atualização (UTC)**: 2026-06-19 17:09 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 23 · vless × 10 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 4 · `ruking-clash` × 18 · `surfboard-eternity` × 7
