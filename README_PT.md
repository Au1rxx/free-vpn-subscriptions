...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1933-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-124ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-05_06:15_UTC-informational)
...
- **RTT mediano**: 124 ms
- **Última atualização (UTC)**: 2026-06-05 06:15 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 35 · vless × 28 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `epodonios` × 29 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 2
