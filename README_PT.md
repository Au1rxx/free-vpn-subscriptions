...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2278-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-147ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-05_01:28_UTC-informational)
...
- **Ativos em todas as fontes**: 2278
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 147 ms
- **Última atualização (UTC)**: 2026-05-05 01:28 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 10 · vless × 95 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 78 · `pawdroid` × 2 · `surfboard-eternity` × 7
