...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1894-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-367ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_11:11_UTC-informational)
...
- **RTT mediano**: 367 ms
- **Última atualização (UTC)**: 2026-07-14 11:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 22 · vless × 11 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 4
