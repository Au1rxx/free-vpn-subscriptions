...
![nós](https://img.shields.io/badge/nós-138-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1829-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-402ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_22:11_UTC-informational)
...
- **RTT mediano**: 402 ms
- **Última atualização (UTC)**: 2026-07-15 22:11 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 74 · trojan × 39 · vless × 10 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `mahdi0024` × 19 · `mahdibland-aggregator` × 30 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 3 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 4
