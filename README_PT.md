...
![nós](https://img.shields.io/badge/nós-125-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2536-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-187ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_05:38_UTC-informational)
...
- **RTT mediano**: 187 ms
- **Última atualização (UTC)**: 2026-06-02 05:38 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 36 · vless × 21 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 25 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 7
