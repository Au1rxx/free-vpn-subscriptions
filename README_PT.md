...
![nós](https://img.shields.io/badge/nós-139-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2208-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-157ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-28_16:39_UTC-informational)
...
- **Ativos em todas as fontes**: 2208
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 157 ms
- **Última atualização (UTC)**: 2026-04-28 16:39 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 21 · vless × 78 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 52 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
