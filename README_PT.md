...
![nós](https://img.shields.io/badge/nós-77-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1761-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-325ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_14:10_UTC-informational)
...
- **Nós selecionados**: 77
- **Ativos em todas as fontes**: 1761
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 325 ms
- **Última atualização (UTC)**: 2026-06-08 14:10 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 17 · vless × 13 · vmess × 4

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 1 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 24 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 6
