...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1991-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-306ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_17:33_UTC-informational)
...
- **RTT mediano**: 306 ms
- **Última atualização (UTC)**: 2026-07-05 17:33 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 26 · vless × 11 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 6 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 2
