...
![nós](https://img.shields.io/badge/nós-119-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2101-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-361ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_05:16_UTC-informational)
...
- **Ativos em todas as fontes**: 2101
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 361 ms
- **Última atualização (UTC)**: 2026-06-24 05:16 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 29 · vless × 41 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 41 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `pawdroid` × 4 · `ruking-clash` × 13 · `surfboard-eternity` × 3
