...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2089-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-407ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_21:11_UTC-informational)
...
- **RTT mediano**: 407 ms
- **Última atualização (UTC)**: 2026-06-24 21:11 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 34 · vless × 33 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 37 · `mahdi0024` × 16 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 14 · `surfboard-eternity` × 5
