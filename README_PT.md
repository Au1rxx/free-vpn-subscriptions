...
![nós](https://img.shields.io/badge/nós-44-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2496-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-78ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_19:21_UTC-informational)
...
- **RTT mediano**: 78 ms
- **Última atualização (UTC)**: 2026-06-01 19:21 UTC

**Mix de protocolos:** shadowsocks × 15 · trojan × 10 · vless × 3 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 16 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 4 · `surfboard-eternity` × 1
