...
![nós](https://img.shields.io/badge/nós-68-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1894-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-112ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-27_08:24_UTC-informational)
...
- **RTT mediano**: 112 ms
- **Última atualização (UTC)**: 2026-05-27 08:24 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 10 · vless × 18 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `ruking-clash` × 6 · `snakem982` × 2 · `surfboard-eternity` × 4
