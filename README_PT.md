...
![nós](https://img.shields.io/badge/nós-131-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2612-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-291ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_23:11_UTC-informational)
...
- **Ativos em todas as fontes**: 2612
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 291 ms
- **Última atualização (UTC)**: 2026-04-22 23:11 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 20 · vless × 68 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
