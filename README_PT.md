...
![nós](https://img.shields.io/badge/nós-146-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2403-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-83ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-19_20:32_UTC-informational)
...
- **Ativos em todas as fontes**: 2403
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 83 ms
- **Última atualização (UTC)**: 2026-05-19 20:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 24 · vless × 66 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
