...
![nós](https://img.shields.io/badge/nós-91-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1945-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-208ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_19:25_UTC-informational)
...
- **RTT mediano**: 208 ms
- **Última atualização (UTC)**: 2026-07-05 19:25 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 22 · vless × 7 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 6 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 2
