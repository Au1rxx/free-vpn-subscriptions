...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1831-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-377ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_19:39_UTC-informational)
...
- **Ativos em todas as fontes**: 1831
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 377 ms
- **Última atualização (UTC)**: 2026-06-15 19:39 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 23 · vless × 22 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 8 · `surfboard-eternity` × 5
