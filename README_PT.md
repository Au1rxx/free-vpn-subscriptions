...
![nós](https://img.shields.io/badge/nós-137-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2184-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-144ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-28_18:17_UTC-informational)
...
- **Ativos em todas as fontes**: 2184
- **RTT do nó mais rápido**: 39 ms
- **RTT mediano**: 144 ms
- **Última atualização (UTC)**: 2026-04-28 18:17 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 24 · vless × 75 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
