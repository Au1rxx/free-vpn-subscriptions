...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1904-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-455ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_17:17_UTC-informational)
...
- **RTT mediano**: 455 ms
- **Última atualização (UTC)**: 2026-06-12 17:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 37 · vless × 13 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 2
