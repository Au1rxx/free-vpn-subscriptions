...
![nós](https://img.shields.io/badge/nós-130-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1939-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-469ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_06:16_UTC-informational)
...
- **RTT mediano**: 469 ms
- **Última atualização (UTC)**: 2026-06-17 06:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 27 · vless × 23 · vmess × 39

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 41 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
