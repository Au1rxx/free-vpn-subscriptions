...
![nós](https://img.shields.io/badge/nós-138-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1698-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-373ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_01:23_UTC-informational)
...
- **Ativos em todas as fontes**: 1698
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 373 ms
- **Última atualização (UTC)**: 2026-06-15 01:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 56 · trojan × 26 · vless × 41 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 36 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 2
