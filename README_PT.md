...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2454-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-79ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-03_10:16_UTC-informational)
...
- **RTT mediano**: 79 ms
- **Última atualização (UTC)**: 2026-06-03 10:16 UTC

**Mix de protocolos:** shadowsocks × 13 · trojan × 36 · vless × 6 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 3 · `snakem982` × 1
