...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2579-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-103ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-28_04:22_UTC-informational)
...
- **RTT mediano**: 103 ms
- **Última atualização (UTC)**: 2026-04-28 04:22 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 7 · vless × 115 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 68 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
