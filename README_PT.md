...
![nós](https://img.shields.io/badge/nós-120-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1752-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-476ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_22:22_UTC-informational)
...
- **Ativos em todas as fontes**: 1752
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 476 ms
- **Última atualização (UTC)**: 2026-06-17 22:22 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 49 · trojan × 32 · vless × 29 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 16 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 23 · `surfboard-eternity` × 3
