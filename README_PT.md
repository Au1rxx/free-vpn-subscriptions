...
![nós](https://img.shields.io/badge/nós-91-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1870-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-388ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_18:13_UTC-informational)
...
- **RTT mediano**: 388 ms
- **Última atualização (UTC)**: 2026-06-30 18:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 34 · trojan × 34 · vless × 16 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `mahdi0024` × 7 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 9 · `ninjastrikers` × 15 · `pawdroid` × 6 · `ruking-clash` × 11 · `surfboard-eternity` × 6
