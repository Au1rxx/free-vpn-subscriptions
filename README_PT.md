...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2167-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_05:34_UTC-informational)
...
- **Ativos em todas as fontes**: 2167
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-04-26 05:34 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 7 · vless × 107 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 8
