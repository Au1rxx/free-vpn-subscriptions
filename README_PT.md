...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1925-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-221ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_20:38_UTC-informational)
...
- **RTT mediano**: 221 ms
- **Última atualização (UTC)**: 2026-07-11 20:38 UTC

**Mix de protocolos:** shadowsocks × 52 · trojan × 16 · vless × 13 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 3 · `surfboard-eternity` × 4
