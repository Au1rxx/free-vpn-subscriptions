...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2360-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-73ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_06:38_UTC-informational)
...
- **RTT mediano**: 73 ms
- **Última atualização (UTC)**: 2026-05-23 06:38 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 7 · vless × 100 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 19 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 70 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
