...
![nós](https://img.shields.io/badge/nós-137-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2446-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-338ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_23:16_UTC-informational)
...
- **RTT mediano**: 338 ms
- **Última atualização (UTC)**: 2026-04-23 23:16 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 22 · vless × 79 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 2 · `surfboard-eternity` × 4
