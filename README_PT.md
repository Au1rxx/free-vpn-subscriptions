...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2132-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-99ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_04:36_UTC-informational)
...
- **RTT mediano**: 99 ms
- **Última atualização (UTC)**: 2026-04-29 04:36 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 6 · vless × 103 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 70 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
