...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2022-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-157ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_11:34_UTC-informational)
...
- **RTT mediano**: 157 ms
- **Última atualização (UTC)**: 2026-05-12 11:34 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 18 · vless × 82 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 4 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 71 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 7
