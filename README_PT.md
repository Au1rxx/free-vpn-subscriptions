...
![nós](https://img.shields.io/badge/nós-137-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1701-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-377ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_04:23_UTC-informational)
...
- **RTT mediano**: 377 ms
- **Última atualização (UTC)**: 2026-06-14 04:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 40 · vless × 36 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 17 · `ninjastrikers` × 34 · `pawdroid` × 3 · `ruking-clash` × 22 · `surfboard-eternity` × 4
