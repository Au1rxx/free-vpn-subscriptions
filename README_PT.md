...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2197-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-87ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_08:17_UTC-informational)
...
- **Ativos em todas as fontes**: 2197
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 87 ms
- **Última atualização (UTC)**: 2026-04-26 08:17 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 10 · vless × 100 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
