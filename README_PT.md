...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1978-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-491ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_08:33_UTC-informational)
...
- **RTT mediano**: 491 ms
- **Última atualização (UTC)**: 2026-06-18 08:33 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 33 · trojan × 29 · vless × 27 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `snakem982` × 1 · `surfboard-eternity` × 2
