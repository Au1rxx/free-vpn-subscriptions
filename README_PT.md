...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2542-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-165ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_08:37_UTC-informational)
...
- **RTT mediano**: 165 ms
- **Última atualização (UTC)**: 2026-04-23 08:37 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 20 · vless × 93 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 73 · `pawdroid` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
