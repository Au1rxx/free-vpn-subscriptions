...
![nós](https://img.shields.io/badge/nós-142-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1987-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-277ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_00:27_UTC-informational)
...
- **RTT mediano**: 277 ms
- **Última atualização (UTC)**: 2026-07-13 00:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 72 · trojan × 27 · vless × 26 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 29 · `mahdibland-aggregator` × 31 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 7 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 5
