...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1664-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-502ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_12:19_UTC-informational)
...
- **RTT mediano**: 502 ms
- **Última atualização (UTC)**: 2026-06-14 12:19 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 36 · vless × 16 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 3 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 4
