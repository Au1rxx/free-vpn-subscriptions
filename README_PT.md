...
![nós](https://img.shields.io/badge/nós-85-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2132-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-147ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_17:27_UTC-informational)
...
- **RTT mediano**: 147 ms
- **Última atualização (UTC)**: 2026-07-09 17:27 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 10 · vless × 21 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 37 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 10 · `pawdroid` × 8 · `ruking-clash` × 2
