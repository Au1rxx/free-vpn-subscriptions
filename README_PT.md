...
![nós](https://img.shields.io/badge/nós-107-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1881-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-372ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_12:28_UTC-informational)
...
- **RTT mediano**: 372 ms
- **Última atualização (UTC)**: 2026-07-06 12:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 30 · vless × 9 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 6 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 4
