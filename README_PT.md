...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2670-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-94ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_00:12_UTC-informational)
...
- **Ativos em todas as fontes**: 2670
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 94 ms
- **Última atualização (UTC)**: 2026-04-25 00:12 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 10 · vless × 106 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 34 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 63 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
