...
![nós](https://img.shields.io/badge/nós-102-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1812-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-316ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_16:37_UTC-informational)
...
- **Ativos em todas as fontes**: 1812
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 316 ms
- **Última atualização (UTC)**: 2026-07-07 16:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 21 · vless × 14 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
