...
![nós](https://img.shields.io/badge/nós-81-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1751-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-317ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_13:32_UTC-informational)
...
- **RTT mediano**: 317 ms
- **Última atualização (UTC)**: 2026-06-08 13:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 19 · vless × 12 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 4 · `surfboard-eternity` × 4
