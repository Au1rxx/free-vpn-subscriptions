...
![nós](https://img.shields.io/badge/nós-131-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2400-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-471ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_00:32_UTC-informational)
...
- **RTT mediano**: 471 ms
- **Última atualização (UTC)**: 2026-06-19 00:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 28 · vless × 49 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `epodonios` × 12 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 28 · `pawdroid` × 3 · `ruking-clash` × 32 · `snakem982` × 10 · `surfboard-eternity` × 3
