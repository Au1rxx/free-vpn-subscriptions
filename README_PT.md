...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2289-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-214ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-08_15:19_UTC-informational)
...
- **Ativos em todas as fontes**: 2289
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 214 ms
- **Última atualização (UTC)**: 2026-05-08 15:19 UTC

**Mix de protocolos:** shadowsocks × 50 · trojan × 18 · vless × 73 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 67 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
