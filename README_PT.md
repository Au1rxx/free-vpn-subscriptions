...
![nós](https://img.shields.io/badge/nós-122-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1806-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-339ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_04:22_UTC-informational)
...
- **Ativos em todas as fontes**: 1806
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 339 ms
- **Última atualização (UTC)**: 2026-07-11 04:22 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 25 · vless × 23 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 33 · `matin-v2ray` × 2 · `ninjastrikers` × 26 · `pawdroid` × 9 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
