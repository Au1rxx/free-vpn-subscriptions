...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2055-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-163ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_03:38_UTC-informational)
...
- **RTT mediano**: 163 ms
- **Última atualização (UTC)**: 2026-07-04 03:38 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 23 · vless × 13 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 6 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
