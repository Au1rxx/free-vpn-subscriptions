...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2110-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-108ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_02:13_UTC-informational)
...
- **Ativos em todas as fontes**: 2110
- **RTT do nó mais rápido**: 38 ms
- **RTT mediano**: 108 ms
- **Última atualização (UTC)**: 2026-04-29 02:13 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 13 · vless × 98 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 6 · `ninjastrikers` × 72 · `surfboard-eternity` × 4
