...
![nós](https://img.shields.io/badge/nós-91-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2339-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-166ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_23:25_UTC-informational)
...
- **RTT mediano**: 166 ms
- **Última atualização (UTC)**: 2026-05-31 23:25 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 29 · vless × 6 · vmess × 37

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `pawdroid` × 1 · `surfboard-eternity` × 1
