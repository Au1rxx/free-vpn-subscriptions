...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2314-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-436ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_17:19_UTC-informational)
...
- **RTT mediano**: 436 ms
- **Última atualização (UTC)**: 2026-04-21 17:19 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 18 · vless × 86 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 48 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 52 · `ruking-clash` × 6 · `surfboard-eternity` × 4
