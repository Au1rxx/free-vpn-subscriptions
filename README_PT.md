...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2091-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-126ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_11:11_UTC-informational)
...
- **RTT mediano**: 126 ms
- **Última atualização (UTC)**: 2026-04-29 11:11 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 11 · vless × 90 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `ruking-clash` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
