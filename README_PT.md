...
![nós](https://img.shields.io/badge/nós-123-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2010-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-314ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_21:29_UTC-informational)
...
- **RTT mediano**: 314 ms
- **Última atualização (UTC)**: 2026-07-12 21:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 69 · trojan × 25 · vless × 15 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 30 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 6 · `mfuu-clash` × 4 · `ninjastrikers` × 15 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 5
