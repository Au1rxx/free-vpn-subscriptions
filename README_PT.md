...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1919-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-130ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_10:21_UTC-informational)
...
- **RTT mediano**: 130 ms
- **Última atualização (UTC)**: 2026-05-12 10:21 UTC

**Mix de protocolos:** shadowsocks × 53 · trojan × 4 · vless × 83 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
