...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2228-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-142ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_01:28_UTC-informational)
...
- **RTT mediano**: 142 ms
- **Última atualização (UTC)**: 2026-05-06 01:28 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 15 · vless × 89 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 79 · `pawdroid` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
