...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2086-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-183ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_13:13_UTC-informational)
...
- **RTT mediano**: 183 ms
- **Última atualização (UTC)**: 2026-06-27 13:13 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 34 · vless × 18 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 5 · `ruking-clash` × 15 · `surfboard-eternity` × 2
