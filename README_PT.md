...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2450-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-126ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-13_17:20_UTC-informational)
...
- **RTT mediano**: 126 ms
- **Última atualização (UTC)**: 2026-05-13 17:20 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 20 · vless × 78 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 5 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 6
