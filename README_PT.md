...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1813-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-370ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_21:38_UTC-informational)
...
- **RTT mediano**: 370 ms
- **Última atualização (UTC)**: 2026-07-07 21:38 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 55 · trojan × 27 · vless × 17 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 10 · `ninjastrikers` × 16 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 2
