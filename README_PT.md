...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1951-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-302ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_23:20_UTC-informational)
...
- **Ativos em todas as fontes**: 1951
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 302 ms
- **Última atualização (UTC)**: 2026-05-11 23:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 56 · trojan × 10 · vless × 70 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 6 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 56 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 5
