...
![nós](https://img.shields.io/badge/nós-139-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1715-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-369ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_03:29_UTC-informational)
...
- **Ativos em todas as fontes**: 1715
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 369 ms
- **Última atualização (UTC)**: 2026-07-11 03:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 77 · trojan × 22 · vless × 23 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 22 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 3 · `ninjastrikers` × 23 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4
