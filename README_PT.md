...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2542-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-85ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_06:09_UTC-informational)
...
- **RTT mediano**: 85 ms
- **Última atualização (UTC)**: 2026-04-27 06:09 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 6 · vless × 97 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 48 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 51 · `surfboard-eternity` × 4
