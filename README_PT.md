...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2446-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-390ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_19:21_UTC-informational)
...
- **RTT mediano**: 390 ms
- **Última atualização (UTC)**: 2026-07-18 19:21 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 93 · vless × 14 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 40 · `mahdibland-shadowsocks` × 32 · `matin-v2ray` × 5 · `ninjastrikers` × 4 · `pawdroid` × 7 · `ruking-clash` × 2 · `snakem982` × 14 · `surfboard-eternity` × 4
