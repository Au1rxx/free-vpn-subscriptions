...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1811-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-352ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_02:35_UTC-informational)
...
- **RTT mediano**: 352 ms
- **Última atualização (UTC)**: 2026-07-08 02:35 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 55 · trojan × 32 · vless × 23 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 7 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 2
