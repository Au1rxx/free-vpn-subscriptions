...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2259-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-339ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_18:12_UTC-informational)
...
- **Nós selecionados**: 82
- **Ativos em todas as fontes**: 2259
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 339 ms
- **Última atualização (UTC)**: 2026-07-01 18:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 19 · vless × 14 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 10 · `pawdroid` × 6 · `surfboard-eternity` × 2
