...
![nós](https://img.shields.io/badge/nós-134-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1704-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-380ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_22:13_UTC-informational)
...
- **Ativos em todas as fontes**: 1704
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 380 ms
- **Última atualização (UTC)**: 2026-07-10 22:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 82 · trojan × 24 · vless × 12 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `epodonios` × 20 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 5
