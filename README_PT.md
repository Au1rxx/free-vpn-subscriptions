...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2154-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-155ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_16:37_UTC-informational)
...
- **Ativos em todas as fontes**: 2154
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 155 ms
- **Última atualização (UTC)**: 2026-05-01 16:37 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 15 · vless × 82 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 51 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
