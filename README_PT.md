...
![nós](https://img.shields.io/badge/nós-141-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2567-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-176ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_21:34_UTC-informational)
...
- **RTT mediano**: 176 ms
- **Última atualização (UTC)**: 2026-04-24 21:34 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 23 · vless × 78 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 33 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 54 · `snakem982` × 1 · `surfboard-eternity` × 4
