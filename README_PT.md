...
![nós](https://img.shields.io/badge/nós-135-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2004-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-404ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_17:24_UTC-informational)
...
- **RTT mediano**: 404 ms
- **Última atualização (UTC)**: 2026-06-23 17:24 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 31 · vless × 45 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 45 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 7 · `ruking-clash` × 17 · `surfboard-eternity` × 3
