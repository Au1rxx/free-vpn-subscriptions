...
![nós](https://img.shields.io/badge/nós-70-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2008-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-204ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_08:22_UTC-informational)
...
- **Nós selecionados**: 70
- **Ativos em todas as fontes**: 2008
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 204 ms
- **Última atualização (UTC)**: 2026-05-28 08:22 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 14 · vless × 16 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 4 · `surfboard-eternity` × 4
