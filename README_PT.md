...
![nós](https://img.shields.io/badge/nós-125-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1793-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-349ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_04:35_UTC-informational)
...
- **RTT mediano**: 349 ms
- **Última atualização (UTC)**: 2026-07-09 04:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 58 · trojan × 22 · vless × 19 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 1
