...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2246-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-181ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-20_16:21_UTC-informational)
...
- **RTT mediano**: 181 ms
- **Última atualização (UTC)**: 2026-04-20 16:21 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 16 · vless × 95 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 50 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
