...
![nós](https://img.shields.io/badge/nós-112-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1922-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-361ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_23:14_UTC-informational)
...
- **RTT mediano**: 361 ms
- **Última atualização (UTC)**: 2026-07-13 23:14 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 41 · trojan × 25 · vless × 13 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 8 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 4
