...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2343-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-94ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-20_21:20_UTC-informational)
...
- **RTT mediano**: 94 ms
- **Última atualização (UTC)**: 2026-05-20 21:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 28 · vless × 62 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 19 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 51 · `pawdroid` × 12 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
