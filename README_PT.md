...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2202-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-96ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-02_12:32_UTC-informational)
...
- **Ativos em todas as fontes**: 2202
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 96 ms
- **Última atualização (UTC)**: 2026-05-02 12:32 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 13 · vless × 89 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 4 · `snakem982` × 2 · `surfboard-eternity` × 8
