...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1868-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-156ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_13:37_UTC-informational)
...
- **RTT mediano**: 156 ms
- **Última atualização (UTC)**: 2026-07-03 13:37 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 23 · vless × 11 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
