...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1940-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-251ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_08:37_UTC-informational)
...
- **RTT mediano**: 251 ms
- **Última atualização (UTC)**: 2026-07-12 08:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 17 · vless × 25 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 9 · `mfuu-clash` × 4 · `ninjastrikers` × 19 · `pawdroid` × 8 · `snakem982` × 1 · `surfboard-eternity` × 5
