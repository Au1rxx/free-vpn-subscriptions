...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2162-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-86ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_06:16_UTC-informational)
...
- **Ativos em todas as fontes**: 2162
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 86 ms
- **Última atualização (UTC)**: 2026-05-03 06:16 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 5 · vless × 101 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
