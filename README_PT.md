...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2159-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-111ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_02:11_UTC-informational)
...
- **RTT mediano**: 111 ms
- **Última atualização (UTC)**: 2026-04-30 02:11 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 4 · vless × 99 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 65 · `ruking-clash` × 1 · `surfboard-eternity` × 7
