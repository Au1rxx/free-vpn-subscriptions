...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2593-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-148ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_06:30_UTC-informational)
...
- **Ativos em todas as fontes**: 2593
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 148 ms
- **Última atualização (UTC)**: 2026-04-23 06:30 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 17 · vless × 96 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `epodonios` × 12 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 73 · `pawdroid` × 2 · `surfboard-eternity` × 6
