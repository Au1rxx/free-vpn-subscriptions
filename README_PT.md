...
![nós](https://img.shields.io/badge/nós-85-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2033-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-198ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_07:27_UTC-informational)
...
- **RTT mediano**: 198 ms
- **Última atualização (UTC)**: 2026-05-28 07:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 30 · trojan × 24 · vless × 19 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 5
