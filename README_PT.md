...
![nós](https://img.shields.io/badge/nós-119-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1785-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-380ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_15:16_UTC-informational)
...
- **RTT mediano**: 380 ms
- **Última atualização (UTC)**: 2026-07-09 15:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 59 · trojan × 17 · vless × 21 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 4 · `ninjastrikers` × 16 · `pawdroid` × 11 · `ruking-clash` × 2 · `surfboard-eternity` × 1
