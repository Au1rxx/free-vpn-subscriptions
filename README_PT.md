...
![nós](https://img.shields.io/badge/nós-74-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2145-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-154ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_21:29_UTC-informational)
...
- **Nós selecionados**: 74
- **Ativos em todas as fontes**: 2145
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 154 ms
- **Última atualização (UTC)**: 2026-07-09 21:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 22 · trojan × 10 · vless × 9 · vmess × 32

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
