...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2175-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-391ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-19_08:12_UTC-informational)
...
- **RTT mediano**: 391 ms
- **Última atualização (UTC)**: 2026-07-19 08:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 78 · vless × 14 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 53 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 5 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 7
