...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1896-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-298ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_14:34_UTC-informational)
...
- **RTT mediano**: 298 ms
- **Última atualização (UTC)**: 2026-07-06 14:34 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 26 · vless × 6 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 3
