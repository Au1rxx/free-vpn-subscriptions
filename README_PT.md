...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2223-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-136ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_00:19_UTC-informational)
...
- **RTT mediano**: 136 ms
- **Última atualização (UTC)**: 2026-04-22 00:19 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 4 · vless × 98 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 71 · `ruking-clash` × 5 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
