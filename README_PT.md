...
![nós](https://img.shields.io/badge/nós-137-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1721-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-371ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_02:13_UTC-informational)
...
- **Ativos em todas as fontes**: 1721
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 371 ms
- **Última atualização (UTC)**: 2026-07-11 02:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 77 · trojan × 24 · vless × 18 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `epodonios` × 23 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 27 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 2
