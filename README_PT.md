...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2157-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-155ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_17:12_UTC-informational)
...
- **RTT mediano**: 155 ms
- **Última atualização (UTC)**: 2026-05-01 17:12 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 17 · vless × 82 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 31 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 49 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
