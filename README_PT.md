...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1843-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-167ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_20:29_UTC-informational)
...
- **RTT mediano**: 167 ms
- **Última atualização (UTC)**: 2026-06-04 20:29 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 51 · vless × 20 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `ruking-clash` × 3 · `surfboard-eternity` × 6
