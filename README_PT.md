...
![nós](https://img.shields.io/badge/nós-135-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1712-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-378ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_02:33_UTC-informational)
...
- **Ativos em todas as fontes**: 1712
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 378 ms
- **Última atualização (UTC)**: 2026-06-14 02:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 37 · vless × 36 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 34 · `pawdroid` × 4 · `ruking-clash` × 21 · `surfboard-eternity` × 7
