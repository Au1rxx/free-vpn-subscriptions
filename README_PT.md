...
![nós](https://img.shields.io/badge/nós-102-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1867-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-352ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_02:16_UTC-informational)
...
- **RTT mediano**: 352 ms
- **Última atualização (UTC)**: 2026-06-30 02:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 34 · vless × 20 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 16 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 4
