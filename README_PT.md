...
![nós](https://img.shields.io/badge/nós-75-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2114-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-124ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_07:12_UTC-informational)
...
- **RTT mediano**: 124 ms
- **Última atualização (UTC)**: 2026-07-10 07:12 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 10 · vless × 15 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 33 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `surfboard-eternity` × 2
