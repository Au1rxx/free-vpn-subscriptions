...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2608-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-155ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_00:36_UTC-informational)
...
- **Ativos em todas as fontes**: 2608
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 155 ms
- **Última atualização (UTC)**: 2026-04-23 00:36 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 14 · vless × 96 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 74 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
