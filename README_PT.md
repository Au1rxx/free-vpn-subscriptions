...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2574-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_00:22_UTC-informational)
...
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-04-27 00:22 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 5 · vless × 96 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 45 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 56 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
