...
![nós](https://img.shields.io/badge/nós-80-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1928-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-168ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_09:13_UTC-informational)
...
- **RTT mediano**: 168 ms
- **Última atualização (UTC)**: 2026-07-03 09:13 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 18 · vless × 12 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 5
