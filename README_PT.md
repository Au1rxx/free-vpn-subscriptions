...
![nós](https://img.shields.io/badge/nós-146-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2072-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-362ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_03:13_UTC-informational)
...
- **RTT mediano**: 362 ms
- **Última atualização (UTC)**: 2026-06-23 03:13 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 27 · vless × 63 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 52 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 23 · `pawdroid` × 1 · `ruking-clash` × 18 · `surfboard-eternity` × 3
