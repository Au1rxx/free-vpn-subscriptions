...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2251-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-446ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-20_20:36_UTC-informational)
...
- **RTT mediano**: 446 ms
- **Última atualização (UTC)**: 2026-04-20 20:36 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 9 · vless × 101 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 64 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 41 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 4
