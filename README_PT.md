...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2570-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-121ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-20_13:24_UTC-informational)
...
- **Ativos em todas as fontes**: 2570
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 121 ms
- **Última atualização (UTC)**: 2026-04-20 13:24 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 8 · vless × 111 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 46 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 23 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 50 · `ruking-clash` × 7 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
