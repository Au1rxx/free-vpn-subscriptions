...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2028-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-69ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_09:11_UTC-informational)
...
- **Ativos em todas as fontes**: 2028
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 69 ms
- **Última atualização (UTC)**: 2026-05-22 09:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 10 · vless × 91 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 67 · `pawdroid` × 4 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 8
