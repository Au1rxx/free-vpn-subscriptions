...
![nós](https://img.shields.io/badge/nós-120-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1909-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-340ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_02:19_UTC-informational)
...
- **RTT mediano**: 340 ms
- **Última atualização (UTC)**: 2026-07-14 02:19 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 26 · vless × 24 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 29 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 7 · `ninjastrikers` × 22 · `pawdroid` × 10 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
