...
![nós](https://img.shields.io/badge/nós-129-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1812-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-291ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_03:26_UTC-informational)
...
- **RTT mediano**: 291 ms
- **Última atualização (UTC)**: 2026-07-09 03:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 57 · trojan × 25 · vless × 21 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 5 · `ninjastrikers` × 27 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 7
