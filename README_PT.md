...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2391-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-87ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-19_18:17_UTC-informational)
...
- **RTT mediano**: 87 ms
- **Última atualização (UTC)**: 2026-05-19 18:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 17 · vless × 75 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 20 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 49 · `pawdroid` × 9 · `ruking-clash` × 9 · `surfboard-eternity` × 8
