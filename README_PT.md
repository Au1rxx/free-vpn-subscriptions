...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1891-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-362ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_13:37_UTC-informational)
...
- **RTT mediano**: 362 ms
- **Última atualização (UTC)**: 2026-06-15 13:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 21 · vless × 16 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 18 · `mfuu-clash` × 2 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 3
