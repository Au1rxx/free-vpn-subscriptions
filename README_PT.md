...
![nós](https://img.shields.io/badge/nós-132-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1748-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-386ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_14:16_UTC-informational)
...
- **Ativos em todas as fontes**: 1748
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 386 ms
- **Última atualização (UTC)**: 2026-07-14 14:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 83 · trojan × 20 · vless × 15 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `mahdi0024` × 11 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
