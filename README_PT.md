...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2416-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-108ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_06:14_UTC-informational)
...
- **Ativos em todas as fontes**: 2416
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 108 ms
- **Última atualização (UTC)**: 2026-04-24 06:14 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 16 · vless × 99 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 73 · `pawdroid` × 3 · `snakem982` × 3 · `surfboard-eternity` × 6
