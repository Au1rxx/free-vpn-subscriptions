...
![nós](https://img.shields.io/badge/nós-142-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2241-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-411ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_23:36_UTC-informational)
...
- **RTT mediano**: 411 ms
- **Última atualização (UTC)**: 2026-04-21 23:36 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 23 · vless × 71 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 4 · `surfboard-eternity` × 6
