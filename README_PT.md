...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2122-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-349ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_07:33_UTC-informational)
...
- **Ativos em todas as fontes**: 2122
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 349 ms
- **Última atualização (UTC)**: 2026-07-02 07:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 30 · vless × 19 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 8 · `ninjastrikers` × 22 · `pawdroid` × 2 · `surfboard-eternity` × 4
