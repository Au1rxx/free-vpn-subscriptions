...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2023-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-341ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_00:10_UTC-informational)
...
- **RTT mediano**: 341 ms
- **Última atualização (UTC)**: 2026-06-30 00:10 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 36 · vless × 18 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 4
