...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1832-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-470ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_16:37_UTC-informational)
...
- **RTT mediano**: 470 ms
- **Última atualização (UTC)**: 2026-06-22 16:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 26 · vless × 68 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 4
