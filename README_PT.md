...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1609-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-376ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_06:10_UTC-informational)
...
- **Ativos em todas as fontes**: 1609
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 376 ms
- **Última atualização (UTC)**: 2026-07-15 06:10 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 96 · trojan × 27 · vless × 17 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 30 · `mahdi0024` × 11 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 7
