...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2446-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-98ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_00:29_UTC-informational)
...
- **RTT mediano**: 98 ms
- **Última atualização (UTC)**: 2026-04-24 00:29 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 11 · vless × 105 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 6
