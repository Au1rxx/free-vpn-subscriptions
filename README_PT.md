...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1919-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-339ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_00:27_UTC-informational)
...
- **RTT mediano**: 339 ms
- **Última atualização (UTC)**: 2026-07-14 00:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 25 · vless × 17 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 29 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 6 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
