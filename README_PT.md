...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1865-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-369ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_01:20_UTC-informational)
...
- **Ativos em todas as fontes**: 1865
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 369 ms
- **Última atualização (UTC)**: 2026-07-16 01:20 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 71 · trojan × 39 · vless × 25 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `mahdi0024` × 23 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 7 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 12 · `surfboard-eternity` × 2
