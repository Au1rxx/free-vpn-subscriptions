...
![nós](https://img.shields.io/badge/nós-70-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2103-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-154ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_11:23_UTC-informational)
...
- **RTT mediano**: 154 ms
- **Última atualização (UTC)**: 2026-07-10 11:23 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 9 · vless × 14 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 5 · `ninjastrikers` × 12 · `pawdroid` × 2
