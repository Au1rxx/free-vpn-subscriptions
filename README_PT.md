...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2682-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-93ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-17_22:37_UTC-informational)
...
- **RTT mediano**: 93 ms
- **Última atualização (UTC)**: 2026-05-17 22:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 22 · vless × 78 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 7 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 49 · `pawdroid` × 3 · `ruking-clash` × 9 · `snakem982` × 1 · `surfboard-eternity` × 3
