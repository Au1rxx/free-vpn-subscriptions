...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1923-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-363ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_09:14_UTC-informational)
...
- **RTT mediano**: 363 ms
- **Última atualização (UTC)**: 2026-07-13 09:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 21 · vless × 19 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `mahdi0024` × 28 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 4 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
