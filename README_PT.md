...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2160-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-141ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_08:12_UTC-informational)
...
- **Ativos em todas as fontes**: 2160
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 141 ms
- **Última atualização (UTC)**: 2026-05-06 08:12 UTC

**Mix de protocolos:** shadowsocks × 44 · trojan × 6 · vless × 90 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 70 · `pawdroid` × 3 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
