...
![nós](https://img.shields.io/badge/nós-136-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1999-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-448ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_23:09_UTC-informational)
...
- **RTT mediano**: 448 ms
- **Última atualização (UTC)**: 2026-06-23 23:09 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 30 · vless × 51 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 49 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
