...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2223-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-121ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_13:27_UTC-informational)
...
- **RTT mediano**: 121 ms
- **Última atualização (UTC)**: 2026-05-03 13:27 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 24 · vless × 91 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 35 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 60 · `pawdroid` × 1 · `surfboard-eternity` × 5
