...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2196-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-352ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-19_04:28_UTC-informational)
...
- **RTT mediano**: 352 ms
- **Última atualização (UTC)**: 2026-07-19 04:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 75 · vless × 18 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `mahdi0024` × 65 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 7 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 9
