...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2482-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-105ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_08:27_UTC-informational)
...
- **Ativos em todas as fontes**: 2482
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 105 ms
- **Última atualização (UTC)**: 2026-05-10 08:27 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 3 · vless × 96 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 66 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
