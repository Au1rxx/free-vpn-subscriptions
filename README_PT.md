...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2531-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-109ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_01:20_UTC-informational)
...
- **RTT mediano**: 109 ms
- **Última atualização (UTC)**: 2026-06-02 01:20 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 31 · vless × 24 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 30 · `pawdroid` × 1 · `surfboard-eternity` × 2
