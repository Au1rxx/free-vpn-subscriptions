...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2072-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-175ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_21:23_UTC-informational)
...
- **RTT mediano**: 175 ms
- **Última atualização (UTC)**: 2026-04-29 21:23 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 18 · vless × 81 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 8 · `ninjastrikers` × 55 · `surfboard-eternity` × 6
