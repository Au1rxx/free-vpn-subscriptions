...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1770-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-364ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_19:26_UTC-informational)
...
- **RTT mediano**: 364 ms
- **Última atualização (UTC)**: 2026-07-07 19:26 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 60 · trojan × 21 · vless × 9 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
