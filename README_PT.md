...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2189-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-83ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-26_06:30_UTC-informational)
...
- **Ativos em todas as fontes**: 2189
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 83 ms
- **Última atualização (UTC)**: 2026-05-26 06:30 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 15 · vless × 85 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 70 · `pawdroid` × 4 · `ruking-clash` × 15 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
