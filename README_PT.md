...
![nós](https://img.shields.io/badge/nós-119-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1774-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-352ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_21:11_UTC-informational)
...
- **RTT mediano**: 352 ms
- **Última atualização (UTC)**: 2026-07-08 21:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 52 · trojan × 32 · vless × 11 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 20 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 12 · `surfboard-eternity` × 3
