...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2371-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-398ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_13:08_UTC-informational)
...
- **RTT mediano**: 398 ms
- **Última atualização (UTC)**: 2026-07-18 13:08 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 91 · vless × 20 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 3 · `mahdi0024` × 57 · `mahdibland-aggregator` × 33 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 5 · `ninjastrikers` × 5 · `pawdroid` × 14 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
