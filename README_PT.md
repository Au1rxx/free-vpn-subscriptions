...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1876-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-343ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_16:30_UTC-informational)
...
- **RTT mediano**: 343 ms
- **Última atualização (UTC)**: 2026-07-13 16:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 21 · vless × 11 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 30 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 9 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
