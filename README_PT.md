...
![nós](https://img.shields.io/badge/nós-127-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2002-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-330ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_05:35_UTC-informational)
...
- **RTT mediano**: 330 ms
- **Última atualização (UTC)**: 2026-07-05 05:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 56 · trojan × 27 · vless × 14 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 5 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 4
