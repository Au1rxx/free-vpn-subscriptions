...
![nós](https://img.shields.io/badge/nós-80-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2418-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-167ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_14:35_UTC-informational)
...
- **RTT mediano**: 167 ms
- **Última atualização (UTC)**: 2026-06-01 14:35 UTC

**Mix de protocolos:** shadowsocks × 16 · trojan × 25 · vless × 7 · vmess × 32

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 9 · `pawdroid` × 3 · `surfboard-eternity` × 2
