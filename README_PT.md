...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2565-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-162ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_20:11_UTC-informational)
...
- **Ativos em todas as fontes**: 2565
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 162 ms
- **Última atualização (UTC)**: 2026-04-26 20:11 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 16 · vless × 80 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 43 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 46 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
