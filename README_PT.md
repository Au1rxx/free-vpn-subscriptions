...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1888-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-352ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_22:34_UTC-informational)
...
- **RTT mediano**: 352 ms
- **Última atualização (UTC)**: 2026-07-06 22:34 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 28 · vless × 7 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 37 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
