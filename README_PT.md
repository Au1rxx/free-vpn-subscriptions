...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1986-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-320ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_12:36_UTC-informational)
...
- **Ativos em todas as fontes**: 1986
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 320 ms
- **Última atualização (UTC)**: 2026-07-05 12:36 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 49 · trojan × 22 · vless × 8 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 31 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
