...
![nós](https://img.shields.io/badge/nós-77-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2510-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-114ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_09:19_UTC-informational)
...
- **Nós selecionados**: 77
- **Ativos em todas as fontes**: 2510
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 114 ms
- **Última atualização (UTC)**: 2026-06-02 09:19 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 24 · vless × 8 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
