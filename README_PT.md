...
![nós](https://img.shields.io/badge/nós-81-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2018-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-161ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_06:09_UTC-informational)
...
- **RTT mediano**: 161 ms
- **Última atualização (UTC)**: 2026-07-04 06:09 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 22 · vless × 12 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
