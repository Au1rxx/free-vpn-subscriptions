...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2567-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-85ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_04:14_UTC-informational)
...
- **RTT mediano**: 85 ms
- **Última atualização (UTC)**: 2026-04-27 04:14 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 2 · vless × 101 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 45 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 6 · `ninjastrikers` × 60 · `pawdroid` × 1 · `surfboard-eternity` × 6
