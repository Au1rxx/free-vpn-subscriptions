...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1954-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-479ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_07:35_UTC-informational)
...
- **RTT mediano**: 479 ms
- **Última atualização (UTC)**: 2026-06-26 07:35 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 40 · vless × 19 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 19 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 5 · `ruking-clash` × 16 · `surfboard-eternity` × 3
