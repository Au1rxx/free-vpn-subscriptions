...
![nós](https://img.shields.io/badge/nós-146-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2633-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-163ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_23:26_UTC-informational)
...
- **Ativos em todas as fontes**: 2633
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 163 ms
- **Última atualização (UTC)**: 2026-04-27 23:26 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 22 · vless × 92 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 5 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 4
