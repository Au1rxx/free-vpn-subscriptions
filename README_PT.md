...
![nós](https://img.shields.io/badge/nós-88-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2206-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-277ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-11_07:32_UTC-informational)
...
- **Nós selecionados**: 88
- **Ativos em todas as fontes**: 2206
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 277 ms
- **Última atualização (UTC)**: 2026-06-11 07:32 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 14 · vless × 16 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 3
