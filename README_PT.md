...
![nós](https://img.shields.io/badge/nós-123-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2060-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-359ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_04:29_UTC-informational)
...
- **RTT mediano**: 359 ms
- **Última atualização (UTC)**: 2026-06-24 04:29 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 28 · vless × 45 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 42 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `pawdroid` × 4 · `ruking-clash` × 13 · `surfboard-eternity` × 2
