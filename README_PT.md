...
![nós](https://img.shields.io/badge/nós-133-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1993-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-408ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_15:33_UTC-informational)
...
- **RTT mediano**: 408 ms
- **Última atualização (UTC)**: 2026-06-23 15:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 33 · vless × 45 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 50 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `mfuu-clash` × 7 · `ninjastrikers` × 15 · `pawdroid` × 6 · `ruking-clash` × 9 · `surfboard-eternity` × 1
