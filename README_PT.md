...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1901-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-342ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_23:19_UTC-informational)
...
- **RTT mediano**: 342 ms
- **Última atualização (UTC)**: 2026-07-06 23:19 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 30 · vless × 10 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 6 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
