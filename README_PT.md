...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2491-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-397ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_14:08_UTC-informational)
...
- **Ativos em todas as fontes**: 2491
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 397 ms
- **Última atualização (UTC)**: 2026-07-18 14:08 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 97 · vless × 17 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 3 · `mahdi0024` × 30 · `mahdibland-aggregator` × 48 · `mahdibland-shadowsocks` × 36 · `matin-v2ray` × 3 · `ninjastrikers` × 4 · `pawdroid` × 14 · `ruking-clash` × 1 · `snakem982` × 6 · `surfboard-eternity` × 2
