...
![nós](https://img.shields.io/badge/nós-138-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2047-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-410ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_09:15_UTC-informational)
...
- **RTT mediano**: 410 ms
- **Última atualização (UTC)**: 2026-06-21 09:15 UTC

**Mix de protocolos:** shadowsocks × 44 · trojan × 29 · vless × 42 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 12 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 41 · `snakem982` × 2 · `surfboard-eternity` × 4
