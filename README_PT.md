...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2408-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-85ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-18_15:15_UTC-informational)
...
- **Ativos em todas as fontes**: 2408
- **RTT do nó mais rápido**: 38 ms
- **RTT mediano**: 85 ms
- **Última atualização (UTC)**: 2026-05-18 15:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 8 · vless × 92 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 3 · `mahdi0024` × 38 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 7
