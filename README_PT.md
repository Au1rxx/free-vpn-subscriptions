...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1888-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-328ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_14:27_UTC-informational)
...
- **RTT mediano**: 328 ms
- **Última atualização (UTC)**: 2026-07-11 14:27 UTC

**Mix de protocolos:** shadowsocks × 53 · trojan × 16 · vless × 17 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 27 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 4 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 2
