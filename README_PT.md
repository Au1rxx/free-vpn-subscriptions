...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2474-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-81ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-17_01:39_UTC-informational)
...
- **RTT mediano**: 81 ms
- **Última atualização (UTC)**: 2026-05-17 01:39 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 10 · vless × 91 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 56 · `pawdroid` × 6 · `ruking-clash` × 4 · `surfboard-eternity` × 1
