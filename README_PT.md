...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2635-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-98ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-28_00:11_UTC-informational)
...
- **Ativos em todas as fontes**: 2635
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 98 ms
- **Última atualização (UTC)**: 2026-04-28 00:11 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 4 · vless × 118 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 68 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
