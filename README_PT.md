...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1824-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-350ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_23:17_UTC-informational)
...
- **Nós selecionados**: 94
- **Ativos em todas as fontes**: 1824
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 350 ms
- **Última atualização (UTC)**: 2026-06-07 23:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 22 · vless × 11 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `ruking-clash` × 3 · `surfboard-eternity` × 5
