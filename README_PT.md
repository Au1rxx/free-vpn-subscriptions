...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2456-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-170ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_21:19_UTC-informational)
...
- **Ativos em todas as fontes**: 2456
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 170 ms
- **Última atualização (UTC)**: 2026-04-27 21:19 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 21 · vless × 92 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 31 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
