...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2224-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-374ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_01:33_UTC-informational)
...
- **RTT mediano**: 374 ms
- **Última atualização (UTC)**: 2026-07-17 01:33 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 75 · vless × 16 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `mahdi0024` × 42 · `mahdibland-aggregator` × 33 · `mahdibland-shadowsocks` × 32 · `matin-v2ray` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 2
