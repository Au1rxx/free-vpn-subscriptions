...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2529-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-164ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_23:21_UTC-informational)
...
- **RTT mediano**: 164 ms
- **Última atualização (UTC)**: 2026-06-01 23:21 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 34 · vless × 6 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `surfboard-eternity` × 2
