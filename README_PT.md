...
![nós](https://img.shields.io/badge/nós-90-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1819-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-418ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_21:15_UTC-informational)
...
- **RTT mediano**: 418 ms
- **Última atualização (UTC)**: 2026-06-30 21:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 12 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 14 · `surfboard-eternity` × 3
