...
![nós](https://img.shields.io/badge/nós-80-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1998-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-169ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_17:24_UTC-informational)
...
- **RTT mediano**: 169 ms
- **Última atualização (UTC)**: 2026-07-03 17:24 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 23 · vless × 16 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 10 · `ninjastrikers` × 12 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 3
