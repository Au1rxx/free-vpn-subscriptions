...
![nós](https://img.shields.io/badge/nós-121-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2461-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-493ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_10:26_UTC-informational)
...
- **RTT mediano**: 493 ms
- **Última atualização (UTC)**: 2026-06-19 10:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 32 · trojan × 21 · vless × 52 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 20 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 42 · `snakem982` × 3 · `surfboard-eternity` × 2
