...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2246-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-149ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_21:14_UTC-informational)
...
- **RTT mediano**: 149 ms
- **Última atualização (UTC)**: 2026-04-25 21:14 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 13 · vless × 87 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 35 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 1 · `ninjastrikers` × 54 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 6
