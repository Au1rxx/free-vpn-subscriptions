...
![nós](https://img.shields.io/badge/nós-137-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2494-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-168ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-09_18:39_UTC-informational)
...
- **RTT mediano**: 168 ms
- **Última atualização (UTC)**: 2026-05-09 18:39 UTC

**Mix de protocolos:** shadowsocks × 52 · trojan × 16 · vless × 61 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `ruking-clash` × 8 · `snakem982` × 3 · `surfboard-eternity` × 6
