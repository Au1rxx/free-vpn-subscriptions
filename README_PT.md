...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2516-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-105ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_13:16_UTC-informational)
...
- **Ativos em todas as fontes**: 2516
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 105 ms
- **Última atualização (UTC)**: 2026-04-27 13:16 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 7 · vless × 93 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 46 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 52 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
