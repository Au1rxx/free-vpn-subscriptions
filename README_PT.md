...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2476-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-108ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_06:30_UTC-informational)
...
- **RTT mediano**: 108 ms
- **Última atualização (UTC)**: 2026-05-10 06:30 UTC

**Mix de protocolos:** shadowsocks × 45 · trojan × 3 · vless × 94 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 67 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
