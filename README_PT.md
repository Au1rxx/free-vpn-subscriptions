...
![nós](https://img.shields.io/badge/nós-71-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2086-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-263ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_18:22_UTC-informational)
...
- **RTT mediano**: 263 ms
- **Última atualização (UTC)**: 2026-05-28 18:22 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 20 · vless × 12 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 4
