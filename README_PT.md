...
![nós](https://img.shields.io/badge/nós-83-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2218-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-226ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_06:37_UTC-informational)
...
- **RTT mediano**: 226 ms
- **Última atualização (UTC)**: 2026-06-29 06:37 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 28 · vless × 24 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 11 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 5
