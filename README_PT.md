...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2193-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-250ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_16:34_UTC-informational)
...
- **Ativos em todas as fontes**: 2193
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 250 ms
- **Última atualização (UTC)**: 2026-04-30 16:34 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 19 · vless × 74 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 53 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
