...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2039-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-73ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_13:15_UTC-informational)
...
- **RTT mediano**: 73 ms
- **Última atualização (UTC)**: 2026-05-22 13:15 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 13 · vless × 87 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 63 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
