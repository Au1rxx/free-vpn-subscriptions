...
![nós](https://img.shields.io/badge/nós-70-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2215-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-152ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_22:35_UTC-informational)
...
- **RTT mediano**: 152 ms
- **Última atualização (UTC)**: 2026-06-28 22:35 UTC

**Mix de protocolos:** shadowsocks × 17 · trojan × 19 · vless × 19 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 2 · `surfboard-eternity` × 1
