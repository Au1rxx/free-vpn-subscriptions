...
![nós](https://img.shields.io/badge/nós-101-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1947-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-352ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_12:30_UTC-informational)
...
- **Ativos em todas as fontes**: 1947
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 352 ms
- **Última atualização (UTC)**: 2026-07-13 12:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 19 · vless × 16 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 25 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 6 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
