...
![nós](https://img.shields.io/badge/nós-72-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1985-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-178ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_10:19_UTC-informational)
...
- **RTT mediano**: 178 ms
- **Última atualização (UTC)**: 2026-07-04 10:19 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 20 · vless × 6 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
