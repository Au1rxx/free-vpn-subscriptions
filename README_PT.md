...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2261-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-100ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_01:22_UTC-informational)
...
- **Ativos em todas as fontes**: 2261
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 100 ms
- **Última atualização (UTC)**: 2026-05-01 01:22 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 5 · vless × 96 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 63 · `snakem982` × 1 · `surfboard-eternity` × 3
