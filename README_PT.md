...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1896-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-418ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_05:32_UTC-informational)
...
- **RTT mediano**: 418 ms
- **Última atualização (UTC)**: 2026-06-17 05:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 13 · vless × 20 · vmess × 72

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 74 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 18 · `ruking-clash` × 3 · `surfboard-eternity` × 3
