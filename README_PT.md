...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1888-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-262ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_06:08_UTC-informational)
...
- **RTT mediano**: 262 ms
- **Última atualização (UTC)**: 2026-07-12 06:08 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 16 · vless × 27 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 12 · `ninjastrikers` × 25 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
