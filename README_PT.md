...
![nós](https://img.shields.io/badge/nós-81-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2173-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-172ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_09:33_UTC-informational)
...
- **RTT mediano**: 172 ms
- **Última atualização (UTC)**: 2026-06-06 09:33 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 24 · vless × 16 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 25 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 1
