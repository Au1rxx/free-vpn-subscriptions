...
![nós](https://img.shields.io/badge/nós-136-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2433-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-115ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_11:21_UTC-informational)
...
- **RTT mediano**: 115 ms
- **Última atualização (UTC)**: 2026-04-24 11:21 UTC

**Mix de protocolos:** shadowsocks × 11 · trojan × 21 · vless × 91 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 67 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
