...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2639-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-96ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_03:37_UTC-informational)
...
- **RTT mediano**: 96 ms
- **Última atualização (UTC)**: 2026-04-25 03:37 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 9 · vless × 106 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 63 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
