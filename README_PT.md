...
![nós](https://img.shields.io/badge/nós-147-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2216-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-293ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_18:10_UTC-informational)
...
- **Ativos em todas as fontes**: 2216
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 293 ms
- **Última atualização (UTC)**: 2026-05-04 18:10 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 23 · vless × 74 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 3 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
