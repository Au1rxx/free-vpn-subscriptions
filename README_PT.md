...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2294-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-120ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-20_02:25_UTC-informational)
...
- **RTT mediano**: 120 ms
- **Última atualização (UTC)**: 2026-05-20 02:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 6 · vless × 84 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 63 · `pawdroid` × 8 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
