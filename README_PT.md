...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1938-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-346ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_09:36_UTC-informational)
...
- **Nós selecionados**: 98
- **Ativos em todas as fontes**: 1938
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 346 ms
- **Última atualização (UTC)**: 2026-07-14 09:36 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 16 · vless × 14 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 6 · `snakem982` × 1 · `surfboard-eternity` × 5
