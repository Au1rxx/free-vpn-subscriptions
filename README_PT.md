...
![nós](https://img.shields.io/badge/nós-130-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2479-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-474ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_02:26_UTC-informational)
...
- **Ativos em todas as fontes**: 2479
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 474 ms
- **Última atualização (UTC)**: 2026-06-19 02:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 28 · vless × 56 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 26 · `pawdroid` × 4 · `ruking-clash` × 39 · `snakem982` × 6 · `surfboard-eternity` × 2
