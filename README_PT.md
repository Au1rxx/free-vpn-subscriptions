...
![nós](https://img.shields.io/badge/nós-140-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1914-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-397ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_16:22_UTC-informational)
...
- **RTT mediano**: 397 ms
- **Última atualização (UTC)**: 2026-07-15 16:22 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 56 · trojan × 46 · vless × 22 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `mahdi0024` × 14 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 9 · `ninjastrikers` × 16 · `pawdroid` × 8 · `ruking-clash` × 1 · `snakem982` × 12 · `surfboard-eternity` × 2
