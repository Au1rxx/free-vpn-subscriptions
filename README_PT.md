...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2174-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-75ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-26_07:32_UTC-informational)
...
- **Ativos em todas as fontes**: 2174
- **RTT do nó mais rápido**: 43 ms
- **RTT mediano**: 75 ms
- **Última atualização (UTC)**: 2026-05-26 07:32 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 14 · vless × 85 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `pawdroid` × 4 · `ruking-clash` × 9 · `surfboard-eternity` × 4
