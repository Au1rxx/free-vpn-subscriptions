...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2474-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-84ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-20_17:24_UTC-informational)
...
- **Ativos em todas as fontes**: 2474
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 84 ms
- **Última atualização (UTC)**: 2026-05-20 17:24 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 23 · vless × 69 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 54 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
