...
![nós](https://img.shields.io/badge/nós-71-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2407-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-148ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_15:33_UTC-informational)
...
- **RTT mediano**: 148 ms
- **Última atualização (UTC)**: 2026-07-02 15:33 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 16 · vless × 20 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 8 · `ninjastrikers` × 13 · `pawdroid` × 11 · `surfboard-eternity` × 2
