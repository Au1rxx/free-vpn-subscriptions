...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1865-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-369ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-13_11:32_UTC-informational)
...
- **RTT mediano**: 369 ms
- **Última atualização (UTC)**: 2026-06-13 11:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 56 · trojan × 23 · vless × 10 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 3
