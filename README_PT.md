...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2640-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-69ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-17_10:26_UTC-informational)
...
- **Ativos em todas as fontes**: 2640
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 69 ms
- **Última atualização (UTC)**: 2026-05-17 10:26 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 11 · vless × 93 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 7 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 11 · `ruking-clash` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
