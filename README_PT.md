...
![nós](https://img.shields.io/badge/nós-86-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2053-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-168ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_04:16_UTC-informational)
...
- **Nós selecionados**: 86
- **Ativos em todas as fontes**: 2053
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 168 ms
- **Última atualização (UTC)**: 2026-07-04 04:16 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 23 · vless × 13 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 7 · `ninjastrikers` × 20 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
