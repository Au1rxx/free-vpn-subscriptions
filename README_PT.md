...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1968-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-339ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_19:34_UTC-informational)
...
- **RTT mediano**: 339 ms
- **Última atualização (UTC)**: 2026-05-06 19:34 UTC

**Mix de protocolos:** shadowsocks × 46 · trojan × 24 · vless × 69 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 2
