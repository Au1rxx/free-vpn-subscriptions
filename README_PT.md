...
![nós](https://img.shields.io/badge/nós-119-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1953-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-333ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_06:26_UTC-informational)
...
- **Ativos em todas as fontes**: 1953
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 333 ms
- **Última atualização (UTC)**: 2026-07-06 06:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 26 · vless × 12 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 5
