...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2662-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-89ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-18_01:16_UTC-informational)
...
- **Ativos em todas as fontes**: 2662
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 89 ms
- **Última atualização (UTC)**: 2026-05-18 01:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 5 · vless × 94 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 6 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 38 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 58 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 6
