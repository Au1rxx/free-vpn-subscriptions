...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2144-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-402ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_08:09_UTC-informational)
...
- **Ativos em todas as fontes**: 2144
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 402 ms
- **Última atualização (UTC)**: 2026-07-17 08:09 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 81 · vless × 13 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 2 · `mahdi0024` × 41 · `mahdibland-aggregator` × 36 · `mahdibland-shadowsocks` × 36 · `matin-v2ray` × 5 · `ninjastrikers` × 8 · `pawdroid` × 2 · `snakem982` × 12 · `surfboard-eternity` × 4
