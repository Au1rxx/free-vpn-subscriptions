...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1956-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-484ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_10:19_UTC-informational)
...
- **RTT mediano**: 484 ms
- **Última atualização (UTC)**: 2026-06-18 10:19 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 25 · vless × 28 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 25 · `snakem982` × 5 · `surfboard-eternity` × 4
