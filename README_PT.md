...
![nós](https://img.shields.io/badge/nós-149-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2444-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-117ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_09:35_UTC-informational)
...
- **RTT mediano**: 117 ms
- **Última atualização (UTC)**: 2026-04-24 09:35 UTC

**Mix de protocolos:** shadowsocks × 13 · trojan × 23 · vless × 99 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 11 · `mahdi0024` × 29 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 75 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
