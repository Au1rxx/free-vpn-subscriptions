...
![nós](https://img.shields.io/badge/nós-117-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1984-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-348ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_03:17_UTC-informational)
...
- **Ativos em todas as fontes**: 1984
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 348 ms
- **Última atualização (UTC)**: 2026-06-28 03:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 32 · trojan × 38 · vless × 36 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 5
