...
![nós](https://img.shields.io/badge/nós-141-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2567-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-163ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_16:30_UTC-informational)
...
- **RTT mediano**: 163 ms
- **Última atualização (UTC)**: 2026-04-24 16:30 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 21 · vless × 84 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 32 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 56 · `pawdroid` × 1 · `surfboard-eternity` × 6
