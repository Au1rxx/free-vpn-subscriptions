...
![nós](https://img.shields.io/badge/nós-53-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2055-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-225ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_13:19_UTC-informational)
...
- **RTT mediano**: 225 ms
- **Última atualização (UTC)**: 2026-05-29 13:19 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 15 · vless × 9 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 8 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
