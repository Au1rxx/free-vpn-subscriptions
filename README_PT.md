...
![nós](https://img.shields.io/badge/nós-138-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2523-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-206ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_18:18_UTC-informational)
...
- **RTT mediano**: 206 ms
- **Última atualização (UTC)**: 2026-04-23 18:18 UTC

**Mix de protocolos:** shadowsocks × 15 · trojan × 26 · vless × 81 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
