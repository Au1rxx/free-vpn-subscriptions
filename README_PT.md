...
![nós](https://img.shields.io/badge/nós-132-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1860-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-385ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_18:10_UTC-informational)
...
- **Ativos em todas as fontes**: 1860
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 385 ms
- **Última atualização (UTC)**: 2026-07-15 18:10 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 73 · trojan × 27 · vless × 20 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `mahdi0024` × 18 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 14 · `surfboard-eternity` × 2
