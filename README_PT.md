...
![nós](https://img.shields.io/badge/nós-147-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2609-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-162ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_18:24_UTC-informational)
...
- **RTT mediano**: 162 ms
- **Última atualização (UTC)**: 2026-04-24 18:24 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 21 · vless × 85 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 7 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 55 · `pawdroid` × 1 · `surfboard-eternity` × 1
