...
![nós](https://img.shields.io/badge/nós-123-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1831-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-388ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_20:09_UTC-informational)
...
- **RTT mediano**: 388 ms
- **Última atualização (UTC)**: 2026-07-15 20:09 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 69 · trojan × 25 · vless × 17 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 3 · `epodonios` × 18 · `mahdi0024` × 17 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 6 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 9 · `surfboard-eternity` × 4
