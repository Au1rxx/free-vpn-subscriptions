...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2342-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-82ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-20_18:29_UTC-informational)
...
- **RTT mediano**: 82 ms
- **Última atualização (UTC)**: 2026-05-20 18:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 20 · vless × 70 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 9 · `surfboard-eternity` × 7
