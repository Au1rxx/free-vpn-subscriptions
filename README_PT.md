...
![nós](https://img.shields.io/badge/nós-58-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2382-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-132ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_18:13_UTC-informational)
...
- **RTT mediano**: 132 ms
- **Última atualização (UTC)**: 2026-07-02 18:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 22 · trojan × 12 · vless × 10 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 8 · `surfboard-eternity` × 2
