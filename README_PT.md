...
![nós](https://img.shields.io/badge/nós-91-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1918-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-309ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_19:17_UTC-informational)
...
- **RTT mediano**: 309 ms
- **Última atualização (UTC)**: 2026-07-13 19:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 11 · vless × 11 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `mahdi0024` × 26 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 6 · `ninjastrikers` × 7 · `pawdroid` × 2 · `ruking-clash` × 1
