...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1853-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-361ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_22:35_UTC-informational)
...
- **RTT mediano**: 361 ms
- **Última atualização (UTC)**: 2026-06-07 22:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 52 · trojan × 19 · vless × 15 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `ruking-clash` × 3 · `surfboard-eternity` × 1
