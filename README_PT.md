...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2158-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-157ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_18:39_UTC-informational)
...
- **Ativos em todas as fontes**: 2158
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 157 ms
- **Última atualização (UTC)**: 2026-05-01 18:39 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 15 · vless × 82 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 31 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
