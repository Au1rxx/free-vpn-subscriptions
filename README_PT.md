...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2381-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-94ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_02:35_UTC-informational)
...
- **Ativos em todas as fontes**: 2381
- **RTT do nó mais rápido**: 39 ms
- **RTT mediano**: 94 ms
- **Última atualização (UTC)**: 2026-05-21 02:35 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 15 · vless × 79 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 64 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 5
