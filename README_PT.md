...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1906-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-218ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_19:10_UTC-informational)
...
- **RTT mediano**: 218 ms
- **Última atualização (UTC)**: 2026-07-11 19:10 UTC

**Mix de protocolos:** shadowsocks × 51 · trojan × 5 · vless × 23 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 7 · `pawdroid` × 12 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 3
