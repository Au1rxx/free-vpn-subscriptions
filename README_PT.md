...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2002-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-402ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_13:15_UTC-informational)
...
- **Ativos em todas as fontes**: 2002
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 402 ms
- **Última atualização (UTC)**: 2026-07-16 13:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 52 · trojan × 72 · vless × 15 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 41 · `mahdibland-shadowsocks` × 44 · `matin-v2ray` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 8 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 10 · `surfboard-eternity` × 4
