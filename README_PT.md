...
![nós](https://img.shields.io/badge/nós-57-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2512-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-100ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_18:35_UTC-informational)
...
- **RTT mediano**: 100 ms
- **Última atualização (UTC)**: 2026-06-01 18:35 UTC

**Mix de protocolos:** shadowsocks × 16 · trojan × 16 · vless × 7 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `mahdi0024` × 18 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 5 · `pawdroid` × 4 · `surfboard-eternity` × 2
