...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2262-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-359ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_06:10_UTC-informational)
...
- **Ativos em todas as fontes**: 2262
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 359 ms
- **Última atualização (UTC)**: 2026-06-12 06:10 UTC

**Mix de protocolos:** shadowsocks × 46 · trojan × 41 · vless × 18 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 33 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 5
