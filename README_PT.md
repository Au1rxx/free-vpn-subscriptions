...
![nós](https://img.shields.io/badge/nós-141-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1903-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-278ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_03:26_UTC-informational)
...
- **RTT mediano**: 278 ms
- **Última atualização (UTC)**: 2026-07-12 03:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 62 · trojan × 26 · vless × 33 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 31 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 14 · `ninjastrikers` × 25 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 7
