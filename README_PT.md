...
![nós](https://img.shields.io/badge/nós-119-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1952-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-434ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_21:10_UTC-informational)
...
- **RTT mediano**: 434 ms
- **Última atualização (UTC)**: 2026-06-12 21:10 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 43 · vless × 13 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 33 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 8 · `surfboard-eternity` × 6
