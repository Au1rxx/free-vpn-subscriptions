...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1910-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-304ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_15:09_UTC-informational)
...
- **Nós selecionados**: 96
- **Ativos em todas as fontes**: 1910
- **RTT do nó mais rápido**: 22 ms
- **RTT mediano**: 304 ms
- **Última atualização (UTC)**: 2026-07-13 15:09 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 15 · vless × 10 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 23 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 3 · `ninjastrikers` × 6 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
