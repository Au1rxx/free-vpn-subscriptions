...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2344-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-90ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_23:16_UTC-informational)
...
- **RTT mediano**: 90 ms
- **Última atualização (UTC)**: 2026-06-02 23:16 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 29 · vless × 6 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `snakem982` × 1 · `surfboard-eternity` × 2
