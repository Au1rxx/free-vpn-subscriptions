...
![nós](https://img.shields.io/badge/nós-74-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2263-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-166ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_14:36_UTC-informational)
...
- **RTT mediano**: 166 ms
- **Última atualização (UTC)**: 2026-05-30 14:36 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 16 · vless × 7 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 6 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 3
