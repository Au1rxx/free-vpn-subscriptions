...
![nós](https://img.shields.io/badge/nós-107-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2113-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-357ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_08:29_UTC-informational)
...
- **RTT mediano**: 357 ms
- **Última atualização (UTC)**: 2026-07-02 08:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 28 · vless × 15 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 21 · `pawdroid` × 3 · `surfboard-eternity` × 4
