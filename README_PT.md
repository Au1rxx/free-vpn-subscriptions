...
![nós](https://img.shields.io/badge/nós-102-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2320-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-186ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_00:26_UTC-informational)
...
- **RTT mediano**: 186 ms
- **Última atualização (UTC)**: 2026-06-20 00:26 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 29 · vless × 19 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 19 · `surfboard-eternity` × 4
