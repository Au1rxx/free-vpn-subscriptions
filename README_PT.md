...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-393-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-116ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-19_07:09_UTC-informational)
...
- **Ativos em todas as fontes**: 393
- **RTT do nó mais rápido**: 9 ms
- **RTT mediano**: 116 ms
- **Última atualização (UTC)**: 2026-04-19 07:09 UTC

**Mix de protocolos:** shadowsocks × 104 · trojan × 7 · vmess × 39

**Fontes usadas nesta execução:** `freefq` × 2 · `mahdibland-aggregator` × 63 · `mahdibland-shadowsocks` × 67 · `pawdroid` × 3 · `vxiaov-clash` × 15
