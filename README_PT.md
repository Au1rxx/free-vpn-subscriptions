...
![nós](https://img.shields.io/badge/nós-138-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1815-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-387ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_19:09_UTC-informational)
...
- **RTT mediano**: 387 ms
- **Última atualização (UTC)**: 2026-07-15 19:09 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 72 · trojan × 34 · vless × 19 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `mahdi0024` × 23 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 3 · `ninjastrikers` × 15 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 3
