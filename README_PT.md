...
![nós](https://img.shields.io/badge/nós-149-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2356-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-20_19:15_UTC-informational)
...
- **Ativos em todas as fontes**: 2356
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-05-20 19:15 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 27 · vless × 65 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 7
