...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2239-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-401ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_02:15_UTC-informational)
...
- **RTT mediano**: 401 ms
- **Última atualização (UTC)**: 2026-07-17 02:15 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 75 · vless × 17 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 2 · `mahdi0024` × 43 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 36 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 8 · `surfboard-eternity` × 2
