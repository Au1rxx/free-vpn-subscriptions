...
![nós](https://img.shields.io/badge/nós-120-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1805-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-347ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_03:23_UTC-informational)
...
- **Ativos em todas as fontes**: 1805
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 347 ms
- **Última atualização (UTC)**: 2026-07-08 03:23 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 55 · trojan × 29 · vless × 18 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 7 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 3
