...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2238-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-162ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_14:11_UTC-informational)
...
- **RTT mediano**: 162 ms
- **Última atualização (UTC)**: 2026-04-25 14:11 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 19 · vless × 89 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 37 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 58 · `snakem982` × 1 · `surfboard-eternity` × 5
