...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1952-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-309ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_15:32_UTC-informational)
...
- **RTT mediano**: 309 ms
- **Última atualização (UTC)**: 2026-07-05 15:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 33 · vless × 10 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 6 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 4
