...
![nós](https://img.shields.io/badge/nós-149-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1654-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-393ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_13:13_UTC-informational)
...
- **Ativos em todas as fontes**: 1654
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 393 ms
- **Última atualização (UTC)**: 2026-07-15 13:13 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 93 · trojan × 35 · vless × 12 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 20 · `mahdi0024` × 13 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 9 · `surfboard-eternity` × 4
