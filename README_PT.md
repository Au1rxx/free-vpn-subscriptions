...
![nós](https://img.shields.io/badge/nós-148-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2480-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-234ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-09_14:30_UTC-informational)
...
- **RTT mediano**: 234 ms
- **Última atualização (UTC)**: 2026-05-09 14:30 UTC

**Mix de protocolos:** shadowsocks × 49 · trojan × 18 · vless × 73 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 3 · `ruking-clash` × 7 · `snakem982` × 2 · `surfboard-eternity` × 7
