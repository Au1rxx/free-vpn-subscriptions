...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2016-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-338ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_11:11_UTC-informational)
...
- **RTT mediano**: 338 ms
- **Última atualização (UTC)**: 2026-06-25 11:11 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 29 · vless × 34 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 34 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 7
