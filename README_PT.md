...
![nós](https://img.shields.io/badge/nós-135-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2216-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-167ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-28_19:27_UTC-informational)
...
- **RTT mediano**: 167 ms
- **Última atualização (UTC)**: 2026-04-28 19:27 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 23 · vless × 72 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
