...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2235-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-142ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_04:14_UTC-informational)
...
- **RTT mediano**: 142 ms
- **Última atualização (UTC)**: 2026-04-22 04:14 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 3 · vless × 102 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 38 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 67 · `ruking-clash` × 5 · `surfboard-eternity` × 6
