...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2380-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-97ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-13_07:29_UTC-informational)
...
- **RTT mediano**: 97 ms
- **Última atualização (UTC)**: 2026-05-13 07:29 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 7 · vless × 97 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 66 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
