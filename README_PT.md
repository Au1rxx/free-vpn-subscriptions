...
![nós](https://img.shields.io/badge/nós-134-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2565-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-302ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_16:35_UTC-informational)
...
- **RTT mediano**: 302 ms
- **Última atualização (UTC)**: 2026-04-22 16:35 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 19 · vless × 71 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 8
