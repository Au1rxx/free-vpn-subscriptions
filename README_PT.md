...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2388-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-150ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-09_09:28_UTC-informational)
...
- **Ativos em todas as fontes**: 2388
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 150 ms
- **Última atualização (UTC)**: 2026-05-09 09:28 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 17 · vless × 84 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 5 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 3 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
