...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1862-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-276ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_02:13_UTC-informational)
...
- **RTT mediano**: 276 ms
- **Última atualização (UTC)**: 2026-07-07 02:13 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 45 · trojan × 25 · vless × 18 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 6 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 4
