...
![nós](https://img.shields.io/badge/nós-89-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1877-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-365ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_14:16_UTC-informational)
...
- **RTT mediano**: 365 ms
- **Última atualização (UTC)**: 2026-06-07 14:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 48 · trojan × 20 · vless × 14 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 5
