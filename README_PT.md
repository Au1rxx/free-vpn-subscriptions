...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2294-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-159ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_01:17_UTC-informational)
...
- **RTT mediano**: 159 ms
- **Última atualização (UTC)**: 2026-06-10 01:17 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 14 · vless × 24 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 28 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 5
