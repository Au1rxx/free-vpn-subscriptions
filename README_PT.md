...
![nós](https://img.shields.io/badge/nós-140-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2556-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-370ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_15:16_UTC-informational)
...
- **RTT mediano**: 370 ms
- **Última atualização (UTC)**: 2026-04-22 15:16 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 21 · vless × 77 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 58 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 9
