...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2442-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-385ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_16:29_UTC-informational)
...
- **RTT mediano**: 385 ms
- **Última atualização (UTC)**: 2026-07-18 16:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 88 · vless × 17 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 31 · `mahdibland-aggregator` × 33 · `mahdibland-shadowsocks` × 35 · `matin-v2ray` × 5 · `ninjastrikers` × 4 · `pawdroid` × 11 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 3
