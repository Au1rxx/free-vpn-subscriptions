...
![nós](https://img.shields.io/badge/nós-147-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2281-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-435ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_21:31_UTC-informational)
...
- **RTT mediano**: 435 ms
- **Última atualização (UTC)**: 2026-04-21 21:31 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 23 · vless × 80 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 46 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 5
