...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2288-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-89ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_04:33_UTC-informational)
...
- **Nós selecionados**: 94
- **Ativos em todas as fontes**: 2288
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 89 ms
- **Última atualização (UTC)**: 2026-05-31 04:33 UTC

**Mix de protocolos:** shadowsocks × 15 · trojan × 27 · vless × 27 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 28 · `pawdroid` × 1 · `surfboard-eternity` × 2
