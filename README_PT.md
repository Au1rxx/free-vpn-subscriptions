...
![nós](https://img.shields.io/badge/nós-144-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2125-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-164ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-28_23:24_UTC-informational)
...
- **RTT mediano**: 164 ms
- **Última atualização (UTC)**: 2026-04-28 23:24 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 22 · vless × 78 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 39 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 7 · `ninjastrikers` × 55 · `ruking-clash` × 1 · `surfboard-eternity` × 6
