...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2343-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-401ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_21:35_UTC-informational)
...
- **Ativos em todas as fontes**: 2343
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 401 ms
- **Última atualização (UTC)**: 2026-07-17 21:35 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 97 · vless × 11 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `mahdi0024` × 65 · `mahdibland-aggregator` × 31 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 4 · `ninjastrikers` × 6 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 8 · `surfboard-eternity` × 3
