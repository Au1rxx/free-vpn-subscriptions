...
![nós](https://img.shields.io/badge/nós-64-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2070-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-143ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_10:21_UTC-informational)
...
- **RTT mediano**: 143 ms
- **Última atualização (UTC)**: 2026-07-10 10:21 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 8 · vless × 10 · vmess × 28

**Fontes usadas nesta execução:** `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
