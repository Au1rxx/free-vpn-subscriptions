...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1932-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-331ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_13:18_UTC-informational)
...
- **RTT mediano**: 331 ms
- **Última atualização (UTC)**: 2026-07-14 13:18 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 15 · vless × 13 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 4 · `ninjastrikers` × 10 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 3
