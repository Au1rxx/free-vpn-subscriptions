...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2473-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-129ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_17:30_UTC-informational)
...
- **RTT mediano**: 129 ms
- **Última atualização (UTC)**: 2026-04-27 17:30 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 17 · vless × 93 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
