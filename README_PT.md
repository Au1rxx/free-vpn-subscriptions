...
![nós](https://img.shields.io/badge/nós-72-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2143-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-139ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_11:16_UTC-informational)
...
- **RTT mediano**: 139 ms
- **Última atualização (UTC)**: 2026-05-30 11:16 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 8 · vless × 8 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 4 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
