...
![nós](https://img.shields.io/badge/nós-74-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2341-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-337ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-11_19:11_UTC-informational)
...
- **RTT mediano**: 337 ms
- **Última atualização (UTC)**: 2026-06-11 19:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 12 · vless × 14 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 8 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 4
