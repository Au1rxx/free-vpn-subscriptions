...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1958-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-225ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-07_17:31_UTC-informational)
...
- **RTT mediano**: 225 ms
- **Última atualização (UTC)**: 2026-05-07 17:31 UTC

**Mix de protocolos:** shadowsocks × 61 · trojan × 8 · vless × 72 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 8 · `mahdi0024` × 12 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 57 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
