...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2280-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-451ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-20_22:36_UTC-informational)
...
- **Ativos em todas as fontes**: 2280
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 451 ms
- **Última atualização (UTC)**: 2026-04-20 22:36 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 19 · vless × 95 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 60 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 44 · `ruking-clash` × 4 · `surfboard-eternity` × 5
