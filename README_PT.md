...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2207-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-153ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_13:26_UTC-informational)
...
- **RTT mediano**: 153 ms
- **Última atualização (UTC)**: 2026-04-30 13:26 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 18 · vless × 85 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 6 · `ninjastrikers` × 63 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
