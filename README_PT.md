...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2470-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-136ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-14_23:13_UTC-informational)
...
- **Ativos em todas as fontes**: 2470
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 136 ms
- **Última atualização (UTC)**: 2026-05-14 23:13 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 25 · vless × 79 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 50 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
