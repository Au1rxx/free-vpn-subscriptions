...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2192-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-156ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_02:24_UTC-informational)
...
- **RTT mediano**: 156 ms
- **Última atualização (UTC)**: 2026-04-22 02:24 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 4 · vless × 98 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 74 · `pawdroid` × 3 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 8
