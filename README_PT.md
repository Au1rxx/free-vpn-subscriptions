...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1785-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-365ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_13:16_UTC-informational)
...
- **RTT mediano**: 365 ms
- **Última atualização (UTC)**: 2026-07-07 13:16 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 59 · trojan × 22 · vless × 10 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 7 · `ruking-clash` × 3 · `surfboard-eternity` × 1
