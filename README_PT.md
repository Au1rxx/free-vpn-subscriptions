...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2087-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-119ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_13:34_UTC-informational)
...
- **RTT mediano**: 119 ms
- **Última atualização (UTC)**: 2026-04-29 13:34 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 6 · vless × 94 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 57 · `ruking-clash` × 7 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
