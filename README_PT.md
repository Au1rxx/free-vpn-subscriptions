...
![nós](https://img.shields.io/badge/nós-112-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1816-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-377ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_17:33_UTC-informational)
...
- **Ativos em todas as fontes**: 1816
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 377 ms
- **Última atualização (UTC)**: 2026-06-15 17:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 27 · vless × 18 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 17 · `surfboard-eternity` × 3
