...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2302-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-109ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_01:36_UTC-informational)
...
- **RTT mediano**: 109 ms
- **Última atualização (UTC)**: 2026-05-31 01:36 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 30 · vless × 31 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `epodonios` × 15 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 33 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
