...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2199-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-227ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_12:29_UTC-informational)
...
- **Ativos em todas as fontes**: 2199
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 227 ms
- **Última atualização (UTC)**: 2026-04-21 12:29 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 4 · vless × 104 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 59 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 2 · `ruking-clash` × 7 · `snakem982` × 2 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
