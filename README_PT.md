...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2515-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-106ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_01:33_UTC-informational)
...
- **Ativos em todas as fontes**: 2515
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 106 ms
- **Última atualização (UTC)**: 2026-05-10 01:33 UTC

**Mix de protocolos:** shadowsocks × 50 · trojan × 4 · vless × 88 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 66 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
