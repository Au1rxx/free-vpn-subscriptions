...
![nós](https://img.shields.io/badge/nós-110-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1975-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-283ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_09:20_UTC-informational)
...
- **RTT mediano**: 283 ms
- **Última atualização (UTC)**: 2026-07-12 09:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 17 · vless × 21 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 17 · `pawdroid` × 10 · `snakem982` × 1 · `surfboard-eternity` × 5
