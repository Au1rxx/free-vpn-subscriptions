...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2329-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-91ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-24_05:32_UTC-informational)
...
- **RTT mediano**: 91 ms
- **Última atualização (UTC)**: 2026-05-24 05:32 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 3 · vless × 87 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 34 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 56 · `pawdroid` × 4 · `surfboard-eternity` × 9
