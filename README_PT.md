...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1619-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-369ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_03:10_UTC-informational)
...
- **RTT mediano**: 369 ms
- **Última atualização (UTC)**: 2026-07-15 03:10 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 107 · trojan × 14 · vless × 18 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 27 · `mahdi0024` × 11 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 4 · `snakem982` × 3 · `surfboard-eternity` × 1
