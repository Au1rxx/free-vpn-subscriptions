...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1954-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-324ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_22:33_UTC-informational)
...
- **Ativos em todas as fontes**: 1954
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 324 ms
- **Última atualização (UTC)**: 2026-05-11 22:33 UTC

**Mix de protocolos:** shadowsocks × 52 · trojan × 18 · vless × 69 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 4 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 58 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
