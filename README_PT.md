...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1963-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-472ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_21:13_UTC-informational)
...
- **Ativos em todas as fontes**: 1963
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 472 ms
- **Última atualização (UTC)**: 2026-06-22 21:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 16 · vless × 79 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 56 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 21 · `snakem982` × 2 · `surfboard-eternity` × 4
