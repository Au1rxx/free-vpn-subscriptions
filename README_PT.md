...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2167-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-151ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-02_16:24_UTC-informational)
...
- **RTT mediano**: 151 ms
- **Última atualização (UTC)**: 2026-05-02 16:24 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 19 · vless × 85 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 34 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 2 · `surfboard-eternity` × 4
