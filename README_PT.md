...
![nós](https://img.shields.io/badge/nós-102-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2146-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-569ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_13:31_UTC-informational)
...
- **RTT mediano**: 569 ms
- **Última atualização (UTC)**: 2026-06-29 13:31 UTC

**Mix de protocolos:** shadowsocks × 16 · trojan × 52 · vless × 20 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `epodonios` × 18 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 10
