...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2084-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-85ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_02:21_UTC-informational)
...
- **RTT mediano**: 85 ms
- **Última atualização (UTC)**: 2026-05-03 02:21 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 5 · vless × 101 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 64 · `pawdroid` × 2 · `surfboard-eternity` × 4
