...
![nós](https://img.shields.io/badge/nós-121-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1965-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-284ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_05:15_UTC-informational)
...
- **RTT mediano**: 284 ms
- **Última atualização (UTC)**: 2026-07-06 05:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 27 · vless × 17 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 4 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
