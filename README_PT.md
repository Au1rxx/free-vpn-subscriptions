...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1857-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-369ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_09:12_UTC-informational)
...
- **RTT mediano**: 369 ms
- **Última atualização (UTC)**: 2026-06-15 09:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 22 · vless × 20 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 11 · `surfboard-eternity` × 9
