...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2218-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-123ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_06:21_UTC-informational)
...
- **RTT mediano**: 123 ms
- **Última atualização (UTC)**: 2026-04-22 06:21 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 4 · vless × 98 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 38 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 9
