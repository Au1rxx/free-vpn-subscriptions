...
![nós](https://img.shields.io/badge/nós-61-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1927-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-105ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-27_11:26_UTC-informational)
...
- **RTT mediano**: 105 ms
- **Última atualização (UTC)**: 2026-05-27 11:26 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 8 · vless × 15 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 3
