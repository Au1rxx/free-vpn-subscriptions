...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2258-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-95ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_06:36_UTC-informational)
...
- **RTT mediano**: 95 ms
- **Última atualização (UTC)**: 2026-05-01 06:36 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 11 · vless × 93 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 63 · `surfboard-eternity` × 5
