...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2049-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-72ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_10:11_UTC-informational)
...
- **RTT mediano**: 72 ms
- **Última atualização (UTC)**: 2026-05-22 10:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 34 · trojan × 11 · vless × 92 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 67 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 8
