...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2474-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-116ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-16_23:36_UTC-informational)
...
- **RTT mediano**: 116 ms
- **Última atualização (UTC)**: 2026-05-16 23:36 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 24 · vless × 76 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 6 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
