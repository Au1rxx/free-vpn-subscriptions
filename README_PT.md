...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2033-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-145ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_03:12_UTC-informational)
...
- **RTT mediano**: 145 ms
- **Última atualização (UTC)**: 2026-05-28 03:12 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 26 · vless × 34 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 26 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 2
