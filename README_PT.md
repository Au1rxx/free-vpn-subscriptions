...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1937-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-362ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_13:35_UTC-informational)
...
- **RTT mediano**: 362 ms
- **Última atualização (UTC)**: 2026-07-13 13:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 21 · vless × 19 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 15 · `mahdi0024` × 26 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
