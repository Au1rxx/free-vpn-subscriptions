...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2242-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-172ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_23:20_UTC-informational)
...
- **RTT mediano**: 172 ms
- **Última atualização (UTC)**: 2026-04-25 23:20 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 16 · vless × 87 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 36 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 50 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 5
