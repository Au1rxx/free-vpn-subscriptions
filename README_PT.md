...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2379-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_20:17_UTC-informational)
...
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-05-23 20:17 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 18 · vless × 67 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 40 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
