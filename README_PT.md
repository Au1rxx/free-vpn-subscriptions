...
![nós](https://img.shields.io/badge/nós-134-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1763-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-386ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_16:16_UTC-informational)
...
- **RTT mediano**: 386 ms
- **Última atualização (UTC)**: 2026-07-08 16:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 78 · trojan × 21 · vless × 11 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 21 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 4
