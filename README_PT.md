...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2206-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-167ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_22:29_UTC-informational)
...
- **RTT mediano**: 167 ms
- **Última atualização (UTC)**: 2026-06-06 22:29 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 20 · vless × 6 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 10 · `ruking-clash` × 1 · `surfboard-eternity` × 3
