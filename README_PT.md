...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1958-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-150ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-07_05:15_UTC-informational)
...
- **RTT mediano**: 150 ms
- **Última atualização (UTC)**: 2026-05-07 05:15 UTC

**Mix de protocolos:** shadowsocks × 51 · trojan × 5 · vless × 83 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 70 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
