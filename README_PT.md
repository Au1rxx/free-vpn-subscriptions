...
![nós](https://img.shields.io/badge/nós-124-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2069-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-384ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_08:24_UTC-informational)
...
- **RTT mediano**: 384 ms
- **Última atualização (UTC)**: 2026-06-24 08:24 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 29 · vless × 45 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 41 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 14 · `surfboard-eternity` × 2
