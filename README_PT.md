...
![nós](https://img.shields.io/badge/nós-146-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2265-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-76ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-19_04:31_UTC-informational)
...
- **RTT mediano**: 76 ms
- **Última atualização (UTC)**: 2026-05-19 04:31 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 23 · vless × 84 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 72 · `pawdroid` × 7 · `ruking-clash` × 1 · `surfboard-eternity` × 4
