...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2141-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-177ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_13:21_UTC-informational)
...
- **RTT mediano**: 177 ms
- **Última atualização (UTC)**: 2026-06-07 13:21 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 23 · vless × 9 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 4
