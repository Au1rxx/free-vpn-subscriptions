...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2006-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-393ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_06:29_UTC-informational)
...
- **RTT mediano**: 393 ms
- **Última atualização (UTC)**: 2026-07-16 06:29 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 44 · trojan × 71 · vless × 22 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 15 · `mahdibland-aggregator` × 42 · `mahdibland-shadowsocks` × 43 · `matin-v2ray` × 6 · `ninjastrikers` × 15 · `pawdroid` × 6 · `ruking-clash` × 2 · `snakem982` × 6 · `surfboard-eternity` × 1
