...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2347-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-399ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_04:32_UTC-informational)
...
- **RTT mediano**: 399 ms
- **Última atualização (UTC)**: 2026-07-18 04:32 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 92 · vless × 15 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 3 · `mahdi0024` × 53 · `mahdibland-aggregator` × 35 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 4 · `ruking-clash` × 4 · `snakem982` × 4 · `surfboard-eternity` × 3
