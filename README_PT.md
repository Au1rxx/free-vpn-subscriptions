...
![nós](https://img.shields.io/badge/nós-75-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1938-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-229ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_11:25_UTC-informational)
...
- **RTT mediano**: 229 ms
- **Última atualização (UTC)**: 2026-05-28 11:25 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 17 · vless × 13 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 3
