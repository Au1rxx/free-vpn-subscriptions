...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2276-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-151ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_01:36_UTC-informational)
...
- **RTT mediano**: 151 ms
- **Última atualização (UTC)**: 2026-04-21 01:36 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 3 · vless × 114 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 54 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 7
