...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1893-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-312ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_05:32_UTC-informational)
...
- **RTT mediano**: 312 ms
- **Última atualização (UTC)**: 2026-06-09 05:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 19 · vless × 20 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 5 · `surfboard-eternity` × 4
