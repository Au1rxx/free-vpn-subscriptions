...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2227-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-84ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_00:26_UTC-informational)
...
- **Ativos em todas as fontes**: 2227
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 84 ms
- **Última atualização (UTC)**: 2026-04-26 00:26 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 4 · vless × 99 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 30 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 64 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
