...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2205-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-112ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_03:25_UTC-informational)
...
- **RTT mediano**: 112 ms
- **Última atualização (UTC)**: 2026-05-01 03:25 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 3 · vless × 98 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 7 · `mahdi0024` × 25 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 63 · `pawdroid` × 2 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
