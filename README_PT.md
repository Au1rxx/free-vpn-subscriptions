...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1887-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-234ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_17:30_UTC-informational)
...
- **RTT mediano**: 234 ms
- **Última atualização (UTC)**: 2026-07-11 17:30 UTC

**Mix de protocolos:** shadowsocks × 48 · trojan × 18 · vless × 24 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 14 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 10 · `ninjastrikers` × 13 · `pawdroid` × 9 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
