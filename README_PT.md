...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2109-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-568ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_21:21_UTC-informational)
...
- **RTT mediano**: 568 ms
- **Última atualização (UTC)**: 2026-06-28 21:21 UTC

**Mix de protocolos:** shadowsocks × 16 · trojan × 30 · vless × 18 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 3
