...
![nós](https://img.shields.io/badge/nós-60-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1971-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-134ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-27_18:22_UTC-informational)
...
- **RTT mediano**: 134 ms
- **Última atualização (UTC)**: 2026-05-27 18:22 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 11 · vless × 19 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 1 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 4 · `ruking-clash` × 7 · `snakem982` × 1 · `surfboard-eternity` × 3
