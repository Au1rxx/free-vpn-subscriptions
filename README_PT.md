...
![nós](https://img.shields.io/badge/nós-135-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1874-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-346ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_01:19_UTC-informational)
...
- **Ativos em todas as fontes**: 1874
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 346 ms
- **Última atualização (UTC)**: 2026-06-16 01:19 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 30 · vless × 37 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 35 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
