...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2314-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-78ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-20_05:33_UTC-informational)
...
- **RTT mediano**: 78 ms
- **Última atualização (UTC)**: 2026-05-20 05:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 11 · vless × 79 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
