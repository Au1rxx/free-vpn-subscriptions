...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2264-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-165ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_20:12_UTC-informational)
...
- **Ativos em todas as fontes**: 2264
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 165 ms
- **Última atualização (UTC)**: 2026-04-25 20:12 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 22 · vless × 79 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 55 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
