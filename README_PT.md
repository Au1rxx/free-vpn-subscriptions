...
![nós](https://img.shields.io/badge/nós-133-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1635-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-480ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_20:27_UTC-informational)
...
- **RTT mediano**: 480 ms
- **Última atualização (UTC)**: 2026-06-14 20:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 61 · trojan × 32 · vless × 26 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 17 · `surfboard-eternity` × 4
