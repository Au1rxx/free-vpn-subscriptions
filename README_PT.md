...
![nós](https://img.shields.io/badge/nós-130-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2005-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-469ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_21:23_UTC-informational)
...
- **RTT mediano**: 469 ms
- **Última atualização (UTC)**: 2026-06-23 21:23 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 38 · trojan × 30 · vless × 45 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 45 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
