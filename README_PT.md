...
![nós](https://img.shields.io/badge/nós-147-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2126-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-85ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_19:11_UTC-informational)
...
- **RTT mediano**: 85 ms
- **Última atualização (UTC)**: 2026-05-21 19:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 33 · trojan × 33 · vless × 70 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `pawdroid` × 10 · `surfboard-eternity` × 2 · `vxiaov-clash` × 1
