...
![nós](https://img.shields.io/badge/nós-129-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2081-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-91ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-26_16:24_UTC-informational)
...
- **RTT mediano**: 91 ms
- **Última atualização (UTC)**: 2026-05-26 16:24 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 21 · vless × 65 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 45 · `pawdroid` × 8 · `ruking-clash` × 14 · `surfboard-eternity` × 2 · `vxiaov-clash` × 2
