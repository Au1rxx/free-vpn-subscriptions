...
![nós](https://img.shields.io/badge/nós-103-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1832-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-336ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_13:18_UTC-informational)
...
- **RTT mediano**: 336 ms
- **Última atualização (UTC)**: 2026-07-11 13:18 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 20 · vless × 17 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
