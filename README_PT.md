...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1972-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-126ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_02:23_UTC-informational)
...
- **RTT mediano**: 126 ms
- **Última atualização (UTC)**: 2026-05-12 02:23 UTC

**Mix de protocolos:** shadowsocks × 54 · trojan × 2 · vless × 84 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 7 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
