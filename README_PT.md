...
![nós](https://img.shields.io/badge/nós-91-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2395-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-165ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_11:37_UTC-informational)
...
- **RTT mediano**: 165 ms
- **Última atualização (UTC)**: 2026-06-01 11:37 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 29 · vless × 7 · vmess × 36

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 11 · `surfboard-eternity` × 2
