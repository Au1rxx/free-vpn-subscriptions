...
![nós](https://img.shields.io/badge/nós-134-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2048-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-361ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_02:30_UTC-informational)
...
- **Ativos em todas as fontes**: 2048
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 361 ms
- **Última atualização (UTC)**: 2026-06-24 02:30 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 27 · vless × 57 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 45 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 24 · `pawdroid` × 7 · `ruking-clash` × 12 · `surfboard-eternity` × 6
