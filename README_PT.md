...
![nós](https://img.shields.io/badge/nós-116-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2546-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-488ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_09:20_UTC-informational)
...
- **Ativos em todas as fontes**: 2546
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 488 ms
- **Última atualização (UTC)**: 2026-06-19 09:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 32 · trojan × 25 · vless × 41 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 15 · `mahdi0024` × 6 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 36 · `snakem982` × 4 · `surfboard-eternity` × 4
