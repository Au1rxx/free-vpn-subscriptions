...
![nós](https://img.shields.io/badge/nós-112-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2414-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-109ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_02:26_UTC-informational)
...
- **RTT mediano**: 109 ms
- **Última atualização (UTC)**: 2026-06-01 02:26 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 25 · vless × 32 · vmess × 33

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 32 · `pawdroid` × 7 · `surfboard-eternity` × 2
