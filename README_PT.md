...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2661-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-74ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-17_12:32_UTC-informational)
...
- **Ativos em todas as fontes**: 2661
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 74 ms
- **Última atualização (UTC)**: 2026-05-17 12:32 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 9 · vless × 89 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 6 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 5 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 5
