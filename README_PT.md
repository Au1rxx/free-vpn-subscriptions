...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2473-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-77ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_14:33_UTC-informational)
...
- **Ativos em todas as fontes**: 2473
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 77 ms
- **Última atualização (UTC)**: 2026-05-21 14:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 13 · vless × 83 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 58 · `pawdroid` × 10 · `ruking-clash` × 2 · `surfboard-eternity` × 8
