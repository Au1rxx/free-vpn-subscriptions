...
![nós](https://img.shields.io/badge/nós-144-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2256-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-293ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_19:17_UTC-informational)
...
- **RTT mediano**: 293 ms
- **Última atualização (UTC)**: 2026-05-04 19:17 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 25 · vless × 71 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 60 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
