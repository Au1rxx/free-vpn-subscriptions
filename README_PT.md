...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1798-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-337ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_09:11_UTC-informational)
...
- **Ativos em todas as fontes**: 1798
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 337 ms
- **Última atualização (UTC)**: 2026-07-11 09:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 21 · vless × 22 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 7 · `ninjastrikers` × 22 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 2
