...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1936-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-363ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_19:36_UTC-informational)
...
- **RTT mediano**: 363 ms
- **Última atualização (UTC)**: 2026-07-04 19:36 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 63 · trojan × 20 · vless × 8 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 38 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 6 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
