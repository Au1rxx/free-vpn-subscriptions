...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2012-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-100ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_00:40_UTC-informational)
...
- **Ativos em todas as fontes**: 2012
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 100 ms
- **Última atualização (UTC)**: 2026-05-22 00:40 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 13 · vless × 82 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 9 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 8
