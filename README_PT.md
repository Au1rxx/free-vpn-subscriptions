...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2124-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-176ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_03:26_UTC-informational)
...
- **RTT mediano**: 176 ms
- **Última atualização (UTC)**: 2026-06-21 03:26 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 26 · vless × 65 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 38 · `mahdi0024` × 29 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 5 · `ninjastrikers` × 24 · `pawdroid` × 2 · `ruking-clash` × 22 · `snakem982` × 1 · `surfboard-eternity` × 3
