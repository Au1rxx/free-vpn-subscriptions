...
![nós](https://img.shields.io/badge/nós-125-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2016-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-352ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_01:37_UTC-informational)
...
- **RTT mediano**: 352 ms
- **Última atualização (UTC)**: 2026-07-05 01:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 23 · vless × 23 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 39 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 7 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 6
