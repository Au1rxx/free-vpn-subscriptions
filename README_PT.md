...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1899-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-158ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_19:39_UTC-informational)
...
- **RTT mediano**: 158 ms
- **Última atualização (UTC)**: 2026-06-04 19:39 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 47 · vless × 19 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `ruking-clash` × 4 · `surfboard-eternity` × 2
