...
![nós](https://img.shields.io/badge/nós-145-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1944-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-461ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_11:25_UTC-informational)
...
- **RTT mediano**: 461 ms
- **Última atualização (UTC)**: 2026-06-17 11:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 24 · vless × 14 · vmess × 69

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `mahdi0024` × 71 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
