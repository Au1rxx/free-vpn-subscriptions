...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1991-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-343ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_21:30_UTC-informational)
...
- **RTT mediano**: 343 ms
- **Última atualização (UTC)**: 2026-06-10 21:30 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 18 · vless × 14 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
