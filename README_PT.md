...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2445-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-94ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-25_04:13_UTC-informational)
...
- **RTT mediano**: 94 ms
- **Última atualização (UTC)**: 2026-05-25 04:13 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 4 · vless × 79 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 42 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 6 · `ruking-clash` × 6 · `surfboard-eternity` × 6
