...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2360-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_18:33_UTC-informational)
...
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-05-23 18:33 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 21 · vless × 67 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 40 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 49 · `pawdroid` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
