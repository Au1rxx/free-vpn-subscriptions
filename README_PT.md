...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2454-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-112ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_04:24_UTC-informational)
...
- **Ativos em todas as fontes**: 2454
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 112 ms
- **Última atualização (UTC)**: 2026-05-11 04:24 UTC

**Mix de protocolos:** shadowsocks × 44 · trojan × 3 · vless × 95 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 71 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
