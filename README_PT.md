...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2413-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-227ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_20:29_UTC-informational)
...
- **RTT mediano**: 227 ms
- **Última atualização (UTC)**: 2026-05-10 20:29 UTC

**Mix de protocolos:** shadowsocks × 50 · trojan × 12 · vless × 77 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 52 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 6 · `surfboard-eternity` × 2 · `vxiaov-clash` × 1
