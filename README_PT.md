...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2217-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-398ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_00:27_UTC-informational)
...
- **RTT mediano**: 398 ms
- **Última atualização (UTC)**: 2026-07-17 00:27 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 74 · vless × 16 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `mahdi0024` × 41 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 42 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 4
