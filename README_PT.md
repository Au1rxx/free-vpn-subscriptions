...
![nós](https://img.shields.io/badge/nós-123-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1793-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-350ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_06:30_UTC-informational)
...
- **Ativos em todas as fontes**: 1793
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 350 ms
- **Última atualização (UTC)**: 2026-07-11 06:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 56 · trojan × 23 · vless × 25 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 7 · `ninjastrikers` × 22 · `pawdroid` × 9 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
