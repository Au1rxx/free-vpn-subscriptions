...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2274-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-275ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-20_15:11_UTC-informational)
...
- **RTT mediano**: 275 ms
- **Última atualização (UTC)**: 2026-04-20 15:11 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 12 · vless × 98 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 51 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `ruking-clash` × 6 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
