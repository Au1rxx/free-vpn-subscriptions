...
![nós](https://img.shields.io/badge/nós-120-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1774-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-378ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_14:16_UTC-informational)
...
- **RTT mediano**: 378 ms
- **Última atualização (UTC)**: 2026-07-09 14:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 63 · trojan × 17 · vless × 14 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 17 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 4 · `ninjastrikers` × 15 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 4
