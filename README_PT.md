...
![nós](https://img.shields.io/badge/nós-69-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2052-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-234ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_16:38_UTC-informational)
...
- **RTT mediano**: 234 ms
- **Última atualização (UTC)**: 2026-05-28 16:38 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 30 · trojan × 14 · vless × 12 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 5 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 3
