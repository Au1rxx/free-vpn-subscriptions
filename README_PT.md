...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2021-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-380ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_16:36_UTC-informational)
...
- **RTT mediano**: 380 ms
- **Última atualização (UTC)**: 2026-06-26 16:36 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 33 · vless × 17 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 17 · `surfboard-eternity` × 3
