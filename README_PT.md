...
![nós](https://img.shields.io/badge/nós-117-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1825-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-362ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_22:33_UTC-informational)
...
- **RTT mediano**: 362 ms
- **Última atualização (UTC)**: 2026-07-07 22:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 59 · trojan × 27 · vless × 15 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 7 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
