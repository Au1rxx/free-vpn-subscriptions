...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1976-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-337ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_23:32_UTC-informational)
...
- **Ativos em todas as fontes**: 1976
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 337 ms
- **Última atualização (UTC)**: 2026-05-06 23:32 UTC

**Mix de protocolos:** shadowsocks × 46 · trojan × 19 · vless × 71 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 61 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
