...
![nós](https://img.shields.io/badge/nós-81-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1892-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-355ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_20:24_UTC-informational)
...
- **RTT mediano**: 355 ms
- **Última atualização (UTC)**: 2026-06-08 20:24 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 14 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `ruking-clash` × 7 · `surfboard-eternity` × 4
