...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2272-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-398ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_03:21_UTC-informational)
...
- **Ativos em todas as fontes**: 2272
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 398 ms
- **Última atualização (UTC)**: 2026-07-18 03:21 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 81 · vless × 15 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `mahdi0024` × 59 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 4 · `surfboard-eternity` × 3
