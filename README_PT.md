...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1923-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-340ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_12:29_UTC-informational)
...
- **RTT mediano**: 340 ms
- **Última atualização (UTC)**: 2026-07-14 12:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 16 · vless × 11 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 25 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 4
