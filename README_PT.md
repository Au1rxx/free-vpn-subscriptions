...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2610-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-132ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_05:28_UTC-informational)
...
- **RTT mediano**: 132 ms
- **Última atualização (UTC)**: 2026-04-23 05:28 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 17 · vless × 96 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 74 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 8
