...
![nós](https://img.shields.io/badge/nós-140-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1862-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-398ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_15:19_UTC-informational)
...
- **Ativos em todas as fontes**: 1862
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 398 ms
- **Última atualização (UTC)**: 2026-07-15 15:19 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 55 · trojan × 50 · vless × 18 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 3 · `epodonios` × 18 · `mahdi0024` × 18 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 1
