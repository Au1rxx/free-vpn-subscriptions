...
![nós](https://img.shields.io/badge/nós-117-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1971-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-351ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_04:37_UTC-informational)
...
- **RTT mediano**: 351 ms
- **Última atualização (UTC)**: 2026-06-28 04:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 33 · trojan × 42 · vless × 30 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `ruking-clash` × 15 · `surfboard-eternity` × 7
