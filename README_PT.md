...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2208-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-163ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_04:31_UTC-informational)
...
- **RTT mediano**: 163 ms
- **Última atualização (UTC)**: 2026-06-07 04:31 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 23 · vless × 20 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 34 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 23 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 4
