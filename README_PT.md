...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2447-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-131ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_20:24_UTC-informational)
...
- **Ativos em todas as fontes**: 2447
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 131 ms
- **Última atualização (UTC)**: 2026-04-27 20:24 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 21 · vless × 90 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 31 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 50 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7
