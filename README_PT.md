...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1804-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-282ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_23:15_UTC-informational)
...
- **Ativos em todas as fontes**: 1804
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 282 ms
- **Última atualização (UTC)**: 2026-07-08 23:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 48 · trojan × 24 · vless × 13 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 7 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 5
