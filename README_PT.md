...
![nós](https://img.shields.io/badge/nós-85-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2142-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-170ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_13:11_UTC-informational)
...
- **Nós selecionados**: 85
- **Ativos em todas as fontes**: 2142
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 170 ms
- **Última atualização (UTC)**: 2026-05-30 13:11 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 24 · vless × 9 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 29 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 3 · `surfboard-eternity` × 5
