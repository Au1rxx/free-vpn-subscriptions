...
![nós](https://img.shields.io/badge/nós-121-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1977-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-368ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_07:33_UTC-informational)
...
- **RTT mediano**: 368 ms
- **Última atualização (UTC)**: 2026-06-28 07:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 42 · vless × 29 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
