...
![nós](https://img.shields.io/badge/nós-112-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2542-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-279ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_06:37_UTC-informational)
...
- **RTT mediano**: 279 ms
- **Última atualização (UTC)**: 2026-06-02 06:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 37 · vless × 16 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 19 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
