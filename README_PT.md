...
![nós](https://img.shields.io/badge/nós-101-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1924-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-403ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_16:25_UTC-informational)
...
- **RTT mediano**: 403 ms
- **Última atualização (UTC)**: 2026-06-25 16:25 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 37 · vless × 19 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 18 · `surfboard-eternity` × 2
