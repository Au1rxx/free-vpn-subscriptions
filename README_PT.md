...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2235-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-333ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-21_14:39_UTC-informational)
...
- **RTT mediano**: 333 ms
- **Última atualização (UTC)**: 2026-04-21 14:39 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 13 · vless × 90 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 50 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
