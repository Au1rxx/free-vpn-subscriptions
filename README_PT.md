...
![nós](https://img.shields.io/badge/nós-110-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1796-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-358ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_12:33_UTC-informational)
...
- **Ativos em todas as fontes**: 1796
- **RTT do nó mais rápido**: 47 ms
- **RTT mediano**: 358 ms
- **Última atualização (UTC)**: 2026-07-08 12:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 61 · trojan × 20 · vless × 16 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 10 · `lagzian-mix` × 7 · `mahdi0024` × 15 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 18 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 3
