...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1932-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-420ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_16:29_UTC-informational)
...
- **RTT mediano**: 420 ms
- **Última atualização (UTC)**: 2026-06-12 16:29 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 45 · trojan × 37 · vless × 12 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 6
