...
![nós](https://img.shields.io/badge/nós-144-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1926-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-481ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_13:37_UTC-informational)
...
- **RTT mediano**: 481 ms
- **Última atualização (UTC)**: 2026-06-22 13:37 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 29 · vless × 62 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 41 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 8
