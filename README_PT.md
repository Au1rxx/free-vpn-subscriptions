...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1904-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-310ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-07_23:23_UTC-informational)
...
- **RTT mediano**: 310 ms
- **Última atualização (UTC)**: 2026-05-07 23:23 UTC

**Mix de protocolos:** shadowsocks × 51 · trojan × 22 · vless × 68 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 9
