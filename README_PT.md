...
![nós](https://img.shields.io/badge/nós-123-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1819-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-312ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_06:16_UTC-informational)
...
- **Ativos em todas as fontes**: 1819
- **RTT do nó mais rápido**: 50 ms
- **RTT mediano**: 312 ms
- **Última atualização (UTC)**: 2026-07-08 06:16 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 55 · trojan × 28 · vless × 21 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 6 · `ninjastrikers` × 26 · `pawdroid` × 9 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 1
