...
![nós](https://img.shields.io/badge/nós-136-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1893-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-478ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_11:39_UTC-informational)
...
- **RTT mediano**: 478 ms
- **Última atualização (UTC)**: 2026-06-22 11:39 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 29 · vless × 50 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 30 · `snakem982` × 3 · `surfboard-eternity` × 3
