...
![nós](https://img.shields.io/badge/nós-74-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2238-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-131ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_13:10_UTC-informational)
...
- **RTT mediano**: 131 ms
- **Última atualização (UTC)**: 2026-05-31 13:10 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 21 · trojan × 19 · vless × 7 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 5 · `pawdroid` × 1 · `surfboard-eternity` × 1
