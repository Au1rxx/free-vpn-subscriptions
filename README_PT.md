...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2394-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-139ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_23:20_UTC-informational)
...
- **RTT mediano**: 139 ms
- **Última atualização (UTC)**: 2026-05-12 23:20 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 19 · vless × 84 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 43 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 44 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 2
