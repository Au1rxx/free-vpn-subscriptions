...
![nós](https://img.shields.io/badge/nós-134-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1915-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-349ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_03:20_UTC-informational)
...
- **RTT mediano**: 349 ms
- **Última atualização (UTC)**: 2026-07-06 03:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 33 · vless × 17 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 5 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 3
