...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2088-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-100ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-02_03:29_UTC-informational)
...
- **Ativos em todas as fontes**: 2088
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 100 ms
- **Última atualização (UTC)**: 2026-05-02 03:29 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 5 · vless × 94 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 6 · `mahdi0024` × 31 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
