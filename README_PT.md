...
![nós](https://img.shields.io/badge/nós-120-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1809-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-377ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_08:22_UTC-informational)
...
- **Ativos em todas as fontes**: 1809
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 377 ms
- **Última atualização (UTC)**: 2026-06-16 08:22 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 27 · vless × 27 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 20 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 4
