...
![nós](https://img.shields.io/badge/nós-112-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1869-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-279ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_03:26_UTC-informational)
...
- **Ativos em todas as fontes**: 1869
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 279 ms
- **Última atualização (UTC)**: 2026-07-07 03:26 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 45 · trojan × 22 · vless × 21 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 9 · `ninjastrikers` × 21 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 3
