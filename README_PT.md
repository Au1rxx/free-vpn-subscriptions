...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2637-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-91ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_05:33_UTC-informational)
...
- **Ativos em todas as fontes**: 2637
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 91 ms
- **Última atualização (UTC)**: 2026-04-25 05:33 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 16 · vless × 108 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 37 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 68 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
