...
![nós](https://img.shields.io/badge/nós-65-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2001-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-200ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_10:23_UTC-informational)
...
- **RTT mediano**: 200 ms
- **Última atualização (UTC)**: 2026-05-28 10:23 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 10 · vless × 14 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
