...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1958-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-290ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_18:14_UTC-informational)
...
- **RTT mediano**: 290 ms
- **Última atualização (UTC)**: 2026-07-04 18:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 48 · trojan × 13 · vless × 10 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 33 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 5 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 8
