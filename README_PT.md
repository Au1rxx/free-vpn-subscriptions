...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2278-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-179ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_22:25_UTC-informational)
...
- **RTT mediano**: 179 ms
- **Última atualização (UTC)**: 2026-04-25 22:25 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 18 · vless × 87 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 53 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 6
