...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2334-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-179ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_07:12_UTC-informational)
...
- **RTT mediano**: 179 ms
- **Última atualização (UTC)**: 2026-06-10 07:12 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 13 · vless × 14 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 2
