...
![nós](https://img.shields.io/badge/nós-68-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1921-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-131ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_04:32_UTC-informational)
...
- **RTT mediano**: 131 ms
- **Última atualização (UTC)**: 2026-07-03 04:32 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 17 · vless × 11 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 3 · `surfboard-eternity` × 2
