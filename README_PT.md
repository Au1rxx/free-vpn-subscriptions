...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2512-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-96ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-16_21:17_UTC-informational)
...
- **RTT mediano**: 96 ms
- **Última atualização (UTC)**: 2026-05-16 21:17 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 16 · vless × 82 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 35 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 4 · `ninjastrikers` × 42 · `pawdroid` × 6 · `ruking-clash` × 3 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
