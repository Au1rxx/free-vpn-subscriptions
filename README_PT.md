...
![nós](https://img.shields.io/badge/nós-112-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2240-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-398ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_12:23_UTC-informational)
...
- **RTT mediano**: 398 ms
- **Última atualização (UTC)**: 2026-07-01 12:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 39 · vless × 14 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 20 · `mfuu-clash` × 9 · `ninjastrikers` × 18 · `pawdroid` × 6 · `surfboard-eternity` × 4
