...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2033-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-103ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_00:19_UTC-informational)
...
- **Ativos em todas as fontes**: 2033
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 103 ms
- **Última atualização (UTC)**: 2026-05-28 00:19 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 26 · vless × 42 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 32 · `pawdroid` × 6 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 2
