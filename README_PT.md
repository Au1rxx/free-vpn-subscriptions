...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2233-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-114ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_14:39_UTC-informational)
...
- **RTT mediano**: 114 ms
- **Última atualização (UTC)**: 2026-05-01 14:39 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 15 · vless × 85 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 6
