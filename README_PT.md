...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1913-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-106ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_09:34_UTC-informational)
...
- **Ativos em todas as fontes**: 1913
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 106 ms
- **Última atualização (UTC)**: 2026-05-12 09:34 UTC

**Mix de protocolos:** shadowsocks × 60 · trojan × 2 · vless × 77 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 4 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 60 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
