...
![nós](https://img.shields.io/badge/nós-88-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2045-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-344ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_20:36_UTC-informational)
...
- **RTT mediano**: 344 ms
- **Última atualização (UTC)**: 2026-07-01 20:36 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 22 · vless × 11 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 5 · `ninjastrikers` × 17 · `surfboard-eternity` × 4
