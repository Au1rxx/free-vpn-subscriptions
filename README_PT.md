...
![nós](https://img.shields.io/badge/nós-142-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2461-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-121ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_10:16_UTC-informational)
...
- **RTT mediano**: 121 ms
- **Última atualização (UTC)**: 2026-04-24 10:16 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 22 · vless × 92 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 71 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
