...
![nós](https://img.shields.io/badge/nós-77-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2465-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-164ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_13:12_UTC-informational)
...
- **RTT mediano**: 164 ms
- **Última atualização (UTC)**: 2026-06-02 13:12 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 25 · vless × 6 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 35 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 8 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
