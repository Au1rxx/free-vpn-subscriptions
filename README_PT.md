...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1947-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-120ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-03_19:28_UTC-informational)
...
- **RTT mediano**: 120 ms
- **Última atualização (UTC)**: 2026-06-03 19:28 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 31 · vless × 15 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `mahdi0024` × 14 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 6 · `pawdroid` × 1 · `surfboard-eternity` × 3
