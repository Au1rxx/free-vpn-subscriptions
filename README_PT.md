...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2226-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-155ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_03:14_UTC-informational)
...
- **RTT mediano**: 155 ms
- **Última atualização (UTC)**: 2026-06-07 03:14 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 24 · vless × 26 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 33 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 1
