...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1660-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-390ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_16:22_UTC-informational)
...
- **Ativos em todas as fontes**: 1660
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 390 ms
- **Última atualização (UTC)**: 2026-07-14 16:22 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 96 · trojan × 27 · vless × 16 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 32 · `mahdi0024` × 12 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 32 · `matin-v2ray` × 6 · `ninjastrikers` × 12 · `pawdroid` × 9 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
