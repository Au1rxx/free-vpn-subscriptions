...
![nós](https://img.shields.io/badge/nós-117-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1980-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-110ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_01:22_UTC-informational)
...
- **RTT mediano**: 110 ms
- **Última atualização (UTC)**: 2026-06-04 01:22 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 46 · vless × 35 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 4 · `ninjastrikers` × 29 · `pawdroid` × 1 · `surfboard-eternity` × 2
