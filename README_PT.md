...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2330-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-397ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_05:23_UTC-informational)
...
- **RTT mediano**: 397 ms
- **Última atualização (UTC)**: 2026-07-18 05:23 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 89 · vless × 13 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 3 · `mahdi0024` × 50 · `mahdibland-aggregator` × 31 · `mahdibland-shadowsocks` × 35 · `matin-v2ray` × 3 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 4 · `snakem982` × 4 · `surfboard-eternity` × 3
