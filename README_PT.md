...
![nós](https://img.shields.io/badge/nós-89-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2353-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-160ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_04:27_UTC-informational)
...
- **RTT mediano**: 160 ms
- **Última atualização (UTC)**: 2026-06-10 04:27 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 13 · vless × 23 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 4
