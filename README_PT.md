...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2487-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-86ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_05:28_UTC-informational)
...
- **RTT mediano**: 86 ms
- **Última atualização (UTC)**: 2026-05-21 05:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 9 · vless × 81 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 64 · `pawdroid` × 8 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
