...
![nós](https://img.shields.io/badge/nós-141-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2555-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-186ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_11:35_UTC-informational)
...
- **Ativos em todas as fontes**: 2555
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 186 ms
- **Última atualização (UTC)**: 2026-04-23 11:35 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 22 · vless × 80 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 70 · `pawdroid` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
