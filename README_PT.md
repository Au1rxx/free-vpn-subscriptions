...
![nós](https://img.shields.io/badge/nós-144-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1974-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-501ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_22:32_UTC-informational)
...
- **RTT mediano**: 501 ms
- **Última atualização (UTC)**: 2026-06-16 22:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 16 · vmess × 54

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 58 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `ruking-clash` × 18
