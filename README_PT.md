...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1915-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-439ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_15:26_UTC-informational)
...
- **RTT mediano**: 439 ms
- **Última atualização (UTC)**: 2026-06-12 15:26 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 45 · trojan × 39 · vless × 12 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 3
