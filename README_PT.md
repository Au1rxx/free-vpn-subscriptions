...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1959-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-278ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_16:25_UTC-informational)
...
- **RTT mediano**: 278 ms
- **Última atualização (UTC)**: 2026-07-04 16:25 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 19 · vless × 12 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 11 · `pawdroid` × 6 · `ruking-clash` × 2 · `surfboard-eternity` × 4
