...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2548-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-93ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_02:27_UTC-informational)
...
- **Ativos em todas as fontes**: 2548
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 93 ms
- **Última atualização (UTC)**: 2026-04-27 02:27 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 3 · vless × 99 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 47 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 56 · `pawdroid` × 1 · `surfboard-eternity` × 4
