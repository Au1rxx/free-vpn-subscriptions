...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1925-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-241ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_13:13_UTC-informational)
...
- **RTT mediano**: 241 ms
- **Última atualização (UTC)**: 2026-07-12 13:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 59 · trojan × 14 · vless × 11 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 2
