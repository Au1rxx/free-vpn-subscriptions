...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2237-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-442ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-20_19:35_UTC-informational)
...
- **RTT mediano**: 442 ms
- **Última atualização (UTC)**: 2026-04-20 19:35 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 18 · vless × 90 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 50 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 10
