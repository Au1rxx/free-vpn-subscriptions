...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1913-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-336ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_05:25_UTC-informational)
...
- **RTT mediano**: 336 ms
- **Última atualização (UTC)**: 2026-07-14 05:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 22 · vless × 23 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 3 · `ninjastrikers` × 24 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
