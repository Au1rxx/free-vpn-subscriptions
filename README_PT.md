...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2143-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-150ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_23:17_UTC-informational)
...
- **RTT mediano**: 150 ms
- **Última atualização (UTC)**: 2026-07-09 23:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 23 · trojan × 12 · vless × 8 · vmess × 32

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
