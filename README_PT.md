...
![nós](https://img.shields.io/badge/nós-141-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2494-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-170ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-09_19:15_UTC-informational)
...
- **RTT mediano**: 170 ms
- **Última atualização (UTC)**: 2026-05-09 19:15 UTC

**Mix de protocolos:** shadowsocks × 52 · trojan × 16 · vless × 64 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 20 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
