...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1858-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-155ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_23:10_UTC-informational)
...
- **RTT mediano**: 155 ms
- **Última atualização (UTC)**: 2026-06-04 23:10 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 35 · vless × 20 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 6
