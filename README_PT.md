...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1775-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-360ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_10:13_UTC-informational)
...
- **Ativos em todas as fontes**: 1775
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 360 ms
- **Última atualização (UTC)**: 2026-07-09 10:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 56 · trojan × 20 · vless × 16 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 7 · `ninjastrikers` × 15 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 3
