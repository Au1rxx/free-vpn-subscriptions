...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2220-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-100ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_06:30_UTC-informational)
...
- **RTT mediano**: 100 ms
- **Última atualização (UTC)**: 2026-04-30 06:30 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 10 · vless × 97 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 14 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 71 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
