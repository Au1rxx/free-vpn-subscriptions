...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2253-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-397ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-20_18:10_UTC-informational)
...
- **RTT mediano**: 397 ms
- **Última atualização (UTC)**: 2026-04-20 18:10 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 16 · vless × 93 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 52 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 7
