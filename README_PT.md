...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2168-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-278ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_11:36_UTC-informational)
...
- **Ativos em todas as fontes**: 2168
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 278 ms
- **Última atualização (UTC)**: 2026-05-06 11:36 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 21 · vless × 81 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 67 · `surfboard-eternity` × 6
