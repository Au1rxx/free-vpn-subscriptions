...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2039-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-183ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_01:28_UTC-informational)
...
- **RTT mediano**: 183 ms
- **Última atualização (UTC)**: 2026-06-27 01:28 UTC

**Mix de protocolos:** shadowsocks × 17 · trojan × 35 · vless × 28 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 3
