...
![nós](https://img.shields.io/badge/nós-81-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2352-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-163ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_02:32_UTC-informational)
...
- **Nós selecionados**: 81
- **Ativos em todas as fontes**: 2352
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 163 ms
- **Última atualização (UTC)**: 2026-07-03 02:32 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 19 · vless × 14 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 20 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
