...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2307-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-399ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_08:34_UTC-informational)
...
- **RTT mediano**: 399 ms
- **Última atualização (UTC)**: 2026-07-18 08:34 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 103 · vless × 8 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 59 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 45 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
