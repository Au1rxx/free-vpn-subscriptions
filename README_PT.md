...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1779-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-360ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_14:33_UTC-informational)
...
- **Ativos em todas as fontes**: 1779
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 360 ms
- **Última atualização (UTC)**: 2026-07-08 14:33 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 56 · trojan × 21 · vless × 12 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 4 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 5
