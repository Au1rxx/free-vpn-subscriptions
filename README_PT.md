...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2363-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-111ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_00:11_UTC-informational)
...
- **Ativos em todas as fontes**: 2363
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 111 ms
- **Última atualização (UTC)**: 2026-06-01 00:11 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 30 · vless × 26 · vmess × 36

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 32 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
