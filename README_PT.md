...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2000-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-398ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_05:28_UTC-informational)
...
- **RTT mediano**: 398 ms
- **Última atualização (UTC)**: 2026-07-16 05:28 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 44 · trojan × 72 · vless × 22 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `mahdi0024` × 17 · `mahdibland-aggregator` × 49 · `mahdibland-shadowsocks` × 29 · `matin-v2ray` × 3 · `ninjastrikers` × 15 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 9 · `surfboard-eternity` × 3
