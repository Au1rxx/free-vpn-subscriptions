...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1900-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-376ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_14:18_UTC-informational)
...
- **RTT mediano**: 376 ms
- **Última atualização (UTC)**: 2026-06-17 14:18 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 23 · vless × 21 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 11 · `mahdi0024` × 14 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 20 · `surfboard-eternity` × 4
