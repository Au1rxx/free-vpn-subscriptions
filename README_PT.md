...
![nós](https://img.shields.io/badge/nós-129-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1898-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-356ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_04:18_UTC-informational)
...
- **RTT mediano**: 356 ms
- **Última atualização (UTC)**: 2026-06-16 04:18 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 30 · vless × 35 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 31 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 3
