...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2609-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-98ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-28_02:39_UTC-informational)
...
- **RTT mediano**: 98 ms
- **Última atualização (UTC)**: 2026-04-28 02:39 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 4 · vless × 113 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 6 · `ninjastrikers` × 62 · `ruking-clash` × 1 · `surfboard-eternity` × 4
