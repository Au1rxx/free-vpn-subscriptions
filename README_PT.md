...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2005-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-355ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_09:32_UTC-informational)
...
- **RTT mediano**: 355 ms
- **Última atualização (UTC)**: 2026-06-28 09:32 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 39 · vless × 27 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
