...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1931-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-341ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_20:09_UTC-informational)
...
- **RTT mediano**: 341 ms
- **Última atualização (UTC)**: 2026-07-13 20:09 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 19 · vless × 9 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `mahdi0024` × 24 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 8 · `ninjastrikers` × 13 · `pawdroid` × 2 · `snakem982` × 1
