...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2258-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-179ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_11:11_UTC-informational)
...
- **RTT mediano**: 179 ms
- **Última atualização (UTC)**: 2026-04-22 11:11 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 10 · vless × 99 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 48 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 59 · `pawdroid` × 2 · `ruking-clash` × 4 · `surfboard-eternity` × 7
