...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2159-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-399ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_19:21_UTC-informational)
...
- **RTT mediano**: 399 ms
- **Última atualização (UTC)**: 2026-07-16 19:21 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 71 · vless × 13 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `mahdi0024` × 49 · `mahdibland-aggregator` × 36 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 5 · `ninjastrikers` × 11 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 8 · `surfboard-eternity` × 4
