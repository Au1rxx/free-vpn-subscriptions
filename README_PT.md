...
![nós](https://img.shields.io/badge/nós-140-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1778-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-402ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_14:15_UTC-informational)
...
- **RTT mediano**: 402 ms
- **Última atualização (UTC)**: 2026-07-15 14:15 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 69 · trojan × 49 · vless × 11 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `mahdi0024` × 23 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 4 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 5
