...
![nós](https://img.shields.io/badge/nós-128-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2541-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-346ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_21:23_UTC-informational)
...
- **Ativos em todas as fontes**: 2541
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 346 ms
- **Última atualização (UTC)**: 2026-04-22 21:23 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 21 · vless × 67 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
