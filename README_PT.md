...
![nós](https://img.shields.io/badge/nós-137-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2535-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-275ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-09_17:36_UTC-informational)
...
- **RTT mediano**: 275 ms
- **Última atualização (UTC)**: 2026-05-09 17:36 UTC

**Mix de protocolos:** shadowsocks × 49 · trojan × 19 · vless × 61 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 58 · `pawdroid` × 1 · `ruking-clash` × 7 · `snakem982` × 3 · `surfboard-eternity` × 9
