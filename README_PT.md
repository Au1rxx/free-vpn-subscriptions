...
![nós](https://img.shields.io/badge/nós-86-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1857-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-357ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_09:12_UTC-informational)
...
- **RTT mediano**: 357 ms
- **Última atualização (UTC)**: 2026-06-09 09:12 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 18 · vless × 18 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
