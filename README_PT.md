...
![nós](https://img.shields.io/badge/nós-123-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1815-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-366ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_07:09_UTC-informational)
...
- **RTT mediano**: 366 ms
- **Última atualização (UTC)**: 2026-07-07 07:09 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 50 · trojan × 28 · vless × 19 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 10 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 2
