...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2354-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-89ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_16:18_UTC-informational)
...
- **RTT mediano**: 89 ms
- **Última atualização (UTC)**: 2026-05-22 16:18 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 16 · vless × 87 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 25 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 64 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 4
