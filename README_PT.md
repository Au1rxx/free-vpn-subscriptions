...
![nós](https://img.shields.io/badge/nós-83-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1845-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-378ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_19:26_UTC-informational)
...
- **RTT mediano**: 378 ms
- **Última atualização (UTC)**: 2026-06-30 19:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 33 · trojan × 30 · vless × 14 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 8 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 3
