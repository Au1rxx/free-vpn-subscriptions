...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2021-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-394ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_12:26_UTC-informational)
...
- **RTT mediano**: 394 ms
- **Última atualização (UTC)**: 2026-07-16 12:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 72 · vless × 14 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 7 · `mahdi0024` × 11 · `mahdibland-aggregator` × 44 · `mahdibland-shadowsocks` × 38 · `matin-v2ray` × 4 · `mfuu-clash` × 5 · `ninjastrikers` × 9 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 8 · `surfboard-eternity` × 4
