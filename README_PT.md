...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1983-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-373ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_23:25_UTC-informational)
...
- **RTT mediano**: 373 ms
- **Última atualização (UTC)**: 2026-06-12 23:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 44 · vless × 11 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 33 · `lagzian-mix` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 7
