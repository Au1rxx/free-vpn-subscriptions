...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2445-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-118ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_03:27_UTC-informational)
...
- **RTT mediano**: 118 ms
- **Última atualização (UTC)**: 2026-04-24 03:27 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 12 · vless × 102 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 73 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
