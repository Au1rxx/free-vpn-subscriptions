...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2210-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-154ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_11:30_UTC-informational)
...
- **Ativos em todas as fontes**: 2210
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 154 ms
- **Última atualização (UTC)**: 2026-04-30 11:30 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 20 · vless × 86 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 36 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 64 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
