...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2196-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-360ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-19_05:32_UTC-informational)
...
- **Ativos em todas as fontes**: 2196
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 360 ms
- **Última atualização (UTC)**: 2026-07-19 05:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 78 · vless × 16 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 67 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 8 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 5
