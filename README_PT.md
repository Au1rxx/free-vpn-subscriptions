...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2491-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-98ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_04:25_UTC-informational)
...
- **RTT mediano**: 98 ms
- **Última atualização (UTC)**: 2026-05-10 04:25 UTC

**Mix de protocolos:** shadowsocks × 47 · trojan × 3 · vless × 91 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 34 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 60 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 6
