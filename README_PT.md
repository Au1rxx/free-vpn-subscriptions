...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2604-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-164ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_03:37_UTC-informational)
...
- **Ativos em todas as fontes**: 2604
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 164 ms
- **Última atualização (UTC)**: 2026-04-23 03:37 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 16 · vless × 96 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 77 · `snakem982` × 1 · `surfboard-eternity` × 6
