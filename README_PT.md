...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2320-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-170ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_03:11_UTC-informational)
...
- **RTT mediano**: 170 ms
- **Última atualização (UTC)**: 2026-06-10 03:11 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 14 · vless × 25 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 24 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 6
