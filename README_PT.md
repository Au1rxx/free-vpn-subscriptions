...
![nós](https://img.shields.io/badge/nós-71-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2394-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-119ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_17:25_UTC-informational)
...
- **RTT mediano**: 119 ms
- **Última atualização (UTC)**: 2026-06-01 17:25 UTC

**Mix de protocolos:** shadowsocks × 15 · trojan × 18 · vless × 6 · vmess × 32

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
