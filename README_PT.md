...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2069-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-212ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_14:31_UTC-informational)
...
- **Ativos em todas as fontes**: 2069
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 212 ms
- **Última atualização (UTC)**: 2026-07-12 14:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 57 · trojan × 17 · vless × 21 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `mfuu-clash` × 6 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 4
