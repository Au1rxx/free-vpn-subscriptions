...
![nós](https://img.shields.io/badge/nós-112-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1776-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-360ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_12:29_UTC-informational)
...
- **RTT mediano**: 360 ms
- **Última atualização (UTC)**: 2026-07-09 12:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 56 · trojan × 21 · vless × 10 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 3 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 3
