...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2407-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-135ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_09:33_UTC-informational)
...
- **Ativos em todas as fontes**: 2407
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 135 ms
- **Última atualização (UTC)**: 2026-05-11 09:33 UTC

**Mix de protocolos:** shadowsocks × 46 · trojan × 4 · vless × 92 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 5
