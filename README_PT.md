...
![nós](https://img.shields.io/badge/nós-85-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1945-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-181ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_14:31_UTC-informational)
...
- **RTT mediano**: 181 ms
- **Última atualização (UTC)**: 2026-07-03 14:31 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 25 · vless × 12 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 8 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
