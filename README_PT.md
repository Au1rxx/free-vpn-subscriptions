...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2202-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-112ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_11:38_UTC-informational)
...
- **RTT mediano**: 112 ms
- **Última atualização (UTC)**: 2026-04-26 11:38 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 15 · vless × 96 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
