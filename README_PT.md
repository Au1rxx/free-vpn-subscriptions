...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2079-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-157ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_23:34_UTC-informational)
...
- **RTT mediano**: 157 ms
- **Última atualização (UTC)**: 2026-05-01 23:34 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 15 · vless × 85 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 53 · `pawdroid` × 1 · `surfboard-eternity` × 9
