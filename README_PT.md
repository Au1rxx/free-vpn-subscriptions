...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2561-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-75ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-16_10:18_UTC-informational)
...
- **Ativos em todas as fontes**: 2561
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 75 ms
- **Última atualização (UTC)**: 2026-05-16 10:18 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 13 · vless × 96 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `pawdroid` × 7 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
