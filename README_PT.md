...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2281-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-171ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-25_17:36_UTC-informational)
...
- **RTT mediano**: 171 ms
- **Última atualização (UTC)**: 2026-04-25 17:36 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 18 · vless × 85 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 55 · `snakem982` × 3 · `surfboard-eternity` × 7
