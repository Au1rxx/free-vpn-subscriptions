...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2175-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-99ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_04:36_UTC-informational)
...
- **RTT mediano**: 99 ms
- **Última atualização (UTC)**: 2026-04-26 04:36 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 10 · vless × 102 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 26 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 73 · `pawdroid` × 3 · `surfboard-eternity` × 4
