...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2054-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-87ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_22:10_UTC-informational)
...
- **RTT mediano**: 87 ms
- **Última atualização (UTC)**: 2026-05-21 22:10 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 32 · vless × 70 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 40 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 11 · `surfboard-eternity` × 5
