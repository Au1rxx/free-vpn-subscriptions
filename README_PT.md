...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2060-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-299ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_02:28_UTC-informational)
...
- **RTT mediano**: 299 ms
- **Última atualização (UTC)**: 2026-07-02 02:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 34 · vless × 21 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 24 · `pawdroid` × 4 · `surfboard-eternity` × 5
