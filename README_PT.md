...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2203-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-265ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-11_08:28_UTC-informational)
...
- **RTT mediano**: 265 ms
- **Última atualização (UTC)**: 2026-06-11 08:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 11 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 6
