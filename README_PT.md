...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2582-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-84ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-16_06:39_UTC-informational)
...
- **Ativos em todas as fontes**: 2582
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 84 ms
- **Última atualização (UTC)**: 2026-05-16 06:39 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 15 · vless × 94 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 61 · `pawdroid` × 6 · `ruking-clash` × 6 · `surfboard-eternity` × 4
