...
![nós](https://img.shields.io/badge/nós-84-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2086-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-178ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_19:33_UTC-informational)
...
- **Nós selecionados**: 84
- **Ativos em todas as fontes**: 2086
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 178 ms
- **Última atualização (UTC)**: 2026-06-06 19:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 32 · trojan × 20 · vless × 7 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 39 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 2
