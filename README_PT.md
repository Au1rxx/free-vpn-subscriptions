...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2096-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-223ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_20:26_UTC-informational)
...
- **Ativos em todas as fontes**: 2096
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 223 ms
- **Última atualização (UTC)**: 2026-04-29 20:26 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 18 · vless × 80 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 6 · `ninjastrikers` × 56 · `surfboard-eternity` × 8
