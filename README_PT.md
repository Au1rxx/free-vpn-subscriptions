...
![nós](https://img.shields.io/badge/nós-130-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2018-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-263ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_17:34_UTC-informational)
...
- **RTT mediano**: 263 ms
- **Última atualização (UTC)**: 2026-07-12 17:34 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 60 · trojan × 24 · vless × 30 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 34 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `mfuu-clash` × 5 · `ninjastrikers` × 15 · `pawdroid` × 12 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 2
