...
![nós](https://img.shields.io/badge/nós-101-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1918-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-355ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_10:24_UTC-informational)
...
- **RTT mediano**: 355 ms
- **Última atualização (UTC)**: 2026-07-14 10:24 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 19 · vless × 9 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 14 · `pawdroid` × 6 · `surfboard-eternity` × 7
