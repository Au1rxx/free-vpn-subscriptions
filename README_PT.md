...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2201-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-157ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-02_14:31_UTC-informational)
...
- **RTT mediano**: 157 ms
- **Última atualização (UTC)**: 2026-05-02 14:31 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 20 · vless × 84 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 24 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 58 · `pawdroid` × 4 · `surfboard-eternity` × 5
