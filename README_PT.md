...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1967-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-365ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_17:29_UTC-informational)
...
- **RTT mediano**: 365 ms
- **Última atualização (UTC)**: 2026-05-06 17:29 UTC

**Mix de protocolos:** shadowsocks × 48 · trojan × 20 · vless × 71 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 58 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
