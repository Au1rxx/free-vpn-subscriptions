...
![nós](https://img.shields.io/badge/nós-129-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2268-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-84ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-18_20:37_UTC-informational)
...
- **Ativos em todas as fontes**: 2268
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 84 ms
- **Última atualização (UTC)**: 2026-05-18 20:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 16 · trojan × 25 · vless × 68 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `ruking-clash` × 7 · `surfboard-eternity` × 4
