...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2447-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-78ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-15_07:14_UTC-informational)
...
- **RTT mediano**: 78 ms
- **Última atualização (UTC)**: 2026-05-15 07:14 UTC

**Mix de protocolos:** shadowsocks × 44 · trojan × 4 · vless × 93 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 3 · `ninjastrikers` × 62 · `pawdroid` × 5 · `ruking-clash` × 5 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
