...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2055-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-132ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_04:12_UTC-informational)
...
- **RTT mediano**: 132 ms
- **Última atualização (UTC)**: 2026-05-22 04:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 13 · vless × 86 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 67 · `pawdroid` × 5 · `ruking-clash` × 7 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
