...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2273-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-159ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_08:34_UTC-informational)
...
- **RTT mediano**: 159 ms
- **Última atualização (UTC)**: 2026-04-22 08:34 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 4 · vless × 103 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 42 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 6
