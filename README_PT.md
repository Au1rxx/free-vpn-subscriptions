...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2589-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-94ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-28_05:37_UTC-informational)
...
- **Ativos em todas as fontes**: 2589
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 94 ms
- **Última atualização (UTC)**: 2026-04-28 05:37 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 10 · vless × 109 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 4
