...
![nós](https://img.shields.io/badge/nós-62-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2410-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-146ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_21:22_UTC-informational)
...
- **RTT mediano**: 146 ms
- **Última atualização (UTC)**: 2026-07-02 21:22 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 15 · vless × 6 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `surfboard-eternity` × 5
