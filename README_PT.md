...
![nós](https://img.shields.io/badge/nós-145-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1803-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-366ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_04:25_UTC-informational)
...
- **Ativos em todas as fontes**: 1803
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 366 ms
- **Última atualização (UTC)**: 2026-07-08 04:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 70 · trojan × 29 · vless × 24 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 8 · `ninjastrikers` × 24 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 8
