...
![nós](https://img.shields.io/badge/nós-121-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1906-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-275ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_04:35_UTC-informational)
...
- **RTT mediano**: 275 ms
- **Última atualização (UTC)**: 2026-07-12 04:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 18 · vless × 27 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 9 · `ninjastrikers` × 23 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 3
