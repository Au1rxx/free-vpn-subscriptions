...
![nós](https://img.shields.io/badge/nós-123-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2075-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-379ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_17:36_UTC-informational)
...
- **RTT mediano**: 379 ms
- **Última atualização (UTC)**: 2026-06-24 17:36 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 33 · vless × 38 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 40 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 3
