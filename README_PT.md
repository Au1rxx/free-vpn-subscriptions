...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2244-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-142ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-22_05:30_UTC-informational)
...
- **RTT mediano**: 142 ms
- **Última atualização (UTC)**: 2026-04-22 05:30 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 2 · vless × 98 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 40 · `epodonios` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 62 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 9
