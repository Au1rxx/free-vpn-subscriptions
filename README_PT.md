...
![nós](https://img.shields.io/badge/nós-84-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2217-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-178ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_23:34_UTC-informational)
...
- **RTT mediano**: 178 ms
- **Última atualização (UTC)**: 2026-06-06 23:34 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 31 · trojan × 21 · vless × 8 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
