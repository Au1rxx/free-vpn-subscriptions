...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1998-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-363ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_01:22_UTC-informational)
...
- **RTT mediano**: 363 ms
- **Última atualização (UTC)**: 2026-06-23 01:22 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 28 · vless × 68 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 57 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 24 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
