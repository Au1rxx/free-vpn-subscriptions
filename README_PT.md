...
![nós](https://img.shields.io/badge/nós-139-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2090-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-281ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_16:30_UTC-informational)
...
- **RTT mediano**: 281 ms
- **Última atualização (UTC)**: 2026-05-03 16:30 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 23 · vless × 78 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
