...
![nós](https://img.shields.io/badge/nós-102-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1925-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-361ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_20:21_UTC-informational)
...
- **RTT mediano**: 361 ms
- **Última atualização (UTC)**: 2026-07-06 20:21 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 46 · trojan × 26 · vless × 9 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 5 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 1
