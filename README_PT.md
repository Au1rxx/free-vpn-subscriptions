...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-394-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-137ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-19_09:40_UTC-informational)
...
- **RTT mediano**: 137 ms
- **Última atualização (UTC)**: 2026-04-19 09:40 UTC

**Mix de protocolos:** shadowsocks × 101 · trojan × 8 · vmess × 41

**Fontes usadas nesta execução:** `freefq` × 2 · `mahdibland-aggregator` × 56 · `mahdibland-shadowsocks` × 73 · `pawdroid` × 4 · `vxiaov-clash` × 15
