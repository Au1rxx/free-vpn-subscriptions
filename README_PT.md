...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2213-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-403ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_05:10_UTC-informational)
...
- **RTT mediano**: 403 ms
- **Última atualização (UTC)**: 2026-07-17 05:10 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 80 · vless × 15 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 3 · `mahdi0024` × 45 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 32 · `matin-v2ray` × 7 · `ninjastrikers` × 16 · `pawdroid` × 5 · `snakem982` × 7 · `surfboard-eternity` × 4
