...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1813-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-401ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-13_17:28_UTC-informational)
...
- **RTT mediano**: 401 ms
- **Última atualização (UTC)**: 2026-06-13 17:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 29 · vless × 14 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 5
