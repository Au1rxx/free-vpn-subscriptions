...
![nós](https://img.shields.io/badge/nós-119-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2519-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-429ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-23_20:36_UTC-informational)
...
- **Ativos em todas as fontes**: 2519
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 429 ms
- **Última atualização (UTC)**: 2026-04-23 20:36 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 25 · vless × 65 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `surfboard-eternity` × 6
