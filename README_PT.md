...
![nós](https://img.shields.io/badge/nós-62-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1987-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-162ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-27_22:14_UTC-informational)
...
- **RTT mediano**: 162 ms
- **Última atualização (UTC)**: 2026-05-27 22:14 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 20 · vless × 8 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `ruking-clash` × 2 · `snakem982` × 7 · `surfboard-eternity` × 2
