...
![nós](https://img.shields.io/badge/nós-149-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2451-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-109ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-24_08:36_UTC-informational)
...
- **RTT mediano**: 109 ms
- **Última atualização (UTC)**: 2026-04-24 08:36 UTC

**Mix de protocolos:** shadowsocks × 13 · trojan × 23 · vless × 100 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 76 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 1
