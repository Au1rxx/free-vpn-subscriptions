...
![nós](https://img.shields.io/badge/nós-139-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1902-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-426ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_08:39_UTC-informational)
...
- **RTT mediano**: 426 ms
- **Última atualização (UTC)**: 2026-06-22 08:39 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 26 · vless × 54 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 4 · `surfboard-eternity` × 4
