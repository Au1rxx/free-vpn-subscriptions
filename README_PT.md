...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2148-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-120ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_15:35_UTC-informational)
...
- **RTT mediano**: 120 ms
- **Última atualização (UTC)**: 2026-05-01 15:35 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 10 · vless × 88 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
