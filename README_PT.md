...
![nós](https://img.shields.io/badge/nós-83-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2351-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-122ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_10:27_UTC-informational)
...
- **Nós selecionados**: 83
- **Ativos em todas as fontes**: 2351
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 122 ms
- **Última atualização (UTC)**: 2026-06-01 10:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 19 · trojan × 25 · vless × 7 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 25 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 11 · `pawdroid` × 2 · `surfboard-eternity` × 4
