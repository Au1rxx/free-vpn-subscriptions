...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2455-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-78ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-18_12:37_UTC-informational)
...
- **RTT mediano**: 78 ms
- **Última atualização (UTC)**: 2026-05-18 12:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 8 · vless × 89 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 40 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 53 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
