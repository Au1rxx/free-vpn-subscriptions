...
![nós](https://img.shields.io/badge/nós-125-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1758-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-374ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_15:18_UTC-informational)
...
- **RTT mediano**: 374 ms
- **Última atualização (UTC)**: 2026-07-08 15:18 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 69 · trojan × 20 · vless × 12 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 6
