...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2103-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-84ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_00:24_UTC-informational)
...
- **RTT mediano**: 84 ms
- **Última atualização (UTC)**: 2026-05-03 00:24 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 7 · vless × 100 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 62 · `surfboard-eternity` × 8 · `vxiaov-clash` × 2
