...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2253-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-164ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-30_14:18_UTC-informational)
...
- **RTT mediano**: 164 ms
- **Última atualização (UTC)**: 2026-04-30 14:18 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 18 · vless × 82 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 36 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 56 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
