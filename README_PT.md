...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2174-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-104ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_04:39_UTC-informational)
...
- **RTT mediano**: 104 ms
- **Última atualização (UTC)**: 2026-05-03 04:39 UTC

**Mix de protocolos:** shadowsocks × 31 · trojan × 4 · vless × 106 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 6 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 69 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
