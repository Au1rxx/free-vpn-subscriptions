...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2336-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-398ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_07:33_UTC-informational)
...
- **RTT mediano**: 398 ms
- **Última atualização (UTC)**: 2026-07-18 07:33 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 100 · vless × 9 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 3 · `mahdi0024` × 64 · `mahdibland-aggregator` × 35 · `mahdibland-shadowsocks` × 29 · `matin-v2ray` × 3 · `ninjastrikers` × 4 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
