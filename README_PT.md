...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2430-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-80ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-15_11:11_UTC-informational)
...
- **RTT mediano**: 80 ms
- **Última atualização (UTC)**: 2026-05-15 11:11 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 5 · vless × 93 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 3 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `pawdroid` × 7 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
