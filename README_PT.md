...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2078-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-183ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_19:20_UTC-informational)
...
- **Ativos em todas as fontes**: 2078
- **RTT do nó mais rápido**: 39 ms
- **RTT mediano**: 183 ms
- **Última atualização (UTC)**: 2026-04-29 19:20 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 15 · vless × 82 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 57 · `pawdroid` × 1 · `surfboard-eternity` × 6
