...
![nós](https://img.shields.io/badge/nós-131-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2100-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-474ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_20:31_UTC-informational)
...
- **RTT mediano**: 474 ms
- **Última atualização (UTC)**: 2026-06-20 20:31 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 34 · vless × 32 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 38 · `surfboard-eternity` × 3
