...
![nós](https://img.shields.io/badge/nós-84-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2079-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-164ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_06:16_UTC-informational)
...
- **RTT mediano**: 164 ms
- **Última atualização (UTC)**: 2026-05-29 06:16 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 31 · vless × 18 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
