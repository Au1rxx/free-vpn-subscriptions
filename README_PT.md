...
![nós](https://img.shields.io/badge/nós-70-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2055-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-203ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_09:15_UTC-informational)
...
- **RTT mediano**: 203 ms
- **Última atualização (UTC)**: 2026-05-28 09:15 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 14 · vless × 16 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 6 · `ruking-clash` × 2 · `snakem982` × 4 · `surfboard-eternity` × 4
