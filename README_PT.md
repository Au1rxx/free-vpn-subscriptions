...
![nós](https://img.shields.io/badge/nós-140-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1720-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-496ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_09:26_UTC-informational)
...
- **Ativos em todas as fontes**: 1720
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 496 ms
- **Última atualização (UTC)**: 2026-06-14 09:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 75 · trojan × 36 · vless × 21 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 21 · `surfboard-eternity` × 4
