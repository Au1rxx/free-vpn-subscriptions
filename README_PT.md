...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2126-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-364ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_10:14_UTC-informational)
...
- **RTT mediano**: 364 ms
- **Última atualização (UTC)**: 2026-07-02 10:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 24 · vless × 15 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 5 · `surfboard-eternity` × 4
