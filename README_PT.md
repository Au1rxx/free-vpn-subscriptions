...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2117-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-96ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-02_04:18_UTC-informational)
...
- **RTT mediano**: 96 ms
- **Última atualização (UTC)**: 2026-05-02 04:18 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 6 · vless × 94 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 32 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 56 · `pawdroid` × 1 · `surfboard-eternity` × 8
