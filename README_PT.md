...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2073-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-183ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_01:38_UTC-informational)
...
- **RTT mediano**: 183 ms
- **Última atualização (UTC)**: 2026-07-02 01:38 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 25 · vless × 23 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 5 · `ninjastrikers` × 22 · `pawdroid` × 8
