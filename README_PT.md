...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2384-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-87ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_18:15_UTC-informational)
...
- **RTT mediano**: 87 ms
- **Última atualização (UTC)**: 2026-05-22 18:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 25 · vless × 77 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
