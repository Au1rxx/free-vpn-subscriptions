...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2663-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-74ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-17_13:25_UTC-informational)
...
- **Ativos em todas as fontes**: 2663
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 74 ms
- **Última atualização (UTC)**: 2026-05-17 13:25 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 9 · vless × 89 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 55 · `pawdroid` × 6 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 5
