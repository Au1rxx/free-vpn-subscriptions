...
![nós](https://img.shields.io/badge/nós-112-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1871-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-363ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_13:40_UTC-informational)
...
- **RTT mediano**: 363 ms
- **Última atualização (UTC)**: 2026-07-06 13:40 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 42 · trojan × 25 · vless × 13 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 6 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 2
