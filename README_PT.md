...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2552-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-72ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-16_09:33_UTC-informational)
...
- **RTT mediano**: 72 ms
- **Última atualização (UTC)**: 2026-05-16 09:33 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 8 · vless × 102 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 8 · `ruking-clash` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
