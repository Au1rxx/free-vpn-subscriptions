...
![nós](https://img.shields.io/badge/nós-112-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1869-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-343ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_20:31_UTC-informational)
...
- **RTT mediano**: 343 ms
- **Última atualização (UTC)**: 2026-07-05 20:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 48 · trojan × 24 · vless × 9 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 2
