...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2211-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-108ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_13:15_UTC-informational)
...
- **RTT mediano**: 108 ms
- **Última atualização (UTC)**: 2026-04-26 13:15 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 16 · vless × 98 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 68 · `surfboard-eternity` × 9
