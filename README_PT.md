...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1910-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-198ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_15:35_UTC-informational)
...
- **RTT mediano**: 198 ms
- **Última atualização (UTC)**: 2026-06-04 15:35 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 57 · vless × 19 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 40 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `ruking-clash` × 3 · `surfboard-eternity` × 2
