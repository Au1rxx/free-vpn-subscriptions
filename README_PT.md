...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2166-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-96ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-26_06:33_UTC-informational)
...
- **RTT mediano**: 96 ms
- **Última atualização (UTC)**: 2026-04-26 06:33 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 9 · vless × 104 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
