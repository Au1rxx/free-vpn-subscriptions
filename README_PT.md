...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2414-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-86ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-19_16:25_UTC-informational)
...
- **RTT mediano**: 86 ms
- **Última atualização (UTC)**: 2026-05-19 16:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 19 · vless × 72 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 52 · `pawdroid` × 12 · `ruking-clash` × 2 · `surfboard-eternity` × 9
