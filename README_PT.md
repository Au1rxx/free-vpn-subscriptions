...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1860-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-308ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_04:38_UTC-informational)
...
- **RTT mediano**: 308 ms
- **Última atualização (UTC)**: 2026-07-07 04:38 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 22 · vless × 21 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 9 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
