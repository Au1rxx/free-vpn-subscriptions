...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2073-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-102ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-02_02:30_UTC-informational)
...
- **RTT mediano**: 102 ms
- **Última atualização (UTC)**: 2026-05-02 02:30 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 8 · vless × 94 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 61 · `pawdroid` × 3 · `surfboard-eternity` × 8
