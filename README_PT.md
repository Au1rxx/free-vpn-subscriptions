...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1679-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-394ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_18:27_UTC-informational)
...
- **Ativos em todas as fontes**: 1679
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 394 ms
- **Última atualização (UTC)**: 2026-07-14 18:27 UTC

**Mix de protocolos:** hysteria2 × 5 · shadowsocks × 94 · trojan × 26 · vless × 16 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 5 · `epodonios` × 31 · `mahdi0024` × 12 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 11 · `snakem982` × 1 · `surfboard-eternity` × 1
