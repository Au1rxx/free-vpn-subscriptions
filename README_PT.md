...
![nós](https://img.shields.io/badge/nós-107-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1949-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-102ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_00:23_UTC-informational)
...
- **RTT mediano**: 102 ms
- **Última atualização (UTC)**: 2026-06-04 00:23 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 38 · vless × 36 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `epodonios` × 26 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 29 · `snakem982` × 1 · `surfboard-eternity` × 1
