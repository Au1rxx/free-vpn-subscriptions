...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2237-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-403ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_04:16_UTC-informational)
...
- **RTT mediano**: 403 ms
- **Última atualização (UTC)**: 2026-07-17 04:16 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 75 · vless × 18 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 3 · `mahdi0024` × 46 · `mahdibland-aggregator` × 34 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 4
