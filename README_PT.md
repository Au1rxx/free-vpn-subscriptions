...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1880-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-408ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_16:21_UTC-informational)
...
- **RTT mediano**: 408 ms
- **Última atualização (UTC)**: 2026-06-29 16:21 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 33 · vless × 21 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
