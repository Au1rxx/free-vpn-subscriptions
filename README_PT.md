...
![nós](https://img.shields.io/badge/nós-83-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2195-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-160ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_06:12_UTC-informational)
...
- **RTT mediano**: 160 ms
- **Última atualização (UTC)**: 2026-05-30 06:12 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 24 · vless × 10 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
