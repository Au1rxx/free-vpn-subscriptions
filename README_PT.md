...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1838-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-375ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_09:33_UTC-informational)
...
- **Ativos em todas as fontes**: 1838
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 375 ms
- **Última atualização (UTC)**: 2026-06-16 09:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 28 · vless × 20 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 21 · `mahdi0024` × 17 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 4
