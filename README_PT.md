...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2419-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-99ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-14_14:22_UTC-informational)
...
- **Ativos em todas as fontes**: 2419
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 99 ms
- **Última atualização (UTC)**: 2026-05-14 14:22 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 18 · vless × 82 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 33 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 6
