...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2094-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-92ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_00:26_UTC-informational)
...
- **RTT mediano**: 92 ms
- **Última atualização (UTC)**: 2026-04-29 00:26 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 8 · vless × 99 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
