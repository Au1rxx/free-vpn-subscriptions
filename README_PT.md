...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2103-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-101ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-29_01:33_UTC-informational)
...
- **Ativos em todas as fontes**: 2103
- **RTT do nó mais rápido**: 38 ms
- **RTT mediano**: 101 ms
- **Última atualização (UTC)**: 2026-04-29 01:33 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 5 · vless × 102 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7
