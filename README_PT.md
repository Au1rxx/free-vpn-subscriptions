...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2036-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-146ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_13:33_UTC-informational)
...
- **RTT mediano**: 146 ms
- **Última atualização (UTC)**: 2026-05-04 13:33 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 23 · vless × 85 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 59 · `pawdroid` × 3 · `surfboard-eternity` × 7
