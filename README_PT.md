...
![nós](https://img.shields.io/badge/nós-103-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2241-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-477ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_13:14_UTC-informational)
...
- **RTT mediano**: 477 ms
- **Última atualização (UTC)**: 2026-06-12 13:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 46 · trojan × 37 · vless × 15 · vmess × 4

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 29 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 5
