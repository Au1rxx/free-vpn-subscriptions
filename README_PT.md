...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1957-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-206ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_06:15_UTC-informational)
...
- **RTT mediano**: 206 ms
- **Última atualização (UTC)**: 2026-07-13 06:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 52 · trojan × 18 · vless × 29 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 4 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 4
