...
![nós](https://img.shields.io/badge/nós-58-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2497-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-111ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_20:34_UTC-informational)
...
- **RTT mediano**: 111 ms
- **Última atualização (UTC)**: 2026-06-01 20:34 UTC

**Mix de protocolos:** shadowsocks × 15 · trojan × 20 · vless × 4 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 2 · `surfboard-eternity` × 1
