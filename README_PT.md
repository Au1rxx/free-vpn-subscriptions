...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2175-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-90ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-01_10:11_UTC-informational)
...
- **RTT mediano**: 90 ms
- **Última atualização (UTC)**: 2026-05-01 10:11 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 6 · vless × 90 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `surfboard-eternity` × 5
