...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2527-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-85ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_07:27_UTC-informational)
...
- **Ativos em todas as fontes**: 2527
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 85 ms
- **Última atualização (UTC)**: 2026-04-27 07:27 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 3 · vless × 101 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 43 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 4 · `surfboard-eternity` × 6
