...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2564-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-27_01:13_UTC-informational)
...
- **Ativos em todas as fontes**: 2564
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-04-27 01:13 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 5 · vless × 95 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 46 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 59 · `pawdroid` × 1 · `surfboard-eternity` × 3
