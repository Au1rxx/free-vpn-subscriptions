...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-393-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-107ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-04-19_08:02_UTC-informational)
...
- **RTT mediano**: 107 ms
- **Última atualização (UTC)**: 2026-04-19 08:02 UTC

**Mix de protocolos:** shadowsocks × 106 · trojan × 8 · vmess × 36

**Fontes usadas nesta execução:** `freefq` × 2 · `mahdibland-aggregator` × 72 · `mahdibland-shadowsocks` × 59 · `pawdroid` × 3 · `vxiaov-clash` × 14
