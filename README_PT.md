...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1854-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-276ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_03:15_UTC-informational)
...
- **RTT mediano**: 276 ms
- **Última atualização (UTC)**: 2026-06-08 03:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 21 · vless × 32 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 2 · `ninjastrikers` × 33 · `pawdroid` × 2 · `ruking-clash` × 4 · `surfboard-eternity` × 5
