...
![节点](https://img.shields.io/badge/节点-72-brightgreen) ![存活](https://img.shields.io/badge/存活-2147-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-161ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-30_09:28_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 161 ms
- **最后更新 (UTC)**: 2026-05-30 09:28 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 24 · trojan × 13 · vless × 8 · vmess × 26

**本次使用的源:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 3 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 3 · `ninjastrikers` × 6 · `pawdroid` × 2 · `surfboard-eternity` × 2
