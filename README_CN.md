...
![节点](https://img.shields.io/badge/节点-124-brightgreen) ![存活](https://img.shields.io/badge/存活-2069-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-384ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_08:24_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 384 ms
- **最后更新 (UTC)**: 2026-06-24 08:24 UTC

**协议分布:** shadowsocks × 34 · trojan × 29 · vless × 45 · vmess × 16

**本次使用的源:** `barry-far-v2ray` × 14 · `epodonios` × 41 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 14 · `surfboard-eternity` × 2
