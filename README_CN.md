...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2585-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-79ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_09:17_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 79 ms
- **最后更新 (UTC)**: 2026-04-28 09:17 UTC

**协议分布:** shadowsocks × 22 · trojan × 14 · vless × 104 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 22 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
