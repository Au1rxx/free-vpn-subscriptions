...
![节点](https://img.shields.io/badge/节点-54-brightgreen) ![存活](https://img.shields.io/badge/存活-2047-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-189ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-29_12:32_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 189 ms
- **最后更新 (UTC)**: 2026-05-29 12:32 UTC

**协议分布:** shadowsocks × 25 · trojan × 13 · vless × 7 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 6 · `ruking-clash` × 3 · `surfboard-eternity` × 2
