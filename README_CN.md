...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2314-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-309ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_15:24_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 309 ms
- **最后更新 (UTC)**: 2026-04-21 15:24 UTC

**协议分布:** shadowsocks × 33 · trojan × 16 · vless × 87 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 46 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 56 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 9
