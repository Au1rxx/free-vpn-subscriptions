...
![节点](https://img.shields.io/badge/节点-92-brightgreen) ![存活](https://img.shields.io/badge/存活-2142-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-178ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_15:17_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 178 ms
- **最后更新 (UTC)**: 2026-06-06 15:17 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 29 · trojan × 29 · vless × 10 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 15 · `mahdi0024` × 35 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 1
