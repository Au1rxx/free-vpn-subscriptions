...
![节点](https://img.shields.io/badge/节点-90-brightgreen) ![存活](https://img.shields.io/badge/存活-1947-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-280ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_20:34_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 280 ms
- **最后更新 (UTC)**: 2026-06-26 20:34 UTC

**协议分布:** shadowsocks × 23 · trojan × 29 · vless × 14 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `mahdi0024` × 16 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `ruking-clash` × 17 · `surfboard-eternity` × 5
