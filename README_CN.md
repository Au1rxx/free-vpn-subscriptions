...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2041-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-78ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_08:17_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 78 ms
- **最后更新 (UTC)**: 2026-05-22 08:17 UTC

**协议分布:** shadowsocks × 42 · trojan × 9 · vless × 86 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 3 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
