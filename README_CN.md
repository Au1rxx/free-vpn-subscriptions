...
![节点](https://img.shields.io/badge/节点-85-brightgreen) ![存活](https://img.shields.io/badge/存活-2232-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-170ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_09:27_UTC-informational)
...
- **最快延迟**: 26 ms
- **中位延迟**: 170 ms
- **最后更新 (UTC)**: 2026-06-07 09:27 UTC

**协议分布:** shadowsocks × 30 · trojan × 19 · vless × 12 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `mahdi0024` × 37 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 2
