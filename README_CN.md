...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2223-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-136ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_00:19_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 136 ms
- **最后更新 (UTC)**: 2026-04-22 00:19 UTC

**协议分布:** shadowsocks × 34 · trojan × 4 · vless × 98 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 28 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 71 · `ruking-clash` × 5 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
