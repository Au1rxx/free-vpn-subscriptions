...
![节点](https://img.shields.io/badge/节点-95-brightgreen) ![存活](https://img.shields.io/badge/存活-1940-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-307ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_21:11_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 307 ms
- **最后更新 (UTC)**: 2026-06-27 21:11 UTC

**协议分布:** shadowsocks × 24 · trojan × 37 · vless × 20 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 22 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 4
