...
![节点](https://img.shields.io/badge/节点-109-brightgreen) ![存活](https://img.shields.io/badge/存活-2059-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-340ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-02_03:27_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 340 ms
- **最后更新 (UTC)**: 2026-07-02 03:27 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 44 · trojan × 37 · vless × 18 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 25 · `pawdroid` × 2 · `surfboard-eternity` × 1
