...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2055-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-132ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_04:12_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 132 ms
- **最后更新 (UTC)**: 2026-05-22 04:12 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 39 · trojan × 13 · vless × 86 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 67 · `pawdroid` × 5 · `ruking-clash` × 7 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
