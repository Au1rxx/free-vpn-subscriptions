...
![节点](https://img.shields.io/badge/节点-113-brightgreen) ![存活](https://img.shields.io/badge/存活-1997-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-338ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-04_22:33_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 338 ms
- **最后更新 (UTC)**: 2026-07-04 22:33 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 55 · trojan × 22 · vless × 9 · vmess × 26

**本次使用的源:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 36 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
