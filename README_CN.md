...
![节点](https://img.shields.io/badge/节点-116-brightgreen) ![存活](https://img.shields.io/badge/存活-2546-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-488ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_09:20_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 488 ms
- **最后更新 (UTC)**: 2026-06-19 09:20 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 32 · trojan × 25 · vless × 41 · vmess × 17

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 15 · `mahdi0024` × 6 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 36 · `snakem982` × 4 · `surfboard-eternity` × 4
