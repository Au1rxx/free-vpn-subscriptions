...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2196-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-149ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_09:19_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 149 ms
- **最后更新 (UTC)**: 2026-04-21 09:19 UTC

**协议分布:** shadowsocks × 29 · trojan × 2 · vless × 105 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 53 · `epodonios` × 3 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 56 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
