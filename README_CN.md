...
![节点](https://img.shields.io/badge/节点-60-brightgreen) ![存活](https://img.shields.io/badge/存活-2090-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-169ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-28_19:20_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 169 ms
- **最后更新 (UTC)**: 2026-05-28 19:20 UTC

**协议分布:** shadowsocks × 29 · trojan × 13 · vless × 8 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 3 · `epodonios` × 15 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 9
