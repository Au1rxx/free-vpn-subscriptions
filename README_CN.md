...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2465-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-140ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-10_11:32_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 140 ms
- **最后更新 (UTC)**: 2026-05-10 11:32 UTC

**协议分布:** shadowsocks × 51 · trojan × 4 · vless × 85 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 8
