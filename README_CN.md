...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2471-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-75ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_10:39_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 75 ms
- **最后更新 (UTC)**: 2026-05-18 10:39 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 45 · trojan × 6 · vless × 92 · vmess × 6

**本次使用的源:** `barry-far-v2ray` × 16 · `epodonios` × 2 · `lagzian-mix` × 5 · `mahdi0024` × 39 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 5 · `ruking-clash` × 11 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
