...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1959-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-157ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_06:34_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 157 ms
- **最后更新 (UTC)**: 2026-05-12 06:34 UTC

**协议分布:** shadowsocks × 58 · trojan × 3 · vless × 79 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 4 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 74 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
