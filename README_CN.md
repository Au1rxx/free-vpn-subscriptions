...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2217-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-172ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_20:29_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 172 ms
- **最后更新 (UTC)**: 2026-04-30 20:29 UTC

**协议分布:** shadowsocks × 30 · trojan × 23 · vless × 75 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 33 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 32 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 51 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
