...
![节点](https://img.shields.io/badge/节点-146-brightgreen) ![存活](https://img.shields.io/badge/存活-2265-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-76ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_04:31_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 76 ms
- **最后更新 (UTC)**: 2026-05-19 04:31 UTC

**协议分布:** shadowsocks × 18 · trojan × 23 · vless × 84 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 72 · `pawdroid` × 7 · `ruking-clash` × 1 · `surfboard-eternity` × 4
