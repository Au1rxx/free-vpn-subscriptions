...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2227-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-69ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_07:10_UTC-informational)
...
- **最快延迟**: 22 ms
- **中位延迟**: 69 ms
- **最后更新 (UTC)**: 2026-05-19 07:10 UTC

**协议分布:** shadowsocks × 21 · trojan × 19 · vless × 91 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 71 · `pawdroid` × 10 · `snakem982` × 1 · `surfboard-eternity` × 4
