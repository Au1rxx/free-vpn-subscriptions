...
![节点](https://img.shields.io/badge/节点-136-brightgreen) ![存活](https://img.shields.io/badge/存活-2582-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-291ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_18:24_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 291 ms
- **最后更新 (UTC)**: 2026-04-22 18:24 UTC

**协议分布:** shadowsocks × 29 · trojan × 22 · vless × 71 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 26 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 6
