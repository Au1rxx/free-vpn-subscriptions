...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1998-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-458ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_23:20_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 458 ms
- **最后更新 (UTC)**: 2026-06-22 23:20 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 42 · trojan × 24 · vless × 69 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 52 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 1 · `ruking-clash` × 24 · `snakem982` × 1 · `surfboard-eternity` × 4
