...
![节点](https://img.shields.io/badge/节点-104-brightgreen) ![存活](https://img.shields.io/badge/存活-1927-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-411ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-25_19:35_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 411 ms
- **最后更新 (UTC)**: 2026-06-25 19:35 UTC

**协议分布:** shadowsocks × 35 · trojan × 38 · vless × 18 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 10 · `epodonios` × 20 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 20 · `surfboard-eternity` × 6
