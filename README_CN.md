...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2414-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-86ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_16:25_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 86 ms
- **最后更新 (UTC)**: 2026-05-19 16:25 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 39 · trojan × 19 · vless × 72 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 52 · `pawdroid` × 12 · `ruking-clash` × 2 · `surfboard-eternity` × 9
