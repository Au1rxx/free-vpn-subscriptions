...
![节点](https://img.shields.io/badge/节点-109-brightgreen) ![存活](https://img.shields.io/badge/存活-2027-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-418ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_13:34_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 418 ms
- **最后更新 (UTC)**: 2026-06-28 13:34 UTC

**协议分布:** shadowsocks × 36 · trojan × 31 · vless × 27 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 12 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 20 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 1
