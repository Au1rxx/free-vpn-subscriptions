...
![节点](https://img.shields.io/badge/节点-104-brightgreen) ![存活](https://img.shields.io/badge/存活-2003-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-177ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-04_14:20_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 177 ms
- **最后更新 (UTC)**: 2026-06-04 14:20 UTC

**协议分布:** shadowsocks × 23 · trojan × 54 · vless × 19 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 39 · `epodonios` × 29 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 5
