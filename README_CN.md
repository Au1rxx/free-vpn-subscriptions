...
![节点](https://img.shields.io/badge/节点-95-brightgreen) ![存活](https://img.shields.io/badge/存活-1891-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-362ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_13:37_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 362 ms
- **最后更新 (UTC)**: 2026-06-15 13:37 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 43 · trojan × 21 · vless × 16 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 18 · `mfuu-clash` × 2 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 3
