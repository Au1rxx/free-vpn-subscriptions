...
![节点](https://img.shields.io/badge/节点-130-brightgreen) ![存活](https://img.shields.io/badge/存活-1939-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-469ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_06:16_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 469 ms
- **最后更新 (UTC)**: 2026-06-17 06:16 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 40 · trojan × 27 · vless × 23 · vmess × 39

**本次使用的源:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 41 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
