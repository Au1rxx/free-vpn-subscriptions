...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2162-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-86ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-03_06:16_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 86 ms
- **最后更新 (UTC)**: 2026-05-03 06:16 UTC

**协议分布:** shadowsocks × 34 · trojan × 5 · vless × 101 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 21 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
