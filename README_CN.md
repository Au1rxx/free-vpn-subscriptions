...
![节点](https://img.shields.io/badge/节点-112-brightgreen) ![存活](https://img.shields.io/badge/存活-1816-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-377ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_17:33_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 377 ms
- **最后更新 (UTC)**: 2026-06-15 17:33 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 51 · trojan × 27 · vless × 18 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 17 · `surfboard-eternity` × 3
