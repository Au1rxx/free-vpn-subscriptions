...
![节点](https://img.shields.io/badge/节点-93-brightgreen) ![存活](https://img.shields.io/badge/存活-2086-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-183ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_13:13_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 183 ms
- **最后更新 (UTC)**: 2026-06-27 13:13 UTC

**协议分布:** shadowsocks × 18 · trojan × 34 · vless × 18 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 10 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 5 · `ruking-clash` × 15 · `surfboard-eternity` × 2
