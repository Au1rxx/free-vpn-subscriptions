...
![节点](https://img.shields.io/badge/节点-128-brightgreen) ![存活](https://img.shields.io/badge/存活-2609-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-384ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_22:13_UTC-informational)
...
- **最快延迟**: 25 ms
- **中位延迟**: 384 ms
- **最后更新 (UTC)**: 2026-04-22 22:13 UTC

**协议分布:** shadowsocks × 30 · trojan × 20 · vless × 66 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
