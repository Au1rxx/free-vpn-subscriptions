...
![节点](https://img.shields.io/badge/节点-87-brightgreen) ![存活](https://img.shields.io/badge/存活-2141-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-272ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_16:09_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 272 ms
- **最后更新 (UTC)**: 2026-06-28 16:09 UTC

**协议分布:** shadowsocks × 18 · trojan × 33 · vless × 19 · vmess × 17

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 3
