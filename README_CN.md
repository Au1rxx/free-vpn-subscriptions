...
![节点](https://img.shields.io/badge/节点-71-brightgreen) ![存活](https://img.shields.io/badge/存活-2072-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-163ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-29_09:27_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 163 ms
- **最后更新 (UTC)**: 2026-05-29 09:27 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 26 · trojan × 25 · vless × 10 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 3 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 10 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 1
