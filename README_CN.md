...
![节点](https://img.shields.io/badge/节点-136-brightgreen) ![存活](https://img.shields.io/badge/存活-1893-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-478ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_11:39_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 478 ms
- **最后更新 (UTC)**: 2026-06-22 11:39 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 43 · trojan × 29 · vless × 50 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 30 · `snakem982` × 3 · `surfboard-eternity` × 3
