...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2373-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-120ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_17:19_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 120 ms
- **最后更新 (UTC)**: 2026-05-12 17:19 UTC

**协议分布:** shadowsocks × 39 · trojan × 14 · vless × 84 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 41 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
