...
![节点](https://img.shields.io/badge/节点-104-brightgreen) ![存活](https://img.shields.io/badge/存活-1843-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-04_20:29_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 167 ms
- **最后更新 (UTC)**: 2026-06-04 20:29 UTC

**协议分布:** shadowsocks × 21 · trojan × 51 · vless × 20 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 33 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `ruking-clash` × 3 · `surfboard-eternity` × 6
