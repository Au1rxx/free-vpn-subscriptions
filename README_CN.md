...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2579-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-136ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-26_23:39_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 136 ms
- **最后更新 (UTC)**: 2026-04-26 23:39 UTC

**协议分布:** shadowsocks × 38 · trojan × 11 · vless × 87 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 26 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 48 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 46 · `pawdroid` × 1 · `surfboard-eternity` × 6
