...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2662-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-89ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_01:16_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 89 ms
- **最后更新 (UTC)**: 2026-05-18 01:16 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 43 · trojan × 5 · vless × 94 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 6 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 38 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 58 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 6
