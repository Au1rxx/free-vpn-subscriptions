...
![节点](https://img.shields.io/badge/节点-89-brightgreen) ![存活](https://img.shields.io/badge/存活-2081-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-252ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_12:30_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 252 ms
- **最后更新 (UTC)**: 2026-06-27 12:30 UTC

**协议分布:** shadowsocks × 18 · trojan × 33 · vless × 15 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 12 · `surfboard-eternity` × 2
