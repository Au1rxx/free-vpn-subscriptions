...
![节点](https://img.shields.io/badge/节点-106-brightgreen) ![存活](https://img.shields.io/badge/存活-2224-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-161ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_01:38_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 161 ms
- **最后更新 (UTC)**: 2026-06-07 01:38 UTC

**协议分布:** shadowsocks × 30 · trojan × 23 · vless × 29 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 39 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 32 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 2
