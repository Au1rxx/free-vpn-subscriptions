...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2192-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-156ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_02:24_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 156 ms
- **最后更新 (UTC)**: 2026-04-22 02:24 UTC

**协议分布:** shadowsocks × 35 · trojan × 4 · vless × 98 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 74 · `pawdroid` × 3 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 8
