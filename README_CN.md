...
![节点](https://img.shields.io/badge/节点-82-brightgreen) ![存活](https://img.shields.io/badge/存活-2055-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-163ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-04_03:38_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 163 ms
- **最后更新 (UTC)**: 2026-07-04 03:38 UTC

**协议分布:** shadowsocks × 25 · trojan × 23 · vless × 13 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 6 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
