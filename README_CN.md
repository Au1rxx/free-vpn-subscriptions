...
![节点](https://img.shields.io/badge/节点-92-brightgreen) ![存活](https://img.shields.io/badge/存活-2021-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-380ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_16:36_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 380 ms
- **最后更新 (UTC)**: 2026-06-26 16:36 UTC

**协议分布:** shadowsocks × 21 · trojan × 33 · vless × 17 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 8 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 17 · `surfboard-eternity` × 3
