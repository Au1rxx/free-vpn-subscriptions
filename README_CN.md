...
![节点](https://img.shields.io/badge/节点-85-brightgreen) ![存活](https://img.shields.io/badge/存活-2142-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-170ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-30_13:11_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 170 ms
- **最后更新 (UTC)**: 2026-05-30 13:11 UTC

**协议分布:** shadowsocks × 23 · trojan × 24 · vless × 9 · vmess × 29

**本次使用的源:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 29 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 3 · `surfboard-eternity` × 5
