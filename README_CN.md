...
![节点](https://img.shields.io/badge/节点-111-brightgreen) ![存活](https://img.shields.io/badge/存活-2262-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-359ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_06:10_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 359 ms
- **最后更新 (UTC)**: 2026-06-12 06:10 UTC

**协议分布:** shadowsocks × 46 · trojan × 41 · vless × 18 · vmess × 6

**本次使用的源:** `barry-far-v2ray` × 8 · `epodonios` × 33 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 5
