...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2565-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-162ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-26_20:11_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 162 ms
- **最后更新 (UTC)**: 2026-04-26 20:11 UTC

**协议分布:** shadowsocks × 40 · trojan × 16 · vless × 80 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 24 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 43 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 46 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
