...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2186-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-117ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-01_13:16_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 117 ms
- **最后更新 (UTC)**: 2026-05-01 13:16 UTC

**协议分布:** shadowsocks × 34 · trojan × 13 · vless × 81 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 33 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `snakem982` × 1 · `surfboard-eternity` × 4
