...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2065-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-84ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-04_06:20_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 84 ms
- **最后更新 (UTC)**: 2026-05-04 06:20 UTC

**协议分布:** shadowsocks × 30 · trojan × 9 · vless × 100 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 68 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
