...
![节点](https://img.shields.io/badge/节点-100-brightgreen) ![存活](https://img.shields.io/badge/存活-2148-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-158ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_03:10_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 158 ms
- **最后更新 (UTC)**: 2026-06-06 03:10 UTC

**协议分布:** shadowsocks × 24 · trojan × 27 · vless × 31 · vmess × 18

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 26 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 30 · `surfboard-eternity` × 1
