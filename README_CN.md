...
![节点](https://img.shields.io/badge/节点-122-brightgreen) ![存活](https://img.shields.io/badge/存活-1991-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-350ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_02:20_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 350 ms
- **最后更新 (UTC)**: 2026-06-28 02:20 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 36 · trojan × 41 · vless × 33 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 5
