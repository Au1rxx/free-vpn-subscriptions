...
![节点](https://img.shields.io/badge/节点-107-brightgreen) ![存活](https://img.shields.io/badge/存活-1949-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-102ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-04_00:23_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 102 ms
- **最后更新 (UTC)**: 2026-06-04 00:23 UTC

**协议分布:** shadowsocks × 24 · trojan × 38 · vless × 36 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 21 · `epodonios` × 26 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 29 · `snakem982` × 1 · `surfboard-eternity` × 1
