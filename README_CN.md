...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2284-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-140ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-05_04:36_UTC-informational)
...
- **最快延迟**: 23 ms
- **中位延迟**: 140 ms
- **最后更新 (UTC)**: 2026-05-05 04:36 UTC

**协议分布:** shadowsocks × 35 · trojan × 20 · vless × 85 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 5 · `ninjastrikers` × 76 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
