...
![节点](https://img.shields.io/badge/节点-87-brightgreen) ![存活](https://img.shields.io/badge/存活-2203-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-265ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-11_08:28_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 265 ms
- **最后更新 (UTC)**: 2026-06-11 08:28 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 11 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 6
