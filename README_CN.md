...
![节点](https://img.shields.io/badge/节点-138-brightgreen) ![存活](https://img.shields.io/badge/存活-2523-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-206ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_18:18_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 206 ms
- **最后更新 (UTC)**: 2026-04-23 18:18 UTC

**协议分布:** shadowsocks × 15 · trojan × 26 · vless × 81 · vmess × 16

**本次使用的源:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
