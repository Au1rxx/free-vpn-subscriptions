...
![节点](https://img.shields.io/badge/节点-75-brightgreen) ![存活](https://img.shields.io/badge/存活-1965-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-174ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-04_09:34_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 174 ms
- **最后更新 (UTC)**: 2026-07-04 09:34 UTC

**协议分布:** shadowsocks × 30 · trojan × 18 · vless × 8 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 5 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
