...
![节点](https://img.shields.io/badge/节点-127-brightgreen) ![存活](https://img.shields.io/badge/存活-2484-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-489ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_11:38_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 489 ms
- **最后更新 (UTC)**: 2026-06-19 11:38 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 32 · trojan × 27 · vless × 48 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 12 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 7
