...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2253-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-164ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_14:18_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 164 ms
- **最后更新 (UTC)**: 2026-04-30 14:18 UTC

**协议分布:** shadowsocks × 32 · trojan × 18 · vless × 82 · vmess × 18

**本次使用的源:** `barry-far-v2ray` × 36 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 56 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
