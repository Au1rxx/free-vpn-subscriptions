...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2229-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-144ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_01:38_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 144 ms
- **最后更新 (UTC)**: 2026-04-22 01:38 UTC

**协议分布:** shadowsocks × 34 · trojan × 5 · vless × 97 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 29 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 71 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 5
