...
![节点](https://img.shields.io/badge/节点-117-brightgreen) ![存活](https://img.shields.io/badge/存活-1971-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-351ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_04:37_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 351 ms
- **最后更新 (UTC)**: 2026-06-28 04:37 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 33 · trojan × 42 · vless × 30 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 16 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `ruking-clash` × 15 · `surfboard-eternity` × 7
