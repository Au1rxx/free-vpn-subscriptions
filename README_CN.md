...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2595-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-146ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_01:22_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 146 ms
- **最后更新 (UTC)**: 2026-04-23 01:22 UTC

**协议分布:** shadowsocks × 29 · trojan × 13 · vless × 99 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 28 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 76 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 7
