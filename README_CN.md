...
![节点](https://img.shields.io/badge/节点-78-brightgreen) ![存活](https://img.shields.io/badge/存活-2420-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-164ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-01_15:20_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 164 ms
- **最后更新 (UTC)**: 2026-06-01 15:20 UTC

**协议分布:** shadowsocks × 15 · trojan × 26 · vless × 7 · vmess × 30

**本次使用的源:** `barry-far-v2ray` × 16 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 9 · `pawdroid` × 5 · `surfboard-eternity` × 2
