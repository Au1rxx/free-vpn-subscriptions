...
![节点](https://img.shields.io/badge/节点-109-brightgreen) ![存活](https://img.shields.io/badge/存活-1866-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-344ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_06:12_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 344 ms
- **最后更新 (UTC)**: 2026-06-15 06:12 UTC

**协议分布:** shadowsocks × 45 · trojan × 26 · vless × 25 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 29 · `pawdroid` × 1 · `ruking-clash` × 11 · `surfboard-eternity` × 2
