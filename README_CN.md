...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1972-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-126ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_02:23_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 126 ms
- **最后更新 (UTC)**: 2026-05-12 02:23 UTC

**协议分布:** shadowsocks × 54 · trojan × 2 · vless × 84 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 7 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
