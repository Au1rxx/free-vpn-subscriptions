...
![节点](https://img.shields.io/badge/节点-100-brightgreen) ![存活](https://img.shields.io/badge/存活-2039-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-183ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_01:28_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 183 ms
- **最后更新 (UTC)**: 2026-06-27 01:28 UTC

**协议分布:** shadowsocks × 17 · trojan × 35 · vless × 28 · vmess × 20

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 3
