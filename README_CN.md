...
![节点](https://img.shields.io/badge/节点-97-brightgreen) ![存活](https://img.shields.io/badge/存活-1978-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-491ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_08:33_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 491 ms
- **最后更新 (UTC)**: 2026-06-18 08:33 UTC

**协议分布:** hysteria2 × 2 · shadowsocks × 33 · trojan × 29 · vless × 27 · vmess × 6

**本次使用的源:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `snakem982` × 1 · `surfboard-eternity` × 2
