...
![节点](https://img.shields.io/badge/节点-113-brightgreen) ![存活](https://img.shields.io/badge/存活-2005-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-355ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_09:32_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 355 ms
- **最后更新 (UTC)**: 2026-06-28 09:32 UTC

**协议分布:** shadowsocks × 33 · trojan × 39 · vless × 27 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 12 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
