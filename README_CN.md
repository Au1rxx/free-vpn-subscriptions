...
![节点](https://img.shields.io/badge/节点-72-brightgreen) ![存活](https://img.shields.io/badge/存活-2128-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_20:12_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 167 ms
- **最后更新 (UTC)**: 2026-06-06 20:12 UTC

**协议分布:** shadowsocks × 26 · trojan × 15 · vless × 7 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 5
