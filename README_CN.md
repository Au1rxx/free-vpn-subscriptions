...
![节点](https://img.shields.io/badge/节点-75-brightgreen) ![存活](https://img.shields.io/badge/存活-2460-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-160ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_12:35_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 160 ms
- **最后更新 (UTC)**: 2026-06-02 12:35 UTC

**协议分布:** shadowsocks × 25 · trojan × 23 · vless × 7 · vmess × 20

**本次使用的源:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 3 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
