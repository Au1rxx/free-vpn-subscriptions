...
![节点](https://img.shields.io/badge/节点-74-brightgreen) ![存活](https://img.shields.io/badge/存活-2263-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-166ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-30_14:36_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 166 ms
- **最后更新 (UTC)**: 2026-05-30 14:36 UTC

**协议分布:** shadowsocks × 24 · trojan × 16 · vless × 7 · vmess × 27

**本次使用的源:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 6 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 3
