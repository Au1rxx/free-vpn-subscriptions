...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2080-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-188ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-29_16:37_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 188 ms
- **最后更新 (UTC)**: 2026-04-29 16:37 UTC

**协议分布:** shadowsocks × 43 · trojan × 16 · vless × 80 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 6 · `ninjastrikers` × 57 · `surfboard-eternity` × 7
