...
![节点](https://img.shields.io/badge/节点-138-brightgreen) ![存活](https://img.shields.io/badge/存活-2047-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-410ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_09:15_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 410 ms
- **最后更新 (UTC)**: 2026-06-21 09:15 UTC

**协议分布:** shadowsocks × 44 · trojan × 29 · vless × 42 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 14 · `epodonios` × 12 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 41 · `snakem982` × 2 · `surfboard-eternity` × 4
