...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2469-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-154ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-27_18:37_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 154 ms
- **最后更新 (UTC)**: 2026-04-27 18:37 UTC

**协议分布:** shadowsocks × 27 · trojan × 21 · vless × 90 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 29 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 27 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
