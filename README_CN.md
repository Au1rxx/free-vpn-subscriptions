...
![节点](https://img.shields.io/badge/节点-86-brightgreen) ![存活](https://img.shields.io/badge/存活-1822-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-390ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_20:35_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 390 ms
- **最后更新 (UTC)**: 2026-06-30 20:35 UTC

**协议分布:** shadowsocks × 38 · trojan × 31 · vless × 10 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 5
