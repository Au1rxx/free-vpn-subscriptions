...
![节点](https://img.shields.io/badge/节点-71-brightgreen) ![存活](https://img.shields.io/badge/存活-2086-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-263ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-28_18:22_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 263 ms
- **最后更新 (UTC)**: 2026-05-28 18:22 UTC

**协议分布:** shadowsocks × 29 · trojan × 20 · vless × 12 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 4
