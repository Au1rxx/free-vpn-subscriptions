...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2599-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-9ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-19_11:06_UTC-informational)
...
- **最快延迟**: 5 ms
- **中位延迟**: 9 ms
- **最后更新 (UTC)**: 2026-04-19 11:06 UTC

**协议分布:** shadowsocks × 22 · trojan × 24 · vless × 75 · vmess × 29

**本次使用的源:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 11 · `epodonios` × 36 · `lagzian-mix` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 3 · `mfuu-clash` × 5 · `ninjastrikers` × 26 · `pawdroid` × 1 · `ruking-clash` × 19 · `snakem982` × 1 · `surfboard-eternity` × 3 · `vxiaov-clash` × 2
