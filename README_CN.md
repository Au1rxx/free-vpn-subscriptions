...
![节点](https://img.shields.io/badge/节点-105-brightgreen) ![存活](https://img.shields.io/badge/存活-2531-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-109ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_01:20_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 109 ms
- **最后更新 (UTC)**: 2026-06-02 01:20 UTC

**协议分布:** shadowsocks × 24 · trojan × 31 · vless × 24 · vmess × 26

**本次使用的源:** `barry-far-v2ray` × 16 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 30 · `pawdroid` × 1 · `surfboard-eternity` × 2
