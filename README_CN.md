...
![节点](https://img.shields.io/badge/节点-119-brightgreen) ![存活](https://img.shields.io/badge/存活-1952-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-434ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_21:10_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 434 ms
- **最后更新 (UTC)**: 2026-06-12 21:10 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 54 · trojan × 43 · vless × 13 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 33 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 8 · `surfboard-eternity` × 6
