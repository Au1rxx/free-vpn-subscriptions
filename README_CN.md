...
![节点](https://img.shields.io/badge/节点-138-brightgreen) ![存活](https://img.shields.io/badge/存活-2105-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-164ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_22:33_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 164 ms
- **最后更新 (UTC)**: 2026-04-28 22:33 UTC

**协议分布:** shadowsocks × 30 · trojan × 22 · vless × 75 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 35 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 53 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
