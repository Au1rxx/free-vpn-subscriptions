...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1938-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-166ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-08_13:18_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 166 ms
- **最后更新 (UTC)**: 2026-05-08 13:18 UTC

**协议分布:** shadowsocks × 58 · trojan × 7 · vless × 75 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 28 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 8
