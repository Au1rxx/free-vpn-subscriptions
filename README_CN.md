...
![节点](https://img.shields.io/badge/节点-112-brightgreen) ![存活](https://img.shields.io/badge/存活-2414-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-109ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-01_02:26_UTC-informational)
...
- **最快延迟**: 26 ms
- **中位延迟**: 109 ms
- **最后更新 (UTC)**: 2026-06-01 02:26 UTC

**协议分布:** shadowsocks × 22 · trojan × 25 · vless × 32 · vmess × 33

**本次使用的源:** `barry-far-v2ray` × 14 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 32 · `pawdroid` × 7 · `surfboard-eternity` × 2
