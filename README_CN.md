...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2470-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-136ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-14_23:13_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 136 ms
- **最后更新 (UTC)**: 2026-05-14 23:13 UTC

**协议分布:** shadowsocks × 40 · trojan × 25 · vless × 79 · vmess × 6

**本次使用的源:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 50 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
