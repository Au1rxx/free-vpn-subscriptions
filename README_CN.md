...
![节点](https://img.shields.io/badge/节点-133-brightgreen) ![存活](https://img.shields.io/badge/存活-1993-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-408ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_15:33_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 408 ms
- **最后更新 (UTC)**: 2026-06-23 15:33 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 40 · trojan × 33 · vless × 45 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 50 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `mfuu-clash` × 7 · `ninjastrikers` × 15 · `pawdroid` × 6 · `ruking-clash` × 9 · `surfboard-eternity` × 1
