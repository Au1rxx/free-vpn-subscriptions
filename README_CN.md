...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2467-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-105ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_02:21_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 105 ms
- **最后更新 (UTC)**: 2026-04-24 02:21 UTC

**协议分布:** shadowsocks × 18 · trojan × 14 · vless × 104 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 26 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 21 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 75 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
