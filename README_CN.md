...
![节点](https://img.shields.io/badge/节点-104-brightgreen) ![存活](https://img.shields.io/badge/存活-1876-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-299ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-09_04:14_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 299 ms
- **最后更新 (UTC)**: 2026-06-09 04:14 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 46 · trojan × 22 · vless × 25 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 27 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 5
