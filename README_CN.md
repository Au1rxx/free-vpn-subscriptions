...
![节点](https://img.shields.io/badge/节点-105-brightgreen) ![存活](https://img.shields.io/badge/存活-1963-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-352ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_05:22_UTC-informational)
...
- **最快延迟**: 26 ms
- **中位延迟**: 352 ms
- **最后更新 (UTC)**: 2026-06-26 05:22 UTC

**协议分布:** shadowsocks × 31 · trojan × 37 · vless × 26 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 12 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `ruking-clash` × 18 · `surfboard-eternity` × 4
