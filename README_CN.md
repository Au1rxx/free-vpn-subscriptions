...
![节点](https://img.shields.io/badge/节点-68-brightgreen) ![存活](https://img.shields.io/badge/存活-1894-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-112ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-27_08:24_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 112 ms
- **最后更新 (UTC)**: 2026-05-27 08:24 UTC

**协议分布:** shadowsocks × 28 · trojan × 10 · vless × 18 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `ruking-clash` × 6 · `snakem982` × 2 · `surfboard-eternity` × 4
