...
![节点](https://img.shields.io/badge/节点-140-brightgreen) ![存活](https://img.shields.io/badge/存活-1720-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-496ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_09:26_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 496 ms
- **最后更新 (UTC)**: 2026-06-14 09:26 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 75 · trojan × 36 · vless × 21 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 21 · `surfboard-eternity` × 4
