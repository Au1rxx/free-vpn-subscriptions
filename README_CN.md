...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2468-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-125ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-27_16:12_UTC-informational)
...
- **最快延迟**: 42 ms
- **中位延迟**: 125 ms
- **最后更新 (UTC)**: 2026-04-27 16:12 UTC

**协议分布:** shadowsocks × 27 · trojan × 14 · vless × 98 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 57 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 6
