...
![节点](https://img.shields.io/badge/节点-146-brightgreen) ![存活](https://img.shields.io/badge/存活-2072-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-362ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_03:13_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 362 ms
- **最后更新 (UTC)**: 2026-06-23 03:13 UTC

**协议分布:** shadowsocks × 41 · trojan × 27 · vless × 63 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 52 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 23 · `pawdroid` × 1 · `ruking-clash` × 18 · `surfboard-eternity` × 3
