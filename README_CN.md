...
![节点](https://img.shields.io/badge/节点-83-brightgreen) ![存活](https://img.shields.io/badge/存活-2363-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-93ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_21:26_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 93 ms
- **最后更新 (UTC)**: 2026-06-02 21:26 UTC

**协议分布:** shadowsocks × 21 · trojan × 30 · vless × 6 · vmess × 26

**本次使用的源:** `barry-far-v2ray` × 17 · `epodonios` × 9 · `mahdi0024` × 24 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
