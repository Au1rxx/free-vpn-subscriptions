...
![节点](https://img.shields.io/badge/节点-81-brightgreen) ![存活](https://img.shields.io/badge/存活-2444-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-78ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-03_12:24_UTC-informational)
...
- **最快延迟**: 26 ms
- **中位延迟**: 78 ms
- **最后更新 (UTC)**: 2026-06-03 12:24 UTC

**协议分布:** shadowsocks × 14 · trojan × 38 · vless × 6 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 27 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 9 · `pawdroid` × 2 · `surfboard-eternity` × 4
