...
![节点](https://img.shields.io/badge/节点-86-brightgreen) ![存活](https://img.shields.io/badge/存活-2053-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-168ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-04_04:16_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 168 ms
- **最后更新 (UTC)**: 2026-07-04 04:16 UTC

**协议分布:** shadowsocks × 29 · trojan × 23 · vless × 13 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 7 · `ninjastrikers` × 20 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
