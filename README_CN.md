...
![节点](https://img.shields.io/badge/节点-144-brightgreen) ![存活](https://img.shields.io/badge/存活-2125-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-164ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_23:24_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 164 ms
- **最后更新 (UTC)**: 2026-04-28 23:24 UTC

**协议分布:** shadowsocks × 33 · trojan × 22 · vless × 78 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 39 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 7 · `ninjastrikers` × 55 · `ruking-clash` × 1 · `surfboard-eternity` × 6
