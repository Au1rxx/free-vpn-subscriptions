...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2373-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-88ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-23_14:39_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 88 ms
- **最后更新 (UTC)**: 2026-05-23 14:39 UTC

**协议分布:** shadowsocks × 39 · trojan × 18 · vless × 66 · vmess × 27

**本次使用的源:** `barry-far-v2ray` × 25 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 42 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 48 · `pawdroid` × 7 · `surfboard-eternity` × 4
