...
![节点](https://img.shields.io/badge/节点-86-brightgreen) ![存活](https://img.shields.io/badge/存活-2173-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-169ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_10:23_UTC-informational)
...
- **最快延迟**: 23 ms
- **中位延迟**: 169 ms
- **最后更新 (UTC)**: 2026-06-07 10:23 UTC

**协议分布:** shadowsocks × 30 · trojan × 21 · vless × 11 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
