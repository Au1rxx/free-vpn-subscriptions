...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2028-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-69ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_09:11_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 69 ms
- **最后更新 (UTC)**: 2026-05-22 09:11 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 36 · trojan × 10 · vless × 91 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 67 · `pawdroid` × 4 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 8
