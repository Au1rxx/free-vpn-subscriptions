...
![节点](https://img.shields.io/badge/节点-120-brightgreen) ![存活](https://img.shields.io/badge/存活-1938-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-281ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-06_01:19_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 281 ms
- **最后更新 (UTC)**: 2026-07-06 01:19 UTC

**协议分布:** shadowsocks × 44 · trojan × 24 · vless × 20 · vmess × 32

**本次使用的源:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 30 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 10 · `ninjastrikers` × 20 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 5
