...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2663-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-74ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-17_13:25_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 74 ms
- **最后更新 (UTC)**: 2026-05-17 13:25 UTC

**协议分布:** shadowsocks × 42 · trojan × 9 · vless × 89 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 55 · `pawdroid` × 6 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 5
