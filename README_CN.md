...
![节点](https://img.shields.io/badge/节点-105-brightgreen) ![存活](https://img.shields.io/badge/存活-1933-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-124ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-05_06:15_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 124 ms
- **最后更新 (UTC)**: 2026-06-05 06:15 UTC

**协议分布:** shadowsocks × 30 · trojan × 35 · vless × 28 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 13 · `epodonios` × 29 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 2
