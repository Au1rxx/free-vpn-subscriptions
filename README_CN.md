...
![节点](https://img.shields.io/badge/节点-104-brightgreen) ![存活](https://img.shields.io/badge/存活-1870-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-355ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_04:11_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 355 ms
- **最后更新 (UTC)**: 2026-06-30 04:11 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 40 · trojan × 39 · vless × 16 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 6
