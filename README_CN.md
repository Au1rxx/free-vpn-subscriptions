...
![节点](https://img.shields.io/badge/节点-79-brightgreen) ![存活](https://img.shields.io/badge/存活-2430-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-70ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-03_09:17_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 70 ms
- **最后更新 (UTC)**: 2026-06-03 09:17 UTC

**协议分布:** shadowsocks × 13 · trojan × 38 · vless × 5 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 23 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `surfboard-eternity` × 2
