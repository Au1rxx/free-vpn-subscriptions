...
![节点](https://img.shields.io/badge/节点-74-brightgreen) ![存活](https://img.shields.io/badge/存活-1982-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-180ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-03_15:35_UTC-informational)
...
- **最快延迟**: 42 ms
- **中位延迟**: 180 ms
- **最后更新 (UTC)**: 2026-07-03 15:35 UTC

**协议分布:** shadowsocks × 22 · trojan × 23 · vless × 6 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
