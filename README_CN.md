...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2394-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-139ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_23:20_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 139 ms
- **最后更新 (UTC)**: 2026-05-12 23:20 UTC

**协议分布:** shadowsocks × 34 · trojan × 19 · vless × 84 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 43 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 44 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 2
