...
![节点](https://img.shields.io/badge/节点-115-brightgreen) ![存活](https://img.shields.io/badge/存活-1983-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-373ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_23:25_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 373 ms
- **最后更新 (UTC)**: 2026-06-12 23:25 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 53 · trojan × 44 · vless × 11 · vmess × 6

**本次使用的源:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 33 · `lagzian-mix` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 7
