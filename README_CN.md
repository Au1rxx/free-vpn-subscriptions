...
![节点](https://img.shields.io/badge/节点-68-brightgreen) ![存活](https://img.shields.io/badge/存活-1993-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-169ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-04_12:25_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 169 ms
- **最后更新 (UTC)**: 2026-07-04 12:25 UTC

**协议分布:** shadowsocks × 23 · trojan × 21 · vless × 8 · vmess × 16

**本次使用的源:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 13 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 2
