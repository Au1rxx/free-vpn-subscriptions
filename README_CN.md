...
![节点](https://img.shields.io/badge/节点-117-brightgreen) ![存活](https://img.shields.io/badge/存活-1984-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-348ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_03:17_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 348 ms
- **最后更新 (UTC)**: 2026-06-28 03:17 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 32 · trojan × 38 · vless × 36 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 5
