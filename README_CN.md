...
![节点](https://img.shields.io/badge/节点-147-brightgreen) ![存活](https://img.shields.io/badge/存活-2592-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-124ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_20:30_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 124 ms
- **最后更新 (UTC)**: 2026-04-24 20:30 UTC

**协议分布:** shadowsocks × 28 · trojan × 22 · vless × 84 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
