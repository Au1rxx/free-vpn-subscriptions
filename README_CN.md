...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2567-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-142ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-26_19:38_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 142 ms
- **最后更新 (UTC)**: 2026-04-26 19:38 UTC

**协议分布:** shadowsocks × 38 · trojan × 18 · vless × 80 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 43 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 4 · `ninjastrikers` × 53 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
