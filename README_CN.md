...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2218-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-123ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_06:21_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 123 ms
- **最后更新 (UTC)**: 2026-04-22 06:21 UTC

**协议分布:** shadowsocks × 36 · trojan × 4 · vless × 98 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 38 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 9
