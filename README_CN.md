...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2521-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-90ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_10:41_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 90 ms
- **最后更新 (UTC)**: 2026-04-20 10:41 UTC

**协议分布:** shadowsocks × 21 · trojan × 9 · vless × 107 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 35 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 1 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 4
