...
![节点](https://img.shields.io/badge/节点-121-brightgreen) ![存活](https://img.shields.io/badge/存活-1977-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-368ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_07:33_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 368 ms
- **最后更新 (UTC)**: 2026-06-28 07:33 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 36 · trojan × 42 · vless × 29 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
