...
![节点](https://img.shields.io/badge/节点-135-brightgreen) ![存活](https://img.shields.io/badge/存活-2216-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_19:27_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 167 ms
- **最后更新 (UTC)**: 2026-04-28 19:27 UTC

**协议分布:** shadowsocks × 28 · trojan × 23 · vless × 72 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 31 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
