...
![节点](https://img.shields.io/badge/节点-83-brightgreen) ![存活](https://img.shields.io/badge/存活-1845-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-378ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_19:26_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 378 ms
- **最后更新 (UTC)**: 2026-06-30 19:26 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 33 · trojan × 30 · vless × 14 · vmess × 5

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 8 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 3
