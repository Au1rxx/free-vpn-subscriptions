...
![节点](https://img.shields.io/badge/节点-81-brightgreen) ![存活](https://img.shields.io/badge/存活-2018-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-161ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-04_06:09_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 161 ms
- **最后更新 (UTC)**: 2026-07-04 06:09 UTC

**协议分布:** shadowsocks × 26 · trojan × 22 · vless × 12 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
