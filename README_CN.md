...
![节点](https://img.shields.io/badge/节点-130-brightgreen) ![存活](https://img.shields.io/badge/存活-2005-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-469ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_21:23_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 469 ms
- **最后更新 (UTC)**: 2026-06-23 21:23 UTC

**协议分布:** hysteria2 × 2 · shadowsocks × 38 · trojan × 30 · vless × 45 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 45 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
