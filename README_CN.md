...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2195-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-117ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_10:18_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 117 ms
- **最后更新 (UTC)**: 2026-04-30 10:18 UTC

**协议分布:** shadowsocks × 42 · trojan × 11 · vless × 89 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 59 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
