...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2253-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-397ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_18:10_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 397 ms
- **最后更新 (UTC)**: 2026-04-20 18:10 UTC

**协议分布:** shadowsocks × 28 · trojan × 16 · vless × 93 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 52 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 7
