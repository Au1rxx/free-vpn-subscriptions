...
![节点](https://img.shields.io/badge/节点-125-brightgreen) ![存活](https://img.shields.io/badge/存活-1836-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-408ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_18:11_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 408 ms
- **最后更新 (UTC)**: 2026-06-15 18:11 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 53 · trojan × 23 · vless × 34 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 22 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 19 · `surfboard-eternity` × 1
