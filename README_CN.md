...
![节点](https://img.shields.io/badge/节点-106-brightgreen) ![存活](https://img.shields.io/badge/存活-1965-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-488ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_14:22_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 488 ms
- **最后更新 (UTC)**: 2026-06-18 14:22 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 29 · vmess × 6

**本次使用的源:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 25 · `snakem982` × 7 · `surfboard-eternity` × 2
