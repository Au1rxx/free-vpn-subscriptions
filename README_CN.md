...
![节点](https://img.shields.io/badge/节点-111-brightgreen) ![存活](https://img.shields.io/badge/存活-1996-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-416ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_11:24_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 416 ms
- **最后更新 (UTC)**: 2026-06-28 11:24 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 33 · trojan × 36 · vless × 28 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 16 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 3
