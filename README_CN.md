...
![节点](https://img.shields.io/badge/节点-134-brightgreen) ![存活](https://img.shields.io/badge/存活-2048-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-361ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_02:30_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 361 ms
- **最后更新 (UTC)**: 2026-06-24 02:30 UTC

**协议分布:** shadowsocks × 35 · trojan × 27 · vless × 57 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 45 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 24 · `pawdroid` × 7 · `ruking-clash` × 12 · `surfboard-eternity` × 6
