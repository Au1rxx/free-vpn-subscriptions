...
![节点](https://img.shields.io/badge/节点-102-brightgreen) ![存活](https://img.shields.io/badge/存活-2146-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-569ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_13:31_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 569 ms
- **最后更新 (UTC)**: 2026-06-29 13:31 UTC

**协议分布:** shadowsocks × 16 · trojan × 52 · vless × 20 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 31 · `epodonios` × 18 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 10
