...
![节点](https://img.shields.io/badge/节点-128-brightgreen) ![存活](https://img.shields.io/badge/存活-2544-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-472ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_06:37_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 472 ms
- **最后更新 (UTC)**: 2026-06-19 06:37 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 35 · trojan × 23 · vless × 55 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 34 · `snakem982` × 5 · `surfboard-eternity` × 1
