...
![节点](https://img.shields.io/badge/节点-111-brightgreen) ![存活](https://img.shields.io/badge/存活-2016-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-338ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-25_11:11_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 338 ms
- **最后更新 (UTC)**: 2026-06-25 11:11 UTC

**协议分布:** shadowsocks × 35 · trojan × 29 · vless × 34 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 34 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 7
