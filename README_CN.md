...
![节点](https://img.shields.io/badge/节点-84-brightgreen) ![存活](https://img.shields.io/badge/存活-2086-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-178ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_19:33_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 178 ms
- **最后更新 (UTC)**: 2026-06-06 19:33 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 32 · trojan × 20 · vless × 7 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 39 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 2
