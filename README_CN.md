...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2179-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-238ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_12:25_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 238 ms
- **最后更新 (UTC)**: 2026-04-22 12:25 UTC

**协议分布:** shadowsocks × 35 · trojan × 21 · vless × 81 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 71 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 7
