...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2344-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-84ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-20_20:31_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 84 ms
- **最后更新 (UTC)**: 2026-05-20 20:31 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 36 · trojan × 23 · vless × 70 · vmess × 20

**本次使用的源:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
