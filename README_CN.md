...
![节点](https://img.shields.io/badge/节点-83-brightgreen) ![存活](https://img.shields.io/badge/存活-2145-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-171ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-05_22:13_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 171 ms
- **最后更新 (UTC)**: 2026-06-05 22:13 UTC

**协议分布:** shadowsocks × 25 · trojan × 28 · vless × 12 · vmess × 18

**本次使用的源:** `barry-far-v2ray` × 2 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 12 · `surfboard-eternity` × 2
