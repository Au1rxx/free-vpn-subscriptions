...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2274-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-275ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_15:11_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 275 ms
- **最后更新 (UTC)**: 2026-04-20 15:11 UTC

**协议分布:** shadowsocks × 29 · trojan × 12 · vless × 98 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 51 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `ruking-clash` × 6 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
