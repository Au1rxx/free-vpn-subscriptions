...
![节点](https://img.shields.io/badge/节点-119-brightgreen) ![存活](https://img.shields.io/badge/存活-2519-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-429ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_20:36_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 429 ms
- **最后更新 (UTC)**: 2026-04-23 20:36 UTC

**协议分布:** shadowsocks × 14 · trojan × 25 · vless × 65 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `surfboard-eternity` × 6
