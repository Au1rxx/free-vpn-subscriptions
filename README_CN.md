...
![节点](https://img.shields.io/badge/节点-144-brightgreen) ![存活](https://img.shields.io/badge/存活-1974-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-501ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_22:32_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 501 ms
- **最后更新 (UTC)**: 2026-06-16 22:32 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 16 · vmess × 54

**本次使用的源:** `barry-far-v2ray` × 6 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 58 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `ruking-clash` × 18
