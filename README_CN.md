...
![节点](https://img.shields.io/badge/节点-62-brightgreen) ![存活](https://img.shields.io/badge/存活-1987-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-162ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-27_22:14_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 162 ms
- **最后更新 (UTC)**: 2026-05-27 22:14 UTC

**协议分布:** shadowsocks × 25 · trojan × 20 · vless × 8 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `ruking-clash` × 2 · `snakem982` × 7 · `surfboard-eternity` × 2
