...
![节点](https://img.shields.io/badge/节点-141-brightgreen) ![存活](https://img.shields.io/badge/存活-2494-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-170ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-09_19:15_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 170 ms
- **最后更新 (UTC)**: 2026-05-09 19:15 UTC

**协议分布:** shadowsocks × 52 · trojan × 16 · vless × 64 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 20 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
