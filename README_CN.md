...
![节点](https://img.shields.io/badge/节点-80-brightgreen) ![存活](https://img.shields.io/badge/存活-2323-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-225ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_20:20_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 225 ms
- **最后更新 (UTC)**: 2026-06-19 20:20 UTC

**协议分布:** shadowsocks × 23 · trojan × 25 · vless × 7 · vmess × 25

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 14 · `surfboard-eternity` × 3
