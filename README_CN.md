...
![节点](https://img.shields.io/badge/节点-81-brightgreen) ![存活](https://img.shields.io/badge/存活-2348-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-163ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_05:28_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 163 ms
- **最后更新 (UTC)**: 2026-06-10 05:28 UTC

**协议分布:** shadowsocks × 28 · trojan × 13 · vless × 18 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 5
