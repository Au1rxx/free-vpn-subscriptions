...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2481-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-80ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-21_13:38_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 80 ms
- **最后更新 (UTC)**: 2026-05-21 13:38 UTC

**协议分布:** shadowsocks × 36 · trojan × 10 · vless × 85 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 25 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 17 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 60 · `pawdroid` × 9 · `ruking-clash` × 5 · `surfboard-eternity` × 9
