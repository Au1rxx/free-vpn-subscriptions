...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-389-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-140ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-19_06:10_UTC-informational)
...
- **最快延迟**: 8 ms
- **中位延迟**: 140 ms
- **最后更新 (UTC)**: 2026-04-19 06:10 UTC

**协议分布:** shadowsocks × 101 · trojan × 7 · vmess × 42

**本次使用的源:** `freefq` × 2 · `mahdibland-aggregator` × 65 · `mahdibland-shadowsocks` × 68 · `vxiaov-clash` × 15
