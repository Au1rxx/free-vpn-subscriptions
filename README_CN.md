...
![节点](https://img.shields.io/badge/节点-136-brightgreen) ![存活](https://img.shields.io/badge/存活-1999-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-448ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_23:09_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 448 ms
- **最后更新 (UTC)**: 2026-06-23 23:09 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 39 · trojan × 30 · vless × 51 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 49 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
