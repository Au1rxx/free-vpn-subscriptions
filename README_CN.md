...
![节点](https://img.shields.io/badge/节点-120-brightgreen) ![存活](https://img.shields.io/badge/存活-1809-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-377ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_08:22_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 377 ms
- **最后更新 (UTC)**: 2026-06-16 08:22 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 50 · trojan × 27 · vless × 27 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 20 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 4
