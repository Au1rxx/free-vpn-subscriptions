...
![节点](https://img.shields.io/badge/节点-105-brightgreen) ![存活](https://img.shields.io/badge/存活-1813-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-401ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-13_17:28_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 401 ms
- **最后更新 (UTC)**: 2026-06-13 17:28 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 54 · trojan × 29 · vless × 14 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 5
