...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2570-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-121ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_13:24_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 121 ms
- **最后更新 (UTC)**: 2026-04-20 13:24 UTC

**协议分布:** shadowsocks × 19 · trojan × 8 · vless × 111 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 46 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 23 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 50 · `ruking-clash` × 7 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
