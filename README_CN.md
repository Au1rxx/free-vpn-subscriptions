...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2331-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-81ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_20:28_UTC-informational)
...
- **最快延迟**: 40 ms
- **中位延迟**: 81 ms
- **最后更新 (UTC)**: 2026-05-22 20:28 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 83 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 55 · `pawdroid` × 8 · `ruking-clash` × 5 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
