...
![节点](https://img.shields.io/badge/节点-138-brightgreen) ![存活](https://img.shields.io/badge/存活-2690-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-177ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_23:28_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 177 ms
- **最后更新 (UTC)**: 2026-04-24 23:28 UTC

**协议分布:** shadowsocks × 24 · trojan × 22 · vless × 77 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 46 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
