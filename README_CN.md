...
![节点](https://img.shields.io/badge/节点-81-brightgreen) ![存活](https://img.shields.io/badge/存活-1890-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-158ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-03_06:23_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 158 ms
- **最后更新 (UTC)**: 2026-07-03 06:23 UTC

**协议分布:** shadowsocks × 29 · trojan × 20 · vless × 15 · vmess × 17

**本次使用的源:** `barry-far-v2ray` × 6 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 16 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
