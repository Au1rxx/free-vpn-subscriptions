...
![节点](https://img.shields.io/badge/节点-107-brightgreen) ![存活](https://img.shields.io/badge/存活-1888-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-303ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-09_03:22_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 303 ms
- **最后更新 (UTC)**: 2026-06-09 03:22 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 45 · trojan × 22 · vless × 29 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 27 · `pawdroid` × 4 · `ruking-clash` × 9 · `surfboard-eternity` × 3
