...
![节点](https://img.shields.io/badge/节点-96-brightgreen) ![存活](https://img.shields.io/badge/存活-1969-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-361ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_22:28_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 361 ms
- **最后更新 (UTC)**: 2026-06-27 22:28 UTC

**协议分布:** shadowsocks × 28 · trojan × 39 · vless × 17 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 8 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 14 · `ruking-clash` × 14 · `surfboard-eternity` × 5
