...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2462-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-76ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_11:25_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 76 ms
- **最后更新 (UTC)**: 2026-05-18 11:25 UTC

**协议分布:** shadowsocks × 42 · trojan × 8 · vless × 93 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 21 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 37 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
