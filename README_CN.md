...
![节点](https://img.shields.io/badge/节点-146-brightgreen) ![存活](https://img.shields.io/badge/存活-2348-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-99ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-24_18:24_UTC-informational)
...
- **最快延迟**: 39 ms
- **中位延迟**: 99 ms
- **最后更新 (UTC)**: 2026-05-24 18:24 UTC

**协议分布:** shadowsocks × 41 · trojan × 19 · vless × 60 · vmess × 26

**本次使用的源:** `barry-far-v2ray` × 18 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 46 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 54 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
