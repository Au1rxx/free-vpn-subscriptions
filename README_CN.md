...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2235-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-207ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_18:39_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 207 ms
- **最后更新 (UTC)**: 2026-04-30 18:39 UTC

**协议分布:** shadowsocks × 30 · trojan × 25 · vless × 73 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 32 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `snakem982` × 3 · `surfboard-eternity` × 5
