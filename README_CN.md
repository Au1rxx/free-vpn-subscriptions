...
![节点](https://img.shields.io/badge/节点-124-brightgreen) ![存活](https://img.shields.io/badge/存活-2059-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-406ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_07:27_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 406 ms
- **最后更新 (UTC)**: 2026-06-23 07:27 UTC

**协议分布:** shadowsocks × 35 · trojan × 31 · vless × 47 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 3 · `epodonios` × 45 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 3
