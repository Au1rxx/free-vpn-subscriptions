...
![节点](https://img.shields.io/badge/节点-93-brightgreen) ![存活](https://img.shields.io/badge/存活-2266-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-277ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_08:26_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 277 ms
- **最后更新 (UTC)**: 2026-06-20 08:26 UTC

**协议分布:** shadowsocks × 22 · trojan × 28 · vless × 14 · vmess × 29

**本次使用的源:** `barry-far-v2ray` × 4 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 18 · `surfboard-eternity` × 4
