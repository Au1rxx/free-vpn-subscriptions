...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2493-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-143ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-10_10:28_UTC-informational)
...
- **最快延迟**: 24 ms
- **中位延迟**: 143 ms
- **最后更新 (UTC)**: 2026-05-10 10:28 UTC

**协议分布:** shadowsocks × 49 · trojan × 7 · vless × 86 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 32 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 9
