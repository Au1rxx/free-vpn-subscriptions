...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2556-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-99ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_13:31_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 99 ms
- **最后更新 (UTC)**: 2026-04-28 13:31 UTC

**协议分布:** shadowsocks × 21 · trojan × 22 · vless × 96 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 29 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 59 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
