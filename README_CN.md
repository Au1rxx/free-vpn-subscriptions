...
![节点](https://img.shields.io/badge/节点-82-brightgreen) ![存活](https://img.shields.io/badge/存活-2400-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-74ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-03_08:35_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 74 ms
- **最后更新 (UTC)**: 2026-06-03 08:35 UTC

**协议分布:** shadowsocks × 14 · trojan × 37 · vless × 6 · vmess × 25

**本次使用的源:** `barry-far-v2ray` × 21 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 10 · `pawdroid` × 1 · `surfboard-eternity` × 2
