...
![节点](https://img.shields.io/badge/节点-136-brightgreen) ![存活](https://img.shields.io/badge/存活-2595-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-380ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_17:34_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 380 ms
- **最后更新 (UTC)**: 2026-04-22 17:34 UTC

**协议分布:** shadowsocks × 29 · trojan × 22 · vless × 72 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 20 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 54 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
