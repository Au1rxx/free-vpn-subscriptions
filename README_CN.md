...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2213-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-153ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_12:19_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 153 ms
- **最后更新 (UTC)**: 2026-04-30 12:19 UTC

**协议分布:** shadowsocks × 34 · trojan × 19 · vless × 87 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 40 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
