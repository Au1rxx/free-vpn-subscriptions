...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1832-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-470ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_16:37_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 470 ms
- **最后更新 (UTC)**: 2026-06-22 16:37 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 42 · trojan × 26 · vless × 68 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 4
