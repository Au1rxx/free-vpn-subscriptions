...
![节点](https://img.shields.io/badge/节点-123-brightgreen) ![存活](https://img.shields.io/badge/存活-2060-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-359ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_04:29_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 359 ms
- **最后更新 (UTC)**: 2026-06-24 04:29 UTC

**协议分布:** shadowsocks × 34 · trojan × 28 · vless × 45 · vmess × 16

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 42 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `pawdroid` × 4 · `ruking-clash` × 13 · `surfboard-eternity` × 2
