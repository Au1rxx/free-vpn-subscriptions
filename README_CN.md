...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2259-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-150ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_07:28_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 150 ms
- **最后更新 (UTC)**: 2026-04-22 07:28 UTC

**协议分布:** shadowsocks × 31 · trojan × 4 · vless × 103 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 39 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 11 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 66 · `ruking-clash` × 4 · `surfboard-eternity` × 6
