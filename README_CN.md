...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2062-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-117ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_01:23_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 117 ms
- **最后更新 (UTC)**: 2026-04-30 01:23 UTC

**协议分布:** shadowsocks × 43 · trojan × 4 · vless × 94 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 28 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 69 · `surfboard-eternity` × 7
