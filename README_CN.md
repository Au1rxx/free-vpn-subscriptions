...
![节点](https://img.shields.io/badge/节点-83-brightgreen) ![存活](https://img.shields.io/badge/存活-2264-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-245ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_09:13_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 245 ms
- **最后更新 (UTC)**: 2026-06-10 09:13 UTC

**协议分布:** shadowsocks × 37 · trojan × 12 · vless × 10 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 8 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 6
