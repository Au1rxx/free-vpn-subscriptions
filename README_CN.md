...
![节点](https://img.shields.io/badge/节点-90-brightgreen) ![存活](https://img.shields.io/badge/存活-1923-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-170ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-03_18:38_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 170 ms
- **最后更新 (UTC)**: 2026-06-03 18:38 UTC

**协议分布:** shadowsocks × 26 · trojan × 37 · vless × 15 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 29 · `mahdi0024` × 12 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 10 · `surfboard-eternity` × 3
