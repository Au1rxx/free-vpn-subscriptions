...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2064-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-165ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-29_15:11_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 165 ms
- **最后更新 (UTC)**: 2026-04-29 15:11 UTC

**协议分布:** shadowsocks × 45 · trojan × 8 · vless × 87 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 40 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
