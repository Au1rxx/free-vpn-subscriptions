...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2430-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-80ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-15_11:11_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 80 ms
- **最后更新 (UTC)**: 2026-05-15 11:11 UTC

**协议分布:** shadowsocks × 43 · trojan × 5 · vless × 93 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 3 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `pawdroid` × 7 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
