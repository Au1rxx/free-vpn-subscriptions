...
![节点](https://img.shields.io/badge/节点-84-brightgreen) ![存活](https://img.shields.io/badge/存活-2217-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-178ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_23:34_UTC-informational)
...
- **最快延迟**: 26 ms
- **中位延迟**: 178 ms
- **最后更新 (UTC)**: 2026-06-06 23:34 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 31 · trojan × 21 · vless × 8 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 4 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
