...
![节点](https://img.shields.io/badge/节点-85-brightgreen) ![存活](https://img.shields.io/badge/存活-2101-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-241ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-09_23:15_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 241 ms
- **最后更新 (UTC)**: 2026-06-09 23:15 UTC

**协议分布:** shadowsocks × 37 · trojan × 18 · vless × 8 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 7
