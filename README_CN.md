...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2222-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-126ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_08:25_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 126 ms
- **最后更新 (UTC)**: 2026-04-30 08:25 UTC

**协议分布:** shadowsocks × 31 · trojan × 19 · vless × 92 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 30 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 71 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
