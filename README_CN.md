...
![节点](https://img.shields.io/badge/节点-104-brightgreen) ![存活](https://img.shields.io/badge/存活-2226-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-155ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_03:14_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 155 ms
- **最后更新 (UTC)**: 2026-06-07 03:14 UTC

**协议分布:** shadowsocks × 30 · trojan × 24 · vless × 26 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 33 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 1
