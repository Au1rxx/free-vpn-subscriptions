...
![节点](https://img.shields.io/badge/节点-60-brightgreen) ![存活](https://img.shields.io/badge/存活-1971-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-149ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-27_16:31_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 149 ms
- **最后更新 (UTC)**: 2026-05-27 16:31 UTC

**协议分布:** shadowsocks × 23 · trojan × 12 · vless × 17 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 4 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 3
