...
![节点](https://img.shields.io/badge/节点-145-brightgreen) ![存活](https://img.shields.io/badge/存活-2083-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-372ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_05:24_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 372 ms
- **最后更新 (UTC)**: 2026-06-23 05:24 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 39 · trojan × 29 · vless × 63 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 50 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 21 · `pawdroid` × 4 · `ruking-clash` × 19 · `surfboard-eternity` × 5
