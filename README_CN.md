...
![节点](https://img.shields.io/badge/节点-148-brightgreen) ![存活](https://img.shields.io/badge/存活-2576-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-140ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_15:37_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 140 ms
- **最后更新 (UTC)**: 2026-04-24 15:37 UTC

**协议分布:** shadowsocks × 29 · trojan × 20 · vless × 86 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 20 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 38 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 57 · `pawdroid` × 2 · `surfboard-eternity` × 3
