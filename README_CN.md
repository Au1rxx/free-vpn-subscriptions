...
![节点](https://img.shields.io/badge/节点-90-brightgreen) ![存活](https://img.shields.io/badge/存活-1819-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-418ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_21:15_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 418 ms
- **最后更新 (UTC)**: 2026-06-30 21:15 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 12 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 14 · `surfboard-eternity` × 3
