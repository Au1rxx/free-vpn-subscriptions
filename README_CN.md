...
![节点](https://img.shields.io/badge/节点-114-brightgreen) ![存活](https://img.shields.io/badge/存活-1849-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-354ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_07:11_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 354 ms
- **最后更新 (UTC)**: 2026-06-15 07:11 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 53 · trojan × 23 · vless × 18 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 19 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 4
