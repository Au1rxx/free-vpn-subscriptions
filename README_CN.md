...
![节点](https://img.shields.io/badge/节点-79-brightgreen) ![存活](https://img.shields.io/badge/存活-2245-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-159ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-31_12:30_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 159 ms
- **最后更新 (UTC)**: 2026-05-31 12:30 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 23 · trojan × 21 · vless × 7 · vmess × 27

**本次使用的源:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
