...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2614-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-76ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_08:14_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 76 ms
- **最后更新 (UTC)**: 2026-05-18 08:14 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 40 · trojan × 8 · vless × 94 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 53 · `pawdroid` × 10 · `ruking-clash` × 7 · `surfboard-eternity` × 6
