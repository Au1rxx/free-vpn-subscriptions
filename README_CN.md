...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2118-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-117ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_00:39_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 117 ms
- **最后更新 (UTC)**: 2026-04-30 00:39 UTC

**协议分布:** shadowsocks × 41 · trojan × 4 · vless × 96 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 31 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 70 · `snakem982` × 1 · `surfboard-eternity` × 5
