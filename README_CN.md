...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2354-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-89ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_16:18_UTC-informational)
...
- **最快延迟**: 45 ms
- **中位延迟**: 89 ms
- **最后更新 (UTC)**: 2026-05-22 16:18 UTC

**协议分布:** shadowsocks × 37 · trojan × 16 · vless × 87 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 25 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 64 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 4
