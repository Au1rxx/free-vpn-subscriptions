...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2228-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-142ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-06_01:28_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 142 ms
- **最后更新 (UTC)**: 2026-05-06 01:28 UTC

**协议分布:** shadowsocks × 36 · trojan × 15 · vless × 89 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 27 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 79 · `pawdroid` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
