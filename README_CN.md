...
![节点](https://img.shields.io/badge/节点-114-brightgreen) ![存活](https://img.shields.io/badge/存活-1910-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-198ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-04_15:35_UTC-informational)
...
- **最快延迟**: 24 ms
- **中位延迟**: 198 ms
- **最后更新 (UTC)**: 2026-06-04 15:35 UTC

**协议分布:** shadowsocks × 25 · trojan × 57 · vless × 19 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 40 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `ruking-clash` × 3 · `surfboard-eternity` × 2
