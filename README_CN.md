...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2574-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-130ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-26_18:37_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 130 ms
- **最后更新 (UTC)**: 2026-04-26 18:37 UTC

**协议分布:** shadowsocks × 39 · trojan × 13 · vless × 85 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 18 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 50 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
