...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2277-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-155ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-25_18:30_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 155 ms
- **最后更新 (UTC)**: 2026-04-25 18:30 UTC

**协议分布:** shadowsocks × 35 · trojan × 17 · vless × 85 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 52 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
