...
![节点](https://img.shields.io/badge/节点-116-brightgreen) ![存活](https://img.shields.io/badge/存活-1780-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-365ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_01:09_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 365 ms
- **最后更新 (UTC)**: 2026-06-18 01:09 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 47 · trojan × 29 · vless × 32 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 24 · `pawdroid` × 1 · `ruking-clash` × 15 · `surfboard-eternity` × 4
