...
![节点](https://img.shields.io/badge/节点-143-brightgreen) ![存活](https://img.shields.io/badge/存活-2358-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-109ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-24_22:18_UTC-informational)
...
- **最快延迟**: 23 ms
- **中位延迟**: 109 ms
- **最后更新 (UTC)**: 2026-05-24 22:18 UTC

**协议分布:** shadowsocks × 44 · trojan × 18 · vless × 53 · vmess × 28

**本次使用的源:** `barry-far-v2ray` × 12 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 49 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
