...
![节点](https://img.shields.io/badge/节点-142-brightgreen) ![存活](https://img.shields.io/badge/存活-2241-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-411ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_23:36_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 411 ms
- **最后更新 (UTC)**: 2026-04-21 23:36 UTC

**协议分布:** shadowsocks × 33 · trojan × 23 · vless × 71 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 32 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 4 · `surfboard-eternity` × 6
