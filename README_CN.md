...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1904-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-371ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_05:29_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 371 ms
- **最后更新 (UTC)**: 2026-06-22 05:29 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 49 · trojan × 27 · vless × 61 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 29 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 26 · `pawdroid` × 2 · `ruking-clash` × 31 · `snakem982` × 1 · `surfboard-eternity` × 3
