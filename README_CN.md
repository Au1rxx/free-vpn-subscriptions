...
![节点](https://img.shields.io/badge/节点-121-brightgreen) ![存活](https://img.shields.io/badge/存活-2461-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-493ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_10:26_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 493 ms
- **最后更新 (UTC)**: 2026-06-19 10:26 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 32 · trojan × 21 · vless × 52 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 20 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 42 · `snakem982` × 3 · `surfboard-eternity` × 2
