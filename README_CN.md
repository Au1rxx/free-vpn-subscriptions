...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2284-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-66ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_09:31_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 66 ms
- **最后更新 (UTC)**: 2026-05-19 09:31 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 17 · trojan × 27 · vless × 88 · vmess × 17

**本次使用的源:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 61 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 4
