...
![节点](https://img.shields.io/badge/节点-107-brightgreen) ![存活](https://img.shields.io/badge/存活-1955-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-383ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_19:19_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 383 ms
- **最后更新 (UTC)**: 2026-06-10 19:19 UTC

**协议分布:** shadowsocks × 43 · trojan × 18 · vless × 11 · vmess × 35

**本次使用的源:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 34 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 6 · `surfboard-eternity` × 1
