...
![节点](https://img.shields.io/badge/节点-135-brightgreen) ![存活](https://img.shields.io/badge/存活-2208-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-166ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_15:20_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 166 ms
- **最后更新 (UTC)**: 2026-04-28 15:20 UTC

**协议分布:** shadowsocks × 30 · trojan × 20 · vless × 75 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 59 · `ruking-clash` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
