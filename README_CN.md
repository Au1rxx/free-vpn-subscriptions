...
![节点](https://img.shields.io/badge/节点-95-brightgreen) ![存活](https://img.shields.io/badge/存活-1941-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-156ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-04_08:34_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 156 ms
- **最后更新 (UTC)**: 2026-06-04 08:34 UTC

**协议分布:** shadowsocks × 23 · trojan × 44 · vless × 21 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 32 · `epodonios` × 23 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 1
