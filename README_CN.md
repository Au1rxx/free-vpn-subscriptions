...
![节点](https://img.shields.io/badge/节点-98-brightgreen) ![存活](https://img.shields.io/badge/存活-2240-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-472ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_11:15_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 472 ms
- **最后更新 (UTC)**: 2026-06-12 11:15 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 43 · trojan × 38 · vless × 11 · vmess × 5

**本次使用的源:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 30 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `ruking-clash` × 5 · `surfboard-eternity` × 4
