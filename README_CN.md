...
![节点](https://img.shields.io/badge/节点-146-brightgreen) ![存活](https://img.shields.io/badge/存活-1888-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-478ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_14:22_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 478 ms
- **最后更新 (UTC)**: 2026-06-22 14:22 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 40 · trojan × 29 · vless × 63 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 41 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 31 · `snakem982` × 3 · `surfboard-eternity` × 2
