...
![节点](https://img.shields.io/badge/节点-72-brightgreen) ![存活](https://img.shields.io/badge/存活-2143-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-139ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-30_11:16_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 139 ms
- **最后更新 (UTC)**: 2026-05-30 11:16 UTC

**协议分布:** shadowsocks × 27 · trojan × 8 · vless × 8 · vmess × 29

**本次使用的源:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 4 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
