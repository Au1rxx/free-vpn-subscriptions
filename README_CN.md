...
![节点](https://img.shields.io/badge/节点-87-brightgreen) ![存活](https://img.shields.io/badge/存活-2242-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-235ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_04:29_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 235 ms
- **最后更新 (UTC)**: 2026-06-29 04:29 UTC

**协议分布:** shadowsocks × 17 · trojan × 30 · vless × 27 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 6 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 8 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 3
