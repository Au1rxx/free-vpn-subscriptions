...
![节点](https://img.shields.io/badge/节点-127-brightgreen) ![存活](https://img.shields.io/badge/存活-2509-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-398ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_19:33_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 398 ms
- **最后更新 (UTC)**: 2026-04-23 19:33 UTC

**协议分布:** shadowsocks × 13 · trojan × 24 · vless × 76 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 24 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `pawdroid` × 1 · `surfboard-eternity` × 1
