...
![节点](https://img.shields.io/badge/节点-70-brightgreen) ![存活](https://img.shields.io/badge/存活-2215-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-152ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_22:35_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 152 ms
- **最后更新 (UTC)**: 2026-06-28 22:35 UTC

**协议分布:** shadowsocks × 17 · trojan × 19 · vless × 19 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 2 · `surfboard-eternity` × 1
