...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1974-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-146ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_05:23_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 146 ms
- **最后更新 (UTC)**: 2026-05-12 05:23 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 57 · trojan × 5 · vless × 77 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 4 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 12
