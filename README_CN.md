...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2241-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-181ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_10:32_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 181 ms
- **最后更新 (UTC)**: 2026-04-22 10:32 UTC

**协议分布:** shadowsocks × 30 · trojan × 18 · vless × 90 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 36 · `epodonios` × 9 · `lagzian-mix` × 7 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 6
