...
![节点](https://img.shields.io/badge/节点-72-brightgreen) ![存活](https://img.shields.io/badge/存活-2157-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-169ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_13:11_UTC-informational)
...
- **最快延迟**: 26 ms
- **中位延迟**: 169 ms
- **最后更新 (UTC)**: 2026-06-06 13:11 UTC

**协议分布:** shadowsocks × 24 · trojan × 24 · vless × 7 · vmess × 17

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3
