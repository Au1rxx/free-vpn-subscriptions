...
![节点](https://img.shields.io/badge/节点-66-brightgreen) ![存活](https://img.shields.io/badge/存活-2194-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-361ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-05_15:36_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 361 ms
- **最后更新 (UTC)**: 2026-06-05 15:36 UTC

**协议分布:** shadowsocks × 14 · trojan × 24 · vless × 13 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 4 · `epodonios` × 20 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 10 · `pawdroid` × 3 · `surfboard-eternity` × 2
