...
![节点](https://img.shields.io/badge/节点-97-brightgreen) ![存活](https://img.shields.io/badge/存活-2165-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-137ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_01:30_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 137 ms
- **最后更新 (UTC)**: 2026-06-06 01:30 UTC

**协议分布:** shadowsocks × 22 · trojan × 27 · vless × 31 · vmess × 17

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 30 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
