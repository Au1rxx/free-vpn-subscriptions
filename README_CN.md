...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2270-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-158ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_09:38_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 158 ms
- **最后更新 (UTC)**: 2026-04-22 09:38 UTC

**协议分布:** shadowsocks × 34 · trojan × 13 · vless × 92 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 34 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 71 · `ruking-clash` × 6 · `surfboard-eternity` × 7
