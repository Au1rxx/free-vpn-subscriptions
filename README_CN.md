...
![节点](https://img.shields.io/badge/节点-143-brightgreen) ![存活](https://img.shields.io/badge/存活-2322-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-116ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_23:28_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 116 ms
- **最后更新 (UTC)**: 2026-05-22 23:28 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 37 · trojan × 24 · vless × 70 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 53 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
