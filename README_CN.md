...
![节点](https://img.shields.io/badge/节点-92-brightgreen) ![存活](https://img.shields.io/badge/存活-2406-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-118ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-01_06:09_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 118 ms
- **最后更新 (UTC)**: 2026-06-01 06:09 UTC

**协议分布:** shadowsocks × 21 · trojan × 20 · vless × 15 · vmess × 36

**本次使用的源:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 29 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 18 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
