...
![节点](https://img.shields.io/badge/节点-92-brightgreen) ![存活](https://img.shields.io/badge/存活-2317-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-172ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_05:15_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 172 ms
- **最后更新 (UTC)**: 2026-06-20 05:15 UTC

**协议分布:** shadowsocks × 22 · trojan × 24 · vless × 16 · vmess × 30

**本次使用的源:** `barry-far-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 3
