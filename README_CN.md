...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2235-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-333ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_14:39_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 333 ms
- **最后更新 (UTC)**: 2026-04-21 14:39 UTC

**协议分布:** shadowsocks × 34 · trojan × 13 · vless × 90 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 50 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
