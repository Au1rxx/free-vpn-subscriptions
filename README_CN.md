...
![节点](https://img.shields.io/badge/节点-136-brightgreen) ![存活](https://img.shields.io/badge/存活-2469-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-217ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_22:26_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 217 ms
- **最后更新 (UTC)**: 2026-04-23 22:26 UTC

**协议分布:** shadowsocks × 20 · trojan × 23 · vless × 74 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 7
