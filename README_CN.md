...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2244-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-142ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_05:30_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 142 ms
- **最后更新 (UTC)**: 2026-04-22 05:30 UTC

**协议分布:** shadowsocks × 37 · trojan × 2 · vless × 98 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 40 · `epodonios` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 62 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 9
