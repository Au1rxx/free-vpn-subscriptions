...
![节点](https://img.shields.io/badge/节点-81-brightgreen) ![存活](https://img.shields.io/badge/存活-2055-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-159ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-04_05:16_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 159 ms
- **最后更新 (UTC)**: 2026-07-04 05:16 UTC

**协议分布:** shadowsocks × 25 · trojan × 23 · vless × 13 · vmess × 20

**本次使用的源:** `barry-far-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 6 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
