...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2237-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-442ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_19:35_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 442 ms
- **最后更新 (UTC)**: 2026-04-20 19:35 UTC

**协议分布:** shadowsocks × 29 · trojan × 18 · vless × 90 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 50 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 10
