...
![节点](https://img.shields.io/badge/节点-109-brightgreen) ![存活](https://img.shields.io/badge/存活-1858-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-376ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_22:31_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 376 ms
- **最后更新 (UTC)**: 2026-06-15 22:31 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 54 · trojan × 25 · vless × 15 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `ruking-clash` × 8 · `surfboard-eternity` × 5
