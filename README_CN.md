...
![节点](https://img.shields.io/badge/节点-141-brightgreen) ![存活](https://img.shields.io/badge/存活-2567-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-176ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_21:34_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 176 ms
- **最后更新 (UTC)**: 2026-04-24 21:34 UTC

**协议分布:** shadowsocks × 28 · trojan × 23 · vless × 78 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 33 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 54 · `snakem982` × 1 · `surfboard-eternity` × 4
