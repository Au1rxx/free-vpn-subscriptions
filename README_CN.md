...
![节点](https://img.shields.io/badge/节点-99-brightgreen) ![存活](https://img.shields.io/badge/存活-2330-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_02:22_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 167 ms
- **最后更新 (UTC)**: 2026-06-10 02:22 UTC

**协议分布:** shadowsocks × 35 · trojan × 14 · vless × 28 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 29 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 5
