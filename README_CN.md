...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2049-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-72ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_10:11_UTC-informational)
...
- **最快延迟**: 24 ms
- **中位延迟**: 72 ms
- **最后更新 (UTC)**: 2026-05-22 10:11 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 34 · trojan × 11 · vless × 92 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 67 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 8
