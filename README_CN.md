...
![节点](https://img.shields.io/badge/节点-140-brightgreen) ![存活](https://img.shields.io/badge/存活-2308-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-290ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_19:19_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 290 ms
- **最后更新 (UTC)**: 2026-04-21 19:19 UTC

**协议分布:** shadowsocks × 30 · trojan × 24 · vless × 71 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 37 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 1 · `ruking-clash` × 7 · `snakem982` × 2 · `surfboard-eternity` × 5
