...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1935-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-142ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-07_08:11_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 142 ms
- **最后更新 (UTC)**: 2026-05-07 08:11 UTC

**协议分布:** shadowsocks × 50 · trojan × 5 · vless × 86 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 70 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
