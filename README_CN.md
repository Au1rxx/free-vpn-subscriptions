...
![节点](https://img.shields.io/badge/节点-145-brightgreen) ![存活](https://img.shields.io/badge/存活-1942-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-418ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_23:32_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 418 ms
- **最后更新 (UTC)**: 2026-06-21 23:32 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 45 · trojan × 32 · vless × 52 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 5 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 34 · `snakem982` × 2 · `surfboard-eternity` × 3
