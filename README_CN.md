...
![节点](https://img.shields.io/badge/节点-87-brightgreen) ![存活](https://img.shields.io/badge/存活-1921-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-166ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-03_20:15_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 166 ms
- **最后更新 (UTC)**: 2026-06-03 20:15 UTC

**协议分布:** shadowsocks × 23 · trojan × 38 · vless × 17 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 21 · `epodonios` × 27 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 10 · `pawdroid` × 2 · `surfboard-eternity` × 2
