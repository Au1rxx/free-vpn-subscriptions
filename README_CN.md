...
![节点](https://img.shields.io/badge/节点-77-brightgreen) ![存活](https://img.shields.io/badge/存活-2510-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-114ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_09:19_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 114 ms
- **最后更新 (UTC)**: 2026-06-02 09:19 UTC

**协议分布:** shadowsocks × 22 · trojan × 24 · vless × 8 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
