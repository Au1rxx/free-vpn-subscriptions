...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2044-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-168ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-02_21:26_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 168 ms
- **最后更新 (UTC)**: 2026-05-02 21:26 UTC

**协议分布:** shadowsocks × 38 · trojan × 17 · vless × 87 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
