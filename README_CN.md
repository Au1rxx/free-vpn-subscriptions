...
![节点](https://img.shields.io/badge/节点-79-brightgreen) ![存活](https://img.shields.io/badge/存活-2238-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-417ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_09:11_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 417 ms
- **最后更新 (UTC)**: 2026-06-29 09:11 UTC

**协议分布:** shadowsocks × 18 · trojan × 27 · vless × 19 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 2
