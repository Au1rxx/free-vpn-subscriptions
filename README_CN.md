...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2571-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-125ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_12:26_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 125 ms
- **最后更新 (UTC)**: 2026-04-28 12:26 UTC

**协议分布:** shadowsocks × 26 · trojan × 17 · vless × 96 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 26 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 17 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 6 · `ninjastrikers` × 68 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6
