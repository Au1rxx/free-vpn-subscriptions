...
![节点](https://img.shields.io/badge/节点-146-brightgreen) ![存活](https://img.shields.io/badge/存活-2081-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-176ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-29_18:35_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 176 ms
- **最后更新 (UTC)**: 2026-04-29 18:35 UTC

**协议分布:** shadowsocks × 42 · trojan × 16 · vless × 78 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 58 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
