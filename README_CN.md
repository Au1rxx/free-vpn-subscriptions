...
![节点](https://img.shields.io/badge/节点-143-brightgreen) ![存活](https://img.shields.io/badge/存活-2098-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-379ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_07:34_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 379 ms
- **最后更新 (UTC)**: 2026-06-21 07:34 UTC

**协议分布:** shadowsocks × 42 · trojan × 31 · vless × 45 · vmess × 25

**本次使用的源:** `barry-far-v2ray` × 14 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 33 · `snakem982` × 2 · `surfboard-eternity` × 2
