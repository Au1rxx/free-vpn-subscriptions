...
![节点](https://img.shields.io/badge/节点-130-brightgreen) ![存活](https://img.shields.io/badge/存活-2479-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-474ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_02:26_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 474 ms
- **最后更新 (UTC)**: 2026-06-19 02:26 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 35 · trojan × 28 · vless × 56 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 15 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 26 · `pawdroid` × 4 · `ruking-clash` × 39 · `snakem982` × 6 · `surfboard-eternity` × 2
