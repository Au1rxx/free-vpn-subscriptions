...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2265-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-448ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_23:39_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 448 ms
- **最后更新 (UTC)**: 2026-04-20 23:39 UTC

**协议分布:** shadowsocks × 23 · trojan × 18 · vless × 96 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 55 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 49 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 6
