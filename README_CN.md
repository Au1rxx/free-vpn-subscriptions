...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2532-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-113ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-25_08:16_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 113 ms
- **最后更新 (UTC)**: 2026-04-25 08:16 UTC

**协议分布:** shadowsocks × 29 · trojan × 17 · vless × 96 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 22 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 68 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
