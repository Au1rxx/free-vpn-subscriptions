...
![节点](https://img.shields.io/badge/节点-57-brightgreen) ![存活](https://img.shields.io/badge/存活-1962-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-157ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-27_17:11_UTC-informational)
...
- **最快延迟**: 39 ms
- **中位延迟**: 157 ms
- **最后更新 (UTC)**: 2026-05-27 17:11 UTC

**协议分布:** shadowsocks × 22 · trojan × 10 · vless × 17 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 6 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 3
