...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2693-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-77ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_06:16_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 77 ms
- **最后更新 (UTC)**: 2026-05-18 06:16 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 40 · trojan × 5 · vless × 97 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 64 · `pawdroid` × 6 · `ruking-clash` × 7 · `surfboard-eternity` × 3
