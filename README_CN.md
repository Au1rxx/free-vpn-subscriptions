...
![节点](https://img.shields.io/badge/节点-123-brightgreen) ![存活](https://img.shields.io/badge/存活-2492-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-439ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_21:14_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 439 ms
- **最后更新 (UTC)**: 2026-04-23 21:14 UTC

**协议分布:** shadowsocks × 14 · trojan × 25 · vless × 70 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 22 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 47 · `pawdroid` × 2 · `surfboard-eternity` × 1
