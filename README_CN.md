...
![节点](https://img.shields.io/badge/节点-82-brightgreen) ![存活](https://img.shields.io/badge/存活-2147-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-173ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_17:16_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 173 ms
- **最后更新 (UTC)**: 2026-06-28 17:16 UTC

**协议分布:** shadowsocks × 18 · trojan × 27 · vless × 20 · vmess × 17

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 3
