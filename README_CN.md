...
![节点](https://img.shields.io/badge/节点-144-brightgreen) ![存活](https://img.shields.io/badge/存活-2513-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-128ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_14:13_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 128 ms
- **最后更新 (UTC)**: 2026-04-24 14:13 UTC

**协议分布:** shadowsocks × 26 · trojan × 21 · vless × 84 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 22 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 60 · `pawdroid` × 3 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
