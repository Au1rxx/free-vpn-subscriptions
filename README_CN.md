...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2091-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-104ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-29_06:36_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 104 ms
- **最后更新 (UTC)**: 2026-04-29 06:36 UTC

**协议分布:** shadowsocks × 33 · trojan × 11 · vless × 96 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 26 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 6 · `ninjastrikers` × 67 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 4
