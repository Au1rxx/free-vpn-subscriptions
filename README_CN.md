...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2189-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-83ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-26_06:30_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 83 ms
- **最后更新 (UTC)**: 2026-05-26 06:30 UTC

**协议分布:** shadowsocks × 36 · trojan × 15 · vless × 85 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 70 · `pawdroid` × 4 · `ruking-clash` × 15 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
