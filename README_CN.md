...
![节点](https://img.shields.io/badge/节点-149-brightgreen) ![存活](https://img.shields.io/badge/存活-2331-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-447ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_16:34_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 447 ms
- **最后更新 (UTC)**: 2026-04-21 16:34 UTC

**协议分布:** shadowsocks × 28 · trojan × 19 · vless × 87 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 50 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
