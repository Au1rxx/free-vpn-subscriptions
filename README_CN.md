...
![节点](https://img.shields.io/badge/节点-126-brightgreen) ![存活](https://img.shields.io/badge/存活-1624-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-403ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_16:33_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 403 ms
- **最后更新 (UTC)**: 2026-06-14 16:33 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 62 · trojan × 23 · vless × 24 · vmess × 16

**本次使用的源:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 4
