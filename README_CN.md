...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2091-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-126ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-29_11:11_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 126 ms
- **最后更新 (UTC)**: 2026-04-29 11:11 UTC

**协议分布:** shadowsocks × 39 · trojan × 11 · vless × 90 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `ruking-clash` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
