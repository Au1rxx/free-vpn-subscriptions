...
![节点](https://img.shields.io/badge/节点-147-brightgreen) ![存活](https://img.shields.io/badge/存活-2281-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-435ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_21:31_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 435 ms
- **最后更新 (UTC)**: 2026-04-21 21:31 UTC

**协议分布:** shadowsocks × 30 · trojan × 23 · vless × 80 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 46 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 5
