...
![节点](https://img.shields.io/badge/节点-86-brightgreen) ![存活](https://img.shields.io/badge/存活-2022-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-201ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_21:10_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 201 ms
- **最后更新 (UTC)**: 2026-06-26 21:10 UTC

**协议分布:** shadowsocks × 17 · trojan × 32 · vless × 17 · vmess × 20

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `ruking-clash` × 17
