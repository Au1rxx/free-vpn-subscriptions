...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2229-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-117ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_09:25_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 117 ms
- **最后更新 (UTC)**: 2026-04-30 09:25 UTC

**协议分布:** shadowsocks × 33 · trojan × 18 · vless × 90 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 31 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 66 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 9
