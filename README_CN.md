...
![节点](https://img.shields.io/badge/节点-142-brightgreen) ![存活](https://img.shields.io/badge/存活-2067-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-406ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_06:16_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 406 ms
- **最后更新 (UTC)**: 2026-06-23 06:16 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 35 · trojan × 29 · vless × 61 · vmess × 16

**本次使用的源:** `barry-far-v2ray` × 4 · `epodonios` × 51 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 4
