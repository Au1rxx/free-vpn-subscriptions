...
![节点](https://img.shields.io/badge/节点-137-brightgreen) ![存活](https://img.shields.io/badge/存活-2184-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-144ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_18:17_UTC-informational)
...
- **最快延迟**: 39 ms
- **中位延迟**: 144 ms
- **最后更新 (UTC)**: 2026-04-28 18:17 UTC

**协议分布:** shadowsocks × 27 · trojan × 24 · vless × 75 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 32 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
