...
![节点](https://img.shields.io/badge/节点-92-brightgreen) ![存活](https://img.shields.io/badge/存活-2017-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-281ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_15:21_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 281 ms
- **最后更新 (UTC)**: 2026-06-26 15:21 UTC

**协议分布:** shadowsocks × 21 · trojan × 33 · vless × 17 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 4 · `epodonios` × 20 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 5 · `ruking-clash` × 16 · `surfboard-eternity` × 2
