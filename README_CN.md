...
![节点](https://img.shields.io/badge/节点-138-brightgreen) ![存活](https://img.shields.io/badge/存活-1611-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-420ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_18:13_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 420 ms
- **最后更新 (UTC)**: 2026-06-14 18:13 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 72 · trojan × 31 · vless × 23 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 4
