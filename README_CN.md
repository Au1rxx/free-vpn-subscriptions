...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1926-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-304ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_17:18_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 304 ms
- **最后更新 (UTC)**: 2026-06-16 17:18 UTC

**协议分布:** shadowsocks × 48 · trojan × 12 · vless × 15 · vmess × 75

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 16 · `lagzian-mix` × 1 · `mahdi0024` × 78 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 1
