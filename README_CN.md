...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2212-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-106ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_04:38_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 106 ms
- **最后更新 (UTC)**: 2026-04-30 04:38 UTC

**协议分布:** shadowsocks × 33 · trojan × 5 · vless × 103 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 29 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 71 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 7
