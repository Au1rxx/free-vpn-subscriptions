...
![节点](https://img.shields.io/badge/节点-128-brightgreen) ![存活](https://img.shields.io/badge/存活-2541-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-346ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_21:23_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 346 ms
- **最后更新 (UTC)**: 2026-04-22 21:23 UTC

**协议分布:** shadowsocks × 30 · trojan × 21 · vless × 67 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
