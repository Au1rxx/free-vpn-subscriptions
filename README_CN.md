...
![节点](https://img.shields.io/badge/节点-69-brightgreen) ![存活](https://img.shields.io/badge/存活-2000-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-175ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-04_11:13_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 175 ms
- **最后更新 (UTC)**: 2026-07-04 11:13 UTC

**协议分布:** shadowsocks × 30 · trojan × 15 · vless × 6 · vmess × 18

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 5 · `ninjastrikers` × 6 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
