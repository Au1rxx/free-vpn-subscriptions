...
![节点](https://img.shields.io/badge/节点-131-brightgreen) ![存活](https://img.shields.io/badge/存活-2100-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-474ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_20:31_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 474 ms
- **最后更新 (UTC)**: 2026-06-20 20:31 UTC

**协议分布:** shadowsocks × 41 · trojan × 34 · vless × 32 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 38 · `surfboard-eternity` × 3
