...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2604-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-164ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_03:37_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 164 ms
- **最后更新 (UTC)**: 2026-04-23 03:37 UTC

**协议分布:** shadowsocks × 29 · trojan × 16 · vless × 96 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 26 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 77 · `snakem982` × 1 · `surfboard-eternity` × 6
