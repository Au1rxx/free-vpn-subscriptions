...
![节点](https://img.shields.io/badge/节点-81-brightgreen) ![存活](https://img.shields.io/badge/存活-2269-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-184ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_12:33_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 184 ms
- **最后更新 (UTC)**: 2026-06-20 12:33 UTC

**协议分布:** shadowsocks × 23 · trojan × 22 · vless × 8 · vmess × 28

**本次使用的源:** `barry-far-v2ray` × 8 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `ruking-clash` × 15 · `surfboard-eternity` × 2
