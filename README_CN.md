...
![节点](https://img.shields.io/badge/节点-79-brightgreen) ![存活](https://img.shields.io/badge/存活-2109-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-568ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_21:21_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 568 ms
- **最后更新 (UTC)**: 2026-06-28 21:21 UTC

**协议分布:** shadowsocks × 16 · trojan × 30 · vless × 18 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 10 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 3
