...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2542-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-165ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_08:37_UTC-informational)
...
- **最快延迟**: 22 ms
- **中位延迟**: 165 ms
- **最后更新 (UTC)**: 2026-04-23 08:37 UTC

**协议分布:** shadowsocks × 28 · trojan × 20 · vless × 93 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 29 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 73 · `pawdroid` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
