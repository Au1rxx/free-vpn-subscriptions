...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2223-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-115ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_03:40_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 115 ms
- **最后更新 (UTC)**: 2026-04-21 03:40 UTC

**协议分布:** shadowsocks × 28 · trojan × 3 · vless × 101 · vmess × 18

**本次使用的源:** `barry-far-v2ray` × 47 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 3 · `ninjastrikers` × 52 · `ruking-clash` × 10 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
