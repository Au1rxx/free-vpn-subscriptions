...
![节点](https://img.shields.io/badge/节点-131-brightgreen) ![存活](https://img.shields.io/badge/存活-2106-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-182ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-03_22:35_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 182 ms
- **最后更新 (UTC)**: 2026-05-03 22:35 UTC

**协议分布:** shadowsocks × 26 · trojan × 20 · vless × 72 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `ruking-clash` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
