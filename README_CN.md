...
![节点](https://img.shields.io/badge/节点-133-brightgreen) ![存活](https://img.shields.io/badge/存活-2331-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-67ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_11:26_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 67 ms
- **最后更新 (UTC)**: 2026-05-19 11:26 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 14 · trojan × 23 · vless × 80 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 56 · `pawdroid` × 9 · `surfboard-eternity` × 2
