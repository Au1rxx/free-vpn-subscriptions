...
![节点](https://img.shields.io/badge/节点-129-brightgreen) ![存活](https://img.shields.io/badge/存活-2081-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-91ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-26_16:24_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 91 ms
- **最后更新 (UTC)**: 2026-05-26 16:24 UTC

**协议分布:** shadowsocks × 31 · trojan × 21 · vless × 65 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 45 · `pawdroid` × 8 · `ruking-clash` × 14 · `surfboard-eternity` × 2 · `vxiaov-clash` × 2
