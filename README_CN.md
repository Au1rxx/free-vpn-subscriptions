...
![节点](https://img.shields.io/badge/节点-118-brightgreen) ![存活](https://img.shields.io/badge/存活-1956-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-300ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-13_00:25_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 300 ms
- **最后更新 (UTC)**: 2026-06-13 00:25 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 55 · trojan × 24 · vless × 30 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 35 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 6
