...
![节点](https://img.shields.io/badge/节点-80-brightgreen) ![存活](https://img.shields.io/badge/存活-1928-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-168ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-03_09:13_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 168 ms
- **最后更新 (UTC)**: 2026-07-03 09:13 UTC

**协议分布:** shadowsocks × 31 · trojan × 18 · vless × 12 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 9 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 5
