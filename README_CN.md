...
![节点](https://img.shields.io/badge/节点-143-brightgreen) ![存活](https://img.shields.io/badge/存活-2216-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-366ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-05_20:27_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 366 ms
- **最后更新 (UTC)**: 2026-05-05 20:27 UTC

**协议分布:** shadowsocks × 36 · trojan × 28 · vless × 68 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 38 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 3 · `surfboard-eternity` × 10
