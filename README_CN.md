...
![节点](https://img.shields.io/badge/节点-141-brightgreen) ![存活](https://img.shields.io/badge/存活-2572-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-111ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-14_16:30_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 111 ms
- **最后更新 (UTC)**: 2026-05-14 16:30 UTC

**协议分布:** shadowsocks × 36 · trojan × 21 · vless × 75 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 28 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 54 · `pawdroid` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
