...
![节点](https://img.shields.io/badge/节点-85-brightgreen) ![存活](https://img.shields.io/badge/存活-2033-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-198ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-28_07:27_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 198 ms
- **最后更新 (UTC)**: 2026-05-28 07:27 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 30 · trojan × 24 · vless × 19 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 5
