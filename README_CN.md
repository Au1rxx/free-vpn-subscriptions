...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-388-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-138ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-19_07:23_UTC-informational)
...
- **最快延迟**: 1 ms
- **中位延迟**: 138 ms
- **最后更新 (UTC)**: 2026-04-19 07:23 UTC

**协议分布:** shadowsocks × 101 · trojan × 7 · vmess × 42

**本次使用的源:** `freefq` × 2 · `mahdibland-aggregator` × 64 · `mahdibland-shadowsocks` × 67 · `pawdroid` × 3 · `vxiaov-clash` × 14
