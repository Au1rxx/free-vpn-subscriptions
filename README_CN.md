...
![节点](https://img.shields.io/badge/节点-98-brightgreen) ![存活](https://img.shields.io/badge/存活-1857-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-354ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_18:14_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 354 ms
- **最后更新 (UTC)**: 2026-06-07 18:14 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 54 · trojan × 22 · vless × 15 · vmess × 6

**本次使用的源:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 24 · `mfuu-clash` × 4 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 1
