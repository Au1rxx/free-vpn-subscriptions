...
![节点](https://img.shields.io/badge/节点-133-brightgreen) ![存活](https://img.shields.io/badge/存活-2567-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-250ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_19:34_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 250 ms
- **最后更新 (UTC)**: 2026-04-22 19:34 UTC

**协议分布:** shadowsocks × 29 · trojan × 22 · vless × 70 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 54 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
