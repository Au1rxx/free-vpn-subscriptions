...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1987-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-166ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-07_10:27_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 166 ms
- **最后更新 (UTC)**: 2026-05-07 10:27 UTC

**协议分布:** shadowsocks × 37 · trojan × 16 · vless × 88 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 28 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 73 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
