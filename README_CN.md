...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1954-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-352ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-06_21:35_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 352 ms
- **最后更新 (UTC)**: 2026-05-06 21:35 UTC

**协议分布:** shadowsocks × 48 · trojan × 19 · vless × 70 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 32 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 57 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 7
