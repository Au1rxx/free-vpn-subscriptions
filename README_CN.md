...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2405-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-84ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_19:21_UTC-informational)
...
- **最快延迟**: 39 ms
- **中位延迟**: 84 ms
- **最后更新 (UTC)**: 2026-05-19 19:21 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 44 · trojan × 18 · vless × 67 · vmess × 20

**本次使用的源:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 51 · `pawdroid` × 8 · `ruking-clash` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
