...
![节点](https://img.shields.io/badge/节点-139-brightgreen) ![存活](https://img.shields.io/badge/存活-2223-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-117ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_14:18_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 117 ms
- **最后更新 (UTC)**: 2026-04-28 14:18 UTC

**协议分布:** shadowsocks × 29 · trojan × 19 · vless × 79 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 27 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 17 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `mfuu-clash` × 5 · `ninjastrikers` × 55 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6
