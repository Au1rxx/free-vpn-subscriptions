...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2408-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-85ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_15:15_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 85 ms
- **最后更新 (UTC)**: 2026-05-18 15:15 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 42 · trojan × 8 · vless × 92 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 3 · `mahdi0024` × 38 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 7
