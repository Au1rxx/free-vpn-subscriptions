...
![节点](https://img.shields.io/badge/节点-86-brightgreen) ![存活](https://img.shields.io/badge/存活-2242-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-155ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_03:29_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 155 ms
- **最后更新 (UTC)**: 2026-06-29 03:29 UTC

**协议分布:** shadowsocks × 17 · trojan × 28 · vless × 27 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 19 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 8 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 1
