...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1961-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-143ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_03:12_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 143 ms
- **最后更新 (UTC)**: 2026-05-12 03:12 UTC

**协议分布:** shadowsocks × 52 · trojan × 4 · vless × 86 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 9 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 64 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 2
