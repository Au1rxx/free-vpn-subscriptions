...
![节点](https://img.shields.io/badge/节点-125-brightgreen) ![存活](https://img.shields.io/badge/存活-1997-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-354ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_06:16_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 354 ms
- **最后更新 (UTC)**: 2026-06-28 06:16 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 36 · trojan × 40 · vless × 37 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 29 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 3
