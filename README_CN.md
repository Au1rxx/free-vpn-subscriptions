...
![节点](https://img.shields.io/badge/节点-94-brightgreen) ![存活](https://img.shields.io/badge/存活-1880-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-408ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_16:21_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 408 ms
- **最后更新 (UTC)**: 2026-06-29 16:21 UTC

**协议分布:** shadowsocks × 29 · trojan × 33 · vless × 21 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
