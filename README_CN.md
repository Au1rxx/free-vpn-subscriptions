...
![节点](https://img.shields.io/badge/节点-72-brightgreen) ![存活](https://img.shields.io/badge/存活-1985-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-178ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-04_10:19_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 178 ms
- **最后更新 (UTC)**: 2026-07-04 10:19 UTC

**协议分布:** shadowsocks × 27 · trojan × 20 · vless × 6 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
