...
![节点](https://img.shields.io/badge/节点-84-brightgreen) ![存活](https://img.shields.io/badge/存活-2118-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-291ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_15:16_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 291 ms
- **最后更新 (UTC)**: 2026-06-28 15:16 UTC

**协议分布:** shadowsocks × 17 · trojan × 30 · vless × 19 · vmess × 18

**本次使用的源:** `barry-far-v2ray` × 6 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 2
