...
![节点](https://img.shields.io/badge/节点-133-brightgreen) ![存活](https://img.shields.io/badge/存活-2374-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-503ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_15:30_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 503 ms
- **最后更新 (UTC)**: 2026-06-18 15:30 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 37 · trojan × 36 · vless × 48 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 25 · `snakem982` × 9 · `surfboard-eternity` × 3
