...
![节点](https://img.shields.io/badge/节点-86-brightgreen) ![存活](https://img.shields.io/badge/存活-1885-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-359ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_20:19_UTC-informational)
...
- **最快延迟**: 22 ms
- **中位延迟**: 359 ms
- **最后更新 (UTC)**: 2026-06-07 20:19 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 46 · trojan × 19 · vless × 13 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
