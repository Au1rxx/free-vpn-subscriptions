...
![节点](https://img.shields.io/badge/节点-53-brightgreen) ![存活](https://img.shields.io/badge/存活-2055-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-225ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-29_13:19_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 225 ms
- **最后更新 (UTC)**: 2026-05-29 13:19 UTC

**协议分布:** shadowsocks × 20 · trojan × 15 · vless × 9 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 13 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 8 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
