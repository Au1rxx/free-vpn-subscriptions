...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2141-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-285ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-06_13:31_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 285 ms
- **最后更新 (UTC)**: 2026-05-06 13:31 UTC

**协议分布:** shadowsocks × 46 · trojan × 17 · vless × 75 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 57 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
