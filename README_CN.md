...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2385-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-132ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_20:26_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 132 ms
- **最后更新 (UTC)**: 2026-05-12 20:26 UTC

**协议分布:** shadowsocks × 38 · trojan × 20 · vless × 80 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
