...
![节点](https://img.shields.io/badge/节点-144-brightgreen) ![存活](https://img.shields.io/badge/存活-1926-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-481ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_13:37_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 481 ms
- **最后更新 (UTC)**: 2026-06-22 13:37 UTC

**协议分布:** shadowsocks × 40 · trojan × 29 · vless × 62 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 6 · `epodonios` × 41 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 8
