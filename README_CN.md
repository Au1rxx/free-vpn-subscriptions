...
![节点](https://img.shields.io/badge/节点-119-brightgreen) ![存活](https://img.shields.io/badge/存活-2394-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-488ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_23:23_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 488 ms
- **最后更新 (UTC)**: 2026-06-18 23:23 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 39 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 38 · `snakem982` × 6 · `surfboard-eternity` × 2
