...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2132-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-99ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-29_04:36_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 99 ms
- **最后更新 (UTC)**: 2026-04-29 04:36 UTC

**协议分布:** shadowsocks × 31 · trojan × 6 · vless × 103 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 26 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 70 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
