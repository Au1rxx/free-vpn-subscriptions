...
![节点](https://img.shields.io/badge/节点-115-brightgreen) ![存活](https://img.shields.io/badge/存活-1829-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-377ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_11:15_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 377 ms
- **最后更新 (UTC)**: 2026-06-16 11:15 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 55 · trojan × 24 · vless × 20 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 23 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 7 · `surfboard-eternity` × 3
