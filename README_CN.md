...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2610-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-132ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_05:28_UTC-informational)
...
- **最快延迟**: 22 ms
- **中位延迟**: 132 ms
- **最后更新 (UTC)**: 2026-04-23 05:28 UTC

**协议分布:** shadowsocks × 28 · trojan × 17 · vless × 96 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 28 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 74 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 8
