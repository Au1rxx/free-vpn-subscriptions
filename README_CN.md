...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2060-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-96ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_02:16_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 96 ms
- **最后更新 (UTC)**: 2026-05-22 02:16 UTC

**协议分布:** shadowsocks × 37 · trojan × 15 · vless × 85 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 12 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 60 · `pawdroid` × 11 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
