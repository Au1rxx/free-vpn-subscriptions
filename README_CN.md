...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1937-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-122ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-08_00:12_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 122 ms
- **最后更新 (UTC)**: 2026-05-08 00:12 UTC

**协议分布:** shadowsocks × 50 · trojan × 4 · vless × 86 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 26 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 70 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
