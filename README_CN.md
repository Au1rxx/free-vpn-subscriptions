...
![节点](https://img.shields.io/badge/节点-83-brightgreen) ![存活](https://img.shields.io/badge/存活-2189-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-191ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_10:22_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 191 ms
- **最后更新 (UTC)**: 2026-06-06 10:22 UTC

**协议分布:** shadowsocks × 23 · trojan × 24 · vless × 19 · vmess × 17

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 26 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 5 · `surfboard-eternity` × 3
