...
![节点](https://img.shields.io/badge/节点-129-brightgreen) ![存活](https://img.shields.io/badge/存活-1898-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-356ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_04:18_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 356 ms
- **最后更新 (UTC)**: 2026-06-16 04:18 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 51 · trojan × 30 · vless × 35 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 31 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 3
