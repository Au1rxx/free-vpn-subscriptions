...
![节点](https://img.shields.io/badge/节点-129-brightgreen) ![存活](https://img.shields.io/badge/存活-2268-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-84ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_20:37_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 84 ms
- **最后更新 (UTC)**: 2026-05-18 20:37 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 16 · trojan × 25 · vless × 68 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `ruking-clash` × 7 · `surfboard-eternity` × 4
