...
![节点](https://img.shields.io/badge/节点-99-brightgreen) ![存活](https://img.shields.io/badge/存活-2232-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-142ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_02:27_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 142 ms
- **最后更新 (UTC)**: 2026-06-07 02:27 UTC

**协议分布:** shadowsocks × 29 · trojan × 21 · vless × 25 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 30 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 5
