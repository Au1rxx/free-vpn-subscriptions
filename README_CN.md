...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2266-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-125ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_00:15_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 125 ms
- **最后更新 (UTC)**: 2026-04-21 00:15 UTC

**协议分布:** shadowsocks × 22 · trojan × 4 · vless × 111 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 52 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7
