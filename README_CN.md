...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2244-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-80ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_05:23_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 80 ms
- **最后更新 (UTC)**: 2026-05-19 05:23 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 23 · trojan × 17 · vless × 85 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 65 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 3
