...
![节点](https://img.shields.io/badge/节点-105-brightgreen) ![存活](https://img.shields.io/badge/存活-2005-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-441ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_12:39_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 441 ms
- **最后更新 (UTC)**: 2026-06-28 12:39 UTC

**协议分布:** shadowsocks × 33 · trojan × 34 · vless × 25 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 31 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 13 · `surfboard-eternity` × 5
