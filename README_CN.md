...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2446-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-136ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-11_06:35_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 136 ms
- **最后更新 (UTC)**: 2026-05-11 06:35 UTC

**协议分布:** shadowsocks × 42 · trojan × 5 · vless × 94 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
