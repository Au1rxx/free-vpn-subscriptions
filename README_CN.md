...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2456-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-170ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-27_21:19_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 170 ms
- **最后更新 (UTC)**: 2026-04-27 21:19 UTC

**协议分布:** shadowsocks × 25 · trojan × 21 · vless × 92 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 31 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 31 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
