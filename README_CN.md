...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2619-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-76ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-17_16:25_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 76 ms
- **最后更新 (UTC)**: 2026-05-17 16:25 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 43 · trojan × 6 · vless × 94 · vmess × 6

**本次使用的源:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 4 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 42 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 49 · `pawdroid` × 2 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 4
