...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2366-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-144ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_19:16_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 144 ms
- **最后更新 (UTC)**: 2026-05-12 19:16 UTC

**协议分布:** shadowsocks × 38 · trojan × 20 · vless × 78 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 53 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
