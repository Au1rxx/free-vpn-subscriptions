...
![节点](https://img.shields.io/badge/节点-86-brightgreen) ![存活](https://img.shields.io/badge/存活-2542-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-100ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_07:11_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 100 ms
- **最后更新 (UTC)**: 2026-06-02 07:11 UTC

**协议分布:** shadowsocks × 25 · trojan × 27 · vless × 13 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 16 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 17 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
