...
![节点](https://img.shields.io/badge/节点-112-brightgreen) ![存活](https://img.shields.io/badge/存活-2542-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-279ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_06:37_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 279 ms
- **最后更新 (UTC)**: 2026-06-02 06:37 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 40 · trojan × 37 · vless × 16 · vmess × 18

**本次使用的源:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 19 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
