...
![节点](https://img.shields.io/badge/节点-141-brightgreen) ![存活](https://img.shields.io/badge/存活-2075-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-379ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_10:19_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 379 ms
- **最后更新 (UTC)**: 2026-06-21 10:19 UTC

**协议分布:** shadowsocks × 42 · trojan × 32 · vless × 44 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 9 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 34 · `snakem982` × 1 · `surfboard-eternity` × 3
