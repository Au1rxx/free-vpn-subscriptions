...
![节点](https://img.shields.io/badge/节点-149-brightgreen) ![存活](https://img.shields.io/badge/存活-2251-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-168ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_17:16_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 168 ms
- **最后更新 (UTC)**: 2026-04-30 17:16 UTC

**协议分布:** shadowsocks × 31 · trojan × 23 · vless × 75 · vmess × 20

**本次使用的源:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 30 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 54 · `snakem982` × 3 · `surfboard-eternity` × 5
