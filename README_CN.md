...
![节点](https://img.shields.io/badge/节点-109-brightgreen) ![存活](https://img.shields.io/badge/存活-1981-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-293ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-05_08:39_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 293 ms
- **最后更新 (UTC)**: 2026-07-05 08:39 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 9 · vmess × 26

**本次使用的源:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 27 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 7
