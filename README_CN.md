...
![节点](https://img.shields.io/badge/节点-76-brightgreen) ![存活](https://img.shields.io/badge/存活-2380-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-329ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-11_17:27_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 329 ms
- **最后更新 (UTC)**: 2026-06-11 17:27 UTC

**协议分布:** shadowsocks × 43 · trojan × 18 · vless × 10 · vmess × 5

**本次使用的源:** `barry-far-v2ray` × 8 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 17 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 2
