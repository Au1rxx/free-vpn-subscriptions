...
![节点](https://img.shields.io/badge/节点-100-brightgreen) ![存活](https://img.shields.io/badge/存活-2170-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-143ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_00:24_UTC-informational)
...
- **最快延迟**: 26 ms
- **中位延迟**: 143 ms
- **最后更新 (UTC)**: 2026-06-06 00:24 UTC

**协议分布:** shadowsocks × 24 · trojan × 26 · vless × 32 · vmess × 18

**本次使用的源:** `barry-far-v2ray` × 3 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 30 · `surfboard-eternity` × 6
