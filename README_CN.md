...
![节点](https://img.shields.io/badge/节点-105-brightgreen) ![存活](https://img.shields.io/badge/存活-1980-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-420ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_12:12_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 420 ms
- **最后更新 (UTC)**: 2026-06-18 12:12 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 35 · trojan × 31 · vless × 31 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 9 · `pawdroid` × 6 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 6
