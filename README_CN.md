...
![节点](https://img.shields.io/badge/节点-70-brightgreen) ![存活](https://img.shields.io/badge/存活-2055-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-203ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-28_09:15_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 203 ms
- **最后更新 (UTC)**: 2026-05-28 09:15 UTC

**协议分布:** shadowsocks × 28 · trojan × 14 · vless × 16 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 6 · `ruking-clash` × 2 · `snakem982` × 4 · `surfboard-eternity` × 4
