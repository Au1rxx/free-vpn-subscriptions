...
![节点](https://img.shields.io/badge/节点-97-brightgreen) ![存活](https://img.shields.io/badge/存活-1930-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-341ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_18:34_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 341 ms
- **最后更新 (UTC)**: 2026-06-16 18:34 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 47 · trojan × 21 · vless × 17 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 11 · `surfboard-eternity` × 4
