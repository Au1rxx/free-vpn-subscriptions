...
![节点](https://img.shields.io/badge/节点-140-brightgreen) ![存活](https://img.shields.io/badge/存活-2506-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-147ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-09_22:30_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 147 ms
- **最后更新 (UTC)**: 2026-05-09 22:30 UTC

**协议分布:** shadowsocks × 46 · trojan × 17 · vless × 68 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 56 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 8
