...
![节点](https://img.shields.io/badge/节点-83-brightgreen) ![存活](https://img.shields.io/badge/存活-2366-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-97ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_20:22_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 97 ms
- **最后更新 (UTC)**: 2026-06-02 20:22 UTC

**协议分布:** shadowsocks × 20 · trojan × 26 · vless × 6 · vmess × 31

**本次使用的源:** `barry-far-v2ray` × 15 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 8 · `snakem982` × 1 · `surfboard-eternity` × 6
