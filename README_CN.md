...
![节点](https://img.shields.io/badge/节点-79-brightgreen) ![存活](https://img.shields.io/badge/存活-2334-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-179ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_07:12_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 179 ms
- **最后更新 (UTC)**: 2026-06-10 07:12 UTC

**协议分布:** shadowsocks × 30 · trojan × 13 · vless × 14 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 2
