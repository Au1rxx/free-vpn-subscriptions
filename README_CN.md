...
![节点](https://img.shields.io/badge/节点-76-brightgreen) ![存活](https://img.shields.io/badge/存活-2177-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-163ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-05_21:19_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 163 ms
- **最后更新 (UTC)**: 2026-06-05 21:19 UTC

**协议分布:** shadowsocks × 23 · trojan × 26 · vless × 9 · vmess × 18

**本次使用的源:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `snakem982` × 1 · `surfboard-eternity` × 1
