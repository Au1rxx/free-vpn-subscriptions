...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2108-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-106ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-29_08:18_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 106 ms
- **最后更新 (UTC)**: 2026-04-29 08:18 UTC

**协议分布:** shadowsocks × 38 · trojan × 4 · vless × 97 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 29 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `ruking-clash` × 6 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
