...
![节点](https://img.shields.io/badge/节点-91-brightgreen) ![存活](https://img.shields.io/badge/存活-2408-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-81ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-03_03:34_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 81 ms
- **最后更新 (UTC)**: 2026-06-03 03:34 UTC

**协议分布:** shadowsocks × 14 · trojan × 34 · vless × 21 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 19 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 24 · `pawdroid` × 2 · `surfboard-eternity` × 3
