...
![节点](https://img.shields.io/badge/节点-146-brightgreen) ![存活](https://img.shields.io/badge/存活-2403-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-83ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_20:32_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 83 ms
- **最后更新 (UTC)**: 2026-05-19 20:32 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 36 · trojan × 24 · vless × 66 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
