...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2273-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-159ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_08:34_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 159 ms
- **最后更新 (UTC)**: 2026-04-22 08:34 UTC

**协议分布:** shadowsocks × 31 · trojan × 4 · vless × 103 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 42 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 6
