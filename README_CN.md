...
![节点](https://img.shields.io/badge/节点-77-brightgreen) ![存活](https://img.shields.io/badge/存活-1761-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-325ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-08_14:10_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 325 ms
- **最后更新 (UTC)**: 2026-06-08 14:10 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 42 · trojan × 17 · vless × 13 · vmess × 4

**本次使用的源:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 1 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 24 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 6
