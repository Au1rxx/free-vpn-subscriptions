...
![节点](https://img.shields.io/badge/节点-112-brightgreen) ![存活](https://img.shields.io/badge/存活-1973-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-339ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-05_14:12_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 339 ms
- **最后更新 (UTC)**: 2026-07-05 14:12 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 42 · trojan × 25 · vless × 13 · vmess × 31

**本次使用的源:** `barry-far-v2ray` × 8 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
