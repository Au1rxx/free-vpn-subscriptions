...
![节点](https://img.shields.io/badge/节点-74-brightgreen) ![存活](https://img.shields.io/badge/存活-2173-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-171ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_12:28_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 171 ms
- **最后更新 (UTC)**: 2026-06-06 12:28 UTC

**协议分布:** shadowsocks × 27 · trojan × 25 · vless × 5 · vmess × 17

**本次使用的源:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
