...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2249-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-169ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_14:23_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 169 ms
- **最后更新 (UTC)**: 2026-04-20 14:23 UTC

**协议分布:** shadowsocks × 28 · trojan × 14 · vless × 97 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 47 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `ruking-clash` × 6 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
