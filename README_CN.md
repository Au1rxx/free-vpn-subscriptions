...
![节点](https://img.shields.io/badge/节点-141-brightgreen) ![存活](https://img.shields.io/badge/存活-2555-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-186ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_11:35_UTC-informational)
...
- **最快延迟**: 26 ms
- **中位延迟**: 186 ms
- **最后更新 (UTC)**: 2026-04-23 11:35 UTC

**协议分布:** shadowsocks × 29 · trojan × 22 · vless × 80 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 22 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 70 · `pawdroid` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
