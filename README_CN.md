...
![节点](https://img.shields.io/badge/节点-79-brightgreen) ![存活](https://img.shields.io/badge/存活-2206-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_22:29_UTC-informational)
...
- **最快延迟**: 19 ms
- **中位延迟**: 167 ms
- **最后更新 (UTC)**: 2026-06-06 22:29 UTC

**协议分布:** shadowsocks × 29 · trojan × 20 · vless × 6 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 10 · `ruking-clash` × 1 · `surfboard-eternity` × 3
