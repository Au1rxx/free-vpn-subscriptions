...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2360-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-73ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-23_06:38_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 73 ms
- **最后更新 (UTC)**: 2026-05-23 06:38 UTC

**协议分布:** shadowsocks × 33 · trojan × 7 · vless × 100 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 19 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 70 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
