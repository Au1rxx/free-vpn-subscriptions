...
![节点](https://img.shields.io/badge/节点-105-brightgreen) ![存活](https://img.shields.io/badge/存活-1915-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-439ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_15:26_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 439 ms
- **最后更新 (UTC)**: 2026-06-12 15:26 UTC

**协议分布:** hysteria2 × 2 · shadowsocks × 45 · trojan × 39 · vless × 12 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 17 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 3
