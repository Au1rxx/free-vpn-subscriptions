...
![节点](https://img.shields.io/badge/节点-138-brightgreen) ![存活](https://img.shields.io/badge/存活-2322-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-309ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_20:32_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 309 ms
- **最后更新 (UTC)**: 2026-04-21 20:32 UTC

**协议分布:** shadowsocks × 31 · trojan × 24 · vless × 68 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 37 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
