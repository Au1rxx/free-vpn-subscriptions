...
![节点](https://img.shields.io/badge/节点-142-brightgreen) ![存活](https://img.shields.io/badge/存活-2250-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-425ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-04_21:24_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 425 ms
- **最后更新 (UTC)**: 2026-05-04 21:24 UTC

**协议分布:** shadowsocks × 35 · trojan × 26 · vless × 69 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 56 · `ruking-clash` × 3 · `surfboard-eternity` × 6
