...
![节点](https://img.shields.io/badge/节点-127-brightgreen) ![存活](https://img.shields.io/badge/存活-2552-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-488ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_12:14_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 488 ms
- **最后更新 (UTC)**: 2026-06-19 12:14 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 34 · trojan × 26 · vless × 46 · vmess × 20

**本次使用的源:** `barry-far-v2ray` × 17 · `epodonios` × 22 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 4 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 6 · `surfboard-eternity` × 2
