...
![节点](https://img.shields.io/badge/节点-139-brightgreen) ![存活](https://img.shields.io/badge/存活-2090-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-281ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-03_16:30_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 281 ms
- **最后更新 (UTC)**: 2026-05-03 16:30 UTC

**协议分布:** shadowsocks × 28 · trojan × 23 · vless × 78 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 30 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
