...
![节点](https://img.shields.io/badge/节点-96-brightgreen) ![存活](https://img.shields.io/badge/存活-1941-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-358ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_20:11_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 358 ms
- **最后更新 (UTC)**: 2026-06-27 20:11 UTC

**协议分布:** shadowsocks × 28 · trojan × 39 · vless × 20 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 13 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 5
