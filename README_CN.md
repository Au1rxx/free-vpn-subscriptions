...
![节点](https://img.shields.io/badge/节点-134-brightgreen) ![存活](https://img.shields.io/badge/存活-2565-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-302ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_16:35_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 302 ms
- **最后更新 (UTC)**: 2026-04-22 16:35 UTC

**协议分布:** shadowsocks × 30 · trojan × 19 · vless × 71 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 8
