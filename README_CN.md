...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2186-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-162ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_11:16_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 162 ms
- **最后更新 (UTC)**: 2026-04-21 11:16 UTC

**协议分布:** shadowsocks × 27 · trojan × 3 · vless × 106 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 54 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 52 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 6
