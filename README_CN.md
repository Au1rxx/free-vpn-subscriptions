...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2585-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-77ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-16_07:21_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 77 ms
- **最后更新 (UTC)**: 2026-05-16 07:21 UTC

**协议分布:** shadowsocks × 34 · trojan × 10 · vless × 98 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 19 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 61 · `pawdroid` × 7 · `ruking-clash` × 3 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
