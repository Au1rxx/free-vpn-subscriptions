...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2210-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-154ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_11:30_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 154 ms
- **最后更新 (UTC)**: 2026-04-30 11:30 UTC

**协议分布:** shadowsocks × 34 · trojan × 20 · vless × 86 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 36 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 64 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
