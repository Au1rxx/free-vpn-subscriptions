...
![节点](https://img.shields.io/badge/节点-149-brightgreen) ![存活](https://img.shields.io/badge/存活-2356-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-88ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-20_19:15_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 88 ms
- **最后更新 (UTC)**: 2026-05-20 19:15 UTC

**协议分布:** shadowsocks × 37 · trojan × 27 · vless × 65 · vmess × 20

**本次使用的源:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 7
