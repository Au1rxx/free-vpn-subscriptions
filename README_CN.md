...
![节点](https://img.shields.io/badge/节点-138-brightgreen) ![存活](https://img.shields.io/badge/存活-2220-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-156ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_17:32_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 156 ms
- **最后更新 (UTC)**: 2026-04-28 17:32 UTC

**协议分布:** shadowsocks × 28 · trojan × 23 · vless × 76 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
