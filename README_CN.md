...
![节点](https://img.shields.io/badge/节点-83-brightgreen) ![存活](https://img.shields.io/badge/存活-2195-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-160ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-30_06:12_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 160 ms
- **最后更新 (UTC)**: 2026-05-30 06:12 UTC

**协议分布:** shadowsocks × 23 · trojan × 24 · vless × 10 · vmess × 26

**本次使用的源:** `barry-far-v2ray` × 14 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
