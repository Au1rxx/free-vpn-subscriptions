...
![节点](https://img.shields.io/badge/节点-60-brightgreen) ![存活](https://img.shields.io/badge/存活-2066-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-166ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-28_21:30_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 166 ms
- **最后更新 (UTC)**: 2026-05-28 21:30 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 24 · trojan × 19 · vless × 7 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 8 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
