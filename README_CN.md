...
![节点](https://img.shields.io/badge/节点-149-brightgreen) ![存活](https://img.shields.io/badge/存活-1908-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-470ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_07:37_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 470 ms
- **最后更新 (UTC)**: 2026-06-22 07:37 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 46 · trojan × 30 · vless × 59 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 6 · `ruking-clash` × 31 · `snakem982` × 3 · `surfboard-eternity` × 2
