...
![节点](https://img.shields.io/badge/节点-76-brightgreen) ![存活](https://img.shields.io/badge/存活-2490-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-137ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_14:32_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 137 ms
- **最后更新 (UTC)**: 2026-06-02 14:32 UTC

**协议分布:** shadowsocks × 21 · trojan × 26 · vless × 8 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 11 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 9 · `pawdroid` × 4 · `surfboard-eternity` × 4
