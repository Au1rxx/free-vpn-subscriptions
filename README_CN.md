...
![节点](https://img.shields.io/badge/节点-148-brightgreen) ![存活](https://img.shields.io/badge/存活-2274-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-245ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-05_13:29_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 245 ms
- **最后更新 (UTC)**: 2026-05-05 13:29 UTC

**协议分布:** shadowsocks × 38 · trojan × 29 · vless × 70 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
