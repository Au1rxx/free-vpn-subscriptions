...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2473-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-129ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-27_17:30_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 129 ms
- **最后更新 (UTC)**: 2026-04-27 17:30 UTC

**协议分布:** shadowsocks × 29 · trojan × 17 · vless × 93 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 32 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
