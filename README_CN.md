...
![节点](https://img.shields.io/badge/节点-100-brightgreen) ![存活](https://img.shields.io/badge/存活-2042-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-186ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_02:27_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 186 ms
- **最后更新 (UTC)**: 2026-06-27 02:27 UTC

**协议分布:** shadowsocks × 18 · trojan × 35 · vless × 26 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 9 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 3
