...
![节点](https://img.shields.io/badge/节点-69-brightgreen) ![存活](https://img.shields.io/badge/存活-2338-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-141ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-02_20:17_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 141 ms
- **最后更新 (UTC)**: 2026-07-02 20:17 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 25 · trojan × 16 · vless × 11 · vmess × 16

**本次使用的源:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 5 · `ninjastrikers` × 10 · `pawdroid` × 4 · `surfboard-eternity` × 4
