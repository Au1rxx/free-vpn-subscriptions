...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2379-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-88ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-23_20:17_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 88 ms
- **最后更新 (UTC)**: 2026-05-23 20:17 UTC

**协议分布:** shadowsocks × 41 · trojan × 18 · vless × 67 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 24 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 40 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
