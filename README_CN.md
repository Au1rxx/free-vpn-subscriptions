...
![节点](https://img.shields.io/badge/节点-148-brightgreen) ![存活](https://img.shields.io/badge/存活-1959-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-322ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-06_22:39_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 322 ms
- **最后更新 (UTC)**: 2026-05-06 22:39 UTC

**协议分布:** shadowsocks × 43 · trojan × 19 · vless × 72 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 6
