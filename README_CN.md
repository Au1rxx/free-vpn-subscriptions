...
![节点](https://img.shields.io/badge/节点-61-brightgreen) ![存活](https://img.shields.io/badge/存活-1927-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-105ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-27_11:26_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 105 ms
- **最后更新 (UTC)**: 2026-05-27 11:26 UTC

**协议分布:** shadowsocks × 27 · trojan × 8 · vless × 15 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 3
