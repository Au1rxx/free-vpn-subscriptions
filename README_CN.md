...
![节点](https://img.shields.io/badge/节点-145-brightgreen) ![存活](https://img.shields.io/badge/存活-2439-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-81ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-25_12:26_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 81 ms
- **最后更新 (UTC)**: 2026-05-25 12:26 UTC

**协议分布:** shadowsocks × 40 · trojan × 18 · vless × 65 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 35 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 8 · `surfboard-eternity` × 7
