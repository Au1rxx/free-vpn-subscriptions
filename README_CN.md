...
![节点](https://img.shields.io/badge/节点-125-brightgreen) ![存活](https://img.shields.io/badge/存活-2536-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-187ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_05:38_UTC-informational)
...
- **最快延迟**: 15 ms
- **中位延迟**: 187 ms
- **最后更新 (UTC)**: 2026-06-02 05:38 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 41 · trojan × 36 · vless × 21 · vmess × 26

**本次使用的源:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 25 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 7
