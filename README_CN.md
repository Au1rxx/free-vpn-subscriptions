...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2249-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-89ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-03_09:39_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 89 ms
- **最后更新 (UTC)**: 2026-05-03 09:39 UTC

**协议分布:** shadowsocks × 27 · trojan × 13 · vless × 100 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 30 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
