...
![节点](https://img.shields.io/badge/节点-96-brightgreen) ![存活](https://img.shields.io/badge/存活-1858-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-155ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-04_23:10_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 155 ms
- **最后更新 (UTC)**: 2026-06-04 23:10 UTC

**协议分布:** shadowsocks × 29 · trojan × 35 · vless × 20 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 17 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 6
