...
![节点](https://img.shields.io/badge/节点-75-brightgreen) ![存活](https://img.shields.io/badge/存活-2145-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-165ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-30_10:13_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 165 ms
- **最后更新 (UTC)**: 2026-05-30 10:13 UTC

**协议分布:** shadowsocks × 25 · trojan × 15 · vless × 8 · vmess × 27

**本次使用的源:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 5 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 4
