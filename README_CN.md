...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2480-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-86ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-16_19:29_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 86 ms
- **最后更新 (UTC)**: 2026-05-16 19:29 UTC

**协议分布:** shadowsocks × 42 · trojan × 16 · vless × 83 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 44 · `pawdroid` × 6 · `ruking-clash` × 7 · `surfboard-eternity` × 6
