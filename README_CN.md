...
![节点](https://img.shields.io/badge/节点-144-brightgreen) ![存活](https://img.shields.io/badge/存活-2082-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-193ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-03_17:22_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 193 ms
- **最后更新 (UTC)**: 2026-05-03 17:22 UTC

**协议分布:** shadowsocks × 27 · trojan × 23 · vless × 82 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 3 · `ninjastrikers` × 54 · `ruking-clash` × 1 · `surfboard-eternity` × 6
