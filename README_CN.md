...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1919-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-130ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_10:21_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 130 ms
- **最后更新 (UTC)**: 2026-05-12 10:21 UTC

**协议分布:** shadowsocks × 53 · trojan × 4 · vless × 83 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
