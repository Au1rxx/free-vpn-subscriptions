...
![节点](https://img.shields.io/badge/节点-106-brightgreen) ![存活](https://img.shields.io/badge/存活-1867-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-358ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_23:16_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 358 ms
- **最后更新 (UTC)**: 2026-06-15 23:16 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 50 · trojan × 26 · vless × 16 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 3
