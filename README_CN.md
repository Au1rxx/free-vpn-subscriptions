...
![节点](https://img.shields.io/badge/节点-113-brightgreen) ![存活](https://img.shields.io/badge/存活-1853-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-344ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_06:20_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 344 ms
- **最后更新 (UTC)**: 2026-06-16 06:20 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 47 · trojan × 25 · vless × 29 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 27 · `pawdroid` × 3 · `ruking-clash` × 9 · `surfboard-eternity` × 3
