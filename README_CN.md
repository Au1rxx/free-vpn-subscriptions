...
![节点](https://img.shields.io/badge/节点-63-brightgreen) ![存活](https://img.shields.io/badge/存活-1954-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-275ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_22:19_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 275 ms
- **最后更新 (UTC)**: 2026-06-30 22:19 UTC

**协议分布:** shadowsocks × 22 · trojan × 29 · vless × 6 · vmess × 6

**本次使用的源:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `mfuu-clash` × 8 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 5
