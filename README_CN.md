...
![节点](https://img.shields.io/badge/节点-94-brightgreen) ![存活](https://img.shields.io/badge/存活-2288-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-89ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-31_04:33_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 89 ms
- **最后更新 (UTC)**: 2026-05-31 04:33 UTC

**协议分布:** shadowsocks × 15 · trojan × 27 · vless × 27 · vmess × 25

**本次使用的源:** `barry-far-v2ray` × 16 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 28 · `pawdroid` × 1 · `surfboard-eternity` × 2
