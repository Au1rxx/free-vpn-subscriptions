...
![节点](https://img.shields.io/badge/节点-75-brightgreen) ![存活](https://img.shields.io/badge/存活-1938-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-229ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-28_11:25_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 229 ms
- **最后更新 (UTC)**: 2026-05-28 11:25 UTC

**协议分布:** shadowsocks × 32 · trojan × 17 · vless × 13 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 10 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 3
