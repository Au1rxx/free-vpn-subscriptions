...
![节点](https://img.shields.io/badge/节点-114-brightgreen) ![存活](https://img.shields.io/badge/存活-1825-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-398ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_12:10_UTC-informational)
...
- **最快延迟**: 26 ms
- **中位延迟**: 398 ms
- **最后更新 (UTC)**: 2026-06-16 12:10 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 52 · trojan × 28 · vless × 19 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 5
