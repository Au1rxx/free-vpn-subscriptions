...
![节点](https://img.shields.io/badge/节点-129-brightgreen) ![存活](https://img.shields.io/badge/存活-2131-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-94ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-25_17:38_UTC-informational)
...
- **最快延迟**: 41 ms
- **中位延迟**: 94 ms
- **最后更新 (UTC)**: 2026-05-25 17:38 UTC

**协议分布:** shadowsocks × 32 · trojan × 27 · vless × 55 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 55 · `pawdroid` × 2 · `ruking-clash` × 10 · `surfboard-eternity` × 5
