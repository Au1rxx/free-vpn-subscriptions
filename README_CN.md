...
![节点](https://img.shields.io/badge/节点-140-brightgreen) ![存活](https://img.shields.io/badge/存活-2464-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-148ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_12:27_UTC-informational)
...
- **最快延迟**: 23 ms
- **中位延迟**: 148 ms
- **最后更新 (UTC)**: 2026-04-24 12:27 UTC

**协议分布:** shadowsocks × 14 · trojan × 23 · vless × 90 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
