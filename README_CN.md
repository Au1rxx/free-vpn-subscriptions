...
![节点](https://img.shields.io/badge/节点-137-brightgreen) ![存活](https://img.shields.io/badge/存活-2446-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-338ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_23:16_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 338 ms
- **最后更新 (UTC)**: 2026-04-23 23:16 UTC

**协议分布:** shadowsocks × 19 · trojan × 22 · vless × 79 · vmess × 17

**本次使用的源:** `barry-far-v2ray` × 26 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 2 · `surfboard-eternity` × 4
