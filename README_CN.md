...
![节点](https://img.shields.io/badge/节点-68-brightgreen) ![存活](https://img.shields.io/badge/存活-1921-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-131ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-03_04:32_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 131 ms
- **最后更新 (UTC)**: 2026-07-03 04:32 UTC

**协议分布:** shadowsocks × 25 · trojan × 17 · vless × 11 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 3 · `surfboard-eternity` × 2
