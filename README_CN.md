...
![节点](https://img.shields.io/badge/节点-135-brightgreen) ![存活](https://img.shields.io/badge/存活-2550-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-287ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_20:29_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 287 ms
- **最后更新 (UTC)**: 2026-04-22 20:29 UTC

**协议分布:** shadowsocks × 29 · trojan × 22 · vless × 70 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 25 · `epodonios` × 11 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 50 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
