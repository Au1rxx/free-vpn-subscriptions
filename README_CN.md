...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2315-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-452ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_18:12_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 452 ms
- **最后更新 (UTC)**: 2026-04-21 18:12 UTC

**协议分布:** shadowsocks × 29 · trojan × 18 · vless × 89 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 52 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 47 · `ruking-clash` × 7 · `surfboard-eternity` × 6
