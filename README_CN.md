...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2475-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-80ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-17_02:39_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 80 ms
- **最后更新 (UTC)**: 2026-05-17 02:39 UTC

**协议分布:** shadowsocks × 39 · trojan × 5 · vless × 97 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 37 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 55 · `pawdroid` × 6 · `ruking-clash` × 6 · `surfboard-eternity` × 5
