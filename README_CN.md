...
![节点](https://img.shields.io/badge/节点-135-brightgreen) ![存活](https://img.shields.io/badge/存活-2004-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-404ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_17:24_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 404 ms
- **最后更新 (UTC)**: 2026-06-23 17:24 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 41 · trojan × 31 · vless × 45 · vmess × 17

**本次使用的源:** `barry-far-v2ray` × 9 · `epodonios` × 45 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 7 · `ruking-clash` × 17 · `surfboard-eternity` × 3
