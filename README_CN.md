...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1968-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-339ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-06_19:34_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 339 ms
- **最后更新 (UTC)**: 2026-05-06 19:34 UTC

**协议分布:** shadowsocks × 46 · trojan × 24 · vless × 69 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 2
