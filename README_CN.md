...
![节点](https://img.shields.io/badge/节点-99-brightgreen) ![存活](https://img.shields.io/badge/存活-1964-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-495ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_09:17_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 495 ms
- **最后更新 (UTC)**: 2026-06-18 09:17 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 35 · trojan × 26 · vless × 31 · vmess × 6

**本次使用的源:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 7 · `ruking-clash` × 18 · `snakem982` × 7 · `surfboard-eternity` × 2
