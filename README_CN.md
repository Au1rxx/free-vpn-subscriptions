...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2253-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-246ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_17:20_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 246 ms
- **最后更新 (UTC)**: 2026-04-20 17:20 UTC

**协议分布:** shadowsocks × 29 · trojan × 13 · vless × 96 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 51 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 7
