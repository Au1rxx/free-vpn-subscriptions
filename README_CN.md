...
![节点](https://img.shields.io/badge/节点-126-brightgreen) ![存活](https://img.shields.io/badge/存活-1889-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-305ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-12_02:20_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 305 ms
- **最后更新 (UTC)**: 2026-07-12 02:20 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 60 · trojan × 26 · vless × 22 · vmess × 17

**本次使用的源:** `barry-far-v2ray` × 4 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 6 · `ninjastrikers` × 24 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
