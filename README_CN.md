...
![节点](https://img.shields.io/badge/节点-122-brightgreen) ![存活](https://img.shields.io/badge/存活-2472-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-474ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_05:15_UTC-informational)
...
- **最快延迟**: 40 ms
- **中位延迟**: 474 ms
- **最后更新 (UTC)**: 2026-06-19 05:15 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 35 · trojan × 27 · vless × 49 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 35 · `snakem982` × 7 · `surfboard-eternity` × 4
