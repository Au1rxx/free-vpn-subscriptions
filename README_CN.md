...
![节点](https://img.shields.io/badge/节点-104-brightgreen) ![存活](https://img.shields.io/badge/存活-1932-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-420ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_16:29_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 420 ms
- **最后更新 (UTC)**: 2026-06-12 16:29 UTC

**协议分布:** hysteria2 × 2 · shadowsocks × 45 · trojan × 37 · vless × 12 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 6
