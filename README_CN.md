...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2246-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-435ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_21:12_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 435 ms
- **最后更新 (UTC)**: 2026-04-20 21:12 UTC

**协议分布:** shadowsocks × 28 · trojan × 5 · vless × 103 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 60 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 44 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 4
