...
![节点](https://img.shields.io/badge/节点-106-brightgreen) ![存活](https://img.shields.io/badge/存活-1901-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-342ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-06_23:19_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 342 ms
- **最后更新 (UTC)**: 2026-07-06 23:19 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 44 · trojan × 30 · vless × 10 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 6 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
