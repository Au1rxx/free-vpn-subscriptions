...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2206-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-172ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_21:37_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 172 ms
- **最后更新 (UTC)**: 2026-04-30 21:37 UTC

**协议分布:** shadowsocks × 31 · trojan × 20 · vless × 78 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 45 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 44 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
