...
![节点](https://img.shields.io/badge/节点-132-brightgreen) ![存活](https://img.shields.io/badge/存活-2254-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-77ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_23:18_UTC-informational)
...
- **最快延迟**: 22 ms
- **中位延迟**: 77 ms
- **最后更新 (UTC)**: 2026-05-18 23:18 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 19 · trojan × 27 · vless × 63 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 25 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 50 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 3
