...
![节点](https://img.shields.io/badge/节点-84-brightgreen) ![存活](https://img.shields.io/badge/存活-2253-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-168ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_07:21_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 168 ms
- **最后更新 (UTC)**: 2026-06-07 07:21 UTC

**协议分布:** shadowsocks × 28 · trojan × 20 · vless × 12 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 1
