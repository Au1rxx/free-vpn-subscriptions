...
![节点](https://img.shields.io/badge/节点-143-brightgreen) ![存活](https://img.shields.io/badge/存活-2607-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-164ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_17:40_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 164 ms
- **最后更新 (UTC)**: 2026-04-24 17:40 UTC

**协议分布:** shadowsocks × 27 · trojan × 21 · vless × 85 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 22 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 34 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 60 · `pawdroid` × 2 · `surfboard-eternity` × 1
