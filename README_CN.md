...
![节点](https://img.shields.io/badge/节点-127-brightgreen) ![存活](https://img.shields.io/badge/存活-2118-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-400ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_23:31_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 400 ms
- **最后更新 (UTC)**: 2026-06-20 23:31 UTC

**协议分布:** shadowsocks × 39 · trojan × 35 · vless × 29 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 10 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 6 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 31 · `surfboard-eternity` × 2
