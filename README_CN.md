...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2398-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-107ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-13_04:28_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 107 ms
- **最后更新 (UTC)**: 2026-05-13 04:28 UTC

**协议分布:** shadowsocks × 38 · trojan × 2 · vless × 96 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 40 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
