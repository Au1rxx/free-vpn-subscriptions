...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2176-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-146ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_10:38_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 146 ms
- **最后更新 (UTC)**: 2026-04-21 10:38 UTC

**协议分布:** shadowsocks × 29 · trojan × 4 · vless × 102 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 50 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 6
