...
![节点](https://img.shields.io/badge/节点-133-brightgreen) ![存活](https://img.shields.io/badge/存活-1998-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-413ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_18:40_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 413 ms
- **最后更新 (UTC)**: 2026-06-23 18:40 UTC

**协议分布:** hysteria2 × 2 · shadowsocks × 38 · trojan × 29 · vless × 45 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 3 · `epodonios` × 47 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 5
