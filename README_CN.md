...
![节点](https://img.shields.io/badge/节点-144-brightgreen) ![存活](https://img.shields.io/badge/存活-2256-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-293ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-04_19:17_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 293 ms
- **最后更新 (UTC)**: 2026-05-04 19:17 UTC

**协议分布:** shadowsocks × 35 · trojan × 25 · vless × 71 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 60 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
