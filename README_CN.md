...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2258-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-179ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_11:11_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 179 ms
- **最后更新 (UTC)**: 2026-04-22 11:11 UTC

**协议分布:** shadowsocks × 28 · trojan × 10 · vless × 99 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 48 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 59 · `pawdroid` × 2 · `ruking-clash` × 4 · `surfboard-eternity` × 7
