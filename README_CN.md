...
![节点](https://img.shields.io/badge/节点-82-brightgreen) ![存活](https://img.shields.io/badge/存活-2454-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-79ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-03_10:16_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 79 ms
- **最后更新 (UTC)**: 2026-06-03 10:16 UTC

**协议分布:** shadowsocks × 13 · trojan × 36 · vless × 6 · vmess × 27

**本次使用的源:** `barry-far-v2ray` × 23 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 3 · `snakem982` × 1
