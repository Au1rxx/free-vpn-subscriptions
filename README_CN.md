...
![节点](https://img.shields.io/badge/节点-146-brightgreen) ![存活](https://img.shields.io/badge/存活-2217-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-181ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_13:29_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 181 ms
- **最后更新 (UTC)**: 2026-04-22 13:29 UTC

**协议分布:** shadowsocks × 32 · trojan × 21 · vless × 79 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 62 · `ruking-clash` × 5 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
