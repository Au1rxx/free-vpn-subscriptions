...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2474-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-81ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-17_01:39_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 81 ms
- **最后更新 (UTC)**: 2026-05-17 01:39 UTC

**协议分布:** shadowsocks × 40 · trojan × 10 · vless × 91 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 16 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 56 · `pawdroid` × 6 · `ruking-clash` × 4 · `surfboard-eternity` × 1
