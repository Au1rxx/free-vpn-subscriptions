...
![节点](https://img.shields.io/badge/节点-69-brightgreen) ![存活](https://img.shields.io/badge/存活-2052-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-234ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-28_16:38_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 234 ms
- **最后更新 (UTC)**: 2026-05-28 16:38 UTC

**协议分布:** hysteria2 × 3 · shadowsocks × 30 · trojan × 14 · vless × 12 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 5 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 3
