...
![节点](https://img.shields.io/badge/节点-146-brightgreen) ![存活](https://img.shields.io/badge/存活-2057-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-429ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_12:34_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 429 ms
- **最后更新 (UTC)**: 2026-06-21 12:34 UTC

**协议分布:** shadowsocks × 45 · trojan × 34 · vless × 44 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 12 · `epodonios` × 21 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 37 · `surfboard-eternity` × 3
