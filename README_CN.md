...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2606-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_04:24_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 167 ms
- **最后更新 (UTC)**: 2026-04-23 04:24 UTC

**协议分布:** shadowsocks × 27 · trojan × 18 · vless × 96 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 28 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 75 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 2
