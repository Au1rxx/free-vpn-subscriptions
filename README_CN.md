...
![节点](https://img.shields.io/badge/节点-139-brightgreen) ![存活](https://img.shields.io/badge/存活-2654-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-199ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_22:32_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 199 ms
- **最后更新 (UTC)**: 2026-04-24 22:32 UTC

**协议分布:** shadowsocks × 24 · trojan × 23 · vless × 79 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 25 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 48 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
