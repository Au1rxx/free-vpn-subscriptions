...
![节点](https://img.shields.io/badge/节点-60-brightgreen) ![存活](https://img.shields.io/badge/存活-1971-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-134ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-27_18:22_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 134 ms
- **最后更新 (UTC)**: 2026-05-27 18:22 UTC

**协议分布:** shadowsocks × 24 · trojan × 11 · vless × 19 · vmess × 6

**本次使用的源:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 1 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 4 · `ruking-clash` × 7 · `snakem982` × 1 · `surfboard-eternity` × 3
