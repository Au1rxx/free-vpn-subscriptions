...
![节点](https://img.shields.io/badge/节点-78-brightgreen) ![存活](https://img.shields.io/badge/存活-2066-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-172ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-29_07:19_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 172 ms
- **最后更新 (UTC)**: 2026-05-29 07:19 UTC

**协议分布:** shadowsocks × 22 · trojan × 32 · vless × 15 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
