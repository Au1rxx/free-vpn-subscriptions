...
![节点](https://img.shields.io/badge/节点-71-brightgreen) ![存活](https://img.shields.io/badge/存活-1884-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-288ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-05_12:30_UTC-informational)
...
- **最快延迟**: 24 ms
- **中位延迟**: 288 ms
- **最后更新 (UTC)**: 2026-06-05 12:30 UTC

**协议分布:** shadowsocks × 26 · trojan × 23 · vless × 10 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
