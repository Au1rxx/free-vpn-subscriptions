...
![节点](https://img.shields.io/badge/节点-81-brightgreen) ![存活](https://img.shields.io/badge/存活-2173-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-172ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_09:33_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 172 ms
- **最后更新 (UTC)**: 2026-06-06 09:33 UTC

**协议分布:** shadowsocks × 22 · trojan × 24 · vless × 16 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 4 · `epodonios` × 25 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 1
