...
![节点](https://img.shields.io/badge/节点-74-brightgreen) ![存活](https://img.shields.io/badge/存活-2238-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-131ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-31_13:10_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 131 ms
- **最后更新 (UTC)**: 2026-05-31 13:10 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 21 · trojan × 19 · vless × 7 · vmess × 26

**本次使用的源:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 5 · `pawdroid` × 1 · `surfboard-eternity` × 1
