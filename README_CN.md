...
![节点](https://img.shields.io/badge/节点-90-brightgreen) ![存活](https://img.shields.io/badge/存活-2196-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-553ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_12:38_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 553 ms
- **最后更新 (UTC)**: 2026-06-29 12:38 UTC

**协议分布:** shadowsocks × 18 · trojan × 40 · vless × 19 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 18 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 5
