...
![节点](https://img.shields.io/badge/节点-73-brightgreen) ![存活](https://img.shields.io/badge/存活-2438-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-106ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_16:18_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 106 ms
- **最后更新 (UTC)**: 2026-06-02 16:18 UTC

**协议分布:** shadowsocks × 23 · trojan × 25 · vless × 7 · vmess × 18

**本次使用的源:** `barry-far-v2ray` × 15 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 5 · `pawdroid` × 2
