...
![节点](https://img.shields.io/badge/节点-149-brightgreen) ![存活](https://img.shields.io/badge/存活-2344-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-375ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-08_21:11_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 375 ms
- **最后更新 (UTC)**: 2026-05-08 21:11 UTC

**协议分布:** shadowsocks × 53 · trojan × 21 · vless × 66 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
