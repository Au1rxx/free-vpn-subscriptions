...
![节点](https://img.shields.io/badge/节点-86-brightgreen) ![存活](https://img.shields.io/badge/存活-1857-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-357ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-09_09:12_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 357 ms
- **最后更新 (UTC)**: 2026-06-09 09:12 UTC

**协议分布:** shadowsocks × 40 · trojan × 18 · vless × 18 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 13 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
