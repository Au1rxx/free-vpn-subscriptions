...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2039-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-73ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_13:15_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 73 ms
- **最后更新 (UTC)**: 2026-05-22 13:15 UTC

**协议分布:** shadowsocks × 37 · trojan × 13 · vless × 87 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 32 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 63 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
