...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2635-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-98ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_00:11_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 98 ms
- **最后更新 (UTC)**: 2026-04-28 00:11 UTC

**协议分布:** shadowsocks × 18 · trojan × 4 · vless × 118 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 32 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 68 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
