...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2157-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-155ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-01_17:12_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 155 ms
- **最后更新 (UTC)**: 2026-05-01 17:12 UTC

**协议分布:** shadowsocks × 40 · trojan × 17 · vless × 82 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 31 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 49 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
