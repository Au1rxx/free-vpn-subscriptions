...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1963-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-472ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_21:13_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 472 ms
- **最后更新 (UTC)**: 2026-06-22 21:13 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 43 · trojan × 16 · vless × 79 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 56 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 21 · `snakem982` × 2 · `surfboard-eternity` × 4
