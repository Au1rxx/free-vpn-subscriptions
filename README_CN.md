...
![节点](https://img.shields.io/badge/节点-96-brightgreen) ![存活](https://img.shields.io/badge/存活-1844-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-374ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_08:38_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 374 ms
- **最后更新 (UTC)**: 2026-06-30 08:38 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 35 · trojan × 41 · vless × 10 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 12
