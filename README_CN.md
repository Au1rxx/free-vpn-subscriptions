...
![节点](https://img.shields.io/badge/节点-149-brightgreen) ![存活](https://img.shields.io/badge/存活-2451-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-109ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_08:36_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 109 ms
- **最后更新 (UTC)**: 2026-04-24 08:36 UTC

**协议分布:** shadowsocks × 13 · trojan × 23 · vless × 100 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 21 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 76 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 1
