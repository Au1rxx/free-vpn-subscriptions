...
![节点](https://img.shields.io/badge/节点-117-brightgreen) ![存活](https://img.shields.io/badge/存活-1980-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-110ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-04_01:22_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 110 ms
- **最后更新 (UTC)**: 2026-06-04 01:22 UTC

**协议分布:** shadowsocks × 25 · trojan × 46 · vless × 35 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 4 · `ninjastrikers` × 29 · `pawdroid` × 1 · `surfboard-eternity` × 2
