...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2552-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-72ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-16_09:33_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 72 ms
- **最后更新 (UTC)**: 2026-05-16 09:33 UTC

**协议分布:** shadowsocks × 32 · trojan × 8 · vless × 102 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 15 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 8 · `ruking-clash` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
