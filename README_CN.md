...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2579-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-103ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_04:22_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 103 ms
- **最后更新 (UTC)**: 2026-04-28 04:22 UTC

**协议分布:** shadowsocks × 19 · trojan × 7 · vless × 115 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 30 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 68 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
