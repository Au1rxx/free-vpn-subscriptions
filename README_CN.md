...
![节点](https://img.shields.io/badge/节点-135-brightgreen) ![存活](https://img.shields.io/badge/存活-1712-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-378ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_02:33_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 378 ms
- **最后更新 (UTC)**: 2026-06-14 02:33 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 54 · trojan × 37 · vless × 36 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 34 · `pawdroid` × 4 · `ruking-clash` × 21 · `surfboard-eternity` × 7
