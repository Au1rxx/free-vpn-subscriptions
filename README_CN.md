...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2474-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-116ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-16_23:36_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 116 ms
- **最后更新 (UTC)**: 2026-05-16 23:36 UTC

**协议分布:** shadowsocks × 41 · trojan × 24 · vless × 76 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 28 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 6 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
