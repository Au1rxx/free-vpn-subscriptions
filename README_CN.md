...
![节点](https://img.shields.io/badge/节点-115-brightgreen) ![存活](https://img.shields.io/badge/存活-2116-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-355ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_19:18_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 355 ms
- **最后更新 (UTC)**: 2026-06-20 19:18 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 42 · trojan × 26 · vless × 23 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 3 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 25 · `surfboard-eternity` × 1
