...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2444-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-76ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_13:29_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 76 ms
- **最后更新 (UTC)**: 2026-05-18 13:29 UTC

**协议分布:** shadowsocks × 44 · trojan × 7 · vless × 92 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 21 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 6
