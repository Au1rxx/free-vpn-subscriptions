...
![节点](https://img.shields.io/badge/节点-123-brightgreen) ![存活](https://img.shields.io/badge/存活-2075-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-379ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_17:36_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 379 ms
- **最后更新 (UTC)**: 2026-06-24 17:36 UTC

**协议分布:** shadowsocks × 36 · trojan × 33 · vless × 38 · vmess × 16

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 40 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 3
