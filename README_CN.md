...
![节点](https://img.shields.io/badge/节点-91-brightgreen) ![存活](https://img.shields.io/badge/存活-1919-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-122ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-04_18:34_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 122 ms
- **最后更新 (UTC)**: 2026-06-04 18:34 UTC

**协议分布:** shadowsocks × 20 · trojan × 39 · vless × 21 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 25 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 8 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 2
