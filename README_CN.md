...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2122-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-173ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_01:12_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 173 ms
- **最后更新 (UTC)**: 2026-06-21 01:12 UTC

**协议分布:** shadowsocks × 38 · trojan × 28 · vless × 62 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 9 · `epodonios` × 39 · `mahdi0024` × 26 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 4 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 22 · `snakem982` × 1 · `surfboard-eternity` × 4
