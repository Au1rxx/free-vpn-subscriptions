...
![节点](https://img.shields.io/badge/节点-140-brightgreen) ![存活](https://img.shields.io/badge/存活-2556-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-370ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_15:16_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 370 ms
- **最后更新 (UTC)**: 2026-04-22 15:16 UTC

**协议分布:** shadowsocks × 28 · trojan × 21 · vless × 77 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 29 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 58 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 9
