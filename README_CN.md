...
![节点](https://img.shields.io/badge/节点-137-brightgreen) ![存活](https://img.shields.io/badge/存活-2494-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-168ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-09_18:39_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 168 ms
- **最后更新 (UTC)**: 2026-05-09 18:39 UTC

**协议分布:** shadowsocks × 52 · trojan × 16 · vless × 61 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `ruking-clash` × 8 · `snakem982` × 3 · `surfboard-eternity` × 6
