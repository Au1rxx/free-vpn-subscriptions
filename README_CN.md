...
![节点](https://img.shields.io/badge/节点-88-brightgreen) ![存活](https://img.shields.io/badge/存活-2206-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-277ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-11_07:32_UTC-informational)
...
- **最快延迟**: 26 ms
- **中位延迟**: 277 ms
- **最后更新 (UTC)**: 2026-06-11 07:32 UTC

**协议分布:** shadowsocks × 36 · trojan × 14 · vless × 16 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 3
