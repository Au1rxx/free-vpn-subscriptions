...
![节点](https://img.shields.io/badge/节点-72-brightgreen) ![存活](https://img.shields.io/badge/存活-2517-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-113ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-01_22:34_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 113 ms
- **最后更新 (UTC)**: 2026-06-01 22:34 UTC

**协议分布:** shadowsocks × 16 · trojan × 31 · vless × 3 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 22 · `epodonios` × 13 · `mahdi0024` × 17 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `surfboard-eternity` × 3
