...
![节点](https://img.shields.io/badge/节点-109-brightgreen) ![存活](https://img.shields.io/badge/存活-1686-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-405ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-13_23:25_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 405 ms
- **最后更新 (UTC)**: 2026-06-13 23:25 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 54 · trojan × 32 · vless × 15 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 14 · `surfboard-eternity` × 4
