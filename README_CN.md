...
![节点](https://img.shields.io/badge/节点-147-brightgreen) ![存活](https://img.shields.io/badge/存活-2074-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-199ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-29_17:21_UTC-informational)
...
- **最快延迟**: 40 ms
- **中位延迟**: 199 ms
- **最后更新 (UTC)**: 2026-04-29 17:21 UTC

**协议分布:** shadowsocks × 43 · trojan × 18 · vless × 76 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 7 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 7 · `ninjastrikers` × 53 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
