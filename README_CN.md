...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2115-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-132ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-29_12:39_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 132 ms
- **最后更新 (UTC)**: 2026-04-29 12:39 UTC

**协议分布:** shadowsocks × 41 · trojan × 10 · vless × 89 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 31 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 60 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
