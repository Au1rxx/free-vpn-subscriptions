...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1923-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-222ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_03:14_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 222 ms
- **最后更新 (UTC)**: 2026-06-22 03:14 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 47 · trojan × 10 · vless × 79 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 13 · `epodonios` × 41 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 18 · `snakem982` × 2 · `surfboard-eternity` × 3
