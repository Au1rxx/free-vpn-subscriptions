...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2276-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-151ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_01:36_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 151 ms
- **最后更新 (UTC)**: 2026-04-21 01:36 UTC

**协议分布:** shadowsocks × 21 · trojan × 3 · vless × 114 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 54 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 7
