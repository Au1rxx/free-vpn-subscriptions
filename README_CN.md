...
![节点](https://img.shields.io/badge/节点-133-brightgreen) ![存活](https://img.shields.io/badge/存活-1635-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-480ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_20:27_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 480 ms
- **最后更新 (UTC)**: 2026-06-14 20:27 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 61 · trojan × 32 · vless × 26 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 17 · `surfboard-eternity` × 4
