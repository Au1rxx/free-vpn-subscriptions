...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2235-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-142ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_04:14_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 142 ms
- **最后更新 (UTC)**: 2026-04-22 04:14 UTC

**协议分布:** shadowsocks × 33 · trojan × 3 · vless × 102 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 38 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 67 · `ruking-clash` × 5 · `surfboard-eternity` × 6
