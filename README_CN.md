...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2222-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-107ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_07:22_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 107 ms
- **最后更新 (UTC)**: 2026-04-30 07:22 UTC

**协议分布:** shadowsocks × 34 · trojan × 17 · vless × 90 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 27 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 7 · `ninjastrikers` × 67 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
