...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2281-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-66ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_10:15_UTC-informational)
...
- **最快延迟**: 24 ms
- **中位延迟**: 66 ms
- **最后更新 (UTC)**: 2026-05-19 10:15 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 19 · trojan × 24 · vless × 85 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 59 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 4
