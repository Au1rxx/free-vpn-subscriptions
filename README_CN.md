...
![节点](https://img.shields.io/badge/节点-112-brightgreen) ![存活](https://img.shields.io/badge/存活-1854-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-329ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_05:18_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 329 ms
- **最后更新 (UTC)**: 2026-06-15 05:18 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 45 · trojan × 22 · vless × 29 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 28 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 4
