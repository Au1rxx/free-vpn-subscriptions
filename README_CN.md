...
![节点](https://img.shields.io/badge/节点-112-brightgreen) ![存活](https://img.shields.io/badge/存活-1869-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-343ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-05_20:31_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 343 ms
- **最后更新 (UTC)**: 2026-07-05 20:31 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 48 · trojan × 24 · vless × 9 · vmess × 30

**本次使用的源:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 2
