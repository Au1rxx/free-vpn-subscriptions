...
![节点](https://img.shields.io/badge/节点-80-brightgreen) ![存活](https://img.shields.io/badge/存活-2418-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-01_14:35_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 167 ms
- **最后更新 (UTC)**: 2026-06-01 14:35 UTC

**协议分布:** shadowsocks × 16 · trojan × 25 · vless × 7 · vmess × 32

**本次使用的源:** `barry-far-v2ray` × 16 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 9 · `pawdroid` × 3 · `surfboard-eternity` × 2
