...
![节点](https://img.shields.io/badge/节点-135-brightgreen) ![存活](https://img.shields.io/badge/存活-1874-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-346ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_01:19_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 346 ms
- **最后更新 (UTC)**: 2026-06-16 01:19 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 53 · trojan × 30 · vless × 37 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 35 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
