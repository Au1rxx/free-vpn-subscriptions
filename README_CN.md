...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1967-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-365ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-06_17:29_UTC-informational)
...
- **最快延迟**: 41 ms
- **中位延迟**: 365 ms
- **最后更新 (UTC)**: 2026-05-06 17:29 UTC

**协议分布:** shadowsocks × 48 · trojan × 20 · vless × 71 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 58 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
