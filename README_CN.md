...
![节点](https://img.shields.io/badge/节点-138-brightgreen) ![存活](https://img.shields.io/badge/存活-2588-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-229ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_14:16_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 229 ms
- **最后更新 (UTC)**: 2026-04-22 14:16 UTC

**协议分布:** shadowsocks × 27 · trojan × 22 · vless × 79 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 30 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 57 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7
