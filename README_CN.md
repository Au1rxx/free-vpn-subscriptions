...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2064-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-88ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-04_07:38_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 88 ms
- **最后更新 (UTC)**: 2026-05-04 07:38 UTC

**协议分布:** shadowsocks × 26 · trojan × 12 · vless × 102 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 24 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 8 · `ninjastrikers` × 69 · `snakem982` × 1 · `surfboard-eternity` × 8
