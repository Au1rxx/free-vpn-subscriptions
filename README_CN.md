...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2165-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-83ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-01_12:24_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 83 ms
- **最后更新 (UTC)**: 2026-05-01 12:24 UTC

**协议分布:** shadowsocks × 32 · trojan × 13 · vless × 85 · vmess × 20

**本次使用的源:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
