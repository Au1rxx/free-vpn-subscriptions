...
![节点](https://img.shields.io/badge/节点-131-brightgreen) ![存活](https://img.shields.io/badge/存活-2612-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-291ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_23:11_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 291 ms
- **最后更新 (UTC)**: 2026-04-22 23:11 UTC

**协议分布:** shadowsocks × 30 · trojan × 20 · vless × 68 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
