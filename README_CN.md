...
![节点](https://img.shields.io/badge/节点-116-brightgreen) ![存活](https://img.shields.io/badge/存活-1906-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-320ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-05_23:26_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 320 ms
- **最后更新 (UTC)**: 2026-07-05 23:26 UTC

**协议分布:** shadowsocks × 49 · trojan × 26 · vless × 10 · vmess × 31

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 31 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `ruking-clash` × 2 · `surfboard-eternity` × 4
