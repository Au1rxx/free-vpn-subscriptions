...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2561-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-75ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-16_10:18_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 75 ms
- **最后更新 (UTC)**: 2026-05-16 10:18 UTC

**协议分布:** shadowsocks × 33 · trojan × 13 · vless × 96 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 18 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `pawdroid` × 7 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
