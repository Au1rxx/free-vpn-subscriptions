...
![节点](https://img.shields.io/badge/节点-66-brightgreen) ![存活](https://img.shields.io/badge/存活-2114-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-143ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-09_19:23_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 143 ms
- **最后更新 (UTC)**: 2026-07-09 19:23 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 22 · trojan × 9 · vless × 5 · vmess × 29

**本次使用的源:** `barry-far-v2ray` × 1 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 9 · `pawdroid` × 1 · `ruking-clash` × 2
