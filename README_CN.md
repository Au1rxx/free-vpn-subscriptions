...
![节点](https://img.shields.io/badge/节点-139-brightgreen) ![存活](https://img.shields.io/badge/存活-1902-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-426ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_08:39_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 426 ms
- **最后更新 (UTC)**: 2026-06-22 08:39 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 45 · trojan × 26 · vless × 54 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 4 · `surfboard-eternity` × 4
