...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2215-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-113ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_05:16_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 113 ms
- **最后更新 (UTC)**: 2026-04-21 05:16 UTC

**协议分布:** shadowsocks × 27 · trojan × 1 · vless × 107 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 48 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 57 · `ruking-clash` × 6 · `surfboard-eternity` × 8
