...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2280-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-451ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_22:36_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 451 ms
- **最后更新 (UTC)**: 2026-04-20 22:36 UTC

**协议分布:** shadowsocks × 22 · trojan × 19 · vless × 95 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 60 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 44 · `ruking-clash` × 4 · `surfboard-eternity` × 5
