...
![节点](https://img.shields.io/badge/节点-149-brightgreen) ![存活](https://img.shields.io/badge/存活-2563-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_19:33_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 167 ms
- **最后更新 (UTC)**: 2026-04-24 19:33 UTC

**协议分布:** shadowsocks × 29 · trojan × 22 · vless × 85 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 27 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 52 · `snakem982` × 1 · `surfboard-eternity` × 6
