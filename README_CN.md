...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2360-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-88ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-23_18:33_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 88 ms
- **最后更新 (UTC)**: 2026-05-23 18:33 UTC

**协议分布:** shadowsocks × 38 · trojan × 21 · vless × 67 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 26 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 40 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 49 · `pawdroid` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
