...
![节点](https://img.shields.io/badge/节点-96-brightgreen) ![存活](https://img.shields.io/badge/存活-1956-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-484ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_10:19_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 484 ms
- **最后更新 (UTC)**: 2026-06-18 10:19 UTC

**协议分布:** shadowsocks × 35 · trojan × 25 · vless × 28 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 12 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 25 · `snakem982` × 5 · `surfboard-eternity` × 4
