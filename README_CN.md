...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2246-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-181ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_16:21_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 181 ms
- **最后更新 (UTC)**: 2026-04-20 16:21 UTC

**协议分布:** shadowsocks × 29 · trojan × 16 · vless × 95 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 50 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
