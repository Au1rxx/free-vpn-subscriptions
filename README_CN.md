...
![节点](https://img.shields.io/badge/节点-126-brightgreen) ![存活](https://img.shields.io/badge/存活-2022-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-405ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_22:14_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 405 ms
- **最后更新 (UTC)**: 2026-06-23 22:14 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 37 · trojan × 30 · vless × 43 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 44 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 18 · `surfboard-eternity` × 3
