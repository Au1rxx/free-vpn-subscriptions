...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2281-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-174ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-25_19:17_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 174 ms
- **最后更新 (UTC)**: 2026-04-25 19:17 UTC

**协议分布:** shadowsocks × 34 · trojan × 18 · vless × 83 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 24 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
