...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1857-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-471ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_15:32_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 471 ms
- **最后更新 (UTC)**: 2026-06-22 15:32 UTC

**协议分布:** shadowsocks × 40 · trojan × 31 · vless × 66 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 14 · `epodonios` × 41 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 2 · `surfboard-eternity` × 3
