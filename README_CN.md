...
![节点](https://img.shields.io/badge/节点-96-brightgreen) ![存活](https://img.shields.io/badge/存活-1899-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-158ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-04_19:39_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 158 ms
- **最后更新 (UTC)**: 2026-06-04 19:39 UTC

**协议分布:** shadowsocks × 20 · trojan × 47 · vless × 19 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 32 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `ruking-clash` × 4 · `surfboard-eternity` × 2
