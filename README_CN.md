...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2160-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-141ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-06_08:12_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 141 ms
- **最后更新 (UTC)**: 2026-05-06 08:12 UTC

**协议分布:** shadowsocks × 44 · trojan × 6 · vless × 90 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 70 · `pawdroid` × 3 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
