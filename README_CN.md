...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2202-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-112ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-26_11:38_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 112 ms
- **最后更新 (UTC)**: 2026-04-26 11:38 UTC

**协议分布:** shadowsocks × 27 · trojan × 15 · vless × 96 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 20 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
