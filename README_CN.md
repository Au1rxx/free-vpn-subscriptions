...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2191-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-123ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_08:12_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 123 ms
- **最后更新 (UTC)**: 2026-04-21 08:12 UTC

**协议分布:** shadowsocks × 29 · trojan × 3 · vless × 103 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 50 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 55 · `pawdroid` × 2 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
