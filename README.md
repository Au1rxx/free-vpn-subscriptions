...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2162-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-86ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_06:16_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2162
- **Fastest node RTT**: 28 ms
- **Median RTT**: 86 ms
- **Last updated (UTC)**: 2026-05-03 06:16 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 5 · vless × 101 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 21 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
