...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2195-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-117ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_10:18_UTC-informational)
...
- **Median RTT**: 117 ms
- **Last updated (UTC)**: 2026-04-30 10:18 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 11 · vless × 89 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 59 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
