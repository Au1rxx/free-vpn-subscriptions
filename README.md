...
![nodes](https://img.shields.io/badge/nodes-87-brightgreen) ![alive](https://img.shields.io/badge/alive-2098-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-193ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_07:32_UTC-informational)
...
- **Median RTT**: 193 ms
- **Last updated (UTC)**: 2026-06-06 07:32 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 26 · vless × 19 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 22 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `surfboard-eternity` × 4
