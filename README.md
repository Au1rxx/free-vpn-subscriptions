...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-1892-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-310ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_09:32_UTC-informational)
...
- **Median RTT**: 310 ms
- **Last updated (UTC)**: 2026-07-06 09:32 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 27 · vless × 12 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 3
