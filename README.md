...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-1913-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-336ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-14_05:25_UTC-informational)
...
- **Median RTT**: 336 ms
- **Last updated (UTC)**: 2026-07-14 05:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 22 · vless × 23 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 3 · `ninjastrikers` × 24 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
