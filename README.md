...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2350-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-397ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_01:20_UTC-informational)
...
- **Median RTT**: 397 ms
- **Last updated (UTC)**: 2026-07-18 01:20 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 87 · vless × 18 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `mahdi0024` × 68 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 6 · `surfboard-eternity` × 5
