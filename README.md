...
![nodes](https://img.shields.io/badge/nodes-144-brightgreen) ![alive](https://img.shields.io/badge/alive-1926-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-481ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_13:37_UTC-informational)
...
- **Median RTT**: 481 ms
- **Last updated (UTC)**: 2026-06-22 13:37 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 29 · vless × 62 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 41 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 8
