...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2211-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-108ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_13:15_UTC-informational)
...
- **Median RTT**: 108 ms
- **Last updated (UTC)**: 2026-04-26 13:15 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 16 · vless × 98 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 20 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 68 · `surfboard-eternity` × 9
