...
![nodes](https://img.shields.io/badge/nodes-130-brightgreen) ![alive](https://img.shields.io/badge/alive-2005-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-469ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_21:23_UTC-informational)
...
- **Median RTT**: 469 ms
- **Last updated (UTC)**: 2026-06-23 21:23 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 38 · trojan × 30 · vless × 45 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 45 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
