...
![nodes](https://img.shields.io/badge/nodes-72-brightgreen) ![alive](https://img.shields.io/badge/alive-2198-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-167ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-31_19:30_UTC-informational)
...
- **Median RTT**: 167 ms
- **Last updated (UTC)**: 2026-05-31 19:30 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 16 · vless × 5 · vmess × 30

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 7 · `mahdi0024` × 22 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `pawdroid` × 1 · `surfboard-eternity` × 4
