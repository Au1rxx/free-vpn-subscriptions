...
![nodes](https://img.shields.io/badge/nodes-137-brightgreen) ![alive](https://img.shields.io/badge/alive-2446-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-338ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_23:16_UTC-informational)
...
- **Median RTT**: 338 ms
- **Last updated (UTC)**: 2026-04-23 23:16 UTC

**Protocol mix:** shadowsocks × 19 · trojan × 22 · vless × 79 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 26 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 2 · `surfboard-eternity` × 4
