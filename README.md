...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2430-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-80ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-15_11:11_UTC-informational)
...
- **Median RTT**: 80 ms
- **Last updated (UTC)**: 2026-05-15 11:11 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 5 · vless × 93 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 3 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `pawdroid` × 7 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
