...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2567-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-85ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_04:14_UTC-informational)
...
- **Median RTT**: 85 ms
- **Last updated (UTC)**: 2026-04-27 04:14 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 2 · vless × 101 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 45 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 6 · `ninjastrikers` × 60 · `pawdroid` × 1 · `surfboard-eternity` × 6
