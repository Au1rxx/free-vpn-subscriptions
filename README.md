...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1921-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-151ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_13:11_UTC-informational)
...
- **Median RTT**: 151 ms
- **Last updated (UTC)**: 2026-05-12 13:11 UTC

**Protocol mix:** shadowsocks × 55 · trojan × 6 · vless × 79 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 7 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `snakem982` × 1 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
