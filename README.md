...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2470-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-93ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-15_01:12_UTC-informational)
...
- **Median RTT**: 93 ms
- **Last updated (UTC)**: 2026-05-15 01:12 UTC

**Protocol mix:** shadowsocks × 44 · trojan × 8 · vless × 91 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 32 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 52 · `pawdroid` × 7 · `ruking-clash` × 5 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
