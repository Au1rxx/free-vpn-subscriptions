...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2361-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-95ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_01:09_UTC-informational)
...
- **Median RTT**: 95 ms
- **Last updated (UTC)**: 2026-05-25 01:09 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 2 · vless × 81 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 48 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 66 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 3
