...
![nodes](https://img.shields.io/badge/nodes-138-brightgreen) ![alive](https://img.shields.io/badge/alive-2322-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-309ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_20:32_UTC-informational)
...
- **Median RTT**: 309 ms
- **Last updated (UTC)**: 2026-04-21 20:32 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 24 · vless × 68 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 37 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
