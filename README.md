...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2506-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-92ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_08:14_UTC-informational)
...
- **Median RTT**: 92 ms
- **Last updated (UTC)**: 2026-04-27 08:14 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 4 · vless × 99 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 48 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 2 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
