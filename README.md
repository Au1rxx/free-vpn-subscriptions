...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2424-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-112ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_05:12_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2424
- **Fastest node RTT**: 28 ms
- **Median RTT**: 112 ms
- **Last updated (UTC)**: 2026-04-24 05:12 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 13 · vless × 102 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 72 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 5
