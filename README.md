...
![nodes](https://img.shields.io/badge/nodes-78-brightgreen) ![alive](https://img.shields.io/badge/alive-2347-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-132ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-31_17:33_UTC-informational)
...
- **Median RTT**: 132 ms
- **Last updated (UTC)**: 2026-05-31 17:33 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 17 · vless × 8 · vmess × 32

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
