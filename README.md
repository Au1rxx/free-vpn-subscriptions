...
![nodes](https://img.shields.io/badge/nodes-128-brightgreen) ![alive](https://img.shields.io/badge/alive-1814-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-274ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-09_01:15_UTC-informational)
...
- **Median RTT**: 274 ms
- **Last updated (UTC)**: 2026-07-09 01:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 29 · vless × 26 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 7 · `ninjastrikers` × 22 · `pawdroid` × 8 · `ruking-clash` × 3 · `snakem982` × 4 · `surfboard-eternity` × 5
