...
![nodes](https://img.shields.io/badge/nodes-128-brightgreen) ![alive](https://img.shields.io/badge/alive-1932-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-293ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_00:31_UTC-informational)
...
- **Median RTT**: 293 ms
- **Last updated (UTC)**: 2026-07-12 00:31 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 64 · trojan × 20 · vless × 27 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 6 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 7
