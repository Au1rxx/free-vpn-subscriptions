...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2481-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-80ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-21_13:38_UTC-informational)
...
- **Median RTT**: 80 ms
- **Last updated (UTC)**: 2026-05-21 13:38 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 10 · vless × 85 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 25 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 17 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 60 · `pawdroid` × 9 · `ruking-clash` × 5 · `surfboard-eternity` × 9
