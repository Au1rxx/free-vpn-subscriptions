...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2663-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-74ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-17_13:25_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2663
- **Fastest node RTT**: 28 ms
- **Median RTT**: 74 ms
- **Last updated (UTC)**: 2026-05-17 13:25 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 9 · vless × 89 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 55 · `pawdroid` × 6 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 5
