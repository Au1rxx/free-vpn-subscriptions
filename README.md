...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2639-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-96ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_03:37_UTC-informational)
...
- **Median RTT**: 96 ms
- **Last updated (UTC)**: 2026-04-25 03:37 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 9 · vless × 106 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 63 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
