...
![nodes](https://img.shields.io/badge/nodes-93-brightgreen) ![alive](https://img.shields.io/badge/alive-1853-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-361ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_22:35_UTC-informational)
...
- **Median RTT**: 361 ms
- **Last updated (UTC)**: 2026-06-07 22:35 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 52 · trojan × 19 · vless × 15 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `ruking-clash` × 3 · `surfboard-eternity` × 1
