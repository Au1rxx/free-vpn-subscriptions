...
![nodes](https://img.shields.io/badge/nodes-98-brightgreen) ![alive](https://img.shields.io/badge/alive-1897-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-350ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_13:16_UTC-informational)
...
- **Median RTT**: 350 ms
- **Last updated (UTC)**: 2026-06-13 13:16 UTC

**Protocol mix:** shadowsocks × 54 · trojan × 25 · vless × 12 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 13 · `mahdi0024` × 3 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 4
