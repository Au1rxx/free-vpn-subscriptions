...
![nodes](https://img.shields.io/badge/nodes-110-brightgreen) ![alive](https://img.shields.io/badge/alive-1967-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-336ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_10:23_UTC-informational)
...
- **Median RTT**: 336 ms
- **Last updated (UTC)**: 2026-07-12 10:23 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 53 · trojan × 26 · vless × 12 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `mfuu-clash` × 6 · `ninjastrikers` × 14 · `pawdroid` × 9 · `surfboard-eternity` × 2
