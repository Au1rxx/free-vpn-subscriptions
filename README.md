...
![nodes](https://img.shields.io/badge/nodes-73-brightgreen) ![alive](https://img.shields.io/badge/alive-2087-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-277ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-28_17:22_UTC-informational)
...
- **Nodes selected**: 73
- **Alive across all sources**: 2087
- **Fastest node RTT**: 37 ms
- **Median RTT**: 277 ms
- **Last updated (UTC)**: 2026-05-28 17:22 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 22 · vless × 12 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 3 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
