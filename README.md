...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-2506-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-147ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_22:30_UTC-informational)
...
- **Nodes selected**: 140
- **Alive across all sources**: 2506
- **Fastest node RTT**: 28 ms
- **Median RTT**: 147 ms
- **Last updated (UTC)**: 2026-05-09 22:30 UTC

**Protocol mix:** shadowsocks × 46 · trojan × 17 · vless × 68 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 56 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 8
