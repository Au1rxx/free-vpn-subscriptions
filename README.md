...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2069-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-123ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_09:31_UTC-informational)
...
- **Median RTT**: 123 ms
- **Last updated (UTC)**: 2026-04-29 09:31 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 4 · vless × 95 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 10
