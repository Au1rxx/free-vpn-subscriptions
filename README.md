...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-1969-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-338ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_03:33_UTC-informational)
...
- **Median RTT**: 338 ms
- **Last updated (UTC)**: 2026-07-05 03:33 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 56 · trojan × 29 · vless × 14 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 39 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 3 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
