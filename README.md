...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2199-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-227ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_12:29_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2199
- **Fastest node RTT**: 29 ms
- **Median RTT**: 227 ms
- **Last updated (UTC)**: 2026-04-21 12:29 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 4 · vless × 104 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 59 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 2 · `ruking-clash` × 7 · `snakem982` × 2 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
