...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-2022-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-405ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_22:14_UTC-informational)
...
- **Nodes selected**: 126
- **Alive across all sources**: 2022
- **Fastest node RTT**: 31 ms
- **Median RTT**: 405 ms
- **Last updated (UTC)**: 2026-06-23 22:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 30 · vless × 43 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 44 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 18 · `surfboard-eternity` × 3
