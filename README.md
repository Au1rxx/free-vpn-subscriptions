...
![nodes](https://img.shields.io/badge/nodes-107-brightgreen) ![alive](https://img.shields.io/badge/alive-2113-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-357ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_08:29_UTC-informational)
...
- **Median RTT**: 357 ms
- **Last updated (UTC)**: 2026-07-02 08:29 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 55 · trojan × 28 · vless × 15 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 21 · `pawdroid` × 3 · `surfboard-eternity` × 4
