...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2448-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-107ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-14_04:37_UTC-informational)
...
- **Median RTT**: 107 ms
- **Last updated (UTC)**: 2026-05-14 04:37 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 2 · vless × 98 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 61 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 4
