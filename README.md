...
![nodes](https://img.shields.io/badge/nodes-110-brightgreen) ![alive](https://img.shields.io/badge/alive-1911-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-353ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_02:33_UTC-informational)
...
- **Median RTT**: 353 ms
- **Last updated (UTC)**: 2026-06-26 02:33 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 38 · vless × 29 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 24 · `ruking-clash` × 17 · `surfboard-eternity` × 2
