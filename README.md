...
![nodes](https://img.shields.io/badge/nodes-119-brightgreen) ![alive](https://img.shields.io/badge/alive-2519-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-429ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_20:36_UTC-informational)
...
- **Nodes selected**: 119
- **Alive across all sources**: 2519
- **Fastest node RTT**: 30 ms
- **Median RTT**: 429 ms
- **Last updated (UTC)**: 2026-04-23 20:36 UTC

**Protocol mix:** shadowsocks × 14 · trojan × 25 · vless × 65 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `surfboard-eternity` × 6
