...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1961-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-143ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_03:12_UTC-informational)
...
- **Median RTT**: 143 ms
- **Last updated (UTC)**: 2026-05-12 03:12 UTC

**Protocol mix:** shadowsocks × 52 · trojan × 4 · vless × 86 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 9 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 64 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 2
