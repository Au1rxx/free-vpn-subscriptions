...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2041-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-78ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-22_08:17_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2041
- **Fastest node RTT**: 31 ms
- **Median RTT**: 78 ms
- **Last updated (UTC)**: 2026-05-22 08:17 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 9 · vless × 86 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 3 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
