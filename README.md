...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2021-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-204ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_12:20_UTC-informational)
...
- **Median RTT**: 204 ms
- **Last updated (UTC)**: 2026-05-07 12:20 UTC

**Protocol mix:** shadowsocks × 46 · trojan × 12 · vless × 83 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 28 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 69 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 9
