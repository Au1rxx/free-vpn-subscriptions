...
![nodes](https://img.shields.io/badge/nodes-116-brightgreen) ![alive](https://img.shields.io/badge/alive-1829-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-277ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_00:13_UTC-informational)
...
- **Median RTT**: 277 ms
- **Last updated (UTC)**: 2026-06-08 00:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 25 · vless × 35 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 20 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 36 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 6
