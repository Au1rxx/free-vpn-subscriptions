...
![nodes](https://img.shields.io/badge/nodes-130-brightgreen) ![alive](https://img.shields.io/badge/alive-1939-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-469ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_06:16_UTC-informational)
...
- **Median RTT**: 469 ms
- **Last updated (UTC)**: 2026-06-17 06:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 27 · vless × 23 · vmess × 39

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 41 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
