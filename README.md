...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-1862-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-276ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_02:13_UTC-informational)
...
- **Median RTT**: 276 ms
- **Last updated (UTC)**: 2026-07-07 02:13 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 45 · trojan × 25 · vless × 18 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 6 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 4
