...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2466-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-79ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_11:23_UTC-informational)
...
- **Median RTT**: 79 ms
- **Last updated (UTC)**: 2026-05-25 11:23 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 17 · vless × 64 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 15 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 50 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 6 · `ruking-clash` × 6 · `surfboard-eternity` × 4
