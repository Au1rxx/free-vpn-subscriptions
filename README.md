...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2320-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-398ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_06:18_UTC-informational)
...
- **Median RTT**: 398 ms
- **Last updated (UTC)**: 2026-07-18 06:18 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 97 · vless × 14 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 66 · `mahdibland-aggregator` × 34 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 6 · `snakem982` × 2 · `surfboard-eternity` × 1
