...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2107-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-87ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-02_09:27_UTC-informational)
...
- **Median RTT**: 87 ms
- **Last updated (UTC)**: 2026-05-02 09:27 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 6 · vless × 95 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 56 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 7
