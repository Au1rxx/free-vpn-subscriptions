...
![nodes](https://img.shields.io/badge/nodes-92-brightgreen) ![alive](https://img.shields.io/badge/alive-2147-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-173ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_12:11_UTC-informational)
...
- **Median RTT**: 173 ms
- **Last updated (UTC)**: 2026-06-07 12:11 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 23 · vless × 9 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 1 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 5
