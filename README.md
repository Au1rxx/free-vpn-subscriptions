...
![nodes](https://img.shields.io/badge/nodes-117-brightgreen) ![alive](https://img.shields.io/badge/alive-1984-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-348ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-28_03:17_UTC-informational)
...
- **Nodes selected**: 117
- **Alive across all sources**: 1984
- **Fastest node RTT**: 32 ms
- **Median RTT**: 348 ms
- **Last updated (UTC)**: 2026-06-28 03:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 32 · trojan × 38 · vless × 36 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 5
