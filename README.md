...
![nodes](https://img.shields.io/badge/nodes-91-brightgreen) ![alive](https://img.shields.io/badge/alive-2340-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-340ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_03:22_UTC-informational)
...
- **Median RTT**: 340 ms
- **Last updated (UTC)**: 2026-07-01 03:22 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 32 · vless × 14 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 13 · `ninjastrikers` × 23 · `surfboard-eternity` × 2
