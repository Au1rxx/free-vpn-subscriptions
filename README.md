...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2473-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-129ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_17:30_UTC-informational)
...
- **Median RTT**: 129 ms
- **Last updated (UTC)**: 2026-04-27 17:30 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 17 · vless × 93 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 32 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
