...
![nodes](https://img.shields.io/badge/nodes-103-brightgreen) ![alive](https://img.shields.io/badge/alive-2241-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-477ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-12_13:14_UTC-informational)
...
- **Median RTT**: 477 ms
- **Last updated (UTC)**: 2026-06-12 13:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 46 · trojan × 37 · vless × 15 · vmess × 4

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 29 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 5
