...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2020-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-398ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-16_10:30_UTC-informational)
...
- **Median RTT**: 398 ms
- **Last updated (UTC)**: 2026-07-16 10:30 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 44 · trojan × 73 · vless × 22 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `mahdi0024` × 18 · `mahdibland-aggregator` × 34 · `mahdibland-shadowsocks` × 46 · `matin-v2ray` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 11 · `surfboard-eternity` × 3
