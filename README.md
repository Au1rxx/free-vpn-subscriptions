...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2237-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-442ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-20_19:35_UTC-informational)
...
- **Median RTT**: 442 ms
- **Last updated (UTC)**: 2026-04-20 19:35 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 18 · vless × 90 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 50 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 10
