...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2489-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-86ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-16_18:11_UTC-informational)
...
- **Median RTT**: 86 ms
- **Last updated (UTC)**: 2026-05-16 18:11 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 19 · vless × 83 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 34 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 50 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 3
