...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-2097-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-279ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-25_08:23_UTC-informational)
...
- **Median RTT**: 279 ms
- **Last updated (UTC)**: 2026-06-25 08:23 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 34 · vless × 36 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 33 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 4
