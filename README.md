...
![nodes](https://img.shields.io/badge/nodes-124-brightgreen) ![alive](https://img.shields.io/badge/alive-2012-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-343ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_07:25_UTC-informational)
...
- **Median RTT**: 343 ms
- **Last updated (UTC)**: 2026-07-05 07:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 57 · trojan × 27 · vless × 11 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 4 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 2
