...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-2542-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-279ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_06:37_UTC-informational)
...
- **Median RTT**: 279 ms
- **Last updated (UTC)**: 2026-06-02 06:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 37 · vless × 16 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 19 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
