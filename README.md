...
![nodes](https://img.shields.io/badge/nodes-79-brightgreen) ![alive](https://img.shields.io/badge/alive-1985-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-170ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-03_19:22_UTC-informational)
...
- **Median RTT**: 170 ms
- **Last updated (UTC)**: 2026-07-03 19:22 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 24 · vless × 10 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 6 · `ninjastrikers` × 10 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
