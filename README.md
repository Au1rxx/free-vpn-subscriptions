...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-1800-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-396ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-15_21:13_UTC-informational)
...
- **Median RTT**: 396 ms
- **Last updated (UTC)**: 2026-07-15 21:13 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 78 · trojan × 34 · vless × 14 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 20 · `mahdi0024` × 16 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 5 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 14 · `surfboard-eternity` × 1
