...
![nodes](https://img.shields.io/badge/nodes-100-brightgreen) ![alive](https://img.shields.io/badge/alive-2317-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-359ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_08:29_UTC-informational)
...
- **Median RTT**: 359 ms
- **Last updated (UTC)**: 2026-07-01 08:29 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 32 · vless × 17 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 12 · `ninjastrikers` × 22 · `pawdroid` × 7 · `surfboard-eternity` × 1
