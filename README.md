...
![nodes](https://img.shields.io/badge/nodes-135-brightgreen) ![alive](https://img.shields.io/badge/alive-1874-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-346ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-16_01:19_UTC-informational)
...
- **Nodes selected**: 135
- **Alive across all sources**: 1874
- **Fastest node RTT**: 34 ms
- **Median RTT**: 346 ms
- **Last updated (UTC)**: 2026-06-16 01:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 53 · trojan × 30 · vless × 37 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 35 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
