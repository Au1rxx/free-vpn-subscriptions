...
![nodes](https://img.shields.io/badge/nodes-81-brightgreen) ![alive](https://img.shields.io/badge/alive-1768-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-317ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_10:36_UTC-informational)
...
- **Nodes selected**: 81
- **Alive across all sources**: 1768
- **Fastest node RTT**: 27 ms
- **Median RTT**: 317 ms
- **Last updated (UTC)**: 2026-06-08 10:36 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 43 · trojan × 17 · vless × 15 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 18 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 4
