...
![nodes](https://img.shields.io/badge/nodes-137-brightgreen) ![alive](https://img.shields.io/badge/alive-1701-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-377ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_04:23_UTC-informational)
...
- **Median RTT**: 377 ms
- **Last updated (UTC)**: 2026-06-14 04:23 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 53 · trojan × 40 · vless × 36 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 17 · `ninjastrikers` × 34 · `pawdroid` × 3 · `ruking-clash` × 22 · `surfboard-eternity` × 4
