...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2455-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-169ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_15:26_UTC-informational)
...
- **Median RTT**: 169 ms
- **Last updated (UTC)**: 2026-04-27 15:26 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 22 · vless × 87 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 19 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
