...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2222-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-126ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_08:25_UTC-informational)
...
- **Median RTT**: 126 ms
- **Last updated (UTC)**: 2026-04-30 08:25 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 19 · vless × 92 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 30 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 71 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
