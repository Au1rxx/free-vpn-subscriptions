...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2181-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-384ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_13:11_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2181
- **Fastest node RTT**: 28 ms
- **Median RTT**: 384 ms
- **Last updated (UTC)**: 2026-04-21 13:11 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 9 · vless × 99 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 55 · `epodonios` × 5 · `lagzian-mix` × 7 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `ruking-clash` × 11 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
