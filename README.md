...
![nodes](https://img.shields.io/badge/nodes-88-brightgreen) ![alive](https://img.shields.io/badge/alive-2045-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-344ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_20:36_UTC-informational)
...
- **Median RTT**: 344 ms
- **Last updated (UTC)**: 2026-07-01 20:36 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 47 · trojan × 22 · vless × 11 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 5 · `ninjastrikers` × 17 · `surfboard-eternity` × 4
