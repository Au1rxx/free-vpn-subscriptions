...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1875-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-221ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-11_17:26_UTC-informational)
...
- **Median RTT**: 221 ms
- **Last updated (UTC)**: 2026-05-11 17:26 UTC

**Protocol mix:** shadowsocks × 65 · trojan × 4 · vless × 69 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 9 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 5 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 57 · `pawdroid` × 4 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
