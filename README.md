...
![nodes](https://img.shields.io/badge/nodes-119-brightgreen) ![alive](https://img.shields.io/badge/alive-2101-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-361ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-24_05:16_UTC-informational)
...
- **Nodes selected**: 119
- **Alive across all sources**: 2101
- **Fastest node RTT**: 29 ms
- **Median RTT**: 361 ms
- **Last updated (UTC)**: 2026-06-24 05:16 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 29 · vless × 41 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 41 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `pawdroid` × 4 · `ruking-clash` × 13 · `surfboard-eternity` × 3
