...
![nodes](https://img.shields.io/badge/nodes-121-brightgreen) ![alive](https://img.shields.io/badge/alive-1965-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-284ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_05:15_UTC-informational)
...
- **Median RTT**: 284 ms
- **Last updated (UTC)**: 2026-07-06 05:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 47 · trojan × 27 · vless × 17 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 4 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
