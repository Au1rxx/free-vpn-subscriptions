...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-1956-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-341ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_11:09_UTC-informational)
...
- **Median RTT**: 341 ms
- **Last updated (UTC)**: 2026-07-12 11:09 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 53 · trojan × 18 · vless × 14 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 4 · `mfuu-clash` × 5 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4
