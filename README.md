...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2218-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-120ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_04:29_UTC-informational)
...
- **Median RTT**: 120 ms
- **Last updated (UTC)**: 2026-04-21 04:29 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 2 · vless × 102 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 47 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 54 · `ruking-clash` × 11 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
