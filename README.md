...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2198-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-371ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-19_06:19_UTC-informational)
...
- **Median RTT**: 371 ms
- **Last updated (UTC)**: 2026-07-19 06:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 79 · vless × 18 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 72 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 6 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 5
