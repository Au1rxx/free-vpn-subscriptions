...
![nodes](https://img.shields.io/badge/nodes-117-brightgreen) ![alive](https://img.shields.io/badge/alive-1980-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-110ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-04_01:22_UTC-informational)
...
- **Median RTT**: 110 ms
- **Last updated (UTC)**: 2026-06-04 01:22 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 46 · vless × 35 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 4 · `ninjastrikers` × 29 · `pawdroid` × 1 · `surfboard-eternity` × 2
