...
![nodes](https://img.shields.io/badge/nodes-138-brightgreen) ![alive](https://img.shields.io/badge/alive-1829-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-402ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-15_22:11_UTC-informational)
...
- **Median RTT**: 402 ms
- **Last updated (UTC)**: 2026-07-15 22:11 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 74 · trojan × 39 · vless × 10 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `mahdi0024` × 19 · `mahdibland-aggregator` × 30 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 3 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 4
