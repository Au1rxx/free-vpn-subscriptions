...
![nodes](https://img.shields.io/badge/nodes-84-brightgreen) ![alive](https://img.shields.io/badge/alive-1932-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-231ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_15:30_UTC-informational)
...
- **Median RTT**: 231 ms
- **Last updated (UTC)**: 2026-07-06 15:30 UTC

**Protocol mix:** shadowsocks × 20 · trojan × 29 · vless × 6 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 5
