...
![nodes](https://img.shields.io/badge/nodes-98-brightgreen) ![alive](https://img.shields.io/badge/alive-1888-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-351ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_08:37_UTC-informational)
...
- **Median RTT**: 351 ms
- **Last updated (UTC)**: 2026-06-13 08:37 UTC

**Protocol mix:** shadowsocks × 49 · trojan × 25 · vless × 16 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 11 · `surfboard-eternity` × 3
