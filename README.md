...
![nodes](https://img.shields.io/badge/nodes-78-brightgreen) ![alive](https://img.shields.io/badge/alive-2128-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-270ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-09_15:19_UTC-informational)
...
- **Median RTT**: 270 ms
- **Last updated (UTC)**: 2026-06-09 15:19 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 15 · vless × 8 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 6
