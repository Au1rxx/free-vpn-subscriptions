...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2407-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-135ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-11_09:33_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2407
- **Fastest node RTT**: 29 ms
- **Median RTT**: 135 ms
- **Last updated (UTC)**: 2026-05-11 09:33 UTC

**Protocol mix:** shadowsocks × 46 · trojan × 4 · vless × 92 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 5
