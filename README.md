...
![nodes](https://img.shields.io/badge/nodes-82-brightgreen) ![alive](https://img.shields.io/badge/alive-1947-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-120ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-03_19:28_UTC-informational)
...
- **Median RTT**: 120 ms
- **Last updated (UTC)**: 2026-06-03 19:28 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 31 · vless × 15 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `mahdi0024` × 14 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 6 · `pawdroid` × 1 · `surfboard-eternity` × 3
