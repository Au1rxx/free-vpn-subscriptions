...
![nodes](https://img.shields.io/badge/nodes-134-brightgreen) ![alive](https://img.shields.io/badge/alive-1915-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-349ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_03:20_UTC-informational)
...
- **Median RTT**: 349 ms
- **Last updated (UTC)**: 2026-07-06 03:20 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 54 · trojan × 33 · vless × 17 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 5 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 3
