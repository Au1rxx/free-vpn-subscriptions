...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-1785-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-365ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_13:16_UTC-informational)
...
- **Median RTT**: 365 ms
- **Last updated (UTC)**: 2026-07-07 13:16 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 59 · trojan × 22 · vless × 10 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 7 · `ruking-clash` × 3 · `surfboard-eternity` × 1
