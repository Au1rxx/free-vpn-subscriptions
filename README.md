...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-1829-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-377ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-16_11:15_UTC-informational)
...
- **Median RTT**: 377 ms
- **Last updated (UTC)**: 2026-06-16 11:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 55 · trojan × 24 · vless × 20 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 23 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 7 · `surfboard-eternity` × 3
