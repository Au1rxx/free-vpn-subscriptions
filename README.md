...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1923-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-222ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_03:14_UTC-informational)
...
- **Median RTT**: 222 ms
- **Last updated (UTC)**: 2026-06-22 03:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 47 · trojan × 10 · vless × 79 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 41 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 18 · `snakem982` × 2 · `surfboard-eternity` × 3
