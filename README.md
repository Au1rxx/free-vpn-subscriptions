...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2385-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-93ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-21_03:27_UTC-informational)
...
- **Median RTT**: 93 ms
- **Last updated (UTC)**: 2026-05-21 03:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 13 · vless × 81 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
