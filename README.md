...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2182-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-89ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-02_07:17_UTC-informational)
...
- **Median RTT**: 89 ms
- **Last updated (UTC)**: 2026-05-02 07:17 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 7 · vless × 92 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 58 · `pawdroid` × 4 · `surfboard-eternity` × 8
