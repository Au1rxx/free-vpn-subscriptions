...
![nodes](https://img.shields.io/badge/nodes-146-brightgreen) ![alive](https://img.shields.io/badge/alive-2072-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-362ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_03:13_UTC-informational)
...
- **Median RTT**: 362 ms
- **Last updated (UTC)**: 2026-06-23 03:13 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 27 · vless × 63 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 52 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 23 · `pawdroid` × 1 · `ruking-clash` × 18 · `surfboard-eternity` × 3
