...
![nodes](https://img.shields.io/badge/nodes-113-brightgreen) ![alive](https://img.shields.io/badge/alive-1940-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-251ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_08:37_UTC-informational)
...
- **Median RTT**: 251 ms
- **Last updated (UTC)**: 2026-07-12 08:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 51 · trojan × 17 · vless × 25 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 9 · `mfuu-clash` × 4 · `ninjastrikers` × 19 · `pawdroid` × 8 · `snakem982` × 1 · `surfboard-eternity` × 5
