...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2491-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-98ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_04:25_UTC-informational)
...
- **Median RTT**: 98 ms
- **Last updated (UTC)**: 2026-05-10 04:25 UTC

**Protocol mix:** shadowsocks × 47 · trojan × 3 · vless × 91 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 34 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 60 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 6
