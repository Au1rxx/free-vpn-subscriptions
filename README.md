...
![nodes](https://img.shields.io/badge/nodes-106-brightgreen) ![alive](https://img.shields.io/badge/alive-1965-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-488ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_14:22_UTC-informational)
...
- **Nodes selected**: 106
- **Alive across all sources**: 1965
- **Fastest node RTT**: 28 ms
- **Median RTT**: 488 ms
- **Last updated (UTC)**: 2026-06-18 14:22 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 29 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 25 · `snakem982` × 7 · `surfboard-eternity` × 2
