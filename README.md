...
![nodes](https://img.shields.io/badge/nodes-72-brightgreen) ![alive](https://img.shields.io/badge/alive-2128-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-167ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_20:12_UTC-informational)
...
- **Median RTT**: 167 ms
- **Last updated (UTC)**: 2026-06-06 20:12 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 15 · vless × 7 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 5
