...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2465-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-140ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_11:32_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2465
- **Fastest node RTT**: 28 ms
- **Median RTT**: 140 ms
- **Last updated (UTC)**: 2026-05-10 11:32 UTC

**Protocol mix:** shadowsocks × 51 · trojan × 4 · vless × 85 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 8
