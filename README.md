...
![nodes](https://img.shields.io/badge/nodes-81-brightgreen) ![alive](https://img.shields.io/badge/alive-1751-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-317ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_13:32_UTC-informational)
...
- **Median RTT**: 317 ms
- **Last updated (UTC)**: 2026-06-08 13:32 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 43 · trojan × 19 · vless × 12 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 4 · `surfboard-eternity` × 4
