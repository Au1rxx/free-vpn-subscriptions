...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2025-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-168ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_11:22_UTC-informational)
...
- **Median RTT**: 168 ms
- **Last updated (UTC)**: 2026-05-07 11:22 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 9 · vless × 88 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 69 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
