...
![nodes](https://img.shields.io/badge/nodes-100-brightgreen) ![alive](https://img.shields.io/badge/alive-1973-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-251ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_16:39_UTC-informational)
...
- **Median RTT**: 251 ms
- **Last updated (UTC)**: 2026-07-05 16:39 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 36 · trojan × 25 · vless × 8 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 6 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 2
