...
![nodes](https://img.shields.io/badge/nodes-72-brightgreen) ![alive](https://img.shields.io/badge/alive-2517-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-113ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-01_22:34_UTC-informational)
...
- **Nodes selected**: 72
- **Alive across all sources**: 2517
- **Fastest node RTT**: 33 ms
- **Median RTT**: 113 ms
- **Last updated (UTC)**: 2026-06-01 22:34 UTC

**Protocol mix:** shadowsocks × 16 · trojan × 31 · vless × 3 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 13 · `mahdi0024` × 17 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `surfboard-eternity` × 3
