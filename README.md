...
![nodes](https://img.shields.io/badge/nodes-99-brightgreen) ![alive](https://img.shields.io/badge/alive-1991-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-343ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-10_21:30_UTC-informational)
...
- **Median RTT**: 343 ms
- **Last updated (UTC)**: 2026-06-10 21:30 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 18 · vless × 14 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
