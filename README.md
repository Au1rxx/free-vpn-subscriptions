...
![nodes](https://img.shields.io/badge/nodes-92-brightgreen) ![alive](https://img.shields.io/badge/alive-2142-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-178ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_15:17_UTC-informational)
...
- **Median RTT**: 178 ms
- **Last updated (UTC)**: 2026-06-06 15:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 29 · trojan × 29 · vless × 10 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 15 · `mahdi0024` × 35 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 1
