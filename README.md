...
![nodes](https://img.shields.io/badge/nodes-96-brightgreen) ![alive](https://img.shields.io/badge/alive-1858-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-155ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-04_23:10_UTC-informational)
...
- **Median RTT**: 155 ms
- **Last updated (UTC)**: 2026-06-04 23:10 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 35 · vless × 20 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 17 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 6
