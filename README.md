...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-2288-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-89ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-31_04:33_UTC-informational)
...
- **Nodes selected**: 94
- **Alive across all sources**: 2288
- **Fastest node RTT**: 30 ms
- **Median RTT**: 89 ms
- **Last updated (UTC)**: 2026-05-31 04:33 UTC

**Protocol mix:** shadowsocks × 15 · trojan × 27 · vless × 27 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 28 · `pawdroid` × 1 · `surfboard-eternity` × 2
