...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2266-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-386ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_02:16_UTC-informational)
...
- **Median RTT**: 386 ms
- **Last updated (UTC)**: 2026-07-18 02:16 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 77 · vless × 18 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 8 · `mahdi0024` × 60 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 6 · `snakem982` × 5 · `surfboard-eternity` × 5
