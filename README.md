...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2235-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-142ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_04:14_UTC-informational)
...
- **Median RTT**: 142 ms
- **Last updated (UTC)**: 2026-04-22 04:14 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 3 · vless × 102 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 38 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 67 · `ruking-clash` × 5 · `surfboard-eternity` × 6
