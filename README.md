...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2266-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-112ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_11:15_UTC-informational)
...
- **Median RTT**: 112 ms
- **Last updated (UTC)**: 2026-05-03 11:15 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 15 · vless × 99 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 61 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
