...
![nodes](https://img.shields.io/badge/nodes-79-brightgreen) ![alive](https://img.shields.io/badge/alive-2109-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-568ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-28_21:21_UTC-informational)
...
- **Median RTT**: 568 ms
- **Last updated (UTC)**: 2026-06-28 21:21 UTC

**Protocol mix:** shadowsocks × 16 · trojan × 30 · vless × 18 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 3
