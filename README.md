...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2175-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-99ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_04:36_UTC-informational)
...
- **Median RTT**: 99 ms
- **Last updated (UTC)**: 2026-04-26 04:36 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 10 · vless × 102 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 26 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 73 · `pawdroid` × 3 · `surfboard-eternity` × 4
