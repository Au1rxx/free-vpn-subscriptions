...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2478-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-384ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_18:35_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2478
- **Fastest node RTT**: 30 ms
- **Median RTT**: 384 ms
- **Last updated (UTC)**: 2026-07-18 18:35 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 34 · trojan × 94 · vless × 14 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 36 · `mahdibland-shadowsocks` × 34 · `matin-v2ray` × 4 · `ninjastrikers` × 6 · `pawdroid` × 10 · `ruking-clash` × 2 · `snakem982` × 13 · `surfboard-eternity` × 5
