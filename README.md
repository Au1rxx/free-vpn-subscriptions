...
![nodes](https://img.shields.io/badge/nodes-78-brightgreen) ![alive](https://img.shields.io/badge/alive-1898-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-156ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-03_12:29_UTC-informational)
...
- **Median RTT**: 156 ms
- **Last updated (UTC)**: 2026-07-03 12:29 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 20 · vless × 11 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
