...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2001-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-371ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_00:37_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2001
- **Fastest node RTT**: 37 ms
- **Median RTT**: 371 ms
- **Last updated (UTC)**: 2026-06-23 00:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 28 · vless × 66 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 56 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 1
