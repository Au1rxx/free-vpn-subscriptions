...
![nodes](https://img.shields.io/badge/nodes-84-brightgreen) ![alive](https://img.shields.io/badge/alive-2253-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-168ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_07:21_UTC-informational)
...
- **Median RTT**: 168 ms
- **Last updated (UTC)**: 2026-06-07 07:21 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 20 · vless × 12 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 1
