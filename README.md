...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-1925-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-241ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_13:13_UTC-informational)
...
- **Median RTT**: 241 ms
- **Last updated (UTC)**: 2026-07-12 13:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 59 · trojan × 14 · vless × 11 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 2
