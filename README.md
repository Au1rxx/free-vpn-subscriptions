...
![nodes](https://img.shields.io/badge/nodes-129-brightgreen) ![alive](https://img.shields.io/badge/alive-2268-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-84ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-18_20:37_UTC-informational)
...
- **Nodes selected**: 129
- **Alive across all sources**: 2268
- **Fastest node RTT**: 34 ms
- **Median RTT**: 84 ms
- **Last updated (UTC)**: 2026-05-18 20:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 16 · trojan × 25 · vless × 68 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `ruking-clash` × 7 · `surfboard-eternity` × 4
