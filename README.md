...
![nodes](https://img.shields.io/badge/nodes-106-brightgreen) ![alive](https://img.shields.io/badge/alive-2224-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-161ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_01:38_UTC-informational)
...
- **Median RTT**: 161 ms
- **Last updated (UTC)**: 2026-06-07 01:38 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 23 · vless × 29 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 39 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 32 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 2
