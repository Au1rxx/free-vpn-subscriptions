...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2640-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-76ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-17_09:13_UTC-informational)
...
- **Median RTT**: 76 ms
- **Last updated (UTC)**: 2026-05-17 09:13 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 4 · vless × 98 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 5 · `epodonios` × 2 · `lagzian-mix` × 5 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 60 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 4
