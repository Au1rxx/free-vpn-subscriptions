...
![nodes](https://img.shields.io/badge/nodes-124-brightgreen) ![alive](https://img.shields.io/badge/alive-2059-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-406ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_07:27_UTC-informational)
...
- **Median RTT**: 406 ms
- **Last updated (UTC)**: 2026-06-23 07:27 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 31 · vless × 47 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 45 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 3
