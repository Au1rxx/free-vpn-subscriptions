...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-1876-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-299ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-09_04:14_UTC-informational)
...
- **Median RTT**: 299 ms
- **Last updated (UTC)**: 2026-06-09 04:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 46 · trojan × 22 · vless × 25 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 27 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 5
