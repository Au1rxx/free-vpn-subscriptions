...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2079-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-157ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_23:34_UTC-informational)
...
- **Median RTT**: 157 ms
- **Last updated (UTC)**: 2026-05-01 23:34 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 15 · vless × 85 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 53 · `pawdroid` × 1 · `surfboard-eternity` × 9
