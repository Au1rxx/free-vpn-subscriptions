...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-1911-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-325ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_05:15_UTC-informational)
...
- **Median RTT**: 325 ms
- **Last updated (UTC)**: 2026-06-13 05:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 51 · trojan × 22 · vless × 30 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 31 · `pawdroid` × 6 · `ruking-clash` × 10 · `surfboard-eternity` × 3
