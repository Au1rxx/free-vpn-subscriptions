...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2451-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-86ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-15_12:26_UTC-informational)
...
- **Median RTT**: 86 ms
- **Last updated (UTC)**: 2026-05-15 12:26 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 18 · vless × 82 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 6 · `ruking-clash` × 3 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
