...
![nodes](https://img.shields.io/badge/nodes-139-brightgreen) ![alive](https://img.shields.io/badge/alive-2208-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-157ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-28_16:39_UTC-informational)
...
- **Nodes selected**: 139
- **Alive across all sources**: 2208
- **Fastest node RTT**: 37 ms
- **Median RTT**: 157 ms
- **Last updated (UTC)**: 2026-04-28 16:39 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 21 · vless × 78 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 52 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
