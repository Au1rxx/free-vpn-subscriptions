...
![nodes](https://img.shields.io/badge/nodes-110-brightgreen) ![alive](https://img.shields.io/badge/alive-1938-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-288ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-11_23:16_UTC-informational)
...
- **Median RTT**: 288 ms
- **Last updated (UTC)**: 2026-07-11 23:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 58 · trojan × 15 · vless × 19 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 8 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 5
