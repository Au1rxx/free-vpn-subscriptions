...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2246-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-149ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_21:14_UTC-informational)
...
- **Median RTT**: 149 ms
- **Last updated (UTC)**: 2026-04-25 21:14 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 13 · vless × 87 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 35 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 1 · `ninjastrikers` × 54 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 6
