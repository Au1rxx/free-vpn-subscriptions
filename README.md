...
![nodes](https://img.shields.io/badge/nodes-60-brightgreen) ![alive](https://img.shields.io/badge/alive-1971-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-134ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-27_18:22_UTC-informational)
...
- **Median RTT**: 134 ms
- **Last updated (UTC)**: 2026-05-27 18:22 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 11 · vless × 19 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 1 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 4 · `ruking-clash` × 7 · `snakem982` × 1 · `surfboard-eternity` × 3
