...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2244-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-142ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_05:30_UTC-informational)
...
- **Median RTT**: 142 ms
- **Last updated (UTC)**: 2026-04-22 05:30 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 2 · vless × 98 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 40 · `epodonios` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 62 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 9
