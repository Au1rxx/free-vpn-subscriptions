...
![nodes](https://img.shields.io/badge/nodes-125-brightgreen) ![alive](https://img.shields.io/badge/alive-1836-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-408ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-15_18:11_UTC-informational)
...
- **Median RTT**: 408 ms
- **Last updated (UTC)**: 2026-06-15 18:11 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 53 · trojan × 23 · vless × 34 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 22 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 19 · `surfboard-eternity` × 1
