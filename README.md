...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1888-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-281ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-11_20:29_UTC-informational)
...
- **Median RTT**: 281 ms
- **Last updated (UTC)**: 2026-05-11 20:29 UTC

**Protocol mix:** shadowsocks × 73 · trojan × 2 · vless × 63 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 7 · `mahdi0024` × 5 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 3 · `ninjastrikers` × 44 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
