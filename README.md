...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2021-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-394ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-16_12:26_UTC-informational)
...
- **Median RTT**: 394 ms
- **Last updated (UTC)**: 2026-07-16 12:26 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 53 · trojan × 72 · vless × 14 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 7 · `mahdi0024` × 11 · `mahdibland-aggregator` × 44 · `mahdibland-shadowsocks` × 38 · `matin-v2ray` × 4 · `mfuu-clash` × 5 · `ninjastrikers` × 9 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 8 · `surfboard-eternity` × 4
