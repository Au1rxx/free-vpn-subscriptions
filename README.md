...
![nodes](https://img.shields.io/badge/nodes-79-brightgreen) ![alive](https://img.shields.io/badge/alive-2430-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-70ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-03_09:17_UTC-informational)
...
- **Median RTT**: 70 ms
- **Last updated (UTC)**: 2026-06-03 09:17 UTC

**Protocol mix:** shadowsocks × 13 · trojan × 38 · vless × 5 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 23 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `surfboard-eternity` × 2
