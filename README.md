...
![nodes](https://img.shields.io/badge/nodes-90-brightgreen) ![alive](https://img.shields.io/badge/alive-1947-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-280ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_20:34_UTC-informational)
...
- **Median RTT**: 280 ms
- **Last updated (UTC)**: 2026-06-26 20:34 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 29 · vless × 14 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `mahdi0024` × 16 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `ruking-clash` × 17 · `surfboard-eternity` × 5
