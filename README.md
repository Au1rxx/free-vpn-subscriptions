...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-2059-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-229ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_19:10_UTC-informational)
...
- **Nodes selected**: 115
- **Alive across all sources**: 2059
- **Fastest node RTT**: 27 ms
- **Median RTT**: 229 ms
- **Last updated (UTC)**: 2026-07-12 19:10 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 67 · trojan × 9 · vless × 24 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 37 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 8 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3
