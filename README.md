...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1857-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-471ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_15:32_UTC-informational)
...
- **Median RTT**: 471 ms
- **Last updated (UTC)**: 2026-06-22 15:32 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 31 · vless × 66 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 41 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 2 · `surfboard-eternity` × 3
