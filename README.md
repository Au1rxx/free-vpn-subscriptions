...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-1991-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-306ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_17:33_UTC-informational)
...
- **Median RTT**: 306 ms
- **Last updated (UTC)**: 2026-07-05 17:33 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 26 · vless × 11 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 6 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 2
