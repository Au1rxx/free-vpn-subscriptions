...
![nodes](https://img.shields.io/badge/nodes-120-brightgreen) ![alive](https://img.shields.io/badge/alive-1918-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-352ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-14_01:22_UTC-informational)
...
- **Median RTT**: 352 ms
- **Last updated (UTC)**: 2026-07-14 01:22 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 25 · vless × 23 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 7 · `ninjastrikers` × 22 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 5
