...
![nodes](https://img.shields.io/badge/nodes-82-brightgreen) ![alive](https://img.shields.io/badge/alive-2147-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-173ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-28_17:16_UTC-informational)
...
- **Median RTT**: 173 ms
- **Last updated (UTC)**: 2026-06-28 17:16 UTC

**Protocol mix:** shadowsocks × 18 · trojan × 27 · vless × 20 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 3
