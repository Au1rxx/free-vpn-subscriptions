...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2118-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-117ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_00:39_UTC-informational)
...
- **Median RTT**: 117 ms
- **Last updated (UTC)**: 2026-04-30 00:39 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 4 · vless × 96 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 31 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 70 · `snakem982` × 1 · `surfboard-eternity` × 5
