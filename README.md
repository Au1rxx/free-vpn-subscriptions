...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2447-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-131ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_20:24_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2447
- **Fastest node RTT**: 32 ms
- **Median RTT**: 131 ms
- **Last updated (UTC)**: 2026-04-27 20:24 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 21 · vless × 90 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 31 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 50 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7
