...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2175-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-90ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_10:11_UTC-informational)
...
- **Median RTT**: 90 ms
- **Last updated (UTC)**: 2026-05-01 10:11 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 6 · vless × 90 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `surfboard-eternity` × 5
