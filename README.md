...
![nodes](https://img.shields.io/badge/nodes-106-brightgreen) ![alive](https://img.shields.io/badge/alive-1894-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-367ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-14_11:11_UTC-informational)
...
- **Median RTT**: 367 ms
- **Last updated (UTC)**: 2026-07-14 11:11 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 44 · trojan × 22 · vless × 11 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 4
