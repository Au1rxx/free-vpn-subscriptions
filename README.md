...
![nodes](https://img.shields.io/badge/nodes-138-brightgreen) ![alive](https://img.shields.io/badge/alive-2690-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-177ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_23:28_UTC-informational)
...
- **Nodes selected**: 138
- **Alive across all sources**: 2690
- **Fastest node RTT**: 28 ms
- **Median RTT**: 177 ms
- **Last updated (UTC)**: 2026-04-24 23:28 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 22 · vless × 77 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 46 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
