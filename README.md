...
![nodes](https://img.shields.io/badge/nodes-123-brightgreen) ![alive](https://img.shields.io/badge/alive-2090-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-281ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_15:22_UTC-informational)
...
- **Median RTT**: 281 ms
- **Last updated (UTC)**: 2026-07-12 15:22 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 62 · trojan × 20 · vless × 27 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 16 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 6 · `surfboard-eternity` × 4
