...
![nodes](https://img.shields.io/badge/nodes-91-brightgreen) ![alive](https://img.shields.io/badge/alive-1918-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-309ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-13_19:17_UTC-informational)
...
- **Median RTT**: 309 ms
- **Last updated (UTC)**: 2026-07-13 19:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 11 · vless × 11 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `mahdi0024` × 26 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 6 · `ninjastrikers` × 7 · `pawdroid` × 2 · `ruking-clash` × 1
