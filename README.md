...
![nodes](https://img.shields.io/badge/nodes-129-brightgreen) ![alive](https://img.shields.io/badge/alive-2081-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-91ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-26_16:24_UTC-informational)
...
- **Median RTT**: 91 ms
- **Last updated (UTC)**: 2026-05-26 16:24 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 21 · vless × 65 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 45 · `pawdroid` × 8 · `ruking-clash` × 14 · `surfboard-eternity` × 2 · `vxiaov-clash` × 2
