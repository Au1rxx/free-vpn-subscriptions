...
![nodes](https://img.shields.io/badge/nodes-73-brightgreen) ![alive](https://img.shields.io/badge/alive-2148-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-159ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-30_12:28_UTC-informational)
...
- **Median RTT**: 159 ms
- **Last updated (UTC)**: 2026-05-30 12:28 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 12 · vless × 8 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 4 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
