...
![nodes](https://img.shields.io/badge/nodes-84-brightgreen) ![alive](https://img.shields.io/badge/alive-1983-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-175ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-03_18:14_UTC-informational)
...
- **Median RTT**: 175 ms
- **Last updated (UTC)**: 2026-07-03 18:14 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 24 · vless × 14 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 11 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
