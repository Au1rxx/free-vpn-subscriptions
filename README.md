...
![nodes](https://img.shields.io/badge/nodes-69-brightgreen) ![alive](https://img.shields.io/badge/alive-2000-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-175ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-04_11:13_UTC-informational)
...
- **Median RTT**: 175 ms
- **Last updated (UTC)**: 2026-07-04 11:13 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 15 · vless × 6 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 5 · `ninjastrikers` × 6 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
