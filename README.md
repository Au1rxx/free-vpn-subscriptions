...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-1811-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-352ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-08_02:35_UTC-informational)
...
- **Median RTT**: 352 ms
- **Last updated (UTC)**: 2026-07-08 02:35 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 55 · trojan × 32 · vless × 23 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 7 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 2
