...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-1899-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-102ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-05_00:10_UTC-informational)
...
- **Median RTT**: 102 ms
- **Last updated (UTC)**: 2026-06-05 00:10 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 32 · vless × 39 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 28 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 30 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6
