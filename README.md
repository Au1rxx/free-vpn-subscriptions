...
![nodes](https://img.shields.io/badge/nodes-79-brightgreen) ![alive](https://img.shields.io/badge/alive-2245-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-159ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-31_12:30_UTC-informational)
...
- **Median RTT**: 159 ms
- **Last updated (UTC)**: 2026-05-31 12:30 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 23 · trojan × 21 · vless × 7 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
