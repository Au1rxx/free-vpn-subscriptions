...
![nodes](https://img.shields.io/badge/nodes-142-brightgreen) ![alive](https://img.shields.io/badge/alive-2067-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-406ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_06:16_UTC-informational)
...
- **Nodes selected**: 142
- **Alive across all sources**: 2067
- **Fastest node RTT**: 28 ms
- **Median RTT**: 406 ms
- **Last updated (UTC)**: 2026-06-23 06:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 29 · vless × 61 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 51 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 4
