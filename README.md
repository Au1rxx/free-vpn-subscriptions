...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2360-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-73ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-23_06:38_UTC-informational)
...
- **Median RTT**: 73 ms
- **Last updated (UTC)**: 2026-05-23 06:38 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 7 · vless × 100 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 19 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 70 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
