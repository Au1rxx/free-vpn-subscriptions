...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1935-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-257ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_02:30_UTC-informational)
...
- **Median RTT**: 257 ms
- **Last updated (UTC)**: 2026-06-22 02:30 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 44 · trojan × 15 · vless × 78 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 39 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 16 · `snakem982` × 5 · `surfboard-eternity` × 2
