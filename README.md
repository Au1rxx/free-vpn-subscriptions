...
![nodes](https://img.shields.io/badge/nodes-85-brightgreen) ![alive](https://img.shields.io/badge/alive-2101-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-241ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-09_23:15_UTC-informational)
...
- **Median RTT**: 241 ms
- **Last updated (UTC)**: 2026-06-09 23:15 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 18 · vless × 8 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 7
