...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2025-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-145ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_01:31_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2025
- **Fastest node RTT**: 35 ms
- **Median RTT**: 145 ms
- **Last updated (UTC)**: 2026-05-07 01:31 UTC

**Protocol mix:** shadowsocks × 50 · trojan × 4 · vless × 84 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
