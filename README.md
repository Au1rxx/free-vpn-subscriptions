...
![nodes](https://img.shields.io/badge/nodes-118-brightgreen) ![alive](https://img.shields.io/badge/alive-2089-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-407ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-24_21:11_UTC-informational)
...
- **Median RTT**: 407 ms
- **Last updated (UTC)**: 2026-06-24 21:11 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 34 · vless × 33 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 37 · `mahdi0024` × 16 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 14 · `surfboard-eternity` × 5
