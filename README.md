...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2242-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-172ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_23:20_UTC-informational)
...
- **Median RTT**: 172 ms
- **Last updated (UTC)**: 2026-04-25 23:20 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 16 · vless × 87 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 36 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 50 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 5
