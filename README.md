...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1904-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-310ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_23:23_UTC-informational)
...
- **Median RTT**: 310 ms
- **Last updated (UTC)**: 2026-05-07 23:23 UTC

**Protocol mix:** shadowsocks × 51 · trojan × 22 · vless × 68 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 9
