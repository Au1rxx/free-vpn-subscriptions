...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2455-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-78ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-18_12:37_UTC-informational)
...
- **Median RTT**: 78 ms
- **Last updated (UTC)**: 2026-05-18 12:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 8 · vless × 89 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 40 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 53 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
