...
![nodes](https://img.shields.io/badge/nodes-103-brightgreen) ![alive](https://img.shields.io/badge/alive-1683-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-487ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_11:37_UTC-informational)
...
- **Median RTT**: 487 ms
- **Last updated (UTC)**: 2026-06-14 11:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 31 · vless × 15 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 2 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 6
