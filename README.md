...
![nodes](https://img.shields.io/badge/nodes-138-brightgreen) ![alive](https://img.shields.io/badge/alive-1815-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-387ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-15_19:09_UTC-informational)
...
- **Median RTT**: 387 ms
- **Last updated (UTC)**: 2026-07-15 19:09 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 72 · trojan × 34 · vless × 19 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `mahdi0024` × 23 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 3 · `ninjastrikers` × 15 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 3
