...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2314-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-402ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-17_20:19_UTC-informational)
...
- **Median RTT**: 402 ms
- **Last updated (UTC)**: 2026-07-17 20:19 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 107 · vless × 8 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 60 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 29 · `matin-v2ray` × 1 · `ninjastrikers` × 2 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 16 · `surfboard-eternity` × 5
