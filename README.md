...
![nodes](https://img.shields.io/badge/nodes-83-brightgreen) ![alive](https://img.shields.io/badge/alive-2366-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-97ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_20:22_UTC-informational)
...
- **Median RTT**: 97 ms
- **Last updated (UTC)**: 2026-06-02 20:22 UTC

**Protocol mix:** shadowsocks × 20 · trojan × 26 · vless × 6 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 15 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 8 · `snakem982` × 1 · `surfboard-eternity` × 6
