...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-1693-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-517ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_13:19_UTC-informational)
...
- **Median RTT**: 517 ms
- **Last updated (UTC)**: 2026-06-14 13:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 52 · trojan × 30 · vless × 14 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `mahdi0024` × 7 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 15 · `surfboard-eternity` × 5
