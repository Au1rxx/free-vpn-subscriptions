...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2378-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-107ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_22:17_UTC-informational)
...
- **Median RTT**: 107 ms
- **Last updated (UTC)**: 2026-05-12 22:17 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 16 · vless × 87 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 40 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 47 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
