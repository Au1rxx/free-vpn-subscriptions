...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-1869-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-343ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_20:31_UTC-informational)
...
- **Median RTT**: 343 ms
- **Last updated (UTC)**: 2026-07-05 20:31 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 48 · trojan × 24 · vless × 9 · vmess × 30

**Sources used this run:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 2
