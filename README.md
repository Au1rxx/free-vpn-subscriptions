...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2238-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-92ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_05:26_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2238
- **Fastest node RTT**: 30 ms
- **Median RTT**: 92 ms
- **Last updated (UTC)**: 2026-05-01 05:26 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 7 · vless × 93 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
