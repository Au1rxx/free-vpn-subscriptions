...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2619-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-76ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-17_16:25_UTC-informational)
...
- **Median RTT**: 76 ms
- **Last updated (UTC)**: 2026-05-17 16:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 43 · trojan × 6 · vless × 94 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 4 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 42 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 49 · `pawdroid` × 2 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 4
