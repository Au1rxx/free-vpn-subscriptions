...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2290-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-398ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-17_17:34_UTC-informational)
...
- **Median RTT**: 398 ms
- **Last updated (UTC)**: 2026-07-17 17:34 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 96 · vless × 17 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 3 · `mahdi0024` × 63 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 2 · `ninjastrikers` × 4 · `pawdroid` × 9 · `ruking-clash` × 3 · `snakem982` × 15 · `surfboard-eternity` × 7
