...
![nodes](https://img.shields.io/badge/nodes-101-brightgreen) ![alive](https://img.shields.io/badge/alive-1924-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-403ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-25_16:25_UTC-informational)
...
- **Median RTT**: 403 ms
- **Last updated (UTC)**: 2026-06-25 16:25 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 37 · vless × 19 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 18 · `surfboard-eternity` × 2
