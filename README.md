...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2264-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-165ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_20:12_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2264
- **Fastest node RTT**: 29 ms
- **Median RTT**: 165 ms
- **Last updated (UTC)**: 2026-04-25 20:12 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 22 · vless × 79 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 55 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
