...
![nodes](https://img.shields.io/badge/nodes-136-brightgreen) ![alive](https://img.shields.io/badge/alive-1893-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-478ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_11:39_UTC-informational)
...
- **Median RTT**: 478 ms
- **Last updated (UTC)**: 2026-06-22 11:39 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 43 · trojan × 29 · vless × 50 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 30 · `snakem982` × 3 · `surfboard-eternity` × 3
