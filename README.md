...
![nodes](https://img.shields.io/badge/nodes-89-brightgreen) ![alive](https://img.shields.io/badge/alive-1877-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-365ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_14:16_UTC-informational)
...
- **Median RTT**: 365 ms
- **Last updated (UTC)**: 2026-06-07 14:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 48 · trojan × 20 · vless × 14 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 5
