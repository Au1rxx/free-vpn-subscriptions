...
![nodes](https://img.shields.io/badge/nodes-87-brightgreen) ![alive](https://img.shields.io/badge/alive-2242-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-235ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-29_04:29_UTC-informational)
...
- **Median RTT**: 235 ms
- **Last updated (UTC)**: 2026-06-29 04:29 UTC

**Protocol mix:** shadowsocks × 17 · trojan × 30 · vless × 27 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 8 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 3
