...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2451-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-83ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-14_13:16_UTC-informational)
...
- **Median RTT**: 83 ms
- **Last updated (UTC)**: 2026-05-14 13:16 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 12 · vless × 88 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 8 · `surfboard-eternity` × 7
