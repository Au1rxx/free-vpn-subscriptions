...
![nodes](https://img.shields.io/badge/nodes-70-brightgreen) ![alive](https://img.shields.io/badge/alive-2103-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-154ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-10_11:23_UTC-informational)
...
- **Median RTT**: 154 ms
- **Last updated (UTC)**: 2026-07-10 11:23 UTC

**Protocol mix:** shadowsocks × 20 · trojan × 9 · vless × 14 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 5 · `ninjastrikers` × 12 · `pawdroid` × 2
