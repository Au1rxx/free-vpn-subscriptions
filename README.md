...
![nodes](https://img.shields.io/badge/nodes-145-brightgreen) ![alive](https://img.shields.io/badge/alive-1942-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-418ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_23:32_UTC-informational)
...
- **Median RTT**: 418 ms
- **Last updated (UTC)**: 2026-06-21 23:32 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 32 · vless × 52 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 5 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 34 · `snakem982` × 2 · `surfboard-eternity` × 3
