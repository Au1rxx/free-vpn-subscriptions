...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2206-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-172ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_21:37_UTC-informational)
...
- **Median RTT**: 172 ms
- **Last updated (UTC)**: 2026-04-30 21:37 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 20 · vless × 78 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 45 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 44 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
