...
![nodes](https://img.shields.io/badge/nodes-76-brightgreen) ![alive](https://img.shields.io/badge/alive-2177-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-163ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-05_21:19_UTC-informational)
...
- **Median RTT**: 163 ms
- **Last updated (UTC)**: 2026-06-05 21:19 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 26 · vless × 9 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `snakem982` × 1 · `surfboard-eternity` × 1
