...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2176-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-146ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_10:38_UTC-informational)
...
- **Median RTT**: 146 ms
- **Last updated (UTC)**: 2026-04-21 10:38 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 4 · vless × 102 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 50 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 6
