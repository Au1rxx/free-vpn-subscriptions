...
![nodes](https://img.shields.io/badge/nodes-84-brightgreen) ![alive](https://img.shields.io/badge/alive-2007-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-264ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_18:36_UTC-informational)
...
- **Median RTT**: 264 ms
- **Last updated (UTC)**: 2026-06-26 18:36 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 28 · vless × 15 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 5
