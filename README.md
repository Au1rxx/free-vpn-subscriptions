...
![nodes](https://img.shields.io/badge/nodes-142-brightgreen) ![alive](https://img.shields.io/badge/alive-1987-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-277ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-13_00:27_UTC-informational)
...
- **Median RTT**: 277 ms
- **Last updated (UTC)**: 2026-07-13 00:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 72 · trojan × 27 · vless × 26 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 29 · `mahdibland-aggregator` × 31 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 7 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 5
