...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-1995-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-348ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_06:24_UTC-informational)
...
- **Median RTT**: 348 ms
- **Last updated (UTC)**: 2026-07-05 06:24 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 59 · trojan × 25 · vless × 12 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 41 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 4 · `ninjastrikers` × 18 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
