...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2276-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-151ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_01:36_UTC-informational)
...
- **Median RTT**: 151 ms
- **Last updated (UTC)**: 2026-04-21 01:36 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 3 · vless × 114 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 54 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 7
