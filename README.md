...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2586-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-106ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_15:21_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2586
- **Fastest node RTT**: 27 ms
- **Median RTT**: 106 ms
- **Last updated (UTC)**: 2026-04-26 15:21 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 4 · vless × 93 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 52 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 51 · `pawdroid` × 1 · `surfboard-eternity` × 6
