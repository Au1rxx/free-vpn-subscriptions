...
- **Nodes selected**: 2000
- **Alive across all sources**: 9572
- **Fastest node RTT**: 14 ms
- **Median RTT**: 645 ms
- **Last updated (UTC)**: 2026-08-15 22:27 UTC

**Protocol mix:** https × 1 · hysteria2 × 76 · shadowsocks × 137 · socks4 × 1 · trojan × 1016 · tuic × 2 · vless × 591 · vmess × 160 · wireguard × 16
