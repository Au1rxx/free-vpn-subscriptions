...
![nodes](https://img.shields.io/badge/nodes-114-brightgreen) ![alive](https://img.shields.io/badge/alive-1825-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-398ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-16_12:10_UTC-informational)
...
- **Median RTT**: 398 ms
- **Last updated (UTC)**: 2026-06-16 12:10 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 52 · trojan × 28 · vless × 19 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 5
