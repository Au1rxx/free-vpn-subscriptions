...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2094-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-101ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_05:33_UTC-informational)
...
- **Median RTT**: 101 ms
- **Last updated (UTC)**: 2026-04-29 05:33 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 8 · vless × 97 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 73 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 2 · `surfboard-eternity` × 8
