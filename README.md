...
![nodes](https://img.shields.io/badge/nodes-87-brightgreen) ![alive](https://img.shields.io/badge/alive-2344-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-90ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_23:16_UTC-informational)
...
- **Median RTT**: 90 ms
- **Last updated (UTC)**: 2026-06-02 23:16 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 29 · vless × 6 · vmess × 30

**Sources used this run:** `barry-far-v2ray` × 19 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `snakem982` × 1 · `surfboard-eternity` × 2
