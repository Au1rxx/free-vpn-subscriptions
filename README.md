...
![nodes](https://img.shields.io/badge/nodes-144-brightgreen) ![alive](https://img.shields.io/badge/alive-2513-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-128ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_14:13_UTC-informational)
...
- **Nodes selected**: 144
- **Alive across all sources**: 2513
- **Fastest node RTT**: 29 ms
- **Median RTT**: 128 ms
- **Last updated (UTC)**: 2026-04-24 14:13 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 21 · vless × 84 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 60 · `pawdroid` × 3 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
