...
![nodes](https://img.shields.io/badge/nodes-117-brightgreen) ![alive](https://img.shields.io/badge/alive-1800-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-360ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_11:37_UTC-informational)
...
- **Median RTT**: 360 ms
- **Last updated (UTC)**: 2026-07-07 11:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 61 · trojan × 23 · vless × 11 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 1
