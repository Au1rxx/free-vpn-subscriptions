...
![nodes](https://img.shields.io/badge/nodes-109-brightgreen) ![alive](https://img.shields.io/badge/alive-1916-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-277ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_17:13_UTC-informational)
...
- **Median RTT**: 277 ms
- **Last updated (UTC)**: 2026-07-06 17:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 46 · trojan × 26 · vless × 16 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 7 · `ninjastrikers` × 14 · `pawdroid` × 11 · `ruking-clash` × 1 · `surfboard-eternity` × 5
