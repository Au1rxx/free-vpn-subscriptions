...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2083-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-131ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_20:30_UTC-informational)
...
- **Median RTT**: 131 ms
- **Last updated (UTC)**: 2026-05-01 20:30 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 12 · vless × 86 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 32 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 8
