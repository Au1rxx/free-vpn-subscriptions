...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2249-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-89ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_09:39_UTC-informational)
...
- **Median RTT**: 89 ms
- **Last updated (UTC)**: 2026-05-03 09:39 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 13 · vless × 100 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 30 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
