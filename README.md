...
![nodes](https://img.shields.io/badge/nodes-144-brightgreen) ![alive](https://img.shields.io/badge/alive-1865-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-380ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-15_23:21_UTC-informational)
...
- **Median RTT**: 380 ms
- **Last updated (UTC)**: 2026-07-15 23:21 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 70 · trojan × 40 · vless × 19 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `mahdi0024` × 23 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 9 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 4
