...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-1880-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-408ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-29_16:21_UTC-informational)
...
- **Median RTT**: 408 ms
- **Last updated (UTC)**: 2026-06-29 16:21 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 33 · vless × 21 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
