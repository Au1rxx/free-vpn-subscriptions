...
![nodes](https://img.shields.io/badge/nodes-98-brightgreen) ![alive](https://img.shields.io/badge/alive-1865-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-335ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-09_06:23_UTC-informational)
...
- **Median RTT**: 335 ms
- **Last updated (UTC)**: 2026-06-09 06:23 UTC

**Protocol mix:** shadowsocks × 48 · trojan × 19 · vless × 20 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `mahdi0024` × 13 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 22 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 10 · `surfboard-eternity` × 3
