...
![nodes](https://img.shields.io/badge/nodes-106-brightgreen) ![alive](https://img.shields.io/badge/alive-1948-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-317ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_11:35_UTC-informational)
...
- **Median RTT**: 317 ms
- **Last updated (UTC)**: 2026-07-05 11:35 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 25 · vless × 8 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
