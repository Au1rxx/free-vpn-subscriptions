...
![nodes](https://img.shields.io/badge/nodes-88-brightgreen) ![alive](https://img.shields.io/badge/alive-2320-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-340ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_23:09_UTC-informational)
...
- **Median RTT**: 340 ms
- **Last updated (UTC)**: 2026-06-11 23:09 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 18 · vless × 15 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 6 · `surfboard-eternity` × 6
