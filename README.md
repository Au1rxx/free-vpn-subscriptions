...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2450-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-76ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_09:27_UTC-informational)
...
- **Median RTT**: 76 ms
- **Last updated (UTC)**: 2026-05-25 09:27 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 7 · vless × 78 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 37 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `ninjastrikers` × 62 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 5
