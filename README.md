...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2693-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-77ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-18_06:16_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2693
- **Fastest node RTT**: 27 ms
- **Median RTT**: 77 ms
- **Last updated (UTC)**: 2026-05-18 06:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 5 · vless × 97 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 64 · `pawdroid` × 6 · `ruking-clash` × 7 · `surfboard-eternity` × 3
