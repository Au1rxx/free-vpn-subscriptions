...
![nodes](https://img.shields.io/badge/nodes-118-brightgreen) ![alive](https://img.shields.io/badge/alive-1940-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-362ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-13_07:17_UTC-informational)
...
- **Median RTT**: 362 ms
- **Last updated (UTC)**: 2026-07-13 07:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 52 · trojan × 22 · vless × 29 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 30 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 5 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 1
