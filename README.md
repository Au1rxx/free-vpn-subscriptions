...
![nodes](https://img.shields.io/badge/nodes-81-brightgreen) ![alive](https://img.shields.io/badge/alive-2550-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-101ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_08:34_UTC-informational)
...
- **Median RTT**: 101 ms
- **Last updated (UTC)**: 2026-06-02 08:34 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 22 · trojan × 26 · vless × 11 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 6 · `snakem982` × 1
