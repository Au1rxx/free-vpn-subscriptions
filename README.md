...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2213-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-153ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_12:19_UTC-informational)
...
- **Median RTT**: 153 ms
- **Last updated (UTC)**: 2026-04-30 12:19 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 19 · vless × 87 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 40 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
