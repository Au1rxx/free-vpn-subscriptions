...
![nodes](https://img.shields.io/badge/nodes-83-brightgreen) ![alive](https://img.shields.io/badge/alive-2189-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-191ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_10:22_UTC-informational)
...
- **Median RTT**: 191 ms
- **Last updated (UTC)**: 2026-06-06 10:22 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 24 · vless × 19 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 26 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 5 · `surfboard-eternity` × 3
