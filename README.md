...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2234-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-105ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_00:28_UTC-informational)
...
- **Median RTT**: 105 ms
- **Last updated (UTC)**: 2026-05-01 00:28 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 5 · vless × 97 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 27 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 68 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
