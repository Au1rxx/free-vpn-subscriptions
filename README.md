...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2160-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-141ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_08:12_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2160
- **Fastest node RTT**: 36 ms
- **Median RTT**: 141 ms
- **Last updated (UTC)**: 2026-05-06 08:12 UTC

**Protocol mix:** shadowsocks × 44 · trojan × 6 · vless × 90 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 70 · `pawdroid` × 3 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
