...
![nodes](https://img.shields.io/badge/nodes-60-brightgreen) ![alive](https://img.shields.io/badge/alive-2066-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-166ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-28_21:30_UTC-informational)
...
- **Median RTT**: 166 ms
- **Last updated (UTC)**: 2026-05-28 21:30 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 24 · trojan × 19 · vless × 7 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 8 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
