...
![nodes](https://img.shields.io/badge/nodes-80-brightgreen) ![alive](https://img.shields.io/badge/alive-2071-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-162ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-29_08:34_UTC-informational)
...
- **Median RTT**: 162 ms
- **Last updated (UTC)**: 2026-05-29 08:34 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 30 · vless × 14 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 3 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 1 · `surfboard-eternity` × 4
