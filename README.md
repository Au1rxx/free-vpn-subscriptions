...
![nodes](https://img.shields.io/badge/nodes-120-brightgreen) ![alive](https://img.shields.io/badge/alive-1909-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-340ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-14_02:19_UTC-informational)
...
- **Median RTT**: 340 ms
- **Last updated (UTC)**: 2026-07-14 02:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 26 · vless × 24 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 29 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 7 · `ninjastrikers` × 22 · `pawdroid` × 10 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
