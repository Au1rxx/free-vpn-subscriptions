...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-1973-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-339ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_14:12_UTC-informational)
...
- **Median RTT**: 339 ms
- **Last updated (UTC)**: 2026-07-05 14:12 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 25 · vless × 13 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
