...
![nodes](https://img.shields.io/badge/nodes-93-brightgreen) ![alive](https://img.shields.io/badge/alive-2294-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-159ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-10_01:17_UTC-informational)
...
- **Median RTT**: 159 ms
- **Last updated (UTC)**: 2026-06-10 01:17 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 14 · vless × 24 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 28 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 5
