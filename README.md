...
![nodes](https://img.shields.io/badge/nodes-120-brightgreen) ![alive](https://img.shields.io/badge/alive-2003-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-263ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_20:12_UTC-informational)
...
- **Nodes selected**: 120
- **Alive across all sources**: 2003
- **Fastest node RTT**: 34 ms
- **Median RTT**: 263 ms
- **Last updated (UTC)**: 2026-07-12 20:12 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 64 · trojan × 18 · vless × 21 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 8 · `mahdi0024` × 30 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 2
