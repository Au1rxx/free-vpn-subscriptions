...
![nodes](https://img.shields.io/badge/nodes-82-brightgreen) ![alive](https://img.shields.io/badge/alive-2055-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-163ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-04_03:38_UTC-informational)
...
- **Median RTT**: 163 ms
- **Last updated (UTC)**: 2026-07-04 03:38 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 23 · vless × 13 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 6 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
