...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1963-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-472ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_21:13_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1963
- **Fastest node RTT**: 32 ms
- **Median RTT**: 472 ms
- **Last updated (UTC)**: 2026-06-22 21:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 43 · trojan × 16 · vless × 79 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 56 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 21 · `snakem982` × 2 · `surfboard-eternity` × 4
