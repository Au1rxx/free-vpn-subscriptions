...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-2116-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-355ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_19:18_UTC-informational)
...
- **Median RTT**: 355 ms
- **Last updated (UTC)**: 2026-06-20 19:18 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 26 · vless × 23 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 3 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 25 · `surfboard-eternity` × 1
