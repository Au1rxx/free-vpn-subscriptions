...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2450-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-122ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-14_22:27_UTC-informational)
...
- **Median RTT**: 122 ms
- **Last updated (UTC)**: 2026-05-14 22:27 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 25 · vless × 78 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 52 · `pawdroid` × 5 · `ruking-clash` × 5 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
