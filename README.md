...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-1884-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-356ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_10:09_UTC-informational)
...
- **Median RTT**: 356 ms
- **Last updated (UTC)**: 2026-06-13 10:09 UTC

**Protocol mix:** shadowsocks × 58 · trojan × 23 · vless × 15 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 7 · `ruking-clash` × 12 · `surfboard-eternity` × 5
