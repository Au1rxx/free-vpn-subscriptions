...
- **Nodes selected**: 2000
- **Alive across all sources**: 8563
- **Fastest node RTT**: 20 ms
- **Median RTT**: 814 ms
- **Last updated (UTC)**: 2026-08-15 15:20 UTC

**Protocol mix:** http × 183 · https × 11 · hysteria2 × 307 · shadowsocks × 190 · socks4 × 49 · socks5 × 97 · trojan × 664 · tuic × 1 · vless × 475 · vmess × 22 · wireguard × 1
