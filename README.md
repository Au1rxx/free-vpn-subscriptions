...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2169-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-114ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-02_17:34_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2169
- **Fastest node RTT**: 30 ms
- **Median RTT**: 114 ms
- **Last updated (UTC)**: 2026-05-02 17:34 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 16 · vless × 89 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `ninjastrikers` × 56 · `pawdroid` × 2 · `surfboard-eternity` × 7
