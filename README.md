...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2110-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-108ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_02:13_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2110
- **Fastest node RTT**: 38 ms
- **Median RTT**: 108 ms
- **Last updated (UTC)**: 2026-04-29 02:13 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 13 · vless × 98 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 6 · `ninjastrikers` × 72 · `surfboard-eternity` × 4
