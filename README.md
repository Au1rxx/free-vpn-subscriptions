...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-1888-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-328ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-11_14:27_UTC-informational)
...
- **Median RTT**: 328 ms
- **Last updated (UTC)**: 2026-07-11 14:27 UTC

**Protocol mix:** shadowsocks × 53 · trojan × 16 · vless × 17 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 27 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 4 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 2
