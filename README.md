...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1919-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-130ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_10:21_UTC-informational)
...
- **Median RTT**: 130 ms
- **Last updated (UTC)**: 2026-05-12 10:21 UTC

**Protocol mix:** shadowsocks × 53 · trojan × 4 · vless × 83 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
