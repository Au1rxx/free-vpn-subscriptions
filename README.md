...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2084-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-85ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_02:21_UTC-informational)
...
- **Median RTT**: 85 ms
- **Last updated (UTC)**: 2026-05-03 02:21 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 5 · vless × 101 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 64 · `pawdroid` × 2 · `surfboard-eternity` × 4
