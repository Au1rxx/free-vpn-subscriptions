...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2593-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-148ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_06:30_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2593
- **Fastest node RTT**: 26 ms
- **Median RTT**: 148 ms
- **Last updated (UTC)**: 2026-04-23 06:30 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 17 · vless × 96 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 25 · `epodonios` × 12 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 73 · `pawdroid` × 2 · `surfboard-eternity` × 6
