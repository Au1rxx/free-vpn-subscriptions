...
![nodes](https://img.shields.io/badge/nodes-85-brightgreen) ![alive](https://img.shields.io/badge/alive-2142-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-170ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-30_13:11_UTC-informational)
...
- **Nodes selected**: 85
- **Alive across all sources**: 2142
- **Fastest node RTT**: 30 ms
- **Median RTT**: 170 ms
- **Last updated (UTC)**: 2026-05-30 13:11 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 24 · vless × 9 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 29 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 3 · `surfboard-eternity` × 5
