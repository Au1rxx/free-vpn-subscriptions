...
![nodes](https://img.shields.io/badge/nodes-65-brightgreen) ![alive](https://img.shields.io/badge/alive-2001-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-200ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-28_10:23_UTC-informational)
...
- **Median RTT**: 200 ms
- **Last updated (UTC)**: 2026-05-28 10:23 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 10 · vless × 14 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
