...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2579-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-103ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-28_04:22_UTC-informational)
...
- **Median RTT**: 103 ms
- **Last updated (UTC)**: 2026-04-28 04:22 UTC

**Protocol mix:** shadowsocks × 19 · trojan × 7 · vless × 115 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 30 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 68 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
