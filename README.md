...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2426-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-83ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-19_22:16_UTC-informational)
...
- **Median RTT**: 83 ms
- **Last updated (UTC)**: 2026-05-19 22:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 9 · vless × 82 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 5 · `ruking-clash` × 16 · `snakem982` × 1 · `surfboard-eternity` × 6
