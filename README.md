...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-2360-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-480ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_19:17_UTC-informational)
...
- **Nodes selected**: 111
- **Alive across all sources**: 2360
- **Fastest node RTT**: 31 ms
- **Median RTT**: 480 ms
- **Last updated (UTC)**: 2026-06-18 19:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 34 · vless × 31 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 29 · `snakem982` × 7 · `surfboard-eternity` × 4
