...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1789-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-591ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_09:35_UTC-informational)
...
- **Median RTT**: 591 ms
- **Last updated (UTC)**: 2026-06-17 09:35 UTC

**Protocol mix:** hysteria2 × 5 · shadowsocks × 40 · trojan × 27 · vless × 19 · vmess × 59

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 61 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 3
