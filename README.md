...
![nodes](https://img.shields.io/badge/nodes-137-brightgreen) ![alive](https://img.shields.io/badge/alive-1721-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-371ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-11_02:13_UTC-informational)
...
- **Nodes selected**: 137
- **Alive across all sources**: 1721
- **Fastest node RTT**: 28 ms
- **Median RTT**: 371 ms
- **Last updated (UTC)**: 2026-07-11 02:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 77 · trojan × 24 · vless × 18 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 20 · `epodonios` × 23 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 27 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 2
