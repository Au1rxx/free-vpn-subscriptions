...
![nodes](https://img.shields.io/badge/nodes-118-brightgreen) ![alive](https://img.shields.io/badge/alive-1838-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-375ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-16_09:33_UTC-informational)
...
- **Nodes selected**: 118
- **Alive across all sources**: 1838
- **Fastest node RTT**: 31 ms
- **Median RTT**: 375 ms
- **Last updated (UTC)**: 2026-06-16 09:33 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 55 · trojan × 28 · vless × 20 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 21 · `mahdi0024` × 17 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 4
