...
![nodes](https://img.shields.io/badge/nodes-72-brightgreen) ![alive](https://img.shields.io/badge/alive-1985-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-178ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-04_10:19_UTC-informational)
...
- **Median RTT**: 178 ms
- **Last updated (UTC)**: 2026-07-04 10:19 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 20 · vless × 6 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
