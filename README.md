...
![nodes](https://img.shields.io/badge/nodes-93-brightgreen) ![alive](https://img.shields.io/badge/alive-2141-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-177ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_13:21_UTC-informational)
...
- **Median RTT**: 177 ms
- **Last updated (UTC)**: 2026-06-07 13:21 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 23 · vless × 9 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 4
