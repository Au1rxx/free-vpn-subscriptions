...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2552-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-72ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-16_09:33_UTC-informational)
...
- **Median RTT**: 72 ms
- **Last updated (UTC)**: 2026-05-16 09:33 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 8 · vless × 102 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 15 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 8 · `ruking-clash` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
