...
![nodes](https://img.shields.io/badge/nodes-120-brightgreen) ![alive](https://img.shields.io/badge/alive-2300-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-359ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-12_04:19_UTC-informational)
...
- **Median RTT**: 359 ms
- **Last updated (UTC)**: 2026-06-12 04:19 UTC

**Protocol mix:** shadowsocks × 45 · trojan × 45 · vless × 25 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 28 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 3
