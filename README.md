...
![nodes](https://img.shields.io/badge/nodes-128-brightgreen) ![alive](https://img.shields.io/badge/alive-2134-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-87ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_20:19_UTC-informational)
...
- **Median RTT**: 87 ms
- **Last updated (UTC)**: 2026-05-25 20:19 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 26 · vless × 58 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 49 · `pawdroid` × 7 · `ruking-clash` × 10 · `surfboard-eternity` × 5
