...
![nodes](https://img.shields.io/badge/nodes-100-brightgreen) ![alive](https://img.shields.io/badge/alive-2211-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-357ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_11:21_UTC-informational)
...
- **Median RTT**: 357 ms
- **Last updated (UTC)**: 2026-07-02 11:21 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 24 · vless × 18 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 8 · `ninjastrikers` × 17 · `pawdroid` × 4 · `surfboard-eternity` × 6
