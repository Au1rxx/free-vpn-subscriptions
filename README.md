...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2191-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-123ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_08:12_UTC-informational)
...
- **Median RTT**: 123 ms
- **Last updated (UTC)**: 2026-04-21 08:12 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 3 · vless × 103 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 50 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 55 · `pawdroid` × 2 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
