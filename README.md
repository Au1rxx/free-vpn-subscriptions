...
![nodes](https://img.shields.io/badge/nodes-134-brightgreen) ![alive](https://img.shields.io/badge/alive-1704-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-380ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-10_22:13_UTC-informational)
...
- **Nodes selected**: 134
- **Alive across all sources**: 1704
- **Fastest node RTT**: 26 ms
- **Median RTT**: 380 ms
- **Last updated (UTC)**: 2026-07-10 22:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 82 · trojan × 24 · vless × 12 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 15 · `epodonios` × 20 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 5
