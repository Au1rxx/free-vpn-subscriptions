...
![nodes](https://img.shields.io/badge/nodes-109-brightgreen) ![alive](https://img.shields.io/badge/alive-1981-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-293ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_08:39_UTC-informational)
...
- **Median RTT**: 293 ms
- **Last updated (UTC)**: 2026-07-05 08:39 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 9 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 27 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 7
