...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2174-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-75ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-26_07:32_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2174
- **Fastest node RTT**: 43 ms
- **Median RTT**: 75 ms
- **Last updated (UTC)**: 2026-05-26 07:32 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 14 · vless × 85 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `pawdroid` × 4 · `ruking-clash` × 9 · `surfboard-eternity` × 4
