...
![nodes](https://img.shields.io/badge/nodes-110-brightgreen) ![alive](https://img.shields.io/badge/alive-1975-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-283ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_09:20_UTC-informational)
...
- **Median RTT**: 283 ms
- **Last updated (UTC)**: 2026-07-12 09:20 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 53 · trojan × 17 · vless × 21 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 17 · `pawdroid` × 10 · `snakem982` × 1 · `surfboard-eternity` × 5
