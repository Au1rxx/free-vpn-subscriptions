...
![nodes](https://img.shields.io/badge/nodes-119-brightgreen) ![alive](https://img.shields.io/badge/alive-1769-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-361ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-08_20:30_UTC-informational)
...
- **Nodes selected**: 119
- **Alive across all sources**: 1769
- **Fastest node RTT**: 34 ms
- **Median RTT**: 361 ms
- **Last updated (UTC)**: 2026-07-08 20:30 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 66 · trojan × 21 · vless × 10 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `ninjastrikers` × 19 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 4
