...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2215-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-113ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_05:16_UTC-informational)
...
- **Median RTT**: 113 ms
- **Last updated (UTC)**: 2026-04-21 05:16 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 1 · vless × 107 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 48 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 57 · `ruking-clash` × 6 · `surfboard-eternity` × 8
