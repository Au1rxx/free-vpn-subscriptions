...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2463-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-76ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_08:36_UTC-informational)
...
- **Median RTT**: 76 ms
- **Last updated (UTC)**: 2026-05-25 08:36 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 3 · vless × 81 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 39 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 58 · `pawdroid` × 5 · `ruking-clash` × 8 · `surfboard-eternity` × 5
