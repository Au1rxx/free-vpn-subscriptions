...
![nodes](https://img.shields.io/badge/nodes-100-brightgreen) ![alive](https://img.shields.io/badge/alive-2042-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-186ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-27_02:27_UTC-informational)
...
- **Median RTT**: 186 ms
- **Last updated (UTC)**: 2026-06-27 02:27 UTC

**Protocol mix:** shadowsocks × 18 · trojan × 35 · vless × 26 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 3
