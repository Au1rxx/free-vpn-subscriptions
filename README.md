...
![nodes](https://img.shields.io/badge/nodes-85-brightgreen) ![alive](https://img.shields.io/badge/alive-1945-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-181ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-03_14:31_UTC-informational)
...
- **Median RTT**: 181 ms
- **Last updated (UTC)**: 2026-07-03 14:31 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 25 · vless × 12 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 8 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
