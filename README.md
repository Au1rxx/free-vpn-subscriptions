...
![nodes](https://img.shields.io/badge/nodes-64-brightgreen) ![alive](https://img.shields.io/badge/alive-2070-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-143ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-10_10:21_UTC-informational)
...
- **Median RTT**: 143 ms
- **Last updated (UTC)**: 2026-07-10 10:21 UTC

**Protocol mix:** shadowsocks × 18 · trojan × 8 · vless × 10 · vmess × 28

**Sources used this run:** `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
