...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1870-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-379ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-16_00:27_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1870
- **Fastest node RTT**: 34 ms
- **Median RTT**: 379 ms
- **Last updated (UTC)**: 2026-07-16 00:27 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 70 · trojan × 39 · vless × 26 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 18 · `mahdi0024` × 24 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 10 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 4
