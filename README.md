...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-2290-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-317ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_22:29_UTC-informational)
...
- **Median RTT**: 317 ms
- **Last updated (UTC)**: 2026-05-04 22:29 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 25 · vless × 69 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
