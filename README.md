...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2468-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-125ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_16:12_UTC-informational)
...
- **Median RTT**: 125 ms
- **Last updated (UTC)**: 2026-04-27 16:12 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 14 · vless × 98 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 57 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 6
