...
![nodes](https://img.shields.io/badge/nodes-137-brightgreen) ![alive](https://img.shields.io/badge/alive-1712-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-396ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_03:37_UTC-informational)
...
- **Nodes selected**: 137
- **Alive across all sources**: 1712
- **Fastest node RTT**: 29 ms
- **Median RTT**: 396 ms
- **Last updated (UTC)**: 2026-06-14 03:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 53 · trojan × 38 · vless × 38 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 24 · `ninjastrikers` × 35 · `pawdroid` × 8 · `ruking-clash` × 21 · `surfboard-eternity` × 3
