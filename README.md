...
![nodes](https://img.shields.io/badge/nodes-93-brightgreen) ![alive](https://img.shields.io/badge/alive-2003-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-271ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_22:13_UTC-informational)
...
- **Median RTT**: 271 ms
- **Last updated (UTC)**: 2026-06-26 22:13 UTC

**Protocol mix:** shadowsocks × 19 · trojan × 37 · vless × 17 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `ruking-clash` × 19 · `surfboard-eternity` × 3
