...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-1801-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-360ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_15:20_UTC-informational)
...
- **Median RTT**: 360 ms
- **Last updated (UTC)**: 2026-07-07 15:20 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 53 · trojan × 30 · vless × 14 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 5 · `ninjastrikers` × 16 · `pawdroid` × 7 · `ruking-clash` × 1
