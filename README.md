...
![nodes](https://img.shields.io/badge/nodes-62-brightgreen) ![alive](https://img.shields.io/badge/alive-1987-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-162ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-27_22:14_UTC-informational)
...
- **Median RTT**: 162 ms
- **Last updated (UTC)**: 2026-05-27 22:14 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 20 · vless × 8 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `ruking-clash` × 2 · `snakem982` × 7 · `surfboard-eternity` × 2
