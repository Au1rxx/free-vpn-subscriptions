...
![nodes](https://img.shields.io/badge/nodes-90-brightgreen) ![alive](https://img.shields.io/badge/alive-1854-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-351ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-09_08:09_UTC-informational)
...
- **Median RTT**: 351 ms
- **Last updated (UTC)**: 2026-06-09 08:09 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 46 · trojan × 17 · vless × 15 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 2
