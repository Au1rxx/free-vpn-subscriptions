...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2072-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-175ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_21:23_UTC-informational)
...
- **Median RTT**: 175 ms
- **Last updated (UTC)**: 2026-04-29 21:23 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 18 · vless × 81 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 8 · `ninjastrikers` × 55 · `surfboard-eternity` × 6
