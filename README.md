...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2291-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-162ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_15:12_UTC-informational)
...
- **Median RTT**: 162 ms
- **Last updated (UTC)**: 2026-04-25 15:12 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 18 · vless × 86 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 6
