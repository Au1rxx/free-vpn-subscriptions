...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2188-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-399ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-16_17:23_UTC-informational)
...
- **Median RTT**: 399 ms
- **Last updated (UTC)**: 2026-07-16 17:23 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 74 · vless × 13 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `mahdi0024` × 47 · `mahdibland-aggregator` × 42 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 5 · `ninjastrikers` × 5 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 9 · `surfboard-eternity` × 3
