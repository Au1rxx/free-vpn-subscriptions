...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2205-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-112ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_03:25_UTC-informational)
...
- **Median RTT**: 112 ms
- **Last updated (UTC)**: 2026-05-01 03:25 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 3 · vless × 98 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 7 · `mahdi0024` × 25 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 63 · `pawdroid` × 2 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
