...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1970-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-402ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-16_08:08_UTC-informational)
...
- **Median RTT**: 402 ms
- **Last updated (UTC)**: 2026-07-16 08:08 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 78 · vless × 19 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 23 · `mahdibland-aggregator` × 48 · `mahdibland-shadowsocks` × 30 · `matin-v2ray` × 4 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 8 · `surfboard-eternity` × 4
