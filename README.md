...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2224-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_01:10_UTC-informational)
...
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-04-26 01:10 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 5 · vless × 100 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 33 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 62 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 7
