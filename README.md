...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2193-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-250ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_16:34_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2193
- **Fastest node RTT**: 33 ms
- **Median RTT**: 250 ms
- **Last updated (UTC)**: 2026-04-30 16:34 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 19 · vless × 74 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 53 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
