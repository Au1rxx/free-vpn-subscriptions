...
![nodes](https://img.shields.io/badge/nodes-147-brightgreen) ![alive](https://img.shields.io/badge/alive-2609-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-162ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_18:24_UTC-informational)
...
- **Median RTT**: 162 ms
- **Last updated (UTC)**: 2026-04-24 18:24 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 21 · vless × 85 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 7 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 55 · `pawdroid` × 1 · `surfboard-eternity` × 1
