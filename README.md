...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2524-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-92ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_09:22_UTC-informational)
...
- **Median RTT**: 92 ms
- **Last updated (UTC)**: 2026-04-27 09:22 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 5 · vless × 97 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 19 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 47 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 6 · `ninjastrikers` × 55 · `surfboard-eternity` × 6
