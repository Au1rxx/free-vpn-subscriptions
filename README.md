...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2202-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-112ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_11:38_UTC-informational)
...
- **Median RTT**: 112 ms
- **Last updated (UTC)**: 2026-04-26 11:38 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 15 · vless × 96 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 20 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
