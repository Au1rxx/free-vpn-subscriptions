...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2006-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-393ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-16_06:29_UTC-informational)
...
- **Median RTT**: 393 ms
- **Last updated (UTC)**: 2026-07-16 06:29 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 44 · trojan × 71 · vless × 22 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 15 · `mahdibland-aggregator` × 42 · `mahdibland-shadowsocks` × 43 · `matin-v2ray` × 6 · `ninjastrikers` × 15 · `pawdroid` × 6 · `ruking-clash` × 2 · `snakem982` × 6 · `surfboard-eternity` × 1
