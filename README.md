...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2261-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-400ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_10:11_UTC-informational)
...
- **Median RTT**: 400 ms
- **Last updated (UTC)**: 2026-07-18 10:11 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 107 · vless × 6 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 62 · `mahdibland-aggregator` × 30 · `mahdibland-shadowsocks` × 40 · `ninjastrikers` × 3 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 4
