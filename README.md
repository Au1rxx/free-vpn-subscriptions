...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2425-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-137ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_03:27_UTC-informational)
...
- **Median RTT**: 137 ms
- **Last updated (UTC)**: 2026-05-09 03:27 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 10 · vless × 92 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 72 · `pawdroid` × 1 · `surfboard-eternity` × 7
