...
![nodes](https://img.shields.io/badge/nodes-123-brightgreen) ![alive](https://img.shields.io/badge/alive-1784-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-348ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-09_06:13_UTC-informational)
...
- **Nodes selected**: 123
- **Alive across all sources**: 1784
- **Fastest node RTT**: 34 ms
- **Median RTT**: 348 ms
- **Last updated (UTC)**: 2026-07-09 06:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 28 · vless × 17 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 4 · `ninjastrikers` × 22 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 3
