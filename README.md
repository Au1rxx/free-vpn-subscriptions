...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2444-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-103ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-14_05:23_UTC-informational)
...
- **Median RTT**: 103 ms
- **Last updated (UTC)**: 2026-05-14 05:23 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 5 · vless × 94 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 3 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 65 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 4
