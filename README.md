...
![nodes](https://img.shields.io/badge/nodes-84-brightgreen) ![alive](https://img.shields.io/badge/alive-1948-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-177ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-03_08:32_UTC-informational)
...
- **Median RTT**: 177 ms
- **Last updated (UTC)**: 2026-07-03 08:32 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 20 · vless × 13 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 3
