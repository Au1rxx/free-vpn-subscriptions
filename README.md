...
![nodes](https://img.shields.io/badge/nodes-82-brightgreen) ![alive](https://img.shields.io/badge/alive-2259-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-339ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_18:12_UTC-informational)
...
- **Nodes selected**: 82
- **Alive across all sources**: 2259
- **Fastest node RTT**: 33 ms
- **Median RTT**: 339 ms
- **Last updated (UTC)**: 2026-07-01 18:12 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 19 · vless × 14 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 10 · `pawdroid` × 6 · `surfboard-eternity` × 2
