...
![nodes](https://img.shields.io/badge/nodes-102-brightgreen) ![alive](https://img.shields.io/badge/alive-1960-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-283ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_18:36_UTC-informational)
...
- **Median RTT**: 283 ms
- **Last updated (UTC)**: 2026-07-05 18:36 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 24 · vless × 8 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `mahdi0024` × 27 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 6 · `ninjastrikers` × 10 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 5
