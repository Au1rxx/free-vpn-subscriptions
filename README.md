...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-2214-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-284ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-05_17:15_UTC-informational)
...
- **Median RTT**: 284 ms
- **Last updated (UTC)**: 2026-05-05 17:15 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 26 · vless × 69 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `snakem982` × 1 · `surfboard-eternity` × 9
