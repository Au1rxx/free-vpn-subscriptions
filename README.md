...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1998-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-363ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_01:22_UTC-informational)
...
- **Median RTT**: 363 ms
- **Last updated (UTC)**: 2026-06-23 01:22 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 28 · vless × 68 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 57 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 24 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
