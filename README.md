...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2090-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-118ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_10:27_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2090
- **Fastest node RTT**: 36 ms
- **Median RTT**: 118 ms
- **Last updated (UTC)**: 2026-04-29 10:27 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 4 · vless × 96 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 1 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
