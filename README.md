...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2159-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-399ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-16_19:21_UTC-informational)
...
- **Median RTT**: 399 ms
- **Last updated (UTC)**: 2026-07-16 19:21 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 71 · vless × 13 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `mahdi0024` × 49 · `mahdibland-aggregator` × 36 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 5 · `ninjastrikers` × 11 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 8 · `surfboard-eternity` × 4
