...
![nodes](https://img.shields.io/badge/nodes-102-brightgreen) ![alive](https://img.shields.io/badge/alive-2196-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-194ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_04:29_UTC-informational)
...
- **Median RTT**: 194 ms
- **Last updated (UTC)**: 2026-06-11 04:29 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 19 · vless × 25 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 27 · `pawdroid` × 5 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
