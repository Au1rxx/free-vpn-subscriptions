...
![nodes](https://img.shields.io/badge/nodes-83-brightgreen) ![alive](https://img.shields.io/badge/alive-2027-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-153ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-04_07:26_UTC-informational)
...
- **Median RTT**: 153 ms
- **Last updated (UTC)**: 2026-07-04 07:26 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 21 · vless × 17 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 7 · `ninjastrikers` × 17 · `pawdroid` × 8 · `ruking-clash` × 2 · `surfboard-eternity` × 3
