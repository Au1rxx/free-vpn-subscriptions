...
![nodes](https://img.shields.io/badge/nodes-98-brightgreen) ![alive](https://img.shields.io/badge/alive-1896-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-298ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_14:34_UTC-informational)
...
- **Median RTT**: 298 ms
- **Last updated (UTC)**: 2026-07-06 14:34 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 26 · vless × 6 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 3
