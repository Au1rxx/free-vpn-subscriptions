...
![nodes](https://img.shields.io/badge/nodes-108-brightgreen) ![alive](https://img.shields.io/badge/alive-1854-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-276ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_03:15_UTC-informational)
...
- **Median RTT**: 276 ms
- **Last updated (UTC)**: 2026-06-08 03:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 21 · vless × 32 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 2 · `ninjastrikers` × 33 · `pawdroid` × 2 · `ruking-clash` × 4 · `surfboard-eternity` × 5
