...
![nodes](https://img.shields.io/badge/nodes-128-brightgreen) ![alive](https://img.shields.io/badge/alive-1796-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-367ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-09_08:31_UTC-informational)
...
- **Median RTT**: 367 ms
- **Last updated (UTC)**: 2026-07-09 08:31 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 62 · trojan × 23 · vless × 16 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 15 · `epodonios` × 15 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 8 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 4
