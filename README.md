...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2585-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-79ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-28_09:17_UTC-informational)
...
- **Median RTT**: 79 ms
- **Last updated (UTC)**: 2026-04-28 09:17 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 14 · vless × 104 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
