...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2474-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-81ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-17_01:39_UTC-informational)
...
- **Median RTT**: 81 ms
- **Last updated (UTC)**: 2026-05-17 01:39 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 10 · vless × 91 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 56 · `pawdroid` × 6 · `ruking-clash` × 4 · `surfboard-eternity` × 1
