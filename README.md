...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2179-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-238ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_12:25_UTC-informational)
...
- **Median RTT**: 238 ms
- **Last updated (UTC)**: 2026-04-22 12:25 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 21 · vless × 81 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 71 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 7
