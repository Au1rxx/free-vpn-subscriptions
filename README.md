...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2174-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-104ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_04:39_UTC-informational)
...
- **Median RTT**: 104 ms
- **Last updated (UTC)**: 2026-05-03 04:39 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 4 · vless × 106 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 6 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 69 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
