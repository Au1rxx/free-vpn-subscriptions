...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2421-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-298ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_17:17_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2421
- **Fastest node RTT**: 29 ms
- **Median RTT**: 298 ms
- **Last updated (UTC)**: 2026-05-10 17:17 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 16 · vless × 80 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 58 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 3 · `surfboard-eternity` × 9
