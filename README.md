...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2456-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-170ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_21:19_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2456
- **Fastest node RTT**: 34 ms
- **Median RTT**: 170 ms
- **Last updated (UTC)**: 2026-04-27 21:19 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 21 · vless × 92 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 31 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 31 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
