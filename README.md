...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-1948-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-358ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-13_08:23_UTC-informational)
...
- **Median RTT**: 358 ms
- **Last updated (UTC)**: 2026-07-13 08:23 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 23 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 26 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 3
