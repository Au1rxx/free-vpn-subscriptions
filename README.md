...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-1923-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-340ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-14_12:29_UTC-informational)
...
- **Median RTT**: 340 ms
- **Last updated (UTC)**: 2026-07-14 12:29 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 16 · vless × 11 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 25 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 4
