...
![nodes](https://img.shields.io/badge/nodes-91-brightgreen) ![alive](https://img.shields.io/badge/alive-2079-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-442ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-27_08:28_UTC-informational)
...
- **Median RTT**: 442 ms
- **Last updated (UTC)**: 2026-06-27 08:28 UTC

**Protocol mix:** shadowsocks × 17 · trojan × 36 · vless × 18 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 16 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 1
