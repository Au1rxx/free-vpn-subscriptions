...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2191-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-92ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-02_08:10_UTC-informational)
...
- **Median RTT**: 92 ms
- **Last updated (UTC)**: 2026-05-02 08:10 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 8 · vless × 96 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 64 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7
