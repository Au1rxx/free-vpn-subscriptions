...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2168-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-278ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_11:36_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2168
- **Fastest node RTT**: 32 ms
- **Median RTT**: 278 ms
- **Last updated (UTC)**: 2026-05-06 11:36 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 21 · vless × 81 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 67 · `surfboard-eternity` × 6
