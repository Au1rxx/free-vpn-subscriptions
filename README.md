...
![nodes](https://img.shields.io/badge/nodes-146-brightgreen) ![alive](https://img.shields.io/badge/alive-2325-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-90ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-24_13:39_UTC-informational)
...
- **Nodes selected**: 146
- **Alive across all sources**: 2325
- **Fastest node RTT**: 30 ms
- **Median RTT**: 90 ms
- **Last updated (UTC)**: 2026-05-24 13:39 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 18 · vless × 65 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 55 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 7
