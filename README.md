...
![nodes](https://img.shields.io/badge/nodes-96-brightgreen) ![alive](https://img.shields.io/badge/alive-2335-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-375ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_15:36_UTC-informational)
...
- **Median RTT**: 375 ms
- **Last updated (UTC)**: 2026-07-01 15:36 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 36 · vless × 10 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 10 · `ninjastrikers` × 14 · `pawdroid` × 6 · `surfboard-eternity` × 4
