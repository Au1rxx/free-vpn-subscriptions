...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2354-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-87ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-24_02:33_UTC-informational)
...
- **Median RTT**: 87 ms
- **Last updated (UTC)**: 2026-05-24 02:33 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 3 · vless × 85 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 27 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 57 · `pawdroid` × 4 · `surfboard-eternity` × 7
