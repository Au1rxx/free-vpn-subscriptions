...
![nodes](https://img.shields.io/badge/nodes-74-brightgreen) ![alive](https://img.shields.io/badge/alive-2324-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-155ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-31_18:39_UTC-informational)
...
- **Median RTT**: 155 ms
- **Last updated (UTC)**: 2026-05-31 18:39 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 22 · trojan × 13 · vless × 5 · vmess × 33

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 24 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `surfboard-eternity` × 3
