...
![nodes](https://img.shields.io/badge/nodes-138-brightgreen) ![alive](https://img.shields.io/badge/alive-1698-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-373ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-15_01:23_UTC-informational)
...
- **Nodes selected**: 138
- **Alive across all sources**: 1698
- **Fastest node RTT**: 29 ms
- **Median RTT**: 373 ms
- **Last updated (UTC)**: 2026-06-15 01:23 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 56 · trojan × 26 · vless × 41 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 36 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 2
