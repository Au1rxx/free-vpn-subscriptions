...
![nodes](https://img.shields.io/badge/nodes-87-brightgreen) ![alive](https://img.shields.io/badge/alive-2080-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-356ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_22:27_UTC-informational)
...
- **Median RTT**: 356 ms
- **Last updated (UTC)**: 2026-07-01 22:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 47 · trojan × 23 · vless × 9 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 1 · `surfboard-eternity` × 2
