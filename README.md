...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2157-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-115ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-02_18:12_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2157
- **Fastest node RTT**: 30 ms
- **Median RTT**: 115 ms
- **Last updated (UTC)**: 2026-05-02 18:12 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 15 · vless × 87 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 52 · `pawdroid` × 3 · `surfboard-eternity` × 6
