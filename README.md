...
![nodes](https://img.shields.io/badge/nodes-119-brightgreen) ![alive](https://img.shields.io/badge/alive-1952-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-434ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-12_21:10_UTC-informational)
...
- **Median RTT**: 434 ms
- **Last updated (UTC)**: 2026-06-12 21:10 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 54 · trojan × 43 · vless × 13 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 33 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 8 · `surfboard-eternity` × 6
