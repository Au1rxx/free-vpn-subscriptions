...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2062-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-117ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_01:23_UTC-informational)
...
- **Median RTT**: 117 ms
- **Last updated (UTC)**: 2026-04-30 01:23 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 4 · vless × 94 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 28 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 69 · `surfboard-eternity` × 7
