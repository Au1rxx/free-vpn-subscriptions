...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2233-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-114ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_14:39_UTC-informational)
...
- **Median RTT**: 114 ms
- **Last updated (UTC)**: 2026-05-01 14:39 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 15 · vless × 85 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 6
