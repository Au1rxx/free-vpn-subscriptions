...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2158-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-157ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_18:39_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2158
- **Fastest node RTT**: 32 ms
- **Median RTT**: 157 ms
- **Last updated (UTC)**: 2026-05-01 18:39 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 15 · vless × 82 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 31 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
