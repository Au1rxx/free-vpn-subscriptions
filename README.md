...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-1933-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-124ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-05_06:15_UTC-informational)
...
- **Median RTT**: 124 ms
- **Last updated (UTC)**: 2026-06-05 06:15 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 35 · vless × 28 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 29 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 2
