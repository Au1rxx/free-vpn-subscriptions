...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2158-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-391ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-16_16:27_UTC-informational)
...
- **Median RTT**: 391 ms
- **Last updated (UTC)**: 2026-07-16 16:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 30 · trojan × 74 · vless × 19 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `mahdi0024` × 54 · `mahdibland-aggregator` × 32 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 10 · `ninjastrikers` × 3 · `pawdroid` × 9 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 3
