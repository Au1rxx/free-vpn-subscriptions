...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2582-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-84ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-16_06:39_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2582
- **Fastest node RTT**: 34 ms
- **Median RTT**: 84 ms
- **Last updated (UTC)**: 2026-05-16 06:39 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 15 · vless × 94 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 61 · `pawdroid` × 6 · `ruking-clash` × 6 · `surfboard-eternity` × 4
