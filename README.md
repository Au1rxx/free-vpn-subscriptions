...
![nodes](https://img.shields.io/badge/nodes-98-brightgreen) ![alive](https://img.shields.io/badge/alive-2148-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-327ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-09_22:19_UTC-informational)
...
- **Median RTT**: 327 ms
- **Last updated (UTC)**: 2026-06-09 22:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 43 · trojan × 17 · vless × 11 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 5
