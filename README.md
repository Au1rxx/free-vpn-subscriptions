...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2373-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-120ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_17:19_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2373
- **Fastest node RTT**: 36 ms
- **Median RTT**: 120 ms
- **Last updated (UTC)**: 2026-05-12 17:19 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 14 · vless × 84 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 41 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
