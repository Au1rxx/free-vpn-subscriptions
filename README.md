...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-2393-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-493ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_20:20_UTC-informational)
...
- **Median RTT**: 493 ms
- **Last updated (UTC)**: 2026-06-18 20:20 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 24 · vless × 38 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 35 · `snakem982` × 7 · `surfboard-eternity` × 5
