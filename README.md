...
![nodes](https://img.shields.io/badge/nodes-148-brightgreen) ![alive](https://img.shields.io/badge/alive-1959-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-322ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_22:39_UTC-informational)
...
- **Median RTT**: 322 ms
- **Last updated (UTC)**: 2026-05-06 22:39 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 19 · vless × 72 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 6
