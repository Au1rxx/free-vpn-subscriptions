...
![nodes](https://img.shields.io/badge/nodes-77-brightgreen) ![alive](https://img.shields.io/badge/alive-2510-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-114ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_09:19_UTC-informational)
...
- **Nodes selected**: 77
- **Alive across all sources**: 2510
- **Fastest node RTT**: 27 ms
- **Median RTT**: 114 ms
- **Last updated (UTC)**: 2026-06-02 09:19 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 24 · vless × 8 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
