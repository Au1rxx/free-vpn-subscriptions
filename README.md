...
![nodes](https://img.shields.io/badge/nodes-133-brightgreen) ![alive](https://img.shields.io/badge/alive-1993-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-408ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_15:33_UTC-informational)
...
- **Median RTT**: 408 ms
- **Last updated (UTC)**: 2026-06-23 15:33 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 33 · vless × 45 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 50 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `mfuu-clash` × 7 · `ninjastrikers` × 15 · `pawdroid` × 6 · `ruking-clash` × 9 · `surfboard-eternity` × 1
