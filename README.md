...
![nodes](https://img.shields.io/badge/nodes-143-brightgreen) ![alive](https://img.shields.io/badge/alive-2322-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-116ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-22_23:28_UTC-informational)
...
- **Nodes selected**: 143
- **Alive across all sources**: 2322
- **Fastest node RTT**: 35 ms
- **Median RTT**: 116 ms
- **Last updated (UTC)**: 2026-05-22 23:28 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 24 · vless × 70 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 53 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
