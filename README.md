...
![nodes](https://img.shields.io/badge/nodes-125-brightgreen) ![alive](https://img.shields.io/badge/alive-1770-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-374ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_12:34_UTC-informational)
...
- **Nodes selected**: 125
- **Alive across all sources**: 1770
- **Fastest node RTT**: 32 ms
- **Median RTT**: 374 ms
- **Last updated (UTC)**: 2026-07-07 12:34 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 67 · trojan × 24 · vless × 10 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 4
