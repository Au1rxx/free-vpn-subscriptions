...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-1871-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-363ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_13:40_UTC-informational)
...
- **Median RTT**: 363 ms
- **Last updated (UTC)**: 2026-07-06 13:40 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 42 · trojan × 25 · vless × 13 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 6 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 2
