...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2542-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-165ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_08:37_UTC-informational)
...
- **Median RTT**: 165 ms
- **Last updated (UTC)**: 2026-04-23 08:37 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 20 · vless × 93 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 29 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 73 · `pawdroid` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
