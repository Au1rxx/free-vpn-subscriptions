...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2278-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-179ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_22:25_UTC-informational)
...
- **Median RTT**: 179 ms
- **Last updated (UTC)**: 2026-04-25 22:25 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 18 · vless × 87 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 53 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 6
