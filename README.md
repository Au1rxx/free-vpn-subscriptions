...
![nodes](https://img.shields.io/badge/nodes-102-brightgreen) ![alive](https://img.shields.io/badge/alive-2320-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-186ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_00:26_UTC-informational)
...
- **Median RTT**: 186 ms
- **Last updated (UTC)**: 2026-06-20 00:26 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 29 · vless × 19 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 19 · `surfboard-eternity` × 4
