...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2545-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-176ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_09:23_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2545
- **Fastest node RTT**: 27 ms
- **Median RTT**: 176 ms
- **Last updated (UTC)**: 2026-04-23 09:23 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 21 · vless × 91 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 28 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 75 · `pawdroid` × 1 · `surfboard-eternity` × 5
