...
![nodes](https://img.shields.io/badge/nodes-100-brightgreen) ![alive](https://img.shields.io/badge/alive-1958-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-290ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-04_18:14_UTC-informational)
...
- **Median RTT**: 290 ms
- **Last updated (UTC)**: 2026-07-04 18:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 48 · trojan × 13 · vless × 10 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 33 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 5 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 8
