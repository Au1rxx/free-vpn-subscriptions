...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2137-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-160ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-02_19:28_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2137
- **Fastest node RTT**: 29 ms
- **Median RTT**: 160 ms
- **Last updated (UTC)**: 2026-05-02 19:28 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 17 · vless × 87 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 53 · `snakem982` × 1 · `surfboard-eternity` × 8
