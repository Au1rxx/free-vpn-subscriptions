...
![nodes](https://img.shields.io/badge/nodes-70-brightgreen) ![alive](https://img.shields.io/badge/alive-2055-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-203ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-28_09:15_UTC-informational)
...
- **Median RTT**: 203 ms
- **Last updated (UTC)**: 2026-05-28 09:15 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 14 · vless × 16 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 6 · `ruking-clash` × 2 · `snakem982` × 4 · `surfboard-eternity` × 4
