...
![nodes](https://img.shields.io/badge/nodes-63-brightgreen) ![alive](https://img.shields.io/badge/alive-1954-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-275ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-30_22:19_UTC-informational)
...
- **Median RTT**: 275 ms
- **Last updated (UTC)**: 2026-06-30 22:19 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 29 · vless × 6 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `mfuu-clash` × 8 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 5
