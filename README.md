...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-1770-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-364ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_19:26_UTC-informational)
...
- **Median RTT**: 364 ms
- **Last updated (UTC)**: 2026-07-07 19:26 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 60 · trojan × 21 · vless × 9 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
