...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2261-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-100ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_01:22_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2261
- **Fastest node RTT**: 29 ms
- **Median RTT**: 100 ms
- **Last updated (UTC)**: 2026-05-01 01:22 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 5 · vless × 96 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 63 · `snakem982` × 1 · `surfboard-eternity` × 3
