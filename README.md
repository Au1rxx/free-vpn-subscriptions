...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2128-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-86ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_05:30_UTC-informational)
...
- **Median RTT**: 86 ms
- **Last updated (UTC)**: 2026-05-03 05:30 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 10 · vless × 98 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 70 · `pawdroid` × 3 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
