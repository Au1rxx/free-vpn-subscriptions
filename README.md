...
![nodes](https://img.shields.io/badge/nodes-149-brightgreen) ![alive](https://img.shields.io/badge/alive-2356-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-20_19:15_UTC-informational)
...
- **Nodes selected**: 149
- **Alive across all sources**: 2356
- **Fastest node RTT**: 30 ms
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-05-20 19:15 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 27 · vless × 65 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 7
