...
![nodes](https://img.shields.io/badge/nodes-81-brightgreen) ![alive](https://img.shields.io/badge/alive-2173-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-172ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_09:33_UTC-informational)
...
- **Median RTT**: 172 ms
- **Last updated (UTC)**: 2026-06-06 09:33 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 24 · vless × 16 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 25 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 1
