...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2442-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-385ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_16:29_UTC-informational)
...
- **Median RTT**: 385 ms
- **Last updated (UTC)**: 2026-07-18 16:29 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 88 · vless × 17 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 31 · `mahdibland-aggregator` × 33 · `mahdibland-shadowsocks` × 35 · `matin-v2ray` × 5 · `ninjastrikers` × 4 · `pawdroid` × 11 · `ruking-clash` × 1 · `snakem982` × 13 · `surfboard-eternity` × 3
