...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2132-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-99ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_04:36_UTC-informational)
...
- **Median RTT**: 99 ms
- **Last updated (UTC)**: 2026-04-29 04:36 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 6 · vless × 103 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 26 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 70 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
