...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2044-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-168ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-02_21:26_UTC-informational)
...
- **Median RTT**: 168 ms
- **Last updated (UTC)**: 2026-05-02 21:26 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 17 · vless × 87 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
