...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-2298-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-83ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-18_16:38_UTC-informational)
...
- **Nodes selected**: 126
- **Alive across all sources**: 2298
- **Fastest node RTT**: 31 ms
- **Median RTT**: 83 ms
- **Last updated (UTC)**: 2026-05-18 16:38 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 16 · trojan × 22 · vless × 68 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 6 · `ruking-clash` × 2 · `surfboard-eternity` × 4
