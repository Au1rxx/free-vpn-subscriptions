...
![nodes](https://img.shields.io/badge/nodes-147-brightgreen) ![alive](https://img.shields.io/badge/alive-1502-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-375ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-09_05:18_UTC-informational)
...
- **Nodes selected**: 147
- **Alive across all sources**: 1502
- **Fastest node RTT**: 35 ms
- **Median RTT**: 375 ms
- **Last updated (UTC)**: 2026-07-09 05:18 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 74 · trojan × 28 · vless × 17 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 30 · `matin-v2ray` × 5 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 6
