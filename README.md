...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2347-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-76ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-23_08:20_UTC-informational)
...
- **Median RTT**: 76 ms
- **Last updated (UTC)**: 2026-05-23 08:20 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 5 · vless × 105 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 23 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 70 · `pawdroid` × 8 · `ruking-clash` × 3 · `surfboard-eternity` × 4
