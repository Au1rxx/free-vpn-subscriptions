...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2380-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-97ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-13_07:29_UTC-informational)
...
- **Median RTT**: 97 ms
- **Last updated (UTC)**: 2026-05-13 07:29 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 7 · vless × 97 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 66 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
