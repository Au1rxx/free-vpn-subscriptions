...
![nodes](https://img.shields.io/badge/nodes-118-brightgreen) ![alive](https://img.shields.io/badge/alive-1910-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-354ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-14_03:30_UTC-informational)
...
- **Median RTT**: 354 ms
- **Last updated (UTC)**: 2026-07-14 03:30 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 24 · vless × 27 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 29 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 6 · `ninjastrikers` × 22 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 2
