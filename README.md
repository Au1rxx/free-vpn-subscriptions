...
![nodes](https://img.shields.io/badge/nodes-96-brightgreen) ![alive](https://img.shields.io/badge/alive-1956-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-484ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_10:19_UTC-informational)
...
- **Median RTT**: 484 ms
- **Last updated (UTC)**: 2026-06-18 10:19 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 25 · vless × 28 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 25 · `snakem982` × 5 · `surfboard-eternity` × 4
