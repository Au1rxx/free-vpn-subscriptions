...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2238-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-162ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_14:11_UTC-informational)
...
- **Median RTT**: 162 ms
- **Last updated (UTC)**: 2026-04-25 14:11 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 19 · vless × 89 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 37 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 58 · `snakem982` × 1 · `surfboard-eternity` × 5
