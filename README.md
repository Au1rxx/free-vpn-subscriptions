...
![nodes](https://img.shields.io/badge/nodes-83-brightgreen) ![alive](https://img.shields.io/badge/alive-2218-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-226ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-29_06:37_UTC-informational)
...
- **Median RTT**: 226 ms
- **Last updated (UTC)**: 2026-06-29 06:37 UTC

**Protocol mix:** shadowsocks × 18 · trojan × 28 · vless × 24 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 11 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 5
