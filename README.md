...
![nodes](https://img.shields.io/badge/nodes-86-brightgreen) ![alive](https://img.shields.io/badge/alive-2542-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-100ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_07:11_UTC-informational)
...
- **Median RTT**: 100 ms
- **Last updated (UTC)**: 2026-06-02 07:11 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 27 · vless × 13 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 17 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
