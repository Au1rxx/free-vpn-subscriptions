...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2086-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-154ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_22:39_UTC-informational)
...
- **Median RTT**: 154 ms
- **Last updated (UTC)**: 2026-05-01 22:39 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 19 · vless × 80 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 3 · `surfboard-eternity` × 11
