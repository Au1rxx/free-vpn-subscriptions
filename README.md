...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-2240-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-398ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_12:23_UTC-informational)
...
- **Median RTT**: 398 ms
- **Last updated (UTC)**: 2026-07-01 12:23 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 51 · trojan × 39 · vless × 14 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 20 · `mfuu-clash` × 9 · `ninjastrikers` × 18 · `pawdroid` × 6 · `surfboard-eternity` × 4
