...
![nodes](https://img.shields.io/badge/nodes-128-brightgreen) ![alive](https://img.shields.io/badge/alive-2544-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-472ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_06:37_UTC-informational)
...
- **Nodes selected**: 128
- **Alive across all sources**: 2544
- **Fastest node RTT**: 33 ms
- **Median RTT**: 472 ms
- **Last updated (UTC)**: 2026-06-19 06:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 23 · vless × 55 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 34 · `snakem982` × 5 · `surfboard-eternity` × 1
