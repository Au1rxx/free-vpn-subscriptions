...
![nodes](https://img.shields.io/badge/nodes-107-brightgreen) ![alive](https://img.shields.io/badge/alive-1955-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-383ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-10_19:19_UTC-informational)
...
- **Median RTT**: 383 ms
- **Last updated (UTC)**: 2026-06-10 19:19 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 18 · vless × 11 · vmess × 35

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 34 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 6 · `surfboard-eternity` × 1
