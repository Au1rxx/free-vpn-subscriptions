...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2606-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-167ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_04:24_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2606
- **Fastest node RTT**: 30 ms
- **Median RTT**: 167 ms
- **Last updated (UTC)**: 2026-04-23 04:24 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 18 · vless × 96 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 28 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 75 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 2
