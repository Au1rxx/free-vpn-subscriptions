...
![nodes](https://img.shields.io/badge/nodes-129-brightgreen) ![alive](https://img.shields.io/badge/alive-2131-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-94ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_17:38_UTC-informational)
...
- **Median RTT**: 94 ms
- **Last updated (UTC)**: 2026-05-25 17:38 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 27 · vless × 55 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 55 · `pawdroid` × 2 · `ruking-clash` × 10 · `surfboard-eternity` × 5
