...
![nodes](https://img.shields.io/badge/nodes-89-brightgreen) ![alive](https://img.shields.io/badge/alive-2081-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-252ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-27_12:30_UTC-informational)
...
- **Median RTT**: 252 ms
- **Last updated (UTC)**: 2026-06-27 12:30 UTC

**Protocol mix:** shadowsocks × 18 · trojan × 33 · vless × 15 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 12 · `surfboard-eternity` × 2
