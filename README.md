...
![nodes](https://img.shields.io/badge/nodes-147-brightgreen) ![alive](https://img.shields.io/badge/alive-1747-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-387ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-14_15:16_UTC-informational)
...
- **Nodes selected**: 147
- **Alive across all sources**: 1747
- **Fastest node RTT**: 29 ms
- **Median RTT**: 387 ms
- **Last updated (UTC)**: 2026-07-14 15:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 93 · trojan × 24 · vless × 21 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 34 · `epodonios` × 18 · `mahdi0024` × 9 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 4 · `ninjastrikers` × 19 · `pawdroid` × 10 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
