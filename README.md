...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2471-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-108ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_14:17_UTC-informational)
...
- **Median RTT**: 108 ms
- **Last updated (UTC)**: 2026-04-27 14:17 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 15 · vless × 98 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
