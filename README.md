...
![nodes](https://img.shields.io/badge/nodes-95-brightgreen) ![alive](https://img.shields.io/badge/alive-1980-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-276ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-04_17:31_UTC-informational)
...
- **Median RTT**: 276 ms
- **Last updated (UTC)**: 2026-07-04 17:31 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 20 · vless × 11 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 27 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 8 · `ninjastrikers` × 12 · `pawdroid` × 6 · `ruking-clash` × 2 · `surfboard-eternity` × 4
