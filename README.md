...
![nodes](https://img.shields.io/badge/nodes-72-brightgreen) ![alive](https://img.shields.io/badge/alive-2143-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-139ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-30_11:16_UTC-informational)
...
- **Median RTT**: 139 ms
- **Last updated (UTC)**: 2026-05-30 11:16 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 8 · vless × 8 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 4 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
