...
![nodes](https://img.shields.io/badge/nodes-123-brightgreen) ![alive](https://img.shields.io/badge/alive-1810-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-357ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-08_05:12_UTC-informational)
...
- **Median RTT**: 357 ms
- **Last updated (UTC)**: 2026-07-08 05:12 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 57 · trojan × 25 · vless × 17 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 5 · `ninjastrikers` × 25 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 1
