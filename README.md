...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1937-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-122ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_00:12_UTC-informational)
...
- **Median RTT**: 122 ms
- **Last updated (UTC)**: 2026-05-08 00:12 UTC

**Protocol mix:** shadowsocks × 50 · trojan × 4 · vless × 86 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 26 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 70 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
