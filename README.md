...
![nodes](https://img.shields.io/badge/nodes-97-brightgreen) ![alive](https://img.shields.io/badge/alive-1932-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-331ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-14_13:18_UTC-informational)
...
- **Median RTT**: 331 ms
- **Last updated (UTC)**: 2026-07-14 13:18 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 15 · vless × 13 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 4 · `ninjastrikers` × 10 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 3
