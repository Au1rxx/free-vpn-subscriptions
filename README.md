...
![nodes](https://img.shields.io/badge/nodes-64-brightgreen) ![alive](https://img.shields.io/badge/alive-2402-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-135ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_19:24_UTC-informational)
...
- **Median RTT**: 135 ms
- **Last updated (UTC)**: 2026-07-02 19:24 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 23 · trojan × 15 · vless × 8 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 3 · `ninjastrikers` × 8 · `pawdroid` × 4 · `surfboard-eternity` × 6
