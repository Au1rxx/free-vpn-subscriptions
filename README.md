...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-2182-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-400ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-17_10:09_UTC-informational)
...
- **Median RTT**: 400 ms
- **Last updated (UTC)**: 2026-07-17 10:09 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 68 · vless × 12 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 7 · `mahdi0024` × 41 · `mahdibland-aggregator` × 32 · `mahdibland-shadowsocks` × 35 · `matin-v2ray` × 7 · `ninjastrikers` × 8 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
