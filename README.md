...
![nodes](https://img.shields.io/badge/nodes-149-brightgreen) ![alive](https://img.shields.io/badge/alive-1886-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-379ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-16_03:10_UTC-informational)
...
- **Nodes selected**: 149
- **Alive across all sources**: 1886
- **Fastest node RTT**: 40 ms
- **Median RTT**: 379 ms
- **Last updated (UTC)**: 2026-07-16 03:10 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 69 · trojan × 40 · vless × 27 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `mahdi0024` × 20 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 6 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 13 · `surfboard-eternity` × 4
