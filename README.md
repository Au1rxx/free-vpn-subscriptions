...
![nodes](https://img.shields.io/badge/nodes-109-brightgreen) ![alive](https://img.shields.io/badge/alive-1686-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-405ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_23:25_UTC-informational)
...
- **Nodes selected**: 109
- **Alive across all sources**: 1686
- **Fastest node RTT**: 35 ms
- **Median RTT**: 405 ms
- **Last updated (UTC)**: 2026-06-13 23:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 54 · trojan × 32 · vless × 15 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 14 · `surfboard-eternity` × 4
