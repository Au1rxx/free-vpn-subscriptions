...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2186-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-117ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_13:16_UTC-informational)
...
- **Median RTT**: 117 ms
- **Last updated (UTC)**: 2026-05-01 13:16 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 13 · vless × 81 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 33 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `snakem982` × 1 · `surfboard-eternity` × 4
