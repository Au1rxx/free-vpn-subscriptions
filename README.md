...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2611-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-161ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_22:20_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2611
- **Fastest node RTT**: 29 ms
- **Median RTT**: 161 ms
- **Last updated (UTC)**: 2026-04-27 22:20 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 22 · vless × 90 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 29 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 6
