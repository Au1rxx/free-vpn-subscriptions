...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2091-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-104ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_06:36_UTC-informational)
...
- **Median RTT**: 104 ms
- **Last updated (UTC)**: 2026-04-29 06:36 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 11 · vless × 96 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 26 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 6 · `ninjastrikers` × 67 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 4
