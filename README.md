...
![nodes](https://img.shields.io/badge/nodes-108-brightgreen) ![alive](https://img.shields.io/badge/alive-1664-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-502ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_12:19_UTC-informational)
...
- **Median RTT**: 502 ms
- **Last updated (UTC)**: 2026-06-14 12:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 36 · vless × 16 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 3 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 4
