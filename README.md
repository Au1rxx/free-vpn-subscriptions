...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2531-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-76ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_07:14_UTC-informational)
...
- **Median RTT**: 76 ms
- **Last updated (UTC)**: 2026-04-25 07:14 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 9 · vless × 106 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 21 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 37 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 4 · `surfboard-eternity` × 5
