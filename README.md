...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2414-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-399ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-19_01:25_UTC-informational)
...
- **Median RTT**: 399 ms
- **Last updated (UTC)**: 2026-07-19 01:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 29 · trojan × 102 · vless × 13 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `mahdi0024` × 29 · `mahdibland-aggregator` × 41 · `mahdibland-shadowsocks` × 40 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `ruking-clash` × 2 · `snakem982` × 6 · `surfboard-eternity` × 9
