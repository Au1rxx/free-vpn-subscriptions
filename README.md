...
![nodes](https://img.shields.io/badge/nodes-132-brightgreen) ![alive](https://img.shields.io/badge/alive-2254-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-77ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-18_23:18_UTC-informational)
...
- **Nodes selected**: 132
- **Alive across all sources**: 2254
- **Fastest node RTT**: 22 ms
- **Median RTT**: 77 ms
- **Last updated (UTC)**: 2026-05-18 23:18 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 19 · trojan × 27 · vless × 63 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 25 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 50 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 3
