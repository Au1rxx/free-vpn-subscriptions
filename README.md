...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2547-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_03:11_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2547
- **Fastest node RTT**: 28 ms
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-04-27 03:11 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 4 · vless × 100 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 21 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 46 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 55 · `pawdroid` × 1 · `surfboard-eternity` × 6
