...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2256-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-140ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_12:14_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2256
- **Fastest node RTT**: 28 ms
- **Median RTT**: 140 ms
- **Last updated (UTC)**: 2026-05-03 12:14 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 21 · vless × 93 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 5 · `ninjastrikers` × 60 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
