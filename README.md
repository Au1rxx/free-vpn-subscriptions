...
![nodes](https://img.shields.io/badge/nodes-107-brightgreen) ![alive](https://img.shields.io/badge/alive-2347-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-91ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-03_02:26_UTC-informational)
...
- **Median RTT**: 91 ms
- **Last updated (UTC)**: 2026-06-03 02:26 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 32 · vless × 24 · vmess × 30

**Sources used this run:** `barry-far-v2ray` × 19 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 29 · `surfboard-eternity` × 3
