...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2196-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-149ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_09:19_UTC-informational)
...
- **Median RTT**: 149 ms
- **Last updated (UTC)**: 2026-04-21 09:19 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 2 · vless × 105 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 53 · `epodonios` × 3 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 56 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
