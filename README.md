...
![nodes](https://img.shields.io/badge/nodes-70-brightgreen) ![alive](https://img.shields.io/badge/alive-2215-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-152ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-28_22:35_UTC-informational)
...
- **Median RTT**: 152 ms
- **Last updated (UTC)**: 2026-06-28 22:35 UTC

**Protocol mix:** shadowsocks × 17 · trojan × 19 · vless × 19 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 2 · `surfboard-eternity` × 1
