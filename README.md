...
![nodes](https://img.shields.io/badge/nodes-57-brightgreen) ![alive](https://img.shields.io/badge/alive-1962-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-157ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-27_17:11_UTC-informational)
...
- **Nodes selected**: 57
- **Alive across all sources**: 1962
- **Fastest node RTT**: 39 ms
- **Median RTT**: 157 ms
- **Last updated (UTC)**: 2026-05-27 17:11 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 10 · vless × 17 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 6 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 3
