...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2585-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-77ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-16_07:21_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2585
- **Fastest node RTT**: 32 ms
- **Median RTT**: 77 ms
- **Last updated (UTC)**: 2026-05-16 07:21 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 10 · vless × 98 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 19 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 61 · `pawdroid` × 7 · `ruking-clash` × 3 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
