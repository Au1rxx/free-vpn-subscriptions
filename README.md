...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2246-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-181ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-20_16:21_UTC-informational)
...
- **Median RTT**: 181 ms
- **Last updated (UTC)**: 2026-04-20 16:21 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 16 · vless × 95 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 50 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
