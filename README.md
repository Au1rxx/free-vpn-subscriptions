...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2475-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-80ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-17_02:39_UTC-informational)
...
- **Median RTT**: 80 ms
- **Last updated (UTC)**: 2026-05-17 02:39 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 5 · vless × 97 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 37 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 55 · `pawdroid` × 6 · `ruking-clash` × 6 · `surfboard-eternity` × 5
