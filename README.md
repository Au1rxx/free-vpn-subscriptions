...
![nodes](https://img.shields.io/badge/nodes-97-brightgreen) ![alive](https://img.shields.io/badge/alive-1830-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-354ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_16:14_UTC-informational)
...
- **Nodes selected**: 97
- **Alive across all sources**: 1830
- **Fastest node RTT**: 29 ms
- **Median RTT**: 354 ms
- **Last updated (UTC)**: 2026-06-07 16:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 54 · trojan × 20 · vless × 15 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 22 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
