...
![nodes](https://img.shields.io/badge/nodes-136-brightgreen) ![alive](https://img.shields.io/badge/alive-2469-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-217ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_22:26_UTC-informational)
...
- **Median RTT**: 217 ms
- **Last updated (UTC)**: 2026-04-23 22:26 UTC

**Protocol mix:** shadowsocks × 20 · trojan × 23 · vless × 74 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 7
