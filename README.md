...
![nodes](https://img.shields.io/badge/nodes-137-brightgreen) ![alive](https://img.shields.io/badge/alive-2494-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-168ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_18:39_UTC-informational)
...
- **Median RTT**: 168 ms
- **Last updated (UTC)**: 2026-05-09 18:39 UTC

**Protocol mix:** shadowsocks × 52 · trojan × 16 · vless × 61 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `ruking-clash` × 8 · `snakem982` × 3 · `surfboard-eternity` × 6
