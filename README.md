...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2213-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-97ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_12:37_UTC-informational)
...
- **Median RTT**: 97 ms
- **Last updated (UTC)**: 2026-04-26 12:37 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 16 · vless × 98 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 21 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 3 · `surfboard-eternity` × 8
