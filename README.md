...
![nodes](https://img.shields.io/badge/nodes-70-brightgreen) ![alive](https://img.shields.io/badge/alive-2008-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-204ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-28_08:22_UTC-informational)
...
- **Nodes selected**: 70
- **Alive across all sources**: 2008
- **Fastest node RTT**: 35 ms
- **Median RTT**: 204 ms
- **Last updated (UTC)**: 2026-05-28 08:22 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 14 · vless × 16 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 4 · `surfboard-eternity` × 4
