...
![nodes](https://img.shields.io/badge/nodes-147-brightgreen) ![alive](https://img.shields.io/badge/alive-2592-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-124ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_20:30_UTC-informational)
...
- **Nodes selected**: 147
- **Alive across all sources**: 2592
- **Fastest node RTT**: 30 ms
- **Median RTT**: 124 ms
- **Last updated (UTC)**: 2026-04-24 20:30 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 22 · vless × 84 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
