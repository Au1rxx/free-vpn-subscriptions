...
![nodes](https://img.shields.io/badge/nodes-99-brightgreen) ![alive](https://img.shields.io/badge/alive-1945-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-285ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_12:36_UTC-informational)
...
- **Median RTT**: 285 ms
- **Last updated (UTC)**: 2026-07-12 12:36 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 17 · vless × 12 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 1
