...
![nodes](https://img.shields.io/badge/nodes-77-brightgreen) ![alive](https://img.shields.io/badge/alive-1959-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-162ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-03_16:33_UTC-informational)
...
- **Median RTT**: 162 ms
- **Last updated (UTC)**: 2026-07-03 16:33 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 21 · vless × 16 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 11 · `ninjastrikers` × 9 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 3
