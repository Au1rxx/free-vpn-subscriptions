...
![nodes](https://img.shields.io/badge/nodes-91-brightgreen) ![alive](https://img.shields.io/badge/alive-2021-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-354ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-29_23:24_UTC-informational)
...
- **Median RTT**: 354 ms
- **Last updated (UTC)**: 2026-06-29 23:24 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 35 · vless × 10 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 5 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 13 · `surfboard-eternity` × 2
