...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2513-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-96ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_11:31_UTC-informational)
...
- **Median RTT**: 96 ms
- **Last updated (UTC)**: 2026-04-27 11:31 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 5 · vless × 96 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 17 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 49 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 57 · `pawdroid` × 1 · `surfboard-eternity` × 5
