...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2592-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-104ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_14:40_UTC-informational)
...
- **Median RTT**: 104 ms
- **Last updated (UTC)**: 2026-04-26 14:40 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 4 · vless × 92 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 48 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 55 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
