...
![nodes](https://img.shields.io/badge/nodes-92-brightgreen) ![alive](https://img.shields.io/badge/alive-2317-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-172ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_05:15_UTC-informational)
...
- **Median RTT**: 172 ms
- **Last updated (UTC)**: 2026-06-20 05:15 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 24 · vless × 16 · vmess × 30

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 3
