...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2278-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-147ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-05_01:28_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2278
- **Fastest node RTT**: 30 ms
- **Median RTT**: 147 ms
- **Last updated (UTC)**: 2026-05-05 01:28 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 10 · vless × 95 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 78 · `pawdroid` × 2 · `surfboard-eternity` × 7
