...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2141-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-285ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_13:31_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2141
- **Fastest node RTT**: 30 ms
- **Median RTT**: 285 ms
- **Last updated (UTC)**: 2026-05-06 13:31 UTC

**Protocol mix:** shadowsocks × 46 · trojan × 17 · vless × 75 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 57 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
