...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2064-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-165ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_15:11_UTC-informational)
...
- **Median RTT**: 165 ms
- **Last updated (UTC)**: 2026-04-29 15:11 UTC

**Protocol mix:** shadowsocks × 45 · trojan × 8 · vless × 87 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 40 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
