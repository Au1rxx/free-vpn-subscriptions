...
![nodes](https://img.shields.io/badge/nodes-72-brightgreen) ![alive](https://img.shields.io/badge/alive-2101-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-165ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-09_20:23_UTC-informational)
...
- **Median RTT**: 165 ms
- **Last updated (UTC)**: 2026-07-09 20:23 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 11 · vless × 9 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 5 · `mahdi0024` × 34 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 4 · `ninjastrikers` × 10 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1
