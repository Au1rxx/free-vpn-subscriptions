...
![nodes](https://img.shields.io/badge/nodes-128-brightgreen) ![alive](https://img.shields.io/badge/alive-1999-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-224ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-13_03:10_UTC-informational)
...
- **Median RTT**: 224 ms
- **Last updated (UTC)**: 2026-07-13 03:10 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 64 · trojan × 18 · vless × 32 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 26 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 3 · `ninjastrikers` × 25 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 1
