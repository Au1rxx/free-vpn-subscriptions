...
![nodes](https://img.shields.io/badge/nodes-127-brightgreen) ![alive](https://img.shields.io/badge/alive-2023-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-289ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_22:21_UTC-informational)
...
- **Median RTT**: 289 ms
- **Last updated (UTC)**: 2026-07-12 22:21 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 69 · trojan × 26 · vless × 18 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 10 · `ninjastrikers` × 17 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 8
