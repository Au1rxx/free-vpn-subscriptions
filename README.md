...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2154-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-155ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_16:37_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2154
- **Fastest node RTT**: 35 ms
- **Median RTT**: 155 ms
- **Last updated (UTC)**: 2026-05-01 16:37 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 15 · vless × 82 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 51 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
