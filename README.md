...
![nodes](https://img.shields.io/badge/nodes-68-brightgreen) ![alive](https://img.shields.io/badge/alive-1993-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-169ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-04_12:25_UTC-informational)
...
- **Median RTT**: 169 ms
- **Last updated (UTC)**: 2026-07-04 12:25 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 21 · vless × 8 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 13 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 2
