...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2245-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-84ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_08:17_UTC-informational)
...
- **Median RTT**: 84 ms
- **Last updated (UTC)**: 2026-05-03 08:17 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 12 · vless × 102 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 30 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 64 · `pawdroid` × 2 · `surfboard-eternity` × 6
