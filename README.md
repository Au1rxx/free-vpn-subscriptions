...
![nodes](https://img.shields.io/badge/nodes-125-brightgreen) ![alive](https://img.shields.io/badge/alive-2536-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-187ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_05:38_UTC-informational)
...
- **Median RTT**: 187 ms
- **Last updated (UTC)**: 2026-06-02 05:38 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 36 · vless × 21 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 25 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 7
