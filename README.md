...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-1804-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-282ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-08_23:15_UTC-informational)
...
- **Nodes selected**: 111
- **Alive across all sources**: 1804
- **Fastest node RTT**: 35 ms
- **Median RTT**: 282 ms
- **Last updated (UTC)**: 2026-07-08 23:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 48 · trojan × 24 · vless × 13 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 15 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 7 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 5
