...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2608-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-155ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_00:36_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2608
- **Fastest node RTT**: 31 ms
- **Median RTT**: 155 ms
- **Last updated (UTC)**: 2026-04-23 00:36 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 14 · vless × 96 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 27 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 74 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
