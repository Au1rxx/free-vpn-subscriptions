...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2589-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-94ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-28_05:37_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2589
- **Fastest node RTT**: 29 ms
- **Median RTT**: 94 ms
- **Last updated (UTC)**: 2026-04-28 05:37 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 10 · vless × 109 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 25 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 4
