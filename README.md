...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2482-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-105ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_08:27_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2482
- **Fastest node RTT**: 27 ms
- **Median RTT**: 105 ms
- **Last updated (UTC)**: 2026-05-10 08:27 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 3 · vless × 96 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 32 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 66 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
