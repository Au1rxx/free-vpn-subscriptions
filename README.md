...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2080-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-188ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_16:37_UTC-informational)
...
- **Median RTT**: 188 ms
- **Last updated (UTC)**: 2026-04-29 16:37 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 16 · vless × 80 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 6 · `ninjastrikers` × 57 · `surfboard-eternity` × 7
