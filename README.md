...
![nodes](https://img.shields.io/badge/nodes-85-brightgreen) ![alive](https://img.shields.io/badge/alive-2033-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-198ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-28_07:27_UTC-informational)
...
- **Median RTT**: 198 ms
- **Last updated (UTC)**: 2026-05-28 07:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 30 · trojan × 24 · vless × 19 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 5
