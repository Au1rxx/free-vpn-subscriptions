...
![nodes](https://img.shields.io/badge/nodes-148-brightgreen) ![alive](https://img.shields.io/badge/alive-2336-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-92ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-24_12:23_UTC-informational)
...
- **Median RTT**: 92 ms
- **Last updated (UTC)**: 2026-05-24 12:23 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 18 · vless × 65 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 44 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 55 · `pawdroid` × 2 · `surfboard-eternity` × 3
