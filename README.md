...
![nodes](https://img.shields.io/badge/nodes-106-brightgreen) ![alive](https://img.shields.io/badge/alive-1947-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-152ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-04_05:09_UTC-informational)
...
- **Median RTT**: 152 ms
- **Last updated (UTC)**: 2026-06-04 05:09 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 47 · vless × 29 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 34 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 23 · `pawdroid` × 1 · `surfboard-eternity` × 2
