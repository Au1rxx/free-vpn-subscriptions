...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1991-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-290ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_14:30_UTC-informational)
...
- **Median RTT**: 290 ms
- **Last updated (UTC)**: 2026-05-06 14:30 UTC

**Protocol mix:** shadowsocks × 51 · trojan × 16 · vless × 72 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 3 · `ninjastrikers` × 61 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
