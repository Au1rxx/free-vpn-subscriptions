...
![nodes](https://img.shields.io/badge/nodes-145-brightgreen) ![alive](https://img.shields.io/badge/alive-1944-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-461ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_11:25_UTC-informational)
...
- **Median RTT**: 461 ms
- **Last updated (UTC)**: 2026-06-17 11:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 24 · vless × 14 · vmess × 69

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `mahdi0024` × 71 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
