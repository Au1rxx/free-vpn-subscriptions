...
![nodes](https://img.shields.io/badge/nodes-88-brightgreen) ![alive](https://img.shields.io/badge/alive-2206-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-277ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_07:32_UTC-informational)
...
- **Nodes selected**: 88
- **Alive across all sources**: 2206
- **Fastest node RTT**: 26 ms
- **Median RTT**: 277 ms
- **Last updated (UTC)**: 2026-06-11 07:32 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 14 · vless × 16 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 3
