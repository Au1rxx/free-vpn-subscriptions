...
![nodes](https://img.shields.io/badge/nodes-134-brightgreen) ![alive](https://img.shields.io/badge/alive-1763-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-386ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-08_16:16_UTC-informational)
...
- **Median RTT**: 386 ms
- **Last updated (UTC)**: 2026-07-08 16:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 78 · trojan × 21 · vless × 11 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 21 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 4
