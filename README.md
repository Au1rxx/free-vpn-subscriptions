...
![nodes](https://img.shields.io/badge/nodes-101-brightgreen) ![alive](https://img.shields.io/badge/alive-1918-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-355ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-14_10:24_UTC-informational)
...
- **Median RTT**: 355 ms
- **Last updated (UTC)**: 2026-07-14 10:24 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 44 · trojan × 19 · vless × 9 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 14 · `pawdroid` × 6 · `surfboard-eternity` × 7
