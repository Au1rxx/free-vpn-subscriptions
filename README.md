...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-1893-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-312ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-09_05:32_UTC-informational)
...
- **Median RTT**: 312 ms
- **Last updated (UTC)**: 2026-06-09 05:32 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 44 · trojan × 19 · vless × 20 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 5 · `surfboard-eternity` × 4
