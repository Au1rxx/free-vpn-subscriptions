...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2454-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-112ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-11_04:24_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2454
- **Fastest node RTT**: 29 ms
- **Median RTT**: 112 ms
- **Last updated (UTC)**: 2026-05-11 04:24 UTC

**Protocol mix:** shadowsocks × 44 · trojan × 3 · vless × 95 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 71 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
