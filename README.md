...
![nodes](https://img.shields.io/badge/nodes-74-brightgreen) ![alive](https://img.shields.io/badge/alive-2173-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-171ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_12:28_UTC-informational)
...
- **Median RTT**: 171 ms
- **Last updated (UTC)**: 2026-06-06 12:28 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 25 · vless × 5 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
