...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2334-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-81ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-24_10:22_UTC-informational)
...
- **Median RTT**: 81 ms
- **Last updated (UTC)**: 2026-05-24 10:22 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 19 · vless × 71 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 20 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 40 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 58 · `pawdroid` × 3 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
