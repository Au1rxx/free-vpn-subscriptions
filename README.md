...
![nodes](https://img.shields.io/badge/nodes-96-brightgreen) ![alive](https://img.shields.io/badge/alive-2085-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-309ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-10_23:11_UTC-informational)
...
- **Nodes selected**: 96
- **Alive across all sources**: 2085
- **Fastest node RTT**: 25 ms
- **Median RTT**: 309 ms
- **Last updated (UTC)**: 2026-06-10 23:11 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 19 · vless × 11 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 3
