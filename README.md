...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2561-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-85ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-16_00:18_UTC-informational)
...
- **Median RTT**: 85 ms
- **Last updated (UTC)**: 2026-05-16 00:18 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 10 · vless × 96 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 61 · `pawdroid` × 9 · `ruking-clash` × 5 · `surfboard-eternity` × 3
