...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2039-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-73ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-22_13:15_UTC-informational)
...
- **Median RTT**: 73 ms
- **Last updated (UTC)**: 2026-05-22 13:15 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 13 · vless × 87 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 32 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 63 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
