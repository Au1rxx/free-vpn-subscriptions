...
![nodes](https://img.shields.io/badge/nodes-118-brightgreen) ![alive](https://img.shields.io/badge/alive-1960-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-351ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_09:23_UTC-informational)
...
- **Median RTT**: 351 ms
- **Last updated (UTC)**: 2026-07-05 09:23 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 53 · trojan × 28 · vless × 10 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 36 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `ninjastrikers` × 16 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
