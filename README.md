...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-2003-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-177ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-04_14:20_UTC-informational)
...
- **Median RTT**: 177 ms
- **Last updated (UTC)**: 2026-06-04 14:20 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 54 · vless × 19 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 39 · `epodonios` × 29 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 5
