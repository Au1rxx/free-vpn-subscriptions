...
![nodes](https://img.shields.io/badge/nodes-96-brightgreen) ![alive](https://img.shields.io/badge/alive-1844-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-374ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-30_08:38_UTC-informational)
...
- **Median RTT**: 374 ms
- **Last updated (UTC)**: 2026-06-30 08:38 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 41 · vless × 10 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 12
