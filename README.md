...
![nodes](https://img.shields.io/badge/nodes-119-brightgreen) ![alive](https://img.shields.io/badge/alive-2394-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-488ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_23:23_UTC-informational)
...
- **Nodes selected**: 119
- **Alive across all sources**: 2394
- **Fastest node RTT**: 37 ms
- **Median RTT**: 488 ms
- **Last updated (UTC)**: 2026-06-18 23:23 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 39 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 38 · `snakem982` × 6 · `surfboard-eternity` × 2
