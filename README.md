...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2186-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-162ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_11:16_UTC-informational)
...
- **Median RTT**: 162 ms
- **Last updated (UTC)**: 2026-04-21 11:16 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 3 · vless × 106 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 54 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 52 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 6
