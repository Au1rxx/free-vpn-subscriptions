...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2305-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-350ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_18:33_UTC-informational)
...
- **Median RTT**: 350 ms
- **Last updated (UTC)**: 2026-05-08 18:33 UTC

**Protocol mix:** shadowsocks × 54 · trojan × 18 · vless × 67 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 7 · `mahdi0024` × 6 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 9
