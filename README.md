...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2087-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-119ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_13:34_UTC-informational)
...
- **Median RTT**: 119 ms
- **Last updated (UTC)**: 2026-04-29 13:34 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 6 · vless × 94 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 57 · `ruking-clash` × 7 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
