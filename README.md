...
![nodes](https://img.shields.io/badge/nodes-106-brightgreen) ![alive](https://img.shields.io/badge/alive-1901-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-342ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_23:19_UTC-informational)
...
- **Median RTT**: 342 ms
- **Last updated (UTC)**: 2026-07-06 23:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 44 · trojan × 30 · vless × 10 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 6 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
