...
![nodes](https://img.shields.io/badge/nodes-86-brightgreen) ![alive](https://img.shields.io/badge/alive-2022-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-201ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_21:10_UTC-informational)
...
- **Median RTT**: 201 ms
- **Last updated (UTC)**: 2026-06-26 21:10 UTC

**Protocol mix:** shadowsocks × 17 · trojan × 32 · vless × 17 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `ruking-clash` × 17
