...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2670-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-94ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_00:12_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2670
- **Fastest node RTT**: 28 ms
- **Median RTT**: 94 ms
- **Last updated (UTC)**: 2026-04-25 00:12 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 10 · vless × 106 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 25 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 34 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 63 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
