...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2222-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-107ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_07:22_UTC-informational)
...
- **Median RTT**: 107 ms
- **Last updated (UTC)**: 2026-04-30 07:22 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 17 · vless × 90 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 27 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 7 · `ninjastrikers` × 67 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
