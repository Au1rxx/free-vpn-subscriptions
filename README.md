...
![nodes](https://img.shields.io/badge/nodes-147-brightgreen) ![alive](https://img.shields.io/badge/alive-2281-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-435ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_21:31_UTC-informational)
...
- **Median RTT**: 435 ms
- **Last updated (UTC)**: 2026-04-21 21:31 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 23 · vless × 80 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 46 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 5
