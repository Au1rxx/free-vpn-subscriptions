...
![nodes](https://img.shields.io/badge/nodes-141-brightgreen) ![alive](https://img.shields.io/badge/alive-1903-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-278ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_03:26_UTC-informational)
...
- **Median RTT**: 278 ms
- **Last updated (UTC)**: 2026-07-12 03:26 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 62 · trojan × 26 · vless × 33 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 31 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 14 · `ninjastrikers` × 25 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 7
