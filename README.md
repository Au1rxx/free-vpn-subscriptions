...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2192-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-81ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_09:22_UTC-informational)
...
- **Median RTT**: 81 ms
- **Last updated (UTC)**: 2026-04-26 09:22 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 10 · vless × 103 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 20 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 67 · `pawdroid` × 4 · `surfboard-eternity` × 7 · `vxiaov-clash` × 2
