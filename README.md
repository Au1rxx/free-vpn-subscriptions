...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2289-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-214ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_15:19_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2289
- **Fastest node RTT**: 28 ms
- **Median RTT**: 214 ms
- **Last updated (UTC)**: 2026-05-08 15:19 UTC

**Protocol mix:** shadowsocks × 50 · trojan × 18 · vless × 73 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 67 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
