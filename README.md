...
![nodes](https://img.shields.io/badge/nodes-58-brightgreen) ![alive](https://img.shields.io/badge/alive-2382-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-132ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_18:13_UTC-informational)
...
- **Median RTT**: 132 ms
- **Last updated (UTC)**: 2026-07-02 18:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 22 · trojan × 12 · vless × 10 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 8 · `surfboard-eternity` × 2
