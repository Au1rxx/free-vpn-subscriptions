...
![nodes](https://img.shields.io/badge/nodes-93-brightgreen) ![alive](https://img.shields.io/badge/alive-2086-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-183ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-27_13:13_UTC-informational)
...
- **Median RTT**: 183 ms
- **Last updated (UTC)**: 2026-06-27 13:13 UTC

**Protocol mix:** shadowsocks × 18 · trojan × 34 · vless × 18 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 5 · `ruking-clash` × 15 · `surfboard-eternity` × 2
