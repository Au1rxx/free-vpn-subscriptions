...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2281-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-174ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_19:17_UTC-informational)
...
- **Median RTT**: 174 ms
- **Last updated (UTC)**: 2026-04-25 19:17 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 18 · vless × 83 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 24 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
