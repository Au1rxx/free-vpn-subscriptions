...
![nodes](https://img.shields.io/badge/nodes-69-brightgreen) ![alive](https://img.shields.io/badge/alive-2338-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-141ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_20:17_UTC-informational)
...
- **Nodes selected**: 69
- **Alive across all sources**: 2338
- **Fastest node RTT**: 32 ms
- **Median RTT**: 141 ms
- **Last updated (UTC)**: 2026-07-02 20:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 25 · trojan × 16 · vless × 11 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 5 · `ninjastrikers` × 10 · `pawdroid` × 4 · `surfboard-eternity` × 4
