...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2281-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-171ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_17:36_UTC-informational)
...
- **Median RTT**: 171 ms
- **Last updated (UTC)**: 2026-04-25 17:36 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 18 · vless × 85 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 55 · `snakem982` × 3 · `surfboard-eternity` × 7
