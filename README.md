...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2404-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-168ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-11_11:10_UTC-informational)
...
- **Median RTT**: 168 ms
- **Last updated (UTC)**: 2026-05-11 11:10 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 8 · vless × 84 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 60 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 2
