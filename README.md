...
![nodes](https://img.shields.io/badge/nodes-97-brightgreen) ![alive](https://img.shields.io/badge/alive-2165-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-137ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_01:30_UTC-informational)
...
- **Median RTT**: 137 ms
- **Last updated (UTC)**: 2026-06-06 01:30 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 27 · vless × 31 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 30 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
