...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-2109-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-127ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-10_01:30_UTC-informational)
...
- **Median RTT**: 127 ms
- **Last updated (UTC)**: 2026-07-10 01:30 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 10 · vless × 24 · vmess × 33

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 37 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 8 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
