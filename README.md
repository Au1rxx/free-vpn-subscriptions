...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2523-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-109ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_10:31_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2523
- **Fastest node RTT**: 27 ms
- **Median RTT**: 109 ms
- **Last updated (UTC)**: 2026-04-25 10:31 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 17 · vless × 97 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 20 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 63 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
