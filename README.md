...
![nodes](https://img.shields.io/badge/nodes-113-brightgreen) ![alive](https://img.shields.io/badge/alive-1997-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-338ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-04_22:33_UTC-informational)
...
- **Median RTT**: 338 ms
- **Last updated (UTC)**: 2026-07-04 22:33 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 55 · trojan × 22 · vless × 9 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 36 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
