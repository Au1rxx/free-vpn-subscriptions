...
![nodes](https://img.shields.io/badge/nodes-76-brightgreen) ![alive](https://img.shields.io/badge/alive-2490-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-137ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_14:32_UTC-informational)
...
- **Nodes selected**: 76
- **Alive across all sources**: 2490
- **Fastest node RTT**: 29 ms
- **Median RTT**: 137 ms
- **Last updated (UTC)**: 2026-06-02 14:32 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 26 · vless × 8 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 9 · `pawdroid` × 4 · `surfboard-eternity` × 4
