...
![nodes](https://img.shields.io/badge/nodes-120-brightgreen) ![alive](https://img.shields.io/badge/alive-1752-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-476ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_22:22_UTC-informational)
...
- **Nodes selected**: 120
- **Alive across all sources**: 1752
- **Fastest node RTT**: 27 ms
- **Median RTT**: 476 ms
- **Last updated (UTC)**: 2026-06-17 22:22 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 49 · trojan × 32 · vless × 29 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 16 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 23 · `surfboard-eternity` × 3
