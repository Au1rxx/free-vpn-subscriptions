...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-1927-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-411ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-25_19:35_UTC-informational)
...
- **Median RTT**: 411 ms
- **Last updated (UTC)**: 2026-06-25 19:35 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 38 · vless × 18 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 20 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 20 · `surfboard-eternity` × 6
