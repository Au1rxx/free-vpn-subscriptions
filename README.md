...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2192-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-89ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-02_06:28_UTC-informational)
...
- **Median RTT**: 89 ms
- **Last updated (UTC)**: 2026-05-02 06:28 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 8 · vless × 93 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 27 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 56 · `pawdroid` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
