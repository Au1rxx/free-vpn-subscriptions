...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-1871-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-354ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-30_06:11_UTC-informational)
...
- **Median RTT**: 354 ms
- **Last updated (UTC)**: 2026-06-30 06:11 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 37 · vless × 17 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 4
