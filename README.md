...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2277-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-155ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_18:30_UTC-informational)
...
- **Median RTT**: 155 ms
- **Last updated (UTC)**: 2026-04-25 18:30 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 17 · vless × 85 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 52 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
