...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1976-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-337ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_23:32_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1976
- **Fastest node RTT**: 35 ms
- **Median RTT**: 337 ms
- **Last updated (UTC)**: 2026-05-06 23:32 UTC

**Protocol mix:** shadowsocks × 46 · trojan × 19 · vless × 71 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 61 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
