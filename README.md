...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2012-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-100ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-22_00:40_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2012
- **Fastest node RTT**: 32 ms
- **Median RTT**: 100 ms
- **Last updated (UTC)**: 2026-05-22 00:40 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 13 · vless × 82 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 9 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 8
