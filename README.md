...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2196-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-400ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-16_14:36_UTC-informational)
...
- **Median RTT**: 400 ms
- **Last updated (UTC)**: 2026-07-16 14:36 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 79 · vless × 13 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `mahdi0024` × 57 · `mahdibland-aggregator` × 29 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 6 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 6 · `surfboard-eternity` × 5
