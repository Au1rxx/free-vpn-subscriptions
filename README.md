...
![nodes](https://img.shields.io/badge/nodes-87-brightgreen) ![alive](https://img.shields.io/badge/alive-2141-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-272ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-28_16:09_UTC-informational)
...
- **Median RTT**: 272 ms
- **Last updated (UTC)**: 2026-06-28 16:09 UTC

**Protocol mix:** shadowsocks × 18 · trojan × 33 · vless × 19 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 3
