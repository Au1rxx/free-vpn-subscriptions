...
![nodes](https://img.shields.io/badge/nodes-78-brightgreen) ![alive](https://img.shields.io/badge/alive-1978-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-174ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-03_22:36_UTC-informational)
...
- **Median RTT**: 174 ms
- **Last updated (UTC)**: 2026-07-03 22:36 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 23 · vless × 7 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 6 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
