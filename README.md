...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2210-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-154ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_11:30_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2210
- **Fastest node RTT**: 28 ms
- **Median RTT**: 154 ms
- **Last updated (UTC)**: 2026-04-30 11:30 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 20 · vless × 86 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 36 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 64 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
