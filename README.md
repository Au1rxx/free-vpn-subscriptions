...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2227-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-69ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-19_07:10_UTC-informational)
...
- **Median RTT**: 69 ms
- **Last updated (UTC)**: 2026-05-19 07:10 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 19 · vless × 91 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 71 · `pawdroid` × 10 · `snakem982` × 1 · `surfboard-eternity` × 4
