...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-1927-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-369ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-13_10:10_UTC-informational)
...
- **Median RTT**: 369 ms
- **Last updated (UTC)**: 2026-07-13 10:10 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 18 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 15 · `epodonios` × 6 · `mahdi0024` × 26 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 6 · `snakem982` × 1 · `surfboard-eternity` × 3
