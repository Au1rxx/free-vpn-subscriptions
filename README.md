...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1958-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-150ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_05:15_UTC-informational)
...
- **Median RTT**: 150 ms
- **Last updated (UTC)**: 2026-05-07 05:15 UTC

**Protocol mix:** shadowsocks × 51 · trojan × 5 · vless × 83 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 70 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
