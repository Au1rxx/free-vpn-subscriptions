...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-1963-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-352ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_05:22_UTC-informational)
...
- **Median RTT**: 352 ms
- **Last updated (UTC)**: 2026-06-26 05:22 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 37 · vless × 26 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `ruking-clash` × 18 · `surfboard-eternity` × 4
