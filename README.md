...
![nodes](https://img.shields.io/badge/nodes-86-brightgreen) ![alive](https://img.shields.io/badge/alive-1857-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-357ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-09_09:12_UTC-informational)
...
- **Median RTT**: 357 ms
- **Last updated (UTC)**: 2026-06-09 09:12 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 18 · vless × 18 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
