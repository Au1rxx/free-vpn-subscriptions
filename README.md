...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2565-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-162ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_20:11_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2565
- **Fastest node RTT**: 27 ms
- **Median RTT**: 162 ms
- **Last updated (UTC)**: 2026-04-26 20:11 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 16 · vless × 80 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 24 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 43 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 46 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
