...
![nodes](https://img.shields.io/badge/nodes-89-brightgreen) ![alive](https://img.shields.io/badge/alive-2353-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-160ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-10_04:27_UTC-informational)
...
- **Median RTT**: 160 ms
- **Last updated (UTC)**: 2026-06-10 04:27 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 13 · vless × 23 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 4
