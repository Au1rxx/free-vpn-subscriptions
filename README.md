...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2192-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-156ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_02:24_UTC-informational)
...
- **Median RTT**: 156 ms
- **Last updated (UTC)**: 2026-04-22 02:24 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 4 · vless × 98 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 74 · `pawdroid` × 3 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 8
