...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1959-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-157ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_06:34_UTC-informational)
...
- **Median RTT**: 157 ms
- **Last updated (UTC)**: 2026-05-12 06:34 UTC

**Protocol mix:** shadowsocks × 58 · trojan × 3 · vless × 79 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 4 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 74 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
