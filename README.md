...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2191-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-172ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-02_15:20_UTC-informational)
...
- **Median RTT**: 172 ms
- **Last updated (UTC)**: 2026-05-02 15:20 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 19 · vless × 81 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `pawdroid` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
