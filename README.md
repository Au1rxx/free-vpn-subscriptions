...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2102-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-99ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_03:17_UTC-informational)
...
- **Median RTT**: 99 ms
- **Last updated (UTC)**: 2026-04-29 03:17 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 5 · vless × 103 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 26 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 74 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
