...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2235-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-207ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_18:39_UTC-informational)
...
- **Median RTT**: 207 ms
- **Last updated (UTC)**: 2026-04-30 18:39 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 25 · vless × 73 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 32 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `snakem982` × 3 · `surfboard-eternity` × 5
