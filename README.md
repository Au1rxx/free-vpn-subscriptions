...
- **Nodes selected**: 2000
- **Alive across all sources**: 3868
- **Fastest node RTT**: 47 ms
- **Median RTT**: 553 ms
- **Last updated (UTC)**: 2026-08-01 05:26 UTC

**Protocol mix:** http × 169 · https × 2 · hysteria2 × 132 · shadowsocks × 203 · socks4 × 33 · socks5 × 126 · trojan × 335 · tuic × 5 · vless × 994 · vmess × 1
