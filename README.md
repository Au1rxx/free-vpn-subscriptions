...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2691-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-80ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-18_05:19_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2691
- **Fastest node RTT**: 29 ms
- **Median RTT**: 80 ms
- **Last updated (UTC)**: 2026-05-18 05:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 3 · vless × 98 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 61 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
