...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2448-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-127ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-11_03:11_UTC-informational)
...
- **Median RTT**: 127 ms
- **Last updated (UTC)**: 2026-05-11 03:11 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 2 · vless × 98 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 5 · `ninjastrikers` × 72 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 5
