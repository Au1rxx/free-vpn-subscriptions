...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2124-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-176ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_03:26_UTC-informational)
...
- **Median RTT**: 176 ms
- **Last updated (UTC)**: 2026-06-21 03:26 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 26 · vless × 65 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 38 · `mahdi0024` × 29 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 5 · `ninjastrikers` × 24 · `pawdroid` × 2 · `ruking-clash` × 22 · `snakem982` × 1 · `surfboard-eternity` × 3
