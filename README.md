...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2439-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-259ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_23:24_UTC-informational)
...
- **Median RTT**: 259 ms
- **Last updated (UTC)**: 2026-05-10 23:24 UTC

**Protocol mix:** shadowsocks × 49 · trojan × 16 · vless × 76 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 5 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
