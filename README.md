...
![nodes](https://img.shields.io/badge/nodes-92-brightgreen) ![alive](https://img.shields.io/badge/alive-2017-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-281ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_15:21_UTC-informational)
...
- **Median RTT**: 281 ms
- **Last updated (UTC)**: 2026-06-26 15:21 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 33 · vless × 17 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 20 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 5 · `ruking-clash` × 16 · `surfboard-eternity` × 2
