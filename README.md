...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-1824-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-350ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_23:17_UTC-informational)
...
- **Nodes selected**: 94
- **Alive across all sources**: 1824
- **Fastest node RTT**: 37 ms
- **Median RTT**: 350 ms
- **Last updated (UTC)**: 2026-06-07 23:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 54 · trojan × 22 · vless × 11 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `ruking-clash` × 3 · `surfboard-eternity` × 5
