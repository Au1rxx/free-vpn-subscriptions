...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2227-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-84ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_00:26_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2227
- **Fastest node RTT**: 30 ms
- **Median RTT**: 84 ms
- **Last updated (UTC)**: 2026-04-26 00:26 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 4 · vless × 99 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 30 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 64 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
