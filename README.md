...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2427-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-116ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-13_18:30_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2427
- **Fastest node RTT**: 29 ms
- **Median RTT**: 116 ms
- **Last updated (UTC)**: 2026-05-13 18:30 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 20 · vless × 81 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 3 · `ruking-clash` × 6 · `snakem982` × 2 · `surfboard-eternity` × 4
