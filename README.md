...
![nodes](https://img.shields.io/badge/nodes-100-brightgreen) ![alive](https://img.shields.io/badge/alive-2170-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-143ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_00:24_UTC-informational)
...
- **Median RTT**: 143 ms
- **Last updated (UTC)**: 2026-06-06 00:24 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 26 · vless × 32 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 30 · `surfboard-eternity` × 6
