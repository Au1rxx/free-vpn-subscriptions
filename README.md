...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2283-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-94ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-19_03:39_UTC-informational)
...
- **Median RTT**: 94 ms
- **Last updated (UTC)**: 2026-05-19 03:39 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 24 · trojan × 21 · vless × 79 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 26 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 71 · `pawdroid` × 3 · `surfboard-eternity` × 7
