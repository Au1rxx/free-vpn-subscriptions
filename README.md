...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2373-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-23_14:39_UTC-informational)
...
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-05-23 14:39 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 18 · vless × 66 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 25 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 42 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 48 · `pawdroid` × 7 · `surfboard-eternity` × 4
