...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2438-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-115ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-11_05:26_UTC-informational)
...
- **Median RTT**: 115 ms
- **Last updated (UTC)**: 2026-05-11 05:26 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 5 · vless × 96 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 74 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 7
