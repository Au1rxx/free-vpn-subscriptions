...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2419-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-99ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-14_14:22_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2419
- **Fastest node RTT**: 29 ms
- **Median RTT**: 99 ms
- **Last updated (UTC)**: 2026-05-14 14:22 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 18 · vless × 82 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 33 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 6
