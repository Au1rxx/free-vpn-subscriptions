...
![nodes](https://img.shields.io/badge/nodes-138-brightgreen) ![alive](https://img.shields.io/badge/alive-2047-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-410ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_09:15_UTC-informational)
...
- **Median RTT**: 410 ms
- **Last updated (UTC)**: 2026-06-21 09:15 UTC

**Protocol mix:** shadowsocks × 44 · trojan × 29 · vless × 42 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 12 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 41 · `snakem982` × 2 · `surfboard-eternity` × 4
