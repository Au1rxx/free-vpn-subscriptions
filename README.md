...
![nodes](https://img.shields.io/badge/nodes-96-brightgreen) ![alive](https://img.shields.io/badge/alive-1906-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-218ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-11_19:10_UTC-informational)
...
- **Median RTT**: 218 ms
- **Last updated (UTC)**: 2026-07-11 19:10 UTC

**Protocol mix:** shadowsocks × 51 · trojan × 5 · vless × 23 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 7 · `pawdroid` × 12 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 3
