...
![nodes](https://img.shields.io/badge/nodes-74-brightgreen) ![alive](https://img.shields.io/badge/alive-2155-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-168ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-28_23:19_UTC-informational)
...
- **Median RTT**: 168 ms
- **Last updated (UTC)**: 2026-05-28 23:19 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 30 · vless × 11 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 4
