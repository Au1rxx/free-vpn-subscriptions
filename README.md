...
![nodes](https://img.shields.io/badge/nodes-77-brightgreen) ![alive](https://img.shields.io/badge/alive-2422-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-331ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_20:38_UTC-informational)
...
- **Median RTT**: 331 ms
- **Last updated (UTC)**: 2026-06-11 20:38 UTC

**Protocol mix:** shadowsocks × 44 · trojan × 17 · vless × 12 · vmess × 4

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 4 · `surfboard-eternity` × 5
