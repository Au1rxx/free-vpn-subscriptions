...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2091-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-126ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_11:11_UTC-informational)
...
- **Median RTT**: 126 ms
- **Last updated (UTC)**: 2026-04-29 11:11 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 11 · vless × 90 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `ruking-clash` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
