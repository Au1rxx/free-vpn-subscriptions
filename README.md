...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2574-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_00:22_UTC-informational)
...
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-04-27 00:22 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 5 · vless × 96 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 19 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 45 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 56 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
