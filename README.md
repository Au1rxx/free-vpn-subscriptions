...
![nodes](https://img.shields.io/badge/nodes-81-brightgreen) ![alive](https://img.shields.io/badge/alive-2348-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-163ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-10_05:28_UTC-informational)
...
- **Median RTT**: 163 ms
- **Last updated (UTC)**: 2026-06-10 05:28 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 13 · vless × 18 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 5
