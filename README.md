...
![nodes](https://img.shields.io/badge/nodes-114-brightgreen) ![alive](https://img.shields.io/badge/alive-1798-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-337ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-11_09:11_UTC-informational)
...
- **Nodes selected**: 114
- **Alive across all sources**: 1798
- **Fastest node RTT**: 28 ms
- **Median RTT**: 337 ms
- **Last updated (UTC)**: 2026-07-11 09:11 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 53 · trojan × 21 · vless × 22 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 7 · `ninjastrikers` × 22 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 2
