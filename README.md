...
![nodes](https://img.shields.io/badge/nodes-87-brightgreen) ![alive](https://img.shields.io/badge/alive-2057-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-353ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_21:39_UTC-informational)
...
- **Median RTT**: 353 ms
- **Last updated (UTC)**: 2026-07-01 21:39 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 44 · trojan × 22 · vless × 12 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 7 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 3 · `ninjastrikers` × 18 · `pawdroid` × 2 · `surfboard-eternity` × 3
