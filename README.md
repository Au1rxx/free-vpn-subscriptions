...
![nodes](https://img.shields.io/badge/nodes-74-brightgreen) ![alive](https://img.shields.io/badge/alive-1982-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-180ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-03_15:35_UTC-informational)
...
- **Median RTT**: 180 ms
- **Last updated (UTC)**: 2026-07-03 15:35 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 23 · vless × 6 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
