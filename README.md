...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2258-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-179ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_11:11_UTC-informational)
...
- **Median RTT**: 179 ms
- **Last updated (UTC)**: 2026-04-22 11:11 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 10 · vless × 99 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 48 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 59 · `pawdroid` × 2 · `ruking-clash` × 4 · `surfboard-eternity` × 7
