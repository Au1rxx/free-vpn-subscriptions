...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2527-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-85ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_07:27_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2527
- **Fastest node RTT**: 28 ms
- **Median RTT**: 85 ms
- **Last updated (UTC)**: 2026-04-27 07:27 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 3 · vless × 101 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 43 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 4 · `surfboard-eternity` × 6
