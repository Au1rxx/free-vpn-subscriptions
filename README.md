...
![nodes](https://img.shields.io/badge/nodes-75-brightgreen) ![alive](https://img.shields.io/badge/alive-1938-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-229ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-28_11:25_UTC-informational)
...
- **Median RTT**: 229 ms
- **Last updated (UTC)**: 2026-05-28 11:25 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 17 · vless × 13 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 3
