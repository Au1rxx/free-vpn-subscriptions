...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2476-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-108ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_06:30_UTC-informational)
...
- **Median RTT**: 108 ms
- **Last updated (UTC)**: 2026-05-10 06:30 UTC

**Protocol mix:** shadowsocks × 45 · trojan × 3 · vless × 94 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 30 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 67 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
