...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2172-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-397ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-16_22:37_UTC-informational)
...
- **Median RTT**: 397 ms
- **Last updated (UTC)**: 2026-07-16 22:37 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 75 · vless × 11 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `mahdi0024` × 51 · `mahdibland-aggregator` × 30 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 5
