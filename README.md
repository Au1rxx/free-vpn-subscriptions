...
![nodes](https://img.shields.io/badge/nodes-121-brightgreen) ![alive](https://img.shields.io/badge/alive-1849-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-351ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_19:39_UTC-informational)
...
- **Median RTT**: 351 ms
- **Last updated (UTC)**: 2026-07-06 19:39 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 60 · trojan × 25 · vless × 12 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 10 · `mfuu-clash` × 1 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 1
