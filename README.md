...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-1931-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-412ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-25_18:37_UTC-informational)
...
- **Median RTT**: 412 ms
- **Last updated (UTC)**: 2026-06-25 18:37 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 40 · vless × 21 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 23 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 20 · `surfboard-eternity` × 3
