...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2595-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-104ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-14_21:16_UTC-informational)
...
- **Median RTT**: 104 ms
- **Last updated (UTC)**: 2026-05-14 21:16 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 23 · vless × 84 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 7 · `ninjastrikers` × 52 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 6
