...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2324-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-104ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-23_22:20_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2324
- **Fastest node RTT**: 32 ms
- **Median RTT**: 104 ms
- **Last updated (UTC)**: 2026-05-23 22:20 UTC

**Protocol mix:** shadowsocks × 44 · trojan × 17 · vless × 63 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 43 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 6
