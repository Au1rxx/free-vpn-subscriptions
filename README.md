...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2237-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-403ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-17_04:16_UTC-informational)
...
- **Median RTT**: 403 ms
- **Last updated (UTC)**: 2026-07-17 04:16 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 75 · vless × 18 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 3 · `mahdi0024` × 46 · `mahdibland-aggregator` × 34 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 4
