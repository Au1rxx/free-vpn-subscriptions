...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2133-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-96ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_03:25_UTC-informational)
...
- **Median RTT**: 96 ms
- **Last updated (UTC)**: 2026-04-26 03:25 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 7 · vless × 104 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 69 · `pawdroid` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 2
