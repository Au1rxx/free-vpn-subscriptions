...
![nodes](https://img.shields.io/badge/nodes-80-brightgreen) ![alive](https://img.shields.io/badge/alive-2323-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-225ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_20:20_UTC-informational)
...
- **Nodes selected**: 80
- **Alive across all sources**: 2323
- **Fastest node RTT**: 31 ms
- **Median RTT**: 225 ms
- **Last updated (UTC)**: 2026-06-19 20:20 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 25 · vless × 7 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 14 · `surfboard-eternity` × 3
