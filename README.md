...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2571-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-125ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-28_12:26_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2571
- **Fastest node RTT**: 29 ms
- **Median RTT**: 125 ms
- **Last updated (UTC)**: 2026-04-28 12:26 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 17 · vless × 96 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 26 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 17 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 6 · `ninjastrikers` × 68 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6
