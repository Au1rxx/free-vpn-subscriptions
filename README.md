...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2009-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-400ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-16_09:36_UTC-informational)
...
- **Median RTT**: 400 ms
- **Last updated (UTC)**: 2026-07-16 09:36 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 73 · vless × 21 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 42 · `mahdibland-shadowsocks` × 46 · `matin-v2ray` × 3 · `mfuu-clash` × 3 · `ninjastrikers` × 10 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 12
