...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-1889-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-305ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_02:20_UTC-informational)
...
- **Nodes selected**: 126
- **Alive across all sources**: 1889
- **Fastest node RTT**: 31 ms
- **Median RTT**: 305 ms
- **Last updated (UTC)**: 2026-07-12 02:20 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 60 · trojan × 26 · vless × 22 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 6 · `ninjastrikers` × 24 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
