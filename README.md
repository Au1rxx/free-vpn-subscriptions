...
![nodes](https://img.shields.io/badge/nodes-92-brightgreen) ![alive](https://img.shields.io/badge/alive-2199-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-568ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-29_11:28_UTC-informational)
...
- **Median RTT**: 568 ms
- **Last updated (UTC)**: 2026-06-29 11:28 UTC

**Protocol mix:** shadowsocks × 16 · trojan × 40 · vless × 21 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 18 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 2
