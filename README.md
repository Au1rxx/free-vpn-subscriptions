...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2413-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-227ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_20:29_UTC-informational)
...
- **Median RTT**: 227 ms
- **Last updated (UTC)**: 2026-05-10 20:29 UTC

**Protocol mix:** shadowsocks × 50 · trojan × 12 · vless × 77 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 52 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 6 · `surfboard-eternity` × 2 · `vxiaov-clash` × 1
