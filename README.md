...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2642-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-84ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_06:30_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2642
- **Fastest node RTT**: 23 ms
- **Median RTT**: 84 ms
- **Last updated (UTC)**: 2026-04-25 06:30 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 8 · vless × 108 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 21 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 68 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
