...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1966-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-180ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_13:21_UTC-informational)
...
- **Median RTT**: 180 ms
- **Last updated (UTC)**: 2026-05-07 13:21 UTC

**Protocol mix:** shadowsocks × 53 · trojan × 6 · vless × 81 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 64 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
