...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2470-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-136ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-14_23:13_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2470
- **Fastest node RTT**: 34 ms
- **Median RTT**: 136 ms
- **Last updated (UTC)**: 2026-05-14 23:13 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 25 · vless × 79 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 50 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
