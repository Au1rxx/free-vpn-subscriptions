...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-2556-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-370ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_15:16_UTC-informational)
...
- **Median RTT**: 370 ms
- **Last updated (UTC)**: 2026-04-22 15:16 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 21 · vless × 77 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 29 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 58 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 9
