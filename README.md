...
![nodes](https://img.shields.io/badge/nodes-149-brightgreen) ![alive](https://img.shields.io/badge/alive-1558-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-388ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_17:25_UTC-informational)
...
- **Nodes selected**: 149
- **Alive across all sources**: 1558
- **Fastest node RTT**: 25 ms
- **Median RTT**: 388 ms
- **Last updated (UTC)**: 2026-07-07 17:25 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 92 · trojan × 27 · vless × 14 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 26 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 32 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 7 · `ruking-clash` × 1 · `surfboard-eternity` × 3
