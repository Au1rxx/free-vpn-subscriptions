...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-392-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-139ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-19_06:05_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 392
- **Fastest node RTT**: 1 ms
- **Median RTT**: 139 ms
- **Last updated (UTC)**: 2026-04-19 06:05 UTC

**Protocol mix:** shadowsocks × 97 · trojan × 8 · vmess × 45

**Sources used this run:** `freefq` × 2 · `mahdibland-aggregator` × 86 · `mahdibland-shadowsocks` × 45 · `pawdroid` × 1 · `vxiaov-clash` × 16
