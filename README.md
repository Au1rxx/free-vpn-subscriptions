...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2229-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-117ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_09:25_UTC-informational)
...
- **Median RTT**: 117 ms
- **Last updated (UTC)**: 2026-04-30 09:25 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 18 · vless × 90 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 31 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 66 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 9
