...
![nodes](https://img.shields.io/badge/nodes-82-brightgreen) ![alive](https://img.shields.io/badge/alive-2049-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-353ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_19:23_UTC-informational)
...
- **Median RTT**: 353 ms
- **Last updated (UTC)**: 2026-07-01 19:23 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 18 · vless × 12 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 3 · `surfboard-eternity` × 4
