...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2610-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-107ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-28_01:14_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2610
- **Fastest node RTT**: 30 ms
- **Median RTT**: 107 ms
- **Last updated (UTC)**: 2026-04-28 01:14 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 6 · vless × 107 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 5 · `ninjastrikers` × 61 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
