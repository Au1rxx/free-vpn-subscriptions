...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2165-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-83ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_12:24_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2165
- **Fastest node RTT**: 30 ms
- **Median RTT**: 83 ms
- **Last updated (UTC)**: 2026-05-01 12:24 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 13 · vless × 85 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
