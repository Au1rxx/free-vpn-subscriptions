...
![nodes](https://img.shields.io/badge/nodes-107-brightgreen) ![alive](https://img.shields.io/badge/alive-1888-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-303ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-09_03:22_UTC-informational)
...
- **Median RTT**: 303 ms
- **Last updated (UTC)**: 2026-06-09 03:22 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 22 · vless × 29 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 27 · `pawdroid` × 4 · `ruking-clash` × 9 · `surfboard-eternity` × 3
