...
![nodes](https://img.shields.io/badge/nodes-60-brightgreen) ![alive](https://img.shields.io/badge/alive-1971-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-149ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-27_16:31_UTC-informational)
...
- **Median RTT**: 149 ms
- **Last updated (UTC)**: 2026-05-27 16:31 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 12 · vless × 17 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 4 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 3
