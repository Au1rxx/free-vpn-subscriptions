...
- **Nodes selected**: 2000
- **Alive across all sources**: 28739
- **Fastest node RTT**: 16 ms
- **Median RTT**: 259 ms
- **Last updated (UTC)**: 2026-08-19 06:24 UTC

**Protocol mix:** https × 1 · hysteria2 × 106 · shadowsocks × 74 · trojan × 1465 · tuic × 1 · vless × 236 · vmess × 43 · wireguard × 74
