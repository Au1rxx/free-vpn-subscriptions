...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2418-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-19_21:17_UTC-informational)
...
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-05-19 21:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 21 · vless × 70 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 2 · `ninjastrikers` × 49 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 8
