...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2122-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-173ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_01:12_UTC-informational)
...
- **Median RTT**: 173 ms
- **Last updated (UTC)**: 2026-06-21 01:12 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 28 · vless × 62 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 39 · `mahdi0024` × 26 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 4 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 22 · `snakem982` × 1 · `surfboard-eternity` × 4
