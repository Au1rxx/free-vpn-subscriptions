...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2212-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-106ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_04:38_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2212
- **Fastest node RTT**: 31 ms
- **Median RTT**: 106 ms
- **Last updated (UTC)**: 2026-04-30 04:38 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 5 · vless × 103 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 29 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 71 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 7
