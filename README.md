...
![nodes](https://img.shields.io/badge/nodes-144-brightgreen) ![alive](https://img.shields.io/badge/alive-2082-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-193ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_17:22_UTC-informational)
...
- **Median RTT**: 193 ms
- **Last updated (UTC)**: 2026-05-03 17:22 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 23 · vless × 82 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 3 · `ninjastrikers` × 54 · `ruking-clash` × 1 · `surfboard-eternity` × 6
