...
![nodes](https://img.shields.io/badge/nodes-98-brightgreen) ![alive](https://img.shields.io/badge/alive-2007-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-371ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-29_18:23_UTC-informational)
...
- **Median RTT**: 371 ms
- **Last updated (UTC)**: 2026-06-29 18:23 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 23 · vless × 26 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 7
