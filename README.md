...
![nodes](https://img.shields.io/badge/nodes-108-brightgreen) ![alive](https://img.shields.io/badge/alive-2302-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-109ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-31_01:36_UTC-informational)
...
- **Median RTT**: 109 ms
- **Last updated (UTC)**: 2026-05-31 01:36 UTC

**Protocol mix:** shadowsocks × 19 · trojan × 30 · vless × 31 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 15 · `epodonios` × 15 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 33 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
