...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2036-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-146ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_13:33_UTC-informational)
...
- **Median RTT**: 146 ms
- **Last updated (UTC)**: 2026-05-04 13:33 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 23 · vless × 85 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 59 · `pawdroid` × 3 · `surfboard-eternity` × 7
