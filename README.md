...
![nodes](https://img.shields.io/badge/nodes-76-brightgreen) ![alive](https://img.shields.io/badge/alive-2143-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-150ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-09_23:17_UTC-informational)
...
- **Median RTT**: 150 ms
- **Last updated (UTC)**: 2026-07-09 23:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 23 · trojan × 12 · vless × 8 · vmess × 32

**Sources used this run:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
