...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2259-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-150ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_07:28_UTC-informational)
...
- **Median RTT**: 150 ms
- **Last updated (UTC)**: 2026-04-22 07:28 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 4 · vless × 103 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 39 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 11 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 66 · `ruking-clash` × 4 · `surfboard-eternity` × 6
