...
![nodes](https://img.shields.io/badge/nodes-121-brightgreen) ![alive](https://img.shields.io/badge/alive-2461-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-493ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_10:26_UTC-informational)
...
- **Median RTT**: 493 ms
- **Last updated (UTC)**: 2026-06-19 10:26 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 32 · trojan × 21 · vless × 52 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 20 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 42 · `snakem982` × 3 · `surfboard-eternity` × 2
