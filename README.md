...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1926-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-304ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-16_17:18_UTC-informational)
...
- **Median RTT**: 304 ms
- **Last updated (UTC)**: 2026-06-16 17:18 UTC

**Protocol mix:** shadowsocks × 48 · trojan × 12 · vless × 15 · vmess × 75

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 16 · `lagzian-mix` × 1 · `mahdi0024` × 78 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 1
