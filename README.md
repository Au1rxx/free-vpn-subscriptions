...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2372-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-76ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-23_09:37_UTC-informational)
...
- **Median RTT**: 76 ms
- **Last updated (UTC)**: 2026-05-23 09:37 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 5 · vless × 101 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 68 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
