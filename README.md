...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2257-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-85ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-21_16:27_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2257
- **Fastest node RTT**: 37 ms
- **Median RTT**: 85 ms
- **Last updated (UTC)**: 2026-05-21 16:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 30 · trojan × 28 · vless × 81 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 43 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 9 · `surfboard-eternity` × 3
