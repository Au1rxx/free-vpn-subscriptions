...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-1857-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-369ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-15_09:12_UTC-informational)
...
- **Median RTT**: 369 ms
- **Last updated (UTC)**: 2026-06-15 09:12 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 22 · vless × 20 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 11 · `surfboard-eternity` × 9
