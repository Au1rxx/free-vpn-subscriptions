...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2564-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_01:13_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2564
- **Fastest node RTT**: 27 ms
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-04-27 01:13 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 5 · vless × 95 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 20 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 46 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 59 · `pawdroid` × 1 · `surfboard-eternity` × 3
