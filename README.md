...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2007-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-121ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_02:32_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2007
- **Fastest node RTT**: 35 ms
- **Median RTT**: 121 ms
- **Last updated (UTC)**: 2026-05-07 02:32 UTC

**Protocol mix:** shadowsocks × 44 · trojan × 5 · vless × 88 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 67 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
