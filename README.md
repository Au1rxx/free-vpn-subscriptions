...
![nodes](https://img.shields.io/badge/nodes-137-brightgreen) ![alive](https://img.shields.io/badge/alive-1923-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-383ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-04_14:13_UTC-informational)
...
- **Median RTT**: 383 ms
- **Last updated (UTC)**: 2026-07-04 14:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 70 · trojan × 27 · vless × 11 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 41 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 5 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 8
