...
![nodes](https://img.shields.io/badge/nodes-85-brightgreen) ![alive](https://img.shields.io/badge/alive-2269-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-319ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_14:15_UTC-informational)
...
- **Median RTT**: 319 ms
- **Last updated (UTC)**: 2026-07-02 14:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 22 · vless × 17 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 11 · `ninjastrikers` × 14 · `pawdroid` × 5 · `surfboard-eternity` × 1
