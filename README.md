...
![nodes](https://img.shields.io/badge/nodes-91-brightgreen) ![alive](https://img.shields.io/badge/alive-1945-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-208ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_19:25_UTC-informational)
...
- **Median RTT**: 208 ms
- **Last updated (UTC)**: 2026-07-05 19:25 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 22 · vless × 7 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 6 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 2
