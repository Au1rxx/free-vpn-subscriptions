...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-1961-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-184ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-28_00:12_UTC-informational)
...
- **Median RTT**: 184 ms
- **Last updated (UTC)**: 2026-06-28 00:12 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 42 · vless × 30 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 7
