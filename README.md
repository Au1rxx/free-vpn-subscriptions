...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1958-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-225ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_17:31_UTC-informational)
...
- **Median RTT**: 225 ms
- **Last updated (UTC)**: 2026-05-07 17:31 UTC

**Protocol mix:** shadowsocks × 61 · trojan × 8 · vless × 72 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 8 · `mahdi0024` × 12 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 57 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
