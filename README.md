...
![nodes](https://img.shields.io/badge/nodes-108-brightgreen) ![alive](https://img.shields.io/badge/alive-1904-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-455ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-12_17:17_UTC-informational)
...
- **Median RTT**: 455 ms
- **Last updated (UTC)**: 2026-06-12 17:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 37 · vless × 13 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 2
