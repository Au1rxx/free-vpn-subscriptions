...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-2080-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-299ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_00:22_UTC-informational)
...
- **Nodes selected**: 104
- **Alive across all sources**: 2080
- **Fastest node RTT**: 35 ms
- **Median RTT**: 299 ms
- **Last updated (UTC)**: 2026-07-02 00:22 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 30 · vless × 19 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 26 · `pawdroid` × 2 · `surfboard-eternity` × 2
