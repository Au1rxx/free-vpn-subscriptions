...
![nodes](https://img.shields.io/badge/nodes-149-brightgreen) ![alive](https://img.shields.io/badge/alive-1654-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-393ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-15_13:13_UTC-informational)
...
- **Nodes selected**: 149
- **Alive across all sources**: 1654
- **Fastest node RTT**: 30 ms
- **Median RTT**: 393 ms
- **Last updated (UTC)**: 2026-07-15 13:13 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 93 · trojan × 35 · vless × 12 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 20 · `mahdi0024` × 13 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 9 · `surfboard-eternity` × 4
