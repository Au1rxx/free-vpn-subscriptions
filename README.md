...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2440-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-79ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-15_09:14_UTC-informational)
...
- **Median RTT**: 79 ms
- **Last updated (UTC)**: 2026-05-15 09:14 UTC

**Protocol mix:** shadowsocks × 44 · trojan × 6 · vless × 91 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 57 · `pawdroid` × 8 · `ruking-clash` × 5 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
