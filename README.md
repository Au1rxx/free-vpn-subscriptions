...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2515-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-106ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_01:33_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2515
- **Fastest node RTT**: 29 ms
- **Median RTT**: 106 ms
- **Last updated (UTC)**: 2026-05-10 01:33 UTC

**Protocol mix:** shadowsocks × 50 · trojan × 4 · vless × 88 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 32 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 66 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
