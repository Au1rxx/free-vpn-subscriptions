...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2354-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-21_04:10_UTC-informational)
...
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-05-21 04:10 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 39 · trojan × 11 · vless × 79 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 1 · `ninjastrikers` × 61 · `pawdroid` × 7 · `ruking-clash` × 3 · `surfboard-eternity` × 10
