...
![nodes](https://img.shields.io/badge/nodes-117-brightgreen) ![alive](https://img.shields.io/badge/alive-1901-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-324ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_04:35_UTC-informational)
...
- **Median RTT**: 324 ms
- **Last updated (UTC)**: 2026-06-13 04:35 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 51 · trojan × 30 · vless × 26 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 32 · `pawdroid` × 7 · `ruking-clash` × 9 · `surfboard-eternity` × 2
