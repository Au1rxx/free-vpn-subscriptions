...
![nodes](https://img.shields.io/badge/nodes-119-brightgreen) ![alive](https://img.shields.io/badge/alive-1953-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-333ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_06:26_UTC-informational)
...
- **Nodes selected**: 119
- **Alive across all sources**: 1953
- **Fastest node RTT**: 36 ms
- **Median RTT**: 333 ms
- **Last updated (UTC)**: 2026-07-06 06:26 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 26 · vless × 12 · vmess × 30

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 5
