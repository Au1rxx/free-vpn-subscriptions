...
![nodes](https://img.shields.io/badge/nodes-129-brightgreen) ![alive](https://img.shields.io/badge/alive-2129-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-358ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_15:21_UTC-informational)
...
- **Nodes selected**: 129
- **Alive across all sources**: 2129
- **Fastest node RTT**: 33 ms
- **Median RTT**: 358 ms
- **Last updated (UTC)**: 2026-06-20 15:21 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 33 · vless × 27 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `mahdi0024` × 27 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 29 · `snakem982` × 2 · `surfboard-eternity` × 2
