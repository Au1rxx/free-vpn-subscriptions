...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2542-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-85ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_06:09_UTC-informational)
...
- **Median RTT**: 85 ms
- **Last updated (UTC)**: 2026-04-27 06:09 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 6 · vless × 97 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 25 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 48 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 51 · `surfboard-eternity` × 4
