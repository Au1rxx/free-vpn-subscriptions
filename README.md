...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2266-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-125ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_00:15_UTC-informational)
...
- **Median RTT**: 125 ms
- **Last updated (UTC)**: 2026-04-21 00:15 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 4 · vless × 111 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 52 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7
