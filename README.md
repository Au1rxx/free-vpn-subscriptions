...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2599-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-70ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-20_09:11_UTC-informational)
...
- **Median RTT**: 70 ms
- **Last updated (UTC)**: 2026-05-20 09:11 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 7 · vless × 94 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 26 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 70 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
