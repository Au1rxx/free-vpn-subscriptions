...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2604-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-164ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_03:37_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2604
- **Fastest node RTT**: 27 ms
- **Median RTT**: 164 ms
- **Last updated (UTC)**: 2026-04-23 03:37 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 16 · vless × 96 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 26 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 77 · `snakem982` × 1 · `surfboard-eternity` × 6
