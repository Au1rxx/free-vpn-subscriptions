...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2462-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-76ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-18_11:25_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2462
- **Fastest node RTT**: 33 ms
- **Median RTT**: 76 ms
- **Last updated (UTC)**: 2026-05-18 11:25 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 8 · vless × 93 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 21 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 37 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
