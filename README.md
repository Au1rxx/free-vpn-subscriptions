...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-391-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-95ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-19_06:53_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 391
- **Fastest node RTT**: 5 ms
- **Median RTT**: 95 ms
- **Last updated (UTC)**: 2026-04-19 06:53 UTC

**Protocol mix:** shadowsocks × 100 · trojan × 12 · vmess × 38

**Sources used this run:** `freefq` × 2 · `mahdibland-aggregator` × 62 · `mahdibland-shadowsocks` × 70 · `pawdroid` × 2 · `vxiaov-clash` × 14
