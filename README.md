...
![nodes](https://img.shields.io/badge/nodes-133-brightgreen) ![alive](https://img.shields.io/badge/alive-2331-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-67ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-19_11:26_UTC-informational)
...
- **Median RTT**: 67 ms
- **Last updated (UTC)**: 2026-05-19 11:26 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 14 · trojan × 23 · vless × 80 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 56 · `pawdroid` × 9 · `surfboard-eternity` × 2
