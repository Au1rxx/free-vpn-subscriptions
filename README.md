...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2146-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-217ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_22:29_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2146
- **Fastest node RTT**: 34 ms
- **Median RTT**: 217 ms
- **Last updated (UTC)**: 2026-04-29 22:29 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 22 · vless × 81 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 43 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 54 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
