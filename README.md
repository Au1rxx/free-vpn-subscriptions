...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2525-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-86ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_09:27_UTC-informational)
...
- **Median RTT**: 86 ms
- **Last updated (UTC)**: 2026-04-25 09:27 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 13 · vless × 101 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 64 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
