...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-394-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-137ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-19_09:40_UTC-informational)
...
- **Median RTT**: 137 ms
- **Last updated (UTC)**: 2026-04-19 09:40 UTC

**Protocol mix:** shadowsocks × 101 · trojan × 8 · vmess × 41

**Sources used this run:** `freefq` × 2 · `mahdibland-aggregator` × 56 · `mahdibland-shadowsocks` × 73 · `pawdroid` × 4 · `vxiaov-clash` × 15
