...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-2414-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-109ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-01_02:26_UTC-informational)
...
- **Median RTT**: 109 ms
- **Last updated (UTC)**: 2026-06-01 02:26 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 25 · vless × 32 · vmess × 33

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 32 · `pawdroid` × 7 · `surfboard-eternity` × 2
