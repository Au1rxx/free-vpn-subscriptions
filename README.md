...
![nodes](https://img.shields.io/badge/nodes-76-brightgreen) ![alive](https://img.shields.io/badge/alive-2147-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-211ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-28_22:25_UTC-informational)
...
- **Median RTT**: 211 ms
- **Last updated (UTC)**: 2026-05-28 22:25 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 28 · vless × 10 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 3
