...
![nodes](https://img.shields.io/badge/nodes-78-brightgreen) ![alive](https://img.shields.io/badge/alive-2255-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-278ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_13:11_UTC-informational)
...
- **Nodes selected**: 78
- **Alive across all sources**: 2255
- **Fastest node RTT**: 27 ms
- **Median RTT**: 278 ms
- **Last updated (UTC)**: 2026-07-02 13:11 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 21 · vless × 10 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 7 · `ninjastrikers` × 13 · `pawdroid` × 3 · `surfboard-eternity` × 7
