...
![nodes](https://img.shields.io/badge/nodes-138-brightgreen) ![alive](https://img.shields.io/badge/alive-1611-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-420ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_18:13_UTC-informational)
...
- **Median RTT**: 420 ms
- **Last updated (UTC)**: 2026-06-14 18:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 72 · trojan × 31 · vless × 23 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 4
