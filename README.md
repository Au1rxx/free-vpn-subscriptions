...
![nodes](https://img.shields.io/badge/nodes-92-brightgreen) ![alive](https://img.shields.io/badge/alive-2021-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-380ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_16:36_UTC-informational)
...
- **Median RTT**: 380 ms
- **Last updated (UTC)**: 2026-06-26 16:36 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 33 · vless × 17 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 17 · `surfboard-eternity` × 3
