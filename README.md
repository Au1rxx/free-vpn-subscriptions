...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2493-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-143ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_10:28_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2493
- **Fastest node RTT**: 24 ms
- **Median RTT**: 143 ms
- **Last updated (UTC)**: 2026-05-10 10:28 UTC

**Protocol mix:** shadowsocks × 49 · trojan × 7 · vless × 86 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 32 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 9
