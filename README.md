...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2073-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-102ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-02_02:30_UTC-informational)
...
- **Median RTT**: 102 ms
- **Last updated (UTC)**: 2026-05-02 02:30 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 8 · vless × 94 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 61 · `pawdroid` × 3 · `surfboard-eternity` × 8
