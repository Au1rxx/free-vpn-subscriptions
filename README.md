...
![nodes](https://img.shields.io/badge/nodes-144-brightgreen) ![alive](https://img.shields.io/badge/alive-1974-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-501ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-16_22:32_UTC-informational)
...
- **Median RTT**: 501 ms
- **Last updated (UTC)**: 2026-06-16 22:32 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 16 · vmess × 54

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 58 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `ruking-clash` × 18
