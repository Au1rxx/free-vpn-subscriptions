...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2595-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-146ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_01:22_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2595
- **Fastest node RTT**: 31 ms
- **Median RTT**: 146 ms
- **Last updated (UTC)**: 2026-04-23 01:22 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 13 · vless × 99 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 28 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 76 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 7
