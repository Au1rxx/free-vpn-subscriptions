...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2274-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-275ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-20_15:11_UTC-informational)
...
- **Median RTT**: 275 ms
- **Last updated (UTC)**: 2026-04-20 15:11 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 12 · vless × 98 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 51 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `ruking-clash` × 6 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
