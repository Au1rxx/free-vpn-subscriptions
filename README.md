...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2201-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-157ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-02_14:31_UTC-informational)
...
- **Median RTT**: 157 ms
- **Last updated (UTC)**: 2026-05-02 14:31 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 20 · vless × 84 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 24 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 58 · `pawdroid` × 4 · `surfboard-eternity` × 5
