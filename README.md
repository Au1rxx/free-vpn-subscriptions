...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2273-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-159ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_08:34_UTC-informational)
...
- **Median RTT**: 159 ms
- **Last updated (UTC)**: 2026-04-22 08:34 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 4 · vless × 103 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 42 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 6
