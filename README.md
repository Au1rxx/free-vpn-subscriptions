...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2251-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-441ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_22:29_UTC-informational)
...
- **Median RTT**: 441 ms
- **Last updated (UTC)**: 2026-04-21 22:29 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 22 · vless × 84 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 47 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 5
