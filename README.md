...
![nodes](https://img.shields.io/badge/nodes-98-brightgreen) ![alive](https://img.shields.io/badge/alive-1905-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-346ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_21:25_UTC-informational)
...
- **Nodes selected**: 98
- **Alive across all sources**: 1905
- **Fastest node RTT**: 32 ms
- **Median RTT**: 346 ms
- **Last updated (UTC)**: 2026-07-06 21:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 46 · trojan × 25 · vless × 8 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
