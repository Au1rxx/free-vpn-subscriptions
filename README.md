...
![nodes](https://img.shields.io/badge/nodes-145-brightgreen) ![alive](https://img.shields.io/badge/alive-2083-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-372ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_05:24_UTC-informational)
...
- **Median RTT**: 372 ms
- **Last updated (UTC)**: 2026-06-23 05:24 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 39 · trojan × 29 · vless × 63 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 50 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 21 · `pawdroid` × 4 · `ruking-clash` × 19 · `surfboard-eternity` × 5
