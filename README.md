...
![nodes](https://img.shields.io/badge/nodes-146-brightgreen) ![alive](https://img.shields.io/badge/alive-2057-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-429ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_12:34_UTC-informational)
...
- **Median RTT**: 429 ms
- **Last updated (UTC)**: 2026-06-21 12:34 UTC

**Protocol mix:** shadowsocks × 45 · trojan × 34 · vless × 44 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 21 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 37 · `surfboard-eternity` × 3
