...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-2126-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-364ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_10:14_UTC-informational)
...
- **Median RTT**: 364 ms
- **Last updated (UTC)**: 2026-07-02 10:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 47 · trojan × 24 · vless × 15 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 5 · `surfboard-eternity` × 4
