...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2234-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-150ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_03:34_UTC-informational)
...
- **Median RTT**: 150 ms
- **Last updated (UTC)**: 2026-04-22 03:34 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 4 · vless × 101 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 39 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `pawdroid` × 1 · `ruking-clash` × 5 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
