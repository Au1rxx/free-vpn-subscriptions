...
![nodes](https://img.shields.io/badge/nodes-97-brightgreen) ![alive](https://img.shields.io/badge/alive-1865-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-369ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_11:32_UTC-informational)
...
- **Median RTT**: 369 ms
- **Last updated (UTC)**: 2026-06-13 11:32 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 56 · trojan × 23 · vless × 10 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 3
