...
- **Nodes selected**: 2000
- **Alive across all sources**: 3748
- **Fastest node RTT**: 24 ms
- **Median RTT**: 574 ms
- **Last updated (UTC)**: 2026-08-01 23:28 UTC

**Protocol mix:** http × 212 · https × 2 · hysteria2 × 136 · shadowsocks × 199 · socks4 × 25 · socks5 × 118 · trojan × 313 · tuic × 4 · vless × 989 · vmess × 2
