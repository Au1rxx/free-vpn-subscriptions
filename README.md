...
![nodes](https://img.shields.io/badge/nodes-100-brightgreen) ![alive](https://img.shields.io/badge/alive-2148-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-158ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_03:10_UTC-informational)
...
- **Median RTT**: 158 ms
- **Last updated (UTC)**: 2026-06-06 03:10 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 27 · vless × 31 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 26 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 30 · `surfboard-eternity` × 1
