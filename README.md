...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2661-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-74ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-17_12:32_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2661
- **Fastest node RTT**: 28 ms
- **Median RTT**: 74 ms
- **Last updated (UTC)**: 2026-05-17 12:32 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 9 · vless × 89 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 6 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 5 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 5
