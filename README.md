...
![nodes](https://img.shields.io/badge/nodes-96-brightgreen) ![alive](https://img.shields.io/badge/alive-1925-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-221ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-11_20:38_UTC-informational)
...
- **Median RTT**: 221 ms
- **Last updated (UTC)**: 2026-07-11 20:38 UTC

**Protocol mix:** shadowsocks × 52 · trojan × 16 · vless × 13 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 3 · `surfboard-eternity` × 4
