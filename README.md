...
![nodes](https://img.shields.io/badge/nodes-53-brightgreen) ![alive](https://img.shields.io/badge/alive-2055-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-225ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-29_13:19_UTC-informational)
...
- **Median RTT**: 225 ms
- **Last updated (UTC)**: 2026-05-29 13:19 UTC

**Protocol mix:** shadowsocks × 20 · trojan × 15 · vless × 9 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 8 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
