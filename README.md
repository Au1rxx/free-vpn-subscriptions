...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2055-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-132ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-22_04:12_UTC-informational)
...
- **Median RTT**: 132 ms
- **Last updated (UTC)**: 2026-05-22 04:12 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 39 · trojan × 13 · vless × 86 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 67 · `pawdroid` × 5 · `ruking-clash` × 7 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
