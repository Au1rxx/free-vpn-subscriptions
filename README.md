...
![nodes](https://img.shields.io/badge/nodes-82-brightgreen) ![alive](https://img.shields.io/badge/alive-2081-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-310ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_23:38_UTC-informational)
...
- **Median RTT**: 310 ms
- **Last updated (UTC)**: 2026-07-01 23:38 UTC

**Protocol mix:** shadowsocks × 45 · trojan × 19 · vless × 11 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 6 · `ninjastrikers` × 18 · `pawdroid` × 1 · `surfboard-eternity` × 3
