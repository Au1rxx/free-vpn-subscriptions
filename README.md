...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2467-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-105ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_02:21_UTC-informational)
...
- **Median RTT**: 105 ms
- **Last updated (UTC)**: 2026-04-24 02:21 UTC

**Protocol mix:** shadowsocks × 18 · trojan × 14 · vless × 104 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 26 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 21 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 75 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
