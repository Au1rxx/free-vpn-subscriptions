...
![nodes](https://img.shields.io/badge/nodes-128-brightgreen) ![alive](https://img.shields.io/badge/alive-2541-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-346ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_21:23_UTC-informational)
...
- **Nodes selected**: 128
- **Alive across all sources**: 2541
- **Fastest node RTT**: 33 ms
- **Median RTT**: 346 ms
- **Last updated (UTC)**: 2026-04-22 21:23 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 21 · vless × 67 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
