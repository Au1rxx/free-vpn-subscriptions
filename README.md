...
![nodes](https://img.shields.io/badge/nodes-118-brightgreen) ![alive](https://img.shields.io/badge/alive-1854-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-331ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_06:38_UTC-informational)
...
- **Median RTT**: 331 ms
- **Last updated (UTC)**: 2026-07-07 06:38 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 48 · trojan × 22 · vless × 23 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 27 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 9 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 2
