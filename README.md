...
![nodes](https://img.shields.io/badge/nodes-81-brightgreen) ![alive](https://img.shields.io/badge/alive-2444-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-78ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-03_12:24_UTC-informational)
...
- **Median RTT**: 78 ms
- **Last updated (UTC)**: 2026-06-03 12:24 UTC

**Protocol mix:** shadowsocks × 14 · trojan × 38 · vless × 6 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 27 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 9 · `pawdroid` × 2 · `surfboard-eternity` × 4
