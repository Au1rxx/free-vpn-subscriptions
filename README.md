...
![nodes](https://img.shields.io/badge/nodes-114-brightgreen) ![alive](https://img.shields.io/badge/alive-1910-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-198ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-04_15:35_UTC-informational)
...
- **Median RTT**: 198 ms
- **Last updated (UTC)**: 2026-06-04 15:35 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 57 · vless × 19 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 40 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `ruking-clash` × 3 · `surfboard-eternity` × 2
