...
![nodes](https://img.shields.io/badge/nodes-121-brightgreen) ![alive](https://img.shields.io/badge/alive-1977-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-368ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-28_07:33_UTC-informational)
...
- **Median RTT**: 368 ms
- **Last updated (UTC)**: 2026-06-28 07:33 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 42 · vless × 29 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
