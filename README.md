...
![nodes](https://img.shields.io/badge/nodes-127-brightgreen) ![alive](https://img.shields.io/badge/alive-2552-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-488ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_12:14_UTC-informational)
...
- **Nodes selected**: 127
- **Alive across all sources**: 2552
- **Fastest node RTT**: 31 ms
- **Median RTT**: 488 ms
- **Last updated (UTC)**: 2026-06-19 12:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 34 · trojan × 26 · vless × 46 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 17 · `epodonios` × 22 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 4 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 6 · `surfboard-eternity` × 2
