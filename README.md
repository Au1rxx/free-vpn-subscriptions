...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2548-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-93ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_02:27_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2548
- **Fastest node RTT**: 28 ms
- **Median RTT**: 93 ms
- **Last updated (UTC)**: 2026-04-27 02:27 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 3 · vless × 99 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 19 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 47 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 56 · `pawdroid` × 1 · `surfboard-eternity` × 4
