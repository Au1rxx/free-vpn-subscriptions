...
![nodes](https://img.shields.io/badge/nodes-99-brightgreen) ![alive](https://img.shields.io/badge/alive-2024-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-328ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-10_16:19_UTC-informational)
...
- **Median RTT**: 328 ms
- **Last updated (UTC)**: 2026-06-10 16:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 19 · vless × 16 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 12 · `pawdroid` × 6 · `ruking-clash` × 9 · `surfboard-eternity` × 5
