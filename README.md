...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1679-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-394ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-14_18:27_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1679
- **Fastest node RTT**: 31 ms
- **Median RTT**: 394 ms
- **Last updated (UTC)**: 2026-07-14 18:27 UTC

**Protocol mix:** hysteria2 × 5 · shadowsocks × 94 · trojan × 26 · vless × 16 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 5 · `epodonios` × 31 · `mahdi0024` × 12 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 11 · `snakem982` × 1 · `surfboard-eternity` × 1
