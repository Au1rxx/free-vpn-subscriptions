...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2473-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-77ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-21_14:33_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2473
- **Fastest node RTT**: 31 ms
- **Median RTT**: 77 ms
- **Last updated (UTC)**: 2026-05-21 14:33 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 13 · vless × 83 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 58 · `pawdroid` × 10 · `ruking-clash` × 2 · `surfboard-eternity` × 8
