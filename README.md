...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2213-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-155ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_04:29_UTC-informational)
...
- **Median RTT**: 155 ms
- **Last updated (UTC)**: 2026-05-06 04:29 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 21 · vless × 84 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 75 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
