...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2609-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-98ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-28_02:39_UTC-informational)
...
- **Median RTT**: 98 ms
- **Last updated (UTC)**: 2026-04-28 02:39 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 4 · vless × 113 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 6 · `ninjastrikers` × 62 · `ruking-clash` × 1 · `surfboard-eternity` × 4
