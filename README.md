...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1935-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-142ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_08:11_UTC-informational)
...
- **Median RTT**: 142 ms
- **Last updated (UTC)**: 2026-05-07 08:11 UTC

**Protocol mix:** shadowsocks × 50 · trojan × 5 · vless × 86 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 70 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
