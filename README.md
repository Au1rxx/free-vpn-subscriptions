...
![nodes](https://img.shields.io/badge/nodes-75-brightgreen) ![alive](https://img.shields.io/badge/alive-1965-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-174ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-04_09:34_UTC-informational)
...
- **Median RTT**: 174 ms
- **Last updated (UTC)**: 2026-07-04 09:34 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 18 · vless × 8 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 5 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
