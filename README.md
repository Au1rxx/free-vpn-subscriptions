...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-2464-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-148ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_12:27_UTC-informational)
...
- **Median RTT**: 148 ms
- **Last updated (UTC)**: 2026-04-24 12:27 UTC

**Protocol mix:** shadowsocks × 14 · trojan × 23 · vless × 90 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
