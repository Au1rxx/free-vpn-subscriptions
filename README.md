...
![nodes](https://img.shields.io/badge/nodes-143-brightgreen) ![alive](https://img.shields.io/badge/alive-2256-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-277ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_15:31_UTC-informational)
...
- **Median RTT**: 277 ms
- **Last updated (UTC)**: 2026-05-04 15:31 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 23 · vless × 70 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 58 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 8
