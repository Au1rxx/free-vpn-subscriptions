...
![nodes](https://img.shields.io/badge/nodes-116-brightgreen) ![alive](https://img.shields.io/badge/alive-2546-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-488ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_09:20_UTC-informational)
...
- **Nodes selected**: 116
- **Alive across all sources**: 2546
- **Fastest node RTT**: 34 ms
- **Median RTT**: 488 ms
- **Last updated (UTC)**: 2026-06-19 09:20 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 32 · trojan × 25 · vless × 41 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 15 · `mahdi0024` × 6 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 36 · `snakem982` × 4 · `surfboard-eternity` × 4
