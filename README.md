...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2197-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-87ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_08:17_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2197
- **Fastest node RTT**: 27 ms
- **Median RTT**: 87 ms
- **Last updated (UTC)**: 2026-04-26 08:17 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 10 · vless × 100 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 23 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
