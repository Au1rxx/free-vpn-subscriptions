...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1990-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-399ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-16_04:14_UTC-informational)
...
- **Median RTT**: 399 ms
- **Last updated (UTC)**: 2026-07-16 04:14 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 46 · trojan × 71 · vless × 21 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 69 · `matin-v2ray` × 4 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 8 · `surfboard-eternity` × 1
