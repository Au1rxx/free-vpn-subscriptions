...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2103-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-84ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_00:24_UTC-informational)
...
- **Median RTT**: 84 ms
- **Last updated (UTC)**: 2026-05-03 00:24 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 7 · vless × 100 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 62 · `surfboard-eternity` × 8 · `vxiaov-clash` × 2
