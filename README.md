...
![nodes](https://img.shields.io/badge/nodes-145-brightgreen) ![alive](https://img.shields.io/badge/alive-2526-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-187ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_10:10_UTC-informational)
...
- **Median RTT**: 187 ms
- **Last updated (UTC)**: 2026-04-23 10:10 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 20 · vless × 87 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 67 · `pawdroid` × 1 · `surfboard-eternity` × 5
