...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2364-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-92ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-23_15:25_UTC-informational)
...
- **Median RTT**: 92 ms
- **Last updated (UTC)**: 2026-05-23 15:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 22 · vless × 71 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `surfboard-eternity` × 7
