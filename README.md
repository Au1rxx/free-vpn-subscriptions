...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2330-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-397ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_05:23_UTC-informational)
...
- **Median RTT**: 397 ms
- **Last updated (UTC)**: 2026-07-18 05:23 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 89 · vless × 13 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 3 · `mahdi0024` × 50 · `mahdibland-aggregator` × 31 · `mahdibland-shadowsocks` × 35 · `matin-v2ray` × 3 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 4 · `snakem982` × 4 · `surfboard-eternity` × 3
