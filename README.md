...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2100-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-196ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_23:18_UTC-informational)
...
- **Median RTT**: 196 ms
- **Last updated (UTC)**: 2026-04-29 23:18 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 21 · vless × 81 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 40 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 54 · `pawdroid` × 2 · `surfboard-eternity` × 2 · `vxiaov-clash` × 2
