...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2258-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-95ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_06:36_UTC-informational)
...
- **Median RTT**: 95 ms
- **Last updated (UTC)**: 2026-05-01 06:36 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 11 · vless × 93 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 63 · `surfboard-eternity` × 5
