...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2480-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-93ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_05:37_UTC-informational)
...
- **Median RTT**: 93 ms
- **Last updated (UTC)**: 2026-05-25 05:37 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 3 · vless × 84 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 19 · `epodonios` × 5 · `mahdi0024` × 41 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 61 · `pawdroid` × 4 · `ruking-clash` × 5 · `surfboard-eternity` × 4
