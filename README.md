...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2103-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-101ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_01:33_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2103
- **Fastest node RTT**: 38 ms
- **Median RTT**: 101 ms
- **Last updated (UTC)**: 2026-04-29 01:33 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 5 · vless × 102 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 31 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7
