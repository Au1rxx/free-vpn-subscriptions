...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2524-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-96ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_12:15_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2524
- **Fastest node RTT**: 28 ms
- **Median RTT**: 96 ms
- **Last updated (UTC)**: 2026-04-27 12:15 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 5 · vless × 101 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 44 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 58 · `pawdroid` × 1 · `surfboard-eternity` × 5
