...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1832-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-470ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_16:37_UTC-informational)
...
- **Median RTT**: 470 ms
- **Last updated (UTC)**: 2026-06-22 16:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 26 · vless × 68 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 4
