...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1974-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-146ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_05:23_UTC-informational)
...
- **Median RTT**: 146 ms
- **Last updated (UTC)**: 2026-05-12 05:23 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 57 · trojan × 5 · vless × 77 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 4 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 12
