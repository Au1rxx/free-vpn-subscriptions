...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2575-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-97ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-28_03:38_UTC-informational)
...
- **Median RTT**: 97 ms
- **Last updated (UTC)**: 2026-04-28 03:38 UTC

**Protocol mix:** shadowsocks × 18 · trojan × 4 · vless × 120 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 31 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 6 · `ninjastrikers` × 64 · `ruking-clash` × 1 · `surfboard-eternity` × 6
