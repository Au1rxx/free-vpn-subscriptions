...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-1813-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-401ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_17:28_UTC-informational)
...
- **Median RTT**: 401 ms
- **Last updated (UTC)**: 2026-06-13 17:28 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 54 · trojan × 29 · vless × 14 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 5
