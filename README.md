...
![nodes](https://img.shields.io/badge/nodes-109-brightgreen) ![alive](https://img.shields.io/badge/alive-1937-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-362ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-13_13:35_UTC-informational)
...
- **Median RTT**: 362 ms
- **Last updated (UTC)**: 2026-07-13 13:35 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 53 · trojan × 21 · vless × 19 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 15 · `mahdi0024` × 26 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
