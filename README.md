...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2094-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-175ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_15:28_UTC-informational)
...
- **Median RTT**: 175 ms
- **Last updated (UTC)**: 2026-05-03 15:28 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 22 · vless × 87 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 25 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
