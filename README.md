...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2605-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-86ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-28_08:31_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2605
- **Fastest node RTT**: 27 ms
- **Median RTT**: 86 ms
- **Last updated (UTC)**: 2026-04-28 08:31 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 11 · vless × 104 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 66 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 5
