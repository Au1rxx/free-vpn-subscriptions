...
![nodes](https://img.shields.io/badge/nodes-91-brightgreen) ![alive](https://img.shields.io/badge/alive-2395-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-165ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-01_11:37_UTC-informational)
...
- **Median RTT**: 165 ms
- **Last updated (UTC)**: 2026-06-01 11:37 UTC

**Protocol mix:** shadowsocks × 19 · trojan × 29 · vless × 7 · vmess × 36

**Sources used this run:** `barry-far-v2ray` × 20 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 11 · `surfboard-eternity` × 2
