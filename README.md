...
![nodes](https://img.shields.io/badge/nodes-131-brightgreen) ![alive](https://img.shields.io/badge/alive-2400-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-471ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_00:32_UTC-informational)
...
- **Median RTT**: 471 ms
- **Last updated (UTC)**: 2026-06-19 00:32 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 44 · trojan × 28 · vless × 49 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 12 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 28 · `pawdroid` × 3 · `ruking-clash` × 32 · `snakem982` × 10 · `surfboard-eternity` × 3
