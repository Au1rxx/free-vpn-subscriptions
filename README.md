...
![nodes](https://img.shields.io/badge/nodes-83-brightgreen) ![alive](https://img.shields.io/badge/alive-1845-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-378ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-30_19:26_UTC-informational)
...
- **Median RTT**: 378 ms
- **Last updated (UTC)**: 2026-06-30 19:26 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 33 · trojan × 30 · vless × 14 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 8 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 3
