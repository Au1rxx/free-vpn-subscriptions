...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2302-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-117ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-05_08:15_UTC-informational)
...
- **Median RTT**: 117 ms
- **Last updated (UTC)**: 2026-05-05 08:15 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 17 · vless × 86 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 68 · `ruking-clash` × 2 · `surfboard-eternity` × 8
