...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2314-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-309ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_15:24_UTC-informational)
...
- **Median RTT**: 309 ms
- **Last updated (UTC)**: 2026-04-21 15:24 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 16 · vless × 87 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 46 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 56 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 9
