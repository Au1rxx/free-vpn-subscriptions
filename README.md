...
![nodes](https://img.shields.io/badge/nodes-89-brightgreen) ![alive](https://img.shields.io/badge/alive-1872-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-161ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-03_07:34_UTC-informational)
...
- **Nodes selected**: 89
- **Alive across all sources**: 1872
- **Fastest node RTT**: 31 ms
- **Median RTT**: 161 ms
- **Last updated (UTC)**: 2026-07-03 07:34 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 21 · vless × 16 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 5 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
