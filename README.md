...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2253-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-246ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-20_17:20_UTC-informational)
...
- **Median RTT**: 246 ms
- **Last updated (UTC)**: 2026-04-20 17:20 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 13 · vless × 96 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 51 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 7
