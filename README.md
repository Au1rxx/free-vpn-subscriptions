...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2444-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-76ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-18_13:29_UTC-informational)
...
- **Median RTT**: 76 ms
- **Last updated (UTC)**: 2026-05-18 13:29 UTC

**Protocol mix:** shadowsocks × 44 · trojan × 7 · vless × 92 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 21 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 6
