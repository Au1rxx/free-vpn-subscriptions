...
![nodes](https://img.shields.io/badge/nodes-123-brightgreen) ![alive](https://img.shields.io/badge/alive-2010-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-314ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_21:29_UTC-informational)
...
- **Median RTT**: 314 ms
- **Last updated (UTC)**: 2026-07-12 21:29 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 69 · trojan × 25 · vless × 15 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 30 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 6 · `mfuu-clash` × 4 · `ninjastrikers` × 15 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 5
