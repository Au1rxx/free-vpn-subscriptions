...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2105-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-158ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_21:22_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2105
- **Fastest node RTT**: 31 ms
- **Median RTT**: 158 ms
- **Last updated (UTC)**: 2026-05-01 21:22 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 15 · vless × 87 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 34 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
