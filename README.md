...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-1996-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-416ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-28_11:24_UTC-informational)
...
- **Median RTT**: 416 ms
- **Last updated (UTC)**: 2026-06-28 11:24 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 33 · trojan × 36 · vless × 28 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 3
