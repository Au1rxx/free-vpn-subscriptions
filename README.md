...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2444-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-86ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_06:12_UTC-informational)
...
- **Median RTT**: 86 ms
- **Last updated (UTC)**: 2026-05-25 06:12 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 2 · vless × 79 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 45 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 59 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 1
