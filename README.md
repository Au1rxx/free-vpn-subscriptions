...
![nodes](https://img.shields.io/badge/nodes-116-brightgreen) ![alive](https://img.shields.io/badge/alive-1906-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-320ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_23:26_UTC-informational)
...
- **Median RTT**: 320 ms
- **Last updated (UTC)**: 2026-07-05 23:26 UTC

**Protocol mix:** shadowsocks × 49 · trojan × 26 · vless × 10 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 31 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `ruking-clash` × 2 · `surfboard-eternity` × 4
