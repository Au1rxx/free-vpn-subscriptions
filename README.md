...
![nodes](https://img.shields.io/badge/nodes-124-brightgreen) ![alive](https://img.shields.io/badge/alive-2054-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-238ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_18:20_UTC-informational)
...
- **Median RTT**: 238 ms
- **Last updated (UTC)**: 2026-07-12 18:20 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 68 · trojan × 13 · vless × 27 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 5 · `mfuu-clash` × 6 · `ninjastrikers` × 8 · `pawdroid` × 12 · `ruking-clash` × 1 · `snakem982` × 6 · `surfboard-eternity` × 3
