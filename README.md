...
![nodes](https://img.shields.io/badge/nodes-90-brightgreen) ![alive](https://img.shields.io/badge/alive-1819-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-418ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-30_21:15_UTC-informational)
...
- **Median RTT**: 418 ms
- **Last updated (UTC)**: 2026-06-30 21:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 12 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 14 · `surfboard-eternity` × 3
