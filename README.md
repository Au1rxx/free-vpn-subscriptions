...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2394-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-139ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_23:20_UTC-informational)
...
- **Median RTT**: 139 ms
- **Last updated (UTC)**: 2026-05-12 23:20 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 19 · vless × 84 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 43 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 44 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 2
