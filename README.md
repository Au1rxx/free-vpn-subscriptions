...
![nodes](https://img.shields.io/badge/nodes-107-brightgreen) ![alive](https://img.shields.io/badge/alive-1881-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-372ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_12:28_UTC-informational)
...
- **Median RTT**: 372 ms
- **Last updated (UTC)**: 2026-07-06 12:28 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 30 · vless × 9 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 6 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 4
