...
![nodes](https://img.shields.io/badge/nodes-116-brightgreen) ![alive](https://img.shields.io/badge/alive-1904-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-291ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_01:22_UTC-informational)
...
- **Median RTT**: 291 ms
- **Last updated (UTC)**: 2026-07-07 01:22 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 46 · trojan × 27 · vless × 20 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 10 · `mahdi0024` × 28 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 9 · `ninjastrikers` × 22 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 2
