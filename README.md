...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2085-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-80ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_03:15_UTC-informational)
...
- **Median RTT**: 80 ms
- **Last updated (UTC)**: 2026-05-03 03:15 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 4 · vless × 104 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 64 · `pawdroid` × 1 · `surfboard-eternity` × 7
