...
![nodes](https://img.shields.io/badge/nodes-129-brightgreen) ![alive](https://img.shields.io/badge/alive-1922-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-330ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_02:17_UTC-informational)
...
- **Median RTT**: 330 ms
- **Last updated (UTC)**: 2026-07-06 02:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 27 · vless × 21 · vmess × 30

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 11 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
