...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2235-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-109ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_03:22_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2235
- **Fastest node RTT**: 29 ms
- **Median RTT**: 109 ms
- **Last updated (UTC)**: 2026-04-30 03:22 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 4 · vless × 102 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 13 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 71 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
