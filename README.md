...
![nodes](https://img.shields.io/badge/nodes-100-brightgreen) ![alive](https://img.shields.io/badge/alive-2129-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-341ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_09:28_UTC-informational)
...
- **Median RTT**: 341 ms
- **Last updated (UTC)**: 2026-07-02 09:28 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 48 · trojan × 30 · vless × 12 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 6 · `surfboard-eternity` × 2
