...
![nodes](https://img.shields.io/badge/nodes-127-brightgreen) ![alive](https://img.shields.io/badge/alive-2509-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-398ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_19:33_UTC-informational)
...
- **Median RTT**: 398 ms
- **Last updated (UTC)**: 2026-04-23 19:33 UTC

**Protocol mix:** shadowsocks × 13 · trojan × 24 · vless × 76 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 24 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `pawdroid` × 1 · `surfboard-eternity` × 1
