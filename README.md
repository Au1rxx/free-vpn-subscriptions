...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2500-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-15_19:28_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2500
- **Fastest node RTT**: 34 ms
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-05-15 19:28 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 14 · vless × 92 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 48 · `pawdroid` × 10 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 4
