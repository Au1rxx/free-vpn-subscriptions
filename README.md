...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2336-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-398ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_07:33_UTC-informational)
...
- **Median RTT**: 398 ms
- **Last updated (UTC)**: 2026-07-18 07:33 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 100 · vless × 9 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 3 · `mahdi0024` × 64 · `mahdibland-aggregator` × 35 · `mahdibland-shadowsocks` × 29 · `matin-v2ray` × 3 · `ninjastrikers` × 4 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
