...
![nodes](https://img.shields.io/badge/nodes-109-brightgreen) ![alive](https://img.shields.io/badge/alive-2194-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-109ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-30_01:36_UTC-informational)
...
- **Nodes selected**: 109
- **Alive across all sources**: 2194
- **Fastest node RTT**: 30 ms
- **Median RTT**: 109 ms
- **Last updated (UTC)**: 2026-05-30 01:36 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 24 · vless × 34 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 34 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 2
