...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2471-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-75ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-18_10:39_UTC-informational)
...
- **Median RTT**: 75 ms
- **Last updated (UTC)**: 2026-05-18 10:39 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 6 · vless × 92 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 2 · `lagzian-mix` × 5 · `mahdi0024` × 39 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 5 · `ruking-clash` × 11 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
