...
![nodes](https://img.shields.io/badge/nodes-109-brightgreen) ![alive](https://img.shields.io/badge/alive-1889-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-359ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_11:27_UTC-informational)
...
- **Median RTT**: 359 ms
- **Last updated (UTC)**: 2026-07-06 11:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 11 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 6 · `ninjastrikers` × 12 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 5
