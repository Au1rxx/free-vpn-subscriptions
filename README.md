...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2567-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-142ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_19:38_UTC-informational)
...
- **Median RTT**: 142 ms
- **Last updated (UTC)**: 2026-04-26 19:38 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 18 · vless × 80 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 43 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 4 · `ninjastrikers` × 53 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
