...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2189-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-83ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-26_06:30_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2189
- **Fastest node RTT**: 30 ms
- **Median RTT**: 83 ms
- **Last updated (UTC)**: 2026-05-26 06:30 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 15 · vless × 85 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 70 · `pawdroid` × 4 · `ruking-clash` × 15 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
