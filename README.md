...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2655-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-105ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_01:14_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2655
- **Fastest node RTT**: 29 ms
- **Median RTT**: 105 ms
- **Last updated (UTC)**: 2026-04-25 01:14 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 9 · vless × 106 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 24 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 34 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 5
