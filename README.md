...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2265-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-448ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-20_23:39_UTC-informational)
...
- **Median RTT**: 448 ms
- **Last updated (UTC)**: 2026-04-20 23:39 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 18 · vless × 96 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 55 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 49 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 6
