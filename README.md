...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1961-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-573ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-16_20:15_UTC-informational)
...
- **Median RTT**: 573 ms
- **Last updated (UTC)**: 2026-06-16 20:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 46 · trojan × 20 · vless × 12 · vmess × 71

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 73 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 3
