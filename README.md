...
![nodes](https://img.shields.io/badge/nodes-95-brightgreen) ![alive](https://img.shields.io/badge/alive-1941-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-156ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-04_08:34_UTC-informational)
...
- **Median RTT**: 156 ms
- **Last updated (UTC)**: 2026-06-04 08:34 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 44 · vless × 21 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 32 · `epodonios` × 23 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 1
