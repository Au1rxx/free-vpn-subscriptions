...
![nodes](https://img.shields.io/badge/nodes-85-brightgreen) ![alive](https://img.shields.io/badge/alive-2232-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-170ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_09:27_UTC-informational)
...
- **Median RTT**: 170 ms
- **Last updated (UTC)**: 2026-06-07 09:27 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 19 · vless × 12 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `mahdi0024` × 37 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 2
