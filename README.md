...
![nodes](https://img.shields.io/badge/nodes-68-brightgreen) ![alive](https://img.shields.io/badge/alive-1921-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-131ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-03_04:32_UTC-informational)
...
- **Median RTT**: 131 ms
- **Last updated (UTC)**: 2026-07-03 04:32 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 17 · vless × 11 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 3 · `surfboard-eternity` × 2
