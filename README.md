...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2682-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-93ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-17_22:37_UTC-informational)
...
- **Median RTT**: 93 ms
- **Last updated (UTC)**: 2026-05-17 22:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 22 · vless × 78 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 7 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 49 · `pawdroid` × 3 · `ruking-clash` × 9 · `snakem982` × 1 · `surfboard-eternity` × 3
