...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-1922-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-361ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-13_23:14_UTC-informational)
...
- **Median RTT**: 361 ms
- **Last updated (UTC)**: 2026-07-13 23:14 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 41 · trojan × 25 · vless × 13 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 8 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 4
