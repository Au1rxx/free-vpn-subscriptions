...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1954-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-352ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_21:35_UTC-informational)
...
- **Median RTT**: 352 ms
- **Last updated (UTC)**: 2026-05-06 21:35 UTC

**Protocol mix:** shadowsocks × 48 · trojan × 19 · vless × 70 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 32 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 57 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 7
