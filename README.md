...
![nodes](https://img.shields.io/badge/nodes-74-brightgreen) ![alive](https://img.shields.io/badge/alive-2145-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-154ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-09_21:29_UTC-informational)
...
- **Median RTT**: 154 ms
- **Last updated (UTC)**: 2026-07-09 21:29 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 22 · trojan × 10 · vless × 9 · vmess × 32

**Sources used this run:** `barry-far-v2ray` × 1 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
