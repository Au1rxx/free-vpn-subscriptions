...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2411-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-86ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-19_15:27_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2411
- **Fastest node RTT**: 31 ms
- **Median RTT**: 86 ms
- **Last updated (UTC)**: 2026-05-19 15:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 11 · vless × 79 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 5 · `ninjastrikers` × 52 · `pawdroid` × 11 · `ruking-clash` × 2 · `surfboard-eternity` × 5
