...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2536-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-91ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-16_01:15_UTC-informational)
...
- **Median RTT**: 91 ms
- **Last updated (UTC)**: 2026-05-16 01:15 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 9 · vless × 100 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 66 · `pawdroid` × 8 · `ruking-clash` × 4 · `surfboard-eternity` × 6
