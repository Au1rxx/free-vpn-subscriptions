...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2078-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-183ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_19:20_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2078
- **Fastest node RTT**: 39 ms
- **Median RTT**: 183 ms
- **Last updated (UTC)**: 2026-04-29 19:20 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 15 · vless × 82 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 57 · `pawdroid` × 1 · `surfboard-eternity` × 6
