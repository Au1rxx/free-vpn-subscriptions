...
![nodes](https://img.shields.io/badge/nodes-87-brightgreen) ![alive](https://img.shields.io/badge/alive-2203-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-265ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_08:28_UTC-informational)
...
- **Median RTT**: 265 ms
- **Last updated (UTC)**: 2026-06-11 08:28 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 11 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 6
