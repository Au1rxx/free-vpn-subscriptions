...
![nodes](https://img.shields.io/badge/nodes-79-brightgreen) ![alive](https://img.shields.io/badge/alive-2238-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-417ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-29_09:11_UTC-informational)
...
- **Median RTT**: 417 ms
- **Last updated (UTC)**: 2026-06-29 09:11 UTC

**Protocol mix:** shadowsocks × 18 · trojan × 27 · vless × 19 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 2
