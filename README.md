...
![nodes](https://img.shields.io/badge/nodes-98-brightgreen) ![alive](https://img.shields.io/badge/alive-2240-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-472ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-12_11:15_UTC-informational)
...
- **Median RTT**: 472 ms
- **Last updated (UTC)**: 2026-06-12 11:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 43 · trojan × 38 · vless × 11 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 30 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `ruking-clash` × 5 · `surfboard-eternity` × 4
