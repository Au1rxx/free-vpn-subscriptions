...
![nodes](https://img.shields.io/badge/nodes-91-brightgreen) ![alive](https://img.shields.io/badge/alive-2093-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-173ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-27_07:13_UTC-informational)
...
- **Median RTT**: 173 ms
- **Last updated (UTC)**: 2026-06-27 07:13 UTC

**Protocol mix:** shadowsocks × 18 · trojan × 29 · vless × 24 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 16 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 11
