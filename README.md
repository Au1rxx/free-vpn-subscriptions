...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2075-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-95ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_05:39_UTC-informational)
...
- **Median RTT**: 95 ms
- **Last updated (UTC)**: 2026-05-04 05:39 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 7 · vless × 104 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 69 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
