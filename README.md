...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2445-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-118ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_03:27_UTC-informational)
...
- **Median RTT**: 118 ms
- **Last updated (UTC)**: 2026-04-24 03:27 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 12 · vless × 102 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 24 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 73 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
