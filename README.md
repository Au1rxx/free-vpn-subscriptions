...
![nodes](https://img.shields.io/badge/nodes-122-brightgreen) ![alive](https://img.shields.io/badge/alive-2285-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-337ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-12_03:26_UTC-informational)
...
- **Median RTT**: 337 ms
- **Last updated (UTC)**: 2026-06-12 03:26 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 41 · trojan × 44 · vless × 30 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 31 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 7
