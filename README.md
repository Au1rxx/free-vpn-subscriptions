...
![nodes](https://img.shields.io/badge/nodes-72-brightgreen) ![alive](https://img.shields.io/badge/alive-2157-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-169ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_13:11_UTC-informational)
...
- **Median RTT**: 169 ms
- **Last updated (UTC)**: 2026-06-06 13:11 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 24 · vless × 7 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3
