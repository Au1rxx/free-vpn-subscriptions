...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1998-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-458ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_23:20_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1998
- **Fastest node RTT**: 34 ms
- **Median RTT**: 458 ms
- **Last updated (UTC)**: 2026-06-22 23:20 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 24 · vless × 69 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 52 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 1 · `ruking-clash` × 24 · `snakem982` × 1 · `surfboard-eternity` × 4
