...
![nodes](https://img.shields.io/badge/nodes-118-brightgreen) ![alive](https://img.shields.io/badge/alive-1956-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-300ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_00:25_UTC-informational)
...
- **Median RTT**: 300 ms
- **Last updated (UTC)**: 2026-06-13 00:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 55 · trojan × 24 · vless × 30 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 35 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 6
