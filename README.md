...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-1816-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-377ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-15_17:33_UTC-informational)
...
- **Nodes selected**: 112
- **Alive across all sources**: 1816
- **Fastest node RTT**: 31 ms
- **Median RTT**: 377 ms
- **Last updated (UTC)**: 2026-06-15 17:33 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 51 · trojan × 27 · vless × 18 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 17 · `surfboard-eternity` × 3
