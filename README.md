...
![nodes](https://img.shields.io/badge/nodes-141-brightgreen) ![alive](https://img.shields.io/badge/alive-2075-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-379ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_10:19_UTC-informational)
...
- **Median RTT**: 379 ms
- **Last updated (UTC)**: 2026-06-21 10:19 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 32 · vless × 44 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 34 · `snakem982` × 1 · `surfboard-eternity` × 3
