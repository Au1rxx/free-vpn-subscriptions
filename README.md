...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2049-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-72ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-22_10:11_UTC-informational)
...
- **Median RTT**: 72 ms
- **Last updated (UTC)**: 2026-05-22 10:11 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 34 · trojan × 11 · vless × 92 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 67 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 8
