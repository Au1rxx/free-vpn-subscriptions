...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2220-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-173ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_22:27_UTC-informational)
...
- **Median RTT**: 173 ms
- **Last updated (UTC)**: 2026-04-30 22:27 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 23 · vless × 79 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 42 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 50 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
