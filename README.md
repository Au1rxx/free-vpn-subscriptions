...
![nodes](https://img.shields.io/badge/nodes-145-brightgreen) ![alive](https://img.shields.io/badge/alive-2520-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-104ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_13:37_UTC-informational)
...
- **Median RTT**: 104 ms
- **Last updated (UTC)**: 2026-04-24 13:37 UTC

**Protocol mix:** shadowsocks × 20 · trojan × 20 · vless × 94 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `pawdroid` × 3 · `surfboard-eternity` × 3
