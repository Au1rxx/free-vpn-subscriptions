...
![nodes](https://img.shields.io/badge/nodes-139-brightgreen) ![alive](https://img.shields.io/badge/alive-1902-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-426ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_08:39_UTC-informational)
...
- **Median RTT**: 426 ms
- **Last updated (UTC)**: 2026-06-22 08:39 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 26 · vless × 54 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 4 · `surfboard-eternity` × 4
