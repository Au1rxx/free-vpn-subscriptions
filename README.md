...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-394-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-138ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-19_06:41_UTC-informational)
...
- **Median RTT**: 138 ms
- **Last updated (UTC)**: 2026-04-19 06:41 UTC

**Protocol mix:** shadowsocks × 103 · trojan × 7 · vmess × 40

**Sources used this run:** `freefq` × 2 · `mahdibland-aggregator` × 62 · `mahdibland-shadowsocks` × 71 · `vxiaov-clash` × 15
