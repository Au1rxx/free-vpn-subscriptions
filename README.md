...
![nodes](https://img.shields.io/badge/nodes-86-brightgreen) ![alive](https://img.shields.io/badge/alive-2053-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-168ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-04_04:16_UTC-informational)
...
- **Nodes selected**: 86
- **Alive across all sources**: 2053
- **Fastest node RTT**: 28 ms
- **Median RTT**: 168 ms
- **Last updated (UTC)**: 2026-07-04 04:16 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 23 · vless × 13 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 7 · `ninjastrikers` × 20 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
