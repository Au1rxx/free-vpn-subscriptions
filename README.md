...
![nodes](https://img.shields.io/badge/nodes-79-brightgreen) ![alive](https://img.shields.io/badge/alive-2287-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-156ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-30_18:12_UTC-informational)
...
- **Median RTT**: 156 ms
- **Last updated (UTC)**: 2026-05-30 18:12 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 16 · vless × 9 · vmess × 32

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 6 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
