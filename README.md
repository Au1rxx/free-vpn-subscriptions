...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-1834-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-344ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-08_01:25_UTC-informational)
...
- **Median RTT**: 344 ms
- **Last updated (UTC)**: 2026-07-08 01:25 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 57 · trojan × 29 · vless × 23 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 7 · `ninjastrikers` × 25 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 7
