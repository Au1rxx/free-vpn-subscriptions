...
![nodes](https://img.shields.io/badge/nodes-92-brightgreen) ![alive](https://img.shields.io/badge/alive-2247-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-347ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_12:25_UTC-informational)
...
- **Nodes selected**: 92
- **Alive across all sources**: 2247
- **Fastest node RTT**: 30 ms
- **Median RTT**: 347 ms
- **Last updated (UTC)**: 2026-07-02 12:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 14 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 8 · `ninjastrikers` × 16 · `pawdroid` × 5 · `surfboard-eternity` × 3
