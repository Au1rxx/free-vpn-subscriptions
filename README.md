...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2341-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-83ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-24_04:21_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2341
- **Fastest node RTT**: 33 ms
- **Median RTT**: 83 ms
- **Last updated (UTC)**: 2026-05-24 04:21 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 1 · vless × 84 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 59 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7
