...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2344-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-401ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_11:13_UTC-informational)
...
- **Median RTT**: 401 ms
- **Last updated (UTC)**: 2026-07-18 11:13 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 105 · vless × 11 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 3 · `mahdi0024` × 62 · `mahdibland-aggregator` × 35 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 4 · `ninjastrikers` × 5 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
