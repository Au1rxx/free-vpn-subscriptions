...
![nodes](https://img.shields.io/badge/nodes-78-brightgreen) ![alive](https://img.shields.io/badge/alive-2420-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-164ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-01_15:20_UTC-informational)
...
- **Median RTT**: 164 ms
- **Last updated (UTC)**: 2026-06-01 15:20 UTC

**Protocol mix:** shadowsocks × 15 · trojan × 26 · vless × 7 · vmess × 30

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 9 · `pawdroid` × 5 · `surfboard-eternity` × 2
