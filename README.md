...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2167-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-151ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-02_16:24_UTC-informational)
...
- **Median RTT**: 151 ms
- **Last updated (UTC)**: 2026-05-02 16:24 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 19 · vless × 85 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 34 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 2 · `surfboard-eternity` × 4
