...
![nodes](https://img.shields.io/badge/nodes-80-brightgreen) ![alive](https://img.shields.io/badge/alive-2091-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-147ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-10_02:26_UTC-informational)
...
- **Median RTT**: 147 ms
- **Last updated (UTC)**: 2026-07-10 02:26 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 10 · vless × 13 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 4
