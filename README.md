...
![nodes](https://img.shields.io/badge/nodes-136-brightgreen) ![alive](https://img.shields.io/badge/alive-2582-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-291ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_18:24_UTC-informational)
...
- **Median RTT**: 291 ms
- **Last updated (UTC)**: 2026-04-22 18:24 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 22 · vless × 71 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 26 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 6
