...
![nodes](https://img.shields.io/badge/nodes-149-brightgreen) ![alive](https://img.shields.io/badge/alive-2344-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-375ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_21:11_UTC-informational)
...
- **Median RTT**: 375 ms
- **Last updated (UTC)**: 2026-05-08 21:11 UTC

**Protocol mix:** shadowsocks × 53 · trojan × 21 · vless × 66 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
