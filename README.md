...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2579-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-136ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_23:39_UTC-informational)
...
- **Median RTT**: 136 ms
- **Last updated (UTC)**: 2026-04-26 23:39 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 11 · vless × 87 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 26 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 48 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 46 · `pawdroid` × 1 · `surfboard-eternity` × 6
