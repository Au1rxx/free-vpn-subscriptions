...
![nodes](https://img.shields.io/badge/nodes-145-brightgreen) ![alive](https://img.shields.io/badge/alive-2439-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-81ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_12:26_UTC-informational)
...
- **Median RTT**: 81 ms
- **Last updated (UTC)**: 2026-05-25 12:26 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 18 · vless × 65 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 35 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 8 · `surfboard-eternity` × 7
