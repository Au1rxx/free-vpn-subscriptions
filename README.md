...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2096-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-223ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_20:26_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2096
- **Fastest node RTT**: 35 ms
- **Median RTT**: 223 ms
- **Last updated (UTC)**: 2026-04-29 20:26 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 18 · vless × 80 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 6 · `ninjastrikers` × 56 · `surfboard-eternity` × 8
