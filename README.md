...
![nodes](https://img.shields.io/badge/nodes-125-brightgreen) ![alive](https://img.shields.io/badge/alive-1793-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-349ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-09_04:35_UTC-informational)
...
- **Median RTT**: 349 ms
- **Last updated (UTC)**: 2026-07-09 04:35 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 58 · trojan × 22 · vless × 19 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 1
