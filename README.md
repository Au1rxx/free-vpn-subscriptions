...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2209-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-97ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_02:17_UTC-informational)
...
- **Median RTT**: 97 ms
- **Last updated (UTC)**: 2026-05-01 02:17 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 5 · vless × 97 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 68 · `snakem982` × 1 · `surfboard-eternity` × 5
