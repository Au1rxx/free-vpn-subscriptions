...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2561-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-75ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-16_10:18_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2561
- **Fastest node RTT**: 31 ms
- **Median RTT**: 75 ms
- **Last updated (UTC)**: 2026-05-16 10:18 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 13 · vless × 96 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `pawdroid` × 7 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
