...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-1720-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-496ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_09:26_UTC-informational)
...
- **Nodes selected**: 140
- **Alive across all sources**: 1720
- **Fastest node RTT**: 30 ms
- **Median RTT**: 496 ms
- **Last updated (UTC)**: 2026-06-14 09:26 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 75 · trojan × 36 · vless × 21 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 21 · `surfboard-eternity` × 4
