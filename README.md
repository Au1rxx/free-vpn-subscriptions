...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2314-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-78ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-20_05:33_UTC-informational)
...
- **Median RTT**: 78 ms
- **Last updated (UTC)**: 2026-05-20 05:33 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 11 · vless × 79 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
