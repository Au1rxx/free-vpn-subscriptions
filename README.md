...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2244-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-80ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-19_05:23_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2244
- **Fastest node RTT**: 36 ms
- **Median RTT**: 80 ms
- **Last updated (UTC)**: 2026-05-19 05:23 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 23 · trojan × 17 · vless × 85 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 65 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 3
