...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2342-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-82ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-20_18:29_UTC-informational)
...
- **Median RTT**: 82 ms
- **Last updated (UTC)**: 2026-05-20 18:29 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 39 · trojan × 20 · vless × 70 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 9 · `surfboard-eternity` × 7
