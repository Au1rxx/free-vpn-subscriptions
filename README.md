...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2525-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-91ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-15_18:21_UTC-informational)
...
- **Median RTT**: 91 ms
- **Last updated (UTC)**: 2026-05-15 18:21 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 12 · vless × 94 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 9 · `ruking-clash` × 7 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
