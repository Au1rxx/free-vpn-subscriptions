...
![nodes](https://img.shields.io/badge/nodes-114-brightgreen) ![alive](https://img.shields.io/badge/alive-1879-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-357ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_21:32_UTC-informational)
...
- **Median RTT**: 357 ms
- **Last updated (UTC)**: 2026-07-05 21:32 UTC

**Protocol mix:** shadowsocks × 47 · trojan × 24 · vless × 13 · vmess × 30

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 2
