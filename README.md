...
![nodes](https://img.shields.io/badge/nodes-97-brightgreen) ![alive](https://img.shields.io/badge/alive-2320-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-170ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-10_03:11_UTC-informational)
...
- **Median RTT**: 170 ms
- **Last updated (UTC)**: 2026-06-10 03:11 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 14 · vless × 25 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 24 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 6
