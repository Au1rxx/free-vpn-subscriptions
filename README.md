...
![nodes](https://img.shields.io/badge/nodes-85-brightgreen) ![alive](https://img.shields.io/badge/alive-2209-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-445ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-29_07:13_UTC-informational)
...
- **Median RTT**: 445 ms
- **Last updated (UTC)**: 2026-06-29 07:13 UTC

**Protocol mix:** shadowsocks × 18 · trojan × 29 · vless × 23 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 18 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 9 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 5
