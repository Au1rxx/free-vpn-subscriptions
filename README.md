...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2054-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-87ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-21_22:10_UTC-informational)
...
- **Median RTT**: 87 ms
- **Last updated (UTC)**: 2026-05-21 22:10 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 32 · vless × 70 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 40 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 11 · `surfboard-eternity` × 5
