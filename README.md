...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2264-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-186ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_23:13_UTC-informational)
...
- **Median RTT**: 186 ms
- **Last updated (UTC)**: 2026-04-30 23:13 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 23 · vless × 81 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 43 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 52 · `surfboard-eternity` × 7
