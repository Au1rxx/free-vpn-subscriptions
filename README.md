...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-1831-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-377ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-15_19:39_UTC-informational)
...
- **Nodes selected**: 111
- **Alive across all sources**: 1831
- **Fastest node RTT**: 34 ms
- **Median RTT**: 377 ms
- **Last updated (UTC)**: 2026-06-15 19:39 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 23 · vless × 22 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 8 · `surfboard-eternity` × 5
