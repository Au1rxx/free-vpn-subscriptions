...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2244-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-279ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-05_18:25_UTC-informational)
...
- **Median RTT**: 279 ms
- **Last updated (UTC)**: 2026-05-05 18:25 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 30 · vless × 71 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 39 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 54 · `snakem982` × 1 · `surfboard-eternity` × 8
