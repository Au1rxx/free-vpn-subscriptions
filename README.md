...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2065-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-84ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_06:20_UTC-informational)
...
- **Median RTT**: 84 ms
- **Last updated (UTC)**: 2026-05-04 06:20 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 9 · vless × 100 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 5 · `ninjastrikers` × 68 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
