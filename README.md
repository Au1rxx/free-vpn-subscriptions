...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-2332-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-344ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_02:16_UTC-informational)
...
- **Nodes selected**: 94
- **Alive across all sources**: 2332
- **Fastest node RTT**: 28 ms
- **Median RTT**: 344 ms
- **Last updated (UTC)**: 2026-07-01 02:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 39 · trojan × 30 · vless × 18 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 13 · `ninjastrikers` × 23 · `pawdroid` × 3 · `surfboard-eternity` × 5
