...
![nodes](https://img.shields.io/badge/nodes-85-brightgreen) ![alive](https://img.shields.io/badge/alive-2106-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-155ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-10_03:10_UTC-informational)
...
- **Median RTT**: 155 ms
- **Last updated (UTC)**: 2026-07-10 03:10 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 10 · vless × 18 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 5 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
