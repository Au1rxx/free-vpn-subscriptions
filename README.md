...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2624-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-81ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-17_05:19_UTC-informational)
...
- **Median RTT**: 81 ms
- **Last updated (UTC)**: 2026-05-17 05:19 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 4 · vless × 96 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 7 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 34 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
