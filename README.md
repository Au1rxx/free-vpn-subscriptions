...
![nodes](https://img.shields.io/badge/nodes-96-brightgreen) ![alive](https://img.shields.io/badge/alive-1949-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-262ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_18:31_UTC-informational)
...
- **Median RTT**: 262 ms
- **Last updated (UTC)**: 2026-07-06 18:31 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 19 · vless × 16 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 21 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 8 · `ninjastrikers` × 7 · `pawdroid` × 10 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
