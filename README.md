...
![nodes](https://img.shields.io/badge/nodes-141-brightgreen) ![alive](https://img.shields.io/badge/alive-2538-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-281ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_13:23_UTC-informational)
...
- **Median RTT**: 281 ms
- **Last updated (UTC)**: 2026-04-23 13:23 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 22 · vless × 78 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 20 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 65 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
