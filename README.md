...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-1940-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-314ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_01:25_UTC-informational)
...
- **Median RTT**: 314 ms
- **Last updated (UTC)**: 2026-07-12 01:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 62 · trojan × 19 · vless × 27 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 5 · `ninjastrikers` × 26 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
