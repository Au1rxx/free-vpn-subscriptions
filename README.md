...
![nodes](https://img.shields.io/badge/nodes-125-brightgreen) ![alive](https://img.shields.io/badge/alive-1758-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-374ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-08_15:18_UTC-informational)
...
- **Median RTT**: 374 ms
- **Last updated (UTC)**: 2026-07-08 15:18 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 69 · trojan × 20 · vless × 12 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 6
