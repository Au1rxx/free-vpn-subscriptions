...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1913-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-106ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_09:34_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1913
- **Fastest node RTT**: 30 ms
- **Median RTT**: 106 ms
- **Last updated (UTC)**: 2026-05-12 09:34 UTC

**Protocol mix:** shadowsocks × 60 · trojan × 2 · vless × 77 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 4 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 60 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
