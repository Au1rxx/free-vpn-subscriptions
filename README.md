...
![nodes](https://img.shields.io/badge/nodes-139-brightgreen) ![alive](https://img.shields.io/badge/alive-2090-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-281ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_16:30_UTC-informational)
...
- **Median RTT**: 281 ms
- **Last updated (UTC)**: 2026-05-03 16:30 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 23 · vless × 78 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 30 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
