...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-2033-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-359ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_06:32_UTC-informational)
...
- **Median RTT**: 359 ms
- **Last updated (UTC)**: 2026-07-02 06:32 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 57 · trojan × 40 · vless × 20 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 25 · `pawdroid` × 5 · `surfboard-eternity` × 1
