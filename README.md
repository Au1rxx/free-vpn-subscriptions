...
![nodes](https://img.shields.io/badge/nodes-91-brightgreen) ![alive](https://img.shields.io/badge/alive-1870-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-388ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-30_18:13_UTC-informational)
...
- **Median RTT**: 388 ms
- **Last updated (UTC)**: 2026-06-30 18:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 34 · trojan × 34 · vless × 16 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `mahdi0024` × 7 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 9 · `ninjastrikers` × 15 · `pawdroid` × 6 · `ruking-clash` × 11 · `surfboard-eternity` × 6
