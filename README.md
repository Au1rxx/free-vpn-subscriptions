...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-1983-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-373ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-12_23:25_UTC-informational)
...
- **Median RTT**: 373 ms
- **Last updated (UTC)**: 2026-06-12 23:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 53 · trojan × 44 · vless × 11 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 33 · `lagzian-mix` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 7
