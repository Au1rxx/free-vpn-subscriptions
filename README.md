...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2446-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-390ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_19:21_UTC-informational)
...
- **Median RTT**: 390 ms
- **Last updated (UTC)**: 2026-07-18 19:21 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 93 · vless × 14 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 40 · `mahdibland-shadowsocks` × 32 · `matin-v2ray` × 5 · `ninjastrikers` × 4 · `pawdroid` × 7 · `ruking-clash` × 2 · `snakem982` × 14 · `surfboard-eternity` × 4
