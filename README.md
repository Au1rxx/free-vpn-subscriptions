...
![nodes](https://img.shields.io/badge/nodes-138-brightgreen) ![alive](https://img.shields.io/badge/alive-2588-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-229ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_14:16_UTC-informational)
...
- **Nodes selected**: 138
- **Alive across all sources**: 2588
- **Fastest node RTT**: 34 ms
- **Median RTT**: 229 ms
- **Last updated (UTC)**: 2026-04-22 14:16 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 22 · vless × 79 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 30 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 57 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7
