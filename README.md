...
![nodes](https://img.shields.io/badge/nodes-71-brightgreen) ![alive](https://img.shields.io/badge/alive-2281-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-153ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-30_20:15_UTC-informational)
...
- **Median RTT**: 153 ms
- **Last updated (UTC)**: 2026-05-30 20:15 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 11 · vless × 9 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `mahdi0024` × 24 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 7 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 4
