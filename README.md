...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-1638-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-402ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-15_10:18_UTC-informational)
...
- **Nodes selected**: 140
- **Alive across all sources**: 1638
- **Fastest node RTT**: 31 ms
- **Median RTT**: 402 ms
- **Last updated (UTC)**: 2026-07-15 10:18 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 88 · trojan × 29 · vless × 15 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `mahdi0024` × 12 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
