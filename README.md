...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2433-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-81ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_13:30_UTC-informational)
...
- **Median RTT**: 81 ms
- **Last updated (UTC)**: 2026-05-25 13:30 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 16 · vless × 69 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 20 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 40 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 54 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 4
