...
![nodes](https://img.shields.io/badge/nodes-78-brightgreen) ![alive](https://img.shields.io/badge/alive-2066-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-172ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-29_07:19_UTC-informational)
...
- **Median RTT**: 172 ms
- **Last updated (UTC)**: 2026-05-29 07:19 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 32 · vless × 15 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
