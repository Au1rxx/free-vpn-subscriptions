...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2159-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-111ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-30_02:11_UTC-informational)
...
- **Median RTT**: 111 ms
- **Last updated (UTC)**: 2026-04-30 02:11 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 4 · vless × 99 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 65 · `ruking-clash` × 1 · `surfboard-eternity` × 7
