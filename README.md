...
![nodes](https://img.shields.io/badge/nodes-127-brightgreen) ![alive](https://img.shields.io/badge/alive-2002-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-330ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_05:35_UTC-informational)
...
- **Median RTT**: 330 ms
- **Last updated (UTC)**: 2026-07-05 05:35 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 56 · trojan × 27 · vless × 14 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 5 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 4
