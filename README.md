...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-1870-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-355ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-30_04:11_UTC-informational)
...
- **Median RTT**: 355 ms
- **Last updated (UTC)**: 2026-06-30 04:11 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 39 · vless × 16 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 6
