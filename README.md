...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2251-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-446ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-20_20:36_UTC-informational)
...
- **Median RTT**: 446 ms
- **Last updated (UTC)**: 2026-04-20 20:36 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 9 · vless × 101 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 64 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 41 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 4
