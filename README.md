...
![nodes](https://img.shields.io/badge/nodes-113-brightgreen) ![alive](https://img.shields.io/badge/alive-2117-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-277ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-25_07:12_UTC-informational)
...
- **Median RTT**: 277 ms
- **Last updated (UTC)**: 2026-06-25 07:12 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 33 · vless × 38 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 32 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 6
