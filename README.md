...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2188-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-111ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_11:21_UTC-informational)
...
- **Median RTT**: 111 ms
- **Last updated (UTC)**: 2026-05-01 11:21 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 7 · vless × 92 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 61 · `surfboard-eternity` × 6
