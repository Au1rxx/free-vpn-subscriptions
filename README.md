...
![nodes](https://img.shields.io/badge/nodes-141-brightgreen) ![alive](https://img.shields.io/badge/alive-2494-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-170ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_19:15_UTC-informational)
...
- **Median RTT**: 170 ms
- **Last updated (UTC)**: 2026-05-09 19:15 UTC

**Protocol mix:** shadowsocks × 52 · trojan × 16 · vless × 64 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 20 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
