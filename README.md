...
![nodes](https://img.shields.io/badge/nodes-109-brightgreen) ![alive](https://img.shields.io/badge/alive-1986-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-320ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_12:36_UTC-informational)
...
- **Nodes selected**: 109
- **Alive across all sources**: 1986
- **Fastest node RTT**: 37 ms
- **Median RTT**: 320 ms
- **Last updated (UTC)**: 2026-07-05 12:36 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 49 · trojan × 22 · vless × 8 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 31 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
