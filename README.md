...
![nodes](https://img.shields.io/badge/nodes-146-brightgreen) ![alive](https://img.shields.io/badge/alive-2217-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-181ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_13:29_UTC-informational)
...
- **Median RTT**: 181 ms
- **Last updated (UTC)**: 2026-04-22 13:29 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 21 · vless × 79 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 62 · `ruking-clash` × 5 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
