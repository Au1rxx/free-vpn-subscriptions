...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2574-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-130ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_18:37_UTC-informational)
...
- **Median RTT**: 130 ms
- **Last updated (UTC)**: 2026-04-26 18:37 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 13 · vless × 85 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 50 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
