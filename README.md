...
![nodes](https://img.shields.io/badge/nodes-142-brightgreen) ![alive](https://img.shields.io/badge/alive-2250-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-425ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_21:24_UTC-informational)
...
- **Median RTT**: 425 ms
- **Last updated (UTC)**: 2026-05-04 21:24 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 26 · vless × 69 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 56 · `ruking-clash` × 3 · `surfboard-eternity` × 6
