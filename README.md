...
![nodes](https://img.shields.io/badge/nodes-69-brightgreen) ![alive](https://img.shields.io/badge/alive-2052-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-234ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-28_16:38_UTC-informational)
...
- **Median RTT**: 234 ms
- **Last updated (UTC)**: 2026-05-28 16:38 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 30 · trojan × 14 · vless × 12 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 5 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 3
