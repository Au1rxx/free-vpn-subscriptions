...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-1854-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-329ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-15_05:18_UTC-informational)
...
- **Median RTT**: 329 ms
- **Last updated (UTC)**: 2026-06-15 05:18 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 22 · vless × 29 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 28 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 4
