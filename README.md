...
![nodes](https://img.shields.io/badge/nodes-83-brightgreen) ![alive](https://img.shields.io/badge/alive-2264-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-245ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-10_09:13_UTC-informational)
...
- **Median RTT**: 245 ms
- **Last updated (UTC)**: 2026-06-10 09:13 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 12 · vless × 10 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 8 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 6
