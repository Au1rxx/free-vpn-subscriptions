...
![nodes](https://img.shields.io/badge/nodes-135-brightgreen) ![alive](https://img.shields.io/badge/alive-1912-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-657ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_08:19_UTC-informational)
...
- **Nodes selected**: 135
- **Alive across all sources**: 1912
- **Fastest node RTT**: 27 ms
- **Median RTT**: 657 ms
- **Last updated (UTC)**: 2026-06-17 08:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 28 · vless × 15 · vmess × 53

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 56 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 3
