...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2509-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-85ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-20_15:30_UTC-informational)
...
- **Median RTT**: 85 ms
- **Last updated (UTC)**: 2026-05-20 15:30 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 20 · vless × 70 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 56 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
