...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2480-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-86ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-16_19:29_UTC-informational)
...
- **Median RTT**: 86 ms
- **Last updated (UTC)**: 2026-05-16 19:29 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 16 · vless × 83 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 44 · `pawdroid` × 6 · `ruking-clash` × 7 · `surfboard-eternity` × 6
