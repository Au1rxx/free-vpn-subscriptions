...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2235-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-333ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_14:39_UTC-informational)
...
- **Median RTT**: 333 ms
- **Last updated (UTC)**: 2026-04-21 14:39 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 13 · vless × 90 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 50 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
