...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2281-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-66ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-19_10:15_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2281
- **Fastest node RTT**: 24 ms
- **Median RTT**: 66 ms
- **Last updated (UTC)**: 2026-05-19 10:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 19 · trojan × 24 · vless × 85 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 59 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 4
