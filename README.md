...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1972-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-126ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_02:23_UTC-informational)
...
- **Median RTT**: 126 ms
- **Last updated (UTC)**: 2026-05-12 02:23 UTC

**Protocol mix:** shadowsocks × 54 · trojan × 2 · vless × 84 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 7 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
