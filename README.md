...
![nodes](https://img.shields.io/badge/nodes-137-brightgreen) ![alive](https://img.shields.io/badge/alive-2459-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-204ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_14:14_UTC-informational)
...
- **Median RTT**: 204 ms
- **Last updated (UTC)**: 2026-04-23 14:14 UTC

**Protocol mix:** shadowsocks × 17 · trojan × 20 · vless × 86 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 59 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 5
