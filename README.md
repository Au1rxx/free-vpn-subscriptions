...
![nodes](https://img.shields.io/badge/nodes-120-brightgreen) ![alive](https://img.shields.io/badge/alive-1809-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-377ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-16_08:22_UTC-informational)
...
- **Nodes selected**: 120
- **Alive across all sources**: 1809
- **Fastest node RTT**: 31 ms
- **Median RTT**: 377 ms
- **Last updated (UTC)**: 2026-06-16 08:22 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 27 · vless × 27 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 20 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 4
