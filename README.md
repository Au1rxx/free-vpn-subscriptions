...
![nodes](https://img.shields.io/badge/nodes-82-brightgreen) ![alive](https://img.shields.io/badge/alive-2400-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-74ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-03_08:35_UTC-informational)
...
- **Median RTT**: 74 ms
- **Last updated (UTC)**: 2026-06-03 08:35 UTC

**Protocol mix:** shadowsocks × 14 · trojan × 37 · vless × 6 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 21 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 10 · `pawdroid` × 1 · `surfboard-eternity` × 2
