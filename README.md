...
![nodes](https://img.shields.io/badge/nodes-143-brightgreen) ![alive](https://img.shields.io/badge/alive-2216-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-366ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-05_20:27_UTC-informational)
...
- **Median RTT**: 366 ms
- **Last updated (UTC)**: 2026-05-05 20:27 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 28 · vless × 68 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 38 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 3 · `surfboard-eternity` × 10
