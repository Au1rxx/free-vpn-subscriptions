...
![nodes](https://img.shields.io/badge/nodes-135-brightgreen) ![alive](https://img.shields.io/badge/alive-1712-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-378ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_02:33_UTC-informational)
...
- **Median RTT**: 378 ms
- **Last updated (UTC)**: 2026-06-14 02:33 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 54 · trojan × 37 · vless × 36 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 34 · `pawdroid` × 4 · `ruking-clash` × 21 · `surfboard-eternity` × 7
