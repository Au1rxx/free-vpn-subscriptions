...
![nodes](https://img.shields.io/badge/nodes-142-brightgreen) ![alive](https://img.shields.io/badge/alive-2241-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-411ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_23:36_UTC-informational)
...
- **Median RTT**: 411 ms
- **Last updated (UTC)**: 2026-04-21 23:36 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 23 · vless × 71 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 32 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 4 · `surfboard-eternity` × 6
