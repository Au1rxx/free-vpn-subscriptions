...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2378-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-398ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_12:27_UTC-informational)
...
- **Median RTT**: 398 ms
- **Last updated (UTC)**: 2026-07-18 12:27 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 98 · vless × 13 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 5 · `mahdi0024` × 60 · `mahdibland-aggregator` × 34 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 5 · `ninjastrikers` × 3 · `pawdroid` × 8 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4
