...
![nodes](https://img.shields.io/badge/nodes-77-brightgreen) ![alive](https://img.shields.io/badge/alive-2262-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-132ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-31_10:28_UTC-informational)
...
- **Median RTT**: 132 ms
- **Last updated (UTC)**: 2026-05-31 10:28 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 18 · vless × 9 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 3 · `surfboard-eternity` × 4
