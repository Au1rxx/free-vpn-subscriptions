...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2223-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-115ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_03:40_UTC-informational)
...
- **Median RTT**: 115 ms
- **Last updated (UTC)**: 2026-04-21 03:40 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 3 · vless × 101 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 47 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 3 · `ninjastrikers` × 52 · `ruking-clash` × 10 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
