...
![nodes](https://img.shields.io/badge/nodes-50-brightgreen) ![alive](https://img.shields.io/badge/alive-2049-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-163ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-29_10:33_UTC-informational)
...
- **Median RTT**: 163 ms
- **Last updated (UTC)**: 2026-05-29 10:33 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 10 · vless × 7 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `ruking-clash` × 2 · `surfboard-eternity` × 5
