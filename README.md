...
![nodes](https://img.shields.io/badge/nodes-109-brightgreen) ![alive](https://img.shields.io/badge/alive-1952-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-309ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_15:32_UTC-informational)
...
- **Median RTT**: 309 ms
- **Last updated (UTC)**: 2026-07-05 15:32 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 33 · vless × 10 · vmess × 30

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 6 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 4
