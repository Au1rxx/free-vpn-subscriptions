...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2223-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-136ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_00:19_UTC-informational)
...
- **Median RTT**: 136 ms
- **Last updated (UTC)**: 2026-04-22 00:19 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 4 · vless × 98 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 28 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 71 · `ruking-clash` × 5 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
