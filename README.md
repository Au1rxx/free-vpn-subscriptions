...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-2064-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-157ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-04_02:14_UTC-informational)
...
- **Median RTT**: 157 ms
- **Last updated (UTC)**: 2026-07-04 02:14 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 30 · vless × 29 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 5 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 14 · `snakem982` × 1 · `surfboard-eternity` × 6
