...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2405-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-84ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-19_19:21_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2405
- **Fastest node RTT**: 39 ms
- **Median RTT**: 84 ms
- **Last updated (UTC)**: 2026-05-19 19:21 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 44 · trojan × 18 · vless × 67 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 51 · `pawdroid` × 8 · `ruking-clash` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
