...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2387-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-105ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-13_02:28_UTC-informational)
...
- **Median RTT**: 105 ms
- **Last updated (UTC)**: 2026-05-13 02:28 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 3 · vless × 101 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 42 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 64 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
