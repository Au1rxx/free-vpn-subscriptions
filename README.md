...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2268-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-399ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-17_16:36_UTC-informational)
...
- **Median RTT**: 399 ms
- **Last updated (UTC)**: 2026-07-17 16:36 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 99 · vless × 12 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 2 · `mahdi0024` × 65 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 4 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 17 · `surfboard-eternity` × 3
