...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2157-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-155ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-01_17:12_UTC-informational)
...
- **Median RTT**: 155 ms
- **Last updated (UTC)**: 2026-05-01 17:12 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 17 · vless × 82 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 31 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 49 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
