...
![nodes](https://img.shields.io/badge/nodes-108-brightgreen) ![alive](https://img.shields.io/badge/alive-1887-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-234ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-11_17:30_UTC-informational)
...
- **Median RTT**: 234 ms
- **Last updated (UTC)**: 2026-07-11 17:30 UTC

**Protocol mix:** shadowsocks × 48 · trojan × 18 · vless × 24 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 14 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 10 · `ninjastrikers` × 13 · `pawdroid` × 9 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
