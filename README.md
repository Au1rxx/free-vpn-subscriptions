...
![nodes](https://img.shields.io/badge/nodes-121-brightgreen) ![alive](https://img.shields.io/badge/alive-1906-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-275ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_04:35_UTC-informational)
...
- **Median RTT**: 275 ms
- **Last updated (UTC)**: 2026-07-12 04:35 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 54 · trojan × 18 · vless × 27 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 9 · `ninjastrikers` × 23 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 3
