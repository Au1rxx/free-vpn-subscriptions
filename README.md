...
![nodes](https://img.shields.io/badge/nodes-107-brightgreen) ![alive](https://img.shields.io/badge/alive-1757-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-384ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_12:28_UTC-informational)
...
- **Median RTT**: 384 ms
- **Last updated (UTC)**: 2026-06-17 12:28 UTC

**Protocol mix:** hysteria2 × 4 · shadowsocks × 43 · trojan × 27 · vless × 21 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 3 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 3
