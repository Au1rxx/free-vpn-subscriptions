...
![nodes](https://img.shields.io/badge/nodes-57-brightgreen) ![alive](https://img.shields.io/badge/alive-2100-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-167ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-28_20:22_UTC-informational)
...
- **Median RTT**: 167 ms
- **Last updated (UTC)**: 2026-05-28 20:22 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 15 · vless × 8 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 5 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 3
