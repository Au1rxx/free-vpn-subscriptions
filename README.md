...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2378-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-350ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-11_13:35_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2378
- **Fastest node RTT**: 28 ms
- **Median RTT**: 350 ms
- **Last updated (UTC)**: 2026-05-11 13:35 UTC

**Protocol mix:** shadowsocks × 45 · trojan × 17 · vless × 79 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
