...
![nodes](https://img.shields.io/badge/nodes-134-brightgreen) ![alive](https://img.shields.io/badge/alive-2048-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-361ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-24_02:30_UTC-informational)
...
- **Nodes selected**: 134
- **Alive across all sources**: 2048
- **Fastest node RTT**: 32 ms
- **Median RTT**: 361 ms
- **Last updated (UTC)**: 2026-06-24 02:30 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 27 · vless × 57 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 45 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 24 · `pawdroid` × 7 · `ruking-clash` × 12 · `surfboard-eternity` × 6
