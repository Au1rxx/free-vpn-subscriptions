...
![nodes](https://img.shields.io/badge/nodes-75-brightgreen) ![alive](https://img.shields.io/badge/alive-2114-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-124ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-10_07:12_UTC-informational)
...
- **Median RTT**: 124 ms
- **Last updated (UTC)**: 2026-07-10 07:12 UTC

**Protocol mix:** shadowsocks × 20 · trojan × 10 · vless × 15 · vmess × 30

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 33 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `surfboard-eternity` × 2
