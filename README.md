...
![nodes](https://img.shields.io/badge/nodes-128-brightgreen) ![alive](https://img.shields.io/badge/alive-1997-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-355ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_02:27_UTC-informational)
...
- **Median RTT**: 355 ms
- **Last updated (UTC)**: 2026-07-05 02:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 55 · trojan × 25 · vless × 20 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 38 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 5 · `ninjastrikers` × 21 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 2
