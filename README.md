...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2139-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-96ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-26_01:36_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2139
- **Fastest node RTT**: 35 ms
- **Median RTT**: 96 ms
- **Last updated (UTC)**: 2026-05-26 01:36 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 20 · vless × 87 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `pawdroid` × 6 · `ruking-clash` × 8 · `surfboard-eternity` × 7
