...
![nodes](https://img.shields.io/badge/nodes-136-brightgreen) ![alive](https://img.shields.io/badge/alive-1999-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-448ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_23:09_UTC-informational)
...
- **Median RTT**: 448 ms
- **Last updated (UTC)**: 2026-06-23 23:09 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 39 · trojan × 30 · vless × 51 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 49 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
