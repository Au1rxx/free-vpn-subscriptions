...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2474-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-161ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_13:12_UTC-informational)
...
- **Median RTT**: 161 ms
- **Last updated (UTC)**: 2026-05-10 13:12 UTC

**Protocol mix:** shadowsocks × 48 · trojan × 16 · vless × 78 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 62 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
