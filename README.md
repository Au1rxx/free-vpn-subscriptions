...
![nodes](https://img.shields.io/badge/nodes-114-brightgreen) ![alive](https://img.shields.io/badge/alive-1762-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-362ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_18:18_UTC-informational)
...
- **Nodes selected**: 114
- **Alive across all sources**: 1762
- **Fastest node RTT**: 55 ms
- **Median RTT**: 362 ms
- **Last updated (UTC)**: 2026-07-07 18:18 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 66 · trojan × 16 · vless × 17 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 5 · `ninjastrikers` × 9 · `pawdroid` × 9 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
