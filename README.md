...
![nodes](https://img.shields.io/badge/nodes-145-brightgreen) ![alive](https://img.shields.io/badge/alive-2350-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-92ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-24_23:31_UTC-informational)
...
- **Nodes selected**: 145
- **Alive across all sources**: 2350
- **Fastest node RTT**: 30 ms
- **Median RTT**: 92 ms
- **Last updated (UTC)**: 2026-05-24 23:31 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 19 · vless × 56 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 47 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 47 · `pawdroid` × 5 · `ruking-clash` × 4 · `surfboard-eternity` × 8
