...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-2531-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-109ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_01:20_UTC-informational)
...
- **Median RTT**: 109 ms
- **Last updated (UTC)**: 2026-06-02 01:20 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 31 · vless × 24 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 30 · `pawdroid` × 1 · `surfboard-eternity` × 2
