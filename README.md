...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-2005-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-441ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-28_12:39_UTC-informational)
...
- **Median RTT**: 441 ms
- **Last updated (UTC)**: 2026-06-28 12:39 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 34 · vless × 25 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 31 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 13 · `surfboard-eternity` × 5
