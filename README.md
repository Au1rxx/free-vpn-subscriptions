...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2381-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-94ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-21_02:35_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2381
- **Fastest node RTT**: 39 ms
- **Median RTT**: 94 ms
- **Last updated (UTC)**: 2026-05-21 02:35 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 15 · vless × 79 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 64 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 5
