...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-2308-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-290ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_19:19_UTC-informational)
...
- **Nodes selected**: 140
- **Alive across all sources**: 2308
- **Fastest node RTT**: 32 ms
- **Median RTT**: 290 ms
- **Last updated (UTC)**: 2026-04-21 19:19 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 24 · vless × 71 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 37 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 1 · `ruking-clash` × 7 · `snakem982` × 2 · `surfboard-eternity` × 5
