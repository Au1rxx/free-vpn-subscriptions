...
![nodes](https://img.shields.io/badge/nodes-131-brightgreen) ![alive](https://img.shields.io/badge/alive-2100-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-474ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_20:31_UTC-informational)
...
- **Median RTT**: 474 ms
- **Last updated (UTC)**: 2026-06-20 20:31 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 34 · vless × 32 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 38 · `surfboard-eternity` × 3
