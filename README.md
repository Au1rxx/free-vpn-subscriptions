...
![nodes](https://img.shields.io/badge/nodes-101-brightgreen) ![alive](https://img.shields.io/badge/alive-2023-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-181ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-27_03:09_UTC-informational)
...
- **Median RTT**: 181 ms
- **Last updated (UTC)**: 2026-06-27 03:09 UTC

**Protocol mix:** shadowsocks × 19 · trojan × 35 · vless × 26 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 19 · `surfboard-eternity` × 4
