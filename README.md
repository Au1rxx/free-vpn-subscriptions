...
![nodes](https://img.shields.io/badge/nodes-96-brightgreen) ![alive](https://img.shields.io/badge/alive-1908-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-227ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-11_22:21_UTC-informational)
...
- **Median RTT**: 227 ms
- **Last updated (UTC)**: 2026-07-11 22:21 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 16 · vless × 11 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 5 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 1
