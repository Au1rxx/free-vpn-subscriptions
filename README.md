...
![nodes](https://img.shields.io/badge/nodes-121-brightgreen) ![alive](https://img.shields.io/badge/alive-1906-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-359ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-14_04:38_UTC-informational)
...
- **Median RTT**: 359 ms
- **Last updated (UTC)**: 2026-07-14 04:38 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 24 · vless × 26 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 6 · `ninjastrikers` × 23 · `pawdroid` × 6 · `ruking-clash` × 2 · `surfboard-eternity` × 3
