...
![nodes](https://img.shields.io/badge/nodes-124-brightgreen) ![alive](https://img.shields.io/badge/alive-2069-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-384ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-24_08:24_UTC-informational)
...
- **Median RTT**: 384 ms
- **Last updated (UTC)**: 2026-06-24 08:24 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 29 · vless × 45 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 41 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 14 · `surfboard-eternity` × 2
