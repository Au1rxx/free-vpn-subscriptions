...
![nodes](https://img.shields.io/badge/nodes-101-brightgreen) ![alive](https://img.shields.io/badge/alive-2314-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-183ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_01:14_UTC-informational)
...
- **Median RTT**: 183 ms
- **Last updated (UTC)**: 2026-06-20 01:14 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 26 · vless × 18 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 11 · `mahdi0024` × 24 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 22 · `pawdroid` × 1 · `ruking-clash` × 18 · `surfboard-eternity` × 6
