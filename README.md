...
![nodes](https://img.shields.io/badge/nodes-135-brightgreen) ![alive](https://img.shields.io/badge/alive-2208-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-166ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-28_15:20_UTC-informational)
...
- **Median RTT**: 166 ms
- **Last updated (UTC)**: 2026-04-28 15:20 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 20 · vless × 75 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 59 · `ruking-clash` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
