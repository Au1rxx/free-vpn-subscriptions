...
![nodes](https://img.shields.io/badge/nodes-127-brightgreen) ![alive](https://img.shields.io/badge/alive-2484-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-489ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_11:38_UTC-informational)
...
- **Median RTT**: 489 ms
- **Last updated (UTC)**: 2026-06-19 11:38 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 32 · trojan × 27 · vless × 48 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 7
