...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2485-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-91ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-16_20:35_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2485
- **Fastest node RTT**: 37 ms
- **Median RTT**: 91 ms
- **Last updated (UTC)**: 2026-05-16 20:35 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 17 · vless × 85 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 36 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 49 · `pawdroid` × 9 · `ruking-clash` × 6 · `surfboard-eternity` × 5
