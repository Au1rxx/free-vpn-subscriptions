...
![nodes](https://img.shields.io/badge/nodes-144-brightgreen) ![alive](https://img.shields.io/badge/alive-2125-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-164ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-28_23:24_UTC-informational)
...
- **Median RTT**: 164 ms
- **Last updated (UTC)**: 2026-04-28 23:24 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 22 · vless × 78 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 39 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 7 · `ninjastrikers` × 55 · `ruking-clash` × 1 · `surfboard-eternity` × 6
