...
![nodes](https://img.shields.io/badge/nodes-122-brightgreen) ![alive](https://img.shields.io/badge/alive-2540-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-168ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_03:26_UTC-informational)
...
- **Nodes selected**: 122
- **Alive across all sources**: 2540
- **Fastest node RTT**: 30 ms
- **Median RTT**: 168 ms
- **Last updated (UTC)**: 2026-06-02 03:26 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 33 · trojan × 35 · vless × 25 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 27 · `pawdroid` × 5 · `snakem982` × 2 · `surfboard-eternity` × 3
