...
![nodes](https://img.shields.io/badge/nodes-74-brightgreen) ![alive](https://img.shields.io/badge/alive-2238-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-131ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-31_13:10_UTC-informational)
...
- **Median RTT**: 131 ms
- **Last updated (UTC)**: 2026-05-31 13:10 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 21 · trojan × 19 · vless × 7 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 5 · `pawdroid` × 1 · `surfboard-eternity` × 1
