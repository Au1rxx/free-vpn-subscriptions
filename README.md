...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2418-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-396ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_22:09_UTC-informational)
...
- **Median RTT**: 396 ms
- **Last updated (UTC)**: 2026-07-18 22:09 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 33 · trojan × 97 · vless × 13 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 33 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 45 · `matin-v2ray` × 5 · `ninjastrikers` × 6 · `pawdroid` × 6 · `ruking-clash` × 2 · `snakem982` × 10 · `surfboard-eternity` × 7
