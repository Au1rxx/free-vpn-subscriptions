...
![nodes](https://img.shields.io/badge/nodes-143-brightgreen) ![alive](https://img.shields.io/badge/alive-2607-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-164ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_17:40_UTC-informational)
...
- **Nodes selected**: 143
- **Alive across all sources**: 2607
- **Fastest node RTT**: 31 ms
- **Median RTT**: 164 ms
- **Last updated (UTC)**: 2026-04-24 17:40 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 21 · vless × 85 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 34 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 60 · `pawdroid` × 2 · `surfboard-eternity` × 1
