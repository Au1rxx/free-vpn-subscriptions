...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2371-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-398ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_13:08_UTC-informational)
...
- **Median RTT**: 398 ms
- **Last updated (UTC)**: 2026-07-18 13:08 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 91 · vless × 20 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 3 · `mahdi0024` × 57 · `mahdibland-aggregator` × 33 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 5 · `ninjastrikers` × 5 · `pawdroid` × 14 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
