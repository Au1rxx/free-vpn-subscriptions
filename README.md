...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2366-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-144ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_19:16_UTC-informational)
...
- **Median RTT**: 144 ms
- **Last updated (UTC)**: 2026-05-12 19:16 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 20 · vless × 78 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 53 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
