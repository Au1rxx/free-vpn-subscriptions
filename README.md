...
![nodes](https://img.shields.io/badge/nodes-141-brightgreen) ![alive](https://img.shields.io/badge/alive-2572-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-111ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-14_16:30_UTC-informational)
...
- **Nodes selected**: 141
- **Alive across all sources**: 2572
- **Fastest node RTT**: 33 ms
- **Median RTT**: 111 ms
- **Last updated (UTC)**: 2026-05-14 16:30 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 21 · vless × 75 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 28 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 54 · `pawdroid` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
