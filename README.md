...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2167-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_05:34_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2167
- **Fastest node RTT**: 30 ms
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-04-26 05:34 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 7 · vless × 107 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 19 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 8
