...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-1980-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-420ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_12:12_UTC-informational)
...
- **Nodes selected**: 105
- **Alive across all sources**: 1980
- **Fastest node RTT**: 29 ms
- **Median RTT**: 420 ms
- **Last updated (UTC)**: 2026-06-18 12:12 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 31 · vless × 31 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 9 · `pawdroid` × 6 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 6
