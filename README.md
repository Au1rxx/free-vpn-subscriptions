...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2514-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-98ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-27_10:27_UTC-informational)
...
- **Median RTT**: 98 ms
- **Last updated (UTC)**: 2026-04-27 10:27 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 7 · vless × 94 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 44 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 59 · `pawdroid` × 1 · `surfboard-eternity` × 3
