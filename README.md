...
![nodes](https://img.shields.io/badge/nodes-99-brightgreen) ![alive](https://img.shields.io/badge/alive-1964-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-495ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_09:17_UTC-informational)
...
- **Median RTT**: 495 ms
- **Last updated (UTC)**: 2026-06-18 09:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 26 · vless × 31 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 7 · `ruking-clash` × 18 · `snakem982` × 7 · `surfboard-eternity` × 2
