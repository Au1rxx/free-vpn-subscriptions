...
![nodes](https://img.shields.io/badge/nodes-149-brightgreen) ![alive](https://img.shields.io/badge/alive-1908-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-470ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_07:37_UTC-informational)
...
- **Nodes selected**: 149
- **Alive across all sources**: 1908
- **Fastest node RTT**: 28 ms
- **Median RTT**: 470 ms
- **Last updated (UTC)**: 2026-06-22 07:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 46 · trojan × 30 · vless × 59 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 6 · `ruking-clash` × 31 · `snakem982` × 3 · `surfboard-eternity` × 2
