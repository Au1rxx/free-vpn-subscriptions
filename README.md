...
![nodes](https://img.shields.io/badge/nodes-148-brightgreen) ![alive](https://img.shields.io/badge/alive-2576-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-140ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_15:37_UTC-informational)
...
- **Median RTT**: 140 ms
- **Last updated (UTC)**: 2026-04-24 15:37 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 20 · vless × 86 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 20 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 38 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 57 · `pawdroid` × 2 · `surfboard-eternity` × 3
