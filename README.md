...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2223-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-121ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_13:27_UTC-informational)
...
- **Median RTT**: 121 ms
- **Last updated (UTC)**: 2026-05-03 13:27 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 24 · vless × 91 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 35 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 60 · `pawdroid` × 1 · `surfboard-eternity` × 5
