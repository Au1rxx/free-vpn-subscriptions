...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1968-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-339ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_19:34_UTC-informational)
...
- **Median RTT**: 339 ms
- **Last updated (UTC)**: 2026-05-06 19:34 UTC

**Protocol mix:** shadowsocks × 46 · trojan × 24 · vless × 69 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 2
