...
![nodes](https://img.shields.io/badge/nodes-141-brightgreen) ![alive](https://img.shields.io/badge/alive-2530-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-242ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_12:29_UTC-informational)
...
- **Median RTT**: 242 ms
- **Last updated (UTC)**: 2026-04-23 12:29 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 22 · vless × 78 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 66 · `pawdroid` × 3 · `surfboard-eternity` × 8
