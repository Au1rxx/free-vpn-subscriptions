...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2401-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-397ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_20:29_UTC-informational)
...
- **Median RTT**: 397 ms
- **Last updated (UTC)**: 2026-07-18 20:29 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 97 · vless × 13 · vmess × 4

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 44 · `mahdibland-shadowsocks` × 46 · `matin-v2ray` × 4 · `ninjastrikers` × 4 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 5
