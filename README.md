...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2166-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-96ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_06:33_UTC-informational)
...
- **Median RTT**: 96 ms
- **Last updated (UTC)**: 2026-04-26 06:33 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 9 · vless × 104 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
