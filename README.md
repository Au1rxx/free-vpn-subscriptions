...
![nodes](https://img.shields.io/badge/nodes-149-brightgreen) ![alive](https://img.shields.io/badge/alive-2563-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-167ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_19:33_UTC-informational)
...
- **Median RTT**: 167 ms
- **Last updated (UTC)**: 2026-04-24 19:33 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 22 · vless × 85 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 27 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 52 · `snakem982` × 1 · `surfboard-eternity` × 6
