...
![nodes](https://img.shields.io/badge/nodes-147-brightgreen) ![alive](https://img.shields.io/badge/alive-2074-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-199ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-29_17:21_UTC-informational)
...
- **Median RTT**: 199 ms
- **Last updated (UTC)**: 2026-04-29 17:21 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 18 · vless × 76 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 7 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 7 · `ninjastrikers` × 53 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
