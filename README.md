...
![nodes](https://img.shields.io/badge/nodes-62-brightgreen) ![alive](https://img.shields.io/badge/alive-2410-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-146ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_21:22_UTC-informational)
...
- **Median RTT**: 146 ms
- **Last updated (UTC)**: 2026-07-02 21:22 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 15 · vless × 6 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `surfboard-eternity` × 5
