...
![nodes](https://img.shields.io/badge/nodes-84-brightgreen) ![alive](https://img.shields.io/badge/alive-2086-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-178ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_19:33_UTC-informational)
...
- **Nodes selected**: 84
- **Alive across all sources**: 2086
- **Fastest node RTT**: 29 ms
- **Median RTT**: 178 ms
- **Last updated (UTC)**: 2026-06-06 19:33 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 32 · trojan × 20 · vless × 7 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 39 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 2
