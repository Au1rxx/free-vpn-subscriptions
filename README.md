...
![nodes](https://img.shields.io/badge/nodes-131-brightgreen) ![alive](https://img.shields.io/badge/alive-2106-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-182ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_22:35_UTC-informational)
...
- **Nodes selected**: 131
- **Alive across all sources**: 2106
- **Fastest node RTT**: 29 ms
- **Median RTT**: 182 ms
- **Last updated (UTC)**: 2026-05-03 22:35 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 20 · vless × 72 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `ruking-clash` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
