...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2474-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-97ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-15_00:25_UTC-informational)
...
- **Median RTT**: 97 ms
- **Last updated (UTC)**: 2026-05-15 00:25 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 8 · vless × 92 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 3 · `epodonios` × 2 · `lagzian-mix` × 7 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 60 · `pawdroid` × 7 · `ruking-clash` × 5 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
