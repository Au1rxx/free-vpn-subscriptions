...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1956-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-152ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_07:27_UTC-informational)
...
- **Median RTT**: 152 ms
- **Last updated (UTC)**: 2026-05-07 07:27 UTC

**Protocol mix:** shadowsocks × 49 · trojan × 5 · vless × 87 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 72 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
