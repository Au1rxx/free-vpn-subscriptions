...
![nodes](https://img.shields.io/badge/nodes-142-brightgreen) ![alive](https://img.shields.io/badge/alive-2461-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-121ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_10:16_UTC-informational)
...
- **Median RTT**: 121 ms
- **Last updated (UTC)**: 2026-04-24 10:16 UTC

**Protocol mix:** shadowsocks × 14 · trojan × 22 · vless × 92 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 20 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 71 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
