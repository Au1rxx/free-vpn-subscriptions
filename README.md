...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-1959-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-294ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-27_23:13_UTC-informational)
...
- **Median RTT**: 294 ms
- **Last updated (UTC)**: 2026-06-27 23:13 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 44 · vless × 18 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `ruking-clash` × 16 · `surfboard-eternity` × 2
