...
![nodes](https://img.shields.io/badge/nodes-128-brightgreen) ![alive](https://img.shields.io/badge/alive-1774-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-358ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-09_07:38_UTC-informational)
...
- **Median RTT**: 358 ms
- **Last updated (UTC)**: 2026-07-09 07:38 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 57 · trojan × 25 · vless × 17 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 24 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 4 · `ninjastrikers` × 18 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 7
