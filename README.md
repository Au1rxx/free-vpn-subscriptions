...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2540-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-96ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_11:37_UTC-informational)
...
- **Median RTT**: 96 ms
- **Last updated (UTC)**: 2026-04-25 11:37 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 14 · vless × 98 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 21 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 3
