...
![nodes](https://img.shields.io/badge/nodes-95-brightgreen) ![alive](https://img.shields.io/badge/alive-1891-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-362ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-15_13:37_UTC-informational)
...
- **Median RTT**: 362 ms
- **Last updated (UTC)**: 2026-06-15 13:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 43 · trojan × 21 · vless × 16 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 18 · `mfuu-clash` × 2 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 3
