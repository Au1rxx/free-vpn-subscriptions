...
![nodes](https://img.shields.io/badge/nodes-113-brightgreen) ![alive](https://img.shields.io/badge/alive-1916-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-337ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_22:31_UTC-informational)
...
- **Median RTT**: 337 ms
- **Last updated (UTC)**: 2026-07-05 22:31 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 25 · vless × 11 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 10 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 4
