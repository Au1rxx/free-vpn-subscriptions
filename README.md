...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2116-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-153ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-02_23:19_UTC-informational)
...
- **Median RTT**: 153 ms
- **Last updated (UTC)**: 2026-05-02 23:19 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 21 · vless × 83 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 38 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 50 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
