...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2090-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-82ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_01:35_UTC-informational)
...
- **Median RTT**: 82 ms
- **Last updated (UTC)**: 2026-05-03 01:35 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 3 · vless × 101 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 62 · `pawdroid` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
