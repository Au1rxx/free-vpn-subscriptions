...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2220-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-122ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_13:31_UTC-informational)
...
- **Median RTT**: 122 ms
- **Last updated (UTC)**: 2026-04-25 13:31 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 16 · vless × 88 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 23 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 57 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
