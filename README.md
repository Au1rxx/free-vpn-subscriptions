...
![nodes](https://img.shields.io/badge/nodes-122-brightgreen) ![alive](https://img.shields.io/badge/alive-2472-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-474ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_05:15_UTC-informational)
...
- **Median RTT**: 474 ms
- **Last updated (UTC)**: 2026-06-19 05:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 27 · vless × 49 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 35 · `snakem982` × 7 · `surfboard-eternity` × 4
