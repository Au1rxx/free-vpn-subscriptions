...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2218-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-123ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_06:21_UTC-informational)
...
- **Median RTT**: 123 ms
- **Last updated (UTC)**: 2026-04-22 06:21 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 4 · vless × 98 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 38 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 9
