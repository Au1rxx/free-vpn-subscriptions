...
![nodes](https://img.shields.io/badge/nodes-123-brightgreen) ![alive](https://img.shields.io/badge/alive-2492-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-439ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_21:14_UTC-informational)
...
- **Nodes selected**: 123
- **Alive across all sources**: 2492
- **Fastest node RTT**: 28 ms
- **Median RTT**: 439 ms
- **Last updated (UTC)**: 2026-04-23 21:14 UTC

**Protocol mix:** shadowsocks × 14 · trojan × 25 · vless × 70 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 47 · `pawdroid` × 2 · `surfboard-eternity` × 1
