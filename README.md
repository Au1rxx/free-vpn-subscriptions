...
![nodes](https://img.shields.io/badge/nodes-109-brightgreen) ![alive](https://img.shields.io/badge/alive-1866-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-344ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-15_06:12_UTC-informational)
...
- **Nodes selected**: 109
- **Alive across all sources**: 1866
- **Fastest node RTT**: 32 ms
- **Median RTT**: 344 ms
- **Last updated (UTC)**: 2026-06-15 06:12 UTC

**Protocol mix:** shadowsocks × 45 · trojan × 26 · vless × 25 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 29 · `pawdroid` × 1 · `ruking-clash` × 11 · `surfboard-eternity` × 2
