...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-1843-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-167ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-04_20:29_UTC-informational)
...
- **Median RTT**: 167 ms
- **Last updated (UTC)**: 2026-06-04 20:29 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 51 · vless × 20 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 33 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `ruking-clash` × 3 · `surfboard-eternity` × 6
