...
![nodes](https://img.shields.io/badge/nodes-127-brightgreen) ![alive](https://img.shields.io/badge/alive-2118-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-400ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_23:31_UTC-informational)
...
- **Nodes selected**: 127
- **Alive across all sources**: 2118
- **Fastest node RTT**: 28 ms
- **Median RTT**: 400 ms
- **Last updated (UTC)**: 2026-06-20 23:31 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 35 · vless × 29 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 6 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 31 · `surfboard-eternity` × 2
