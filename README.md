...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2228-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-142ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_01:28_UTC-informational)
...
- **Median RTT**: 142 ms
- **Last updated (UTC)**: 2026-05-06 01:28 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 15 · vless × 89 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 27 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 79 · `pawdroid` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
