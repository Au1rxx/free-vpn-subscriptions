...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-1869-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-279ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_03:26_UTC-informational)
...
- **Nodes selected**: 112
- **Alive across all sources**: 1869
- **Fastest node RTT**: 35 ms
- **Median RTT**: 279 ms
- **Last updated (UTC)**: 2026-07-07 03:26 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 45 · trojan × 22 · vless × 21 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 9 · `ninjastrikers` × 21 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 3
