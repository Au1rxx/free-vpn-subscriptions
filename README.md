...
![nodes](https://img.shields.io/badge/nodes-122-brightgreen) ![alive](https://img.shields.io/badge/alive-1806-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-339ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-11_04:22_UTC-informational)
...
- **Nodes selected**: 122
- **Alive across all sources**: 1806
- **Fastest node RTT**: 31 ms
- **Median RTT**: 339 ms
- **Last updated (UTC)**: 2026-07-11 04:22 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 55 · trojan × 25 · vless × 23 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 33 · `matin-v2ray` × 2 · `ninjastrikers` × 26 · `pawdroid` × 9 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
