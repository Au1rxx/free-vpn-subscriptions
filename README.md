...
![nodes](https://img.shields.io/badge/nodes-84-brightgreen) ![alive](https://img.shields.io/badge/alive-2114-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-137ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-10_05:12_UTC-informational)
...
- **Median RTT**: 137 ms
- **Last updated (UTC)**: 2026-07-10 05:12 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 10 · vless × 19 · vmess × 32

**Sources used this run:** `barry-far-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 41 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 3 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 3
