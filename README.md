...
![nodes](https://img.shields.io/badge/nodes-76-brightgreen) ![alive](https://img.shields.io/badge/alive-2380-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-329ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_17:27_UTC-informational)
...
- **Median RTT**: 329 ms
- **Last updated (UTC)**: 2026-06-11 17:27 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 18 · vless × 10 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 17 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 2
