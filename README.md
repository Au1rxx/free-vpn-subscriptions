...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2418-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-225ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_14:23_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2418
- **Fastest node RTT**: 28 ms
- **Median RTT**: 225 ms
- **Last updated (UTC)**: 2026-05-10 14:23 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 16 · vless × 83 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 60 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 3 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
