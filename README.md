...
![nodes](https://img.shields.io/badge/nodes-73-brightgreen) ![alive](https://img.shields.io/badge/alive-2502-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-97ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_10:26_UTC-informational)
...
- **Median RTT**: 97 ms
- **Last updated (UTC)**: 2026-06-02 10:26 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 22 · vless × 8 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 10 · `pawdroid` × 3 · `surfboard-eternity` × 1
