...
![nodes](https://img.shields.io/badge/nodes-74-brightgreen) ![alive](https://img.shields.io/badge/alive-1948-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-174ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-03_21:33_UTC-informational)
...
- **Median RTT**: 174 ms
- **Last updated (UTC)**: 2026-07-03 21:33 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 21 · vless × 9 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
