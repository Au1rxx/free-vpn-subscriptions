...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1967-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-365ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_17:29_UTC-informational)
...
- **Median RTT**: 365 ms
- **Last updated (UTC)**: 2026-05-06 17:29 UTC

**Protocol mix:** shadowsocks × 48 · trojan × 20 · vless × 71 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 58 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
