...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2600-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-67ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-20_10:30_UTC-informational)
...
- **Median RTT**: 67 ms
- **Last updated (UTC)**: 2026-05-20 10:30 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 12 · vless × 90 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 70 · `pawdroid` × 13 · `ruking-clash` × 1 · `surfboard-eternity` × 7
