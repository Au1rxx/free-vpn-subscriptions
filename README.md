...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2028-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-69ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-22_09:11_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2028
- **Fastest node RTT**: 30 ms
- **Median RTT**: 69 ms
- **Last updated (UTC)**: 2026-05-22 09:11 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 10 · vless × 91 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 67 · `pawdroid` × 4 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 8
