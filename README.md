...
![nodes](https://img.shields.io/badge/nodes-136-brightgreen) ![alive](https://img.shields.io/badge/alive-2433-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-115ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-24_11:21_UTC-informational)
...
- **Median RTT**: 115 ms
- **Last updated (UTC)**: 2026-04-24 11:21 UTC

**Protocol mix:** shadowsocks × 11 · trojan × 21 · vless × 91 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 19 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 67 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
