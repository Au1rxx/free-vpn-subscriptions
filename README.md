...
![nodes](https://img.shields.io/badge/nodes-91-brightgreen) ![alive](https://img.shields.io/badge/alive-2408-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-81ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-03_03:34_UTC-informational)
...
- **Median RTT**: 81 ms
- **Last updated (UTC)**: 2026-06-03 03:34 UTC

**Protocol mix:** shadowsocks × 14 · trojan × 34 · vless × 21 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 19 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 24 · `pawdroid` × 2 · `surfboard-eternity` × 3
