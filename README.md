...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2343-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-401ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-17_21:35_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2343
- **Fastest node RTT**: 32 ms
- **Median RTT**: 401 ms
- **Last updated (UTC)**: 2026-07-17 21:35 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 97 · vless × 11 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `mahdi0024` × 65 · `mahdibland-aggregator` × 31 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 4 · `ninjastrikers` × 6 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 8 · `surfboard-eternity` × 3
