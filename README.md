...
![nodes](https://img.shields.io/badge/nodes-89-brightgreen) ![alive](https://img.shields.io/badge/alive-2057-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-151ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-10_00:22_UTC-informational)
...
- **Median RTT**: 151 ms
- **Last updated (UTC)**: 2026-07-10 00:22 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 26 · trojan × 10 · vless × 19 · vmess × 33

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 34 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
