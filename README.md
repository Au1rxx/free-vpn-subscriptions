...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-1919-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-339ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-14_00:27_UTC-informational)
...
- **Median RTT**: 339 ms
- **Last updated (UTC)**: 2026-07-14 00:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 39 · trojan × 25 · vless × 17 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 29 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 6 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
