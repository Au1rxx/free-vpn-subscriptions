...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2089-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-165ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_14:31_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2089
- **Fastest node RTT**: 28 ms
- **Median RTT**: 165 ms
- **Last updated (UTC)**: 2026-05-03 14:31 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 25 · vless × 87 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 59 · `pawdroid` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
