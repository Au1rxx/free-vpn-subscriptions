...
![nodes](https://img.shields.io/badge/nodes-92-brightgreen) ![alive](https://img.shields.io/badge/alive-1931-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-341ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-13_20:09_UTC-informational)
...
- **Median RTT**: 341 ms
- **Last updated (UTC)**: 2026-07-13 20:09 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 19 · vless × 9 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `mahdi0024` × 24 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 8 · `ninjastrikers` × 13 · `pawdroid` × 2 · `snakem982` × 1
