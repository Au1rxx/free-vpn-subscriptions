...
![nodes](https://img.shields.io/badge/nodes-149-brightgreen) ![alive](https://img.shields.io/badge/alive-2331-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-447ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-21_16:34_UTC-informational)
...
- **Median RTT**: 447 ms
- **Last updated (UTC)**: 2026-04-21 16:34 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 19 · vless × 87 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 50 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
