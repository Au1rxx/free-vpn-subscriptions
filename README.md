...
![nodes](https://img.shields.io/badge/nodes-97-brightgreen) ![alive](https://img.shields.io/badge/alive-1911-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-121ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-05_09:33_UTC-informational)
...
- **Median RTT**: 121 ms
- **Last updated (UTC)**: 2026-06-05 09:33 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 37 · vless × 19 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 15 · `epodonios` × 30 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `surfboard-eternity` × 2
