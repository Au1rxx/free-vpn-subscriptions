...
![nodes](https://img.shields.io/badge/nodes-144-brightgreen) ![alive](https://img.shields.io/badge/alive-2256-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-293ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_19:17_UTC-informational)
...
- **Median RTT**: 293 ms
- **Last updated (UTC)**: 2026-05-04 19:17 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 25 · vless × 71 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 60 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
