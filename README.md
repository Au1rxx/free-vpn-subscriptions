...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2344-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-84ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-20_20:31_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2344
- **Fastest node RTT**: 35 ms
- **Median RTT**: 84 ms
- **Last updated (UTC)**: 2026-05-20 20:31 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 23 · vless × 70 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
