...
![nodes](https://img.shields.io/badge/nodes-113-brightgreen) ![alive](https://img.shields.io/badge/alive-2005-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-355ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-28_09:32_UTC-informational)
...
- **Median RTT**: 355 ms
- **Last updated (UTC)**: 2026-06-28 09:32 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 39 · vless × 27 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
