...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2224-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-374ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-17_01:33_UTC-informational)
...
- **Median RTT**: 374 ms
- **Last updated (UTC)**: 2026-07-17 01:33 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 75 · vless × 16 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `mahdi0024` × 42 · `mahdibland-aggregator` × 33 · `mahdibland-shadowsocks` × 32 · `matin-v2ray` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 2
