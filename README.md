...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2532-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-113ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-25_08:16_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2532
- **Fastest node RTT**: 27 ms
- **Median RTT**: 113 ms
- **Last updated (UTC)**: 2026-04-25 08:16 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 17 · vless × 96 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 68 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
