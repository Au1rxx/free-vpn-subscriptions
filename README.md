...
![nodes](https://img.shields.io/badge/nodes-141-brightgreen) ![alive](https://img.shields.io/badge/alive-2555-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-186ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-23_11:35_UTC-informational)
...
- **Nodes selected**: 141
- **Alive across all sources**: 2555
- **Fastest node RTT**: 26 ms
- **Median RTT**: 186 ms
- **Last updated (UTC)**: 2026-04-23 11:35 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 22 · vless × 80 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 70 · `pawdroid` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
