...
![nodes](https://img.shields.io/badge/nodes-133-brightgreen) ![alive](https://img.shields.io/badge/alive-2374-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-503ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_15:30_UTC-informational)
...
- **Median RTT**: 503 ms
- **Last updated (UTC)**: 2026-06-18 15:30 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 36 · vless × 48 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 25 · `snakem982` × 9 · `surfboard-eternity` × 3
