...
![nodes](https://img.shields.io/badge/nodes-118-brightgreen) ![alive](https://img.shields.io/badge/alive-1825-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-374ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_23:18_UTC-informational)
...
- **Median RTT**: 374 ms
- **Last updated (UTC)**: 2026-07-07 23:18 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 66 · trojan × 26 · vless × 10 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 9 · `ninjastrikers` × 17 · `ruking-clash` × 1 · `surfboard-eternity` × 3
