...
![nodes](https://img.shields.io/badge/nodes-98-brightgreen) ![alive](https://img.shields.io/badge/alive-1857-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-354ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_18:14_UTC-informational)
...
- **Median RTT**: 354 ms
- **Last updated (UTC)**: 2026-06-07 18:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 54 · trojan × 22 · vless × 15 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 24 · `mfuu-clash` × 4 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 1
