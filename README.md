...
![nodes](https://img.shields.io/badge/nodes-133-brightgreen) ![alive](https://img.shields.io/badge/alive-1635-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-480ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_20:27_UTC-informational)
...
- **Median RTT**: 480 ms
- **Last updated (UTC)**: 2026-06-14 20:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 61 · trojan × 32 · vless × 26 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 17 · `surfboard-eternity` × 4
