...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-1813-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-370ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_21:38_UTC-informational)
...
- **Median RTT**: 370 ms
- **Last updated (UTC)**: 2026-07-07 21:38 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 55 · trojan × 27 · vless × 17 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 10 · `ninjastrikers` × 16 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 2
