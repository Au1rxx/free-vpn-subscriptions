...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2360-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-23_18:33_UTC-informational)
...
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-05-23 18:33 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 21 · vless × 67 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 26 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 40 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 49 · `pawdroid` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
