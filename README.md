...
![nodes](https://img.shields.io/badge/nodes-102-brightgreen) ![alive](https://img.shields.io/badge/alive-1925-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-361ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-06_20:21_UTC-informational)
...
- **Median RTT**: 361 ms
- **Last updated (UTC)**: 2026-07-06 20:21 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 46 · trojan × 26 · vless × 9 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 5 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 1
