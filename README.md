...
![nodes](https://img.shields.io/badge/nodes-138-brightgreen) ![alive](https://img.shields.io/badge/alive-2105-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-164ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-28_22:33_UTC-informational)
...
- **Median RTT**: 164 ms
- **Last updated (UTC)**: 2026-04-28 22:33 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 22 · vless × 75 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 35 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 53 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
