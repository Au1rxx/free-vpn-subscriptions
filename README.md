...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2024-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-78ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-22_14:35_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2024
- **Fastest node RTT**: 32 ms
- **Median RTT**: 78 ms
- **Last updated (UTC)**: 2026-05-22 14:35 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 21 · vless × 83 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 69 · `pawdroid` × 4 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
