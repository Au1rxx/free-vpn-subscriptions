...
![nodes](https://img.shields.io/badge/nodes-114-brightgreen) ![alive](https://img.shields.io/badge/alive-1957-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-206ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-13_06:15_UTC-informational)
...
- **Median RTT**: 206 ms
- **Last updated (UTC)**: 2026-07-13 06:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 52 · trojan × 18 · vless × 29 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 4 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 4
