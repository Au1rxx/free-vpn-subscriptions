...
![nodes](https://img.shields.io/badge/nodes-114-brightgreen) ![alive](https://img.shields.io/badge/alive-1968-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-331ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_13:39_UTC-informational)
...
- **Median RTT**: 331 ms
- **Last updated (UTC)**: 2026-07-05 13:39 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 24 · vless × 12 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 34 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 10 · `ninjastrikers` × 13 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
