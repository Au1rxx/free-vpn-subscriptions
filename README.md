...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-1888-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-262ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_06:08_UTC-informational)
...
- **Median RTT**: 262 ms
- **Last updated (UTC)**: 2026-07-12 06:08 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 16 · vless × 27 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 12 · `ninjastrikers` × 25 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
