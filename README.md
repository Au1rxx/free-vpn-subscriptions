...
![nodes](https://img.shields.io/badge/nodes-71-brightgreen) ![alive](https://img.shields.io/badge/alive-2407-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-148ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_15:33_UTC-informational)
...
- **Median RTT**: 148 ms
- **Last updated (UTC)**: 2026-07-02 15:33 UTC

**Protocol mix:** shadowsocks × 20 · trojan × 16 · vless × 20 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 8 · `ninjastrikers` × 13 · `pawdroid` × 11 · `surfboard-eternity` × 2
