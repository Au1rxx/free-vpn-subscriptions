...
![nodes](https://img.shields.io/badge/nodes-116-brightgreen) ![alive](https://img.shields.io/badge/alive-1780-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-365ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_01:09_UTC-informational)
...
- **Median RTT**: 365 ms
- **Last updated (UTC)**: 2026-06-18 01:09 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 47 · trojan × 29 · vless × 32 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 24 · `pawdroid` × 1 · `ruking-clash` × 15 · `surfboard-eternity` × 4
