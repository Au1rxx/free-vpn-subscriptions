...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2446-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-136ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-11_06:35_UTC-informational)
...
- **Median RTT**: 136 ms
- **Last updated (UTC)**: 2026-05-11 06:35 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 5 · vless × 94 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
