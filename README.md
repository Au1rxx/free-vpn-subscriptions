...
![nodes](https://img.shields.io/badge/nodes-76-brightgreen) ![alive](https://img.shields.io/badge/alive-2079-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-150ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-10_08:13_UTC-informational)
...
- **Median RTT**: 150 ms
- **Last updated (UTC)**: 2026-07-10 08:13 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 11 · vless × 14 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 34 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `surfboard-eternity` × 3
