...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2329-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-91ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-24_05:32_UTC-informational)
...
- **Median RTT**: 91 ms
- **Last updated (UTC)**: 2026-05-24 05:32 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 3 · vless × 87 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 29 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 34 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 56 · `pawdroid` × 4 · `surfboard-eternity` × 9
