...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2567-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-156ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-26_21:20_UTC-informational)
...
- **Median RTT**: 156 ms
- **Last updated (UTC)**: 2026-04-26 21:20 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 22 · vless × 80 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 26 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 42 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 3 · `ninjastrikers` × 50 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
