...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2425-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-107ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_05:21_UTC-informational)
...
- **Median RTT**: 107 ms
- **Last updated (UTC)**: 2026-05-09 05:21 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 15 · vless × 89 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 75 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 5
