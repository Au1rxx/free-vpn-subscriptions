...
![nodes](https://img.shields.io/badge/nodes-129-brightgreen) ![alive](https://img.shields.io/badge/alive-1898-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-356ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-16_04:18_UTC-informational)
...
- **Median RTT**: 356 ms
- **Last updated (UTC)**: 2026-06-16 04:18 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 51 · trojan × 30 · vless × 35 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 31 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 3
