...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2229-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-144ms-orange) ![updated](https://img.shields.io/badge/updated-2026-04-22_01:38_UTC-informational)
...
- **Median RTT**: 144 ms
- **Last updated (UTC)**: 2026-04-22 01:38 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 5 · vless × 97 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 29 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 71 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 5
