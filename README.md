...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2010-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-149ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_03:33_UTC-informational)
...
- **Median RTT**: 149 ms
- **Last updated (UTC)**: 2026-05-08 03:33 UTC

**Protocol mix:** shadowsocks × 51 · trojan × 6 · vless × 84 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 80 · `snakem982` × 1 · `surfboard-eternity` × 6
