...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2450-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-126ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-13_17:20_UTC-informational)
...
- **Median RTT**: 126 ms
- **Last updated (UTC)**: 2026-05-13 17:20 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 20 · vless × 78 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 5 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 6
