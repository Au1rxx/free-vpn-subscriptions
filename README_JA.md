...
![ノード](https://img.shields.io/badge/ノード-109-brightgreen) ![生存](https://img.shields.io/badge/生存-1686-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-405ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-13_23:25_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 405 ms
- **最終更新 (UTC)**: 2026-06-13 23:25 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 54 · trojan × 32 · vless × 15 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 14 · `surfboard-eternity` × 4
