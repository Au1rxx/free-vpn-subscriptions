...
![ノード](https://img.shields.io/badge/ノード-140-brightgreen) ![生存](https://img.shields.io/badge/生存-1720-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-496ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_09:26_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 496 ms
- **最終更新 (UTC)**: 2026-06-14 09:26 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 75 · trojan × 36 · vless × 21 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 21 · `surfboard-eternity` × 4
