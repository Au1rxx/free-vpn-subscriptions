...
![ノード](https://img.shields.io/badge/ノード-112-brightgreen) ![生存](https://img.shields.io/badge/生存-2542-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-279ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_06:37_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 279 ms
- **最終更新 (UTC)**: 2026-06-02 06:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 40 · trojan × 37 · vless × 16 · vmess × 18

**今回使用したソース:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 19 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
