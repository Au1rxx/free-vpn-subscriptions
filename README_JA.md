...
![ノード](https://img.shields.io/badge/ノード-78-brightgreen) ![生存](https://img.shields.io/badge/生存-2420-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-164ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-01_15:20_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 164 ms
- **最終更新 (UTC)**: 2026-06-01 15:20 UTC

**プロトコル構成:** shadowsocks × 15 · trojan × 26 · vless × 7 · vmess × 30

**今回使用したソース:** `barry-far-v2ray` × 16 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 9 · `pawdroid` × 5 · `surfboard-eternity` × 2
