...
![ノード](https://img.shields.io/badge/ノード-98-brightgreen) ![生存](https://img.shields.io/badge/生存-2148-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-327ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-09_22:19_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 327 ms
- **最終更新 (UTC)**: 2026-06-09 22:19 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 17 · vless × 11 · vmess × 26

**今回使用したソース:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 5
