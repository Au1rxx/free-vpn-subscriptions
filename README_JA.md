...
![ノード](https://img.shields.io/badge/ノード-112-brightgreen) ![生存](https://img.shields.io/badge/生存-1869-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-343ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-05_20:31_UTC-informational)
...
- **最速 RTT**: 38 ms
- **中央値 RTT**: 343 ms
- **最終更新 (UTC)**: 2026-07-05 20:31 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 48 · trojan × 24 · vless × 9 · vmess × 30

**今回使用したソース:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 2
