...
![ノード](https://img.shields.io/badge/ノード-128-brightgreen) ![生存](https://img.shields.io/badge/生存-2544-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-472ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_06:37_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 472 ms
- **最終更新 (UTC)**: 2026-06-19 06:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 35 · trojan × 23 · vless × 55 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 34 · `snakem982` × 5 · `surfboard-eternity` × 1
