...
![ノード](https://img.shields.io/badge/ノード-79-brightgreen) ![生存](https://img.shields.io/badge/生存-2430-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-70ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-03_09:17_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 70 ms
- **最終更新 (UTC)**: 2026-06-03 09:17 UTC

**プロトコル構成:** shadowsocks × 13 · trojan × 38 · vless × 5 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 23 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `surfboard-eternity` × 2
