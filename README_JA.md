...
![ノード](https://img.shields.io/badge/ノード-120-brightgreen) ![生存](https://img.shields.io/badge/生存-2018-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-319ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-25_10:38_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 319 ms
- **最終更新 (UTC)**: 2026-06-25 10:38 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 39 · trojan × 29 · vless × 36 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 31 · `lagzian-mix` × 3 · `mahdi0024` × 20 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 6
