...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2246-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-181ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_16:21_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 181 ms
- **最終更新 (UTC)**: 2026-04-20 16:21 UTC

**プロトコル構成:** shadowsocks × 29 · trojan × 16 · vless × 95 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 50 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
