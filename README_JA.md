...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2258-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-179ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_11:11_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 179 ms
- **最終更新 (UTC)**: 2026-04-22 11:11 UTC

**プロトコル構成:** shadowsocks × 28 · trojan × 10 · vless × 99 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 48 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 59 · `pawdroid` × 2 · `ruking-clash` × 4 · `surfboard-eternity` × 7
