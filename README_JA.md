...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1857-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-471ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_15:32_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 471 ms
- **最終更新 (UTC)**: 2026-06-22 15:32 UTC

**プロトコル構成:** shadowsocks × 40 · trojan × 31 · vless × 66 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 14 · `epodonios` × 41 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 2 · `surfboard-eternity` × 3
