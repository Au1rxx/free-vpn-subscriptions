...
![ノード](https://img.shields.io/badge/ノード-112-brightgreen) ![生存](https://img.shields.io/badge/生存-1816-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-377ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_17:33_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 377 ms
- **最終更新 (UTC)**: 2026-06-15 17:33 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 51 · trojan × 27 · vless × 18 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 17 · `surfboard-eternity` × 3
