...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2273-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-159ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_08:34_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 159 ms
- **最終更新 (UTC)**: 2026-04-22 08:34 UTC

**プロトコル構成:** shadowsocks × 31 · trojan × 4 · vless × 103 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 42 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 6
