...
![ノード](https://img.shields.io/badge/ノード-74-brightgreen) ![生存](https://img.shields.io/badge/生存-2238-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-131ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-31_13:10_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 131 ms
- **最終更新 (UTC)**: 2026-05-31 13:10 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 21 · trojan × 19 · vless × 7 · vmess × 26

**今回使用したソース:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 5 · `pawdroid` × 1 · `surfboard-eternity` × 1
