...
![ノード](https://img.shields.io/badge/ノード-102-brightgreen) ![生存](https://img.shields.io/badge/生存-2146-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-569ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_13:31_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 569 ms
- **最終更新 (UTC)**: 2026-06-29 13:31 UTC

**プロトコル構成:** shadowsocks × 16 · trojan × 52 · vless × 20 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 31 · `epodonios` × 18 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 10
