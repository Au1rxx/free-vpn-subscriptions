...
![ノード](https://img.shields.io/badge/ノード-105-brightgreen) ![生存](https://img.shields.io/badge/生存-1980-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-420ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_12:12_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 420 ms
- **最終更新 (UTC)**: 2026-06-18 12:12 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 35 · trojan × 31 · vless × 31 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 9 · `pawdroid` × 6 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 6
