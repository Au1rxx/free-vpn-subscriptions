...
![ノード](https://img.shields.io/badge/ノード-138-brightgreen) ![生存](https://img.shields.io/badge/生存-2047-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-410ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_09:15_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 410 ms
- **最終更新 (UTC)**: 2026-06-21 09:15 UTC

**プロトコル構成:** shadowsocks × 44 · trojan × 29 · vless × 42 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 14 · `epodonios` × 12 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 41 · `snakem982` × 2 · `surfboard-eternity` × 4
