...
![ノード](https://img.shields.io/badge/ノード-98-brightgreen) ![生存](https://img.shields.io/badge/生存-2240-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-472ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_11:15_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 472 ms
- **最終更新 (UTC)**: 2026-06-12 11:15 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 38 · vless × 11 · vmess × 5

**今回使用したソース:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 30 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `ruking-clash` × 5 · `surfboard-eternity` × 4
