...
![ノード](https://img.shields.io/badge/ノード-109-brightgreen) ![生存](https://img.shields.io/badge/生存-1858-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-376ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_22:31_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 376 ms
- **最終更新 (UTC)**: 2026-06-15 22:31 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 54 · trojan × 25 · vless × 15 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `ruking-clash` × 8 · `surfboard-eternity` × 5
