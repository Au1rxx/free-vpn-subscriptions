...
![ノード](https://img.shields.io/badge/ノード-71-brightgreen) ![生存](https://img.shields.io/badge/生存-2394-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-119ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-01_17:25_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 119 ms
- **最終更新 (UTC)**: 2026-06-01 17:25 UTC

**プロトコル構成:** shadowsocks × 15 · trojan × 18 · vless × 6 · vmess × 32

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
