...
![ノード](https://img.shields.io/badge/ノード-79-brightgreen) ![生存](https://img.shields.io/badge/生存-2238-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-417ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_09:11_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 417 ms
- **最終更新 (UTC)**: 2026-06-29 09:11 UTC

**プロトコル構成:** shadowsocks × 18 · trojan × 27 · vless × 19 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 2
