...
![ノード](https://img.shields.io/badge/ノード-146-brightgreen) ![生存](https://img.shields.io/badge/生存-1888-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-478ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_14:22_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 478 ms
- **最終更新 (UTC)**: 2026-06-22 14:22 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 40 · trojan × 29 · vless × 63 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 41 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 31 · `snakem982` × 3 · `surfboard-eternity` × 2
