...
![ノード](https://img.shields.io/badge/ノード-97-brightgreen) ![生存](https://img.shields.io/badge/生存-1978-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-491ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_08:33_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 491 ms
- **最終更新 (UTC)**: 2026-06-18 08:33 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 33 · trojan × 29 · vless × 27 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `snakem982` × 1 · `surfboard-eternity` × 2
