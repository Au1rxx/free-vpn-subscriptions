...
![ノード](https://img.shields.io/badge/ノード-136-brightgreen) ![生存](https://img.shields.io/badge/生存-1999-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-448ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_23:09_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 448 ms
- **最終更新 (UTC)**: 2026-06-23 23:09 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 39 · trojan × 30 · vless × 51 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 49 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
