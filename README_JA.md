...
![ノード](https://img.shields.io/badge/ノード-140-brightgreen) ![生存](https://img.shields.io/badge/生存-2464-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-148ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_12:27_UTC-informational)
...
- **最速 RTT**: 23 ms
- **中央値 RTT**: 148 ms
- **最終更新 (UTC)**: 2026-04-24 12:27 UTC

**プロトコル構成:** shadowsocks × 14 · trojan × 23 · vless × 90 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
