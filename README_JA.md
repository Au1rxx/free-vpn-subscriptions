...
![ノード](https://img.shields.io/badge/ノード-103-brightgreen) ![生存](https://img.shields.io/badge/生存-2241-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-477ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_13:14_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 477 ms
- **最終更新 (UTC)**: 2026-06-12 13:14 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 46 · trojan × 37 · vless × 15 · vmess × 4

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 29 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 5
