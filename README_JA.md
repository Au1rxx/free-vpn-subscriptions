...
![ノード](https://img.shields.io/badge/ノード-58-brightgreen) ![生存](https://img.shields.io/badge/生存-2497-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-111ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-01_20:34_UTC-informational)
...
- **最速 RTT**: 26 ms
- **中央値 RTT**: 111 ms
- **最終更新 (UTC)**: 2026-06-01 20:34 UTC

**プロトコル構成:** shadowsocks × 15 · trojan × 20 · vless × 4 · vmess × 19

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 2 · `surfboard-eternity` × 1
