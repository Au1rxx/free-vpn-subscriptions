...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-389-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-140ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-19_06:10_UTC-informational)
...
- **最速 RTT**: 8 ms
- **中央値 RTT**: 140 ms
- **最終更新 (UTC)**: 2026-04-19 06:10 UTC

**プロトコル構成:** shadowsocks × 101 · trojan × 7 · vmess × 42

**今回使用したソース:** `freefq` × 2 · `mahdibland-aggregator` × 65 · `mahdibland-shadowsocks` × 68 · `vxiaov-clash` × 15
