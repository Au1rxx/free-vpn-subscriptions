...
![ノード](https://img.shields.io/badge/ノード-139-brightgreen) ![生存](https://img.shields.io/badge/生存-2654-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-199ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_22:32_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 199 ms
- **最終更新 (UTC)**: 2026-04-24 22:32 UTC

**プロトコル構成:** shadowsocks × 24 · trojan × 23 · vless × 79 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 25 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 48 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
