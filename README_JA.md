...
![ノード](https://img.shields.io/badge/ノード-134-brightgreen) ![生存](https://img.shields.io/badge/生存-2565-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-302ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_16:35_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 302 ms
- **最終更新 (UTC)**: 2026-04-22 16:35 UTC

**プロトコル構成:** shadowsocks × 30 · trojan × 19 · vless × 71 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 8
