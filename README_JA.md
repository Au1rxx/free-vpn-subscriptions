...
![ノード](https://img.shields.io/badge/ノード-145-brightgreen) ![生存](https://img.shields.io/badge/生存-2083-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-372ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_05:24_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 372 ms
- **最終更新 (UTC)**: 2026-06-23 05:24 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 39 · trojan × 29 · vless × 63 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 50 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 21 · `pawdroid` × 4 · `ruking-clash` × 19 · `surfboard-eternity` × 5
