...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2223-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-136ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_00:19_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 136 ms
- **最終更新 (UTC)**: 2026-04-22 00:19 UTC

**プロトコル構成:** shadowsocks × 34 · trojan × 4 · vless × 98 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 28 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 71 · `ruking-clash` × 5 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
