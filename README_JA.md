...
![ノード](https://img.shields.io/badge/ノード-111-brightgreen) ![生存](https://img.shields.io/badge/生存-2393-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-493ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_20:20_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 493 ms
- **最終更新 (UTC)**: 2026-06-18 20:20 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 38 · trojan × 24 · vless × 38 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 35 · `snakem982` × 7 · `surfboard-eternity` × 5
