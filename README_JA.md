...
![ノード](https://img.shields.io/badge/ノード-87-brightgreen) ![生存](https://img.shields.io/badge/生存-2098-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-193ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_07:32_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 193 ms
- **最終更新 (UTC)**: 2026-06-06 07:32 UTC

**プロトコル構成:** shadowsocks × 24 · trojan × 26 · vless × 19 · vmess × 18

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 22 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `surfboard-eternity` × 4
