...
![ノード](https://img.shields.io/badge/ノード-121-brightgreen) ![生存](https://img.shields.io/badge/生存-1977-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-368ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_07:33_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 368 ms
- **最終更新 (UTC)**: 2026-06-28 07:33 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 36 · trojan × 42 · vless × 29 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
