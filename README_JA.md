...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2206-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-172ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_21:37_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 172 ms
- **最終更新 (UTC)**: 2026-04-30 21:37 UTC

**プロトコル構成:** shadowsocks × 31 · trojan × 20 · vless × 78 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 45 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 44 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
