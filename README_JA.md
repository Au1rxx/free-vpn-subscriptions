...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2244-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-80ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_05:23_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 80 ms
- **最終更新 (UTC)**: 2026-05-19 05:23 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 23 · trojan × 17 · vless × 85 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 65 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 3
