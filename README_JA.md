...
![ノード](https://img.shields.io/badge/ノード-145-brightgreen) ![生存](https://img.shields.io/badge/生存-1944-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-461ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_11:25_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 461 ms
- **最終更新 (UTC)**: 2026-06-17 11:25 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 37 · trojan × 24 · vless × 14 · vmess × 69

**今回使用したソース:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `mahdi0024` × 71 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
