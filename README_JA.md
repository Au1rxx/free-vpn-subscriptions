...
![ノード](https://img.shields.io/badge/ノード-145-brightgreen) ![生存](https://img.shields.io/badge/生存-1942-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-418ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_23:32_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 418 ms
- **最終更新 (UTC)**: 2026-06-21 23:32 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 45 · trojan × 32 · vless × 52 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 5 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 34 · `snakem982` × 2 · `surfboard-eternity` × 3
