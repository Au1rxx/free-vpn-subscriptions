...
![ノード](https://img.shields.io/badge/ノード-149-brightgreen) ![生存](https://img.shields.io/badge/生存-1908-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-470ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_07:37_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 470 ms
- **最終更新 (UTC)**: 2026-06-22 07:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 46 · trojan × 30 · vless × 59 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 6 · `ruking-clash` × 31 · `snakem982` × 3 · `surfboard-eternity` × 2
