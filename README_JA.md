...
![ノード](https://img.shields.io/badge/ノード-109-brightgreen) ![生存](https://img.shields.io/badge/生存-2027-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-418ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_13:34_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 418 ms
- **最終更新 (UTC)**: 2026-06-28 13:34 UTC

**プロトコル構成:** shadowsocks × 36 · trojan × 31 · vless × 27 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 20 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 1
