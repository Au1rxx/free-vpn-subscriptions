...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-394-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-137ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-19_09:40_UTC-informational)
...
- **最速 RTT**: 1 ms
- **中央値 RTT**: 137 ms
- **最終更新 (UTC)**: 2026-04-19 09:40 UTC

**プロトコル構成:** shadowsocks × 101 · trojan × 8 · vmess × 41

**今回使用したソース:** `freefq` × 2 · `mahdibland-aggregator` × 56 · `mahdibland-shadowsocks` × 73 · `pawdroid` × 4 · `vxiaov-clash` × 15
