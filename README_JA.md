...
![ノード](https://img.shields.io/badge/ノード-91-brightgreen) ![生存](https://img.shields.io/badge/生存-2079-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-442ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_08:28_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 442 ms
- **最終更新 (UTC)**: 2026-06-27 08:28 UTC

**プロトコル構成:** shadowsocks × 17 · trojan × 36 · vless × 18 · vmess × 20

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 16 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 1
