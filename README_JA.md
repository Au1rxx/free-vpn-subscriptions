...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2471-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-75ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_10:39_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 75 ms
- **最終更新 (UTC)**: 2026-05-18 10:39 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 45 · trojan × 6 · vless × 92 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 16 · `epodonios` × 2 · `lagzian-mix` × 5 · `mahdi0024` × 39 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 5 · `ruking-clash` × 11 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
