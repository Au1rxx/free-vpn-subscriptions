...
![ノード](https://img.shields.io/badge/ノード-60-brightgreen) ![生存](https://img.shields.io/badge/生存-2066-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-166ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-28_21:30_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 166 ms
- **最終更新 (UTC)**: 2026-05-28 21:30 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 24 · trojan × 19 · vless × 7 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 8 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
