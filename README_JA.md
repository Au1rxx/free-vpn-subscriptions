...
![ノード](https://img.shields.io/badge/ノード-92-brightgreen) ![生存](https://img.shields.io/badge/生存-2092-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-333ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_18:22_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 333 ms
- **最終更新 (UTC)**: 2026-06-10 18:22 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 13 · vless × 14 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 2
