...
![ノード](https://img.shields.io/badge/ノード-135-brightgreen) ![生存](https://img.shields.io/badge/生存-2208-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-166ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_15:20_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 166 ms
- **最終更新 (UTC)**: 2026-04-28 15:20 UTC

**プロトコル構成:** shadowsocks × 30 · trojan × 20 · vless × 75 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 59 · `ruking-clash` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
