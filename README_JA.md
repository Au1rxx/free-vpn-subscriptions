...
![ノード](https://img.shields.io/badge/ノード-104-brightgreen) ![生存](https://img.shields.io/badge/生存-1961-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-184ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_00:12_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 184 ms
- **最終更新 (UTC)**: 2026-06-28 00:12 UTC

**プロトコル構成:** shadowsocks × 21 · trojan × 42 · vless × 30 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 13 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 7
