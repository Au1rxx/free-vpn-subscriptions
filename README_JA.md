...
![ノード](https://img.shields.io/badge/ノード-130-brightgreen) ![生存](https://img.shields.io/badge/生存-2005-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-469ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_21:23_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 469 ms
- **最終更新 (UTC)**: 2026-06-23 21:23 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 38 · trojan × 30 · vless × 45 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 45 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
