...
![ノード](https://img.shields.io/badge/ノード-105-brightgreen) ![生存](https://img.shields.io/badge/生存-1933-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-124ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-05_06:15_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 124 ms
- **最終更新 (UTC)**: 2026-06-05 06:15 UTC

**プロトコル構成:** shadowsocks × 30 · trojan × 35 · vless × 28 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 13 · `epodonios` × 29 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 2
