...
![ノード](https://img.shields.io/badge/ノード-139-brightgreen) ![生存](https://img.shields.io/badge/生存-2208-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-157ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_16:39_UTC-informational)
...
- **最速 RTT**: 37 ms
- **中央値 RTT**: 157 ms
- **最終更新 (UTC)**: 2026-04-28 16:39 UTC

**プロトコル構成:** shadowsocks × 28 · trojan × 21 · vless × 78 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 52 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
