...
![ノード](https://img.shields.io/badge/ノード-140-brightgreen) ![生存](https://img.shields.io/badge/生存-2214-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-284ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-05_17:15_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 284 ms
- **最終更新 (UTC)**: 2026-05-05 17:15 UTC

**プロトコル構成:** shadowsocks × 35 · trojan × 26 · vless × 69 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `snakem982` × 1 · `surfboard-eternity` × 9
