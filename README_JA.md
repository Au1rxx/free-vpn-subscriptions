...
![ノード](https://img.shields.io/badge/ノード-94-brightgreen) ![生存](https://img.shields.io/badge/生存-1893-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-312ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-09_05:32_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 312 ms
- **最終更新 (UTC)**: 2026-06-09 05:32 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 44 · trojan × 19 · vless × 20 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 5 · `surfboard-eternity` × 4
