...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2284-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-66ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_09:31_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 66 ms
- **最終更新 (UTC)**: 2026-05-19 09:31 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 17 · trojan × 27 · vless × 88 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 61 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 4
