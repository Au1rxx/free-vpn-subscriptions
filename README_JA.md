...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2228-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-142ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-06_01:28_UTC-informational)
...
- **最速 RTT**: 37 ms
- **中央値 RTT**: 142 ms
- **最終更新 (UTC)**: 2026-05-06 01:28 UTC

**プロトコル構成:** shadowsocks × 36 · trojan × 15 · vless × 89 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 27 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 79 · `pawdroid` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
