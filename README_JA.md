...
![ノード](https://img.shields.io/badge/ノード-116-brightgreen) ![生存](https://img.shields.io/badge/生存-2546-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-488ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_09:20_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 488 ms
- **最終更新 (UTC)**: 2026-06-19 09:20 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 32 · trojan × 25 · vless × 41 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 15 · `mahdi0024` × 6 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 36 · `snakem982` × 4 · `surfboard-eternity` × 4
