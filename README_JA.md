...
![ノード](https://img.shields.io/badge/ノード-97-brightgreen) ![生存](https://img.shields.io/badge/生存-1865-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-369ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-13_11:32_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 369 ms
- **最終更新 (UTC)**: 2026-06-13 11:32 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 56 · trojan × 23 · vless × 10 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 3
