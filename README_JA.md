...
![ノード](https://img.shields.io/badge/ノード-86-brightgreen) ![生存](https://img.shields.io/badge/生存-2022-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-201ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_21:10_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 201 ms
- **最終更新 (UTC)**: 2026-06-26 21:10 UTC

**プロトコル構成:** shadowsocks × 17 · trojan × 32 · vless × 17 · vmess × 20

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `ruking-clash` × 17
