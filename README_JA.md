...
![ノード](https://img.shields.io/badge/ノード-130-brightgreen) ![生存](https://img.shields.io/badge/生存-2479-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-474ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_02:26_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 474 ms
- **最終更新 (UTC)**: 2026-06-19 02:26 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 35 · trojan × 28 · vless × 56 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 15 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 26 · `pawdroid` × 4 · `ruking-clash` × 39 · `snakem982` × 6 · `surfboard-eternity` × 2
