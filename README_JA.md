...
![ノード](https://img.shields.io/badge/ノード-126-brightgreen) ![生存](https://img.shields.io/badge/生存-2022-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-405ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_22:14_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 405 ms
- **最終更新 (UTC)**: 2026-06-23 22:14 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 37 · trojan × 30 · vless × 43 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 44 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 18 · `surfboard-eternity` × 3
