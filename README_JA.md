...
![ノード](https://img.shields.io/badge/ノード-104-brightgreen) ![生存](https://img.shields.io/badge/生存-1932-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-420ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_16:29_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 420 ms
- **最終更新 (UTC)**: 2026-06-12 16:29 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 45 · trojan × 37 · vless × 12 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 6
