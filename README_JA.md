...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2196-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-149ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_09:19_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 149 ms
- **最終更新 (UTC)**: 2026-04-21 09:19 UTC

**プロトコル構成:** shadowsocks × 29 · trojan × 2 · vless × 105 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 53 · `epodonios` × 3 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 56 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
