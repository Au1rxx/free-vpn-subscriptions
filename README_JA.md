...
![ノード](https://img.shields.io/badge/ノード-133-brightgreen) ![生存](https://img.shields.io/badge/生存-1993-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-408ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_15:33_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 408 ms
- **最終更新 (UTC)**: 2026-06-23 15:33 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 40 · trojan × 33 · vless × 45 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 50 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `mfuu-clash` × 7 · `ninjastrikers` × 15 · `pawdroid` × 6 · `ruking-clash` × 9 · `surfboard-eternity` × 1
