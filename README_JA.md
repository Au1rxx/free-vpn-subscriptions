...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2235-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-142ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_04:14_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 142 ms
- **最終更新 (UTC)**: 2026-04-22 04:14 UTC

**プロトコル構成:** shadowsocks × 33 · trojan × 3 · vless × 102 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 38 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 67 · `ruking-clash` × 5 · `surfboard-eternity` × 6
