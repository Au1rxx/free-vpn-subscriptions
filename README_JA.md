...
![ノード](https://img.shields.io/badge/ノード-138-brightgreen) ![生存](https://img.shields.io/badge/生存-1698-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-373ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_01:23_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 373 ms
- **最終更新 (UTC)**: 2026-06-15 01:23 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 56 · trojan × 26 · vless × 41 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 36 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 2
