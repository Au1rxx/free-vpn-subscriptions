...
![ノード](https://img.shields.io/badge/ノード-136-brightgreen) ![生存](https://img.shields.io/badge/生存-2582-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-291ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_18:24_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 291 ms
- **最終更新 (UTC)**: 2026-04-22 18:24 UTC

**プロトコル構成:** shadowsocks × 29 · trojan × 22 · vless × 71 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 26 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 6
