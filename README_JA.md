...
![ノード](https://img.shields.io/badge/ノード-91-brightgreen) ![生存](https://img.shields.io/badge/生存-2163-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-305ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-11_14:15_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 305 ms
- **最終更新 (UTC)**: 2026-06-11 14:15 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 33 · trojan × 25 · vless × 11 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 1
