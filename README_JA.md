...
![ノード](https://img.shields.io/badge/ノード-130-brightgreen) ![生存](https://img.shields.io/badge/生存-1939-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-469ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_06:16_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 469 ms
- **最終更新 (UTC)**: 2026-06-17 06:16 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 40 · trojan × 27 · vless × 23 · vmess × 39

**今回使用したソース:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 41 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
