...
![ノード](https://img.shields.io/badge/ノード-92-brightgreen) ![生存](https://img.shields.io/badge/生存-2142-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-178ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_15:17_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 178 ms
- **最終更新 (UTC)**: 2026-06-06 15:17 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 29 · trojan × 29 · vless × 10 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 15 · `mahdi0024` × 35 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 1
