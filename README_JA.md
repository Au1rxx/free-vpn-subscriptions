...
![ノード](https://img.shields.io/badge/ノード-117-brightgreen) ![生存](https://img.shields.io/badge/生存-1971-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-351ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_04:37_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 351 ms
- **最終更新 (UTC)**: 2026-06-28 04:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 33 · trojan × 42 · vless × 30 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 16 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `ruking-clash` × 15 · `surfboard-eternity` × 7
