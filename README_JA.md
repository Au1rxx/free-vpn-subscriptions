...
![ノード](https://img.shields.io/badge/ノード-66-brightgreen) ![生存](https://img.shields.io/badge/生存-2114-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-143ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-09_19:23_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 143 ms
- **最終更新 (UTC)**: 2026-07-09 19:23 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 22 · trojan × 9 · vless × 5 · vmess × 29

**今回使用したソース:** `barry-far-v2ray` × 1 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 9 · `pawdroid` × 1 · `ruking-clash` × 2
