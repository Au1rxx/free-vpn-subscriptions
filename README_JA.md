...
![ノード](https://img.shields.io/badge/ノード-105-brightgreen) ![生存](https://img.shields.io/badge/生存-1915-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-439ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_15:26_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 439 ms
- **最終更新 (UTC)**: 2026-06-12 15:26 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 45 · trojan × 39 · vless × 12 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 17 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 3
