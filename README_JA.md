...
![ノード](https://img.shields.io/badge/ノード-105-brightgreen) ![生存](https://img.shields.io/badge/生存-1813-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-401ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-13_17:28_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 401 ms
- **最終更新 (UTC)**: 2026-06-13 17:28 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 54 · trojan × 29 · vless × 14 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 5
