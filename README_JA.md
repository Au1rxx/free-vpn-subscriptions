...
![ノード](https://img.shields.io/badge/ノード-135-brightgreen) ![生存](https://img.shields.io/badge/生存-2004-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-404ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_17:24_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 404 ms
- **最終更新 (UTC)**: 2026-06-23 17:24 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 41 · trojan × 31 · vless × 45 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 9 · `epodonios` × 45 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 7 · `ruking-clash` × 17 · `surfboard-eternity` × 3
