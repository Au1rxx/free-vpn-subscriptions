...
![ノード](https://img.shields.io/badge/ノード-93-brightgreen) ![生存](https://img.shields.io/badge/生存-2266-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-277ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_08:26_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 277 ms
- **最終更新 (UTC)**: 2026-06-20 08:26 UTC

**プロトコル構成:** shadowsocks × 22 · trojan × 28 · vless × 14 · vmess × 29

**今回使用したソース:** `barry-far-v2ray` × 4 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 18 · `surfboard-eternity` × 4
