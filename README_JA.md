...
![ノード](https://img.shields.io/badge/ノード-146-brightgreen) ![生存](https://img.shields.io/badge/生存-2057-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-429ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_12:34_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 429 ms
- **最終更新 (UTC)**: 2026-06-21 12:34 UTC

**プロトコル構成:** shadowsocks × 45 · trojan × 34 · vless × 44 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 21 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 37 · `surfboard-eternity` × 3
