...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2585-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-79ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_09:17_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 79 ms
- **最終更新 (UTC)**: 2026-04-28 09:17 UTC

**プロトコル構成:** shadowsocks × 22 · trojan × 14 · vless × 104 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 22 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
