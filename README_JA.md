...
![ノード](https://img.shields.io/badge/ノード-72-brightgreen) ![生存](https://img.shields.io/badge/生存-2147-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-161ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-30_09:28_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 161 ms
- **最終更新 (UTC)**: 2026-05-30 09:28 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 24 · trojan × 13 · vless × 8 · vmess × 26

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 3 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 3 · `ninjastrikers` × 6 · `pawdroid` × 2 · `surfboard-eternity` × 2
