...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1974-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-146ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_05:23_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 146 ms
- **最終更新 (UTC)**: 2026-05-12 05:23 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 57 · trojan × 5 · vless × 77 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 4 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 12
