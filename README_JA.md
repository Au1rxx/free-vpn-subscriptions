...
![ノード](https://img.shields.io/badge/ノード-112-brightgreen) ![生存](https://img.shields.io/badge/生存-1854-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-329ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_05:18_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 329 ms
- **最終更新 (UTC)**: 2026-06-15 05:18 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 45 · trojan × 22 · vless × 29 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 28 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 4
