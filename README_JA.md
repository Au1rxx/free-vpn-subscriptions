...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2481-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-80ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-21_13:38_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 80 ms
- **最終更新 (UTC)**: 2026-05-21 13:38 UTC

**プロトコル構成:** shadowsocks × 36 · trojan × 10 · vless × 85 · vmess × 19

**今回使用したソース:** `barry-far-v2ray` × 25 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 17 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 60 · `pawdroid` × 9 · `ruking-clash` × 5 · `surfboard-eternity` × 9
