...
![ノード](https://img.shields.io/badge/ノード-141-brightgreen) ![生存](https://img.shields.io/badge/生存-2555-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-186ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_11:35_UTC-informational)
...
- **最速 RTT**: 26 ms
- **中央値 RTT**: 186 ms
- **最終更新 (UTC)**: 2026-04-23 11:35 UTC

**プロトコル構成:** shadowsocks × 29 · trojan × 22 · vless × 80 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 22 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 70 · `pawdroid` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
