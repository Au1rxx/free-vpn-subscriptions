...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2354-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-88ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-21_04:10_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 88 ms
- **最終更新 (UTC)**: 2026-05-21 04:10 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 39 · trojan × 11 · vless × 79 · vmess × 20

**今回使用したソース:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 1 · `ninjastrikers` × 61 · `pawdroid` × 7 · `ruking-clash` × 3 · `surfboard-eternity` × 10
