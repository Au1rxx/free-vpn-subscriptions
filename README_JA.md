...
![ノード](https://img.shields.io/badge/ノード-138-brightgreen) ![生存](https://img.shields.io/badge/生存-2519-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-169ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_15:25_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 169 ms
- **最終更新 (UTC)**: 2026-04-23 15:25 UTC

**プロトコル構成:** shadowsocks × 17 · trojan × 22 · vless × 83 · vmess × 16

**今回使用したソース:** `barry-far-v2ray` × 23 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 55 · `pawdroid` × 1 · `surfboard-eternity` × 7
