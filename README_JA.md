...
![ノード](https://img.shields.io/badge/ノード-135-brightgreen) ![生存](https://img.shields.io/badge/生存-1712-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-378ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_02:33_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 378 ms
- **最終更新 (UTC)**: 2026-06-14 02:33 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 54 · trojan × 37 · vless × 36 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 34 · `pawdroid` × 4 · `ruking-clash` × 21 · `surfboard-eternity` × 7
