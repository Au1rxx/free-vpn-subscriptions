...
![ノード](https://img.shields.io/badge/ノード-143-brightgreen) ![生存](https://img.shields.io/badge/生存-2216-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-366ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-05_20:27_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 366 ms
- **最終更新 (UTC)**: 2026-05-05 20:27 UTC

**プロトコル構成:** shadowsocks × 36 · trojan × 28 · vless × 68 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 38 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 3 · `surfboard-eternity` × 10
