...
![ノード](https://img.shields.io/badge/ノード-92-brightgreen) ![生存](https://img.shields.io/badge/生存-2317-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-172ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_05:15_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 172 ms
- **最終更新 (UTC)**: 2026-06-20 05:15 UTC

**プロトコル構成:** shadowsocks × 22 · trojan × 24 · vless × 16 · vmess × 30

**今回使用したソース:** `barry-far-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 3
