...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-389-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-107ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-19_08:44_UTC-informational)
...
- **最速 RTT**: 1 ms
- **中央値 RTT**: 107 ms
- **最終更新 (UTC)**: 2026-04-19 08:44 UTC

**プロトコル構成:** shadowsocks × 103 · trojan × 6 · vmess × 41

**今回使用したソース:** `freefq` × 1 · `mahdibland-aggregator` × 73 · `mahdibland-shadowsocks` × 60 · `pawdroid` × 3 · `vxiaov-clash` × 13
