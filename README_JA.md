...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2344-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-84ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-20_20:31_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 84 ms
- **最終更新 (UTC)**: 2026-05-20 20:31 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 36 · trojan × 23 · vless × 70 · vmess × 20

**今回使用したソース:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
