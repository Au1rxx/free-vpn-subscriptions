...
![ノード](https://img.shields.io/badge/ノード-114-brightgreen) ![生存](https://img.shields.io/badge/生存-1825-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-398ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_12:10_UTC-informational)
...
- **最速 RTT**: 26 ms
- **中央値 RTT**: 398 ms
- **最終更新 (UTC)**: 2026-06-16 12:10 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 52 · trojan × 28 · vless × 19 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 5
