...
![ノード](https://img.shields.io/badge/ノード-72-brightgreen) ![生存](https://img.shields.io/badge/生存-2128-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_20:12_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 167 ms
- **最終更新 (UTC)**: 2026-06-06 20:12 UTC

**プロトコル構成:** shadowsocks × 26 · trojan × 15 · vless × 7 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 5
