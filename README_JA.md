...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1980-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-396ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_00:12_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 396 ms
- **最終更新 (UTC)**: 2026-06-24 00:12 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 32 · vless × 61 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 43 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 27 · `pawdroid` × 7 · `ruking-clash` × 16 · `surfboard-eternity` × 3
