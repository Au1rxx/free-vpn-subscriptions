...
![ノード](https://img.shields.io/badge/ノード-142-brightgreen) ![生存](https://img.shields.io/badge/生存-2067-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-406ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_06:16_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 406 ms
- **最終更新 (UTC)**: 2026-06-23 06:16 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 35 · trojan × 29 · vless × 61 · vmess × 16

**今回使用したソース:** `barry-far-v2ray` × 4 · `epodonios` × 51 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 4
