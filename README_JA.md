...
![ノード](https://img.shields.io/badge/ノード-81-brightgreen) ![生存](https://img.shields.io/badge/生存-1892-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-355ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-08_20:24_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 355 ms
- **最終更新 (UTC)**: 2026-06-08 20:24 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 14 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `ruking-clash` × 7 · `surfboard-eternity` × 4
