...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1963-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-472ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_21:13_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 472 ms
- **最終更新 (UTC)**: 2026-06-22 21:13 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 16 · vless × 79 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 56 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 21 · `snakem982` × 2 · `surfboard-eternity` × 4
