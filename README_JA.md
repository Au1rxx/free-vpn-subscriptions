...
![ノード](https://img.shields.io/badge/ノード-127-brightgreen) ![生存](https://img.shields.io/badge/生存-2484-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-489ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_11:38_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 489 ms
- **最終更新 (UTC)**: 2026-06-19 11:38 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 32 · trojan × 27 · vless × 48 · vmess × 19

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 7
