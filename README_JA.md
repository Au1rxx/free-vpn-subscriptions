...
![ノード](https://img.shields.io/badge/ノード-138-brightgreen) ![生存](https://img.shields.io/badge/生存-1611-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-420ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_18:13_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 420 ms
- **最終更新 (UTC)**: 2026-06-14 18:13 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 72 · trojan × 31 · vless × 23 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 4
