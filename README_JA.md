...
![ノード](https://img.shields.io/badge/ノード-105-brightgreen) ![生存](https://img.shields.io/badge/生存-2531-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-109ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_01:20_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 109 ms
- **最終更新 (UTC)**: 2026-06-02 01:20 UTC

**プロトコル構成:** shadowsocks × 24 · trojan × 31 · vless × 24 · vmess × 26

**今回使用したソース:** `barry-far-v2ray` × 16 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 30 · `pawdroid` × 1 · `surfboard-eternity` × 2
