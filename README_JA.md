...
![ノード](https://img.shields.io/badge/ノード-81-brightgreen) ![生存](https://img.shields.io/badge/生存-2444-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-78ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-03_12:24_UTC-informational)
...
- **最速 RTT**: 26 ms
- **中央値 RTT**: 78 ms
- **最終更新 (UTC)**: 2026-06-03 12:24 UTC

**プロトコル構成:** shadowsocks × 14 · trojan × 38 · vless × 6 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 27 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 9 · `pawdroid` × 2 · `surfboard-eternity` × 4
