...
![ノード](https://img.shields.io/badge/ノード-104-brightgreen) ![生存](https://img.shields.io/badge/生存-1857-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-369ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_09:12_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 369 ms
- **最終更新 (UTC)**: 2026-06-15 09:12 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 50 · trojan × 22 · vless × 20 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 11 · `surfboard-eternity` × 9
