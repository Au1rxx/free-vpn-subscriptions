...
![ノード](https://img.shields.io/badge/ノード-137-brightgreen) ![生存](https://img.shields.io/badge/生存-1712-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-396ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_03:37_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 396 ms
- **最終更新 (UTC)**: 2026-06-14 03:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 53 · trojan × 38 · vless × 38 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 24 · `ninjastrikers` × 35 · `pawdroid` × 8 · `ruking-clash` × 21 · `surfboard-eternity` × 3
