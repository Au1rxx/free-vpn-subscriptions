...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2691-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-80ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_05:19_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 80 ms
- **最終更新 (UTC)**: 2026-05-18 05:19 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 42 · trojan × 3 · vless × 98 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 61 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
