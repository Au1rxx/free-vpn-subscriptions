...
![ノード](https://img.shields.io/badge/ノード-106-brightgreen) ![生存](https://img.shields.io/badge/生存-1901-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-342ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-06_23:19_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 342 ms
- **最終更新 (UTC)**: 2026-07-06 23:19 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 44 · trojan × 30 · vless × 10 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 6 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
