...
![ノード](https://img.shields.io/badge/ノード-88-brightgreen) ![生存](https://img.shields.io/badge/生存-2206-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-277ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-11_07:32_UTC-informational)
...
- **最速 RTT**: 26 ms
- **中央値 RTT**: 277 ms
- **最終更新 (UTC)**: 2026-06-11 07:32 UTC

**プロトコル構成:** shadowsocks × 36 · trojan × 14 · vless × 16 · vmess × 22

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 3
