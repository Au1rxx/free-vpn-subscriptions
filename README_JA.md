...
![ノード](https://img.shields.io/badge/ノード-82-brightgreen) ![生存](https://img.shields.io/badge/生存-2400-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-74ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-03_08:35_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 74 ms
- **最終更新 (UTC)**: 2026-06-03 08:35 UTC

**プロトコル構成:** shadowsocks × 14 · trojan × 37 · vless × 6 · vmess × 25

**今回使用したソース:** `barry-far-v2ray` × 21 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 10 · `pawdroid` × 1 · `surfboard-eternity` × 2
