...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-394-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-134ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-19_06:03_UTC-informational)
...
- **最速 RTT**: 8 ms
- **中央値 RTT**: 134 ms
- **最終更新 (UTC)**: 2026-04-19 06:03 UTC

**プロトコル構成:** shadowsocks × 102 · trojan × 7 · vmess × 41

**今回使用したソース:** `freefq` × 2 · `mahdibland-aggregator` × 72 · `mahdibland-shadowsocks` × 58 · `pawdroid` × 3 · `vxiaov-clash` × 15
