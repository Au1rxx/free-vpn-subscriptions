...
![ノード](https://img.shields.io/badge/ノード-141-brightgreen) ![生存](https://img.shields.io/badge/生存-2572-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-111ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-14_16:30_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 111 ms
- **最終更新 (UTC)**: 2026-05-14 16:30 UTC

**プロトコル構成:** shadowsocks × 36 · trojan × 21 · vless × 75 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 28 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 54 · `pawdroid` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
