...
![ノード](https://img.shields.io/badge/ノード-97-brightgreen) ![生存](https://img.shields.io/badge/生存-1930-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-341ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_18:34_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 341 ms
- **最終更新 (UTC)**: 2026-06-16 18:34 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 47 · trojan × 21 · vless × 17 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 11 · `surfboard-eternity` × 4
