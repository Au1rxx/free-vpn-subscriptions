...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-393-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-119ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-19_06:42_UTC-informational)
...
- **最速 RTT**: 8 ms
- **中央値 RTT**: 119 ms
- **最終更新 (UTC)**: 2026-04-19 06:42 UTC

**プロトコル構成:** shadowsocks × 104 · trojan × 7 · vmess × 39

**今回使用したソース:** `freefq` × 2 · `mahdibland-aggregator` × 67 · `mahdibland-shadowsocks` × 65 · `vxiaov-clash` × 16
