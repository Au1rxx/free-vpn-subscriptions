...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2210-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-154ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_11:30_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 154 ms
- **最終更新 (UTC)**: 2026-04-30 11:30 UTC

**プロトコル構成:** shadowsocks × 34 · trojan × 20 · vless × 86 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 36 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 64 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
