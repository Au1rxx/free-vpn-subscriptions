...
![ノード](https://img.shields.io/badge/ノード-68-brightgreen) ![生存](https://img.shields.io/badge/生存-1921-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-131ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-03_04:32_UTC-informational)
...
- **最速 RTT**: 38 ms
- **中央値 RTT**: 131 ms
- **最終更新 (UTC)**: 2026-07-03 04:32 UTC

**プロトコル構成:** shadowsocks × 25 · trojan × 17 · vless × 11 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 3 · `surfboard-eternity` × 2
