...
![ノード](https://img.shields.io/badge/ノード-100-brightgreen) ![生存](https://img.shields.io/badge/生存-2042-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-186ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_02:27_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 186 ms
- **最終更新 (UTC)**: 2026-06-27 02:27 UTC

**プロトコル構成:** shadowsocks × 18 · trojan × 35 · vless × 26 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 9 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 3
