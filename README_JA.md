...
![ノード](https://img.shields.io/badge/ノード-82-brightgreen) ![生存](https://img.shields.io/badge/生存-2147-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-173ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_17:16_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 173 ms
- **最終更新 (UTC)**: 2026-06-28 17:16 UTC

**プロトコル構成:** shadowsocks × 18 · trojan × 27 · vless × 20 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 3
