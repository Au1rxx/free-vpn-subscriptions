...
![ノード](https://img.shields.io/badge/ノード-84-brightgreen) ![生存](https://img.shields.io/badge/生存-2314-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-276ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_17:09_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 276 ms
- **最終更新 (UTC)**: 2026-06-19 17:09 UTC

**プロトコル構成:** shadowsocks × 23 · trojan × 23 · vless × 10 · vmess × 28

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 4 · `ruking-clash` × 18 · `surfboard-eternity` × 7
