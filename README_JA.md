...
![ノード](https://img.shields.io/badge/ノード-96-brightgreen) ![生存](https://img.shields.io/badge/生存-1899-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-158ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-04_19:39_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 158 ms
- **最終更新 (UTC)**: 2026-06-04 19:39 UTC

**プロトコル構成:** shadowsocks × 20 · trojan × 47 · vless × 19 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 32 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `ruking-clash` × 4 · `surfboard-eternity` × 2
