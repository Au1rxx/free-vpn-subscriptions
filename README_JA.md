...
![ノード](https://img.shields.io/badge/ノード-77-brightgreen) ![生存](https://img.shields.io/badge/生存-1761-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-325ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-08_14:10_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 325 ms
- **最終更新 (UTC)**: 2026-06-08 14:10 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 42 · trojan × 17 · vless × 13 · vmess × 4

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 1 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 24 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 6
