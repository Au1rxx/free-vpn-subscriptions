...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2213-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-153ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_12:19_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 153 ms
- **最終更新 (UTC)**: 2026-04-30 12:19 UTC

**プロトコル構成:** shadowsocks × 34 · trojan × 19 · vless × 87 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 40 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
