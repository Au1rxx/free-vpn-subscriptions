...
![ノード](https://img.shields.io/badge/ノード-92-brightgreen) ![生存](https://img.shields.io/badge/生存-2199-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-568ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_11:28_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 568 ms
- **最終更新 (UTC)**: 2026-06-29 11:28 UTC

**プロトコル構成:** shadowsocks × 16 · trojan × 40 · vless × 21 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 18 · `epodonios` × 18 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 2
