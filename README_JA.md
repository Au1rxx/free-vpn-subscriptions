...
![ノード](https://img.shields.io/badge/ノード-77-brightgreen) ![生存](https://img.shields.io/badge/生存-2422-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-331ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-11_20:38_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 331 ms
- **最終更新 (UTC)**: 2026-06-11 20:38 UTC

**プロトコル構成:** shadowsocks × 44 · trojan × 17 · vless × 12 · vmess × 4

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 4 · `surfboard-eternity` × 5
