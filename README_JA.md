...
![ノード](https://img.shields.io/badge/ノード-133-brightgreen) ![生存](https://img.shields.io/badge/生存-2374-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-503ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_15:30_UTC-informational)
...
- **最速 RTT**: 38 ms
- **中央値 RTT**: 503 ms
- **最終更新 (UTC)**: 2026-06-18 15:30 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 37 · trojan × 36 · vless × 48 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 25 · `snakem982` × 9 · `surfboard-eternity` × 3
