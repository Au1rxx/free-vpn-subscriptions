...
![ノード](https://img.shields.io/badge/ノード-104-brightgreen) ![生存](https://img.shields.io/badge/生存-1927-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-411ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-25_19:35_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 411 ms
- **最終更新 (UTC)**: 2026-06-25 19:35 UTC

**プロトコル構成:** shadowsocks × 35 · trojan × 38 · vless × 18 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 20 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 20 · `surfboard-eternity` × 6
