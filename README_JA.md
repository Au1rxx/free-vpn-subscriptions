...
![ノード](https://img.shields.io/badge/ノード-79-brightgreen) ![生存](https://img.shields.io/badge/生存-2245-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-159ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-31_12:30_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 159 ms
- **最終更新 (UTC)**: 2026-05-31 12:30 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 23 · trojan × 21 · vless × 7 · vmess × 27

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
