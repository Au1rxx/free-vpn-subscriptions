...
![ノード](https://img.shields.io/badge/ノード-94-brightgreen) ![生存](https://img.shields.io/badge/生存-1959-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-294ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_23:13_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 294 ms
- **最終更新 (UTC)**: 2026-06-27 23:13 UTC

**プロトコル構成:** shadowsocks × 21 · trojan × 44 · vless × 18 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 16 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `ruking-clash` × 16 · `surfboard-eternity` × 2
