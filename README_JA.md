...
![ノード](https://img.shields.io/badge/ノード-75-brightgreen) ![生存](https://img.shields.io/badge/生存-1938-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-229ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-28_11:25_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 229 ms
- **最終更新 (UTC)**: 2026-05-28 11:25 UTC

**プロトコル構成:** shadowsocks × 32 · trojan × 17 · vless × 13 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 3
