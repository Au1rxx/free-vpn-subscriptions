...
![ノード](https://img.shields.io/badge/ノード-53-brightgreen) ![生存](https://img.shields.io/badge/生存-2055-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-225ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-29_13:19_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 225 ms
- **最終更新 (UTC)**: 2026-05-29 13:19 UTC

**プロトコル構成:** shadowsocks × 20 · trojan × 15 · vless × 9 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 13 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 8 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
