...
![ノード](https://img.shields.io/badge/ノード-107-brightgreen) ![生存](https://img.shields.io/badge/生存-1757-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-384ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_12:28_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 384 ms
- **最終更新 (UTC)**: 2026-06-17 12:28 UTC

**プロトコル構成:** hysteria2 × 4 · shadowsocks × 43 · trojan × 27 · vless × 21 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 3 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 3
