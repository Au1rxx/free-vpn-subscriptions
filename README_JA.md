...
![ノード](https://img.shields.io/badge/ノード-76-brightgreen) ![生存](https://img.shields.io/badge/生存-2380-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-329ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-11_17:27_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 329 ms
- **最終更新 (UTC)**: 2026-06-11 17:27 UTC

**プロトコル構成:** shadowsocks × 43 · trojan × 18 · vless × 10 · vmess × 5

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 17 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 2
