...
![ノード](https://img.shields.io/badge/ノード-135-brightgreen) ![生存](https://img.shields.io/badge/生存-2216-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_19:27_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 167 ms
- **最終更新 (UTC)**: 2026-04-28 19:27 UTC

**プロトコル構成:** shadowsocks × 28 · trojan × 23 · vless × 72 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 31 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
