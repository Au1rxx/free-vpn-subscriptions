...
![ノード](https://img.shields.io/badge/ノード-136-brightgreen) ![生存](https://img.shields.io/badge/生存-1893-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-478ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_11:39_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 478 ms
- **最終更新 (UTC)**: 2026-06-22 11:39 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 29 · vless × 50 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 30 · `snakem982` × 3 · `surfboard-eternity` × 3
