...
![ノード](https://img.shields.io/badge/ノード-86-brightgreen) ![生存](https://img.shields.io/badge/生存-2128-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-345ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_14:39_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 345 ms
- **最終更新 (UTC)**: 2026-06-28 14:39 UTC

**プロトコル構成:** shadowsocks × 17 · trojan × 32 · vless × 19 · vmess × 18

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 2
