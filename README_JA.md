...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2264-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-186ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_23:13_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 186 ms
- **最終更新 (UTC)**: 2026-04-30 23:13 UTC

**プロトコル構成:** shadowsocks × 25 · trojan × 23 · vless × 81 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 43 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 52 · `surfboard-eternity` × 7
