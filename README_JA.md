...
![ノード](https://img.shields.io/badge/ノード-145-brightgreen) ![生存](https://img.shields.io/badge/生存-2439-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-81ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-25_12:26_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 81 ms
- **最終更新 (UTC)**: 2026-05-25 12:26 UTC

**プロトコル構成:** shadowsocks × 40 · trojan × 18 · vless × 65 · vmess × 22

**今回使用したソース:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 35 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 8 · `surfboard-eternity` × 7
