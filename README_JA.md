...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1789-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-591ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_09:35_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 591 ms
- **最終更新 (UTC)**: 2026-06-17 09:35 UTC

**プロトコル構成:** hysteria2 × 5 · shadowsocks × 40 · trojan × 27 · vless × 19 · vmess × 59

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 61 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 3
