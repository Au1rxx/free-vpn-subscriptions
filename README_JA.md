...
![ノード](https://img.shields.io/badge/ノード-129-brightgreen) ![生存](https://img.shields.io/badge/生存-2129-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-358ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_15:21_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 358 ms
- **最終更新 (UTC)**: 2026-06-20 15:21 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 45 · trojan × 33 · vless × 27 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `mahdi0024` × 27 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 29 · `snakem982` × 2 · `surfboard-eternity` × 2
