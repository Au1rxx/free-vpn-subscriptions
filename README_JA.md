...
![ノード](https://img.shields.io/badge/ノード-94-brightgreen) ![生存](https://img.shields.io/badge/生存-1850-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-358ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-09_07:25_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 358 ms
- **最終更新 (UTC)**: 2026-06-09 07:25 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 46 · trojan × 21 · vless × 16 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 8 · `surfboard-eternity` × 3
