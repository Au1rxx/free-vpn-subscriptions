...
![ノード](https://img.shields.io/badge/ノード-83-brightgreen) ![生存](https://img.shields.io/badge/生存-2145-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-171ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-05_22:13_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 171 ms
- **最終更新 (UTC)**: 2026-06-05 22:13 UTC

**プロトコル構成:** shadowsocks × 25 · trojan × 28 · vless × 12 · vmess × 18

**今回使用したソース:** `barry-far-v2ray` × 2 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 12 · `surfboard-eternity` × 2
