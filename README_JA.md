...
![ノード](https://img.shields.io/badge/ノード-85-brightgreen) ![生存](https://img.shields.io/badge/生存-2101-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-241ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-09_23:15_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 241 ms
- **最終更新 (UTC)**: 2026-06-09 23:15 UTC

**プロトコル構成:** shadowsocks × 37 · trojan × 18 · vless × 8 · vmess × 22

**今回使用したソース:** `barry-far-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 7
