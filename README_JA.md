...
![ノード](https://img.shields.io/badge/ノード-74-brightgreen) ![生存](https://img.shields.io/badge/生存-2173-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-171ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_12:28_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 171 ms
- **最終更新 (UTC)**: 2026-06-06 12:28 UTC

**プロトコル構成:** shadowsocks × 27 · trojan × 25 · vless × 5 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
