...
![ノード](https://img.shields.io/badge/ノード-115-brightgreen) ![生存](https://img.shields.io/badge/生存-1983-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-373ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_23:25_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 373 ms
- **最終更新 (UTC)**: 2026-06-12 23:25 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 53 · trojan × 44 · vless × 11 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 33 · `lagzian-mix` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 7
