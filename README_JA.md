...
![ノード](https://img.shields.io/badge/ノード-116-brightgreen) ![生存](https://img.shields.io/badge/生存-1780-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-365ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_01:09_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 365 ms
- **最終更新 (UTC)**: 2026-06-18 01:09 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 47 · trojan × 29 · vless × 32 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 24 · `pawdroid` × 1 · `ruking-clash` × 15 · `surfboard-eternity` × 4
