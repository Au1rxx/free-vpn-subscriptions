...
![ノード](https://img.shields.io/badge/ノード-87-brightgreen) ![生存](https://img.shields.io/badge/生存-2344-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-90ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_23:16_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 90 ms
- **最終更新 (UTC)**: 2026-06-02 23:16 UTC

**プロトコル構成:** shadowsocks × 22 · trojan × 29 · vless × 6 · vmess × 30

**今回使用したソース:** `barry-far-v2ray` × 19 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `snakem982` × 1 · `surfboard-eternity` × 2
