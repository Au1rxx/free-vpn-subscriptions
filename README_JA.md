...
![ノード](https://img.shields.io/badge/ノード-93-brightgreen) ![生存](https://img.shields.io/badge/生存-2275-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-182ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_09:12_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 182 ms
- **最終更新 (UTC)**: 2026-06-20 09:12 UTC

**プロトコル構成:** shadowsocks × 22 · trojan × 28 · vless × 13 · vmess × 30

**今回使用したソース:** `barry-far-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 5
