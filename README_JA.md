...
![ノード](https://img.shields.io/badge/ノード-104-brightgreen) ![生存](https://img.shields.io/badge/生存-1870-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-355ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_04:11_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 355 ms
- **最終更新 (UTC)**: 2026-06-30 04:11 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 40 · trojan × 39 · vless × 16 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 6
