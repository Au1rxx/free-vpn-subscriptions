...
![ノード](https://img.shields.io/badge/ノード-89-brightgreen) ![生存](https://img.shields.io/badge/生存-1877-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-365ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_14:16_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 365 ms
- **最終更新 (UTC)**: 2026-06-07 14:16 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 48 · trojan × 20 · vless × 14 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 5
