...
![ノード](https://img.shields.io/badge/ノード-111-brightgreen) ![生存](https://img.shields.io/badge/生存-2360-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-480ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_19:17_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 480 ms
- **最終更新 (UTC)**: 2026-06-18 19:17 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 37 · trojan × 34 · vless × 31 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 29 · `snakem982` × 7 · `surfboard-eternity` × 4
