...
![ノード](https://img.shields.io/badge/ノード-76-brightgreen) ![生存](https://img.shields.io/badge/生存-2490-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-137ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_14:32_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 137 ms
- **最終更新 (UTC)**: 2026-06-02 14:32 UTC

**プロトコル構成:** shadowsocks × 21 · trojan × 26 · vless × 8 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 9 · `pawdroid` × 4 · `surfboard-eternity` × 4
