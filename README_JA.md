...
![ノード](https://img.shields.io/badge/ノード-123-brightgreen) ![生存](https://img.shields.io/badge/生存-2060-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-359ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_04:29_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 359 ms
- **最終更新 (UTC)**: 2026-06-24 04:29 UTC

**プロトコル構成:** shadowsocks × 34 · trojan × 28 · vless × 45 · vmess × 16

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 42 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `pawdroid` × 4 · `ruking-clash` × 13 · `surfboard-eternity` × 2
