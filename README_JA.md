...
![ノード](https://img.shields.io/badge/ノード-106-brightgreen) ![生存](https://img.shields.io/badge/生存-1867-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-358ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_23:16_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 358 ms
- **最終更新 (UTC)**: 2026-06-15 23:16 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 50 · trojan × 26 · vless × 16 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 3
