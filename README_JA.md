...
![ノード](https://img.shields.io/badge/ノード-99-brightgreen) ![生存](https://img.shields.io/badge/生存-2023-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-341ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_00:10_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 341 ms
- **最終更新 (UTC)**: 2026-06-30 00:10 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 36 · trojan × 36 · vless × 18 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 4
