...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2054-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-87ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-21_22:10_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 87 ms
- **最終更新 (UTC)**: 2026-05-21 22:10 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 35 · trojan × 32 · vless × 70 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 40 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 11 · `surfboard-eternity` × 5
