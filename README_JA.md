...
![ノード](https://img.shields.io/badge/ノード-107-brightgreen) ![生存](https://img.shields.io/badge/生存-1955-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-383ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_19:19_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 383 ms
- **最終更新 (UTC)**: 2026-06-10 19:19 UTC

**プロトコル構成:** shadowsocks × 43 · trojan × 18 · vless × 11 · vmess × 35

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 34 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 6 · `surfboard-eternity` × 1
