...
![ノード](https://img.shields.io/badge/ノード-140-brightgreen) ![生存](https://img.shields.io/badge/生存-2308-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-290ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_19:19_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 290 ms
- **最終更新 (UTC)**: 2026-04-21 19:19 UTC

**プロトコル構成:** shadowsocks × 30 · trojan × 24 · vless × 71 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 37 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 1 · `ruking-clash` × 7 · `snakem982` × 2 · `surfboard-eternity` × 5
