...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2257-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-85ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-21_16:27_UTC-informational)
...
- **最速 RTT**: 37 ms
- **中央値 RTT**: 85 ms
- **最終更新 (UTC)**: 2026-05-21 16:27 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 30 · trojan × 28 · vless × 81 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 43 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 50 · `pawdroid` × 9 · `surfboard-eternity` × 3
