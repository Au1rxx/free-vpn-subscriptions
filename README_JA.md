...
![ノード](https://img.shields.io/badge/ノード-143-brightgreen) ![生存](https://img.shields.io/badge/生存-2098-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-379ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_07:34_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 379 ms
- **最終更新 (UTC)**: 2026-06-21 07:34 UTC

**プロトコル構成:** shadowsocks × 42 · trojan × 31 · vless × 45 · vmess × 25

**今回使用したソース:** `barry-far-v2ray` × 14 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 33 · `snakem982` × 2 · `surfboard-eternity` × 2
