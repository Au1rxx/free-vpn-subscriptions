...
![ノード](https://img.shields.io/badge/ノード-119-brightgreen) ![生存](https://img.shields.io/badge/生存-2394-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-488ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_23:23_UTC-informational)
...
- **最速 RTT**: 37 ms
- **中央値 RTT**: 488 ms
- **最終更新 (UTC)**: 2026-06-18 23:23 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 39 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 38 · `snakem982` × 6 · `surfboard-eternity` × 2
