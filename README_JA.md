...
![ノード](https://img.shields.io/badge/ノード-149-brightgreen) ![生存](https://img.shields.io/badge/生存-2563-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_19:33_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 167 ms
- **最終更新 (UTC)**: 2026-04-24 19:33 UTC

**プロトコル構成:** shadowsocks × 29 · trojan × 22 · vless × 85 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 27 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 52 · `snakem982` × 1 · `surfboard-eternity` × 6
