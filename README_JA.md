...
![ノード](https://img.shields.io/badge/ノード-121-brightgreen) ![生存](https://img.shields.io/badge/生存-2461-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-493ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_10:26_UTC-informational)
...
- **最速 RTT**: 38 ms
- **中央値 RTT**: 493 ms
- **最終更新 (UTC)**: 2026-06-19 10:26 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 32 · trojan × 21 · vless × 52 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 20 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 42 · `snakem982` × 3 · `surfboard-eternity` × 2
