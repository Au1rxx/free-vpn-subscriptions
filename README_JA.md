...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1923-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-222ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_03:14_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 222 ms
- **最終更新 (UTC)**: 2026-06-22 03:14 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 47 · trojan × 10 · vless × 79 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 13 · `epodonios` × 41 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 18 · `snakem982` × 2 · `surfboard-eternity` × 3
