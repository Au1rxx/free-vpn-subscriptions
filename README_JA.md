...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2364-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-92ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-23_15:25_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 92 ms
- **最終更新 (UTC)**: 2026-05-23 15:25 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 35 · trojan × 22 · vless × 71 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `surfboard-eternity` × 7
