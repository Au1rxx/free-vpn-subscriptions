...
![ノード](https://img.shields.io/badge/ノード-122-brightgreen) ![生存](https://img.shields.io/badge/生存-2472-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-474ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_05:15_UTC-informational)
...
- **最速 RTT**: 40 ms
- **中央値 RTT**: 474 ms
- **最終更新 (UTC)**: 2026-06-19 05:15 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 35 · trojan × 27 · vless × 49 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 35 · `snakem982` × 7 · `surfboard-eternity` × 4
