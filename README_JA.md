...
![ノード](https://img.shields.io/badge/ノード-140-brightgreen) ![生存](https://img.shields.io/badge/生存-2506-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-147ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-09_22:30_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 147 ms
- **最終更新 (UTC)**: 2026-05-09 22:30 UTC

**プロトコル構成:** shadowsocks × 46 · trojan × 17 · vless × 68 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 56 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 8
