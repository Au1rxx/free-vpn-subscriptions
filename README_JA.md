...
![ノード](https://img.shields.io/badge/ノード-83-brightgreen) ![生存](https://img.shields.io/badge/生存-2195-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-160ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-30_06:12_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 160 ms
- **最終更新 (UTC)**: 2026-05-30 06:12 UTC

**プロトコル構成:** shadowsocks × 23 · trojan × 24 · vless × 10 · vmess × 26

**今回使用したソース:** `barry-far-v2ray` × 14 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
