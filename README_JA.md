...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2028-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-69ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_09:11_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 69 ms
- **最終更新 (UTC)**: 2026-05-22 09:11 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 36 · trojan × 10 · vless × 91 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 67 · `pawdroid` × 4 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 8
