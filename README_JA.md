...
![ノード](https://img.shields.io/badge/ノード-63-brightgreen) ![生存](https://img.shields.io/badge/生存-1954-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-275ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_22:19_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 275 ms
- **最終更新 (UTC)**: 2026-06-30 22:19 UTC

**プロトコル構成:** shadowsocks × 22 · trojan × 29 · vless × 6 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `mfuu-clash` × 8 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 5
