...
![ノード](https://img.shields.io/badge/ノード-129-brightgreen) ![生存](https://img.shields.io/badge/生存-2268-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-84ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_20:37_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 84 ms
- **最終更新 (UTC)**: 2026-05-18 20:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 16 · trojan × 25 · vless × 68 · vmess × 19

**今回使用したソース:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `ruking-clash` × 7 · `surfboard-eternity` × 4
