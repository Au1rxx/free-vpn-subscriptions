...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2049-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-72ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_10:11_UTC-informational)
...
- **最速 RTT**: 24 ms
- **中央値 RTT**: 72 ms
- **最終更新 (UTC)**: 2026-05-22 10:11 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 34 · trojan × 11 · vless × 92 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 67 · `pawdroid` × 5 · `ruking-clash` × 6 · `surfboard-eternity` × 8
