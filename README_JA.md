...
![ノード](https://img.shields.io/badge/ノード-125-brightgreen) ![生存](https://img.shields.io/badge/生存-2536-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-187ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_05:38_UTC-informational)
...
- **最速 RTT**: 15 ms
- **中央値 RTT**: 187 ms
- **最終更新 (UTC)**: 2026-06-02 05:38 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 41 · trojan × 36 · vless × 21 · vmess × 26

**今回使用したソース:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 25 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 7
