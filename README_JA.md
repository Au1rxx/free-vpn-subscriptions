...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2241-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-181ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_10:32_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 181 ms
- **最終更新 (UTC)**: 2026-04-22 10:32 UTC

**プロトコル構成:** shadowsocks × 30 · trojan × 18 · vless × 90 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 36 · `epodonios` × 9 · `lagzian-mix` × 7 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 6
