...
![ノード](https://img.shields.io/badge/ノード-138-brightgreen) ![生存](https://img.shields.io/badge/生存-2105-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-164ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_22:33_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 164 ms
- **最終更新 (UTC)**: 2026-04-28 22:33 UTC

**プロトコル構成:** shadowsocks × 30 · trojan × 22 · vless × 75 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 35 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 53 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
