...
![ノード](https://img.shields.io/badge/ノード-109-brightgreen) ![生存](https://img.shields.io/badge/生存-1866-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-344ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_06:12_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 344 ms
- **最終更新 (UTC)**: 2026-06-15 06:12 UTC

**プロトコル構成:** shadowsocks × 45 · trojan × 26 · vless × 25 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 29 · `pawdroid` × 1 · `ruking-clash` × 11 · `surfboard-eternity` × 2
