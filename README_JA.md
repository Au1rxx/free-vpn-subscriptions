...
![ノード](https://img.shields.io/badge/ノード-99-brightgreen) ![生存](https://img.shields.io/badge/生存-2330-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_02:22_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 167 ms
- **最終更新 (UTC)**: 2026-06-10 02:22 UTC

**プロトコル構成:** shadowsocks × 35 · trojan × 14 · vless × 28 · vmess × 22

**今回使用したソース:** `barry-far-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 29 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 5
