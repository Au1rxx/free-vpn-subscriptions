...
![ノード](https://img.shields.io/badge/ノード-114-brightgreen) ![生存](https://img.shields.io/badge/生存-2025-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-331ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-02_05:18_UTC-informational)
...
- **最速 RTT**: 40 ms
- **中央値 RTT**: 331 ms
- **最終更新 (UTC)**: 2026-07-02 05:18 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 47 · trojan × 35 · vless × 21 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 25 · `pawdroid` × 4 · `surfboard-eternity` × 1
