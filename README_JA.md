...
![ノード](https://img.shields.io/badge/ノード-97-brightgreen) ![生存](https://img.shields.io/badge/生存-2165-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-137ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_01:30_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 137 ms
- **最終更新 (UTC)**: 2026-06-06 01:30 UTC

**プロトコル構成:** shadowsocks × 22 · trojan × 27 · vless × 31 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 30 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
