...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2455-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-78ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_12:37_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 78 ms
- **最終更新 (UTC)**: 2026-05-18 12:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 45 · trojan × 8 · vless × 89 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 16 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 40 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 53 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
