...
![ノード](https://img.shields.io/badge/ノード-84-brightgreen) ![生存](https://img.shields.io/badge/生存-2217-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-178ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_23:34_UTC-informational)
...
- **最速 RTT**: 26 ms
- **中央値 RTT**: 178 ms
- **最終更新 (UTC)**: 2026-06-06 23:34 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 31 · trojan × 21 · vless × 8 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 4 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
