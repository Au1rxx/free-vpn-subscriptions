...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1998-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-458ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_23:20_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 458 ms
- **最終更新 (UTC)**: 2026-06-22 23:20 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 42 · trojan × 24 · vless × 69 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 52 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 1 · `ruking-clash` × 24 · `snakem982` × 1 · `surfboard-eternity` × 4
