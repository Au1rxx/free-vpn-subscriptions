...
![ノード](https://img.shields.io/badge/ノード-90-brightgreen) ![生存](https://img.shields.io/badge/生存-2196-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-553ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_12:38_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 553 ms
- **最終更新 (UTC)**: 2026-06-29 12:38 UTC

**プロトコル構成:** shadowsocks × 18 · trojan × 40 · vless × 19 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 18 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 5
