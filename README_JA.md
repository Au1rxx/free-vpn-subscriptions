...
![ノード](https://img.shields.io/badge/ノード-114-brightgreen) ![生存](https://img.shields.io/badge/生存-2120-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-364ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_19:28_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 364 ms
- **最終更新 (UTC)**: 2026-06-24 19:28 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 30 · trojan × 32 · vless × 34 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 37 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 6 · `ruking-clash` × 15 · `surfboard-eternity` × 2
