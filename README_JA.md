...
![ノード](https://img.shields.io/badge/ノード-131-brightgreen) ![生存](https://img.shields.io/badge/生存-2100-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-474ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_20:31_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 474 ms
- **最終更新 (UTC)**: 2026-06-20 20:31 UTC

**プロトコル構成:** shadowsocks × 41 · trojan × 34 · vless × 32 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 38 · `surfboard-eternity` × 3
