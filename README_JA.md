...
![ノード](https://img.shields.io/badge/ノード-123-brightgreen) ![生存](https://img.shields.io/badge/生存-2492-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-439ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_21:14_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 439 ms
- **最終更新 (UTC)**: 2026-04-23 21:14 UTC

**プロトコル構成:** shadowsocks × 14 · trojan × 25 · vless × 70 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 22 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 47 · `pawdroid` × 2 · `surfboard-eternity` × 1
