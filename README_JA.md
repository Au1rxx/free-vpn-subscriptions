...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2244-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-142ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_05:30_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 142 ms
- **最終更新 (UTC)**: 2026-04-22 05:30 UTC

**プロトコル構成:** shadowsocks × 37 · trojan × 2 · vless × 98 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 40 · `epodonios` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 62 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 9
