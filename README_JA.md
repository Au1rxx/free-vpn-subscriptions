...
![ノード](https://img.shields.io/badge/ノード-103-brightgreen) ![生存](https://img.shields.io/badge/生存-1802-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-396ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_14:24_UTC-informational)
...
- **最速 RTT**: 37 ms
- **中央値 RTT**: 396 ms
- **最終更新 (UTC)**: 2026-06-30 14:24 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 39 · trojan × 43 · vless × 11 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 17 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 13 · `surfboard-eternity` × 5
