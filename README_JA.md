...
![ノード](https://img.shields.io/badge/ノード-132-brightgreen) ![生存](https://img.shields.io/badge/生存-2254-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-77ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_23:18_UTC-informational)
...
- **最速 RTT**: 22 ms
- **中央値 RTT**: 77 ms
- **最終更新 (UTC)**: 2026-05-18 23:18 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 19 · trojan × 27 · vless × 63 · vmess × 22

**今回使用したソース:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 25 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 50 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 3
