...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2302-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-68ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_08:39_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 68 ms
- **最終更新 (UTC)**: 2026-05-19 08:39 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 18 · trojan × 24 · vless × 91 · vmess × 16

**今回使用したソース:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 19 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 66 · `pawdroid` × 7 · `ruking-clash` × 1 · `surfboard-eternity` × 2
