...
![ノード](https://img.shields.io/badge/ノード-108-brightgreen) ![生存](https://img.shields.io/badge/生存-2188-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-198ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-11_02:23_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 198 ms
- **最終更新 (UTC)**: 2026-06-11 02:23 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 31 · vmess × 22

**今回使用したソース:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 17 · `ninjastrikers` × 33 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 3
