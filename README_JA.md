...
![ノード](https://img.shields.io/badge/ノード-124-brightgreen) ![生存](https://img.shields.io/badge/生存-2059-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-406ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_07:27_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 406 ms
- **最終更新 (UTC)**: 2026-06-23 07:27 UTC

**プロトコル構成:** shadowsocks × 35 · trojan × 31 · vless × 47 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 3 · `epodonios` × 45 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 3
