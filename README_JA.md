...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2229-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-144ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_01:38_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 144 ms
- **最終更新 (UTC)**: 2026-04-22 01:38 UTC

**プロトコル構成:** shadowsocks × 34 · trojan × 5 · vless × 97 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 29 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 71 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 5
