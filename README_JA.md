...
![ノード](https://img.shields.io/badge/ノード-95-brightgreen) ![生存](https://img.shields.io/badge/生存-1891-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-362ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_13:37_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 362 ms
- **最終更新 (UTC)**: 2026-06-15 13:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 21 · vless × 16 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 18 · `mfuu-clash` × 2 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 3
