...
![ノード](https://img.shields.io/badge/ノード-85-brightgreen) ![生存](https://img.shields.io/badge/生存-2209-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-445ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_07:13_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 445 ms
- **最終更新 (UTC)**: 2026-06-29 07:13 UTC

**プロトコル構成:** shadowsocks × 18 · trojan × 29 · vless × 23 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 9 · `epodonios` × 18 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 9 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 5
