...
![ノード](https://img.shields.io/badge/ノード-86-brightgreen) ![生存](https://img.shields.io/badge/生存-1822-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-390ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_20:35_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 390 ms
- **最終更新 (UTC)**: 2026-06-30 20:35 UTC

**プロトコル構成:** shadowsocks × 38 · trojan × 31 · vless × 10 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 5
