...
![ノード](https://img.shields.io/badge/ノード-70-brightgreen) ![生存](https://img.shields.io/badge/生存-2055-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-203ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-28_09:15_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 203 ms
- **最終更新 (UTC)**: 2026-05-28 09:15 UTC

**プロトコル構成:** shadowsocks × 28 · trojan × 14 · vless × 16 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 6 · `ruking-clash` × 2 · `snakem982` × 4 · `surfboard-eternity` × 4
