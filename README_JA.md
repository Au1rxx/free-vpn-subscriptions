...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2280-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-451ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_22:36_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 451 ms
- **最終更新 (UTC)**: 2026-04-20 22:36 UTC

**プロトコル構成:** shadowsocks × 22 · trojan × 19 · vless × 95 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 60 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 44 · `ruking-clash` × 4 · `surfboard-eternity` × 5
