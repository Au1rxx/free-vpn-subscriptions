...
![ノード](https://img.shields.io/badge/ノード-71-brightgreen) ![生存](https://img.shields.io/badge/生存-2072-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-163ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-29_09:27_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 163 ms
- **最終更新 (UTC)**: 2026-05-29 09:27 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 26 · trojan × 25 · vless × 10 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 3 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 10 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 1
