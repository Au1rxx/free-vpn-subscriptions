...
![ノード](https://img.shields.io/badge/ノード-87-brightgreen) ![生存](https://img.shields.io/badge/生存-2242-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-235ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_04:29_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 235 ms
- **最終更新 (UTC)**: 2026-06-29 04:29 UTC

**プロトコル構成:** shadowsocks × 17 · trojan × 30 · vless × 27 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 8 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 3
