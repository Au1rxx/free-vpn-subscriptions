...
![ノード](https://img.shields.io/badge/ノード-80-brightgreen) ![生存](https://img.shields.io/badge/生存-2418-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-01_14:35_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 167 ms
- **最終更新 (UTC)**: 2026-06-01 14:35 UTC

**プロトコル構成:** shadowsocks × 16 · trojan × 25 · vless × 7 · vmess × 32

**今回使用したソース:** `barry-far-v2ray` × 16 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 9 · `pawdroid` × 3 · `surfboard-eternity` × 2
