...
![ノード](https://img.shields.io/badge/ノード-80-brightgreen) ![生存](https://img.shields.io/badge/生存-1998-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-169ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-03_17:24_UTC-informational)
...
- **最速 RTT**: 41 ms
- **中央値 RTT**: 169 ms
- **最終更新 (UTC)**: 2026-07-03 17:24 UTC

**プロトコル構成:** shadowsocks × 22 · trojan × 23 · vless × 16 · vmess × 19

**今回使用したソース:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 10 · `ninjastrikers` × 12 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 3
