...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2392-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-88ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-23_03:13_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 88 ms
- **最終更新 (UTC)**: 2026-05-23 03:13 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 30 · trojan × 11 · vless × 97 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 19 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 71 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
