...
![ノード](https://img.shields.io/badge/ノード-99-brightgreen) ![生存](https://img.shields.io/badge/生存-1900-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-376ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_14:18_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 376 ms
- **最終更新 (UTC)**: 2026-06-17 14:18 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 40 · trojan × 23 · vless × 21 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 9 · `epodonios` × 11 · `mahdi0024` × 14 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 20 · `surfboard-eternity` × 4
