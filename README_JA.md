...
![ノード](https://img.shields.io/badge/ノード-127-brightgreen) ![生存](https://img.shields.io/badge/生存-2552-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-488ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_12:14_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 488 ms
- **最終更新 (UTC)**: 2026-06-19 12:14 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 34 · trojan × 26 · vless × 46 · vmess × 20

**今回使用したソース:** `barry-far-v2ray` × 17 · `epodonios` × 22 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 4 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 6 · `surfboard-eternity` × 2
