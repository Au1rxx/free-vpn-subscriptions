...
![ノード](https://img.shields.io/badge/ノード-108-brightgreen) ![生存](https://img.shields.io/badge/生存-1664-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-502ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_12:19_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 502 ms
- **最終更新 (UTC)**: 2026-06-14 12:19 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 49 · trojan × 36 · vless × 16 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 3 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 4
