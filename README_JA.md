...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2202-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-112ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-26_11:38_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 112 ms
- **最終更新 (UTC)**: 2026-04-26 11:38 UTC

**プロトコル構成:** shadowsocks × 27 · trojan × 15 · vless × 96 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 20 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
