...
![ノード](https://img.shields.io/badge/ノード-140-brightgreen) ![生存](https://img.shields.io/badge/生存-1778-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-402ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-15_14:15_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 402 ms
- **最終更新 (UTC)**: 2026-07-15 14:15 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 69 · trojan × 49 · vless × 11 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `mahdi0024` × 23 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 4 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 7 · `surfboard-eternity` × 5
