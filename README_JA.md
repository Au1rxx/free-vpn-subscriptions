...
![ノード](https://img.shields.io/badge/ノード-114-brightgreen) ![生存](https://img.shields.io/badge/生存-1849-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-354ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_07:11_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 354 ms
- **最終更新 (UTC)**: 2026-06-15 07:11 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 53 · trojan × 23 · vless × 18 · vmess × 19

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 19 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 4
