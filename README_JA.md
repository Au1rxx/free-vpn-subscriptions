...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2567-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-142ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-26_19:38_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 142 ms
- **最終更新 (UTC)**: 2026-04-26 19:38 UTC

**プロトコル構成:** shadowsocks × 38 · trojan × 18 · vless × 80 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 43 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 4 · `ninjastrikers` × 53 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
