...
![ノード](https://img.shields.io/badge/ノード-139-brightgreen) ![生存](https://img.shields.io/badge/生存-2223-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-117ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_14:18_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 117 ms
- **最終更新 (UTC)**: 2026-04-28 14:18 UTC

**プロトコル構成:** shadowsocks × 29 · trojan × 19 · vless × 79 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 27 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 17 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `mfuu-clash` × 5 · `ninjastrikers` × 55 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6
