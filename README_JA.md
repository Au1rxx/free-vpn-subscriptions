...
![ノード](https://img.shields.io/badge/ノード-136-brightgreen) ![生存](https://img.shields.io/badge/生存-2469-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-217ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-23_22:26_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 217 ms
- **最終更新 (UTC)**: 2026-04-23 22:26 UTC

**プロトコル構成:** shadowsocks × 20 · trojan × 23 · vless × 74 · vmess × 19

**今回使用したソース:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 7
