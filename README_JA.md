...
![ノード](https://img.shields.io/badge/ノード-106-brightgreen) ![生存](https://img.shields.io/badge/生存-1965-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-488ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_14:22_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 488 ms
- **最終更新 (UTC)**: 2026-06-18 14:22 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 29 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 25 · `snakem982` × 7 · `surfboard-eternity` × 2
