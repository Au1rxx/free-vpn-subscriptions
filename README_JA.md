...
![ノード](https://img.shields.io/badge/ノード-137-brightgreen) ![生存](https://img.shields.io/badge/生存-1701-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-377ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_04:23_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 377 ms
- **最終更新 (UTC)**: 2026-06-14 04:23 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 53 · trojan × 40 · vless × 36 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 17 · `ninjastrikers` × 34 · `pawdroid` × 3 · `ruking-clash` × 22 · `surfboard-eternity` × 4
