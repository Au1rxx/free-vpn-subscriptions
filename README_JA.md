...
![ノード](https://img.shields.io/badge/ノード-80-brightgreen) ![生存](https://img.shields.io/badge/生存-2323-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-225ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_20:20_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 225 ms
- **最終更新 (UTC)**: 2026-06-19 20:20 UTC

**プロトコル構成:** shadowsocks × 23 · trojan × 25 · vless × 7 · vmess × 25

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 14 · `surfboard-eternity` × 3
