...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2589-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-94ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_05:37_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 94 ms
- **最終更新 (UTC)**: 2026-04-28 05:37 UTC

**プロトコル構成:** shadowsocks × 22 · trojan × 10 · vless × 109 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 25 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 4
