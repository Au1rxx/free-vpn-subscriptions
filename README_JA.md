...
![ノード](https://img.shields.io/badge/ノード-100-brightgreen) ![生存](https://img.shields.io/badge/生存-2148-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-158ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_03:10_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 158 ms
- **最終更新 (UTC)**: 2026-06-06 03:10 UTC

**プロトコル構成:** shadowsocks × 24 · trojan × 27 · vless × 31 · vmess × 18

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 26 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 30 · `surfboard-eternity` × 1
