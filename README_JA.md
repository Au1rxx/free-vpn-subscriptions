...
![ノード](https://img.shields.io/badge/ノード-105-brightgreen) ![生存](https://img.shields.io/badge/生存-1963-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-352ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_05:22_UTC-informational)
...
- **最速 RTT**: 26 ms
- **中央値 RTT**: 352 ms
- **最終更新 (UTC)**: 2026-06-26 05:22 UTC

**プロトコル構成:** shadowsocks × 31 · trojan × 37 · vless × 26 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `ruking-clash` × 18 · `surfboard-eternity` × 4
