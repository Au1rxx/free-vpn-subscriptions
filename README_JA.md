...
![ノード](https://img.shields.io/badge/ノード-69-brightgreen) ![生存](https://img.shields.io/badge/生存-2052-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-234ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-28_16:38_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 234 ms
- **最終更新 (UTC)**: 2026-05-28 16:38 UTC

**プロトコル構成:** hysteria2 × 3 · shadowsocks × 30 · trojan × 14 · vless × 12 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 5 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 3
