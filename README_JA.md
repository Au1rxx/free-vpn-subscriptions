...
![ノード](https://img.shields.io/badge/ノード-85-brightgreen) ![生存](https://img.shields.io/badge/生存-2033-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-198ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-28_07:27_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 198 ms
- **最終更新 (UTC)**: 2026-05-28 07:27 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 30 · trojan × 24 · vless × 19 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 5
