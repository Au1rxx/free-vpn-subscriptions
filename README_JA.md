...
![ノード](https://img.shields.io/badge/ノード-84-brightgreen) ![生存](https://img.shields.io/badge/生存-2118-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-291ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_15:16_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 291 ms
- **最終更新 (UTC)**: 2026-06-28 15:16 UTC

**プロトコル構成:** shadowsocks × 17 · trojan × 30 · vless × 19 · vmess × 18

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 2
