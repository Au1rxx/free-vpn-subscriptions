...
![ノード](https://img.shields.io/badge/ノード-99-brightgreen) ![生存](https://img.shields.io/badge/生存-1945-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-285ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-12_12:36_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 285 ms
- **最終更新 (UTC)**: 2026-07-12 12:36 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 49 · trojan × 17 · vless × 12 · vmess × 20

**今回使用したソース:** `barry-far-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 1
