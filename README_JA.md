...
![ノード](https://img.shields.io/badge/ノード-111-brightgreen) ![生存](https://img.shields.io/badge/生存-2262-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-359ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_06:10_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 359 ms
- **最終更新 (UTC)**: 2026-06-12 06:10 UTC

**プロトコル構成:** shadowsocks × 46 · trojan × 41 · vless × 18 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 33 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 5
