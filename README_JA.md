...
![ノード](https://img.shields.io/badge/ノード-141-brightgreen) ![生存](https://img.shields.io/badge/生存-2075-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-379ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_10:19_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 379 ms
- **最終更新 (UTC)**: 2026-06-21 10:19 UTC

**プロトコル構成:** shadowsocks × 42 · trojan × 32 · vless × 44 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 9 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 34 · `snakem982` × 1 · `surfboard-eternity` × 3
