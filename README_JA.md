...
![ノード](https://img.shields.io/badge/ノード-67-brightgreen) ![生存](https://img.shields.io/badge/生存-2264-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-165ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-29_17:21_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 165 ms
- **最終更新 (UTC)**: 2026-05-29 17:21 UTC

**プロトコル構成:** shadowsocks × 12 · trojan × 27 · vless × 4 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 19 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 2
