...
![ノード](https://img.shields.io/badge/ノード-81-brightgreen) ![生存](https://img.shields.io/badge/生存-2269-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-184ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_12:33_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 184 ms
- **最終更新 (UTC)**: 2026-06-20 12:33 UTC

**プロトコル構成:** shadowsocks × 23 · trojan × 22 · vless × 8 · vmess × 28

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `ruking-clash` × 15 · `surfboard-eternity` × 2
