...
![ノード](https://img.shields.io/badge/ノード-96-brightgreen) ![生存](https://img.shields.io/badge/生存-1853-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-356ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-09_13:30_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 356 ms
- **最終更新 (UTC)**: 2026-06-09 13:30 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 51 · trojan × 17 · vless × 15 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 14 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 5 · `surfboard-eternity` × 2
