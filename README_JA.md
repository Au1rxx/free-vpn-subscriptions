...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2253-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-246ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_17:20_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 246 ms
- **最終更新 (UTC)**: 2026-04-20 17:20 UTC

**プロトコル構成:** shadowsocks × 29 · trojan × 13 · vless × 96 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 51 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 7
