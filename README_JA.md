...
![ノード](https://img.shields.io/badge/ノード-66-brightgreen) ![生存](https://img.shields.io/badge/生存-2194-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-361ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-05_15:36_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 361 ms
- **最終更新 (UTC)**: 2026-06-05 15:36 UTC

**プロトコル構成:** shadowsocks × 14 · trojan × 24 · vless × 13 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 4 · `epodonios` × 20 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 10 · `pawdroid` × 3 · `surfboard-eternity` × 2
