...
![ノード](https://img.shields.io/badge/ノード-143-brightgreen) ![生存](https://img.shields.io/badge/生存-2322-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-116ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_23:28_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 116 ms
- **最終更新 (UTC)**: 2026-05-22 23:28 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 37 · trojan × 24 · vless × 70 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 53 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
