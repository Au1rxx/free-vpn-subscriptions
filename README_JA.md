...
![ノード](https://img.shields.io/badge/ノード-135-brightgreen) ![生存](https://img.shields.io/badge/生存-1874-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-346ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_01:19_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 346 ms
- **最終更新 (UTC)**: 2026-06-16 01:19 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 53 · trojan × 30 · vless × 37 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 35 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
