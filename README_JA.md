...
![ノード](https://img.shields.io/badge/ノード-83-brightgreen) ![生存](https://img.shields.io/badge/生存-2218-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-226ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_06:37_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 226 ms
- **最終更新 (UTC)**: 2026-06-29 06:37 UTC

**プロトコル構成:** shadowsocks × 18 · trojan × 28 · vless × 24 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 11 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 5
