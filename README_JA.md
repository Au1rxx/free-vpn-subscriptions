...
![ノード](https://img.shields.io/badge/ノード-98-brightgreen) ![生存](https://img.shields.io/badge/生存-1865-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-335ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-09_06:23_UTC-informational)
...
- **最速 RTT**: 21 ms
- **中央値 RTT**: 335 ms
- **最終更新 (UTC)**: 2026-06-09 06:23 UTC

**プロトコル構成:** shadowsocks × 48 · trojan × 19 · vless × 20 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `mahdi0024` × 13 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 22 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 10 · `surfboard-eternity` × 3
