...
![ノード](https://img.shields.io/badge/ノード-148-brightgreen) ![生存](https://img.shields.io/badge/生存-2274-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-245ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-05_13:29_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 245 ms
- **最終更新 (UTC)**: 2026-05-05 13:29 UTC

**プロトコル構成:** shadowsocks × 38 · trojan × 29 · vless × 70 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
