...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2408-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-85ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_15:15_UTC-informational)
...
- **最速 RTT**: 38 ms
- **中央値 RTT**: 85 ms
- **最終更新 (UTC)**: 2026-05-18 15:15 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 42 · trojan × 8 · vless × 92 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 3 · `mahdi0024` × 38 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 7
