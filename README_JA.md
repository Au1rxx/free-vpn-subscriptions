...
![ノード](https://img.shields.io/badge/ノード-139-brightgreen) ![生存](https://img.shields.io/badge/生存-1902-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-426ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_08:39_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 426 ms
- **最終更新 (UTC)**: 2026-06-22 08:39 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 45 · trojan × 26 · vless × 54 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 4 · `surfboard-eternity` × 4
