...
![ノード](https://img.shields.io/badge/ノード-117-brightgreen) ![生存](https://img.shields.io/badge/生存-1984-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-348ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_03:17_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 348 ms
- **最終更新 (UTC)**: 2026-06-28 03:17 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 32 · trojan × 38 · vless × 36 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 5
