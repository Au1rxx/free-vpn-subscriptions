...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2246-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-435ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_21:12_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 435 ms
- **最終更新 (UTC)**: 2026-04-20 21:12 UTC

**プロトコル構成:** shadowsocks × 28 · trojan × 5 · vless × 103 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 60 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 44 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 4
