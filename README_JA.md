...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2444-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-86ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-25_06:12_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 86 ms
- **最終更新 (UTC)**: 2026-05-25 06:12 UTC

**プロトコル構成:** shadowsocks × 41 · trojan × 2 · vless × 79 · vmess × 28

**今回使用したソース:** `barry-far-v2ray` × 16 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 45 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 59 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 1
