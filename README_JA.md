...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2229-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-117ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_09:25_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 117 ms
- **最終更新 (UTC)**: 2026-04-30 09:25 UTC

**プロトコル構成:** shadowsocks × 33 · trojan × 18 · vless × 90 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 31 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 66 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 9
