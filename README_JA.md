...
![ノード](https://img.shields.io/badge/ノード-79-brightgreen) ![生存](https://img.shields.io/badge/生存-2206-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_22:29_UTC-informational)
...
- **最速 RTT**: 19 ms
- **中央値 RTT**: 167 ms
- **最終更新 (UTC)**: 2026-06-06 22:29 UTC

**プロトコル構成:** shadowsocks × 29 · trojan × 20 · vless × 6 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 10 · `ruking-clash` × 1 · `surfboard-eternity` × 3
