...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2249-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-89ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-03_09:39_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 89 ms
- **最終更新 (UTC)**: 2026-05-03 09:39 UTC

**プロトコル構成:** shadowsocks × 27 · trojan × 13 · vless × 100 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 30 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
