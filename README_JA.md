...
![ノード](https://img.shields.io/badge/ノード-115-brightgreen) ![生存](https://img.shields.io/badge/生存-2116-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-355ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_19:18_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 355 ms
- **最終更新 (UTC)**: 2026-06-20 19:18 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 42 · trojan × 26 · vless × 23 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 3 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 25 · `surfboard-eternity` × 1
