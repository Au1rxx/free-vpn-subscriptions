...
![ノード](https://img.shields.io/badge/ノード-105-brightgreen) ![生存](https://img.shields.io/badge/生存-2005-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-441ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_12:39_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 441 ms
- **最終更新 (UTC)**: 2026-06-28 12:39 UTC

**プロトコル構成:** shadowsocks × 33 · trojan × 34 · vless × 25 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 31 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 13 · `surfboard-eternity` × 5
