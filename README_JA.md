...
![ノード](https://img.shields.io/badge/ノード-125-brightgreen) ![生存](https://img.shields.io/badge/生存-1836-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-408ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_18:11_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 408 ms
- **最終更新 (UTC)**: 2026-06-15 18:11 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 53 · trojan × 23 · vless × 34 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 22 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 19 · `surfboard-eternity` × 1
