...
![ノード](https://img.shields.io/badge/ノード-148-brightgreen) ![生存](https://img.shields.io/badge/生存-2576-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-140ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_15:37_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 140 ms
- **最終更新 (UTC)**: 2026-04-24 15:37 UTC

**プロトコル構成:** shadowsocks × 29 · trojan × 20 · vless × 86 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 20 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 38 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 57 · `pawdroid` × 2 · `surfboard-eternity` × 3
