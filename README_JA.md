...
![ノード](https://img.shields.io/badge/ノード-144-brightgreen) ![生存](https://img.shields.io/badge/生存-1926-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-481ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_13:37_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 481 ms
- **最終更新 (UTC)**: 2026-06-22 13:37 UTC

**プロトコル構成:** shadowsocks × 40 · trojan × 29 · vless × 62 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 41 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 8
