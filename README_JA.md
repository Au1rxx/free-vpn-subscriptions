...
![ノード](https://img.shields.io/badge/ノード-142-brightgreen) ![生存](https://img.shields.io/badge/生存-2241-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-411ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_23:36_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 411 ms
- **最終更新 (UTC)**: 2026-04-21 23:36 UTC

**プロトコル構成:** shadowsocks × 33 · trojan × 23 · vless × 71 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 32 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 4 · `surfboard-eternity` × 6
