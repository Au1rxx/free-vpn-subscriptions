...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2281-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-66ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_10:15_UTC-informational)
...
- **最速 RTT**: 24 ms
- **中央値 RTT**: 66 ms
- **最終更新 (UTC)**: 2026-05-19 10:15 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 19 · trojan × 24 · vless × 85 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 59 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 4
