...
![ノード](https://img.shields.io/badge/ノード-100-brightgreen) ![生存](https://img.shields.io/badge/生存-1876-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-360ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-13_12:34_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 360 ms
- **最終更新 (UTC)**: 2026-06-13 12:34 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 56 · trojan × 23 · vless × 13 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 12 · `surfboard-eternity` × 2
