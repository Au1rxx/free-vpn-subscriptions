...
![ノード](https://img.shields.io/badge/ノード-113-brightgreen) ![生存](https://img.shields.io/badge/生存-2005-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-355ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_09:32_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 355 ms
- **最終更新 (UTC)**: 2026-06-28 09:32 UTC

**プロトコル構成:** shadowsocks × 33 · trojan × 39 · vless × 27 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
