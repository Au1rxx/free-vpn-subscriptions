...
![ノード](https://img.shields.io/badge/ノード-90-brightgreen) ![生存](https://img.shields.io/badge/生存-1819-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-418ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_21:15_UTC-informational)
...
- **最速 RTT**: 37 ms
- **中央値 RTT**: 418 ms
- **最終更新 (UTC)**: 2026-06-30 21:15 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 12 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 14 · `surfboard-eternity` × 3
