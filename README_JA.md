...
![ノード](https://img.shields.io/badge/ノード-137-brightgreen) ![生存](https://img.shields.io/badge/生存-2184-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-144ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_18:17_UTC-informational)
...
- **最速 RTT**: 39 ms
- **中央値 RTT**: 144 ms
- **最終更新 (UTC)**: 2026-04-28 18:17 UTC

**プロトコル構成:** shadowsocks × 27 · trojan × 24 · vless × 75 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 32 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
