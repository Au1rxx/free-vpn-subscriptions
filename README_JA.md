...
![ノード](https://img.shields.io/badge/ノード-83-brightgreen) ![生存](https://img.shields.io/badge/生存-1845-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-378ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_19:26_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 378 ms
- **最終更新 (UTC)**: 2026-06-30 19:26 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 33 · trojan × 30 · vless × 14 · vmess × 5

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 8 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 3
