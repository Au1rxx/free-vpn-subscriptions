...
![ノード](https://img.shields.io/badge/ノード-122-brightgreen) ![生存](https://img.shields.io/badge/生存-2540-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-168ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_03:26_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 168 ms
- **最終更新 (UTC)**: 2026-06-02 03:26 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 33 · trojan × 35 · vless × 25 · vmess × 28

**今回使用したソース:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 27 · `pawdroid` × 5 · `snakem982` × 2 · `surfboard-eternity` × 3
