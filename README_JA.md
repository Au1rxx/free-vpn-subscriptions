...
![ノード](https://img.shields.io/badge/ノード-119-brightgreen) ![生存](https://img.shields.io/badge/生存-1952-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-434ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_21:10_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 434 ms
- **最終更新 (UTC)**: 2026-06-12 21:10 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 54 · trojan × 43 · vless × 13 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 33 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 8 · `surfboard-eternity` × 6
