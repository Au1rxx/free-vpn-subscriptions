...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2342-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-82ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-20_18:29_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 82 ms
- **最終更新 (UTC)**: 2026-05-20 18:29 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 39 · trojan × 20 · vless × 70 · vmess × 20

**今回使用したソース:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 9 · `surfboard-eternity` × 7
