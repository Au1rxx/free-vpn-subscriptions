...
![ノード](https://img.shields.io/badge/ノード-62-brightgreen) ![生存](https://img.shields.io/badge/生存-2410-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-146ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-02_21:22_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 146 ms
- **最終更新 (UTC)**: 2026-07-02 21:22 UTC

**プロトコル構成:** shadowsocks × 26 · trojan × 15 · vless × 6 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `surfboard-eternity` × 5
