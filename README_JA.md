...
![ノード](https://img.shields.io/badge/ノード-138-brightgreen) ![生存](https://img.shields.io/badge/生存-2322-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-309ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_20:32_UTC-informational)
...
- **最速 RTT**: 38 ms
- **中央値 RTT**: 309 ms
- **最終更新 (UTC)**: 2026-04-21 20:32 UTC

**プロトコル構成:** shadowsocks × 31 · trojan × 24 · vless × 68 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 37 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
