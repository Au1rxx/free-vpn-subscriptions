...
![ノード](https://img.shields.io/badge/ノード-99-brightgreen) ![生存](https://img.shields.io/badge/生存-1964-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-495ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_09:17_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 495 ms
- **最終更新 (UTC)**: 2026-06-18 09:17 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 35 · trojan × 26 · vless × 31 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 7 · `ruking-clash` × 18 · `snakem982` × 7 · `surfboard-eternity` × 2
