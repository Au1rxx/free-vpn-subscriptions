...
![ノード](https://img.shields.io/badge/ノード-131-brightgreen) ![生存](https://img.shields.io/badge/生存-2400-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-471ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_00:32_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 471 ms
- **最終更新 (UTC)**: 2026-06-19 00:32 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 44 · trojan × 28 · vless × 49 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 13 · `epodonios` × 12 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 28 · `pawdroid` × 3 · `ruking-clash` × 32 · `snakem982` × 10 · `surfboard-eternity` × 3
