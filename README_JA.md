...
![ノード](https://img.shields.io/badge/ノード-90-brightgreen) ![生存](https://img.shields.io/badge/生存-1947-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-280ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_20:34_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 280 ms
- **最終更新 (UTC)**: 2026-06-26 20:34 UTC

**プロトコル構成:** shadowsocks × 23 · trojan × 29 · vless × 14 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `mahdi0024` × 16 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `ruking-clash` × 17 · `surfboard-eternity` × 5
