...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2115-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-132ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-29_12:39_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 132 ms
- **最終更新 (UTC)**: 2026-04-29 12:39 UTC

**プロトコル構成:** shadowsocks × 41 · trojan × 10 · vless × 89 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 31 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 60 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
