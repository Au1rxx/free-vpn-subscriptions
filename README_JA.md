...
![ノード](https://img.shields.io/badge/ノード-86-brightgreen) ![生存](https://img.shields.io/badge/生存-2242-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-155ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_03:29_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 155 ms
- **最終更新 (UTC)**: 2026-06-29 03:29 UTC

**プロトコル構成:** shadowsocks × 17 · trojan × 28 · vless × 27 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 19 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 8 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 1
