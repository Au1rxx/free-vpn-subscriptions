...
![ノード](https://img.shields.io/badge/ノード-84-brightgreen) ![生存](https://img.shields.io/badge/生存-2086-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-178ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_19:33_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 178 ms
- **最終更新 (UTC)**: 2026-06-06 19:33 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 32 · trojan × 20 · vless × 7 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 39 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 2
