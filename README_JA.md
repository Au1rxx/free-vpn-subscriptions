...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2249-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-169ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_14:23_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 169 ms
- **最終更新 (UTC)**: 2026-04-20 14:23 UTC

**プロトコル構成:** shadowsocks × 28 · trojan × 14 · vless × 97 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 47 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `ruking-clash` × 6 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
