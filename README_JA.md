...
![ノード](https://img.shields.io/badge/ノード-99-brightgreen) ![生存](https://img.shields.io/badge/生存-2232-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-142ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_02:27_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 142 ms
- **最終更新 (UTC)**: 2026-06-07 02:27 UTC

**プロトコル構成:** shadowsocks × 29 · trojan × 21 · vless × 25 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 30 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 5
