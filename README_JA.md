...
![ノード](https://img.shields.io/badge/ノード-135-brightgreen) ![生存](https://img.shields.io/badge/生存-2550-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-287ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_20:29_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 287 ms
- **最終更新 (UTC)**: 2026-04-22 20:29 UTC

**プロトコル構成:** shadowsocks × 29 · trojan × 22 · vless × 70 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 25 · `epodonios` × 11 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 50 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
