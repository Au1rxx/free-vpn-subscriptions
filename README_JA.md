...
![ノード](https://img.shields.io/badge/ノード-149-brightgreen) ![生存](https://img.shields.io/badge/生存-2356-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-88ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-20_19:15_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 88 ms
- **最終更新 (UTC)**: 2026-05-20 19:15 UTC

**プロトコル構成:** shadowsocks × 37 · trojan × 27 · vless × 65 · vmess × 20

**今回使用したソース:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `pawdroid` × 9 · `ruking-clash` × 2 · `surfboard-eternity` × 7
