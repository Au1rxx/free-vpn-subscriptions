...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2222-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-107ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_07:22_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 107 ms
- **最終更新 (UTC)**: 2026-04-30 07:22 UTC

**プロトコル構成:** shadowsocks × 34 · trojan × 17 · vless × 90 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 27 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 7 · `ninjastrikers` × 67 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
