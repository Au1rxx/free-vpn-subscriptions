...
![ノード](https://img.shields.io/badge/ノード-84-brightgreen) ![生存](https://img.shields.io/badge/生存-2253-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-168ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_07:21_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 168 ms
- **最終更新 (UTC)**: 2026-06-07 07:21 UTC

**プロトコル構成:** shadowsocks × 28 · trojan × 20 · vless × 12 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 1
