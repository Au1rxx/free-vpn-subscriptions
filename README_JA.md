...
![ノード](https://img.shields.io/badge/ノード-83-brightgreen) ![生存](https://img.shields.io/badge/生存-2189-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-191ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_10:22_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 191 ms
- **最終更新 (UTC)**: 2026-06-06 10:22 UTC

**プロトコル構成:** shadowsocks × 23 · trojan × 24 · vless × 19 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 26 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 5 · `surfboard-eternity` × 3
