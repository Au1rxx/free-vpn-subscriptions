...
![ノード](https://img.shields.io/badge/ノード-96-brightgreen) ![生存](https://img.shields.io/badge/生存-1941-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-358ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_20:11_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 358 ms
- **最終更新 (UTC)**: 2026-06-27 20:11 UTC

**プロトコル構成:** shadowsocks × 28 · trojan × 39 · vless × 20 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 13 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 5
