...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2218-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-123ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_06:21_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 123 ms
- **最終更新 (UTC)**: 2026-04-22 06:21 UTC

**プロトコル構成:** shadowsocks × 36 · trojan × 4 · vless × 98 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 38 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 9
