...
![ノード](https://img.shields.io/badge/ノード-72-brightgreen) ![生存](https://img.shields.io/badge/生存-2157-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-169ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_13:11_UTC-informational)
...
- **最速 RTT**: 26 ms
- **中央値 RTT**: 169 ms
- **最終更新 (UTC)**: 2026-06-06 13:11 UTC

**プロトコル構成:** shadowsocks × 24 · trojan × 24 · vless × 7 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3
