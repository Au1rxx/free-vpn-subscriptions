...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1961-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-573ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_20:15_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 573 ms
- **最終更新 (UTC)**: 2026-06-16 20:15 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 46 · trojan × 20 · vless × 12 · vmess × 71

**今回使用したソース:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 73 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 3
