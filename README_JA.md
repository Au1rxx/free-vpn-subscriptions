...
![ノード](https://img.shields.io/badge/ノード-57-brightgreen) ![生存](https://img.shields.io/badge/生存-1926-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-92ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-27_10:14_UTC-informational)
...
- **最速 RTT**: 37 ms
- **中央値 RTT**: 92 ms
- **最終更新 (UTC)**: 2026-05-27 10:14 UTC

**プロトコル構成:** shadowsocks × 26 · trojan × 7 · vless × 14 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 16 · `epodonios` × 1 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 5
