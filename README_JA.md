...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2001-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-371ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_00:37_UTC-informational)
...
- **最速 RTT**: 37 ms
- **中央値 RTT**: 371 ms
- **最終更新 (UTC)**: 2026-06-23 00:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 41 · trojan × 28 · vless × 66 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 56 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 1
