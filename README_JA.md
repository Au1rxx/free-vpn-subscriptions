...
![ノード](https://img.shields.io/badge/ノード-79-brightgreen) ![生存](https://img.shields.io/badge/生存-2000-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-344ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_19:33_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 344 ms
- **最終更新 (UTC)**: 2026-06-29 19:33 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 34 · trojan × 31 · vless × 5 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 3
