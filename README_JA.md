...
![ノード](https://img.shields.io/badge/ノード-98-brightgreen) ![生存](https://img.shields.io/badge/生存-2007-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-371ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_18:23_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 371 ms
- **最終更新 (UTC)**: 2026-06-29 18:23 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 36 · trojan × 23 · vless × 26 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 7
