...
![ノード](https://img.shields.io/badge/ノード-128-brightgreen) ![生存](https://img.shields.io/badge/生存-2609-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-384ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_22:13_UTC-informational)
...
- **最速 RTT**: 25 ms
- **中央値 RTT**: 384 ms
- **最終更新 (UTC)**: 2026-04-22 22:13 UTC

**プロトコル構成:** shadowsocks × 30 · trojan × 20 · vless × 66 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
