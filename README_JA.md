...
![ノード](https://img.shields.io/badge/ノード-112-brightgreen) ![生存](https://img.shields.io/badge/生存-1973-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-339ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-05_14:12_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 339 ms
- **最終更新 (UTC)**: 2026-07-05 14:12 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 42 · trojan × 25 · vless × 13 · vmess × 31

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
