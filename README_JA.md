...
![ノード](https://img.shields.io/badge/ノード-144-brightgreen) ![生存](https://img.shields.io/badge/生存-1974-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-501ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_22:32_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 501 ms
- **最終更新 (UTC)**: 2026-06-16 22:32 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 16 · vmess × 54

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 58 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `ruking-clash` × 18
