...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2265-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-448ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_23:39_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 448 ms
- **最終更新 (UTC)**: 2026-04-20 23:39 UTC

**プロトコル構成:** shadowsocks × 23 · trojan × 18 · vless × 96 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 55 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 49 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 6
