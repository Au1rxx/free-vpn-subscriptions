...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2025-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-168ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-07_11:22_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 168 ms
- **最終更新 (UTC)**: 2026-05-07 11:22 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 40 · trojan × 9 · vless × 88 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 69 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
