...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2039-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-73ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_13:15_UTC-informational)
...
- **最速 RTT**: 38 ms
- **中央値 RTT**: 73 ms
- **最終更新 (UTC)**: 2026-05-22 13:15 UTC

**プロトコル構成:** shadowsocks × 37 · trojan × 13 · vless × 87 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 32 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 63 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
