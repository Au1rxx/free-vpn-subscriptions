...
![ノード](https://img.shields.io/badge/ノード-144-brightgreen) ![生存](https://img.shields.io/badge/生存-2125-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-164ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-28_23:24_UTC-informational)
...
- **最速 RTT**: 38 ms
- **中央値 RTT**: 164 ms
- **最終更新 (UTC)**: 2026-04-28 23:24 UTC

**プロトコル構成:** shadowsocks × 33 · trojan × 22 · vless × 78 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 39 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 7 · `ninjastrikers` × 55 · `ruking-clash` × 1 · `surfboard-eternity` × 6
