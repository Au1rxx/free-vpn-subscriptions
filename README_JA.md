...
![ノード](https://img.shields.io/badge/ノード-133-brightgreen) ![生存](https://img.shields.io/badge/生存-1635-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-480ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_20:27_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 480 ms
- **最終更新 (UTC)**: 2026-06-14 20:27 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 61 · trojan × 32 · vless × 26 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 17 · `surfboard-eternity` × 4
