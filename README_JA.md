...
![ノード](https://img.shields.io/badge/ノード-143-brightgreen) ![生存](https://img.shields.io/badge/生存-2607-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-164ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-24_17:40_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 164 ms
- **最終更新 (UTC)**: 2026-04-24 17:40 UTC

**プロトコル構成:** shadowsocks × 27 · trojan × 21 · vless × 85 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 22 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 34 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 60 · `pawdroid` × 2 · `surfboard-eternity` × 1
