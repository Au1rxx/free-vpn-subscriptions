...
![ノード](https://img.shields.io/badge/ノード-69-brightgreen) ![生存](https://img.shields.io/badge/生存-2000-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-175ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-04_11:13_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 175 ms
- **最終更新 (UTC)**: 2026-07-04 11:13 UTC

**プロトコル構成:** shadowsocks × 30 · trojan × 15 · vless × 6 · vmess × 18

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 5 · `ninjastrikers` × 6 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
