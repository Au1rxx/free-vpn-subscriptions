...
![ノード](https://img.shields.io/badge/ノード-111-brightgreen) ![生存](https://img.shields.io/badge/生存-1831-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-377ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_19:39_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 377 ms
- **最終更新 (UTC)**: 2026-06-15 19:39 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 50 · trojan × 23 · vless × 22 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 8 · `surfboard-eternity` × 5
