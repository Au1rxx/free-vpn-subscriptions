...
![ノード](https://img.shields.io/badge/ノード-70-brightgreen) ![生存](https://img.shields.io/badge/生存-2215-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-152ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_22:35_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 152 ms
- **最終更新 (UTC)**: 2026-06-28 22:35 UTC

**プロトコル構成:** shadowsocks × 17 · trojan × 19 · vless × 19 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 2 · `surfboard-eternity` × 1
