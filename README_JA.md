...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1832-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-470ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_16:37_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 470 ms
- **最終更新 (UTC)**: 2026-06-22 16:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 42 · trojan × 26 · vless × 68 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 4
