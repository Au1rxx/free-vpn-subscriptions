...
![ノード](https://img.shields.io/badge/ノード-96-brightgreen) ![生存](https://img.shields.io/badge/生存-1956-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-484ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_10:19_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 484 ms
- **最終更新 (UTC)**: 2026-06-18 10:19 UTC

**プロトコル構成:** shadowsocks × 35 · trojan × 25 · vless × 28 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 25 · `snakem982` × 5 · `surfboard-eternity` × 4
