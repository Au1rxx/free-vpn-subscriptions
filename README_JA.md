...
![ノード](https://img.shields.io/badge/ノード-122-brightgreen) ![生存](https://img.shields.io/badge/生存-2285-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-337ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_03:26_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 337 ms
- **最終更新 (UTC)**: 2026-06-12 03:26 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 41 · trojan × 44 · vless × 30 · vmess × 5

**今回使用したソース:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 31 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 7
