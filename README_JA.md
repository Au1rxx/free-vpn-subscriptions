...
![ノード](https://img.shields.io/badge/ノード-96-brightgreen) ![生存](https://img.shields.io/badge/生存-1969-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-361ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_22:28_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 361 ms
- **最終更新 (UTC)**: 2026-06-27 22:28 UTC

**プロトコル構成:** shadowsocks × 28 · trojan × 39 · vless × 17 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 14 · `ruking-clash` × 14 · `surfboard-eternity` × 5
