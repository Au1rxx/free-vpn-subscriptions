...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2217-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-172ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_20:29_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 172 ms
- **最終更新 (UTC)**: 2026-04-30 20:29 UTC

**プロトコル構成:** shadowsocks × 30 · trojan × 23 · vless × 75 · vmess × 22

**今回使用したソース:** `barry-far-v2ray` × 33 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 32 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 51 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
