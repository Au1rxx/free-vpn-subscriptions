...
![ノード](https://img.shields.io/badge/ノード-79-brightgreen) ![生存](https://img.shields.io/badge/生存-2109-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-568ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_21:21_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 568 ms
- **最終更新 (UTC)**: 2026-06-28 21:21 UTC

**プロトコル構成:** shadowsocks × 16 · trojan × 30 · vless × 18 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 3
