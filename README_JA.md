...
![ノード](https://img.shields.io/badge/ノード-78-brightgreen) ![生存](https://img.shields.io/badge/生存-2128-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-270ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-09_15:19_UTC-informational)
...
- **最速 RTT**: 21 ms
- **中央値 RTT**: 270 ms
- **最終更新 (UTC)**: 2026-06-09 15:19 UTC

**プロトコル構成:** shadowsocks × 32 · trojan × 15 · vless × 8 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 6
