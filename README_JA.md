...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1998-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-363ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_01:22_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 363 ms
- **最終更新 (UTC)**: 2026-06-23 01:22 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 40 · trojan × 28 · vless × 68 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 57 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 24 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
