...
![ノード](https://img.shields.io/badge/ノード-133-brightgreen) ![生存](https://img.shields.io/badge/生存-1998-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-413ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_18:40_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 413 ms
- **最終更新 (UTC)**: 2026-06-23 18:40 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 38 · trojan × 29 · vless × 45 · vmess × 19

**今回使用したソース:** `barry-far-v2ray` × 3 · `epodonios` × 47 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 5
