...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1896-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-418ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_05:32_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 418 ms
- **最終更新 (UTC)**: 2026-06-17 05:32 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 44 · trojan × 13 · vless × 20 · vmess × 72

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 74 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 18 · `ruking-clash` × 3 · `surfboard-eternity` × 3
