...
![ノード](https://img.shields.io/badge/ノード-140-brightgreen) ![生存](https://img.shields.io/badge/生存-2556-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-370ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_15:16_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 370 ms
- **最終更新 (UTC)**: 2026-04-22 15:16 UTC

**プロトコル構成:** shadowsocks × 28 · trojan × 21 · vless × 77 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 29 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 58 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 9
