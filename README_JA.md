...
![ノード](https://img.shields.io/badge/ノード-111-brightgreen) ![生存](https://img.shields.io/badge/生存-1996-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-416ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_11:24_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 416 ms
- **最終更新 (UTC)**: 2026-06-28 11:24 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 33 · trojan × 36 · vless × 28 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 16 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 3
