...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1935-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-257ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_02:30_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 257 ms
- **最終更新 (UTC)**: 2026-06-22 02:30 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 44 · trojan × 15 · vless × 78 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 39 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 16 · `snakem982` × 5 · `surfboard-eternity` × 2
