...
![ノード](https://img.shields.io/badge/ノード-102-brightgreen) ![生存](https://img.shields.io/badge/生存-2320-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-186ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_00:26_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 186 ms
- **最終更新 (UTC)**: 2026-06-20 00:26 UTC

**プロトコル構成:** shadowsocks × 23 · trojan × 29 · vless × 19 · vmess × 31

**今回使用したソース:** `barry-far-v2ray` × 4 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 19 · `surfboard-eternity` × 4
