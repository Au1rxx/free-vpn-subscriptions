...
![ノード](https://img.shields.io/badge/ノード-105-brightgreen) ![生存](https://img.shields.io/badge/生存-1693-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-517ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_13:19_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 517 ms
- **最終更新 (UTC)**: 2026-06-14 13:19 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 52 · trojan × 30 · vless × 14 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `mahdi0024` × 7 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 15 · `surfboard-eternity` × 5
