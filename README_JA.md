...
![ノード](https://img.shields.io/badge/ノード-71-brightgreen) ![生存](https://img.shields.io/badge/生存-1884-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-288ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-05_12:30_UTC-informational)
...
- **最速 RTT**: 24 ms
- **中央値 RTT**: 288 ms
- **最終更新 (UTC)**: 2026-06-05 12:30 UTC

**プロトコル構成:** shadowsocks × 26 · trojan × 23 · vless × 10 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
