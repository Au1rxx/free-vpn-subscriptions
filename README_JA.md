...
![ノード](https://img.shields.io/badge/ノード-139-brightgreen) ![生存](https://img.shields.io/badge/生存-2090-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-281ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-03_16:30_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 281 ms
- **最終更新 (UTC)**: 2026-05-03 16:30 UTC

**プロトコル構成:** shadowsocks × 28 · trojan × 23 · vless × 78 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 30 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
