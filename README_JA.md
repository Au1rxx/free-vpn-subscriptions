...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2195-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-117ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-30_10:18_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 117 ms
- **最終更新 (UTC)**: 2026-04-30 10:18 UTC

**プロトコル構成:** shadowsocks × 42 · trojan × 11 · vless × 89 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 59 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
