...
![ノード](https://img.shields.io/badge/ノード-84-brightgreen) ![生存](https://img.shields.io/badge/生存-2007-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-264ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_18:36_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 264 ms
- **最終更新 (UTC)**: 2026-06-26 18:36 UTC

**プロトコル構成:** shadowsocks × 21 · trojan × 28 · vless × 15 · vmess × 20

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 5
