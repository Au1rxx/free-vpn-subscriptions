...
![ノード](https://img.shields.io/badge/ノード-95-brightgreen) ![生存](https://img.shields.io/badge/生存-1940-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-307ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_21:11_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 307 ms
- **最終更新 (UTC)**: 2026-06-27 21:11 UTC

**プロトコル構成:** shadowsocks × 24 · trojan × 37 · vless × 20 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 22 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 4
