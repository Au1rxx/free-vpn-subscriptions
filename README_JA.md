...
![ノード](https://img.shields.io/badge/ノード-147-brightgreen) ![生存](https://img.shields.io/badge/生存-2126-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-85ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-21_19:11_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 85 ms
- **最終更新 (UTC)**: 2026-05-21 19:11 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 33 · trojan × 33 · vless × 70 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `pawdroid` × 10 · `surfboard-eternity` × 2 · `vxiaov-clash` × 1
