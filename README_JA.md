...
![ノード](https://img.shields.io/badge/ノード-107-brightgreen) ![生存](https://img.shields.io/badge/生存-1888-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-303ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-09_03:22_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 303 ms
- **最終更新 (UTC)**: 2026-06-09 03:22 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 45 · trojan × 22 · vless × 29 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 27 · `pawdroid` × 4 · `ruking-clash` × 9 · `surfboard-eternity` × 3
