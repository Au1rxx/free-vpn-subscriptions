...
![ノード](https://img.shields.io/badge/ノード-72-brightgreen) ![生存](https://img.shields.io/badge/生存-2198-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-167ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-31_19:30_UTC-informational)
...
- **最速 RTT**: 24 ms
- **中央値 RTT**: 167 ms
- **最終更新 (UTC)**: 2026-05-31 19:30 UTC

**プロトコル構成:** shadowsocks × 21 · trojan × 16 · vless × 5 · vmess × 30

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 7 · `mahdi0024` × 22 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `pawdroid` × 1 · `surfboard-eternity` × 4
