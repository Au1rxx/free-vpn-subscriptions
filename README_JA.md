...
![ノード](https://img.shields.io/badge/ノード-92-brightgreen) ![生存](https://img.shields.io/badge/生存-2021-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-380ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_16:36_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 380 ms
- **最終更新 (UTC)**: 2026-06-26 16:36 UTC

**プロトコル構成:** shadowsocks × 21 · trojan × 33 · vless × 17 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 17 · `surfboard-eternity` × 3
