...
![ノード](https://img.shields.io/badge/ノード-118-brightgreen) ![生存](https://img.shields.io/badge/生存-1956-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-300ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-13_00:25_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 300 ms
- **最終更新 (UTC)**: 2026-06-13 00:25 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 55 · trojan × 24 · vless × 30 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 35 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 6
