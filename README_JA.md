...
![ノード](https://img.shields.io/badge/ノード-81-brightgreen) ![生存](https://img.shields.io/badge/生存-2348-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-163ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_05:28_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 163 ms
- **最終更新 (UTC)**: 2026-06-10 05:28 UTC

**プロトコル構成:** shadowsocks × 28 · trojan × 13 · vless × 18 · vmess × 22

**今回使用したソース:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 5
