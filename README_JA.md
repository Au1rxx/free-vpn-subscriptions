...
![ノード](https://img.shields.io/badge/ノード-87-brightgreen) ![生存](https://img.shields.io/badge/生存-2141-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-272ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_16:09_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 272 ms
- **最終更新 (UTC)**: 2026-06-28 16:09 UTC

**プロトコル構成:** shadowsocks × 18 · trojan × 33 · vless × 19 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 3
