...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2570-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-121ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-20_13:24_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 121 ms
- **最終更新 (UTC)**: 2026-04-20 13:24 UTC

**プロトコル構成:** shadowsocks × 19 · trojan × 8 · vless × 111 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 46 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 23 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 50 · `ruking-clash` × 7 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
