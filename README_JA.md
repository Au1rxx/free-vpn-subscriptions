...
![ノード](https://img.shields.io/badge/ノード-120-brightgreen) ![生存](https://img.shields.io/badge/生存-1752-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-476ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_22:22_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 476 ms
- **最終更新 (UTC)**: 2026-06-17 22:22 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 49 · trojan × 32 · vless × 29 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 16 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 23 · `surfboard-eternity` × 3
