...
![ノード](https://img.shields.io/badge/ノード-96-brightgreen) ![生存](https://img.shields.io/badge/生存-1844-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-374ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_08:38_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 374 ms
- **最終更新 (UTC)**: 2026-06-30 08:38 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 35 · trojan × 41 · vless × 10 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 12
