...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2315-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-452ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_18:12_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 452 ms
- **最終更新 (UTC)**: 2026-04-21 18:12 UTC

**プロトコル構成:** shadowsocks × 29 · trojan × 18 · vless × 89 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 52 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 47 · `ruking-clash` × 7 · `surfboard-eternity` × 6
