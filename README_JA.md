...
![ノード](https://img.shields.io/badge/ノード-143-brightgreen) ![生存](https://img.shields.io/badge/生存-2358-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-109ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-24_22:18_UTC-informational)
...
- **最速 RTT**: 23 ms
- **中央値 RTT**: 109 ms
- **最終更新 (UTC)**: 2026-05-24 22:18 UTC

**プロトコル構成:** shadowsocks × 44 · trojan × 18 · vless × 53 · vmess × 28

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 49 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
