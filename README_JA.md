...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2426-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-83ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_22:16_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 83 ms
- **最終更新 (UTC)**: 2026-05-19 22:16 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 38 · trojan × 9 · vless × 82 · vmess × 20

**今回使用したソース:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 5 · `ruking-clash` × 16 · `snakem982` × 1 · `surfboard-eternity` × 6
