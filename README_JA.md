...
![ノード](https://img.shields.io/badge/ノード-124-brightgreen) ![生存](https://img.shields.io/badge/生存-2069-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-384ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_08:24_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 384 ms
- **最終更新 (UTC)**: 2026-06-24 08:24 UTC

**プロトコル構成:** shadowsocks × 34 · trojan × 29 · vless × 45 · vmess × 16

**今回使用したソース:** `barry-far-v2ray` × 14 · `epodonios` × 41 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 14 · `surfboard-eternity` × 2
