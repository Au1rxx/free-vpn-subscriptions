...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2373-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-88ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-23_14:39_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 88 ms
- **最終更新 (UTC)**: 2026-05-23 14:39 UTC

**プロトコル構成:** shadowsocks × 39 · trojan × 18 · vless × 66 · vmess × 27

**今回使用したソース:** `barry-far-v2ray` × 25 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 42 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 48 · `pawdroid` × 7 · `surfboard-eternity` × 4
