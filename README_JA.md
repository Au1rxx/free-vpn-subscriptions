...
![ノード](https://img.shields.io/badge/ノード-142-brightgreen) ![生存](https://img.shields.io/badge/生存-2250-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-425ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-04_21:24_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 425 ms
- **最終更新 (UTC)**: 2026-05-04 21:24 UTC

**プロトコル構成:** shadowsocks × 35 · trojan × 26 · vless × 69 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 56 · `ruking-clash` × 3 · `surfboard-eternity` × 6
