...
![ノード](https://img.shields.io/badge/ノード-74-brightgreen) ![生存](https://img.shields.io/badge/生存-2341-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-337ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-11_19:11_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 337 ms
- **最終更新 (UTC)**: 2026-06-11 19:11 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 41 · trojan × 12 · vless × 14 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 8 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 4
