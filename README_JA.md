...
![ノード](https://img.shields.io/badge/ノード-138-brightgreen) ![生存](https://img.shields.io/badge/生存-2588-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-229ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-22_14:16_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 229 ms
- **最終更新 (UTC)**: 2026-04-22 14:16 UTC

**プロトコル構成:** shadowsocks × 27 · trojan × 22 · vless × 79 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 30 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 57 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7
