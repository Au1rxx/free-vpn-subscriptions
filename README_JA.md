...
![ノード](https://img.shields.io/badge/ノード-73-brightgreen) ![生存](https://img.shields.io/badge/生存-2438-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-106ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_16:18_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 106 ms
- **最終更新 (UTC)**: 2026-06-02 16:18 UTC

**プロトコル構成:** shadowsocks × 23 · trojan × 25 · vless × 7 · vmess × 18

**今回使用したソース:** `barry-far-v2ray` × 15 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 5 · `pawdroid` × 2
