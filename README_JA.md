...
![ノード](https://img.shields.io/badge/ノード-125-brightgreen) ![生存](https://img.shields.io/badge/生存-1997-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-354ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_06:16_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 354 ms
- **最終更新 (UTC)**: 2026-06-28 06:16 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 36 · trojan × 40 · vless × 37 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 29 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 3
