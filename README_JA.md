...
![ノード](https://img.shields.io/badge/ノード-147-brightgreen) ![生存](https://img.shields.io/badge/生存-2281-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-435ms-orange) ![更新](https://img.shields.io/badge/更新-2026-04-21_21:31_UTC-informational)
...
- **最速 RTT**: 37 ms
- **中央値 RTT**: 435 ms
- **最終更新 (UTC)**: 2026-04-21 21:31 UTC

**プロトコル構成:** shadowsocks × 30 · trojan × 23 · vless × 80 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 46 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 5
