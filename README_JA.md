...
![ノード](https://img.shields.io/badge/ノード-120-brightgreen) ![生存](https://img.shields.io/badge/生存-1809-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-377ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_08:22_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 377 ms
- **最終更新 (UTC)**: 2026-06-16 08:22 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 50 · trojan × 27 · vless × 27 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 20 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 4
