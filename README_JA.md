...
![ノード](https://img.shields.io/badge/ノード-91-brightgreen) ![生存](https://img.shields.io/badge/生存-1870-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-388ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_18:13_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 388 ms
- **最終更新 (UTC)**: 2026-06-30 18:13 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 34 · trojan × 34 · vless × 16 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `mahdi0024` × 7 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 9 · `ninjastrikers` × 15 · `pawdroid` × 6 · `ruking-clash` × 11 · `surfboard-eternity` × 6
