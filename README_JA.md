...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1926-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-304ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_17:18_UTC-informational)
...
- **最速 RTT**: 38 ms
- **中央値 RTT**: 304 ms
- **最終更新 (UTC)**: 2026-06-16 17:18 UTC

**プロトコル構成:** shadowsocks × 48 · trojan × 12 · vless × 15 · vmess × 75

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 16 · `lagzian-mix` × 1 · `mahdi0024` × 78 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 1
