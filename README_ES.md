...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2235-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-142ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-22_04:14_UTC-informational)
...
- **RTT mediana**: 142 ms
- **Última actualización (UTC)**: 2026-04-22 04:14 UTC

**Mezcla de protocolos:** shadowsocks × 33 · trojan × 3 · vless × 102 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 38 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 67 · `ruking-clash` × 5 · `surfboard-eternity` × 6
