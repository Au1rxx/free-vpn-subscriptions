...
![nodos](https://img.shields.io/badge/nodos-99-brightgreen) ![activos](https://img.shields.io/badge/activos-1900-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-376ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-17_14:18_UTC-informational)
...
- **RTT mediana**: 376 ms
- **Última actualización (UTC)**: 2026-06-17 14:18 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 23 · vless × 21 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 9 · `epodonios` × 11 · `mahdi0024` × 14 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 20 · `surfboard-eternity` × 4
