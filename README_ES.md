...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1926-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-304ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-16_17:18_UTC-informational)
...
- **RTT mediana**: 304 ms
- **Última actualización (UTC)**: 2026-06-16 17:18 UTC

**Mezcla de protocolos:** shadowsocks × 48 · trojan × 12 · vless × 15 · vmess × 75

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 16 · `lagzian-mix` × 1 · `mahdi0024` × 78 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 1
