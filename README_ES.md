...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2445-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-118ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-24_03:27_UTC-informational)
...
- **RTT mediana**: 118 ms
- **Última actualización (UTC)**: 2026-04-24 03:27 UTC

**Mezcla de protocolos:** shadowsocks × 24 · trojan × 12 · vless × 102 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 24 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 73 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
