...
![nodos](https://img.shields.io/badge/nodos-109-brightgreen) ![activos](https://img.shields.io/badge/activos-1889-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-359ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-06_11:27_UTC-informational)
...
- **RTT mediana**: 359 ms
- **Última actualización (UTC)**: 2026-07-06 11:27 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 11 · vmess × 28

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 6 · `ninjastrikers` × 12 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 5
