...
![nodos](https://img.shields.io/badge/nodos-63-brightgreen) ![activos](https://img.shields.io/badge/activos-1954-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-275ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-30_22:19_UTC-informational)
...
- **RTT mediana**: 275 ms
- **Última actualización (UTC)**: 2026-06-30 22:19 UTC

**Mezcla de protocolos:** shadowsocks × 22 · trojan × 29 · vless × 6 · vmess × 6

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `mfuu-clash` × 8 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 5
