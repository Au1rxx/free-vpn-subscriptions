...
![nodos](https://img.shields.io/badge/nodos-106-brightgreen) ![activos](https://img.shields.io/badge/activos-1948-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-317ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-05_11:35_UTC-informational)
...
- **RTT mediana**: 317 ms
- **Última actualización (UTC)**: 2026-07-05 11:35 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 25 · vless × 8 · vmess × 27

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
