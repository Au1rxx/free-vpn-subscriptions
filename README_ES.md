...
![nodos](https://img.shields.io/badge/nodos-114-brightgreen) ![activos](https://img.shields.io/badge/activos-1910-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-198ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-04_15:35_UTC-informational)
...
- **RTT mediana**: 198 ms
- **Última actualización (UTC)**: 2026-06-04 15:35 UTC

**Mezcla de protocolos:** shadowsocks × 25 · trojan × 57 · vless × 19 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 40 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `ruking-clash` × 3 · `surfboard-eternity` × 2
