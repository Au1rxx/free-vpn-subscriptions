...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2241-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-181ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-22_10:32_UTC-informational)
...
- **RTT mediana**: 181 ms
- **Última actualización (UTC)**: 2026-04-22 10:32 UTC

**Mezcla de protocolos:** shadowsocks × 30 · trojan × 18 · vless × 90 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 36 · `epodonios` × 9 · `lagzian-mix` × 7 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 6
