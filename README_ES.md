...
![nodos](https://img.shields.io/badge/nodos-113-brightgreen) ![activos](https://img.shields.io/badge/activos-1997-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-338ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-04_22:33_UTC-informational)
...
- **RTT mediana**: 338 ms
- **Última actualización (UTC)**: 2026-07-04 22:33 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 22 · vless × 9 · vmess × 26

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 36 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
