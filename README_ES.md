...
![nodos](https://img.shields.io/badge/nodos-130-brightgreen) ![activos](https://img.shields.io/badge/activos-1939-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-469ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-17_06:16_UTC-informational)
...
- **RTT mediana**: 469 ms
- **Última actualización (UTC)**: 2026-06-17 06:16 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 27 · vless × 23 · vmess × 39

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 41 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
