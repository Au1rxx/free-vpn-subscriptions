...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-393-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-119ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-19_06:42_UTC-informational)
...
- **RTT mediana**: 119 ms
- **Última actualización (UTC)**: 2026-04-19 06:42 UTC

**Mezcla de protocolos:** shadowsocks × 104 · trojan × 7 · vmess × 39

**Fuentes usadas en esta ejecución:** `freefq` × 2 · `mahdibland-aggregator` × 67 · `mahdibland-shadowsocks` × 65 · `vxiaov-clash` × 16
