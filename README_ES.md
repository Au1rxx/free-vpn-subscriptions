...
![nodos](https://img.shields.io/badge/nodos-144-brightgreen) ![activos](https://img.shields.io/badge/activos-1974-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-501ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-16_22:32_UTC-informational)
...
- **RTT mediana**: 501 ms
- **Última actualización (UTC)**: 2026-06-16 22:32 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 16 · vmess × 54

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 58 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `ruking-clash` × 18
