...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1972-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-126ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-12_02:23_UTC-informational)
...
- **RTT mediana**: 126 ms
- **Última actualización (UTC)**: 2026-05-12 02:23 UTC

**Mezcla de protocolos:** shadowsocks × 54 · trojan × 2 · vless × 84 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 7 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
