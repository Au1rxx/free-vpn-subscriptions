...
![nodos](https://img.shields.io/badge/nodos-108-brightgreen) ![activos](https://img.shields.io/badge/activos-1860-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-308ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-07_04:38_UTC-informational)
...
- **RTT mediana**: 308 ms
- **Última actualización (UTC)**: 2026-07-07 04:38 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 22 · vless × 21 · vmess × 21

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 7 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 9 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
