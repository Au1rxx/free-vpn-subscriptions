...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2251-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-446ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-20_20:36_UTC-informational)
...
- **RTT mediana**: 446 ms
- **Última actualización (UTC)**: 2026-04-20 20:36 UTC

**Mezcla de protocolos:** shadowsocks × 27 · trojan × 9 · vless × 101 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 64 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 41 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 4
