...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2266-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-386ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-18_02:16_UTC-informational)
...
- **RTT mediana**: 386 ms
- **Última actualización (UTC)**: 2026-07-18 02:16 UTC

**Mezcla de protocolos:** shadowsocks × 41 · trojan × 77 · vless × 18 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `epodonios` × 8 · `mahdi0024` × 60 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 6 · `snakem982` × 5 · `surfboard-eternity` × 5
