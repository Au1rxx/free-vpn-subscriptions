...
![nodos](https://img.shields.io/badge/nodos-104-brightgreen) ![activos](https://img.shields.io/badge/activos-1932-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-420ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-12_16:29_UTC-informational)
...
- **RTT mediana**: 420 ms
- **Última actualización (UTC)**: 2026-06-12 16:29 UTC

**Mezcla de protocolos:** hysteria2 × 2 · shadowsocks × 45 · trojan × 37 · vless × 12 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 6
