...
![nodos](https://img.shields.io/badge/nodos-114-brightgreen) ![activos](https://img.shields.io/badge/activos-1879-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-357ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-05_21:32_UTC-informational)
...
- **RTT mediana**: 357 ms
- **Última actualización (UTC)**: 2026-07-05 21:32 UTC

**Mezcla de protocolos:** shadowsocks × 47 · trojan × 24 · vless × 13 · vmess × 30

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 9 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 2
