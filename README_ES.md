...
![nodos](https://img.shields.io/badge/nodos-114-brightgreen) ![activos](https://img.shields.io/badge/activos-1849-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-354ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-15_07:11_UTC-informational)
...
- **RTT mediana**: 354 ms
- **Última actualización (UTC)**: 2026-06-15 07:11 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 23 · vless × 18 · vmess × 19

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 19 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 4
