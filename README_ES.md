...
![nodos](https://img.shields.io/badge/nodos-112-brightgreen) ![activos](https://img.shields.io/badge/activos-1973-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-339ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-05_14:12_UTC-informational)
...
- **RTT mediana**: 339 ms
- **Última actualización (UTC)**: 2026-07-05 14:12 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 25 · vless × 13 · vmess × 31

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 10 · `ninjastrikers` × 14 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
