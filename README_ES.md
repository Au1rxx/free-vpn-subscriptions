...
![nodos](https://img.shields.io/badge/nodos-145-brightgreen) ![activos](https://img.shields.io/badge/activos-1944-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-461ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-17_11:25_UTC-informational)
...
- **RTT mediana**: 461 ms
- **Última actualización (UTC)**: 2026-06-17 11:25 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 24 · vless × 14 · vmess × 69

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `mahdi0024` × 71 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
