...
![nodos](https://img.shields.io/badge/nodos-114-brightgreen) ![activos](https://img.shields.io/badge/activos-2120-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-364ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-24_19:28_UTC-informational)
...
- **RTT mediana**: 364 ms
- **Última actualización (UTC)**: 2026-06-24 19:28 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 30 · trojan × 32 · vless × 34 · vmess × 17

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 7 · `epodonios` × 37 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 6 · `ruking-clash` × 15 · `surfboard-eternity` × 2
