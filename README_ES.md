...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2471-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-108ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-27_14:17_UTC-informational)
...
- **RTT mediana**: 108 ms
- **Última actualización (UTC)**: 2026-04-27 14:17 UTC

**Mezcla de protocolos:** shadowsocks × 27 · trojan × 15 · vless × 98 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 32 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
