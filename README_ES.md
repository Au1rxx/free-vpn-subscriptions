...
![nodos](https://img.shields.io/badge/nodos-139-brightgreen) ![activos](https://img.shields.io/badge/activos-2090-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-281ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-03_16:30_UTC-informational)
...
- **RTT mediana**: 281 ms
- **Última actualización (UTC)**: 2026-05-03 16:30 UTC

**Mezcla de protocolos:** shadowsocks × 28 · trojan × 23 · vless × 78 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 30 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
