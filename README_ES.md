...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-389-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-140ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-19_06:10_UTC-informational)
...
- **RTT mediana**: 140 ms
- **Última actualización (UTC)**: 2026-04-19 06:10 UTC

**Mezcla de protocolos:** shadowsocks × 101 · trojan × 7 · vmess × 42

**Fuentes usadas en esta ejecución:** `freefq` × 2 · `mahdibland-aggregator` × 65 · `mahdibland-shadowsocks` × 68 · `vxiaov-clash` × 15
