...
![nodos](https://img.shields.io/badge/nodos-79-brightgreen) ![activos](https://img.shields.io/badge/activos-2000-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-344ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-29_19:33_UTC-informational)
...
- **RTT mediana**: 344 ms
- **Última actualización (UTC)**: 2026-06-29 19:33 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 34 · trojan × 31 · vless × 5 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 3
