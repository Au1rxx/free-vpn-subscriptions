...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2115-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-132ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-29_12:39_UTC-informational)
...
- **RTT mediana**: 132 ms
- **Última actualización (UTC)**: 2026-04-29 12:39 UTC

**Mezcla de protocolos:** shadowsocks × 41 · trojan × 10 · vless × 89 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 31 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 60 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
