...
![nodos](https://img.shields.io/badge/nodos-115-brightgreen) ![activos](https://img.shields.io/badge/activos-1967-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-349ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-04_15:23_UTC-informational)
...
- **RTT mediana**: 349 ms
- **Última actualización (UTC)**: 2026-07-04 15:23 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 22 · vless × 15 · vmess × 26

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 36 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 6 · `ninjastrikers` × 13 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 1
