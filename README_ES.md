...
![nodos](https://img.shields.io/badge/nodos-104-brightgreen) ![activos](https://img.shields.io/badge/activos-1927-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-411ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-25_19:35_UTC-informational)
...
- **RTT mediana**: 411 ms
- **Última actualización (UTC)**: 2026-06-25 19:35 UTC

**Mezcla de protocolos:** shadowsocks × 35 · trojan × 38 · vless × 18 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `epodonios` × 20 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 20 · `surfboard-eternity` × 6
