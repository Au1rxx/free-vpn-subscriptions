...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2258-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-179ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-22_11:11_UTC-informational)
...
- **RTT mediana**: 179 ms
- **Última actualización (UTC)**: 2026-04-22 11:11 UTC

**Mezcla de protocolos:** shadowsocks × 28 · trojan × 10 · vless × 99 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 48 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 59 · `pawdroid` × 2 · `ruking-clash` × 4 · `surfboard-eternity` × 7
