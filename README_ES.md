...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2378-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-107ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-12_22:17_UTC-informational)
...
- **RTT mediana**: 107 ms
- **Última actualización (UTC)**: 2026-05-12 22:17 UTC

**Mezcla de protocolos:** shadowsocks × 34 · trojan × 16 · vless × 87 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 40 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 47 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
