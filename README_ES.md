...
![nodos](https://img.shields.io/badge/nodos-79-brightgreen) ![activos](https://img.shields.io/badge/activos-2238-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-417ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-29_09:11_UTC-informational)
...
- **RTT mediana**: 417 ms
- **Última actualización (UTC)**: 2026-06-29 09:11 UTC

**Mezcla de protocolos:** shadowsocks × 18 · trojan × 27 · vless × 19 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 2
