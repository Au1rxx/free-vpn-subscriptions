...
![nodos](https://img.shields.io/badge/nodos-86-brightgreen) ![activos](https://img.shields.io/badge/activos-2242-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-155ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-29_03:29_UTC-informational)
...
- **RTT mediana**: 155 ms
- **Última actualización (UTC)**: 2026-06-29 03:29 UTC

**Mezcla de protocolos:** shadowsocks × 17 · trojan × 28 · vless × 27 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 7 · `epodonios` × 19 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 8 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 1
