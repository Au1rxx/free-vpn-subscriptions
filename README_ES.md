...
![nodos](https://img.shields.io/badge/nodos-120-brightgreen) ![activos](https://img.shields.io/badge/activos-1979-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-277ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-25_03:27_UTC-informational)
...
- **RTT mediana**: 277 ms
- **Última actualización (UTC)**: 2026-06-25 03:27 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 26 · trojan × 33 · vless × 47 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `epodonios` × 38 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 4
