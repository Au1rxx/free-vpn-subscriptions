...
![nodos](https://img.shields.io/badge/nodos-120-brightgreen) ![activos](https://img.shields.io/badge/activos-1812-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-366ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-08_09:35_UTC-informational)
...
- **RTT mediana**: 366 ms
- **Última actualización (UTC)**: 2026-07-08 09:35 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 68 · trojan × 25 · vless × 12 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 18 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 18 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 19 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 4
