...
![nodos](https://img.shields.io/badge/nodos-81-brightgreen) ![activos](https://img.shields.io/badge/activos-2018-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-161ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-04_06:09_UTC-informational)
...
- **RTT mediana**: 161 ms
- **Última actualización (UTC)**: 2026-07-04 06:09 UTC

**Mezcla de protocolos:** shadowsocks × 26 · trojan × 22 · vless × 12 · vmess × 21

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
