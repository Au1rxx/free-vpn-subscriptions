...
![nodos](https://img.shields.io/badge/nodos-131-brightgreen) ![activos](https://img.shields.io/badge/activos-2100-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-474ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-20_20:31_UTC-informational)
...
- **RTT mediana**: 474 ms
- **Última actualización (UTC)**: 2026-06-20 20:31 UTC

**Mezcla de protocolos:** shadowsocks × 41 · trojan × 34 · vless × 32 · vmess × 24

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 38 · `surfboard-eternity` × 3
