...
![nodos](https://img.shields.io/badge/nodos-69-brightgreen) ![activos](https://img.shields.io/badge/activos-2052-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-234ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-28_16:38_UTC-informational)
...
- **RTT mediana**: 234 ms
- **Última actualización (UTC)**: 2026-05-28 16:38 UTC

**Mezcla de protocolos:** hysteria2 × 3 · shadowsocks × 30 · trojan × 14 · vless × 12 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 5 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 3
