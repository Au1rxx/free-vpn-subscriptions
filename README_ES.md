...
![nodos](https://img.shields.io/badge/nodos-77-brightgreen) ![activos](https://img.shields.io/badge/activos-2422-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-331ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-11_20:38_UTC-informational)
...
- **RTT mediana**: 331 ms
- **Última actualización (UTC)**: 2026-06-11 20:38 UTC

**Mezcla de protocolos:** shadowsocks × 44 · trojan × 17 · vless × 12 · vmess × 4

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 4 · `surfboard-eternity` × 5
