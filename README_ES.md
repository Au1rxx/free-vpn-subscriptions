...
![nodos](https://img.shields.io/badge/nodos-138-brightgreen) ![activos](https://img.shields.io/badge/activos-1611-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-420ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-14_18:13_UTC-informational)
...
- **RTT mediana**: 420 ms
- **Última actualización (UTC)**: 2026-06-14 18:13 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 72 · trojan × 31 · vless × 23 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 4
