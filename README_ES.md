...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1896-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-418ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-17_05:32_UTC-informational)
...
- **RTT mediana**: 418 ms
- **Última actualización (UTC)**: 2026-06-17 05:32 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 13 · vless × 20 · vmess × 72

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 74 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 18 · `ruking-clash` × 3 · `surfboard-eternity` × 3
