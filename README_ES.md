...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2191-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-123ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-21_08:12_UTC-informational)
...
- **RTT mediana**: 123 ms
- **Última actualización (UTC)**: 2026-04-21 08:12 UTC

**Mezcla de protocolos:** shadowsocks × 29 · trojan × 3 · vless × 103 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 50 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 55 · `pawdroid` × 2 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
