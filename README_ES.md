...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2265-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-448ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-20_23:39_UTC-informational)
...
- **RTT mediana**: 448 ms
- **Última actualización (UTC)**: 2026-04-20 23:39 UTC

**Mezcla de protocolos:** shadowsocks × 23 · trojan × 18 · vless × 96 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 55 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 49 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 6
