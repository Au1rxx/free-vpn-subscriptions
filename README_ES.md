...
![nodos](https://img.shields.io/badge/nodos-106-brightgreen) ![activos](https://img.shields.io/badge/activos-2224-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-161ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-07_01:38_UTC-informational)
...
- **RTT mediana**: 161 ms
- **Última actualización (UTC)**: 2026-06-07 01:38 UTC

**Mezcla de protocolos:** shadowsocks × 30 · trojan × 23 · vless × 29 · vmess × 24

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 39 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 32 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 2
