...
![nodos](https://img.shields.io/badge/nodos-125-brightgreen) ![activos](https://img.shields.io/badge/activos-1997-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-354ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-28_06:16_UTC-informational)
...
- **RTT mediana**: 354 ms
- **Última actualización (UTC)**: 2026-06-28 06:16 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 40 · vless × 37 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 29 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 3
