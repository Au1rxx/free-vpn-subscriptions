...
![nodos](https://img.shields.io/badge/nodos-98-brightgreen) ![activos](https://img.shields.io/badge/activos-1896-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-298ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-06_14:34_UTC-informational)
...
- **RTT mediana**: 298 ms
- **Última actualización (UTC)**: 2026-07-06 14:34 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 26 · vless × 6 · vmess × 29

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 3
