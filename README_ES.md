...
![nodos](https://img.shields.io/badge/nodos-133-brightgreen) ![activos](https://img.shields.io/badge/activos-1635-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-480ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-14_20:27_UTC-informational)
...
- **RTT mediana**: 480 ms
- **Última actualización (UTC)**: 2026-06-14 20:27 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 61 · trojan × 32 · vless × 26 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 17 · `surfboard-eternity` × 4
