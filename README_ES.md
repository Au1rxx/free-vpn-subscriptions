...
![nodos](https://img.shields.io/badge/nodos-114-brightgreen) ![activos](https://img.shields.io/badge/activos-1914-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-347ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-04_20:11_UTC-informational)
...
- **RTT mediana**: 347 ms
- **Última actualización (UTC)**: 2026-07-04 20:11 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 21 · vless × 10 · vmess × 27

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 6 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 2
