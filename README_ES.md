...
![nodos](https://img.shields.io/badge/nodos-84-brightgreen) ![activos](https://img.shields.io/badge/activos-2314-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-276ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-19_17:09_UTC-informational)
...
- **RTT mediana**: 276 ms
- **Última actualización (UTC)**: 2026-06-19 17:09 UTC

**Mezcla de protocolos:** shadowsocks × 23 · trojan × 23 · vless × 10 · vmess × 28

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 7 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 4 · `ruking-clash` × 18 · `surfboard-eternity` × 7
