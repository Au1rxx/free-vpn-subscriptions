...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2513-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-96ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-27_11:31_UTC-informational)
...
- **RTT mediana**: 96 ms
- **Última actualización (UTC)**: 2026-04-27 11:31 UTC

**Mezcla de protocolos:** shadowsocks × 37 · trojan × 5 · vless × 96 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 17 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 49 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 57 · `pawdroid` × 1 · `surfboard-eternity` × 5
