...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2514-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-98ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-27_10:27_UTC-informational)
...
- **RTT mediana**: 98 ms
- **Última actualización (UTC)**: 2026-04-27 10:27 UTC

**Mezcla de protocolos:** shadowsocks × 37 · trojan × 7 · vless × 94 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 18 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 44 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 59 · `pawdroid` × 1 · `surfboard-eternity` × 3
