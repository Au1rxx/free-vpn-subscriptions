...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2585-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-79ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-28_09:17_UTC-informational)
...
- **RTT mediana**: 79 ms
- **Última actualización (UTC)**: 2026-04-28 09:17 UTC

**Mezcla de protocolos:** shadowsocks × 22 · trojan × 14 · vless × 104 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 22 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
