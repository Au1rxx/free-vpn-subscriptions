...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1832-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-470ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-22_16:37_UTC-informational)
...
- **RTT mediana**: 470 ms
- **Última actualización (UTC)**: 2026-06-22 16:37 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 26 · vless × 68 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 4
