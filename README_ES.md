...
![nodos](https://img.shields.io/badge/nodos-96-brightgreen) ![activos](https://img.shields.io/badge/activos-1969-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-361ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-27_22:28_UTC-informational)
...
- **RTT mediana**: 361 ms
- **Última actualización (UTC)**: 2026-06-27 22:28 UTC

**Mezcla de protocolos:** shadowsocks × 28 · trojan × 39 · vless × 17 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 14 · `ruking-clash` × 14 · `surfboard-eternity` × 5
