...
![nodos](https://img.shields.io/badge/nodos-102-brightgreen) ![activos](https://img.shields.io/badge/activos-1960-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-283ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-05_18:36_UTC-informational)
...
- **RTT mediana**: 283 ms
- **Última actualización (UTC)**: 2026-07-05 18:36 UTC

**Mezcla de protocolos:** shadowsocks × 41 · trojan × 24 · vless × 8 · vmess × 29

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `mahdi0024` × 27 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 6 · `ninjastrikers` × 10 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 5
