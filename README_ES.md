...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2179-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-238ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-22_12:25_UTC-informational)
...
- **RTT mediana**: 238 ms
- **Última actualización (UTC)**: 2026-04-22 12:25 UTC

**Mezcla de protocolos:** shadowsocks × 35 · trojan × 21 · vless × 81 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 71 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 7
