...
![nodos](https://img.shields.io/badge/nodos-127-brightgreen) ![activos](https://img.shields.io/badge/activos-1982-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-218ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-13_04:18_UTC-informational)
...
- **RTT mediana**: 218 ms
- **Última actualización (UTC)**: 2026-07-13 04:18 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 62 · trojan × 18 · vless × 31 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `mahdi0024` × 31 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `ninjastrikers` × 23 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 1
