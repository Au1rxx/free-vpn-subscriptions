...
![nodos](https://img.shields.io/badge/nodos-114-brightgreen) ![activos](https://img.shields.io/badge/activos-2047-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-337ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-02_04:37_UTC-informational)
...
- **RTT mediana**: 337 ms
- **Última actualización (UTC)**: 2026-07-02 04:37 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 38 · vless × 23 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 25 · `pawdroid` × 7 · `surfboard-eternity` × 5
