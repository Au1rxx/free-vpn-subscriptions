...
![nodos](https://img.shields.io/badge/nodos-86-brightgreen) ![activos](https://img.shields.io/badge/activos-1885-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-359ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-07_20:19_UTC-informational)
...
- **RTT mediana**: 359 ms
- **Última actualización (UTC)**: 2026-06-07 20:19 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 46 · trojan × 19 · vless × 13 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
