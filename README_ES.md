...
![nodos](https://img.shields.io/badge/nodos-98-brightgreen) ![activos](https://img.shields.io/badge/activos-2240-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-472ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-12_11:15_UTC-informational)
...
- **RTT mediana**: 472 ms
- **Última actualización (UTC)**: 2026-06-12 11:15 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 38 · vless × 11 · vmess × 5

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 30 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `ruking-clash` × 5 · `surfboard-eternity` × 4
