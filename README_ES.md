...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2385-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-132ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-12_20:26_UTC-informational)
...
- **RTT mediana**: 132 ms
- **Última actualización (UTC)**: 2026-05-12 20:26 UTC

**Mezcla de protocolos:** shadowsocks × 38 · trojan × 20 · vless × 80 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
