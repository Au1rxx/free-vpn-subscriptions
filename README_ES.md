...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2235-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-207ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-30_18:39_UTC-informational)
...
- **RTT mediana**: 207 ms
- **Última actualización (UTC)**: 2026-04-30 18:39 UTC

**Mezcla de protocolos:** shadowsocks × 30 · trojan × 25 · vless × 73 · vmess × 22

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 32 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `snakem982` × 3 · `surfboard-eternity` × 5
