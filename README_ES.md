...
![nodos](https://img.shields.io/badge/nodos-129-brightgreen) ![activos](https://img.shields.io/badge/activos-1922-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-330ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-06_02:17_UTC-informational)
...
- **RTT mediana**: 330 ms
- **Última actualización (UTC)**: 2026-07-06 02:17 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 27 · vless × 21 · vmess × 30

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 11 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
