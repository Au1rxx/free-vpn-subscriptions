...
![nodos](https://img.shields.io/badge/nodos-109-brightgreen) ![activos](https://img.shields.io/badge/activos-2059-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-340ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-02_03:27_UTC-informational)
...
- **RTT mediana**: 340 ms
- **Última actualización (UTC)**: 2026-07-02 03:27 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 37 · vless × 18 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 25 · `pawdroid` × 2 · `surfboard-eternity` × 1
