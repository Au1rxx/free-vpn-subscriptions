...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2574-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-130ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-26_18:37_UTC-informational)
...
- **RTT mediana**: 130 ms
- **Última actualización (UTC)**: 2026-04-26 18:37 UTC

**Mezcla de protocolos:** shadowsocks × 39 · trojan × 13 · vless × 85 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 18 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 50 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
