...
![nodos](https://img.shields.io/badge/nodos-130-brightgreen) ![activos](https://img.shields.io/badge/activos-2005-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-469ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-23_21:23_UTC-informational)
...
- **RTT mediana**: 469 ms
- **Última actualización (UTC)**: 2026-06-23 21:23 UTC

**Mezcla de protocolos:** hysteria2 × 2 · shadowsocks × 38 · trojan × 30 · vless × 45 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `epodonios` × 45 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
