...
![nodos](https://img.shields.io/badge/nodos-86-brightgreen) ![activos](https://img.shields.io/badge/activos-1822-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-390ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-30_20:35_UTC-informational)
...
- **RTT mediana**: 390 ms
- **Última actualización (UTC)**: 2026-06-30 20:35 UTC

**Mezcla de protocolos:** shadowsocks × 38 · trojan × 31 · vless × 10 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 5
