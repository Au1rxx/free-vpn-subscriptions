...
![nodos](https://img.shields.io/badge/nodos-112-brightgreen) ![activos](https://img.shields.io/badge/activos-1871-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-363ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-06_13:40_UTC-informational)
...
- **RTT mediana**: 363 ms
- **Última actualización (UTC)**: 2026-07-06 13:40 UTC

**Mezcla de protocolos:** hysteria2 × 3 · shadowsocks × 42 · trojan × 25 · vless × 13 · vmess × 29

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 6 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 2
