...
![nodos](https://img.shields.io/badge/nodos-105-brightgreen) ![activos](https://img.shields.io/badge/activos-2005-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-441ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-28_12:39_UTC-informational)
...
- **RTT mediana**: 441 ms
- **Última actualización (UTC)**: 2026-06-28 12:39 UTC

**Mezcla de protocolos:** shadowsocks × 33 · trojan × 34 · vless × 25 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 31 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 13 · `surfboard-eternity` × 5
