...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1919-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-130ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-12_10:21_UTC-informational)
...
- **RTT mediana**: 130 ms
- **Última actualización (UTC)**: 2026-05-12 10:21 UTC

**Mezcla de protocolos:** shadowsocks × 53 · trojan × 4 · vless × 83 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
