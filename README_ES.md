...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2196-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-149ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-21_09:19_UTC-informational)
...
- **RTT mediana**: 149 ms
- **Última actualización (UTC)**: 2026-04-21 09:19 UTC

**Mezcla de protocolos:** shadowsocks × 29 · trojan × 2 · vless × 105 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 53 · `epodonios` × 3 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 56 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
