...
![nodos](https://img.shields.io/badge/nodos-120-brightgreen) ![activos](https://img.shields.io/badge/activos-2018-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-319ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-25_10:38_UTC-informational)
...
- **RTT mediana**: 319 ms
- **Última actualización (UTC)**: 2026-06-25 10:38 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 29 · vless × 36 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `epodonios` × 31 · `lagzian-mix` × 3 · `mahdi0024` × 20 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 6
