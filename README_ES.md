...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2567-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-142ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-26_19:38_UTC-informational)
...
- **RTT mediana**: 142 ms
- **Última actualización (UTC)**: 2026-04-26 19:38 UTC

**Mezcla de protocolos:** shadowsocks × 38 · trojan × 18 · vless × 80 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 43 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 4 · `ninjastrikers` × 53 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
