...
![nodos](https://img.shields.io/badge/nodos-103-brightgreen) ![activos](https://img.shields.io/badge/activos-2241-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-477ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-12_13:14_UTC-informational)
...
- **RTT mediana**: 477 ms
- **Última actualización (UTC)**: 2026-06-12 13:14 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 46 · trojan × 37 · vless × 15 · vmess × 4

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 29 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 5
