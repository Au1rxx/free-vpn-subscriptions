...
![nodos](https://img.shields.io/badge/nodos-87-brightgreen) ![activos](https://img.shields.io/badge/activos-2080-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-356ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-01_22:27_UTC-informational)
...
- **RTT mediana**: 356 ms
- **Última actualización (UTC)**: 2026-07-01 22:27 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 23 · vless × 9 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 1 · `surfboard-eternity` × 2
