...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2542-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-85ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-27_06:09_UTC-informational)
...
- **RTT mediana**: 85 ms
- **Última actualización (UTC)**: 2026-04-27 06:09 UTC

**Mezcla de protocolos:** shadowsocks × 33 · trojan × 6 · vless × 97 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 25 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 48 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 51 · `surfboard-eternity` × 4
