...
![nodos](https://img.shields.io/badge/nodos-80-brightgreen) ![activos](https://img.shields.io/badge/activos-1998-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-169ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-03_17:24_UTC-informational)
...
- **RTT mediana**: 169 ms
- **Última actualización (UTC)**: 2026-07-03 17:24 UTC

**Mezcla de protocolos:** shadowsocks × 22 · trojan × 23 · vless × 16 · vmess × 19

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 10 · `ninjastrikers` × 12 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 3
