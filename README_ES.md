...
![nodos](https://img.shields.io/badge/nodos-96-brightgreen) ![activos](https://img.shields.io/badge/activos-1844-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-374ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-30_08:38_UTC-informational)
...
- **RTT mediana**: 374 ms
- **Última actualización (UTC)**: 2026-06-30 08:38 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 41 · vless × 10 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 12
