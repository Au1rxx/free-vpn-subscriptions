...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2251-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-441ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-21_22:29_UTC-informational)
...
- **RTT mediana**: 441 ms
- **Última actualización (UTC)**: 2026-04-21 22:29 UTC

**Mezcla de protocolos:** shadowsocks × 33 · trojan × 22 · vless × 84 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 47 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 5
