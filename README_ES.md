...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1857-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-471ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-22_15:32_UTC-informational)
...
- **RTT mediana**: 471 ms
- **Última actualización (UTC)**: 2026-06-22 15:32 UTC

**Mezcla de protocolos:** shadowsocks × 40 · trojan × 31 · vless × 66 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 14 · `epodonios` × 41 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 2 · `surfboard-eternity` × 3
