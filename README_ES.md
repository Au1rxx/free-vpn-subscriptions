...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1789-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-591ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-17_09:35_UTC-informational)
...
- **RTT mediana**: 591 ms
- **Última actualización (UTC)**: 2026-06-17 09:35 UTC

**Mezcla de protocolos:** hysteria2 × 5 · shadowsocks × 40 · trojan × 27 · vless × 19 · vmess × 59

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 61 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 3
