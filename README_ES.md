...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2244-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-142ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-22_05:30_UTC-informational)
...
- **RTT mediana**: 142 ms
- **Última actualización (UTC)**: 2026-04-22 05:30 UTC

**Mezcla de protocolos:** shadowsocks × 37 · trojan × 2 · vless × 98 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 40 · `epodonios` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 62 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 9
