...
![nodos](https://img.shields.io/badge/nodos-139-brightgreen) ![activos](https://img.shields.io/badge/activos-1902-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-426ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-22_08:39_UTC-informational)
...
- **RTT mediana**: 426 ms
- **Última actualización (UTC)**: 2026-06-22 08:39 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 26 · vless × 54 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 4 · `surfboard-eternity` × 4
