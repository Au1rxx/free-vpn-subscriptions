...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1966-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-180ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-07_13:21_UTC-informational)
...
- **RTT mediana**: 180 ms
- **Última actualización (UTC)**: 2026-05-07 13:21 UTC

**Mezcla de protocolos:** shadowsocks × 53 · trojan × 6 · vless × 81 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 64 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
