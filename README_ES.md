...
![nodos](https://img.shields.io/badge/nodos-112-brightgreen) ![activos](https://img.shields.io/badge/activos-1854-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-329ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-15_05:18_UTC-informational)
...
- **RTT mediana**: 329 ms
- **Última actualización (UTC)**: 2026-06-15 05:18 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 22 · vless × 29 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 28 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 4
