...
![nodos](https://img.shields.io/badge/nodos-87-brightgreen) ![activos](https://img.shields.io/badge/activos-2344-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-90ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-02_23:16_UTC-informational)
...
- **RTT mediana**: 90 ms
- **Última actualización (UTC)**: 2026-06-02 23:16 UTC

**Mezcla de protocolos:** shadowsocks × 22 · trojan × 29 · vless × 6 · vmess × 30

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 19 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `snakem982` × 1 · `surfboard-eternity` × 2
