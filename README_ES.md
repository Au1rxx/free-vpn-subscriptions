...
![nodos](https://img.shields.io/badge/nodos-78-brightgreen) ![activos](https://img.shields.io/badge/activos-2128-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-270ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-09_15:19_UTC-informational)
...
- **RTT mediana**: 270 ms
- **Última actualización (UTC)**: 2026-06-09 15:19 UTC

**Mezcla de protocolos:** shadowsocks × 32 · trojan × 15 · vless × 8 · vmess × 23

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 6
