...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2253-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-246ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-20_17:20_UTC-informational)
...
- **RTT mediana**: 246 ms
- **Última actualización (UTC)**: 2026-04-20 17:20 UTC

**Mezcla de protocolos:** shadowsocks × 29 · trojan × 13 · vless × 96 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 51 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 7
