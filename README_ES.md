...
![nodos](https://img.shields.io/badge/nodos-88-brightgreen) ![activos](https://img.shields.io/badge/activos-2045-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-344ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-01_20:36_UTC-informational)
...
- **RTT mediana**: 344 ms
- **Última actualización (UTC)**: 2026-07-01 20:36 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 22 · vless × 11 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 5 · `ninjastrikers` × 17 · `surfboard-eternity` × 4
