...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2229-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-144ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-22_01:38_UTC-informational)
...
- **RTT mediana**: 144 ms
- **Última actualización (UTC)**: 2026-04-22 01:38 UTC

**Mezcla de protocolos:** shadowsocks × 34 · trojan × 5 · vless × 97 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 29 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 71 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 5
