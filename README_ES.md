...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2610-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-132ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-23_05:28_UTC-informational)
...
- **RTT mediana**: 132 ms
- **Última actualización (UTC)**: 2026-04-23 05:28 UTC

**Mezcla de protocolos:** shadowsocks × 28 · trojan × 17 · vless × 96 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 28 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 74 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 8
