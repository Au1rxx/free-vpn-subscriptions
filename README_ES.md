...
![nodos](https://img.shields.io/badge/nodos-113-brightgreen) ![activos](https://img.shields.io/badge/activos-2005-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-355ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-28_09:32_UTC-informational)
...
- **RTT mediana**: 355 ms
- **Última actualización (UTC)**: 2026-06-28 09:32 UTC

**Mezcla de protocolos:** shadowsocks × 33 · trojan × 39 · vless × 27 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
