...
![nodos](https://img.shields.io/badge/nodos-83-brightgreen) ![activos](https://img.shields.io/badge/activos-2366-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-97ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-02_20:22_UTC-informational)
...
- **RTT mediana**: 97 ms
- **Última actualización (UTC)**: 2026-06-02 20:22 UTC

**Mezcla de protocolos:** shadowsocks × 20 · trojan × 26 · vless × 6 · vmess × 31

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 15 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 8 · `snakem982` × 1 · `surfboard-eternity` × 6
