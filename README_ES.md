...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1998-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-363ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-23_01:22_UTC-informational)
...
- **RTT mediana**: 363 ms
- **Última actualización (UTC)**: 2026-06-23 01:22 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 28 · vless × 68 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `epodonios` × 57 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 24 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
