...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1980-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-396ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-24_00:12_UTC-informational)
...
- **RTT mediana**: 396 ms
- **Última actualización (UTC)**: 2026-06-24 00:12 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 32 · vless × 61 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 43 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 27 · `pawdroid` × 7 · `ruking-clash` × 16 · `surfboard-eternity` × 3
