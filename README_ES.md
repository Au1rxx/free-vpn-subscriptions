...
![nodos](https://img.shields.io/badge/nodos-128-brightgreen) ![activos](https://img.shields.io/badge/activos-1932-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-293ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-12_00:31_UTC-informational)
...
- **RTT mediana**: 293 ms
- **Última actualización (UTC)**: 2026-07-12 00:31 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 64 · trojan × 20 · vless × 27 · vmess × 16

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 6 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 7
