...
![nodos](https://img.shields.io/badge/nodos-103-brightgreen) ![activos](https://img.shields.io/badge/activos-1683-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-487ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-14_11:37_UTC-informational)
...
- **RTT mediana**: 487 ms
- **Última actualización (UTC)**: 2026-06-14 11:37 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 31 · vless × 15 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 2 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 6
