...
![nodos](https://img.shields.io/badge/nodos-84-brightgreen) ![activos](https://img.shields.io/badge/activos-2217-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-178ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-06_23:34_UTC-informational)
...
- **RTT mediana**: 178 ms
- **Última actualización (UTC)**: 2026-06-06 23:34 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 31 · trojan × 21 · vless × 8 · vmess × 23

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
