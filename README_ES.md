...
![nodos](https://img.shields.io/badge/nodos-91-brightgreen) ![activos](https://img.shields.io/badge/activos-2079-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-442ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-27_08:28_UTC-informational)
...
- **RTT mediana**: 442 ms
- **Última actualización (UTC)**: 2026-06-27 08:28 UTC

**Mezcla de protocolos:** shadowsocks × 17 · trojan × 36 · vless × 18 · vmess × 20

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `epodonios` × 16 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 1
