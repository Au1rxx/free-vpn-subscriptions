...
![nodos](https://img.shields.io/badge/nodos-135-brightgreen) ![activos](https://img.shields.io/badge/activos-2216-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-167ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-28_19:27_UTC-informational)
...
- **RTT mediana**: 167 ms
- **Última actualización (UTC)**: 2026-04-28 19:27 UTC

**Mezcla de protocolos:** shadowsocks × 28 · trojan × 23 · vless × 72 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 31 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
