...
![nodos](https://img.shields.io/badge/nodos-76-brightgreen) ![activos](https://img.shields.io/badge/activos-2380-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-329ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-11_17:27_UTC-informational)
...
- **RTT mediana**: 329 ms
- **Última actualización (UTC)**: 2026-06-11 17:27 UTC

**Mezcla de protocolos:** shadowsocks × 43 · trojan × 18 · vless × 10 · vmess × 5

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 17 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 2
