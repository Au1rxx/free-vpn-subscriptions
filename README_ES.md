...
![nodos](https://img.shields.io/badge/nodos-102-brightgreen) ![activos](https://img.shields.io/badge/activos-2146-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-569ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-29_13:31_UTC-informational)
...
- **RTT mediana**: 569 ms
- **Última actualización (UTC)**: 2026-06-29 13:31 UTC

**Mezcla de protocolos:** shadowsocks × 16 · trojan × 52 · vless × 20 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 31 · `epodonios` × 18 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 10
