...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2425-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-80ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-14_08:31_UTC-informational)
...
- **RTT mediana**: 80 ms
- **Última actualización (UTC)**: 2026-05-14 08:31 UTC

**Mezcla de protocolos:** shadowsocks × 44 · trojan × 1 · vless × 97 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 5
