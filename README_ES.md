...
![nodos](https://img.shields.io/badge/nodos-118-brightgreen) ![activos](https://img.shields.io/badge/activos-1956-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-300ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-13_00:25_UTC-informational)
...
- **RTT mediana**: 300 ms
- **Última actualización (UTC)**: 2026-06-13 00:25 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 24 · vless × 30 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 35 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 6
