...
![nodos](https://img.shields.io/badge/nodos-111-brightgreen) ![activos](https://img.shields.io/badge/activos-1931-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-412ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-25_18:37_UTC-informational)
...
- **RTT mediana**: 412 ms
- **Última actualización (UTC)**: 2026-06-25 18:37 UTC

**Mezcla de protocolos:** shadowsocks × 37 · trojan × 40 · vless × 21 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 23 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 20 · `surfboard-eternity` × 3
