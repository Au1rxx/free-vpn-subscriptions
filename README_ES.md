...
![nodos](https://img.shields.io/badge/nodos-87-brightgreen) ![activos](https://img.shields.io/badge/activos-2246-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-354ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-01_17:16_UTC-informational)
...
- **RTT del nodo más rápido**: 53 ms
- **RTT mediana**: 354 ms
- **Última actualización (UTC)**: 2026-07-01 17:16 UTC

**Mezcla de protocolos:** shadowsocks × 40 · trojan × 27 · vless × 13 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 18 · `pawdroid` × 5 · `surfboard-eternity` × 2
