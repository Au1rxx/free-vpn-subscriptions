...
![nodos](https://img.shields.io/badge/nodos-90-brightgreen) ![activos](https://img.shields.io/badge/activos-2196-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-553ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-29_12:38_UTC-informational)
...
- **RTT mediana**: 553 ms
- **Última actualización (UTC)**: 2026-06-29 12:38 UTC

**Mezcla de protocolos:** shadowsocks × 18 · trojan × 40 · vless × 19 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 18 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 5
