...
![nodos](https://img.shields.io/badge/nodos-120-brightgreen) ![activos](https://img.shields.io/badge/activos-1774-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-378ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-09_14:16_UTC-informational)
...
- **RTT mediana**: 378 ms
- **Última actualización (UTC)**: 2026-07-09 14:16 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 63 · trojan × 17 · vless × 14 · vmess × 25

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 15 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 17 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 4 · `ninjastrikers` × 15 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 4
