...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2064-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-165ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-29_15:11_UTC-informational)
...
- **RTT mediana**: 165 ms
- **Última actualización (UTC)**: 2026-04-29 15:11 UTC

**Mezcla de protocolos:** shadowsocks × 45 · trojan × 8 · vless × 87 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 40 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
