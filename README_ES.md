...
![nodos](https://img.shields.io/badge/nodos-82-brightgreen) ![activos](https://img.shields.io/badge/activos-2049-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-353ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-01_19:23_UTC-informational)
...
- **RTT mediana**: 353 ms
- **Última actualización (UTC)**: 2026-07-01 19:23 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 18 · vless × 12 · vmess × 6

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 3 · `surfboard-eternity` × 4
