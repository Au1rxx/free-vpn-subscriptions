...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2237-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-442ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-20_19:35_UTC-informational)
...
- **RTT mediana**: 442 ms
- **Última actualización (UTC)**: 2026-04-20 19:35 UTC

**Mezcla de protocolos:** shadowsocks × 29 · trojan × 18 · vless × 90 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 50 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 10
