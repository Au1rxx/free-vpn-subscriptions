...
![nodos](https://img.shields.io/badge/nodos-134-brightgreen) ![activos](https://img.shields.io/badge/activos-1915-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-349ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-06_03:20_UTC-informational)
...
- **RTT mediana**: 349 ms
- **Última actualización (UTC)**: 2026-07-06 03:20 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 33 · vless × 17 · vmess × 29

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 5 · `ninjastrikers` × 24 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 3
