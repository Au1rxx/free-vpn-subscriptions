...
![nodos](https://img.shields.io/badge/nodos-148-brightgreen) ![activos](https://img.shields.io/badge/activos-1959-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-322ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-06_22:39_UTC-informational)
...
- **RTT mediana**: 322 ms
- **Última actualización (UTC)**: 2026-05-06 22:39 UTC

**Mezcla de protocolos:** shadowsocks × 43 · trojan × 19 · vless × 72 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 6
