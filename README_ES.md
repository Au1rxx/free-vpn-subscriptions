...
![nodos](https://img.shields.io/badge/nodos-90-brightgreen) ![activos](https://img.shields.io/badge/activos-1947-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-280ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-26_20:34_UTC-informational)
...
- **RTT mediana**: 280 ms
- **Última actualización (UTC)**: 2026-06-26 20:34 UTC

**Mezcla de protocolos:** shadowsocks × 23 · trojan × 29 · vless × 14 · vmess × 24

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `mahdi0024` × 16 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `ruking-clash` × 17 · `surfboard-eternity` × 5
