...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2437-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-118ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-13_16:29_UTC-informational)
...
- **RTT mediana**: 118 ms
- **Última actualización (UTC)**: 2026-05-13 16:29 UTC

**Mezcla de protocolos:** shadowsocks × 41 · trojan × 18 · vless × 83 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 7 · `mahdi0024` × 31 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 5 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 5
