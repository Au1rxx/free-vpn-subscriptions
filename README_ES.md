...
![nodos](https://img.shields.io/badge/nodos-109-brightgreen) ![activos](https://img.shields.io/badge/activos-1858-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-376ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-15_22:31_UTC-informational)
...
- **RTT mediana**: 376 ms
- **Última actualización (UTC)**: 2026-06-15 22:31 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 25 · vless × 15 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `ruking-clash` × 8 · `surfboard-eternity` × 5
