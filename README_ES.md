...
![nodos](https://img.shields.io/badge/nodos-118-brightgreen) ![activos](https://img.shields.io/badge/activos-1940-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-362ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-13_07:17_UTC-informational)
...
- **RTT mediana**: 362 ms
- **Última actualización (UTC)**: 2026-07-13 07:17 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 52 · trojan × 22 · vless × 29 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 30 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 5 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 1
