...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-394-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-138ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-19_06:41_UTC-informational)
...
- **RTT mediana**: 138 ms
- **Última actualización (UTC)**: 2026-04-19 06:41 UTC

**Mezcla de protocolos:** shadowsocks × 103 · trojan × 7 · vmess × 40

**Fuentes usadas en esta ejecución:** `freefq` × 2 · `mahdibland-aggregator` × 62 · `mahdibland-shadowsocks` × 71 · `vxiaov-clash` × 15
