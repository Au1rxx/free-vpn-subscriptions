...
![nodos](https://img.shields.io/badge/nodos-138-brightgreen) ![activos](https://img.shields.io/badge/activos-2047-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-410ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-21_09:15_UTC-informational)
...
- **RTT mediana**: 410 ms
- **Última actualización (UTC)**: 2026-06-21 09:15 UTC

**Mezcla de protocolos:** shadowsocks × 44 · trojan × 29 · vless × 42 · vmess × 23

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 14 · `epodonios` × 12 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 41 · `snakem982` × 2 · `surfboard-eternity` × 4
