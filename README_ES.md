...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2274-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-275ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-20_15:11_UTC-informational)
...
- **RTT mediana**: 275 ms
- **Última actualización (UTC)**: 2026-04-20 15:11 UTC

**Mezcla de protocolos:** shadowsocks × 29 · trojan × 12 · vless × 98 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 51 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `ruking-clash` × 6 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
