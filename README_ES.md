...
![nodos](https://img.shields.io/badge/nodos-117-brightgreen) ![activos](https://img.shields.io/badge/activos-1971-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-351ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-28_04:37_UTC-informational)
...
- **RTT mediana**: 351 ms
- **Última actualización (UTC)**: 2026-06-28 04:37 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 33 · trojan × 42 · vless × 30 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 16 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `ruking-clash` × 15 · `surfboard-eternity` × 7
