...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2579-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-103ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-28_04:22_UTC-informational)
...
- **RTT mediana**: 103 ms
- **Última actualización (UTC)**: 2026-04-28 04:22 UTC

**Mezcla de protocolos:** shadowsocks × 19 · trojan × 7 · vless × 115 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 30 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 68 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
