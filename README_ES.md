...
![nodos](https://img.shields.io/badge/nodos-82-brightgreen) ![activos](https://img.shields.io/badge/activos-2147-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-173ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-28_17:16_UTC-informational)
...
- **RTT mediana**: 173 ms
- **Última actualización (UTC)**: 2026-06-28 17:16 UTC

**Mezcla de protocolos:** shadowsocks × 18 · trojan × 27 · vless × 20 · vmess × 17

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 3
