...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2506-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-92ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-27_08:14_UTC-informational)
...
- **RTT mediana**: 92 ms
- **Última actualización (UTC)**: 2026-04-27 08:14 UTC

**Mezcla de protocolos:** shadowsocks × 34 · trojan × 4 · vless × 99 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 16 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 48 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 2 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
