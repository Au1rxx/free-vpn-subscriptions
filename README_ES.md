...
![nodos](https://img.shields.io/badge/nodos-81-brightgreen) ![activos](https://img.shields.io/badge/activos-2348-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-163ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-10_05:28_UTC-informational)
...
- **RTT mediana**: 163 ms
- **Última actualización (UTC)**: 2026-06-10 05:28 UTC

**Mezcla de protocolos:** shadowsocks × 28 · trojan × 13 · vless × 18 · vmess × 22

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 5
