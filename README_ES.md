...
![nodos](https://img.shields.io/badge/nodos-107-brightgreen) ![activos](https://img.shields.io/badge/activos-1757-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-384ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-17_12:28_UTC-informational)
...
- **RTT mediana**: 384 ms
- **Última actualización (UTC)**: 2026-06-17 12:28 UTC

**Mezcla de protocolos:** hysteria2 × 4 · shadowsocks × 43 · trojan × 27 · vless × 21 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 3 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 3
