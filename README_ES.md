...
![nodos](https://img.shields.io/badge/nodos-142-brightgreen) ![activos](https://img.shields.io/badge/activos-2461-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-121ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-24_10:16_UTC-informational)
...
- **RTT mediana**: 121 ms
- **Última actualización (UTC)**: 2026-04-24 10:16 UTC

**Mezcla de protocolos:** shadowsocks × 14 · trojan × 22 · vless × 92 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 20 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 71 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
