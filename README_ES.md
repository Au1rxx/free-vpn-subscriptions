...
![nodos](https://img.shields.io/badge/nodos-113-brightgreen) ![activos](https://img.shields.io/badge/activos-1853-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-344ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-16_06:20_UTC-informational)
...
- **RTT mediana**: 344 ms
- **Última actualización (UTC)**: 2026-06-16 06:20 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 25 · vless × 29 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 27 · `pawdroid` × 3 · `ruking-clash` × 9 · `surfboard-eternity` × 3
