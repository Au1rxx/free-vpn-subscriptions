...
![nodos](https://img.shields.io/badge/nodos-82-brightgreen) ![activos](https://img.shields.io/badge/activos-2454-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-79ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-03_10:16_UTC-informational)
...
- **RTT mediana**: 79 ms
- **Última actualización (UTC)**: 2026-06-03 10:16 UTC

**Mezcla de protocolos:** shadowsocks × 13 · trojan × 36 · vless × 6 · vmess × 27

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 23 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 3 · `snakem982` × 1
