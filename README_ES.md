...
![nodos](https://img.shields.io/badge/nodos-136-brightgreen) ![activos](https://img.shields.io/badge/activos-1999-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-448ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-23_23:09_UTC-informational)
...
- **RTT mediana**: 448 ms
- **Última actualización (UTC)**: 2026-06-23 23:09 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 30 · vless × 51 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 49 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
