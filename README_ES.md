...
![nodos](https://img.shields.io/badge/nodos-92-brightgreen) ![activos](https://img.shields.io/badge/activos-2199-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-568ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-29_11:28_UTC-informational)
...
- **RTT mediana**: 568 ms
- **Última actualización (UTC)**: 2026-06-29 11:28 UTC

**Mezcla de protocolos:** shadowsocks × 16 · trojan × 40 · vless × 21 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 18 · `epodonios` × 18 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 2
