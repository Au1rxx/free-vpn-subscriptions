...
![nodos](https://img.shields.io/badge/nodos-83-brightgreen) ![activos](https://img.shields.io/badge/activos-2195-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-160ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-30_06:12_UTC-informational)
...
- **RTT mediana**: 160 ms
- **Última actualización (UTC)**: 2026-05-30 06:12 UTC

**Mezcla de protocolos:** shadowsocks × 23 · trojan × 24 · vless × 10 · vmess × 26

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 14 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
