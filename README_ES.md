...
![nodos](https://img.shields.io/badge/nodos-127-brightgreen) ![activos](https://img.shields.io/badge/activos-2270-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-331ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-12_01:26_UTC-informational)
...
- **RTT mediana**: 331 ms
- **Última actualización (UTC)**: 2026-06-12 01:26 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 46 · trojan × 43 · vless × 32 · vmess × 5

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 33 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 34 · `pawdroid` × 4 · `ruking-clash` × 6 · `surfboard-eternity` × 3
