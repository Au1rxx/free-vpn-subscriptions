...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2118-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-117ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-30_00:39_UTC-informational)
...
- **RTT mediana**: 117 ms
- **Última actualización (UTC)**: 2026-04-30 00:39 UTC

**Mezcla de protocolos:** shadowsocks × 41 · trojan × 4 · vless × 96 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 31 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 70 · `snakem982` × 1 · `surfboard-eternity` × 5
