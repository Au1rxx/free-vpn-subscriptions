...
![nodos](https://img.shields.io/badge/nodos-115-brightgreen) ![activos](https://img.shields.io/badge/activos-1983-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-373ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-12_23:25_UTC-informational)
...
- **RTT mediana**: 373 ms
- **Última actualización (UTC)**: 2026-06-12 23:25 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 44 · vless × 11 · vmess × 6

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 33 · `lagzian-mix` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 7
