...
![nodos](https://img.shields.io/badge/nodos-112-brightgreen) ![activos](https://img.shields.io/badge/activos-1869-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-343ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-05_20:31_UTC-informational)
...
- **RTT mediana**: 343 ms
- **Última actualización (UTC)**: 2026-07-05 20:31 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 48 · trojan × 24 · vless × 9 · vmess × 30

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 2
