...
![nodos](https://img.shields.io/badge/nodos-127-brightgreen) ![activos](https://img.shields.io/badge/activos-2484-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-489ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-19_11:38_UTC-informational)
...
- **RTT mediana**: 489 ms
- **Última actualización (UTC)**: 2026-06-19 11:38 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 32 · trojan × 27 · vless × 48 · vmess × 19

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 7
