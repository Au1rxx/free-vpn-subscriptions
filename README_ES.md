...
![nodos](https://img.shields.io/badge/nodos-136-brightgreen) ![activos](https://img.shields.io/badge/activos-2595-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-380ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-22_17:34_UTC-informational)
...
- **RTT mediana**: 380 ms
- **Última actualización (UTC)**: 2026-04-22 17:34 UTC

**Mezcla de protocolos:** shadowsocks × 29 · trojan × 22 · vless × 72 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 20 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 54 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
