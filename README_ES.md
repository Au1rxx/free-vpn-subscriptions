...
![nodos](https://img.shields.io/badge/nodos-85-brightgreen) ![activos](https://img.shields.io/badge/activos-2033-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-198ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-28_07:27_UTC-informational)
...
- **RTT mediana**: 198 ms
- **Última actualización (UTC)**: 2026-05-28 07:27 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 30 · trojan × 24 · vless × 19 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 5
