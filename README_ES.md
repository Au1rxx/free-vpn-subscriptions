...
![nodos](https://img.shields.io/badge/nodos-111-brightgreen) ![activos](https://img.shields.io/badge/activos-2393-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-493ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-18_20:20_UTC-informational)
...
- **RTT mediana**: 493 ms
- **Última actualización (UTC)**: 2026-06-18 20:20 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 24 · vless × 38 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 35 · `snakem982` × 7 · `surfboard-eternity` × 5
