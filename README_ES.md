...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1967-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-365ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-06_17:29_UTC-informational)
...
- **RTT mediana**: 365 ms
- **Última actualización (UTC)**: 2026-05-06 17:29 UTC

**Mezcla de protocolos:** shadowsocks × 48 · trojan × 20 · vless × 71 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 58 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
