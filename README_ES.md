...
![nodos](https://img.shields.io/badge/nodos-86-brightgreen) ![activos](https://img.shields.io/badge/activos-2542-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-100ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-02_07:11_UTC-informational)
...
- **RTT mediana**: 100 ms
- **Última actualización (UTC)**: 2026-06-02 07:11 UTC

**Mezcla de protocolos:** shadowsocks × 25 · trojan × 27 · vless × 13 · vmess × 21

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 16 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 17 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
