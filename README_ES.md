...
![nodos](https://img.shields.io/badge/nodos-137-brightgreen) ![activos](https://img.shields.io/badge/activos-1923-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-383ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-04_14:13_UTC-informational)
...
- **RTT mediana**: 383 ms
- **Última actualización (UTC)**: 2026-07-04 14:13 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 70 · trojan × 27 · vless × 11 · vmess × 28

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 41 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 5 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 8
