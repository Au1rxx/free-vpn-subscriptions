...
![nodos](https://img.shields.io/badge/nodos-105-brightgreen) ![activos](https://img.shields.io/badge/activos-1915-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-439ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-12_15:26_UTC-informational)
...
- **RTT mediana**: 439 ms
- **Última actualización (UTC)**: 2026-06-12 15:26 UTC

**Mezcla de protocolos:** hysteria2 × 2 · shadowsocks × 45 · trojan × 39 · vless × 12 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 17 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 3
