...
![nodos](https://img.shields.io/badge/nodos-145-brightgreen) ![activos](https://img.shields.io/badge/activos-1942-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-418ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-21_23:32_UTC-informational)
...
- **RTT mediana**: 418 ms
- **Última actualización (UTC)**: 2026-06-21 23:32 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 32 · vless × 52 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 5 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 34 · `snakem982` × 2 · `surfboard-eternity` × 3
