...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2163-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-115ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-21_07:10_UTC-informational)
...
- **RTT mediana**: 115 ms
- **Última actualización (UTC)**: 2026-04-21 07:10 UTC

**Mezcla de protocolos:** shadowsocks × 23 · trojan × 1 · vless × 111 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 50 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 59 · `ruking-clash` × 11 · `surfboard-eternity` × 7
