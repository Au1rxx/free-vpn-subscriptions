...
![nodos](https://img.shields.io/badge/nodos-135-brightgreen) ![activos](https://img.shields.io/badge/activos-2550-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-287ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-22_20:29_UTC-informational)
...
- **RTT mediana**: 287 ms
- **Última actualización (UTC)**: 2026-04-22 20:29 UTC

**Mezcla de protocolos:** shadowsocks × 29 · trojan × 22 · vless × 70 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 25 · `epodonios` × 11 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 50 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
