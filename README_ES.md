...
![nodos](https://img.shields.io/badge/nodos-79-brightgreen) ![activos](https://img.shields.io/badge/activos-2287-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-156ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-30_18:12_UTC-informational)
...
- **RTT mediana**: 156 ms
- **Última actualización (UTC)**: 2026-05-30 18:12 UTC

**Mezcla de protocolos:** shadowsocks × 22 · trojan × 16 · vless × 9 · vmess × 32

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 6 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
