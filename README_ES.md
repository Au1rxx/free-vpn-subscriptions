...
![nodos](https://img.shields.io/badge/nodos-75-brightgreen) ![activos](https://img.shields.io/badge/activos-1938-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-229ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-28_11:25_UTC-informational)
...
- **RTT mediana**: 229 ms
- **Última actualización (UTC)**: 2026-05-28 11:25 UTC

**Mezcla de protocolos:** shadowsocks × 32 · trojan × 17 · vless × 13 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `epodonios` × 13 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 3
