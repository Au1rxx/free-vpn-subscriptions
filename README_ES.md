...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2083-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-131ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-01_20:30_UTC-informational)
...
- **RTT mediana**: 131 ms
- **Última actualización (UTC)**: 2026-05-01 20:30 UTC

**Mezcla de protocolos:** shadowsocks × 42 · trojan × 12 · vless × 86 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 32 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 8
