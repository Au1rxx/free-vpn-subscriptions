...
![nodos](https://img.shields.io/badge/nodos-117-brightgreen) ![activos](https://img.shields.io/badge/activos-1901-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-324ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-13_04:35_UTC-informational)
...
- **RTT mediana**: 324 ms
- **Última actualización (UTC)**: 2026-06-13 04:35 UTC

**Mezcla de protocolos:** hysteria2 × 2 · shadowsocks × 51 · trojan × 30 · vless × 26 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 32 · `pawdroid` × 7 · `ruking-clash` × 9 · `surfboard-eternity` × 2
