...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2266-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-125ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-21_00:15_UTC-informational)
...
- **RTT mediana**: 125 ms
- **Última actualización (UTC)**: 2026-04-21 00:15 UTC

**Mezcla de protocolos:** shadowsocks × 22 · trojan × 4 · vless × 111 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 52 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7
