...
![nodos](https://img.shields.io/badge/nodos-140-brightgreen) ![activos](https://img.shields.io/badge/activos-2290-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-317ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-04_22:29_UTC-informational)
...
- **RTT mediana**: 317 ms
- **Última actualización (UTC)**: 2026-05-04 22:29 UTC

**Mezcla de protocolos:** shadowsocks × 35 · trojan × 25 · vless × 69 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
