...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2148-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-120ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-01_15:35_UTC-informational)
...
- **RTT mediana**: 120 ms
- **Última actualización (UTC)**: 2026-05-01 15:35 UTC

**Mezcla de protocolos:** shadowsocks × 42 · trojan × 10 · vless × 88 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
