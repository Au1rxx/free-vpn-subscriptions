...
![nodos](https://img.shields.io/badge/nodos-97-brightgreen) ![activos](https://img.shields.io/badge/activos-2165-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-137ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-06_01:30_UTC-informational)
...
- **RTT mediana**: 137 ms
- **Última actualización (UTC)**: 2026-06-06 01:30 UTC

**Mezcla de protocolos:** shadowsocks × 22 · trojan × 27 · vless × 31 · vmess × 17

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 30 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
