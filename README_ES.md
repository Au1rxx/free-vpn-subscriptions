...
![nodos](https://img.shields.io/badge/nodos-148-brightgreen) ![activos](https://img.shields.io/badge/activos-2274-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-245ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-05_13:29_UTC-informational)
...
- **RTT mediana**: 245 ms
- **Última actualización (UTC)**: 2026-05-05 13:29 UTC

**Mezcla de protocolos:** shadowsocks × 38 · trojan × 29 · vless × 70 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
