...
![nodos](https://img.shields.io/badge/nodos-131-brightgreen) ![activos](https://img.shields.io/badge/activos-2400-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-471ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-19_00:32_UTC-informational)
...
- **RTT mediana**: 471 ms
- **Última actualización (UTC)**: 2026-06-19 00:32 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 28 · vless × 49 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 13 · `epodonios` × 12 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 28 · `pawdroid` × 3 · `ruking-clash` × 32 · `snakem982` × 10 · `surfboard-eternity` × 3
