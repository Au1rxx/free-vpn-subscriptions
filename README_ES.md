...
![nodos](https://img.shields.io/badge/nodos-104-brightgreen) ![activos](https://img.shields.io/badge/activos-1870-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-355ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-30_04:11_UTC-informational)
...
- **RTT mediana**: 355 ms
- **Última actualización (UTC)**: 2026-06-30 04:11 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 39 · vless × 16 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 6
