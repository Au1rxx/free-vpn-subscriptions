...
![nodos](https://img.shields.io/badge/nodos-107-brightgreen) ![activos](https://img.shields.io/badge/activos-1955-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-383ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-10_19:19_UTC-informational)
...
- **RTT mediana**: 383 ms
- **Última actualización (UTC)**: 2026-06-10 19:19 UTC

**Mezcla de protocolos:** shadowsocks × 43 · trojan × 18 · vless × 11 · vmess × 35

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 34 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 6 · `surfboard-eternity` × 1
