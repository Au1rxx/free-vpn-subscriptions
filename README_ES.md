...
![nodos](https://img.shields.io/badge/nodos-96-brightgreen) ![activos](https://img.shields.io/badge/activos-1899-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-158ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-04_19:39_UTC-informational)
...
- **RTT mediana**: 158 ms
- **Última actualización (UTC)**: 2026-06-04 19:39 UTC

**Mezcla de protocolos:** shadowsocks × 20 · trojan × 47 · vless × 19 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 32 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `ruking-clash` × 4 · `surfboard-eternity` × 2
