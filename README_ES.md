...
![nodos](https://img.shields.io/badge/nodos-106-brightgreen) ![activos](https://img.shields.io/badge/activos-1965-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-488ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-18_14:22_UTC-informational)
...
- **Activos en todas las fuentes**: 1965
- **RTT del nodo más rápido**: 28 ms
- **RTT mediana**: 488 ms
- **Última actualización (UTC)**: 2026-06-18 14:22 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 29 · vmess × 6

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 25 · `snakem982` × 7 · `surfboard-eternity` × 2
