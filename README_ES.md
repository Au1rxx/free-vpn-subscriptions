...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2474-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-116ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-16_23:36_UTC-informational)
...
- **RTT mediana**: 116 ms
- **Última actualización (UTC)**: 2026-05-16 23:36 UTC

**Mezcla de protocolos:** shadowsocks × 41 · trojan × 24 · vless × 76 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 28 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 6 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
