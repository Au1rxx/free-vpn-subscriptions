...
![nodos](https://img.shields.io/badge/nodos-97-brightgreen) ![activos](https://img.shields.io/badge/activos-1932-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-331ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-14_13:18_UTC-informational)
...
- **RTT mediana**: 331 ms
- **Última actualización (UTC)**: 2026-07-14 13:18 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 15 · vless × 13 · vmess × 26

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 7 · `epodonios` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 28 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 4 · `ninjastrikers` × 10 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 3
