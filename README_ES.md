...
![nodos](https://img.shields.io/badge/nodos-89-brightgreen) ![activos](https://img.shields.io/badge/activos-2081-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-252ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-27_12:30_UTC-informational)
...
- **RTT mediana**: 252 ms
- **Última actualización (UTC)**: 2026-06-27 12:30 UTC

**Mezcla de protocolos:** shadowsocks × 18 · trojan × 33 · vless × 15 · vmess × 23

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 12 · `surfboard-eternity` × 2
