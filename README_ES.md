...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1991-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-290ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-06_14:30_UTC-informational)
...
- **RTT mediana**: 290 ms
- **Última actualización (UTC)**: 2026-05-06 14:30 UTC

**Mezcla de protocolos:** shadowsocks × 51 · trojan × 16 · vless × 72 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 3 · `ninjastrikers` × 61 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
