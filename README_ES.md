...
![nodos](https://img.shields.io/badge/nodos-118-brightgreen) ![activos](https://img.shields.io/badge/activos-1936-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-363ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-04_19:36_UTC-informational)
...
- **RTT mediana**: 363 ms
- **Última actualización (UTC)**: 2026-07-04 19:36 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 63 · trojan × 20 · vless × 8 · vmess × 26

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 38 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 6 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
