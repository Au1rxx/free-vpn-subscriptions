...
![nodos](https://img.shields.io/badge/nodos-117-brightgreen) ![activos](https://img.shields.io/badge/activos-1980-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-110ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-04_01:22_UTC-informational)
...
- **RTT mediana**: 110 ms
- **Última actualización (UTC)**: 2026-06-04 01:22 UTC

**Mezcla de protocolos:** shadowsocks × 25 · trojan × 46 · vless × 35 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 4 · `ninjastrikers` × 29 · `pawdroid` × 1 · `surfboard-eternity` × 2
