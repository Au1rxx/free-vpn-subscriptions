...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2418-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-88ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-19_21:17_UTC-informational)
...
- **RTT mediana**: 88 ms
- **Última actualización (UTC)**: 2026-05-19 21:17 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 21 · vless × 70 · vmess × 20

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 2 · `ninjastrikers` × 49 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 8
