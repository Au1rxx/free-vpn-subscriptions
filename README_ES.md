...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2394-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-139ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-12_23:20_UTC-informational)
...
- **RTT mediana**: 139 ms
- **Última actualización (UTC)**: 2026-05-12 23:20 UTC

**Mezcla de protocolos:** shadowsocks × 34 · trojan × 19 · vless × 84 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 43 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 44 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 2
