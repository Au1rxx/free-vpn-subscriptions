...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2450-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-126ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-13_17:20_UTC-informational)
...
- **RTT mediana**: 126 ms
- **Última actualización (UTC)**: 2026-05-13 17:20 UTC

**Mezcla de protocolos:** shadowsocks × 43 · trojan × 20 · vless × 78 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 5 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 6
