...
![nodos](https://img.shields.io/badge/nodos-60-brightgreen) ![activos](https://img.shields.io/badge/activos-1971-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-134ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-27_18:22_UTC-informational)
...
- **RTT mediana**: 134 ms
- **Última actualización (UTC)**: 2026-05-27 18:22 UTC

**Mezcla de protocolos:** shadowsocks × 24 · trojan × 11 · vless × 19 · vmess × 6

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 1 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 4 · `ruking-clash` × 7 · `snakem982` × 1 · `surfboard-eternity` × 3
