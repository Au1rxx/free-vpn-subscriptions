...
![nodos](https://img.shields.io/badge/nodos-105-brightgreen) ![activos](https://img.shields.io/badge/activos-1956-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-341ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-12_11:09_UTC-informational)
...
- **RTT mediana**: 341 ms
- **Última actualización (UTC)**: 2026-07-12 11:09 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 18 · vless × 14 · vmess × 19

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 4 · `mfuu-clash` × 5 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4
