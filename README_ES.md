...
![nodos](https://img.shields.io/badge/nodos-141-brightgreen) ![activos](https://img.shields.io/badge/activos-2075-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-379ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-21_10:19_UTC-informational)
...
- **RTT mediana**: 379 ms
- **Última actualización (UTC)**: 2026-06-21 10:19 UTC

**Mezcla de protocolos:** shadowsocks × 42 · trojan × 32 · vless × 44 · vmess × 23

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 9 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 34 · `snakem982` × 1 · `surfboard-eternity` × 3
