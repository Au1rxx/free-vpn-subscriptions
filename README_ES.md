...
![nodos](https://img.shields.io/badge/nodos-77-brightgreen) ![activos](https://img.shields.io/badge/activos-1989-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-163ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-04_08:22_UTC-informational)
...
- **RTT mediana**: 163 ms
- **Última actualización (UTC)**: 2026-07-04 08:22 UTC

**Mezcla de protocolos:** shadowsocks × 27 · trojan × 20 · vless × 11 · vmess × 19

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 5 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
