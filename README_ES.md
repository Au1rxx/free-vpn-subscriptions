...
![nodos](https://img.shields.io/badge/nodos-85-brightgreen) ![activos](https://img.shields.io/badge/activos-2232-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-170ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-07_09:27_UTC-informational)
...
- **RTT mediana**: 170 ms
- **Última actualización (UTC)**: 2026-06-07 09:27 UTC

**Mezcla de protocolos:** shadowsocks × 30 · trojan × 19 · vless × 12 · vmess × 24

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `mahdi0024` × 37 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 2
