...
![nodos](https://img.shields.io/badge/nodos-140-brightgreen) ![activos](https://img.shields.io/badge/activos-2214-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-284ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-05_17:15_UTC-informational)
...
- **RTT mediana**: 284 ms
- **Última actualización (UTC)**: 2026-05-05 17:15 UTC

**Mezcla de protocolos:** shadowsocks × 35 · trojan × 26 · vless × 69 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `snakem982` × 1 · `surfboard-eternity` × 9
