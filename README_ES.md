...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1935-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-142ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-07_08:11_UTC-informational)
...
- **RTT mediana**: 142 ms
- **Última actualización (UTC)**: 2026-05-07 08:11 UTC

**Mezcla de protocolos:** shadowsocks × 50 · trojan × 5 · vless × 86 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 70 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
