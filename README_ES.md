...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2084-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-112ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-02_20:18_UTC-informational)
...
- **RTT mediana**: 112 ms
- **Última actualización (UTC)**: 2026-05-02 20:18 UTC

**Mezcla de protocolos:** shadowsocks × 39 · trojan × 14 · vless × 87 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
