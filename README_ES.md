...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2038-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-168ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-29_14:33_UTC-informational)
...
- **RTT mediana**: 168 ms
- **Última actualización (UTC)**: 2026-04-29 14:33 UTC

**Mezcla de protocolos:** shadowsocks × 45 · trojan × 9 · vless × 88 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 40 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 52 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
