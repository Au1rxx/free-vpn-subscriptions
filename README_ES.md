...
![nodos](https://img.shields.io/badge/nodos-118-brightgreen) ![activos](https://img.shields.io/badge/activos-1960-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-351ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-05_09:23_UTC-informational)
...
- **RTT mediana**: 351 ms
- **Última actualización (UTC)**: 2026-07-05 09:23 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 28 · vless × 10 · vmess × 26

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 36 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `ninjastrikers` × 16 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
