...
![nodos](https://img.shields.io/badge/nodos-128-brightgreen) ![activos](https://img.shields.io/badge/activos-2609-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-384ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-22_22:13_UTC-informational)
...
- **RTT mediana**: 384 ms
- **Última actualización (UTC)**: 2026-04-22 22:13 UTC

**Mezcla de protocolos:** shadowsocks × 30 · trojan × 20 · vless × 66 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
