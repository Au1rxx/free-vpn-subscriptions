...
![nodos](https://img.shields.io/badge/nodos-72-brightgreen) ![activos](https://img.shields.io/badge/activos-1985-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-178ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-04_10:19_UTC-informational)
...
- **RTT mediana**: 178 ms
- **Última actualización (UTC)**: 2026-07-04 10:19 UTC

**Mezcla de protocolos:** shadowsocks × 27 · trojan × 20 · vless × 6 · vmess × 19

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
