...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2223-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-136ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-22_00:19_UTC-informational)
...
- **RTT mediana**: 136 ms
- **Última actualización (UTC)**: 2026-04-22 00:19 UTC

**Mezcla de protocolos:** shadowsocks × 34 · trojan × 4 · vless × 98 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 28 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 71 · `ruking-clash` × 5 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
