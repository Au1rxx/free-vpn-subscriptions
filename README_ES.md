...
![nodos](https://img.shields.io/badge/nodos-113-brightgreen) ![activos](https://img.shields.io/badge/activos-1916-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-337ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-05_22:31_UTC-informational)
...
- **RTT mediana**: 337 ms
- **Última actualización (UTC)**: 2026-07-05 22:31 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 25 · vless × 11 · vmess × 31

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 10 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 4
