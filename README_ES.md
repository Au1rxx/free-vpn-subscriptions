...
![nodos](https://img.shields.io/badge/nodos-115-brightgreen) ![activos](https://img.shields.io/badge/activos-1829-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-377ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-16_11:15_UTC-informational)
...
- **RTT mediana**: 377 ms
- **Última actualización (UTC)**: 2026-06-16 11:15 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 24 · vless × 20 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 23 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 7 · `surfboard-eternity` × 3
