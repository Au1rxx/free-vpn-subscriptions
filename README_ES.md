...
![nodos](https://img.shields.io/badge/nodos-99-brightgreen) ![activos](https://img.shields.io/badge/activos-1991-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-343ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-10_21:30_UTC-informational)
...
- **RTT mediana**: 343 ms
- **Última actualización (UTC)**: 2026-06-10 21:30 UTC

**Mezcla de protocolos:** shadowsocks × 43 · trojan × 18 · vless × 14 · vmess × 24

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
