...
![nodos](https://img.shields.io/badge/nodos-102-brightgreen) ![activos](https://img.shields.io/badge/activos-1867-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-352ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-30_02:16_UTC-informational)
...
- **RTT mediana**: 352 ms
- **Última actualización (UTC)**: 2026-06-30 02:16 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 34 · vless × 20 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 16 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 4
