...
![nodos](https://img.shields.io/badge/nodos-144-brightgreen) ![activos](https://img.shields.io/badge/activos-1926-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-481ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-22_13:37_UTC-informational)
...
- **RTT mediana**: 481 ms
- **Última actualización (UTC)**: 2026-06-22 13:37 UTC

**Mezcla de protocolos:** shadowsocks × 40 · trojan × 29 · vless × 62 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `epodonios` × 41 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 8
