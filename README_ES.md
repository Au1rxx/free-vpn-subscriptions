...
![nodos](https://img.shields.io/badge/nodos-92-brightgreen) ![activos](https://img.shields.io/badge/activos-2142-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-178ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-06_15:17_UTC-informational)
...
- **RTT mediana**: 178 ms
- **Última actualización (UTC)**: 2026-06-06 15:17 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 29 · trojan × 29 · vless × 10 · vmess × 23

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `epodonios` × 15 · `mahdi0024` × 35 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 1
