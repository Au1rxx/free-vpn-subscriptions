...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2222-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-126ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-30_08:25_UTC-informational)
...
- **RTT mediana**: 126 ms
- **Última actualización (UTC)**: 2026-04-30 08:25 UTC

**Mezcla de protocolos:** shadowsocks × 31 · trojan × 19 · vless × 92 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 30 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 71 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
