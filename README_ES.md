...
![nodos](https://img.shields.io/badge/nodos-116-brightgreen) ![activos](https://img.shields.io/badge/activos-1780-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-365ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-18_01:09_UTC-informational)
...
- **RTT mediana**: 365 ms
- **Última actualización (UTC)**: 2026-06-18 01:09 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 29 · vless × 32 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 24 · `pawdroid` × 1 · `ruking-clash` × 15 · `surfboard-eternity` × 4
