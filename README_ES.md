...
![nodos](https://img.shields.io/badge/nodos-146-brightgreen) ![activos](https://img.shields.io/badge/activos-2057-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-429ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-21_12:34_UTC-informational)
...
- **RTT mediana**: 429 ms
- **Última actualización (UTC)**: 2026-06-21 12:34 UTC

**Mezcla de protocolos:** shadowsocks × 45 · trojan × 34 · vless × 44 · vmess × 23

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `epodonios` × 21 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 37 · `surfboard-eternity` × 3
