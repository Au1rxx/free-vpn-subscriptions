...
![nodos](https://img.shields.io/badge/nodos-79-brightgreen) ![activos](https://img.shields.io/badge/activos-2334-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-179ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-10_07:12_UTC-informational)
...
- **RTT mediana**: 179 ms
- **Última actualización (UTC)**: 2026-06-10 07:12 UTC

**Mezcla de protocolos:** shadowsocks × 30 · trojan × 13 · vless × 14 · vmess × 22

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 2
