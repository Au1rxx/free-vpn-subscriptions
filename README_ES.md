...
![nodos](https://img.shields.io/badge/nodos-66-brightgreen) ![activos](https://img.shields.io/badge/activos-2194-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-361ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-05_15:36_UTC-informational)
...
- **RTT mediana**: 361 ms
- **Última actualización (UTC)**: 2026-06-05 15:36 UTC

**Mezcla de protocolos:** shadowsocks × 14 · trojan × 24 · vless × 13 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `epodonios` × 20 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 10 · `pawdroid` × 3 · `surfboard-eternity` × 2
