...
![nodos](https://img.shields.io/badge/nodos-121-brightgreen) ![activos](https://img.shields.io/badge/activos-1977-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-368ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-28_07:33_UTC-informational)
...
- **RTT mediana**: 368 ms
- **Última actualización (UTC)**: 2026-06-28 07:33 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 42 · vless × 29 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
