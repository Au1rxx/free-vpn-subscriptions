...
![nodos](https://img.shields.io/badge/nodos-85-brightgreen) ![activos](https://img.shields.io/badge/activos-2269-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-319ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-02_14:15_UTC-informational)
...
- **RTT mediana**: 319 ms
- **Última actualización (UTC)**: 2026-07-02 14:15 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 22 · vless × 17 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 11 · `ninjastrikers` × 14 · `pawdroid` × 5 · `surfboard-eternity` × 1
