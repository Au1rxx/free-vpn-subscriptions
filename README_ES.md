...
![nodos](https://img.shields.io/badge/nodos-90-brightgreen) ![activos](https://img.shields.io/badge/activos-1819-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-418ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-30_21:15_UTC-informational)
...
- **RTT mediana**: 418 ms
- **Última actualización (UTC)**: 2026-06-30 21:15 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 12 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 14 · `surfboard-eternity` × 3
