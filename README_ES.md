...
![nodos](https://img.shields.io/badge/nodos-145-brightgreen) ![activos](https://img.shields.io/badge/activos-2439-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-81ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-25_12:26_UTC-informational)
...
- **RTT mediana**: 81 ms
- **Última actualización (UTC)**: 2026-05-25 12:26 UTC

**Mezcla de protocolos:** shadowsocks × 40 · trojan × 18 · vless × 65 · vmess × 22

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 35 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 8 · `surfboard-eternity` × 7
