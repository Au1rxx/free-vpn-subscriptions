...
![nodos](https://img.shields.io/badge/nodos-70-brightgreen) ![activos](https://img.shields.io/badge/activos-2215-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-152ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-28_22:35_UTC-informational)
...
- **RTT mediana**: 152 ms
- **Última actualización (UTC)**: 2026-06-28 22:35 UTC

**Mezcla de protocolos:** shadowsocks × 17 · trojan × 19 · vless × 19 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 2 · `surfboard-eternity` × 1
