...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2455-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-78ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-18_12:37_UTC-informational)
...
- **RTT mediana**: 78 ms
- **Última actualización (UTC)**: 2026-05-18 12:37 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 8 · vless × 89 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 16 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 40 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 53 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
