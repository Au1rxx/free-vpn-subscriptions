...
![nodos](https://img.shields.io/badge/nodos-97-brightgreen) ![activos](https://img.shields.io/badge/activos-1930-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-341ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-16_18:34_UTC-informational)
...
- **RTT mediana**: 341 ms
- **Última actualización (UTC)**: 2026-06-16 18:34 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 21 · vless × 17 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 7 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 11 · `surfboard-eternity` × 4
