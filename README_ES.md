...
![nodos](https://img.shields.io/badge/nodos-71-brightgreen) ![activos](https://img.shields.io/badge/activos-1884-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-288ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-05_12:30_UTC-informational)
...
- **RTT mediana**: 288 ms
- **Última actualización (UTC)**: 2026-06-05 12:30 UTC

**Mezcla de protocolos:** shadowsocks × 26 · trojan × 23 · vless × 10 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 7 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
