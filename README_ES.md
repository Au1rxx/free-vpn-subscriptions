...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1974-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-146ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-12_05:23_UTC-informational)
...
- **RTT mediana**: 146 ms
- **Última actualización (UTC)**: 2026-05-12 05:23 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 57 · trojan × 5 · vless × 77 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 4 · `epodonios` × 3 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 12
