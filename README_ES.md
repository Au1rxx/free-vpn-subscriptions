...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1954-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-352ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-06_21:35_UTC-informational)
...
- **RTT mediana**: 352 ms
- **Última actualización (UTC)**: 2026-05-06 21:35 UTC

**Mezcla de protocolos:** shadowsocks × 48 · trojan × 19 · vless × 70 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 32 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 57 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 7
