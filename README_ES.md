...
![nodos](https://img.shields.io/badge/nodos-149-brightgreen) ![activos](https://img.shields.io/badge/activos-2331-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-447ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-21_16:34_UTC-informational)
...
- **RTT mediana**: 447 ms
- **Última actualización (UTC)**: 2026-04-21 16:34 UTC

**Mezcla de protocolos:** shadowsocks × 28 · trojan × 19 · vless × 87 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 50 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
