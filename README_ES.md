...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1923-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-222ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-22_03:14_UTC-informational)
...
- **RTT mediana**: 222 ms
- **Última actualización (UTC)**: 2026-06-22 03:14 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 10 · vless × 79 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 13 · `epodonios` × 41 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 18 · `snakem982` × 2 · `surfboard-eternity` × 3
