...
![nodos](https://img.shields.io/badge/nodos-79-brightgreen) ![activos](https://img.shields.io/badge/activos-2206-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-167ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-06_22:29_UTC-informational)
...
- **RTT mediana**: 167 ms
- **Última actualización (UTC)**: 2026-06-06 22:29 UTC

**Mezcla de protocolos:** shadowsocks × 29 · trojan × 20 · vless × 6 · vmess × 24

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 10 · `ruking-clash` × 1 · `surfboard-eternity` × 3
