...
![nodos](https://img.shields.io/badge/nodos-79-brightgreen) ![activos](https://img.shields.io/badge/activos-2109-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-568ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-28_21:21_UTC-informational)
...
- **RTT mediana**: 568 ms
- **Última actualización (UTC)**: 2026-06-28 21:21 UTC

**Mezcla de protocolos:** shadowsocks × 16 · trojan × 30 · vless × 18 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 3
