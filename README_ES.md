...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2055-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-132ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-22_04:12_UTC-informational)
...
- **RTT mediana**: 132 ms
- **Última actualización (UTC)**: 2026-05-22 04:12 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 13 · vless × 86 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 67 · `pawdroid` × 5 · `ruking-clash` × 7 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
