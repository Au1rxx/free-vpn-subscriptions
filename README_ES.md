...
![nodos](https://img.shields.io/badge/nodos-140-brightgreen) ![activos](https://img.shields.io/badge/activos-2556-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-370ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-22_15:16_UTC-informational)
...
- **RTT mediana**: 370 ms
- **Última actualización (UTC)**: 2026-04-22 15:16 UTC

**Mezcla de protocolos:** shadowsocks × 28 · trojan × 21 · vless × 77 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 29 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 58 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 9
