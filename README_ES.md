...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2366-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-144ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-12_19:16_UTC-informational)
...
- **RTT mediana**: 144 ms
- **Última actualización (UTC)**: 2026-05-12 19:16 UTC

**Mezcla de protocolos:** shadowsocks × 38 · trojan × 20 · vless × 78 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 53 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
