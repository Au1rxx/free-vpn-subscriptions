...
![nodos](https://img.shields.io/badge/nodos-105-brightgreen) ![activos](https://img.shields.io/badge/activos-1980-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-420ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-18_12:12_UTC-informational)
...
- **Activos en todas las fuentes**: 1980
- **RTT del nodo más rápido**: 29 ms
- **RTT mediana**: 420 ms
- **Última actualización (UTC)**: 2026-06-18 12:12 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 31 · vless × 31 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 9 · `pawdroid` × 6 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 6
