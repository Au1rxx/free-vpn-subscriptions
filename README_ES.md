...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2235-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-333ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-21_14:39_UTC-informational)
...
- **RTT mediana**: 333 ms
- **Última actualización (UTC)**: 2026-04-21 14:39 UTC

**Mezcla de protocolos:** shadowsocks × 34 · trojan × 13 · vless × 90 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 50 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
