...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2213-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-153ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-30_12:19_UTC-informational)
...
- **RTT mediana**: 153 ms
- **Última actualización (UTC)**: 2026-04-30 12:19 UTC

**Mezcla de protocolos:** shadowsocks × 34 · trojan × 19 · vless × 87 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 40 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
