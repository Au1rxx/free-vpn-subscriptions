...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2249-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-169ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-20_14:23_UTC-informational)
...
- **RTT mediana**: 169 ms
- **Última actualización (UTC)**: 2026-04-20 14:23 UTC

**Mezcla de protocolos:** shadowsocks × 28 · trojan × 14 · vless × 97 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 47 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `ruking-clash` × 6 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
