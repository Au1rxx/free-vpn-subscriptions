...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2426-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-83ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-19_22:16_UTC-informational)
...
- **RTT mediana**: 83 ms
- **Última actualización (UTC)**: 2026-05-19 22:16 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 9 · vless × 82 · vmess × 20

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 5 · `ruking-clash` × 16 · `snakem982` × 1 · `surfboard-eternity` × 6
