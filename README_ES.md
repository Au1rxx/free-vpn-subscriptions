...
![nodos](https://img.shields.io/badge/nodos-61-brightgreen) ![activos](https://img.shields.io/badge/activos-1927-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-105ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-27_11:26_UTC-informational)
...
- **RTT mediana**: 105 ms
- **Última actualización (UTC)**: 2026-05-27 11:26 UTC

**Mezcla de protocolos:** shadowsocks × 27 · trojan × 8 · vless × 15 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 3
