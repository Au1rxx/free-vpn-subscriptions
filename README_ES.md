...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-393-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-96ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-19_07:12_UTC-informational)
...
- **RTT mediana**: 96 ms
- **Última actualización (UTC)**: 2026-04-19 07:12 UTC

**Mezcla de protocolos:** shadowsocks × 102 · trojan × 12 · vmess × 36

**Fuentes usadas en esta ejecución:** `freefq` × 2 · `mahdibland-aggregator` × 76 · `mahdibland-shadowsocks` × 56 · `pawdroid` × 3 · `vxiaov-clash` × 13
