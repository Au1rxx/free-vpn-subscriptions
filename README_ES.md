...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2246-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-149ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-25_21:14_UTC-informational)
...
- **RTT mediana**: 149 ms
- **Última actualización (UTC)**: 2026-04-25 21:14 UTC

**Mezcla de protocolos:** shadowsocks × 36 · trojan × 13 · vless × 87 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 35 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 1 · `ninjastrikers` × 54 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 6
