...
![nodos](https://img.shields.io/badge/nodos-79-brightgreen) ![activos](https://img.shields.io/badge/activos-1868-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-156ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-03_13:37_UTC-informational)
...
- **RTT mediana**: 156 ms
- **Última actualización (UTC)**: 2026-07-03 13:37 UTC

**Mezcla de protocolos:** shadowsocks × 26 · trojan × 23 · vless × 11 · vmess × 19

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
