...
![nodos](https://img.shields.io/badge/nodos-99-brightgreen) ![activos](https://img.shields.io/badge/activos-1964-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-495ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-18_09:17_UTC-informational)
...
- **RTT mediana**: 495 ms
- **Última actualización (UTC)**: 2026-06-18 09:17 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 26 · vless × 31 · vmess × 6

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 7 · `ruking-clash` × 18 · `snakem982` × 7 · `surfboard-eternity` × 2
