...
![nodos](https://img.shields.io/badge/nodos-96-brightgreen) ![activos](https://img.shields.io/badge/activos-1956-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-484ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-18_10:19_UTC-informational)
...
- **RTT mediana**: 484 ms
- **Última actualización (UTC)**: 2026-06-18 10:19 UTC

**Mezcla de protocolos:** shadowsocks × 35 · trojan × 25 · vless × 28 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 25 · `snakem982` × 5 · `surfboard-eternity` × 4
