...
![nodos](https://img.shields.io/badge/nodos-87-brightgreen) ![activos](https://img.shields.io/badge/activos-2242-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-235ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-29_04:29_UTC-informational)
...
- **RTT mediana**: 235 ms
- **Última actualización (UTC)**: 2026-06-29 04:29 UTC

**Mezcla de protocolos:** shadowsocks × 17 · trojan × 30 · vless × 27 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 8 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 3
