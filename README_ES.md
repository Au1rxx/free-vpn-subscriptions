...
![nodos](https://img.shields.io/badge/nodos-100-brightgreen) ![activos](https://img.shields.io/badge/activos-2042-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-186ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-27_02:27_UTC-informational)
...
- **RTT mediana**: 186 ms
- **Última actualización (UTC)**: 2026-06-27 02:27 UTC

**Mezcla de protocolos:** shadowsocks × 18 · trojan × 35 · vless × 26 · vmess × 21

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 9 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 3
