...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1937-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-122ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-08_00:12_UTC-informational)
...
- **RTT mediana**: 122 ms
- **Última actualización (UTC)**: 2026-05-08 00:12 UTC

**Mezcla de protocolos:** shadowsocks × 50 · trojan × 4 · vless × 86 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 26 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 70 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
