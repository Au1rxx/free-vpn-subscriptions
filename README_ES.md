...
![nodos](https://img.shields.io/badge/nodos-125-brightgreen) ![activos](https://img.shields.io/badge/activos-1900-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-279ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-12_05:08_UTC-informational)
...
- **RTT mediana**: 279 ms
- **Última actualización (UTC)**: 2026-07-12 05:08 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 20 · vless × 28 · vmess × 21

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 27 · `matin-v2ray` × 13 · `ninjastrikers` × 23 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 1
