...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2246-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-435ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-20_21:12_UTC-informational)
...
- **RTT mediana**: 435 ms
- **Última actualización (UTC)**: 2026-04-20 21:12 UTC

**Mezcla de protocolos:** shadowsocks × 28 · trojan × 5 · vless × 103 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 60 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 44 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 4
