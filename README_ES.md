...
![nodos](https://img.shields.io/badge/nodos-81-brightgreen) ![activos](https://img.shields.io/badge/activos-2269-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-184ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-20_12:33_UTC-informational)
...
- **RTT mediana**: 184 ms
- **Última actualización (UTC)**: 2026-06-20 12:33 UTC

**Mezcla de protocolos:** shadowsocks × 23 · trojan × 22 · vless × 8 · vmess × 28

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `ruking-clash` × 15 · `surfboard-eternity` × 2
