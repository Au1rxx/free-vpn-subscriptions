...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1961-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-143ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-12_03:12_UTC-informational)
...
- **RTT mediana**: 143 ms
- **Última actualización (UTC)**: 2026-05-12 03:12 UTC

**Mezcla de protocolos:** shadowsocks × 52 · trojan × 4 · vless × 86 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 9 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 64 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 2
