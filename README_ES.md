...
![nodos](https://img.shields.io/badge/nodos-106-brightgreen) ![activos](https://img.shields.io/badge/activos-1901-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-342ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-06_23:19_UTC-informational)
...
- **RTT mediana**: 342 ms
- **Última actualización (UTC)**: 2026-07-06 23:19 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 30 · vless × 10 · vmess × 21

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 6 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
