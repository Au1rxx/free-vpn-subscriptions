...
![nodos](https://img.shields.io/badge/nodos-84-brightgreen) ![activos](https://img.shields.io/badge/activos-1932-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-231ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-06_15:30_UTC-informational)
...
- **RTT mediana**: 231 ms
- **Última actualización (UTC)**: 2026-07-06 15:30 UTC

**Mezcla de protocolos:** shadowsocks × 20 · trojan × 29 · vless × 6 · vmess × 29

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 5
