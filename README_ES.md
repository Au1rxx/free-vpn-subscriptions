...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2253-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-164ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-30_14:18_UTC-informational)
...
- **RTT mediana**: 164 ms
- **Última actualización (UTC)**: 2026-04-30 14:18 UTC

**Mezcla de protocolos:** shadowsocks × 32 · trojan × 18 · vless × 82 · vmess × 18

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 36 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 56 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
