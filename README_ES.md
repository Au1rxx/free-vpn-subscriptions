...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2469-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-154ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-27_18:37_UTC-informational)
...
- **RTT mediana**: 154 ms
- **Última actualización (UTC)**: 2026-04-27 18:37 UTC

**Mezcla de protocolos:** shadowsocks × 27 · trojan × 21 · vless × 90 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 29 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 27 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
