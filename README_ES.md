...
![nodos](https://img.shields.io/badge/nodos-104-brightgreen) ![activos](https://img.shields.io/badge/activos-1884-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-356ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-13_10:09_UTC-informational)
...
- **RTT mediana**: 356 ms
- **Última actualización (UTC)**: 2026-06-13 10:09 UTC

**Mezcla de protocolos:** shadowsocks × 58 · trojan × 23 · vless × 15 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 7 · `ruking-clash` × 12 · `surfboard-eternity` × 5
