...
![nodos](https://img.shields.io/badge/nodos-120-brightgreen) ![activos](https://img.shields.io/badge/activos-2300-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-359ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-12_04:19_UTC-informational)
...
- **RTT mediana**: 359 ms
- **Última actualización (UTC)**: 2026-06-12 04:19 UTC

**Mezcla de protocolos:** shadowsocks × 45 · trojan × 45 · vless × 25 · vmess × 5

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 28 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 3
