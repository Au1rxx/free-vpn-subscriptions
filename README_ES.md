...
![nodos](https://img.shields.io/badge/nodos-86-brightgreen) ![activos](https://img.shields.io/badge/activos-2022-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-201ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-26_21:10_UTC-informational)
...
- **RTT mediana**: 201 ms
- **Última actualización (UTC)**: 2026-06-26 21:10 UTC

**Mezcla de protocolos:** shadowsocks × 17 · trojan × 32 · vless × 17 · vmess × 20

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `ruking-clash` × 17
