...
![nodos](https://img.shields.io/badge/nodos-108-brightgreen) ![activos](https://img.shields.io/badge/activos-1664-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-502ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-14_12:19_UTC-informational)
...
- **RTT mediana**: 502 ms
- **Última actualización (UTC)**: 2026-06-14 12:19 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 36 · vless × 16 · vmess × 6

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 3 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 4
