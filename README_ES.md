...
![nodos](https://img.shields.io/badge/nodos-83-brightgreen) ![activos](https://img.shields.io/badge/activos-2264-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-245ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-10_09:13_UTC-informational)
...
- **RTT mediana**: 245 ms
- **Última actualización (UTC)**: 2026-06-10 09:13 UTC

**Mezcla de protocolos:** shadowsocks × 37 · trojan × 12 · vless × 10 · vmess × 24

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 8 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 6
