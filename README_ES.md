...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2228-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-142ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-06_01:28_UTC-informational)
...
- **RTT mediana**: 142 ms
- **Última actualización (UTC)**: 2026-05-06 01:28 UTC

**Mezcla de protocolos:** shadowsocks × 36 · trojan × 15 · vless × 89 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 27 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 79 · `pawdroid` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
