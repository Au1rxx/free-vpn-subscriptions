...
![nodos](https://img.shields.io/badge/nodos-87-brightgreen) ![activos](https://img.shields.io/badge/activos-2203-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-265ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-11_08:28_UTC-informational)
...
- **RTT mediana**: 265 ms
- **Última actualización (UTC)**: 2026-06-11 08:28 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 11 · vmess × 21

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 6
