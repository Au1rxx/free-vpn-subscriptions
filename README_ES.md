...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2552-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-72ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-16_09:33_UTC-informational)
...
- **RTT mediana**: 72 ms
- **Última actualización (UTC)**: 2026-05-16 09:33 UTC

**Mezcla de protocolos:** shadowsocks × 32 · trojan × 8 · vless × 102 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 15 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 8 · `ruking-clash` × 4 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
