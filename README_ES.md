...
![nodos](https://img.shields.io/badge/nodos-133-brightgreen) ![activos](https://img.shields.io/badge/activos-1989-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-228ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-13_02:09_UTC-informational)
...
- **RTT mediana**: 228 ms
- **Última actualización (UTC)**: 2026-07-13 02:09 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 67 · trojan × 21 · vless × 28 · vmess × 16

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `epodonios` × 5 · `mahdi0024` × 24 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 7 · `ninjastrikers` × 25 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 4 · `surfboard-eternity` × 5
