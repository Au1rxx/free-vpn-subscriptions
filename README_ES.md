...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2430-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-80ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-15_11:11_UTC-informational)
...
- **RTT mediana**: 80 ms
- **Última actualización (UTC)**: 2026-05-15 11:11 UTC

**Mezcla de protocolos:** shadowsocks × 43 · trojan × 5 · vless × 93 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 3 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 33 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `pawdroid` × 7 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
