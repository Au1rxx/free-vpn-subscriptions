...
![nodos](https://img.shields.io/badge/nodos-120-brightgreen) ![activos](https://img.shields.io/badge/activos-1938-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-281ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-06_01:19_UTC-informational)
...
- **RTT mediana**: 281 ms
- **Última actualización (UTC)**: 2026-07-06 01:19 UTC

**Mezcla de protocolos:** shadowsocks × 44 · trojan × 24 · vless × 20 · vmess × 32

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 30 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 10 · `ninjastrikers` × 20 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 5
