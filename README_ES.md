...
![nodos](https://img.shields.io/badge/nodos-121-brightgreen) ![activos](https://img.shields.io/badge/activos-2461-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-493ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-19_10:26_UTC-informational)
...
- **RTT mediana**: 493 ms
- **Última actualización (UTC)**: 2026-06-19 10:26 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 32 · trojan × 21 · vless × 52 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 20 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 42 · `snakem982` × 3 · `surfboard-eternity` × 2
