...
![nodos](https://img.shields.io/badge/nodos-124-brightgreen) ![activos](https://img.shields.io/badge/activos-2012-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-343ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-05_07:25_UTC-informational)
...
- **RTT mediana**: 343 ms
- **Última actualización (UTC)**: 2026-07-05 07:25 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 57 · trojan × 27 · vless × 11 · vmess × 28

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 4 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 2
