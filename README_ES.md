...
![nodos](https://img.shields.io/badge/nodos-99-brightgreen) ![activos](https://img.shields.io/badge/activos-1945-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-285ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-12_12:36_UTC-informational)
...
- **RTT mediana**: 285 ms
- **Última actualización (UTC)**: 2026-07-12 12:36 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 17 · vless × 12 · vmess × 20

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 1
