...
![nodos](https://img.shields.io/badge/nodos-97-brightgreen) ![activos](https://img.shields.io/badge/activos-1978-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-491ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-18_08:33_UTC-informational)
...
- **RTT mediana**: 491 ms
- **Última actualización (UTC)**: 2026-06-18 08:33 UTC

**Mezcla de protocolos:** hysteria2 × 2 · shadowsocks × 33 · trojan × 29 · vless × 27 · vmess × 6

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `snakem982` × 1 · `surfboard-eternity` × 2
