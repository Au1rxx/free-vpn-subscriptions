...
![nodos](https://img.shields.io/badge/nodos-109-brightgreen) ![activos](https://img.shields.io/badge/activos-1981-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-293ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-05_08:39_UTC-informational)
...
- **RTT mediana**: 293 ms
- **Última actualización (UTC)**: 2026-07-05 08:39 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 9 · vmess × 26

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 27 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 7
