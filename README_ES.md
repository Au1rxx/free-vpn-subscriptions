...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2444-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-76ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-18_13:29_UTC-informational)
...
- **RTT mediana**: 76 ms
- **Última actualización (UTC)**: 2026-05-18 13:29 UTC

**Mezcla de protocolos:** shadowsocks × 44 · trojan × 7 · vless × 92 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 21 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 36 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 6
