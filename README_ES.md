...
![nodos](https://img.shields.io/badge/nodos-142-brightgreen) ![activos](https://img.shields.io/badge/activos-2241-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-411ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-21_23:36_UTC-informational)
...
- **RTT mediana**: 411 ms
- **Última actualización (UTC)**: 2026-04-21 23:36 UTC

**Mezcla de protocolos:** shadowsocks × 33 · trojan × 23 · vless × 71 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 32 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 4 · `surfboard-eternity` × 6
