...
![nodos](https://img.shields.io/badge/nodos-122-brightgreen) ![activos](https://img.shields.io/badge/activos-2285-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-337ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-12_03:26_UTC-informational)
...
- **RTT mediana**: 337 ms
- **Última actualización (UTC)**: 2026-06-12 03:26 UTC

**Mezcla de protocolos:** hysteria2 × 2 · shadowsocks × 41 · trojan × 44 · vless × 30 · vmess × 5

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 31 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 7
