...
![nodos](https://img.shields.io/badge/nodos-134-brightgreen) ![activos](https://img.shields.io/badge/activos-2565-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-302ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-22_16:35_UTC-informational)
...
- **RTT mediana**: 302 ms
- **Última actualización (UTC)**: 2026-04-22 16:35 UTC

**Mezcla de protocolos:** shadowsocks × 30 · trojan × 19 · vless × 71 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 8
