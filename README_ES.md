...
![nodos](https://img.shields.io/badge/nodos-104-brightgreen) ![activos](https://img.shields.io/badge/activos-1961-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-184ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-28_00:12_UTC-informational)
...
- **RTT mediana**: 184 ms
- **Última actualización (UTC)**: 2026-06-28 00:12 UTC

**Mezcla de protocolos:** shadowsocks × 21 · trojan × 42 · vless × 30 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 13 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 7
