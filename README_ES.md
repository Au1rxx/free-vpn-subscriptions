...
![nodos](https://img.shields.io/badge/nodos-94-brightgreen) ![activos](https://img.shields.io/badge/activos-1959-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-294ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-27_23:13_UTC-informational)
...
- **RTT mediana**: 294 ms
- **Última actualización (UTC)**: 2026-06-27 23:13 UTC

**Mezcla de protocolos:** shadowsocks × 21 · trojan × 44 · vless × 18 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 16 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `ruking-clash` × 16 · `surfboard-eternity` × 2
