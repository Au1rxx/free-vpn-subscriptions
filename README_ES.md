...
![nodos](https://img.shields.io/badge/nodos-146-brightgreen) ![activos](https://img.shields.io/badge/activos-1888-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-478ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-22_14:22_UTC-informational)
...
- **RTT mediana**: 478 ms
- **Última actualización (UTC)**: 2026-06-22 14:22 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 29 · vless × 63 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 41 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 31 · `snakem982` × 3 · `surfboard-eternity` × 2
