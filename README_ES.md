...
![nodos](https://img.shields.io/badge/nodos-130-brightgreen) ![activos](https://img.shields.io/badge/activos-2018-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-263ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-12_17:34_UTC-informational)
...
- **RTT mediana**: 263 ms
- **Última actualización (UTC)**: 2026-07-12 17:34 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 60 · trojan × 24 · vless × 30 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 34 · `mahdibland-aggregator` × 27 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `mfuu-clash` × 5 · `ninjastrikers` × 15 · `pawdroid` × 12 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 2
