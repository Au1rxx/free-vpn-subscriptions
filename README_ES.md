...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2195-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-117ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-30_10:18_UTC-informational)
...
- **RTT mediana**: 117 ms
- **Última actualización (UTC)**: 2026-04-30 10:18 UTC

**Mezcla de protocolos:** shadowsocks × 42 · trojan × 11 · vless × 89 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 59 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
