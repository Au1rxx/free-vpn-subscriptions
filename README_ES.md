...
![nodos](https://img.shields.io/badge/nodos-105-brightgreen) ![activos](https://img.shields.io/badge/activos-1813-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-401ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-13_17:28_UTC-informational)
...
- **RTT mediana**: 401 ms
- **Última actualización (UTC)**: 2026-06-13 17:28 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 29 · vless × 14 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 5
