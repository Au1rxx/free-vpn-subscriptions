...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2222-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-107ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-30_07:22_UTC-informational)
...
- **RTT mediana**: 107 ms
- **Última actualización (UTC)**: 2026-04-30 07:22 UTC

**Mezcla de protocolos:** shadowsocks × 34 · trojan × 17 · vless × 90 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 27 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 7 · `ninjastrikers` × 67 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
