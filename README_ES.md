...
![nodos](https://img.shields.io/badge/nodos-114-brightgreen) ![activos](https://img.shields.io/badge/activos-1936-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-253ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-06_07:22_UTC-informational)
...
- **RTT mediana**: 253 ms
- **Última actualización (UTC)**: 2026-07-06 07:22 UTC

**Mezcla de protocolos:** shadowsocks × 41 · trojan × 27 · vless × 16 · vmess × 30

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 4 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
