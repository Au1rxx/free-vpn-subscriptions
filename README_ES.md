...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1987-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-166ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-07_10:27_UTC-informational)
...
- **RTT mediana**: 166 ms
- **Última actualización (UTC)**: 2026-05-07 10:27 UTC

**Mezcla de protocolos:** shadowsocks × 37 · trojan × 16 · vless × 88 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 28 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 73 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
