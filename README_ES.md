...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2567-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-85ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-04-27_04:14_UTC-informational)
...
- **RTT mediana**: 85 ms
- **Última actualización (UTC)**: 2026-04-27 04:14 UTC

**Mezcla de protocolos:** shadowsocks × 33 · trojan × 2 · vless × 101 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 18 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 45 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 6 · `ninjastrikers` × 60 · `pawdroid` × 1 · `surfboard-eternity` × 6
