...
grep -Fq 'migrations_total=7' <<<"$first"
grep -Fq 'migrations_total=7 applied=0 skipped=7' <<<"$second"
grep -Fq 'migrations=7 tables=22 empty_table_comments=0 empty_column_comments=0 enabled_policies=6' <<<"$status"
