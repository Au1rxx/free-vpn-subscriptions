...
grep -Fq 'migrations_total=8' <<<"$first"
grep -Fq 'migrations_total=8 applied=0 skipped=8' <<<"$second"
grep -Fq 'migrations=8 tables=22 empty_table_comments=0 empty_column_comments=0 enabled_policies=6' <<<"$status"
