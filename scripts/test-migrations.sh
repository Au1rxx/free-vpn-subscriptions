...
grep -Fq 'migrations_total=13' <<<"$first"
grep -Fq 'migrations_total=13 applied=0 skipped=13' <<<"$second"
grep -Fq 'migrations=13 tables=22 empty_table_comments=0 empty_column_comments=0 enabled_policies=7' <<<"$status"
