...
![노드](https://img.shields.io/badge/노드-119-brightgreen) ![생존](https://img.shields.io/badge/생존-2519-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-429ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-23_20:36_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 429 ms
- **최종 업데이트 (UTC)**: 2026-04-23 20:36 UTC

**프로토콜 분포:** shadowsocks × 14 · trojan × 25 · vless × 65 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `surfboard-eternity` × 6
