...
![노드](https://img.shields.io/badge/노드-144-brightgreen) ![생존](https://img.shields.io/badge/생존-2125-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-164ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_23:24_UTC-informational)
...
- **최고 속도 RTT**: 38 ms
- **중앙값 RTT**: 164 ms
- **최종 업데이트 (UTC)**: 2026-04-28 23:24 UTC

**프로토콜 분포:** shadowsocks × 33 · trojan × 22 · vless × 78 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 39 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 7 · `ninjastrikers` × 55 · `ruking-clash` × 1 · `surfboard-eternity` × 6
