...
![노드](https://img.shields.io/badge/노드-105-brightgreen) ![생존](https://img.shields.io/badge/생존-1963-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-352ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-26_05:22_UTC-informational)
...
- **최고 속도 RTT**: 26 ms
- **중앙값 RTT**: 352 ms
- **최종 업데이트 (UTC)**: 2026-06-26 05:22 UTC

**프로토콜 분포:** shadowsocks × 31 · trojan × 37 · vless × 26 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `ruking-clash` × 18 · `surfboard-eternity` × 4
