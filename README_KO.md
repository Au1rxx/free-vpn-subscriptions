...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2556-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-99ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_13:31_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 99 ms
- **최종 업데이트 (UTC)**: 2026-04-28 13:31 UTC

**프로토콜 분포:** shadowsocks × 21 · trojan × 22 · vless × 96 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 29 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 59 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
