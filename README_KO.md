...
![노드](https://img.shields.io/badge/노드-62-brightgreen) ![생존](https://img.shields.io/badge/생존-2410-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-146ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-02_21:22_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 146 ms
- **최종 업데이트 (UTC)**: 2026-07-02 21:22 UTC

**프로토콜 분포:** shadowsocks × 26 · trojan × 15 · vless × 6 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `surfboard-eternity` × 5
