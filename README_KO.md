...
![노드](https://img.shields.io/badge/노드-104-brightgreen) ![생존](https://img.shields.io/badge/생존-1932-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-420ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-12_16:29_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 420 ms
- **최종 업데이트 (UTC)**: 2026-06-12 16:29 UTC

**프로토콜 분포:** hysteria2 × 2 · shadowsocks × 45 · trojan × 37 · vless × 12 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 6
