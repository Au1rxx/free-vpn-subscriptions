...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2592-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-104ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-26_14:40_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 104 ms
- **최종 업데이트 (UTC)**: 2026-04-26 14:40 UTC

**프로토콜 분포:** shadowsocks × 41 · trojan × 4 · vless × 92 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 18 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 48 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 55 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
