...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2246-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-435ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-20_21:12_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 435 ms
- **최종 업데이트 (UTC)**: 2026-04-20 21:12 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 5 · vless × 103 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 60 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 44 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 4
