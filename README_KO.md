...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2222-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-126ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_08:25_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 126 ms
- **최종 업데이트 (UTC)**: 2026-04-30 08:25 UTC

**프로토콜 분포:** shadowsocks × 31 · trojan × 19 · vless × 92 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 30 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 71 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
