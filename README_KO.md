...
![노드](https://img.shields.io/badge/노드-144-brightgreen) ![생존](https://img.shields.io/badge/생존-2082-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-193ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-03_17:22_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 193 ms
- **최종 업데이트 (UTC)**: 2026-05-03 17:22 UTC

**프로토콜 분포:** shadowsocks × 27 · trojan × 23 · vless × 82 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 3 · `ninjastrikers` × 54 · `ruking-clash` × 1 · `surfboard-eternity` × 6
