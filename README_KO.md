...
![노드](https://img.shields.io/badge/노드-92-brightgreen) ![생존](https://img.shields.io/badge/생존-2199-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-568ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-29_11:28_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 568 ms
- **최종 업데이트 (UTC)**: 2026-06-29 11:28 UTC

**프로토콜 분포:** shadowsocks × 16 · trojan × 40 · vless × 21 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 18 · `epodonios` × 18 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 2
