...
![노드](https://img.shields.io/badge/노드-131-brightgreen) ![생존](https://img.shields.io/badge/생존-2100-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-474ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-20_20:31_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 474 ms
- **최종 업데이트 (UTC)**: 2026-06-20 20:31 UTC

**프로토콜 분포:** shadowsocks × 41 · trojan × 34 · vless × 32 · vmess × 24

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 38 · `surfboard-eternity` × 3
