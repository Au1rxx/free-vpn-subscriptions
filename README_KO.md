...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2176-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-146ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-21_10:38_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 146 ms
- **최종 업데이트 (UTC)**: 2026-04-21 10:38 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 4 · vless × 102 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 50 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 6
