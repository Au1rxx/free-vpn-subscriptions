...
![노드](https://img.shields.io/badge/노드-95-brightgreen) ![생존](https://img.shields.io/badge/생존-1940-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-307ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-27_21:11_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 307 ms
- **최종 업데이트 (UTC)**: 2026-06-27 21:11 UTC

**프로토콜 분포:** shadowsocks × 24 · trojan × 37 · vless × 20 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 22 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 4
