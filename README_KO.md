...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2192-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-156ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_02:24_UTC-informational)
...
- **최고 속도 RTT**: 35 ms
- **중앙값 RTT**: 156 ms
- **최종 업데이트 (UTC)**: 2026-04-22 02:24 UTC

**프로토콜 분포:** shadowsocks × 35 · trojan × 4 · vless × 98 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 74 · `pawdroid` × 3 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 8
