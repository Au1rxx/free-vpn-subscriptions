...
![노드](https://img.shields.io/badge/노드-126-brightgreen) ![생존](https://img.shields.io/badge/생존-2022-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-405ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-23_22:14_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 405 ms
- **최종 업데이트 (UTC)**: 2026-06-23 22:14 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 37 · trojan × 30 · vless × 43 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 44 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 18 · `surfboard-eternity` × 3
