...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2199-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-227ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-21_12:29_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 227 ms
- **최종 업데이트 (UTC)**: 2026-04-21 12:29 UTC

**프로토콜 분포:** shadowsocks × 27 · trojan × 4 · vless × 104 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 59 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 49 · `pawdroid` × 2 · `ruking-clash` × 7 · `snakem982` × 2 · `surfboard-eternity` × 10 · `vxiaov-clash` × 1
