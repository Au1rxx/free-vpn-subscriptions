...
![노드](https://img.shields.io/badge/노드-99-brightgreen) ![생존](https://img.shields.io/badge/생존-1964-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-495ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_09:17_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 495 ms
- **최종 업데이트 (UTC)**: 2026-06-18 09:17 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 35 · trojan × 26 · vless × 31 · vmess × 6

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 7 · `ruking-clash` × 18 · `snakem982` × 7 · `surfboard-eternity` × 2
