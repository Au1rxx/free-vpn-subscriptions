...
![노드](https://img.shields.io/badge/노드-134-brightgreen) ![생존](https://img.shields.io/badge/생존-2565-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-302ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_16:35_UTC-informational)
...
- **최고 속도 RTT**: 35 ms
- **중앙값 RTT**: 302 ms
- **최종 업데이트 (UTC)**: 2026-04-22 16:35 UTC

**프로토콜 분포:** shadowsocks × 30 · trojan × 19 · vless × 71 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 25 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 8
