...
![노드](https://img.shields.io/badge/노드-143-brightgreen) ![생존](https://img.shields.io/badge/생존-2216-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-366ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-05_20:27_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 366 ms
- **최종 업데이트 (UTC)**: 2026-05-05 20:27 UTC

**프로토콜 분포:** shadowsocks × 36 · trojan × 28 · vless × 68 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 38 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 3 · `surfboard-eternity` × 10
