...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2212-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-106ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_04:38_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 106 ms
- **최종 업데이트 (UTC)**: 2026-04-30 04:38 UTC

**프로토콜 분포:** shadowsocks × 33 · trojan × 5 · vless × 103 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 29 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 71 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 7
