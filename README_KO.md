...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2229-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-117ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_09:25_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 117 ms
- **최종 업데이트 (UTC)**: 2026-04-30 09:25 UTC

**프로토콜 분포:** shadowsocks × 33 · trojan × 18 · vless × 90 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 31 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 66 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 9
