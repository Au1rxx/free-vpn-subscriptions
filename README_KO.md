...
![노드](https://img.shields.io/badge/노드-80-brightgreen) ![생존](https://img.shields.io/badge/생존-2418-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-167ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-01_14:35_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 167 ms
- **최종 업데이트 (UTC)**: 2026-06-01 14:35 UTC

**프로토콜 분포:** shadowsocks × 16 · trojan × 25 · vless × 7 · vmess × 32

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 16 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 9 · `pawdroid` × 3 · `surfboard-eternity` × 2
