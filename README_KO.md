...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2446-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-98ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-24_00:29_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 98 ms
- **최종 업데이트 (UTC)**: 2026-04-24 00:29 UTC

**프로토콜 분포:** shadowsocks × 22 · trojan × 11 · vless × 105 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 26 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 25 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 6
