...
![노드](https://img.shields.io/badge/노드-130-brightgreen) ![생존](https://img.shields.io/badge/생존-2479-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-474ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-19_02:26_UTC-informational)
...
- **최고 속도 RTT**: 35 ms
- **중앙값 RTT**: 474 ms
- **최종 업데이트 (UTC)**: 2026-06-19 02:26 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 35 · trojan × 28 · vless × 56 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 15 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 26 · `pawdroid` × 4 · `ruking-clash` × 39 · `snakem982` × 6 · `surfboard-eternity` × 2
