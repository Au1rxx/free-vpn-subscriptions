...
![노드](https://img.shields.io/badge/노드-115-brightgreen) ![생존](https://img.shields.io/badge/생존-1829-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-377ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-16_11:15_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 377 ms
- **최종 업데이트 (UTC)**: 2026-06-16 11:15 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 55 · trojan × 24 · vless × 20 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 23 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 7 · `surfboard-eternity` × 3
