...
![노드](https://img.shields.io/badge/노드-90-brightgreen) ![생존](https://img.shields.io/badge/생존-1819-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-418ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-30_21:15_UTC-informational)
...
- **최고 속도 RTT**: 37 ms
- **중앙값 RTT**: 418 ms
- **최종 업데이트 (UTC)**: 2026-06-30 21:15 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 12 · vmess × 7

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 14 · `surfboard-eternity` × 3
