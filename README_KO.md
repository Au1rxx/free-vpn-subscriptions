...
![노드](https://img.shields.io/badge/노드-83-brightgreen) ![생존](https://img.shields.io/badge/생존-2189-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-191ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-06_10:22_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 191 ms
- **최종 업데이트 (UTC)**: 2026-06-06 10:22 UTC

**프로토콜 분포:** shadowsocks × 23 · trojan × 24 · vless × 19 · vmess × 17

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 26 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 5 · `surfboard-eternity` × 3
