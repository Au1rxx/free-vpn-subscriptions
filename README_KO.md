...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2280-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-451ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-20_22:36_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 451 ms
- **최종 업데이트 (UTC)**: 2026-04-20 22:36 UTC

**프로토콜 분포:** shadowsocks × 22 · trojan × 19 · vless × 95 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 60 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 44 · `ruking-clash` × 4 · `surfboard-eternity` × 5
