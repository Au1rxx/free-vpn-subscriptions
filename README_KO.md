...
![노드](https://img.shields.io/badge/노드-145-brightgreen) ![생존](https://img.shields.io/badge/생존-1942-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-418ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-21_23:32_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 418 ms
- **최종 업데이트 (UTC)**: 2026-06-21 23:32 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 45 · trojan × 32 · vless × 52 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 5 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 34 · `snakem982` × 2 · `surfboard-eternity` × 3
