...
![노드](https://img.shields.io/badge/노드-68-brightgreen) ![생존](https://img.shields.io/badge/생존-1894-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-112ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-27_08:24_UTC-informational)
...
- **최고 속도 RTT**: 38 ms
- **중앙값 RTT**: 112 ms
- **최종 업데이트 (UTC)**: 2026-05-27 08:24 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 10 · vless × 18 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `ruking-clash` × 6 · `snakem982` × 2 · `surfboard-eternity` × 4
