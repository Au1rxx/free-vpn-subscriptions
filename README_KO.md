...
![노드](https://img.shields.io/badge/노드-93-brightgreen) ![생존](https://img.shields.io/badge/생존-2086-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-183ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-27_13:13_UTC-informational)
...
- **최고 속도 RTT**: 35 ms
- **중앙값 RTT**: 183 ms
- **최종 업데이트 (UTC)**: 2026-06-27 13:13 UTC

**프로토콜 분포:** shadowsocks × 18 · trojan × 34 · vless × 18 · vmess × 23

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 10 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 5 · `ruking-clash` × 15 · `surfboard-eternity` × 2
