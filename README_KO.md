...
![노드](https://img.shields.io/badge/노드-102-brightgreen) ![생존](https://img.shields.io/badge/생존-2320-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-186ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-20_00:26_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 186 ms
- **최종 업데이트 (UTC)**: 2026-06-20 00:26 UTC

**프로토콜 분포:** shadowsocks × 23 · trojan × 29 · vless × 19 · vmess × 31

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 4 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 19 · `surfboard-eternity` × 4
