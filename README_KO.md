...
![노드](https://img.shields.io/badge/노드-147-brightgreen) ![생존](https://img.shields.io/badge/생존-2281-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-435ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-21_21:31_UTC-informational)
...
- **최고 속도 RTT**: 37 ms
- **중앙값 RTT**: 435 ms
- **최종 업데이트 (UTC)**: 2026-04-21 21:31 UTC

**프로토콜 분포:** shadowsocks × 30 · trojan × 23 · vless × 80 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 46 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 5
