...
![노드](https://img.shields.io/badge/노드-72-brightgreen) ![생존](https://img.shields.io/badge/생존-2128-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-167ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-06_20:12_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 167 ms
- **최종 업데이트 (UTC)**: 2026-06-06 20:12 UTC

**프로토콜 분포:** shadowsocks × 26 · trojan × 15 · vless × 7 · vmess × 24

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 5
