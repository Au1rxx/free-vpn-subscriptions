...
![노드](https://img.shields.io/badge/노드-141-brightgreen) ![생존](https://img.shields.io/badge/생존-2572-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-111ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-14_16:30_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 111 ms
- **최종 업데이트 (UTC)**: 2026-05-14 16:30 UTC

**프로토콜 분포:** shadowsocks × 36 · trojan × 21 · vless × 75 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 28 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 54 · `pawdroid` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
