...
![노드](https://img.shields.io/badge/노드-138-brightgreen) ![생존](https://img.shields.io/badge/생존-2523-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-206ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-23_18:18_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 206 ms
- **최종 업데이트 (UTC)**: 2026-04-23 18:18 UTC

**프로토콜 분포:** shadowsocks × 15 · trojan × 26 · vless × 81 · vmess × 16

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
