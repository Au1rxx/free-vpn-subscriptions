...
![노드](https://img.shields.io/badge/노드-83-brightgreen) ![생존](https://img.shields.io/badge/생존-2145-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-171ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-05_22:13_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 171 ms
- **최종 업데이트 (UTC)**: 2026-06-05 22:13 UTC

**프로토콜 분포:** shadowsocks × 25 · trojan × 28 · vless × 12 · vmess × 18

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 2 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 12 · `surfboard-eternity` × 2
