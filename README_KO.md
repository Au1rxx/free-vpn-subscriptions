...
![노드](https://img.shields.io/badge/노드-86-brightgreen) ![생존](https://img.shields.io/badge/생존-2173-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-169ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-07_10:23_UTC-informational)
...
- **최고 속도 RTT**: 23 ms
- **중앙값 RTT**: 169 ms
- **최종 업데이트 (UTC)**: 2026-06-07 10:23 UTC

**프로토콜 분포:** shadowsocks × 30 · trojan × 21 · vless × 11 · vmess × 24

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
