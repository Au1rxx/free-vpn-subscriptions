...
![노드](https://img.shields.io/badge/노드-100-brightgreen) ![생존](https://img.shields.io/badge/생존-2170-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-143ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-06_00:24_UTC-informational)
...
- **최고 속도 RTT**: 26 ms
- **중앙값 RTT**: 143 ms
- **최종 업데이트 (UTC)**: 2026-06-06 00:24 UTC

**프로토콜 분포:** shadowsocks × 24 · trojan × 26 · vless × 32 · vmess × 18

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 3 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 30 · `surfboard-eternity` × 6
