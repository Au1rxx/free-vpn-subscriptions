...
![노드](https://img.shields.io/badge/노드-147-brightgreen) ![생존](https://img.shields.io/badge/생존-2216-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-293ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-04_18:10_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 293 ms
- **최종 업데이트 (UTC)**: 2026-05-04 18:10 UTC

**프로토콜 분포:** shadowsocks × 37 · trojan × 23 · vless × 74 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 3 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
