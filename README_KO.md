...
![노드](https://img.shields.io/badge/노드-80-brightgreen) ![생존](https://img.shields.io/badge/생존-2323-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-225ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-19_20:20_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 225 ms
- **최종 업데이트 (UTC)**: 2026-06-19 20:20 UTC

**프로토콜 분포:** shadowsocks × 23 · trojan × 25 · vless × 7 · vmess × 25

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 14 · `surfboard-eternity` × 3
