...
![노드](https://img.shields.io/badge/노드-86-brightgreen) ![생존](https://img.shields.io/badge/생존-2022-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-201ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-26_21:10_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 201 ms
- **최종 업데이트 (UTC)**: 2026-06-26 21:10 UTC

**프로토콜 분포:** shadowsocks × 17 · trojan × 32 · vless × 17 · vmess × 20

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `ruking-clash` × 17
