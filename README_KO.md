...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2229-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-144ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_01:38_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 144 ms
- **최종 업데이트 (UTC)**: 2026-04-22 01:38 UTC

**프로토콜 분포:** shadowsocks × 34 · trojan × 5 · vless × 97 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 29 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 71 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 5
