...
![노드](https://img.shields.io/badge/노드-87-brightgreen) ![생존](https://img.shields.io/badge/생존-2141-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-272ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_16:09_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 272 ms
- **최종 업데이트 (UTC)**: 2026-06-28 16:09 UTC

**프로토콜 분포:** shadowsocks × 18 · trojan × 33 · vless × 19 · vmess × 17

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 3
