...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2108-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-106ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-29_08:18_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 106 ms
- **최종 업데이트 (UTC)**: 2026-04-29 08:18 UTC

**프로토콜 분포:** shadowsocks × 38 · trojan × 4 · vless × 97 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 29 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `ruking-clash` × 6 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
