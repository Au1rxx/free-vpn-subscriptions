...
![노드](https://img.shields.io/badge/노드-146-brightgreen) ![생존](https://img.shields.io/badge/생존-2072-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-362ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-23_03:13_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 362 ms
- **최종 업데이트 (UTC)**: 2026-06-23 03:13 UTC

**프로토콜 분포:** shadowsocks × 41 · trojan × 27 · vless × 63 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 52 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 23 · `pawdroid` × 1 · `ruking-clash` × 18 · `surfboard-eternity` × 3
