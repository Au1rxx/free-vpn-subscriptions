...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2191-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-123ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-21_08:12_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 123 ms
- **최종 업데이트 (UTC)**: 2026-04-21 08:12 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 3 · vless × 103 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 50 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 55 · `pawdroid` × 2 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
