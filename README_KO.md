...
![노드](https://img.shields.io/badge/노드-139-brightgreen) ![생존](https://img.shields.io/badge/생존-2090-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-281ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-03_16:30_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 281 ms
- **최종 업데이트 (UTC)**: 2026-05-03 16:30 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 23 · vless × 78 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 30 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
