...
![노드](https://img.shields.io/badge/노드-96-brightgreen) ![생존](https://img.shields.io/badge/생존-1956-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-484ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_10:19_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 484 ms
- **최종 업데이트 (UTC)**: 2026-06-18 10:19 UTC

**프로토콜 분포:** shadowsocks × 35 · trojan × 25 · vless × 28 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 25 · `snakem982` × 5 · `surfboard-eternity` × 4
