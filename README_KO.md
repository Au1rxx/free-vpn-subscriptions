...
![노드](https://img.shields.io/badge/노드-79-brightgreen) ![생존](https://img.shields.io/badge/생존-2000-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-344ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-29_19:33_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 344 ms
- **최종 업데이트 (UTC)**: 2026-06-29 19:33 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 34 · trojan × 31 · vless × 5 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 3
