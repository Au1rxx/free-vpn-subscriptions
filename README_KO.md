...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2192-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-81ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-26_09:22_UTC-informational)
...
- **최고 속도 RTT**: 26 ms
- **중앙값 RTT**: 81 ms
- **최종 업데이트 (UTC)**: 2026-04-26 09:22 UTC

**프로토콜 분포:** shadowsocks × 26 · trojan × 10 · vless × 103 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 20 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 67 · `pawdroid` × 4 · `surfboard-eternity` × 7 · `vxiaov-clash` × 2
