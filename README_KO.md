...
![노드](https://img.shields.io/badge/노드-86-brightgreen) ![생존](https://img.shields.io/badge/생존-2242-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-155ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-29_03:29_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 155 ms
- **최종 업데이트 (UTC)**: 2026-06-29 03:29 UTC

**프로토콜 분포:** shadowsocks × 17 · trojan × 28 · vless × 27 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 19 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 8 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 1
