...
![노드](https://img.shields.io/badge/노드-144-brightgreen) ![생존](https://img.shields.io/badge/생존-2256-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-293ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-04_19:17_UTC-informational)
...
- **최고 속도 RTT**: 36 ms
- **중앙값 RTT**: 293 ms
- **최종 업데이트 (UTC)**: 2026-05-04 19:17 UTC

**프로토콜 분포:** shadowsocks × 35 · trojan × 25 · vless × 71 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 60 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
