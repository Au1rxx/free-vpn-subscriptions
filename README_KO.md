...
![노드](https://img.shields.io/badge/노드-78-brightgreen) ![생존](https://img.shields.io/badge/생존-2255-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-278ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-02_13:11_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 278 ms
- **최종 업데이트 (UTC)**: 2026-07-02 13:11 UTC

**프로토콜 분포:** shadowsocks × 38 · trojan × 21 · vless × 10 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `epodonios` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 7 · `ninjastrikers` × 13 · `pawdroid` × 3 · `surfboard-eternity` × 7
