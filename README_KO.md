...
![노드](https://img.shields.io/badge/노드-141-brightgreen) ![생존](https://img.shields.io/badge/생존-2538-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-281ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-23_13:23_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 281 ms
- **최종 업데이트 (UTC)**: 2026-04-23 13:23 UTC

**프로토콜 분포:** shadowsocks × 30 · trojan × 22 · vless × 78 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 20 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 65 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
