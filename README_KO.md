...
![노드](https://img.shields.io/badge/노드-135-brightgreen) ![생존](https://img.shields.io/badge/생존-2216-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-167ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_19:27_UTC-informational)
...
- **최고 속도 RTT**: 36 ms
- **중앙값 RTT**: 167 ms
- **최종 업데이트 (UTC)**: 2026-04-28 19:27 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 23 · vless × 72 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 31 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
