...
![노드](https://img.shields.io/badge/노드-93-brightgreen) ![생존](https://img.shields.io/badge/생존-2003-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-271ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-26_22:13_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 271 ms
- **최종 업데이트 (UTC)**: 2026-06-26 22:13 UTC

**프로토콜 분포:** shadowsocks × 19 · trojan × 37 · vless × 17 · vmess × 20

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `ruking-clash` × 19 · `surfboard-eternity` × 3
