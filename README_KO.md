...
![노드](https://img.shields.io/badge/노드-76-brightgreen) ![생존](https://img.shields.io/badge/생존-2380-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-329ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-11_17:27_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 329 ms
- **최종 업데이트 (UTC)**: 2026-06-11 17:27 UTC

**프로토콜 분포:** shadowsocks × 43 · trojan × 18 · vless × 10 · vmess × 5

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 8 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 17 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 2
