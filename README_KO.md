...
![노드](https://img.shields.io/badge/노드-79-brightgreen) ![생존](https://img.shields.io/badge/생존-2430-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-70ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-03_09:17_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 70 ms
- **최종 업데이트 (UTC)**: 2026-06-03 09:17 UTC

**프로토콜 분포:** shadowsocks × 13 · trojan × 38 · vless × 5 · vmess × 23

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 23 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `surfboard-eternity` × 2
