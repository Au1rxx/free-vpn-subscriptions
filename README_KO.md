...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2217-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-172ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_20:29_UTC-informational)
...
- **최고 속도 RTT**: 36 ms
- **중앙값 RTT**: 172 ms
- **최종 업데이트 (UTC)**: 2026-04-30 20:29 UTC

**프로토콜 분포:** shadowsocks × 30 · trojan × 23 · vless × 75 · vmess × 22

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 33 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 32 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 51 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
