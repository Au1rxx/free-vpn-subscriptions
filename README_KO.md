...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2265-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-448ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-20_23:39_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 448 ms
- **최종 업데이트 (UTC)**: 2026-04-20 23:39 UTC

**프로토콜 분포:** shadowsocks × 23 · trojan × 18 · vless × 96 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 55 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 49 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 6
