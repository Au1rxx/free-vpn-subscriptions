...
![노드](https://img.shields.io/badge/노드-99-brightgreen) ![생존](https://img.shields.io/badge/생존-2301-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-176ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-20_03:27_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 176 ms
- **최종 업데이트 (UTC)**: 2026-06-20 03:27 UTC

**프로토콜 분포:** shadowsocks × 22 · trojan × 27 · vless × 19 · vmess × 31

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 22 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 2
