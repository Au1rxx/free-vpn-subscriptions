...
![노드](https://img.shields.io/badge/노드-111-brightgreen) ![생존](https://img.shields.io/badge/생존-1996-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-416ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_11:24_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 416 ms
- **최종 업데이트 (UTC)**: 2026-06-28 11:24 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 33 · trojan × 36 · vless × 28 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 16 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 3
