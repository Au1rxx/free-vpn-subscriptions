...
![노드](https://img.shields.io/badge/노드-86-brightgreen) ![생존](https://img.shields.io/badge/생존-2128-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-345ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_14:39_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 345 ms
- **최종 업데이트 (UTC)**: 2026-06-28 14:39 UTC

**프로토콜 분포:** shadowsocks × 17 · trojan × 32 · vless × 19 · vmess × 18

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 2
