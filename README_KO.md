...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2468-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-125ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-27_16:12_UTC-informational)
...
- **최고 속도 RTT**: 42 ms
- **중앙값 RTT**: 125 ms
- **최종 업데이트 (UTC)**: 2026-04-27 16:12 UTC

**프로토콜 분포:** shadowsocks × 27 · trojan × 14 · vless × 98 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 57 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 6
