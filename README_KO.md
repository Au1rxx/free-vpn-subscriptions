...
![노드](https://img.shields.io/badge/노드-123-brightgreen) ![생존](https://img.shields.io/badge/생존-2492-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-439ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-23_21:14_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 439 ms
- **최종 업데이트 (UTC)**: 2026-04-23 21:14 UTC

**프로토콜 분포:** shadowsocks × 14 · trojan × 25 · vless × 70 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 22 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 47 · `pawdroid` × 2 · `surfboard-eternity` × 1
