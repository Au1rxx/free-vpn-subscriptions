...
![노드](https://img.shields.io/badge/노드-86-brightgreen) ![생존](https://img.shields.io/badge/생존-1822-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-390ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-30_20:35_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 390 ms
- **최종 업데이트 (UTC)**: 2026-06-30 20:35 UTC

**프로토콜 분포:** shadowsocks × 38 · trojan × 31 · vless × 10 · vmess × 7

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 5
