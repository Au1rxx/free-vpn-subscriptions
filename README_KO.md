...
![노드](https://img.shields.io/badge/노드-104-brightgreen) ![생존](https://img.shields.io/badge/생존-1961-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-184ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_00:12_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 184 ms
- **최종 업데이트 (UTC)**: 2026-06-28 00:12 UTC

**프로토콜 분포:** shadowsocks × 21 · trojan × 42 · vless × 30 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 13 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 7
