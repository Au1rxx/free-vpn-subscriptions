...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2253-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-397ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-20_18:10_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 397 ms
- **최종 업데이트 (UTC)**: 2026-04-20 18:10 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 16 · vless × 93 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 52 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 7
