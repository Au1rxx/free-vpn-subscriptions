...
![노드](https://img.shields.io/badge/노드-140-brightgreen) ![생존](https://img.shields.io/badge/생존-2556-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-370ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_15:16_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 370 ms
- **최종 업데이트 (UTC)**: 2026-04-22 15:16 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 21 · vless × 77 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 29 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 58 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 9
