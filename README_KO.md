...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2157-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-155ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-01_17:12_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 155 ms
- **최종 업데이트 (UTC)**: 2026-05-01 17:12 UTC

**프로토콜 분포:** shadowsocks × 40 · trojan × 17 · vless × 82 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 31 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 49 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
