...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2218-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-123ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_06:21_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 123 ms
- **최종 업데이트 (UTC)**: 2026-04-22 06:21 UTC

**프로토콜 분포:** shadowsocks × 36 · trojan × 4 · vless × 98 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 38 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 9
