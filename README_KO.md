...
![노드](https://img.shields.io/badge/노드-128-brightgreen) ![생존](https://img.shields.io/badge/생존-2609-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-384ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_22:13_UTC-informational)
...
- **최고 속도 RTT**: 25 ms
- **중앙값 RTT**: 384 ms
- **최종 업데이트 (UTC)**: 2026-04-22 22:13 UTC

**프로토콜 분포:** shadowsocks × 30 · trojan × 20 · vless × 66 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6
