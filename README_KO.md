...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2103-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-101ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-29_01:33_UTC-informational)
...
- **최고 속도 RTT**: 38 ms
- **중앙값 RTT**: 101 ms
- **최종 업데이트 (UTC)**: 2026-04-29 01:33 UTC

**프로토콜 분포:** shadowsocks × 32 · trojan × 5 · vless × 102 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 31 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7
