...
![노드](https://img.shields.io/badge/노드-130-brightgreen) ![생존](https://img.shields.io/badge/생존-1939-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-469ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-17_06:16_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 469 ms
- **최종 업데이트 (UTC)**: 2026-06-17 06:16 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 40 · trojan × 27 · vless × 23 · vmess × 39

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 41 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
