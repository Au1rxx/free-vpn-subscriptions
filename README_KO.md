...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2274-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-275ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-20_15:11_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 275 ms
- **최종 업데이트 (UTC)**: 2026-04-20 15:11 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 12 · vless × 98 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 51 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `ruking-clash` × 6 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
