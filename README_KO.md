...
![노드](https://img.shields.io/badge/노드-142-brightgreen) ![생존](https://img.shields.io/badge/생존-2241-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-411ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-21_23:36_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 411 ms
- **최종 업데이트 (UTC)**: 2026-04-21 23:36 UTC

**프로토콜 분포:** shadowsocks × 33 · trojan × 23 · vless × 71 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 32 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 4 · `surfboard-eternity` × 6
