...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-1857-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-471ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-22_15:32_UTC-informational)
...
- **최고 속도 RTT**: 35 ms
- **중앙값 RTT**: 471 ms
- **최종 업데이트 (UTC)**: 2026-06-22 15:32 UTC

**프로토콜 분포:** shadowsocks × 40 · trojan × 31 · vless × 66 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 14 · `epodonios` × 41 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 2 · `surfboard-eternity` × 3
