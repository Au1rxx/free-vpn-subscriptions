...
![노드](https://img.shields.io/badge/노드-66-brightgreen) ![생존](https://img.shields.io/badge/생존-2194-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-361ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-05_15:36_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 361 ms
- **최종 업데이트 (UTC)**: 2026-06-05 15:36 UTC

**프로토콜 분포:** shadowsocks × 14 · trojan × 24 · vless × 13 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 4 · `epodonios` × 20 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 10 · `pawdroid` × 3 · `surfboard-eternity` × 2
