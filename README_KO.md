...
![노드](https://img.shields.io/badge/노드-127-brightgreen) ![생존](https://img.shields.io/badge/생존-2118-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-400ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-20_23:31_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 400 ms
- **최종 업데이트 (UTC)**: 2026-06-20 23:31 UTC

**프로토콜 분포:** shadowsocks × 39 · trojan × 35 · vless × 29 · vmess × 24

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 10 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 6 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 31 · `surfboard-eternity` × 2
