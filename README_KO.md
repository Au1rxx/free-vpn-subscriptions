...
![노드](https://img.shields.io/badge/노드-130-brightgreen) ![생존](https://img.shields.io/badge/생존-2005-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-469ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-23_21:23_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 469 ms
- **최종 업데이트 (UTC)**: 2026-06-23 21:23 UTC

**프로토콜 분포:** hysteria2 × 2 · shadowsocks × 38 · trojan × 30 · vless × 45 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 5 · `epodonios` × 45 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
