...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2146-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-217ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-29_22:29_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 217 ms
- **최종 업데이트 (UTC)**: 2026-04-29 22:29 UTC

**프로토콜 분포:** shadowsocks × 37 · trojan × 22 · vless × 81 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 43 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 54 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
