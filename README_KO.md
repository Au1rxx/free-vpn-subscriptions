...
![노드](https://img.shields.io/badge/노드-118-brightgreen) ![생존](https://img.shields.io/badge/생존-1956-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-300ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-13_00:25_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 300 ms
- **최종 업데이트 (UTC)**: 2026-06-13 00:25 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 55 · trojan × 24 · vless × 30 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 35 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 6
