...
![노드](https://img.shields.io/badge/노드-71-brightgreen) ![생존](https://img.shields.io/badge/생존-2407-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-148ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-02_15:33_UTC-informational)
...
- **최고 속도 RTT**: 26 ms
- **중앙값 RTT**: 148 ms
- **최종 업데이트 (UTC)**: 2026-07-02 15:33 UTC

**프로토콜 분포:** shadowsocks × 20 · trojan × 16 · vless × 20 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 8 · `ninjastrikers` × 13 · `pawdroid` × 11 · `surfboard-eternity` × 2
