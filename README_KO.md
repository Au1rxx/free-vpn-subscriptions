...
![노드](https://img.shields.io/badge/노드-144-brightgreen) ![생존](https://img.shields.io/badge/생존-1974-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-501ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-16_22:32_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 501 ms
- **최종 업데이트 (UTC)**: 2026-06-16 22:32 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 16 · vmess × 54

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 6 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 58 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `ruking-clash` × 18
