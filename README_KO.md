...
![노드](https://img.shields.io/badge/노드-76-brightgreen) ![생존](https://img.shields.io/badge/생존-2490-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-137ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-02_14:32_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 137 ms
- **최종 업데이트 (UTC)**: 2026-06-02 14:32 UTC

**프로토콜 분포:** shadowsocks × 21 · trojan × 26 · vless × 8 · vmess × 21

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 9 · `pawdroid` × 4 · `surfboard-eternity` × 4
