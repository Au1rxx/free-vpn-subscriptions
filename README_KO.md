...
![노드](https://img.shields.io/badge/노드-93-brightgreen) ![생존](https://img.shields.io/badge/생존-2266-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-277ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-20_08:26_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 277 ms
- **최종 업데이트 (UTC)**: 2026-06-20 08:26 UTC

**프로토콜 분포:** shadowsocks × 22 · trojan × 28 · vless × 14 · vmess × 29

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 4 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 18 · `surfboard-eternity` × 4
