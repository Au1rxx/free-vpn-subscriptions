...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2567-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-85ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-27_04:14_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 85 ms
- **최종 업데이트 (UTC)**: 2026-04-27 04:14 UTC

**프로토콜 분포:** shadowsocks × 33 · trojan × 2 · vless × 101 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 18 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 45 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 6 · `ninjastrikers` × 60 · `pawdroid` × 1 · `surfboard-eternity` × 6
