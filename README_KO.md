...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2609-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-98ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_02:39_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 98 ms
- **최종 업데이트 (UTC)**: 2026-04-28 02:39 UTC

**프로토콜 분포:** shadowsocks × 24 · trojan × 4 · vless × 113 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 6 · `ninjastrikers` × 62 · `ruking-clash` × 1 · `surfboard-eternity` × 4
