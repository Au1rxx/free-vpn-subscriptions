...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-393-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-119ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-19_06:42_UTC-informational)
...
- **최고 속도 RTT**: 8 ms
- **중앙값 RTT**: 119 ms
- **최종 업데이트 (UTC)**: 2026-04-19 06:42 UTC

**프로토콜 분포:** shadowsocks × 104 · trojan × 7 · vmess × 39

**이번 실행에 사용된 소스:** `freefq` × 2 · `mahdibland-aggregator` × 67 · `mahdibland-shadowsocks` × 65 · `vxiaov-clash` × 16
