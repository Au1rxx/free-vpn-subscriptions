...
![노드](https://img.shields.io/badge/노드-133-brightgreen) ![생존](https://img.shields.io/badge/생존-1998-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-413ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-23_18:40_UTC-informational)
...
- **최고 속도 RTT**: 36 ms
- **중앙값 RTT**: 413 ms
- **최종 업데이트 (UTC)**: 2026-06-23 18:40 UTC

**프로토콜 분포:** hysteria2 × 2 · shadowsocks × 38 · trojan × 29 · vless × 45 · vmess × 19

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 3 · `epodonios` × 47 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 5
