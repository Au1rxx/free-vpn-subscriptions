...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2246-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-181ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-20_16:21_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 181 ms
- **최종 업데이트 (UTC)**: 2026-04-20 16:21 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 16 · vless × 95 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 50 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
