...
![노드](https://img.shields.io/badge/노드-117-brightgreen) ![생존](https://img.shields.io/badge/생존-1971-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-351ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_04:37_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 351 ms
- **최종 업데이트 (UTC)**: 2026-06-28 04:37 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 33 · trojan × 42 · vless × 30 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 16 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `ruking-clash` × 15 · `surfboard-eternity` × 7
