...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2264-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-186ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_23:13_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 186 ms
- **최종 업데이트 (UTC)**: 2026-04-30 23:13 UTC

**프로토콜 분포:** shadowsocks × 25 · trojan × 23 · vless × 81 · vmess × 21

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 43 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 52 · `surfboard-eternity` × 7
