...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2196-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-149ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-21_09:19_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 149 ms
- **최종 업데이트 (UTC)**: 2026-04-21 09:19 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 2 · vless × 105 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 53 · `epodonios` × 3 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 56 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
