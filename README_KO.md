...
![노드](https://img.shields.io/badge/노드-90-brightgreen) ![생존](https://img.shields.io/badge/생존-1947-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-280ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-26_20:34_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 280 ms
- **최종 업데이트 (UTC)**: 2026-06-26 20:34 UTC

**프로토콜 분포:** shadowsocks × 23 · trojan × 29 · vless × 14 · vmess × 24

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 6 · `epodonios` × 18 · `mahdi0024` × 16 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `ruking-clash` × 17 · `surfboard-eternity` × 5
