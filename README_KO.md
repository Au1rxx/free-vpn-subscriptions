...
![노드](https://img.shields.io/badge/노드-124-brightgreen) ![생존](https://img.shields.io/badge/생존-2059-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-406ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-23_07:27_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 406 ms
- **최종 업데이트 (UTC)**: 2026-06-23 07:27 UTC

**프로토콜 분포:** shadowsocks × 35 · trojan × 31 · vless × 47 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 3 · `epodonios` × 45 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 3
