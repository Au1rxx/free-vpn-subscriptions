...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2213-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-153ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_12:19_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 153 ms
- **최종 업데이트 (UTC)**: 2026-04-30 12:19 UTC

**프로토콜 분포:** shadowsocks × 34 · trojan × 19 · vless × 87 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 40 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 62 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
