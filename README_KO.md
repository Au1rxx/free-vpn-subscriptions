...
![노드](https://img.shields.io/badge/노드-136-brightgreen) ![생존](https://img.shields.io/badge/생존-2469-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-217ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-23_22:26_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 217 ms
- **최종 업데이트 (UTC)**: 2026-04-23 22:26 UTC

**프로토콜 분포:** shadowsocks × 20 · trojan × 23 · vless × 74 · vmess × 19

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 23 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 54 · `pawdroid` × 4 · `surfboard-eternity` × 7
