...
![노드](https://img.shields.io/badge/노드-92-brightgreen) ![생존](https://img.shields.io/badge/생존-2021-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-380ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-26_16:36_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 380 ms
- **최종 업데이트 (UTC)**: 2026-06-26 16:36 UTC

**프로토콜 분포:** shadowsocks × 21 · trojan × 33 · vless × 17 · vmess × 21

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 8 · `epodonios` × 16 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 17 · `surfboard-eternity` × 3
