...
![노드](https://img.shields.io/badge/노드-138-brightgreen) ![생존](https://img.shields.io/badge/생존-2588-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-229ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_14:16_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 229 ms
- **최종 업데이트 (UTC)**: 2026-04-22 14:16 UTC

**프로토콜 분포:** shadowsocks × 27 · trojan × 22 · vless × 79 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 30 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 57 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7
