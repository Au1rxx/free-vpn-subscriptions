...
![노드](https://img.shields.io/badge/노드-81-brightgreen) ![생존](https://img.shields.io/badge/생존-1892-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-355ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-08_20:24_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 355 ms
- **최종 업데이트 (UTC)**: 2026-06-08 20:24 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 37 · trojan × 17 · vless × 14 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `ruking-clash` × 7 · `surfboard-eternity` × 4
