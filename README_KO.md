...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2064-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-165ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-29_15:11_UTC-informational)
...
- **최고 속도 RTT**: 38 ms
- **중앙값 RTT**: 165 ms
- **최종 업데이트 (UTC)**: 2026-04-29 15:11 UTC

**프로토콜 분포:** shadowsocks × 45 · trojan × 8 · vless × 87 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 40 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 17 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
