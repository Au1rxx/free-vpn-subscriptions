...
![노드](https://img.shields.io/badge/노드-67-brightgreen) ![생존](https://img.shields.io/badge/생존-2264-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-165ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-29_17:21_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 165 ms
- **최종 업데이트 (UTC)**: 2026-05-29 17:21 UTC

**프로토콜 분포:** shadowsocks × 12 · trojan × 27 · vless × 4 · vmess × 24

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 19 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 2
