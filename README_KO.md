...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2207-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-153ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_13:26_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 153 ms
- **최종 업데이트 (UTC)**: 2026-04-30 13:26 UTC

**프로토콜 분포:** shadowsocks × 39 · trojan × 18 · vless × 85 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 6 · `ninjastrikers` × 63 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
