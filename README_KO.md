...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2064-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-88ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-04_07:38_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 88 ms
- **최종 업데이트 (UTC)**: 2026-05-04 07:38 UTC

**프로토콜 분포:** shadowsocks × 26 · trojan × 12 · vless × 102 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 24 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 8 · `ninjastrikers` × 69 · `snakem982` × 1 · `surfboard-eternity` × 8
