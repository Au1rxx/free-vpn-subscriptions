...
![노드](https://img.shields.io/badge/노드-89-brightgreen) ![생존](https://img.shields.io/badge/생존-1998-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-162ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-04_00:21_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 162 ms
- **최종 업데이트 (UTC)**: 2026-07-04 00:21 UTC

**프로토콜 분포:** shadowsocks × 22 · trojan × 29 · vless × 16 · vmess × 22

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 9 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 6 · `ninjastrikers` × 21 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
