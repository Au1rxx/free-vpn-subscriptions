...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2237-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-442ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-20_19:35_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 442 ms
- **최종 업데이트 (UTC)**: 2026-04-20 19:35 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 18 · vless × 90 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 50 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 10
