...
![노드](https://img.shields.io/badge/노드-145-brightgreen) ![생존](https://img.shields.io/badge/생존-2083-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-372ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-23_05:24_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 372 ms
- **최종 업데이트 (UTC)**: 2026-06-23 05:24 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 39 · trojan × 29 · vless × 63 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 50 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 21 · `pawdroid` × 4 · `ruking-clash` × 19 · `surfboard-eternity` × 5
