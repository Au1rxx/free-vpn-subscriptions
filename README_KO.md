...
![노드](https://img.shields.io/badge/노드-70-brightgreen) ![생존](https://img.shields.io/badge/생존-2055-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-203ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-28_09:15_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 203 ms
- **최종 업데이트 (UTC)**: 2026-05-28 09:15 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 14 · vless × 16 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 6 · `ruking-clash` × 2 · `snakem982` × 4 · `surfboard-eternity` × 4
