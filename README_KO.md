...
![노드](https://img.shields.io/badge/노드-79-brightgreen) ![생존](https://img.shields.io/badge/생존-2238-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-417ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-29_09:11_UTC-informational)
...
- **최고 속도 RTT**: 35 ms
- **중앙값 RTT**: 417 ms
- **최종 업데이트 (UTC)**: 2026-06-29 09:11 UTC

**프로토콜 분포:** shadowsocks × 18 · trojan × 27 · vless × 19 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 2
