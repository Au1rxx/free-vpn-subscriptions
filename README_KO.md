...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2197-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-87ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-26_08:17_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 87 ms
- **최종 업데이트 (UTC)**: 2026-04-26 08:17 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 10 · vless × 100 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 23 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
