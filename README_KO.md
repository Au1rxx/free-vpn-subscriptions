...
![노드](https://img.shields.io/badge/노드-111-brightgreen) ![생존](https://img.shields.io/badge/생존-2262-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-359ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-12_06:10_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 359 ms
- **최종 업데이트 (UTC)**: 2026-06-12 06:10 UTC

**프로토콜 분포:** shadowsocks × 46 · trojan × 41 · vless × 18 · vmess × 6

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 8 · `epodonios` × 33 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 24 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 5
