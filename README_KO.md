...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2228-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-142ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-06_01:28_UTC-informational)
...
- **최고 속도 RTT**: 37 ms
- **중앙값 RTT**: 142 ms
- **최종 업데이트 (UTC)**: 2026-05-06 01:28 UTC

**프로토콜 분포:** shadowsocks × 36 · trojan × 15 · vless × 89 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 27 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 79 · `pawdroid` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
