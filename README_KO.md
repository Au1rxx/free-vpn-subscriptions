...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2181-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-384ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-21_13:11_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 384 ms
- **최종 업데이트 (UTC)**: 2026-04-21 13:11 UTC

**프로토콜 분포:** shadowsocks × 27 · trojan × 9 · vless × 99 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 55 · `epodonios` × 5 · `lagzian-mix` × 7 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `ruking-clash` × 11 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
