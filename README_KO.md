...
![노드](https://img.shields.io/badge/노드-123-brightgreen) ![생존](https://img.shields.io/badge/생존-2060-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-359ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-24_04:29_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 359 ms
- **최종 업데이트 (UTC)**: 2026-06-24 04:29 UTC

**프로토콜 분포:** shadowsocks × 34 · trojan × 28 · vless × 45 · vmess × 16

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 42 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `pawdroid` × 4 · `ruking-clash` × 13 · `surfboard-eternity` × 2
