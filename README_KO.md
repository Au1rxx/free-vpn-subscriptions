...
![노드](https://img.shields.io/badge/노드-97-brightgreen) ![생존](https://img.shields.io/badge/생존-1930-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-341ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-16_18:34_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 341 ms
- **최종 업데이트 (UTC)**: 2026-06-16 18:34 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 47 · trojan × 21 · vless × 17 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 11 · `surfboard-eternity` × 4
