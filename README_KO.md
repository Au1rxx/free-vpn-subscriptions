...
![노드](https://img.shields.io/badge/노드-142-brightgreen) ![생존](https://img.shields.io/badge/생존-2067-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-406ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-23_06:16_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 406 ms
- **최종 업데이트 (UTC)**: 2026-06-23 06:16 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 35 · trojan × 29 · vless × 61 · vmess × 16

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 4 · `epodonios` × 51 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 4
