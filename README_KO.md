...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2244-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-142ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_05:30_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 142 ms
- **최종 업데이트 (UTC)**: 2026-04-22 05:30 UTC

**프로토콜 분포:** shadowsocks × 37 · trojan × 2 · vless × 98 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 40 · `epodonios` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 62 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 9
