...
![노드](https://img.shields.io/badge/노드-122-brightgreen) ![생존](https://img.shields.io/badge/생존-2472-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-474ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-19_05:15_UTC-informational)
...
- **최고 속도 RTT**: 40 ms
- **중앙값 RTT**: 474 ms
- **최종 업데이트 (UTC)**: 2026-06-19 05:15 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 35 · trojan × 27 · vless × 49 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 35 · `snakem982` × 7 · `surfboard-eternity` × 4
