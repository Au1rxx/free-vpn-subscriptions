...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-1926-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-304ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-16_17:18_UTC-informational)
...
- **최고 속도 RTT**: 38 ms
- **중앙값 RTT**: 304 ms
- **최종 업데이트 (UTC)**: 2026-06-16 17:18 UTC

**프로토콜 분포:** shadowsocks × 48 · trojan × 12 · vless × 15 · vmess × 75

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 16 · `lagzian-mix` × 1 · `mahdi0024` × 78 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 1
