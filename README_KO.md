...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2589-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-94ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_05:37_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 94 ms
- **최종 업데이트 (UTC)**: 2026-04-28 05:37 UTC

**프로토콜 분포:** shadowsocks × 22 · trojan × 10 · vless × 109 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 25 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 71 · `pawdroid` × 2 · `surfboard-eternity` × 4
