...
![노드](https://img.shields.io/badge/노드-92-brightgreen) ![생존](https://img.shields.io/badge/생존-2147-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-173ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-07_12:11_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 173 ms
- **최종 업데이트 (UTC)**: 2026-06-07 12:11 UTC

**프로토콜 분포:** shadowsocks × 37 · trojan × 23 · vless × 9 · vmess × 23

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 8 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 1 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 5
