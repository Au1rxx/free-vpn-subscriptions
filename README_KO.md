...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2469-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-154ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-27_18:37_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 154 ms
- **최종 업데이트 (UTC)**: 2026-04-27 18:37 UTC

**프로토콜 분포:** shadowsocks × 27 · trojan × 21 · vless × 90 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 29 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 27 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
