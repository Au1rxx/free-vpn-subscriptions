...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2235-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-333ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-21_14:39_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 333 ms
- **최종 업데이트 (UTC)**: 2026-04-21 14:39 UTC

**프로토콜 분포:** shadowsocks × 34 · trojan × 13 · vless × 90 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 50 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
