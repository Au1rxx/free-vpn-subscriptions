...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2192-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-89ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-02_06:28_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 89 ms
- **최종 업데이트 (UTC)**: 2026-05-02 06:28 UTC

**프로토콜 분포:** shadowsocks × 40 · trojan × 8 · vless × 93 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 27 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 56 · `pawdroid` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
