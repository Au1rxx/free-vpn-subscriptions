...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2210-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-154ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_11:30_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 154 ms
- **최종 업데이트 (UTC)**: 2026-04-30 11:30 UTC

**프로토콜 분포:** shadowsocks × 34 · trojan × 20 · vless × 86 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 36 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 64 · `ruking-clash` × 1 · `snakem982` × 5 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
