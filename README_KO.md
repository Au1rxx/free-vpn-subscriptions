...
![노드](https://img.shields.io/badge/노드-138-brightgreen) ![생존](https://img.shields.io/badge/생존-2047-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-410ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-21_09:15_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 410 ms
- **최종 업데이트 (UTC)**: 2026-06-21 09:15 UTC

**프로토콜 분포:** shadowsocks × 44 · trojan × 29 · vless × 42 · vmess × 23

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 14 · `epodonios` × 12 · `mahdi0024` × 25 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 41 · `snakem982` × 2 · `surfboard-eternity` × 4
