...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2578-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-85ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_06:21_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 85 ms
- **최종 업데이트 (UTC)**: 2026-04-28 06:21 UTC

**프로토콜 분포:** shadowsocks × 18 · trojan × 8 · vless × 115 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 22 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 3 · `ninjastrikers` × 71 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 6
