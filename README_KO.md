...
![노드](https://img.shields.io/badge/노드-138-brightgreen) ![생존](https://img.shields.io/badge/생존-2105-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-164ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_22:33_UTC-informational)
...
- **최고 속도 RTT**: 36 ms
- **중앙값 RTT**: 164 ms
- **최종 업데이트 (UTC)**: 2026-04-28 22:33 UTC

**프로토콜 분포:** shadowsocks × 30 · trojan × 22 · vless × 75 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 35 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 53 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
