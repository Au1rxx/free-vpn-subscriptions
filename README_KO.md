...
![노드](https://img.shields.io/badge/노드-134-brightgreen) ![생존](https://img.shields.io/badge/생존-2048-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-361ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-24_02:30_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 361 ms
- **최종 업데이트 (UTC)**: 2026-06-24 02:30 UTC

**프로토콜 분포:** shadowsocks × 35 · trojan × 27 · vless × 57 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 45 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 24 · `pawdroid` × 7 · `ruking-clash` × 12 · `surfboard-eternity` × 6
