...
![노드](https://img.shields.io/badge/노드-79-brightgreen) ![생존](https://img.shields.io/badge/생존-2334-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-179ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-10_07:12_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 179 ms
- **최종 업데이트 (UTC)**: 2026-06-10 07:12 UTC

**프로토콜 분포:** shadowsocks × 30 · trojan × 13 · vless × 14 · vmess × 22

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 2
