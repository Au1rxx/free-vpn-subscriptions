...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2611-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-161ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-27_22:20_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 161 ms
- **최종 업데이트 (UTC)**: 2026-04-27 22:20 UTC

**프로토콜 분포:** shadowsocks × 24 · trojan × 22 · vless × 90 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 29 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 6
