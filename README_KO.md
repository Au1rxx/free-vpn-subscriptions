...
![노드](https://img.shields.io/badge/노드-105-brightgreen) ![생존](https://img.shields.io/badge/생존-1813-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-401ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-13_17:28_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 401 ms
- **최종 업데이트 (UTC)**: 2026-06-13 17:28 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 54 · trojan × 29 · vless × 14 · vmess × 7

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 5
