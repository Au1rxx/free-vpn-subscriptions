...
![노드](https://img.shields.io/badge/노드-127-brightgreen) ![생존](https://img.shields.io/badge/생존-2484-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-489ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-19_11:38_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 489 ms
- **최종 업데이트 (UTC)**: 2026-06-19 11:38 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 32 · trojan × 27 · vless × 48 · vmess × 19

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 7
