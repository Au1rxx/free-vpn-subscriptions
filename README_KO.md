...
![노드](https://img.shields.io/badge/노드-142-brightgreen) ![생존](https://img.shields.io/badge/생존-2250-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-425ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-04_21:24_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 425 ms
- **최종 업데이트 (UTC)**: 2026-05-04 21:24 UTC

**프로토콜 분포:** shadowsocks × 35 · trojan × 26 · vless × 69 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 56 · `ruking-clash` × 3 · `surfboard-eternity` × 6
