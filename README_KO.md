...
![노드](https://img.shields.io/badge/노드-127-brightgreen) ![생존](https://img.shields.io/badge/생존-2552-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-488ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-19_12:14_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 488 ms
- **최종 업데이트 (UTC)**: 2026-06-19 12:14 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 34 · trojan × 26 · vless × 46 · vmess × 20

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 17 · `epodonios` × 22 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 4 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 6 · `surfboard-eternity` × 2
