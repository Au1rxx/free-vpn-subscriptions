...
![노드](https://img.shields.io/badge/노드-96-brightgreen) ![생존](https://img.shields.io/badge/생존-1941-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-358ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-27_20:11_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 358 ms
- **최종 업데이트 (UTC)**: 2026-06-27 20:11 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 39 · vless × 20 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 13 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 5
