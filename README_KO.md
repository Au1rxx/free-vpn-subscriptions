...
![노드](https://img.shields.io/badge/노드-141-brightgreen) ![생존](https://img.shields.io/badge/생존-2530-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-242ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-23_12:29_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 242 ms
- **최종 업데이트 (UTC)**: 2026-04-23 12:29 UTC

**프로토콜 분포:** shadowsocks × 31 · trojan × 22 · vless × 78 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 66 · `pawdroid` × 3 · `surfboard-eternity` × 8
