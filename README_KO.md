...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2249-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-169ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-20_14:23_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 169 ms
- **최종 업데이트 (UTC)**: 2026-04-20 14:23 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 14 · vless × 97 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 47 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `ruking-clash` × 6 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
