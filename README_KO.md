...
![노드](https://img.shields.io/badge/노드-127-brightgreen) ![생존](https://img.shields.io/badge/생존-2509-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-398ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-23_19:33_UTC-informational)
...
- **최고 속도 RTT**: 38 ms
- **중앙값 RTT**: 398 ms
- **최종 업데이트 (UTC)**: 2026-04-23 19:33 UTC

**프로토콜 분포:** shadowsocks × 13 · trojan × 24 · vless × 76 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 24 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `pawdroid` × 1 · `surfboard-eternity` × 1
