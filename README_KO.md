...
![노드](https://img.shields.io/badge/노드-69-brightgreen) ![생존](https://img.shields.io/badge/생존-2000-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-175ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-04_11:13_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 175 ms
- **최종 업데이트 (UTC)**: 2026-07-04 11:13 UTC

**프로토콜 분포:** shadowsocks × 30 · trojan × 15 · vless × 6 · vmess × 18

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 5 · `ninjastrikers` × 6 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
