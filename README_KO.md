...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2473-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-129ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-27_17:30_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 129 ms
- **최종 업데이트 (UTC)**: 2026-04-27 17:30 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 17 · vless × 93 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 32 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 31 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 51 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
