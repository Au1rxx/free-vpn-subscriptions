...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2605-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-86ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_08:31_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 86 ms
- **최종 업데이트 (UTC)**: 2026-04-28 08:31 UTC

**프로토콜 분포:** shadowsocks × 24 · trojan × 11 · vless × 104 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 66 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 5
