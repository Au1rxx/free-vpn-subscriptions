...
![노드](https://img.shields.io/badge/노드-121-brightgreen) ![생존](https://img.shields.io/badge/생존-1977-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-368ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_07:33_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 368 ms
- **최종 업데이트 (UTC)**: 2026-06-28 07:33 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 36 · trojan × 42 · vless × 29 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
