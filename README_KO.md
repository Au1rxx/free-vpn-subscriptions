...
![노드](https://img.shields.io/badge/노드-105-brightgreen) ![생존](https://img.shields.io/badge/생존-2005-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-441ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_12:39_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 441 ms
- **최종 업데이트 (UTC)**: 2026-06-28 12:39 UTC

**프로토콜 분포:** shadowsocks × 33 · trojan × 34 · vless × 25 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 31 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 13 · `surfboard-eternity` × 5
