...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2115-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-132ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-29_12:39_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 132 ms
- **최종 업데이트 (UTC)**: 2026-04-29 12:39 UTC

**프로토콜 분포:** shadowsocks × 41 · trojan × 10 · vless × 89 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 31 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 60 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
