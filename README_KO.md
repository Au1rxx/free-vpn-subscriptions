...
![노드](https://img.shields.io/badge/노드-137-brightgreen) ![생존](https://img.shields.io/badge/생존-2459-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-204ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-23_14:14_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 204 ms
- **최종 업데이트 (UTC)**: 2026-04-23 14:14 UTC

**프로토콜 분포:** shadowsocks × 17 · trojan × 20 · vless × 86 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 59 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 5
