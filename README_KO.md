...
![노드](https://img.shields.io/badge/노드-98-brightgreen) ![생존](https://img.shields.io/badge/생존-1897-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-350ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-13_13:16_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 350 ms
- **최종 업데이트 (UTC)**: 2026-06-13 13:16 UTC

**프로토콜 분포:** shadowsocks × 54 · trojan × 25 · vless × 12 · vmess × 7

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 13 · `mahdi0024` × 3 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 4
