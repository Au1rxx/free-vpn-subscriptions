...
![노드](https://img.shields.io/badge/노드-102-brightgreen) ![생존](https://img.shields.io/badge/생존-2196-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-194ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-11_04:29_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 194 ms
- **최종 업데이트 (UTC)**: 2026-06-11 04:29 UTC

**프로토콜 분포:** shadowsocks × 35 · trojan × 19 · vless × 25 · vmess × 23

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 5 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 27 · `pawdroid` × 5 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
