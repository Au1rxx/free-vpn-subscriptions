...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2211-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-108ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-26_13:15_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 108 ms
- **최종 업데이트 (UTC)**: 2026-04-26 13:15 UTC

**프로토콜 분포:** shadowsocks × 26 · trojan × 16 · vless × 98 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 20 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 68 · `surfboard-eternity` × 9
