...
![노드](https://img.shields.io/badge/노드-87-brightgreen) ![생존](https://img.shields.io/badge/생존-2242-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-235ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-29_04:29_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 235 ms
- **최종 업데이트 (UTC)**: 2026-06-29 04:29 UTC

**프로토콜 분포:** shadowsocks × 17 · trojan × 30 · vless × 27 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 6 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 8 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 3
