...
![노드](https://img.shields.io/badge/노드-140-brightgreen) ![생존](https://img.shields.io/badge/생존-2464-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-148ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-24_12:27_UTC-informational)
...
- **최고 속도 RTT**: 23 ms
- **중앙값 RTT**: 148 ms
- **최종 업데이트 (UTC)**: 2026-04-24 12:27 UTC

**프로토콜 분포:** shadowsocks × 14 · trojan × 23 · vless × 90 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
