...
![노드](https://img.shields.io/badge/노드-107-brightgreen) ![생존](https://img.shields.io/badge/생존-1955-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-383ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-10_19:19_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 383 ms
- **최종 업데이트 (UTC)**: 2026-06-10 19:19 UTC

**프로토콜 분포:** shadowsocks × 43 · trojan × 18 · vless × 11 · vmess × 35

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 34 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 6 · `surfboard-eternity` × 1
