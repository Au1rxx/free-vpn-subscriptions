...
![노드](https://img.shields.io/badge/노드-69-brightgreen) ![생존](https://img.shields.io/badge/생존-2052-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-234ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-28_16:38_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 234 ms
- **최종 업데이트 (UTC)**: 2026-05-28 16:38 UTC

**프로토콜 분포:** hysteria2 × 3 · shadowsocks × 30 · trojan × 14 · vless × 12 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 5 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 3
