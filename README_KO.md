...
![노드](https://img.shields.io/badge/노드-71-brightgreen) ![생존](https://img.shields.io/badge/생존-1884-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-288ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-05_12:30_UTC-informational)
...
- **최고 속도 RTT**: 24 ms
- **중앙값 RTT**: 288 ms
- **최종 업데이트 (UTC)**: 2026-06-05 12:30 UTC

**프로토콜 분포:** shadowsocks × 26 · trojan × 23 · vless × 10 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4
