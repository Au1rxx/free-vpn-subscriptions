...
![노드](https://img.shields.io/badge/노드-101-brightgreen) ![생존](https://img.shields.io/badge/생존-2023-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-181ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-27_03:09_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 181 ms
- **최종 업데이트 (UTC)**: 2026-06-27 03:09 UTC

**프로토콜 분포:** shadowsocks × 19 · trojan × 35 · vless × 26 · vmess × 21

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 8 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 19 · `surfboard-eternity` × 4
