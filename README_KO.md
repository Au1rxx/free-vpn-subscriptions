...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-1935-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-142ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-07_08:11_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 142 ms
- **최종 업데이트 (UTC)**: 2026-05-07 08:11 UTC

**프로토콜 분포:** shadowsocks × 50 · trojan × 5 · vless × 86 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 70 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
