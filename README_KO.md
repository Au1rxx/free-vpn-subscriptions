...
![노드](https://img.shields.io/badge/노드-120-brightgreen) ![생존](https://img.shields.io/badge/생존-2018-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-319ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-25_10:38_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 319 ms
- **최종 업데이트 (UTC)**: 2026-06-25 10:38 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 39 · trojan × 29 · vless × 36 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 6 · `epodonios` × 31 · `lagzian-mix` × 3 · `mahdi0024` × 20 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 6
