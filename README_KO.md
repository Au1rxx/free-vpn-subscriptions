...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2196-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-102ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_05:35_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 102 ms
- **최종 업데이트 (UTC)**: 2026-04-30 05:35 UTC

**프로토콜 분포:** shadowsocks × 30 · trojan × 12 · vless × 99 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 4 · `ninjastrikers` × 72 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 4
