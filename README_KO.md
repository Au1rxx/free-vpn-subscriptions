...
![노드](https://img.shields.io/badge/노드-137-brightgreen) ![생존](https://img.shields.io/badge/생존-2184-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-144ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_18:17_UTC-informational)
...
- **최고 속도 RTT**: 39 ms
- **중앙값 RTT**: 144 ms
- **최종 업데이트 (UTC)**: 2026-04-28 18:17 UTC

**프로토콜 분포:** shadowsocks × 27 · trojan × 24 · vless × 75 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 32 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
