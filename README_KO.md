...
![노드](https://img.shields.io/badge/노드-72-brightgreen) ![생존](https://img.shields.io/badge/생존-2157-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-169ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-06_13:11_UTC-informational)
...
- **최고 속도 RTT**: 26 ms
- **중앙값 RTT**: 169 ms
- **최종 업데이트 (UTC)**: 2026-06-06 13:11 UTC

**프로토콜 분포:** shadowsocks × 24 · trojan × 24 · vless × 7 · vmess × 17

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 5 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3
