...
![노드](https://img.shields.io/badge/노드-135-brightgreen) ![생존](https://img.shields.io/badge/생존-2208-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-166ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_15:20_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 166 ms
- **최종 업데이트 (UTC)**: 2026-04-28 15:20 UTC

**프로토콜 분포:** shadowsocks × 30 · trojan × 20 · vless × 75 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 24 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 59 · `ruking-clash` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
