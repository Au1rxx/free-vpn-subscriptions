...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2235-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-207ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_18:39_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 207 ms
- **최종 업데이트 (UTC)**: 2026-04-30 18:39 UTC

**프로토콜 분포:** shadowsocks × 30 · trojan × 25 · vless × 73 · vmess × 22

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 32 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 54 · `snakem982` × 3 · `surfboard-eternity` × 5
