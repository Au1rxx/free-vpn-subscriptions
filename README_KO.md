...
![노드](https://img.shields.io/badge/노드-140-brightgreen) ![생존](https://img.shields.io/badge/생존-2506-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-147ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-09_22:30_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 147 ms
- **최종 업데이트 (UTC)**: 2026-05-09 22:30 UTC

**프로토콜 분포:** shadowsocks × 46 · trojan × 17 · vless × 68 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 56 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 8
