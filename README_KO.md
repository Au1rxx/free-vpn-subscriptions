...
![노드](https://img.shields.io/badge/노드-140-brightgreen) ![생존](https://img.shields.io/badge/생존-1720-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-496ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-14_09:26_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 496 ms
- **최종 업데이트 (UTC)**: 2026-06-14 09:26 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 75 · trojan × 36 · vless × 21 · vmess × 7

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 21 · `surfboard-eternity` × 4
