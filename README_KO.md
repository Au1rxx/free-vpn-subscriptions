...
![노드](https://img.shields.io/badge/노드-115-brightgreen) ![생존](https://img.shields.io/badge/생존-2116-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-355ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-20_19:18_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 355 ms
- **최종 업데이트 (UTC)**: 2026-06-20 19:18 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 42 · trojan × 26 · vless × 23 · vmess × 23

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 3 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 25 · `surfboard-eternity` × 1
