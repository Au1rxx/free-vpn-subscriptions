...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2253-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-246ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-20_17:20_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 246 ms
- **최종 업데이트 (UTC)**: 2026-04-20 17:20 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 13 · vless × 96 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 51 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 51 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 7
