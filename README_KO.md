...
![노드](https://img.shields.io/badge/노드-93-brightgreen) ![생존](https://img.shields.io/badge/생존-2275-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-182ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-20_09:12_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 182 ms
- **최종 업데이트 (UTC)**: 2026-06-20 09:12 UTC

**프로토콜 분포:** shadowsocks × 22 · trojan × 28 · vless × 13 · vmess × 30

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 18 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 5
