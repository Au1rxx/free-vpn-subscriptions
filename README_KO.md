...
![노드](https://img.shields.io/badge/노드-81-brightgreen) ![생존](https://img.shields.io/badge/생존-2348-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-163ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-10_05:28_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 163 ms
- **최종 업데이트 (UTC)**: 2026-06-10 05:28 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 13 · vless × 18 · vmess × 22

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 5
