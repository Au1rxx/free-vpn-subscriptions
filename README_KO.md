...
![노드](https://img.shields.io/badge/노드-138-brightgreen) ![생존](https://img.shields.io/badge/생존-1611-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-420ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-14_18:13_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 420 ms
- **최종 업데이트 (UTC)**: 2026-06-14 18:13 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 72 · trojan × 31 · vless × 23 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 18 · `surfboard-eternity` × 4
