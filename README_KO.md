...
![노드](https://img.shields.io/badge/노드-122-brightgreen) ![생존](https://img.shields.io/badge/생존-1991-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-350ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_02:20_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 350 ms
- **최종 업데이트 (UTC)**: 2026-06-28 02:20 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 36 · trojan × 41 · vless × 33 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 5
