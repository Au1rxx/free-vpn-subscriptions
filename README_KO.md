...
![노드](https://img.shields.io/badge/노드-136-brightgreen) ![생존](https://img.shields.io/badge/생존-2433-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-115ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-24_11:21_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 115 ms
- **최종 업데이트 (UTC)**: 2026-04-24 11:21 UTC

**프로토콜 분포:** shadowsocks × 11 · trojan × 21 · vless × 91 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 19 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 67 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
