...
![노드](https://img.shields.io/badge/노드-92-brightgreen) ![생존](https://img.shields.io/badge/생존-1954-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-479ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-26_07:35_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 479 ms
- **최종 업데이트 (UTC)**: 2026-06-26 07:35 UTC

**프로토콜 분포:** shadowsocks × 23 · trojan × 40 · vless × 19 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 19 · `mahdi0024` × 4 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 5 · `ruking-clash` × 16 · `surfboard-eternity` × 3
