...
![노드](https://img.shields.io/badge/노드-69-brightgreen) ![생존](https://img.shields.io/badge/생존-2338-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-141ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-02_20:17_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 141 ms
- **최종 업데이트 (UTC)**: 2026-07-02 20:17 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 25 · trojan × 16 · vless × 11 · vmess × 16

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 5 · `ninjastrikers` × 10 · `pawdroid` × 4 · `surfboard-eternity` × 4
