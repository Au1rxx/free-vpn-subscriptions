...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2570-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-121ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-20_13:24_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 121 ms
- **최종 업데이트 (UTC)**: 2026-04-20 13:24 UTC

**프로토콜 분포:** shadowsocks × 19 · trojan × 8 · vless × 111 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 46 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 23 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 50 · `ruking-clash` × 7 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
