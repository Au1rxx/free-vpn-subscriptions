...
![노드](https://img.shields.io/badge/노드-72-brightgreen) ![생존](https://img.shields.io/badge/생존-1985-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-178ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-04_10:19_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 178 ms
- **최종 업데이트 (UTC)**: 2026-07-04 10:19 UTC

**프로토콜 분포:** shadowsocks × 27 · trojan × 20 · vless × 6 · vmess × 19

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 5
