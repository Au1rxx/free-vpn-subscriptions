...
![노드](https://img.shields.io/badge/노드-92-brightgreen) ![생존](https://img.shields.io/badge/생존-2317-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-172ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-20_05:15_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 172 ms
- **최종 업데이트 (UTC)**: 2026-06-20 05:15 UTC

**프로토콜 분포:** shadowsocks × 22 · trojan × 24 · vless × 16 · vmess × 30

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 3
