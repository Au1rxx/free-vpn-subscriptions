...
![노드](https://img.shields.io/badge/노드-63-brightgreen) ![생존](https://img.shields.io/badge/생존-1954-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-275ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-30_22:19_UTC-informational)
...
- **최고 속도 RTT**: 36 ms
- **중앙값 RTT**: 275 ms
- **최종 업데이트 (UTC)**: 2026-06-30 22:19 UTC

**프로토콜 분포:** shadowsocks × 22 · trojan × 29 · vless × 6 · vmess × 6

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `mfuu-clash` × 8 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 5
