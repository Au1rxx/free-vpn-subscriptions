...
![노드](https://img.shields.io/badge/노드-84-brightgreen) ![생존](https://img.shields.io/badge/생존-2118-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-291ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_15:16_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 291 ms
- **최종 업데이트 (UTC)**: 2026-06-28 15:16 UTC

**프로토콜 분포:** shadowsocks × 17 · trojan × 30 · vless × 19 · vmess × 18

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 6 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 2
