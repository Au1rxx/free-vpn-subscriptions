...
![노드](https://img.shields.io/badge/노드-140-brightgreen) ![생존](https://img.shields.io/badge/생존-2290-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-317ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-04_22:29_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 317 ms
- **최종 업데이트 (UTC)**: 2026-05-04 22:29 UTC

**프로토콜 분포:** shadowsocks × 35 · trojan × 25 · vless × 69 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
