...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2524-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-92ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-27_09:22_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 92 ms
- **최종 업데이트 (UTC)**: 2026-04-27 09:22 UTC

**프로토콜 분포:** shadowsocks × 35 · trojan × 5 · vless × 97 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 19 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 47 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 6 · `ninjastrikers` × 55 · `surfboard-eternity` × 6
