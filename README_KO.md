...
![노드](https://img.shields.io/badge/노드-53-brightgreen) ![생존](https://img.shields.io/badge/생존-2055-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-225ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-29_13:19_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 225 ms
- **최종 업데이트 (UTC)**: 2026-05-29 13:19 UTC

**프로토콜 분포:** shadowsocks × 20 · trojan × 15 · vless × 9 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 13 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 8 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
