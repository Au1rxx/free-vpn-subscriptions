...
![노드](https://img.shields.io/badge/노드-83-brightgreen) ![생존](https://img.shields.io/badge/생존-2363-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-93ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-02_21:26_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 93 ms
- **최종 업데이트 (UTC)**: 2026-06-02 21:26 UTC

**프로토콜 분포:** shadowsocks × 21 · trojan × 30 · vless × 6 · vmess × 26

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 17 · `epodonios` × 9 · `mahdi0024` × 24 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
