...
![노드](https://img.shields.io/badge/노드-109-brightgreen) ![생존](https://img.shields.io/badge/생존-2027-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-418ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_13:34_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 418 ms
- **최종 업데이트 (UTC)**: 2026-06-28 13:34 UTC

**프로토콜 분포:** shadowsocks × 36 · trojan × 31 · vless × 27 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 20 · `mfuu-clash` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 1
