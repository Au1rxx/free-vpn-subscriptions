...
![노드](https://img.shields.io/badge/노드-146-brightgreen) ![생존](https://img.shields.io/badge/생존-2267-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-186ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-05_12:10_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 186 ms
- **최종 업데이트 (UTC)**: 2026-05-05 12:10 UTC

**프로토콜 분포:** shadowsocks × 36 · trojan × 29 · vless × 70 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 65 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
