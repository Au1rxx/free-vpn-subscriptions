...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2514-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-98ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-27_10:27_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 98 ms
- **최종 업데이트 (UTC)**: 2026-04-27 10:27 UTC

**프로토콜 분포:** shadowsocks × 37 · trojan × 7 · vless × 94 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 18 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 44 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 4 · `ninjastrikers` × 59 · `pawdroid` × 1 · `surfboard-eternity` × 3
