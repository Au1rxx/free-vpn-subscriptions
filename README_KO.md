...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2235-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-142ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_04:14_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 142 ms
- **최종 업데이트 (UTC)**: 2026-04-22 04:14 UTC

**프로토콜 분포:** shadowsocks × 33 · trojan × 3 · vless × 102 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 38 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 67 · `ruking-clash` × 5 · `surfboard-eternity` × 6
