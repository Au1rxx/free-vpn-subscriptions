...
![노드](https://img.shields.io/badge/노드-77-brightgreen) ![생존](https://img.shields.io/badge/생존-2422-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-331ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-11_20:38_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 331 ms
- **최종 업데이트 (UTC)**: 2026-06-11 20:38 UTC

**프로토콜 분포:** shadowsocks × 44 · trojan × 17 · vless × 12 · vmess × 4

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 4 · `surfboard-eternity` × 5
