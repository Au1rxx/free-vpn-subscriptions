...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2213-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-97ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-26_12:37_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 97 ms
- **최종 업데이트 (UTC)**: 2026-04-26 12:37 UTC

**프로토콜 분포:** shadowsocks × 25 · trojan × 16 · vless × 98 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 21 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 3 · `surfboard-eternity` × 8
