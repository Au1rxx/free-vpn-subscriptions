...
![노드](https://img.shields.io/badge/노드-81-brightgreen) ![생존](https://img.shields.io/badge/생존-2269-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-184ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-20_12:33_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 184 ms
- **최종 업데이트 (UTC)**: 2026-06-20 12:33 UTC

**프로토콜 분포:** shadowsocks × 23 · trojan × 22 · vless × 8 · vmess × 28

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 8 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `ruking-clash` × 15 · `surfboard-eternity` × 2
