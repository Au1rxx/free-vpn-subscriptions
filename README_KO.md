...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2527-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-85ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-27_07:27_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 85 ms
- **최종 업데이트 (UTC)**: 2026-04-27 07:27 UTC

**프로토콜 분포:** shadowsocks × 32 · trojan × 3 · vless × 101 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 22 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 43 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 4 · `surfboard-eternity` × 6
