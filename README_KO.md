...
![노드](https://img.shields.io/badge/노드-146-brightgreen) ![생존](https://img.shields.io/badge/생존-2217-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-181ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_13:29_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 181 ms
- **최종 업데이트 (UTC)**: 2026-04-22 13:29 UTC

**프로토콜 분포:** shadowsocks × 32 · trojan × 21 · vless × 79 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 62 · `ruking-clash` × 5 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
