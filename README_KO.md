...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2234-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-105ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-01_00:28_UTC-informational)
...
- **최고 속도 RTT**: 26 ms
- **중앙값 RTT**: 105 ms
- **최종 업데이트 (UTC)**: 2026-05-01 00:28 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 5 · vless × 97 · vmess × 20

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 27 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 5 · `ninjastrikers` × 68 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
