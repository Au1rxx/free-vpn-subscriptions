...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2073-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-102ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-02_02:30_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 102 ms
- **최종 업데이트 (UTC)**: 2026-05-02 02:30 UTC

**프로토콜 분포:** shadowsocks × 38 · trojan × 8 · vless × 94 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 32 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 61 · `pawdroid` × 3 · `surfboard-eternity` × 8
