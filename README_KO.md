...
![노드](https://img.shields.io/badge/노드-143-brightgreen) ![생존](https://img.shields.io/badge/생존-2098-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-379ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-21_07:34_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 379 ms
- **최종 업데이트 (UTC)**: 2026-06-21 07:34 UTC

**프로토콜 분포:** shadowsocks × 42 · trojan × 31 · vless × 45 · vmess × 25

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 14 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 33 · `snakem982` × 2 · `surfboard-eternity` × 2
