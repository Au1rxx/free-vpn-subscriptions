...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2567-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-142ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-26_19:38_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 142 ms
- **최종 업데이트 (UTC)**: 2026-04-26 19:38 UTC

**프로토콜 분포:** shadowsocks × 38 · trojan × 18 · vless × 80 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 23 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 43 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 4 · `ninjastrikers` × 53 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
