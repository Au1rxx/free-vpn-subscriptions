...
![노드](https://img.shields.io/badge/노드-105-brightgreen) ![생존](https://img.shields.io/badge/생존-1915-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-439ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-12_15:26_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 439 ms
- **최종 업데이트 (UTC)**: 2026-06-12 15:26 UTC

**프로토콜 분포:** hysteria2 × 2 · shadowsocks × 45 · trojan × 39 · vless × 12 · vmess × 7

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 17 · `epodonios` × 23 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 3
