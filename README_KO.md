...
![노드](https://img.shields.io/badge/노드-107-brightgreen) ![생존](https://img.shields.io/badge/생존-1949-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-102ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-04_00:23_UTC-informational)
...
- **최고 속도 RTT**: 35 ms
- **중앙값 RTT**: 102 ms
- **최종 업데이트 (UTC)**: 2026-06-04 00:23 UTC

**프로토콜 분포:** shadowsocks × 24 · trojan × 38 · vless × 36 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 21 · `epodonios` × 26 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 29 · `snakem982` × 1 · `surfboard-eternity` × 1
