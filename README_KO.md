...
![노드](https://img.shields.io/badge/노드-139-brightgreen) ![생존](https://img.shields.io/badge/생존-2654-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-199ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-24_22:32_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 199 ms
- **최종 업데이트 (UTC)**: 2026-04-24 22:32 UTC

**프로토콜 분포:** shadowsocks × 24 · trojan × 23 · vless × 79 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 25 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 48 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
