...
![노드](https://img.shields.io/badge/노드-100-brightgreen) ![생존](https://img.shields.io/badge/생존-2039-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-183ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-27_01:28_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 183 ms
- **최종 업데이트 (UTC)**: 2026-06-27 01:28 UTC

**프로토콜 분포:** shadowsocks × 17 · trojan × 35 · vless × 28 · vmess × 20

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 3
