...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2159-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-111ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_02:11_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 111 ms
- **최종 업데이트 (UTC)**: 2026-04-30 02:11 UTC

**프로토콜 분포:** shadowsocks × 38 · trojan × 4 · vless × 99 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 65 · `ruking-clash` × 1 · `surfboard-eternity` × 7
