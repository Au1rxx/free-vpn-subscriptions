...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2258-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-179ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_11:11_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 179 ms
- **최종 업데이트 (UTC)**: 2026-04-22 11:11 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 10 · vless × 99 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 48 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 59 · `pawdroid` × 2 · `ruking-clash` × 4 · `surfboard-eternity` × 7
