...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2202-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-93ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-02_10:39_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 93 ms
- **최종 업데이트 (UTC)**: 2026-05-02 10:39 UTC

**프로토콜 분포:** shadowsocks × 39 · trojan × 10 · vless × 91 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 27 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 4 · `snakem982` × 1 · `surfboard-eternity` × 10
