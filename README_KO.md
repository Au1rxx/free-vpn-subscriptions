...
![노드](https://img.shields.io/badge/노드-78-brightgreen) ![생존](https://img.shields.io/badge/생존-2128-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-270ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-09_15:19_UTC-informational)
...
- **최고 속도 RTT**: 21 ms
- **중앙값 RTT**: 270 ms
- **최종 업데이트 (UTC)**: 2026-06-09 15:19 UTC

**프로토콜 분포:** shadowsocks × 32 · trojan × 15 · vless × 8 · vmess × 23

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 6
