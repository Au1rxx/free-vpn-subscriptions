...
![노드](https://img.shields.io/badge/노드-96-brightgreen) ![생존](https://img.shields.io/badge/생존-1899-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-158ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-04_19:39_UTC-informational)
...
- **최고 속도 RTT**: 36 ms
- **중앙값 RTT**: 158 ms
- **최종 업데이트 (UTC)**: 2026-06-04 19:39 UTC

**프로토콜 분포:** shadowsocks × 20 · trojan × 47 · vless × 19 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 32 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `ruking-clash` × 4 · `surfboard-eternity` × 2
