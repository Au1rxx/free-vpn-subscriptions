...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-1937-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-122ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-08_00:12_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 122 ms
- **최종 업데이트 (UTC)**: 2026-05-08 00:12 UTC

**프로토콜 분포:** shadowsocks × 50 · trojan × 4 · vless × 86 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 26 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 70 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
