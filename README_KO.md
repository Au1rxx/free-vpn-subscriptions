...
![노드](https://img.shields.io/badge/노드-73-brightgreen) ![생존](https://img.shields.io/badge/생존-2438-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-106ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-02_16:18_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 106 ms
- **최종 업데이트 (UTC)**: 2026-06-02 16:18 UTC

**프로토콜 분포:** shadowsocks × 23 · trojan × 25 · vless × 7 · vmess × 18

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 15 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 5 · `pawdroid` × 2
