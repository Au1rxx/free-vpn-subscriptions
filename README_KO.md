...
![노드](https://img.shields.io/badge/노드-145-brightgreen) ![생존](https://img.shields.io/badge/생존-2520-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-104ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-24_13:37_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 104 ms
- **최종 업데이트 (UTC)**: 2026-04-24 13:37 UTC

**프로토콜 분포:** shadowsocks × 20 · trojan × 20 · vless × 94 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 32 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `pawdroid` × 3 · `surfboard-eternity` × 3
