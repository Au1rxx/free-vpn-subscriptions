...
![노드](https://img.shields.io/badge/노드-148-brightgreen) ![생존](https://img.shields.io/badge/생존-2274-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-245ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-05_13:29_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 245 ms
- **최종 업데이트 (UTC)**: 2026-05-05 13:29 UTC

**프로토콜 분포:** shadowsocks × 38 · trojan × 29 · vless × 70 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 6
