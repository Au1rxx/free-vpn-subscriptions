...
![노드](https://img.shields.io/badge/노드-138-brightgreen) ![생존](https://img.shields.io/badge/생존-2220-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-156ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_17:32_UTC-informational)
...
- **최고 속도 RTT**: 36 ms
- **중앙값 RTT**: 156 ms
- **최종 업데이트 (UTC)**: 2026-04-28 17:32 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 23 · vless × 76 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
