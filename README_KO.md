...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-1832-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-470ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-22_16:37_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 470 ms
- **최종 업데이트 (UTC)**: 2026-06-22 16:37 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 42 · trojan × 26 · vless × 68 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 4
