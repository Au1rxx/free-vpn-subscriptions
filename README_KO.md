...
![노드](https://img.shields.io/badge/노드-135-brightgreen) ![생존](https://img.shields.io/badge/생존-2550-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-287ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_20:29_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 287 ms
- **최종 업데이트 (UTC)**: 2026-04-22 20:29 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 22 · vless × 70 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 25 · `epodonios` × 11 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 50 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
