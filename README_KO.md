...
![노드](https://img.shields.io/badge/노드-106-brightgreen) ![생존](https://img.shields.io/badge/생존-1965-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-488ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_14:22_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 488 ms
- **최종 업데이트 (UTC)**: 2026-06-18 14:22 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 29 · vmess × 6

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 25 · `snakem982` × 7 · `surfboard-eternity` × 2
