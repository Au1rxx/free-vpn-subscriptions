...
![노드](https://img.shields.io/badge/노드-146-brightgreen) ![생존](https://img.shields.io/badge/생존-2057-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-429ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-21_12:34_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 429 ms
- **최종 업데이트 (UTC)**: 2026-06-21 12:34 UTC

**프로토콜 분포:** shadowsocks × 45 · trojan × 34 · vless × 44 · vmess × 23

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `epodonios` × 21 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 37 · `surfboard-eternity` × 3
