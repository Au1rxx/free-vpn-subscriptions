...
![노드](https://img.shields.io/badge/노드-81-brightgreen) ![생존](https://img.shields.io/badge/생존-2018-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-161ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-04_06:09_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 161 ms
- **최종 업데이트 (UTC)**: 2026-07-04 06:09 UTC

**프로토콜 분포:** shadowsocks × 26 · trojan × 22 · vless × 12 · vmess × 21

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
