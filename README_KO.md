...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2091-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-104ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-29_06:36_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 104 ms
- **최종 업데이트 (UTC)**: 2026-04-29 06:36 UTC

**프로토콜 분포:** shadowsocks × 33 · trojan × 11 · vless × 96 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 26 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 6 · `ninjastrikers` × 67 · `ruking-clash` × 5 · `snakem982` × 2 · `surfboard-eternity` × 4
