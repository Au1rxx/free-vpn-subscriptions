...
![노드](https://img.shields.io/badge/노드-103-brightgreen) ![생존](https://img.shields.io/badge/생존-2241-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-477ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-12_13:14_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 477 ms
- **최종 업데이트 (UTC)**: 2026-06-12 13:14 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 46 · trojan × 37 · vless × 15 · vmess × 4

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 29 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 5
