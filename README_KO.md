...
![노드](https://img.shields.io/badge/노드-102-brightgreen) ![생존](https://img.shields.io/badge/생존-2146-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-569ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-29_13:31_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 569 ms
- **최종 업데이트 (UTC)**: 2026-06-29 13:31 UTC

**프로토콜 분포:** shadowsocks × 16 · trojan × 52 · vless × 20 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 31 · `epodonios` × 18 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 10
