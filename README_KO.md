...
![노드](https://img.shields.io/badge/노드-128-brightgreen) ![생존](https://img.shields.io/badge/생존-2544-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-472ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-19_06:37_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 472 ms
- **최종 업데이트 (UTC)**: 2026-06-19 06:37 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 35 · trojan × 23 · vless × 55 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 34 · `snakem982` × 5 · `surfboard-eternity` × 1
