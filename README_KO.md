...
![노드](https://img.shields.io/badge/노드-85-brightgreen) ![생존](https://img.shields.io/badge/생존-2101-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-241ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-09_23:15_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 241 ms
- **최종 업데이트 (UTC)**: 2026-06-09 23:15 UTC

**프로토콜 분포:** shadowsocks × 37 · trojan × 18 · vless × 8 · vmess × 22

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 7
