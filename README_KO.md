...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-1968-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-339ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-06_19:34_UTC-informational)
...
- **최고 속도 RTT**: 38 ms
- **중앙값 RTT**: 339 ms
- **최종 업데이트 (UTC)**: 2026-05-06 19:34 UTC

**프로토콜 분포:** shadowsocks × 46 · trojan × 24 · vless × 69 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 2
