...
![노드](https://img.shields.io/badge/노드-71-brightgreen) ![생존](https://img.shields.io/badge/생존-2410-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-155ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-02_16:10_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 155 ms
- **최종 업데이트 (UTC)**: 2026-07-02 16:10 UTC

**프로토콜 분포:** shadowsocks × 20 · trojan × 16 · vless × 20 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 8 · `ninjastrikers` × 12 · `pawdroid` × 11 · `surfboard-eternity` × 3
