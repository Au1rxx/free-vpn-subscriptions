...
![노드](https://img.shields.io/badge/노드-90-brightgreen) ![생존](https://img.shields.io/badge/생존-2196-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-553ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-29_12:38_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 553 ms
- **최종 업데이트 (UTC)**: 2026-06-29 12:38 UTC

**프로토콜 분포:** shadowsocks × 18 · trojan × 40 · vless × 19 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 18 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 5
