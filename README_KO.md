...
![노드](https://img.shields.io/badge/노드-84-brightgreen) ![생존](https://img.shields.io/badge/생존-2314-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-276ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-19_17:09_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 276 ms
- **최종 업데이트 (UTC)**: 2026-06-19 17:09 UTC

**프로토콜 분포:** shadowsocks × 23 · trojan × 23 · vless × 10 · vmess × 28

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 4 · `ruking-clash` × 18 · `surfboard-eternity` × 7
