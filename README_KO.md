...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2222-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-107ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_07:22_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 107 ms
- **최종 업데이트 (UTC)**: 2026-04-30 07:22 UTC

**프로토콜 분포:** shadowsocks × 34 · trojan × 17 · vless × 90 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 27 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 7 · `ninjastrikers` × 67 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
