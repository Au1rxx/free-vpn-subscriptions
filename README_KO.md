...
![노드](https://img.shields.io/badge/노드-100-brightgreen) ![생존](https://img.shields.io/badge/생존-2148-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-158ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-06_03:10_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 158 ms
- **최종 업데이트 (UTC)**: 2026-06-06 03:10 UTC

**프로토콜 분포:** shadowsocks × 24 · trojan × 27 · vless × 31 · vmess × 18

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 5 · `epodonios` × 26 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 30 · `surfboard-eternity` × 1
