...
![노드](https://img.shields.io/badge/노드-141-brightgreen) ![생존](https://img.shields.io/badge/생존-2555-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-186ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-23_11:35_UTC-informational)
...
- **최고 속도 RTT**: 26 ms
- **중앙값 RTT**: 186 ms
- **최종 업데이트 (UTC)**: 2026-04-23 11:35 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 22 · vless × 80 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 22 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 70 · `pawdroid` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
