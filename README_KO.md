...
![노드](https://img.shields.io/badge/노드-125-brightgreen) ![생존](https://img.shields.io/badge/생존-1997-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-354ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_06:16_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 354 ms
- **최종 업데이트 (UTC)**: 2026-06-28 06:16 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 36 · trojan × 40 · vless × 37 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 29 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 3
