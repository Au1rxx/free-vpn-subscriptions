...
![노드](https://img.shields.io/badge/노드-83-brightgreen) ![생존](https://img.shields.io/badge/생존-1845-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-378ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-30_19:26_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 378 ms
- **최종 업데이트 (UTC)**: 2026-06-30 19:26 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 33 · trojan × 30 · vless × 14 · vmess × 5

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 5 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 8 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 3
