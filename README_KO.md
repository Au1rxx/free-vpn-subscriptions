...
![노드](https://img.shields.io/badge/노드-85-brightgreen) ![생존](https://img.shields.io/badge/생존-2132-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-147ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-09_17:27_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 147 ms
- **최종 업데이트 (UTC)**: 2026-07-09 17:27 UTC

**프로토콜 분포:** shadowsocks × 23 · trojan × 10 · vless × 21 · vmess × 31

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 2 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 37 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 10 · `pawdroid` × 8 · `ruking-clash` × 2
