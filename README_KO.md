...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2585-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-79ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_09:17_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 79 ms
- **최종 업데이트 (UTC)**: 2026-04-28 09:17 UTC

**프로토콜 분포:** shadowsocks × 22 · trojan × 14 · vless × 104 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 22 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 28 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
