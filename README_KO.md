...
![노드](https://img.shields.io/badge/노드-138-brightgreen) ![생존](https://img.shields.io/badge/생존-2322-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-309ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-21_20:32_UTC-informational)
...
- **최고 속도 RTT**: 38 ms
- **중앙값 RTT**: 309 ms
- **최종 업데이트 (UTC)**: 2026-04-21 20:32 UTC

**프로토콜 분포:** shadowsocks × 31 · trojan × 24 · vless × 68 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 37 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 49 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
