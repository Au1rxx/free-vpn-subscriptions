...
![노드](https://img.shields.io/badge/노드-89-brightgreen) ![생존](https://img.shields.io/badge/생존-2081-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-252ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-27_12:30_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 252 ms
- **최종 업데이트 (UTC)**: 2026-06-27 12:30 UTC

**프로토콜 분포:** shadowsocks × 18 · trojan × 33 · vless × 15 · vmess × 23

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 5 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 12 · `surfboard-eternity` × 2
