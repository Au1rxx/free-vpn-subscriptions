...
![노드](https://img.shields.io/badge/노드-86-brightgreen) ![생존](https://img.shields.io/badge/생존-2542-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-100ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-02_07:11_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 100 ms
- **최종 업데이트 (UTC)**: 2026-06-02 07:11 UTC

**프로토콜 분포:** shadowsocks × 25 · trojan × 27 · vless × 13 · vmess × 21

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 16 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 17 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
