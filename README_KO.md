...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2456-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-170ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-27_21:19_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 170 ms
- **최종 업데이트 (UTC)**: 2026-04-27 21:19 UTC

**프로토콜 분포:** shadowsocks × 25 · trojan × 21 · vless × 92 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 31 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 31 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
