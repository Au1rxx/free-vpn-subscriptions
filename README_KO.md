...
![노드](https://img.shields.io/badge/노드-149-brightgreen) ![생존](https://img.shields.io/badge/생존-2451-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-109ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-24_08:36_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 109 ms
- **최종 업데이트 (UTC)**: 2026-04-24 08:36 UTC

**프로토콜 분포:** shadowsocks × 13 · trojan × 23 · vless × 100 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 21 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 76 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 1
