...
![노드](https://img.shields.io/badge/노드-92-brightgreen) ![생존](https://img.shields.io/badge/생존-2017-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-281ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-26_15:21_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 281 ms
- **최종 업데이트 (UTC)**: 2026-06-26 15:21 UTC

**프로토콜 분포:** shadowsocks × 21 · trojan × 33 · vless × 17 · vmess × 21

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 4 · `epodonios` × 20 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 5 · `ruking-clash` × 16 · `surfboard-eternity` × 2
