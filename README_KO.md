...
![노드](https://img.shields.io/badge/노드-116-brightgreen) ![생존](https://img.shields.io/badge/생존-1780-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-365ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_01:09_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 365 ms
- **최종 업데이트 (UTC)**: 2026-06-18 01:09 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 47 · trojan × 29 · vless × 32 · vmess × 7

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 24 · `pawdroid` × 1 · `ruking-clash` × 15 · `surfboard-eternity` × 4
