...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2202-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-112ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-26_11:38_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 112 ms
- **최종 업데이트 (UTC)**: 2026-04-26 11:38 UTC

**프로토콜 분포:** shadowsocks × 27 · trojan × 15 · vless × 96 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 20 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 2 · `ninjastrikers` × 67 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8
