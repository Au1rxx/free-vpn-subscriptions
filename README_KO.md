...
![노드](https://img.shields.io/badge/노드-96-brightgreen) ![생존](https://img.shields.io/badge/생존-1969-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-361ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-27_22:28_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 361 ms
- **최종 업데이트 (UTC)**: 2026-06-27 22:28 UTC

**프로토콜 분포:** shadowsocks × 28 · trojan × 39 · vless × 17 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 8 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 14 · `ruking-clash` × 14 · `surfboard-eternity` × 5
