...
![노드](https://img.shields.io/badge/노드-82-brightgreen) ![생존](https://img.shields.io/badge/생존-2147-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-173ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_17:16_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 173 ms
- **최종 업데이트 (UTC)**: 2026-06-28 17:16 UTC

**프로토콜 분포:** shadowsocks × 18 · trojan × 27 · vless × 20 · vmess × 17

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 3
