...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2186-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-162ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-21_11:16_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 162 ms
- **최종 업데이트 (UTC)**: 2026-04-21 11:16 UTC

**프로토콜 분포:** shadowsocks × 27 · trojan × 3 · vless × 106 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 54 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 52 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 6
