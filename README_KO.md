...
![노드](https://img.shields.io/badge/노드-144-brightgreen) ![생존](https://img.shields.io/badge/생존-1926-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-481ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-22_13:37_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 481 ms
- **최종 업데이트 (UTC)**: 2026-06-22 13:37 UTC

**프로토콜 분포:** shadowsocks × 40 · trojan × 29 · vless × 62 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 6 · `epodonios` × 41 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 8
