...
![노드](https://img.shields.io/badge/노드-105-brightgreen) ![생존](https://img.shields.io/badge/생존-1980-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-420ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_12:12_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 420 ms
- **최종 업데이트 (UTC)**: 2026-06-18 12:12 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 35 · trojan × 31 · vless × 31 · vmess × 7

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 9 · `pawdroid` × 6 · `ruking-clash` × 28 · `snakem982` × 2 · `surfboard-eternity` × 6
