...
![노드](https://img.shields.io/badge/노드-109-brightgreen) ![생존](https://img.shields.io/badge/생존-1866-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-344ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-15_06:12_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 344 ms
- **최종 업데이트 (UTC)**: 2026-06-15 06:12 UTC

**프로토콜 분포:** shadowsocks × 45 · trojan × 26 · vless × 25 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 29 · `pawdroid` × 1 · `ruking-clash` × 11 · `surfboard-eternity` × 2
