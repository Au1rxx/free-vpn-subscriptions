...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2259-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-150ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_07:28_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 150 ms
- **최종 업데이트 (UTC)**: 2026-04-22 07:28 UTC

**프로토콜 분포:** shadowsocks × 31 · trojan × 4 · vless × 103 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 39 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 11 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 66 · `ruking-clash` × 4 · `surfboard-eternity` × 6
