...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2579-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-103ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_04:22_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 103 ms
- **최종 업데이트 (UTC)**: 2026-04-28 04:22 UTC

**프로토콜 분포:** shadowsocks × 19 · trojan × 7 · vless × 115 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 30 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 68 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 2
