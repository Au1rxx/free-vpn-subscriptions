...
![노드](https://img.shields.io/badge/노드-109-brightgreen) ![생존](https://img.shields.io/badge/생존-1686-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-405ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-13_23:25_UTC-informational)
...
- **최고 속도 RTT**: 35 ms
- **중앙값 RTT**: 405 ms
- **최종 업데이트 (UTC)**: 2026-06-13 23:25 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 54 · trojan × 32 · vless × 15 · vmess × 7

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 14 · `surfboard-eternity` × 4
