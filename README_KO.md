...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2080-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-188ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-29_16:37_UTC-informational)
...
- **최고 속도 RTT**: 36 ms
- **중앙값 RTT**: 188 ms
- **최종 업데이트 (UTC)**: 2026-04-29 16:37 UTC

**프로토콜 분포:** shadowsocks × 43 · trojan × 16 · vless × 80 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 6 · `ninjastrikers` × 57 · `surfboard-eternity` × 7
