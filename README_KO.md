...
![노드](https://img.shields.io/badge/노드-113-brightgreen) ![생존](https://img.shields.io/badge/생존-2005-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-355ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_09:32_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 355 ms
- **최종 업데이트 (UTC)**: 2026-06-28 09:32 UTC

**프로토콜 분포:** shadowsocks × 33 · trojan × 39 · vless × 27 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
