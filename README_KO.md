...
![노드](https://img.shields.io/badge/노드-100-brightgreen) ![생존](https://img.shields.io/badge/생존-2042-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-186ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-27_02:27_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 186 ms
- **최종 업데이트 (UTC)**: 2026-06-27 02:27 UTC

**프로토콜 분포:** shadowsocks × 18 · trojan × 35 · vless × 26 · vmess × 21

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 9 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 3
