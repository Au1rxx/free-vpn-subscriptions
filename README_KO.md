...
![노드](https://img.shields.io/badge/노드-117-brightgreen) ![생존](https://img.shields.io/badge/생존-1984-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-348ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_03:17_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 348 ms
- **최종 업데이트 (UTC)**: 2026-06-28 03:17 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 32 · trojan × 38 · vless × 36 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 5
