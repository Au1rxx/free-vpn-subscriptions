...
![노드](https://img.shields.io/badge/노드-136-brightgreen) ![생존](https://img.shields.io/badge/생존-1893-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-478ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-22_11:39_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 478 ms
- **최종 업데이트 (UTC)**: 2026-06-22 11:39 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 43 · trojan × 29 · vless × 50 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 2 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 30 · `snakem982` × 3 · `surfboard-eternity` × 3
