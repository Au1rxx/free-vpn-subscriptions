...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-1433-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-5ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-19_10:15_UTC-informational)
...
- **최고 속도 RTT**: 5 ms
- **중앙값 RTT**: 5 ms
- **최종 업데이트 (UTC)**: 2026-04-19 10:15 UTC

**프로토콜 분포:** shadowsocks × 49 · trojan × 27 · vless × 56 · vmess × 18

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 63 · `ebrasha-v2ray` × 39 · `freefq` × 1 · `lagzian-mix` × 1 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 8 · `mfuu-clash` × 4 · `ruking-clash` × 25 · `vxiaov-clash` × 2
