...
![노드](https://img.shields.io/badge/노드-147-brightgreen) ![생존](https://img.shields.io/badge/생존-2074-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-199ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-29_17:21_UTC-informational)
...
- **최고 속도 RTT**: 40 ms
- **중앙값 RTT**: 199 ms
- **최종 업데이트 (UTC)**: 2026-04-29 17:21 UTC

**프로토콜 분포:** shadowsocks × 43 · trojan × 18 · vless × 76 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 7 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 7 · `ninjastrikers` × 53 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
