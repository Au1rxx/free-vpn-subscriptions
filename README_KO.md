...
![노드](https://img.shields.io/badge/노드-87-brightgreen) ![생존](https://img.shields.io/badge/생존-2344-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-90ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-02_23:16_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 90 ms
- **최종 업데이트 (UTC)**: 2026-06-02 23:16 UTC

**프로토콜 분포:** shadowsocks × 22 · trojan × 29 · vless × 6 · vmess × 30

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 19 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `snakem982` × 1 · `surfboard-eternity` × 2
