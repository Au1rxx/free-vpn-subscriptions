...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2482-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-105ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-10_08:27_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 105 ms
- **최종 업데이트 (UTC)**: 2026-05-10 08:27 UTC

**프로토콜 분포:** shadowsocks × 43 · trojan × 3 · vless × 96 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 32 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 66 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
