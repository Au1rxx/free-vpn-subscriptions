...
![노드](https://img.shields.io/badge/노드-68-brightgreen) ![생존](https://img.shields.io/badge/생존-1921-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-131ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-03_04:32_UTC-informational)
...
- **최고 속도 RTT**: 38 ms
- **중앙값 RTT**: 131 ms
- **최종 업데이트 (UTC)**: 2026-07-03 04:32 UTC

**프로토콜 분포:** shadowsocks × 25 · trojan × 17 · vless × 11 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 3 · `surfboard-eternity` × 2
