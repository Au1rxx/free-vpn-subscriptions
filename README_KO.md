...
![노드](https://img.shields.io/badge/노드-121-brightgreen) ![생존](https://img.shields.io/badge/생존-2461-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-493ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-19_10:26_UTC-informational)
...
- **최고 속도 RTT**: 38 ms
- **중앙값 RTT**: 493 ms
- **최종 업데이트 (UTC)**: 2026-06-19 10:26 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 32 · trojan × 21 · vless × 52 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 20 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 1 · `ruking-clash` × 42 · `snakem982` × 3 · `surfboard-eternity` × 2
