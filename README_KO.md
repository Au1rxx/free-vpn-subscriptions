...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2575-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-97ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_03:38_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 97 ms
- **최종 업데이트 (UTC)**: 2026-04-28 03:38 UTC

**프로토콜 분포:** shadowsocks × 18 · trojan × 4 · vless × 120 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 31 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 6 · `ninjastrikers` × 64 · `ruking-clash` × 1 · `surfboard-eternity` × 6
