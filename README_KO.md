...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2574-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-130ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-26_18:37_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 130 ms
- **최종 업데이트 (UTC)**: 2026-04-26 18:37 UTC

**프로토콜 분포:** shadowsocks × 39 · trojan × 13 · vless × 85 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 18 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 50 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 4
