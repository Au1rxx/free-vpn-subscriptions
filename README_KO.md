...
![노드](https://img.shields.io/badge/노드-94-brightgreen) ![생존](https://img.shields.io/badge/생존-1959-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-294ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-27_23:13_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 294 ms
- **최종 업데이트 (UTC)**: 2026-06-27 23:13 UTC

**프로토콜 분포:** shadowsocks × 21 · trojan × 44 · vless × 18 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 16 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `ruking-clash` × 16 · `surfboard-eternity` × 2
