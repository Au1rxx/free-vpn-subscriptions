...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2195-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-117ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_10:18_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 117 ms
- **최종 업데이트 (UTC)**: 2026-04-30 10:18 UTC

**프로토콜 분포:** shadowsocks × 42 · trojan × 11 · vless × 89 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 6 · `ninjastrikers` × 59 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
