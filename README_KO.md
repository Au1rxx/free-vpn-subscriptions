...
![노드](https://img.shields.io/badge/노드-139-brightgreen) ![생존](https://img.shields.io/badge/생존-1902-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-426ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-22_08:39_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 426 ms
- **최종 업데이트 (UTC)**: 2026-06-22 08:39 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 45 · trojan × 26 · vless × 54 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 6 · `ruking-clash` × 27 · `snakem982` × 4 · `surfboard-eternity` × 4
