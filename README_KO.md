...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2452-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-156ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-27_19:14_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 156 ms
- **최종 업데이트 (UTC)**: 2026-04-27 19:14 UTC

**프로토콜 분포:** shadowsocks × 27 · trojan × 19 · vless × 92 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 31 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 53 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 3
