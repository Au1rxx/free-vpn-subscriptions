...
![노드](https://img.shields.io/badge/노드-98-brightgreen) ![생존](https://img.shields.io/badge/생존-1922-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-166ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-04_07:38_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 166 ms
- **최종 업데이트 (UTC)**: 2026-06-04 07:38 UTC

**프로토콜 분포:** shadowsocks × 24 · trojan × 46 · vless × 21 · vmess × 7

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 28 · `epodonios` × 29 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
