...
![노드](https://img.shields.io/badge/노드-136-brightgreen) ![생존](https://img.shields.io/badge/생존-2582-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-291ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_18:24_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 291 ms
- **최종 업데이트 (UTC)**: 2026-04-22 18:24 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 22 · vless × 71 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 26 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 6
