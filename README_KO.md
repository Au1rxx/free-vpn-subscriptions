...
![노드](https://img.shields.io/badge/노드-116-brightgreen) ![생존](https://img.shields.io/badge/생존-2546-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-488ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-19_09:20_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 488 ms
- **최종 업데이트 (UTC)**: 2026-06-19 09:20 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 32 · trojan × 25 · vless × 41 · vmess × 17

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 15 · `mahdi0024` × 6 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 20 · `pawdroid` × 3 · `ruking-clash` × 36 · `snakem982` × 4 · `surfboard-eternity` × 4
