...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2465-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-140ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-10_11:32_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 140 ms
- **최종 업데이트 (UTC)**: 2026-05-10 11:32 UTC

**프로토콜 분포:** shadowsocks × 51 · trojan × 4 · vless × 85 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 33 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 8
