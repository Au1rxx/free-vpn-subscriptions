...
![노드](https://img.shields.io/badge/노드-105-brightgreen) ![생존](https://img.shields.io/badge/생존-2531-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-109ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-02_01:20_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 109 ms
- **최종 업데이트 (UTC)**: 2026-06-02 01:20 UTC

**프로토콜 분포:** shadowsocks × 24 · trojan × 31 · vless × 24 · vmess × 26

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 16 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 30 · `pawdroid` × 1 · `surfboard-eternity` × 2
