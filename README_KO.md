...
![노드](https://img.shields.io/badge/노드-133-brightgreen) ![생존](https://img.shields.io/badge/생존-2374-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-503ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_15:30_UTC-informational)
...
- **최고 속도 RTT**: 38 ms
- **중앙값 RTT**: 503 ms
- **최종 업데이트 (UTC)**: 2026-06-18 15:30 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 37 · trojan × 36 · vless × 48 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 25 · `snakem982` × 9 · `surfboard-eternity` × 3
