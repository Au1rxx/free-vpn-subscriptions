...
![노드](https://img.shields.io/badge/노드-94-brightgreen) ![생존](https://img.shields.io/badge/생존-1880-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-408ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-29_16:21_UTC-informational)
...
- **최고 속도 RTT**: 35 ms
- **중앙값 RTT**: 408 ms
- **최종 업데이트 (UTC)**: 2026-06-29 16:21 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 33 · vless × 21 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
