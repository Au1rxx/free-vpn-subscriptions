...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2253-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-164ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-30_14:18_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 164 ms
- **최종 업데이트 (UTC)**: 2026-04-30 14:18 UTC

**프로토콜 분포:** shadowsocks × 32 · trojan × 18 · vless × 82 · vmess × 18

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 36 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 56 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
