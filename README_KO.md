...
![노드](https://img.shields.io/badge/노드-111-brightgreen) ![생존](https://img.shields.io/badge/생존-2016-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-338ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-25_11:11_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 338 ms
- **최종 업데이트 (UTC)**: 2026-06-25 11:11 UTC

**프로토콜 분포:** shadowsocks × 35 · trojan × 29 · vless × 34 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 5 · `epodonios` × 34 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 7
