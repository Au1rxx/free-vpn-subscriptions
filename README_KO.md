...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2223-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-136ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-22_00:19_UTC-informational)
...
- **최고 속도 RTT**: 35 ms
- **중앙값 RTT**: 136 ms
- **최종 업데이트 (UTC)**: 2026-04-22 00:19 UTC

**프로토콜 분포:** shadowsocks × 34 · trojan × 4 · vless × 98 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 28 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 71 · `ruking-clash` × 5 · `snakem982` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
