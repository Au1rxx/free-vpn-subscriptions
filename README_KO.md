...
![노드](https://img.shields.io/badge/노드-139-brightgreen) ![생존](https://img.shields.io/badge/생존-2223-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-117ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-28_14:18_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 117 ms
- **최종 업데이트 (UTC)**: 2026-04-28 14:18 UTC

**프로토콜 분포:** shadowsocks × 29 · trojan × 19 · vless × 79 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 27 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 17 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `mfuu-clash` × 5 · `ninjastrikers` × 55 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6
