...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2579-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-106ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-04-26_16:17_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 106 ms
- **최종 업데이트 (UTC)**: 2026-04-26 16:17 UTC

**프로토콜 분포:** shadowsocks × 39 · trojan × 5 · vless × 93 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 17 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 51 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 4 · `ninjastrikers` × 51 · `pawdroid` × 3 · `surfboard-eternity` × 7
