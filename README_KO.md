...
![노드](https://img.shields.io/badge/노드-119-brightgreen) ![생존](https://img.shields.io/badge/생존-1952-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-434ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-12_21:10_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 434 ms
- **최종 업데이트 (UTC)**: 2026-06-12 21:10 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 54 · trojan × 43 · vless × 13 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 33 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 8 · `surfboard-eternity` × 6
