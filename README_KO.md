...
![노드](https://img.shields.io/badge/노드-84-brightgreen) ![생존](https://img.shields.io/badge/생존-2007-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-264ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-26_18:36_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 264 ms
- **최종 업데이트 (UTC)**: 2026-06-26 18:36 UTC

**프로토콜 분포:** shadowsocks × 21 · trojan × 28 · vless × 15 · vmess × 20

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 5 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 5
